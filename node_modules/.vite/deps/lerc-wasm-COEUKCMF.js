...
n = i, e = "undefined" != typeof document && document.currentScript ? document.currentScript.src : void 0, r = function(t) {
  ...
  function z() {
    return f || !o3 && !u2 || "function" != typeof fetch ? Promise.resolve().then(function() {
      return q(B);
    }) : fetch(B, { credentials: "same-origin" }).then(function(t2) {
  ...
  function L() {
    ...
    function u3() {
      return f || "function" != typeof WebAssembly.instantiateStreaming || F(B) || "function" != typeof fetch ? o4(i3) : fetch(B, { credentials: "same-origin" }).then(function(t2) {
...
//# sourceMappingURL=lerc-wasm-COEUKCMF.js.map
