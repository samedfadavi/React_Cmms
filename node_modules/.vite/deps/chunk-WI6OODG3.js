...
var s3 = class {
  ...
  *keys() {
    ...
    for (const { row: s4, colFrom: e4, colTo: r2 } of this.spans) for (let t = e4; t <= r2; t++) {
  ...
  forEach(o3, l) {
    ...
    if (0 !== s4.length) for (const { row: t, colFrom: n3, colTo: c } of s4) for (let s5 = n3; s5 <= c; s5++) o3.call(l, r2, t, e4.normalizeCol(s5), e4.getWorldForColumn(s5));
  }
};
s3.pool = new e(s3);
...
//# sourceMappingURL=chunk-WI6OODG3.js.map
