import {
  ...
  r,
  s as s4
} from "./chunk-JWA73VK6.js";
import {
  o as o2,
  r as r2
} from "./chunk-URNMKNS6.js";
import {
  f
...
async function i2(i3, n2, p2, m4) {
  const a = f(i3), u = n2[0].spatialReference, c = { ...m4, responseType: "json", query: { ...a.query, f: "json", sr: d(u), target: JSON.stringify({ geometryType: p(n2[0]), geometries: n2 }), cutter: JSON.stringify(p2) } }, f2 = await U(a.path + "/cut", c), { cutIndexes: y3, geometries: g2 = [] } = f2.data;
...
async function m2(m4, p2, f2) {
  const n2 = "string" == typeof m4 ? I(m4) : m4, a = p2[0].spatialReference, u = p(p2[0]), l = { ...f2, query: { ...n2.query, f: "json", sr: d(a), geometries: JSON.stringify(r2(p2)) } }, { data: y3 } = await U(n2.path + "/simplify", l);
...
function M(t, n2) {
  ...
  return g(t) ? new j({ rings: l, spatialReference: t.spatialReference }) : new m({ paths: l, spatialReference: t.spatialReference });
}
function w(t, e, n2) {
  if (e) {
    const e2 = M(t, 1e6);
...
async function R2(e, n2, r3) {
  ...
  const z = [], A = [];
  for (const t of e) if (null != t) if (g2 || (g2 = t.spatialReference, y3 = s3(g2), x2 = g2.isWebMercator, v2 = x2 ? 102100 : 4326, d4 = r[v2].maxX, M2 = r[v2].minX, P2 = r[v2].plus180Line, L2 = r[v2].minus180Line), y3) if ("mesh" === t.type) A.push(t);
...
function v(t) {
  ...
  if (!n2) return e;
  const [o3, s5] = n2.valid, r3 = 2 * s5, { width: i3 } = e;
...
//# sourceMappingURL=chunk-P3MZKJDB.js.map
