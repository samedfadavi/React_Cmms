...
function w(t, r, n3) {
  ...
  return { type: String, read: (t2, r2, e) => {
    ...
    const l = x2(r2), m2 = m(l, { ...u, verifyItemRelativeUrls: (u == null ? void 0 : u.verifyItemRelativeUrls) ? { writtenUrls: u.verifyItemRelativeUrls.writtenUrls, rootPath: void 0 } : void 0 }, y.NO), d2 = i2.type !== String && (!i(this) || (u == null ? void 0 : u.origin) && this.originIdOf(n3) > n(u.origin)), h = { object: this, propertyName: n3, value: r2, targetUrl: m2, dest: p2, targetPropertyName: c, context: u, params: t };
    (u == null ? void 0 : u.portalItem) && m2 && !Y(m2) ? d2 && (t == null ? void 0 : t.contentAddressed) ? I(h) : d2 ? N(h) : P2(h) : (u == null ? void 0 : u.portalItem) && (null == m2 || null != U(m2) || Z(m2) || d2) ? I(h) : p2[c] = m2;
  } } };
}
function I(e) {
  var _a;
  const { targetUrl: o2, params: p2, value: u, context: a, dest: l, targetPropertyName: d2 } = e;
  if (!a.portalItem) return;
  const f2 = g(o2), y2 = S(u, o2, a);
  if ((p2 == null ? void 0 : p2.contentAddressed) && "json" !== y2.type) return void ((_a = a.messages) == null ? void 0 : _a.push(new s("persistable:contentAddressingUnsupported", `Property "${d2}" is trying to serializing a resource with content of type ${y2.type} with content addressing. Content addressing is only supported for json resources.`, { content: y2 })));
  const g2 = (p2 == null ? void 0 : p2.contentAddressed) && "json" === y2.type ? x(y2.jsonString) : (f2 == null ? void 0 : f2.filename) ?? n2(), v = V((p2 == null ? void 0 : p2.prefix) ?? (f2 == null ? void 0 : f2.prefix), g2), j2 = `${v}.${p(y2)}`;
  ...
  Z(o2) && a.resources && a.resources.pendingOperations.push(it(o2).then((t) => {
    U3.path = `${v}.${p({ type: "blob", blob: t })}`, l[d2] = U3.itemRelativeUrl;
  }).catch(() => {
  }));
  const w2 = (p2 == null ? void 0 : p2.compress) ?? false;
  a.resources && b({ ...e, resource: U3, content: y2, compress: w2, updates: a.resources.toAdd }), l[d2] = U3.itemRelativeUrl;
}
function N(t) {
  const { context: r, targetUrl: e, params: o2, value: s2, dest: n3, targetPropertyName: i2 } = t;
  if (!r.portalItem) return;
  const c = r.portalItem.resourceFromPath(e), u = S(s2, e, r), a = p(u), l = Ht(c.path), d2 = (o2 == null ? void 0 : o2.compress) ?? false;
...
//# sourceMappingURL=chunk-W45JEAP5.js.map
