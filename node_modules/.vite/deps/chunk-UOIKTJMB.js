...
var m = class {
  ...
  _add(e) {
    ...
    let i2;
    if (this._markedIds.add(r), o4 ? (e.displayId = o4.displayId, i2 = this._boundsStore.get(r), this._boundsStore.delete(r)) : null != this.onFeatureAdd && this.onFeatureAdd(e), !((_b = (_a = e.geometry) == null ? void 0 : _a.coords) == null ? void 0 : _b.length)) return this._boundsStore.set(r, null), void this._featuresById.set(r, e);
...
//# sourceMappingURL=chunk-UOIKTJMB.js.map
