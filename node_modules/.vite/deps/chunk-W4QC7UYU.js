...
var i2 = class _i {
  ...
  decode(n15, s8, r13) {
    ...
    return new Promise((t8, d4) => {
      let g6 = null;
      "jpg" === o11 && l7 && (g6 = _i._getMask(n15, { width: c7, height: h7 }));
      const w5 = new Blob([new Uint8Array(n15)], { type: "image/" + o11 == "jpg" ? "jpeg" : o11 }), v5 = URL.createObjectURL(w5), m6 = new Image();
      let _3;
      m6.src = v5, m6.onload = () => {
        ...
        t8({ width: c7, height: h7, pixels: [l8, w6, p5], mask: g6, pixelType: "u8" });
      }, m6.onerror = () => {
...
n5 = a5, r3 = function() {
  ...
  return function() {
    ...
    function u12(e8, n16) {
      ...
      for (r14 = 0; r14 < i9; r14++) {
        for (o12 = 0; o12 < e8[r14]; o12++) {
          ...
          for (c8.index++, t9.push(c8); t9.length <= r14; ) t9.push(s9 = { children: [], index: 0 }), c8.children[c8.index] = s9.children, c8 = s9;
          a14++;
        }
        r14 + 1 < i9 && (t9.push(s9 = { children: [], index: 0 }), c8.children[c8.index] = s9.children, c8 = s9);
      }
    ...
    function p5(e8, n16, r14) {
      ...
      return { invalid: i9.toString(16), marker: s9, offset: t9 };
    }
    return l7.prototype = { parse: function(r14) {
      function o12() {
      ...
      for (k4 = o12(); 65497 !== k4; ) {
        ...
        switch (k4) {
          ...
          case 65534:
            var x4 = a14();
            65504 === k4 && 74 === x4[0] && 70 === x4[1] && 73 === x4[2] && 70 === x4[3] && 0 === x4[4] && (f10 = { version: { major: x4[5], minor: x4[6] }, densityUnits: x4[7], xDensity: x4[8] << 8 | x4[9], yDensity: x4[10] << 8 | x4[11], thumbWidth: x4[12], thumbHeight: x4[13], thumbData: x4.subarray(14, 14 + 3 * x4[12] * x4[13]) }), 65518 === k4 && 65 === x4[0] && 100 === x4[1] && 111 === x4[2] && 98 === x4[3] && 101 === x4[4] && (l8 = { version: x4[5] << 8 | x4[6], flags0: x4[7] << 8 | x4[8], flags1: x4[9] << 8 | x4[10], transformCode: x4[11] });
            break;
          case 65499:
          ...
          case 65474:
            ...
            for (g6 = 0; g6 < L3; g6++) {
              ...
              var I4 = r14[c8 + 2];
              w5 = i9.components.push({ h: U4, v: z2, quantizationId: I4, quantizationTable: null }), i9.componentIds[P3] = w5 - 1, c8 += 3;
            }
...
var r4 = class {
  static decode(r13, n15 = false) {
    ...
    o11.parse(s8);
    const { width: a13, height: i8, numComponents: f9, eof: h7 } = o11, l7 = o11.getData(a13, i8, true), c7 = a13 * i8;
    ...
    return { width: a13, height: i8, pixels: u12, mask: g6 };
  }
};
...
var n6 = null;
function r5() {
  return n6 || (n6 = import("./lerc-wasm-COEUKCMF.js").then((e7) => e7.l).then(({ default: t8 }) => t8({ locateFile: (t9) => n4(`esri/layers/support/rasterFormats/${t9}`) })).then((e7) => {
    l3(e7);
  }), n6);
}
...
function l3(e7) {
  const { _malloc: n15, _free: r13, _lerc_getBlobInfo: l7, _lerc_getDataRanges: i8, _lerc_decode_4D: u12, asm: f9 } = e7;
  let c7;
  ...
  a6.getBlobInfo = (e8) => {
    ...
    const d4 = new Uint32Array(a13.buffer), b4 = new Float64Array(o11.buffer), [w5, A5, , m6, U4, x4, C5, V3, T3, D4, z2] = d4, F2 = { version: w5, depthCount: D4, width: m6, height: U4, validPixelCount: C5, bandCount: x4, blobSize: V3, maskCount: T3, dataType: A5, minValue: b4[0], maxValue: b4[1], maxZerror: b4[2], statistics: [], bandCountWithNoData: z2 };
    if (z2 && D4 > 1) return r13(u13), F2;
    if (1 === D4 && 1 === x4) return r13(u13), F2.statistics.push({ minValue: b4[0], maxValue: b4[1] }), F2;
    ...
    for (let r14 = 0; r14 < x4; r14++) if (D4 > 1) {
      ...
      j3.push({ minValue: n17, maxValue: a14, depthStats: { minValues: e9, maxValues: t9 } });
    } else j3.push({ minValue: O4[r14], maxValue: $[r14] });
    return r13(B3), E3 || r13(S4), F2;
  }, a6.decode = (e8, n16) => {
    const { maskCount: a13, depthCount: o11, bandCount: l8, width: i9, height: f10, dataType: p5, bandCountWithNoData: g6 } = n16, d4 = t2[p5], b4 = i9 * f10, w5 = new Uint8Array(b4 * l8), A5 = b4 * o11 * l8 * d4.size, m6 = new Uint8Array(A5), U4 = new Uint8Array(l8), x4 = new Uint8Array(8 * l8), [C5, V3, T3, D4, z2] = y6([e8.length, w5.length, m6.length, U4.length, x4.length]);
    ...
    return r13(C5), { data: m6, maskData: w5, noDataValues: I4 };
  };
}
...
function u4(e7, n15 = {}) {
  const r13 = n15.inputOffset ?? 0, o11 = e7 instanceof Uint8Array ? e7.subarray(r13) : new Uint8Array(e7, r13), s8 = a6.getBlobInfo(o11), { data: l7, maskData: u12, noDataValues: f9 } = a6.decode(o11, s8), { width: c7, height: h7, bandCount: y6, depthCount: p5, dataType: g6, maskCount: d4, statistics: b4 } = s8, w5 = t2[g6], A5 = new w5.ctor(l7.buffer), m6 = [], U4 = [], x4 = c7 * h7, C5 = x4 * p5;
  ...
  const { noDataValue: T3 } = n15, D4 = null != T3 && w5.range[0] <= T3 && w5.range[1] >= T3;
  if (d4 > 0 && D4) for (let t8 = 0; t8 < y6; t8++) {
    const e8 = m6[t8], n16 = U4[t8] || V3;
    for (let t9 = 0; t9 < x4; t9++) 0 === n16[t9] && (e8[t9] = T3);
  }
  const z2 = d4 === y6 && y6 > 1 ? U4 : null, { pixelType: F2 } = w5;
  return { width: c7, height: h7, bandCount: y6, pixelType: F2, depthCount: p5, statistics: b4, pixels: m6, mask: V3, bandMasks: z2, noDataValues: f9 };
}
...
var a7 = class {
  static decode(a13, n15) {
    const s8 = n15.pixelType, l7 = [], i8 = n15.width * n15.height, h7 = e4(a13, n15), { bandIds: c7, format: y6 } = n15, o11 = (c7 == null ? void 0 : c7.length) || e4(a13, n15), b4 = a13.byteLength - a13.byteLength % (i8 * t4(s8)), f9 = new s8(a13, 0, i8 * h7);
    ...
    return b4 < a13.byteLength - 1 && (d4 = r7(a13.slice(b4), i8)), { pixels: l7, mask: d4 };
  }
};
...
var n8 = { tiffTags: e5, ifdTags: E, geoKeys: o6, getTagName: S };
...
function d(e7, t8, n15, a13 = 0, i8 = n8.tiffTags, s8 = 4) {
  ...
  if (n15 + c7 > e7.byteLength) return { success: false, ifd: null, nextIFD: null, requiredBufferSize: c7 };
  ...
  for (let S4 = 0; S4 < o11; S4++) {
    ...
    const n16 = [];
    2 === s8 ? (m6 = I4.getUint16(4, t8), y6 = I4.getUint16(6, t8)) : 4 === s8 ? (m6 = I4.getUint32(4, t8), y6 = I4.getUint32(8, t8)) : 8 === s8 && (m6 = v(I4, 4, t8, true), y6 = v(I4, 12, t8, true), n16.push(I4.getUint32(12, t8)), n16.push(I4.getUint32(16, t8))), T3 = { id: w5, type: d4, valueCount: m6, valueOffset: y6, valueOffsets: n16, values: null }, L(e7, t8, T3, a13, false, s8), E3.set(p5, T3);
  }
  return { success: true, ifd: E3, nextIFD: h7, requiredBufferSize: c7 };
}
var m = (e7, t8) => u4(e7, { inputOffset: t8 }).pixels[0];
function y3(e7, t8) {
...
async function M(e7, t8, a13, s8, r13) {
  ...
  let d4, M3, P3;
  if (34887 === I4) return await r5(), m(e7, s8);
...
async function P(e7, t8, n15) {
  const a13 = I(n15, "TILEOFFSETS");
  if (void 0 === a13) return null;
  const i8 = I(n15, "TILEBYTECOUNTS"), { width: s8, height: r13, pixelType: l7, tileWidth: o11, tileHeight: f9 } = R([n15]), u12 = D(n15, t8), c7 = p(n15, "SAMPLESPERPIXEL") || t8.planes, h7 = s8 * r13, E3 = p(n15, "BITSPERSAMPLE"), T3 = 34887 === (p(n15, "COMPRESSION") ?? 1), w5 = g2(l7), d4 = [];
  ...
  if (E3 % 8 == 0) if (T3 && u12 && c7 > 1) {
    ...
    for (m6 = 0; m6 < l8; m6++) {
      ...
      for (let l9 = 0; l9 < c7; l9++) {
        const u13 = m6 * c7 + l9;
        for (0 === i8[u13] ? (S4 = null, F2 = true) : S4 = await M(e7, t8.littleEndian, n15, a13[u13], i8[u13]), U4 = 0, L3 = x4, k4 = Math.min(o11, s8 - b4), N2 = Math.min(f9, r13 - O4), C5 = d4[l9], A5 = 0; A5 < N2; A5++) for (L3 = x4 + A5 * s8, U4 = A5 * o11, P3 = 0; P3 < k4; P3++, L3++, U4++) S4 ? C5[L3] = S4[U4] : v5[L3] = 0;
      }
    }
  } else for (m6 = 0; m6 < a13.length; m6++) for (O4 = Math.floor(m6 / G3) * f9, b4 = m6 % G3 * o11, x4 = O4 * s8 + b4, 0 === i8[m6] ? (S4 = null, F2 = true) : S4 = await M(e7, t8.littleEndian, n15, a13[m6], i8[m6]), U4 = 0, L3 = x4, k4 = Math.min(o11, s8 - b4), N2 = Math.min(f9, r13 - O4), y6 = 0; y6 < c7; y6++) if (C5 = d4[y6], u12 || T3) for (A5 = 0; A5 < N2; A5++) for (L3 = x4 + A5 * s8, U4 = o11 * f9 * y6 + A5 * o11, P3 = 0; P3 < k4; P3++, L3++, U4++) S4 ? C5[L3] = S4[U4] : v5[L3] = 0;
  else for (A5 = 0; A5 < N2; A5++) for (L3 = x4 + A5 * s8, U4 = A5 * o11 * c7 + y6, P3 = 0; P3 < k4; P3++, L3++, U4 += c7) S4 ? C5[L3] = S4[U4] : v5[L3] = 0;
  return { width: s8, height: r13, pixelType: l7, pixels: d4, mask: F2 ? v5 : void 0 };
}
var O = (e7, t8, n15) => {
  const a13 = r9 === t8.littleEndian, s8 = I(n15, "STRIPOFFSETS");
  if (void 0 === s8) return null;
  const { width: r13, height: o11, pixelType: f9 } = R([n15]), u12 = p(n15, "SAMPLESPERPIXEL") || t8.planes, c7 = p(n15, "PHOTOMETRICINTERPRETATION"), h7 = r13 * o11, E3 = p(n15, "BITSPERSAMPLE"), T3 = g2(f9), w5 = new T3(h7 * u12), d4 = I(n15, "STRIPBYTECOUNTS"), m6 = p(n15, "ROWSPERSTRIP"), M3 = p(n15, "COMPRESSION") ?? 1;
  ...
  return { width: r13, height: o11, pixelType: f9, pixels: C5 };
};
var b = (e7, t8, n15) => {
...
var x = (e7) => {
  ...
  if (o11 && f9) {
    h7 = [];
    for (let e8 = 0; e8 < o11.length; e8++) h7.push({ min: parseFloat(o11[e8]), max: parseFloat(f9[e8]), avg: u12 && parseFloat(u12[e8]), stddev: c7 && parseFloat(c7[e8]) });
  }
  const g6 = n15.get("BandName"), E3 = n15.get("WavelengthMin"), T3 = n15.get("WavelengthMax");
  let I4 = null;
  if (g6) {
    I4 = [];
    for (let e8 = 0; e8 < g6.length; e8++) I4.push({ BandName: g6[e8], WavelengthMin: E3 && parseFloat(E3[e8]), WavelengthMax: T3 && parseFloat(T3[e8]) });
  }
...
function L(e7, t8, n15, a13 = 0, i8 = false, s8 = 4) {
  ...
  if (T3 <= p5) {
    if (!t8) if (p5 <= 32) o11 >>>= 32 - T3;
      ...
      const e8 = (d4 == null ? void 0 : d4.length) ? d4[0] : o11 >>> 0, t9 = (d4 == null ? void 0 : d4.length) ? d4[1] : Math.round((o11 - e8) / u5);
...
function R(e7) {
  ...
  let d4 = null;
  (g6 == null ? void 0 : g6.length) && (d4 = g6.map((e8) => parseFloat(e8)), d4.some((e8) => isNaN(e8)) && (d4 = null));
  ...
  if (R3) {
    ...
    if (2 === e8) {
      ...
      e9 >= 1024 && e9 <= 32766 && (P3 = { wkid: e9 }), P3 || 32767 !== e9 || (v5 = true, P3 = { wkid: 4326 });
    } else if (1 === e8) {
  ...
  if (b4 && O4 && O4.length >= 6 ? (k4 = [b4[0], 0, O4[3] - O4[0] * b4[0], 0, -Math.abs(b4[1]), O4[4] - O4[1] * b4[1]], G3 && (k4[2] -= 0.5 * k4[0] + 0.5 * k4[1], k4[5] -= 0.5 * k4[3] + 0.5 * k4[4])) : L3 && 16 === L3.length && (k4 = G3 ? [L3[0], L3[1], L3[3] - 0.5 * L3[0], L3[4], L3[5], L3[7] - 0.5 * L3[5]] : [L3[0], L3[1], L3[3], L3[4], L3[5], L3[7]]), k4) {
    const e8 = [{ x: 0, y: s8 }, { x: 0, y: 0 }, { x: i8, y: s8 }, { x: i8, y: 0 }];
    ...
    C5 = { xmin: n16, xmax: r14, ymin: a14, ymax: l8, spatialReference: P3 };
  } else C5 = { xmin: -0.5, ymin: 0.5 - s8, xmax: i8 - 0.5, ymax: 0.5, spatialReference: P3 };
  ...
  B3 = null != Y2 && Y2 > 0 ? B3 || n15 : null, W2 = null != Y2 && Y2 > 0 ? W2 || a13 : null, n15 && (_3 = [{ maxCol: Math.ceil(i8 / n15) - 1, maxRow: Math.ceil(s8 / a13) - 1, minRow: 0, minCol: 0 }], F2.forEach((e8) => {
    _3.push({ maxCol: Math.ceil(p(e8, "IMAGEWIDTH") / p(e8, "TILEWIDTH")) - 1, maxRow: Math.ceil(p(e8, "IMAGELENGTH") / p(e8, "TILELENGTH")) - 1, minRow: 0, minCol: 0 });
  }));
  const j3 = w2(e7[0], "GDAL_METADATA"), K = x(j3);
  A5 += " " + V({ width: i8, height: s8, tileWidth: n15, tileHeight: a13, planes: l7, ifds: e7 });
  const X = N(e7).length === F2.length + 1, J = (F2 == null ? void 0 : F2.length) ? F2.map((e8) => ({ x: i8 / p(e8, "IMAGEWIDTH"), y: s8 / p(e8, "IMAGELENGTH") })) : void 0;
  return { width: i8, height: s8, tileWidth: n15, tileHeight: a13, planes: l7, isBSQ: u12, pixelType: f9, compression: y6, noData: d4, hasMaskBand: X, isSupported: S4, pyramidResolutions: J, message: A5, extent: C5, isPseudoGeographic: v5, affine: b4 ? null : k4, firstPyramidLevel: H2, maximumPyramidLevel: Y2, pyramidBlockWidth: B3, pyramidBlockHeight: W2, tileBoundary: _3, metadata: K };
}
function D(e7, t8) {
...
function k(e7) {
  const { littleEndian: t8, isBigTiff: n15, firstIFDPos: a13 } = F(e7);
  let i8 = a13;
  const s8 = [];
  do {
  ...
  return { ...R(s8), littleEndian: t8, isBigTiff: n15, ifds: s8, pyramidIFDs: U(s8), maskIFDs: N(s8) };
}
...
function F(e7) {
  ...
  return { littleEndian: a13, isBigTiff: r13, firstIFDPos: v(t8, s8, a13, r13) };
}
  ...
  if (u12) {
    if (n8.ifdTags.forEach((e7, a14) => {
      ...
      if (e7 && e7.length > 4) {
        ...
        f9.data = d(t8, n15, f9.valueOffset + 6 - i8, i8, n8.geoKeys, 2).ifd, f9.data && f9.data.set("GEOTIFFVersion", { id: 0, type: 2, valueCount: 1, valueOffset: null, values: [a14] });
      }
    }
    if (u12.has("XMP")) {
      f9 = u12.get("XMP");
...
function V(e7) {
  const { width: t8, height: n15, tileHeight: a13, tileWidth: i8 } = e7, s8 = e7.planes, r13 = i8 ? i8 * a13 : t8 * n15, l7 = p(e7.ifds[0], "BITSPERSAMPLE");
  let o11 = "";
...
async function H(e7, t8) {
  const { headerInfo: n15, ifd: a13, offsets: i8, sizes: r13 } = t8, l7 = [];
  for (let s8 = 0; s8 < i8.length; s8++) {
    r13[s8];
    const t9 = await M(e7, n15.littleEndian, a13, i8[s8], r13[s8] || e7.byteLength);
    l7.push(t9);
  }
  ...
  const P3 = n15.noData ? n15.noData[0] : t8.noDataValue, O4 = n15.metadata ? n15.metadata.statistics : null, x4 = O4 ? O4.map((e8) => e8.min) : null, L3 = O4 ? O4.map((e8) => e8.max) : null, R3 = { pixelType: u12, width: T3, height: I4, pixels: y6, noDataValue: P3 };
  return null != P3 ? l2(R3, P3) : x4 && L3 && t8.applyMinMaxConstraint && (R3.mask = b(y6, x4, L3)), R3;
}
async function Y(e7, t8 = {}) {
  const n15 = t8.pyramidLevel || 0, a13 = t8.headerInfo || k(e7), { ifds: i8, noData: r13 } = a13;
  if (0 === i8.length) throw new Error("no valid image file directory");
  const l7 = V(a13);
  if (l7) throw l7;
  let o11 = null;
  const f9 = -1 === n15 ? i8[i8.length - 1] : i8[n15], u12 = r13 ?? t8.noDataValue;
  return o11 = a13.tileWidth ? await P(e7, a13, f9) : O(e7, a13, f9), o11 ? (null != u12 && l2(o11, u12), o11) : o11;
}
    ...
    for (this.data = t9, this.pos = 8, this.palette = [], this.imgData = [], this.transparency = {}, this.animation = null, this.text = {}, r14 = null; ; ) {
      switch (e8 = this.readUInt32(), h7 = (function() {
        ...
        case "PLTE":
          ...
          break;
        case "fcTL":
          r14 && this.animation.frames.push(r14), this.pos += 4, r14 = { width: this.readUInt32(), height: this.readUInt32(), xOffset: this.readUInt32(), yOffset: this.readUInt32() }, s9 = this.readUInt16(), i9 = this.readUInt16() || 100, r14.delay = 1e3 * s9 / i9, r14.disposeOp = this.data[this.pos++], r14.blendOp = this.data[this.pos++], r14.data = [];
          break;
        case "IDAT":
        case "fdAT":
...
async function w3(e7, s8) {
  if (!r9) throw new s("rasterCoded:decode", "lerc decoder is not supported on big endian platform");
  await r5();
  const { offset: r13 } = s8, { width: h7, height: c7, pixelType: l7, statistics: p5, depthCount: d4, noDataValues: u12, bandMasks: m6, pixels: g6, mask: w5 } = u4(e7, { inputOffset: r13, returnInterleaved: s8.returnInterleaved }), y6 = new g({ width: h7, height: c7, pixelType: l7.toLowerCase(), pixels: g6, mask: w5, statistics: p5.map(({ minValue: t8, maxValue: e8 }) => new l(t8, e8)), bandMasks: m6, depthCount: d4, noDataValues: u12 });
  return (p5 == null ? void 0 : p5.length) || y6.updateStatistics(), y6;
}
async function y4(t8, i8) {
  const s8 = await Y(t8, { ...i8, noDataValue: null });
  n2(s8);
  const r13 = new g({ width: s8.width, height: s8.height, pixels: s8.pixels, pixelType: s8.pixelType.toLowerCase(), mask: s8.mask, bandMasks: s8.bandMasks, statistics: null });
  return r13.updateStatistics(), r13;
}
async function x2(t8, e7) {
  const i8 = await H(t8, e7.customOptions), s8 = new g({ width: i8.width, height: i8.height, pixels: i8.pixels, pixelType: i8.pixelType.toLowerCase(), mask: i8.mask, statistics: null });
...
function b2(t8, e7) {
  ...
  const h7 = new g({ width: e7.width || 1, height: e7.height || t8.length, pixels: n15, pixelType: i8, statistics: null });
...
function I2(t8, e7, i8) {
  const { pixelTypeCtor: s8 } = S3(e7.pixelType), r13 = (0, a7.decode)(t8, { width: e7.width, height: e7.height, pixelType: s8, format: i8 }), n15 = new g({ width: e7.width, height: e7.height, pixels: r13.pixels, pixelType: e7.pixelType, mask: r13.mask, statistics: null });
  return n15.updateStatistics(), n15;
}
function C2(t8, e7) {
  const i8 = r4.decode(t8, e7.hasNoZlibMask ?? void 0), s8 = new g({ width: i8.width, height: i8.height, pixels: i8.pixels, pixelType: "u8", mask: i8.mask, statistics: null });
  return s8.updateStatistics(), s8;
}
function v2(t8, e7) {
  const i8 = new Uint8Array(t8), s8 = new m2(i8), { width: r13, height: n15 } = e7, o11 = r13 * n15, h7 = s8.decode();
  let c7, l7 = 0, p5 = 0;
  const d4 = new Uint8Array(o11);
  for (l7 = 0; l7 < o11; l7++) d4[l7] = h7[4 * l7 + 3];
  const u12 = new g({ width: r13, height: n15, pixels: [], pixelType: "u8", mask: d4, statistics: [] });
  for (l7 = 0; l7 < 3; l7++) {
...
async function A3(t8, e7, i8, r13) {
  const n15 = new i2(), o11 = { applyJpegMask: false, format: e7, ...i8 }, h7 = await n15.decode(t8, o11, r13), c7 = new g(h7);
...
function O2(t8, e7 = 1) {
  if (!t8) return;
  const { pixels: i8, width: s8, height: r13, mask: n15 } = t8;
...
async function j2(e7, i8 = {}, s8) {
  var _a;
  if (null == e7) throw new s("rasterCodec:decode", "missing encodeddata parameter.");
  let r13 = (_a = i8.format) == null ? void 0 : _a.toLowerCase();
  ...
  const { offsets: h7 } = i8;
  if (h7 && h7.length > 1) {
    const t8 = h7.map((t9, a13) => n15(e7.slice(t9, h7[a13 + 1]), i8)), s9 = await Promise.all(t8);
  ...
  } else o11 = await n15(e7, { ...i8, offset: (h7 == null ? void 0 : h7[0]) ?? i8.offset });
  return "jpg" !== r13 && null != i8.noDataValue && 1 === o11.depthCount && l2(o11, i8.noDataValue, { customFloatTolerance: i8.tolerance }), i8.isPoint && O2(o11), o11;
}
...
function r10(t8, n15 = 256) {
  ...
  const { size: e7, counts: s8 } = t8, i8 = new Uint8Array(e7), o11 = s8.reduce((t9, e8) => t9 + e8 / n15, 0);
...
function a9(t8) {
  const { minCutOff: n15, maxCutOff: e7, gamma: s8, pixelType: i8, rounding: o11 } = t8, r13 = t8.outMin || 0, a13 = t8.outMax || 255;
  ...
  if (s8 && s8.length >= f9) {
    ...
    for (u12 = 0; u12 < f9; u12++) {
      for (v5 = [], c7 = 0; c7 < h7; c7++) if (0 !== p5[u12]) if (b4 = c7 + m6, M3 = (b4 - n15[u12]) / p5[u12], k4 = 1, s8[u12] > 1 && (k4 -= (1 / d4) ** (M3 * t9[u12])), b4 < e7[u12] && b4 > n15[u12]) {
...
function f6(t8, n15, e7) {
  ...
  for (let i8 = 0; i8 < n15.length; i8++) {
    ...
    "min" in n15[i8] ? { min: r13, max: a13, avg: l7 } = n15[i8] : [r13, a13, l7] = n15[i8];
    let f9 = l7 ?? 0;
...
function c3(t8, n15, e7, s8) {
  ...
  if (0 === a13) return { statistics: { min: 0, max: 0, avg: 0, stddev: 0, mode: 0, median: 0 }, histogram: null };
  const h7 = r13 / a13;
  let g6 = 0;
  ...
  const x4 = a13 >>> 1, M3 = { min: i8, max: o11, avg: h7, stddev: d4, mode: l7, median: a13 % 2 ? m6[Math.floor(x4)] : (m6[x4 - 1] + m6[x4]) / 2 };
  if (["u8", "s8", "u4", "u2", "u1"].includes(e7)) {
    const e8 = o11 - i8 + 1, s9 = new Uint32Array(e8);
    for (let o12 = 0; o12 < u12; o12++) n15 && !n15[o12] || s9[t8[o12] - i8]++;
    return { statistics: M3, histogram: { min: i8 - 0.5, max: o11 + 0.5, size: e8, counts: s9 } };
  }
  const y6 = 256, b4 = new Uint32Array(y6), k4 = (o11 - i8) / y6;
  if (0 === k4) return { statistics: M3, histogram: { min: i8, max: o11, size: 1, counts: new Uint32Array(1).fill(a13) } };
  ...
  return b4[y6 - 1] = v5[y6 - 1] + v5[y6], { statistics: M3, histogram: { min: i8, max: o11, size: y6, counts: b4 } };
}
function m3(t8) {
  const { pixels: n15, mask: e7, pixelType: s8, bandMasks: i8 } = t8, o11 = n15.map((t9, n16) => c3(t9, (i8 == null ? void 0 : i8[n16]) ?? e7, s8));
  return { statistics: o11.map(({ statistics: t9 }) => t9), histograms: o11.map(({ histogram: t9 }) => t9) };
}
function h3(t8) {
  var _a;
  if (!((_a = t8 == null ? void 0 : t8.pixels) == null ? void 0 : _a.length)) return null;
  const { pixels: n15, mask: e7, bandMasks: s8, pixelType: i8 } = t8, o11 = t8.width * t8.height, r13 = n15.length, a13 = [], l7 = [], f9 = 256;
  let u12, c7, m6, h7;
  for (let g6 = 0; g6 < r13; g6++) {
    m6 = new Uint32Array(f9);
    const r14 = n15[g6], p5 = (s8 == null ? void 0 : s8[g6]) ?? e7;
    if ("u8" === i8) {
      if (u12 = 255, c7 = 0, p5) {
    ...
    a13.push({ min: d4, max: x4, size: m6.length, counts: m6 });
    let M3 = 0, y6 = 0, b4 = 0;
    ...
    l7.push({ min: u12, max: c7, avg: z2, stddev: C5 });
  }
  return { statistics: l7, histograms: a13 };
}
function g4(t8) {
  const n15 = [];
  for (let e7 = 0; e7 < t8.length; e7++) {
    const { min: s8, max: i8, size: o11, counts: r13 } = t8[e7];
    let a13 = 0, l7 = 0;
    ...
    n15.push({ min: s8, max: i8, avg: m6, stddev: h7 });
  }
  return n15;
}
function p2(n15, i8) {
  var _a;
  const { pixelBlock: o11, bandIds: a13, returnHistogramLut: l7, rasterInfo: f9 } = i8;
  let u12 = null, c7 = null, m6 = n15.stretchType;
  if ("number" == typeof m6 && (m6 = a8[m6]), n15.dra) if ("minMax" === m6 && (o11 == null ? void 0 : o11.statistics)) u12 = o11.statistics.map((t8) => [t8.minValue, t8.maxValue, 0, 0]);
  else {
    const t8 = h3(o11);
    u12 = null != t8 ? t8.statistics : null, c7 = null != t8 ? t8.histograms : null;
  }
  else u12 = ((_a = n15.statistics) == null ? void 0 : _a.length) ? n15.statistics : f9.statistics, c7 = "histograms" in n15 ? n15.histograms : void 0, c7 || (c7 = f9.histograms);
  "percentClip" !== m6 && "histogramEqualization" !== m6 || (c7 == null ? void 0 : c7.length) || (m6 = "minMax");
  const g6 = (u12 == null ? void 0 : u12.length) || (c7 == null ? void 0 : c7.length) || f9.bandCount, p5 = [], x4 = [];
  ...
  return d2({ minCutOff: p5, maxCutOff: x4, outMax: q, outMin: T3, histogramLut: P3 }, a13);
}
function d2(t8, n15) {
  if (null == n15 || 0 === n15.length) return t8;
  const e7 = Math.max.apply(null, n15), { minCutOff: s8, maxCutOff: i8, outMin: o11, outMax: r13, histogramLut: a13 } = t8;
  return s8.length === n15.length || s8.length <= e7 ? t8 : { minCutOff: n15.map((t9) => s8[t9]), maxCutOff: n15.map((t9) => i8[t9]), histogramLut: a13 ? n15.map((t9) => a13[t9]) : null, outMin: o11, outMax: r13 };
}
function x3(t8, n15) {
...
function M2(t8, e7) {
  var _a;
  if (!((_a = t8 == null ? void 0 : t8.pixels) == null ? void 0 : _a.length)) return t8;
  const { mask: s8, bandMasks: i8, width: o11, height: r13, pixels: a13 } = t8, { minCutOff: l7, maxCutOff: f9, gamma: u12 } = e7, c7 = e7.outMin || 0, m6 = e7.outMax || 255, h7 = o11 * r13, g6 = e7.outputPixelType || "u8", p5 = t8.pixels.map(() => g.createEmptyBand(g6, h7)), d4 = p5.length, M3 = m6 - c7, y6 = [], b4 = [];
  ...
  if (v5) {
    ...
    for (let n15 = 0; n15 < d4; n15++) {
      const e8 = (i8 == null ? void 0 : i8[n15]) ?? s8;
    ...
    const t9 = (i8 == null ? void 0 : i8[n15]) ?? s8;
  ...
  const z2 = new g({ width: o11, height: r13, mask: s8, bandMasks: i8, pixels: p5, pixelType: g6 });
...
e([y({ json: { name: "BandName", write: true } })], o8.prototype, "name", void 0), e([y({ json: { name: "WavelengthMin", read: { reader: n10 }, write: true } })], o8.prototype, "minWavelength", void 0), e([y({ json: { name: "WavelengthMax", read: { reader: n10 }, write: true } })], o8.prototype, "maxWavelength", void 0), e([y({ json: { name: "RadianceBias", read: { reader: n10 }, write: true } })], o8.prototype, "radianceBias", void 0), e([y({ json: { name: "RadianceGain", read: { reader: n10 }, write: true } })], o8.prototype, "radianceGain", void 0), e([y({ json: { name: "ReflectanceBias", read: { reader: n10 }, write: true } })], o8.prototype, "reflectanceBias", void 0), e([y({ json: { name: "ReflectanceGain", read: { reader: n10 }, write: true } })], o8.prototype, "reflectanceGain", void 0), e([y({ json: { name: "SolarIrradiance", read: { reader: n10 }, write: true } })], o8.prototype, "solarIrradiance", void 0), o8 = t6 = e([a2("esri.layers.support.RasterBandInfo")], o8);
var s5 = o8;
...
e([y({ json: { name: "AcquisitionDate", write: true } })], u7.prototype, "acquisitionDate", void 0), e([o("acquisitionDate")], u7.prototype, "readAcquisitionDate", null), e([r("acquisitionDate")], u7.prototype, "writeAcquisitionDate", null), e([y({ json: { name: "CloudCover", read: { reader: a10 }, write: true } })], u7.prototype, "cloudCover", void 0), e([y({ json: { name: "ProductName", write: true } })], u7.prototype, "productName", void 0), e([y({ json: { name: "SensorName", write: true } })], u7.prototype, "sensorName", void 0), e([y({ json: { name: "SensorAzimuth", read: { reader: a10 }, write: true } })], u7.prototype, "sensorAzimuth", void 0), e([y({ json: { name: "SensorElevation", read: { reader: a10 }, write: true } })], u7.prototype, "sensorElevation", void 0), e([y({ json: { name: "SunAzimuth", read: { reader: a10 }, write: true } })], u7.prototype, "sunAzimuth", void 0), e([y({ json: { name: "SunElevation", read: { reader: a10 }, write: true } })], u7.prototype, "sunElevation", void 0), u7 = n11 = e([a2("esri.layers.support.RasterSensorInfo")], u7);
var c4 = u7;
...
e([y({ type: Number, json: { write: true } })], l5.prototype, "blockWidth", void 0), e([y({ type: Number, json: { write: true } })], l5.prototype, "blockHeight", void 0), e([y({ type: String, json: { write: true } })], l5.prototype, "compression", void 0), e([y({ type: _, json: { write: true } })], l5.prototype, "origin", void 0), e([y({ type: Number, json: { write: true } })], l5.prototype, "firstPyramidLevel", void 0), e([y({ type: Number, json: { write: true } })], l5.prototype, "maximumPyramidLevel", void 0), e([y({ json: { write: true } })], l5.prototype, "pyramidResolutions", void 0), e([y({ type: Number, json: { write: true } })], l5.prototype, "pyramidScalingFactor", void 0), e([y({ type: Number, json: { write: true } })], l5.prototype, "pyramidBlockWidth", void 0), e([y({ type: Number, json: { write: true } })], l5.prototype, "pyramidBlockHeight", void 0), e([y({ type: Boolean, json: { write: true } })], l5.prototype, "isVirtualTileInfo", void 0), e([y({ json: { write: true } })], l5.prototype, "tileInfo", void 0), e([y()], l5.prototype, "transposeInfo", void 0), e([y()], l5.prototype, "blockBoundary", void 0), l5 = p3 = e([a2("esri.layers.support.RasterStorageInfo")], l5);
var n12 = l5;
...
var u8 = h4 = class extends f {
  ...
  get bandInfos() {
    ...
    if (!(t8 == null ? void 0 : t8.length) || t8.length < e7) {
      const t9 = [];
      for (let o12 = 1; o12 <= e7; o12++) t9.push(new s5({ name: "band_" + o12 }));
      return t9;
    }
...
e([y({ json: { write: true } })], u8.prototype, "attributeTable", void 0), e([y({ json: { write: true } })], u8.prototype, "bandCount", void 0), e([y({ readOnly: true })], u8.prototype, "bandInfos", null), e([y({ json: { write: true } })], u8.prototype, "colormap", void 0), e([y({ type: String, readOnly: true })], u8.prototype, "dataType", null), e([y({ type: w, json: { write: true } })], u8.prototype, "extent", void 0), e([y({ type: w, json: { write: true } })], u8.prototype, "nativeExtent", null), e([y({ json: { write: true } })], u8.prototype, "nativePixelSize", null), e([y({ json: { write: true } })], u8.prototype, "format", void 0), e([y({ json: { write: true } })], u8.prototype, "height", void 0), e([y({ json: { write: true } })], u8.prototype, "width", void 0), e([y({ json: { write: true } })], u8.prototype, "hasMultidimensionalTranspose", null), e([y({ json: { write: true } })], u8.prototype, "histograms", void 0), e([y({ json: { write: true } })], u8.prototype, "keyProperties", void 0), e([y({ json: { write: true } })], u8.prototype, "multidimensionalInfo", void 0), e([y({ json: { write: true } })], u8.prototype, "noDataValue", void 0), e([y({ json: { write: true } })], u8.prototype, "pixelSize", void 0), e([y({ json: { write: true } })], u8.prototype, "pixelType", void 0), e([y()], u8.prototype, "isPseudoSpatialReference", void 0), e([y({ readOnly: true })], u8.prototype, "sensorInfo", null), e([y({ type: f2, json: { write: true } })], u8.prototype, "spatialReference", void 0), e([y({ json: { write: true } })], u8.prototype, "statistics", void 0), e([y({ type: n12, json: { write: true } })], u8.prototype, "storageInfo", void 0), e([y({ json: { write: true } })], u8.prototype, "transform", void 0), u8 = h4 = e([a2("esri.layers.support.RasterInfo")], u8);
var m4 = u8;
...
var n13 = 1 / 111e3;
function o9(t8) {
  let { altitude: e7, azimuth: i8 } = t8;
  const { hillshadeType: s8, pixelSizePower: o11 = 1, pixelSizeFactor: a13 = 1, scalingType: l7, isGCS: r13, resolution: c7 } = t8, h7 = "multi-directional" === s8 ? 2 * t8.zFactor : t8.zFactor, { x: u12, y: f9 } = c7;
  ...
  return { resolution: c7, factor: [d4, p5], sinZcosA: M3, sinZsinA: m6, cosZ: w5, sinZcosAs: Z, sinZsinAs: v5, cosZs: C5, weights: F2, hillshadeType: ["traditional", "multi-directional"].indexOf(s8) };
}
function a11(t8, e7) {
  const { width: i8, height: n15 } = t8, o11 = i8 * n15, a13 = new Uint8Array(o11), l7 = null != t8.mask;
  let r13;
  if (l7) {
  ...
  return { outMask: l7 ? a13 : null, dzxs: h7, dzys: u12, curvatures: f9 };
}
...
function r11(n15, r13) {
  ...
  const { factor: c7, sinZcosA: h7, sinZsinA: u12, cosZ: f9, sinZcosAs: d4, sinZsinAs: p5, cosZs: x4, weights: w5 } = o9(r13), [y6, M3] = c7, m6 = "traditional" === r13.hillshadeType, { width: A5, height: g6 } = n15, k4 = new Uint8Array(A5 * g6), { dzxs: z2, dzys: F2, outMask: P3 } = a11(n15);
  ...
  l6(k4, A5, g6);
  return new g({ width: A5, height: g6, pixels: [k4], mask: P3, pixelType: "u8", validPixelCount: n15.validPixelCount, statistics: [new l(0, 255)] });
}
function c5(t8, e7, s8, n15) {
  if (!o3(t8) || !o3(e7)) return;
  const { min: o11, max: a13 } = n15, l7 = t8.pixels[0], { pixels: r13, mask: c7 } = e7, h7 = r13[0], u12 = 255.00001 / (a13 - o11), f9 = new Uint8ClampedArray(h7.length), d4 = new Uint8ClampedArray(h7.length), p5 = new Uint8ClampedArray(h7.length), x4 = s8.length - 1;
...
function h5(e7, o11) {
  if (!o3(e7)) return e7;
  const r13 = o11.zFactor, c7 = o11.pixelSizePower ?? 1, h7 = o11.pixelSizeFactor ?? 1, u12 = o11.slopeType, f9 = o11.isGCS, { x: d4, y: p5 } = o11.resolution;
  let x4 = r13 / (8 * d4), w5 = r13 / (8 * p5);
  f9 && Math.abs(r13 - 1) < 1e-4 && (x4 /= n13, w5 /= n13), "adjusted" === u12 && (x4 = (r13 + d4 ** c7 * h7) / (8 * d4), w5 = (r13 + p5 ** c7 * h7) / (8 * p5));
  const { dzxs: y6, dzys: M3, outMask: m6 } = a11(e7), { width: A5, height: g6 } = e7, k4 = new Float32Array(A5 * g6);
  for (let t8 = s6; t8 < g6 - s6; t8++) {
    const e8 = t8 * A5;
    for (let t9 = s6; t9 < A5 - s6; t9++) {
      const i8 = e8 + t9;
  ...
  l6(k4, A5, g6);
  const z2 = new g({ width: A5, height: g6, pixels: [k4], mask: m6, pixelType: "f32", validPixelCount: e7.validPixelCount });
  return z2.updateStatistics(), z2;
}
function u9(n15, o11 = {}) {
  if (!o3(n15)) return n15;
  const { resolution: r13 } = o11, c7 = r13 ? 1 / r13.x : 1, h7 = r13 ? 1 / r13.y : 1, { dzxs: u12, dzys: f9, outMask: d4 } = a11(n15), { width: p5, height: x4 } = n15, w5 = new Float32Array(p5 * x4);
  ...
  l6(w5, p5, x4);
  return new g({ width: p5, height: x4, pixels: [w5], mask: d4, pixelType: "f32", validPixelCount: n15.validPixelCount, statistics: [new l(-1, 360)] });
}
function f7(e7, s8) {
  if (!o3(e7)) return e7;
  const { curvatures: n15, outMask: o11 } = a11(e7, s8), { width: r13, height: c7 } = e7;
  l6(n15, r13, c7);
  const h7 = new g({ width: r13, height: c7, pixels: [n15], mask: o11, pixelType: "f32", validPixelCount: e7.validPixelCount });
  return h7.updateStatistics(), h7;
}
...
function u10(o11) {
  ...
  if ("multipart" === o11.type) {
    const r13 = o11.clone();
    return ((_a = r13.colorRamps) == null ? void 0 : _a.length) ? (r13.colorRamps = r13.colorRamps.reverse().map((o12) => p4(o12)), r13) : r13;
  }
  return p4(o11);
}
function f8(r13, t8) {
...
function s7(o11, r13, t8 = false) {
  ...
  return null != e7 || t8 || (l7 = true, e7 = f8(o11 = u10(o11), r13)), e7 ? { id: e7, inverted: l7 } : void 0;
}
function d3(o11, r13 = false) {
  var _a;
  const t8 = "string" == typeof o11 ? o11 : (_a = s7(o11, void 0, r13)) == null ? void 0 : _a.id;
  return t8 ? a12.toJSON(t8) : null;
}
function c6(o11, r13 = "esriCIELabAlgorithm") {
  const t8 = m5.find(({ id: r14 }) => r14 === o11);
  return t8 ? t8.colorRamps ? { type: "multipart", colorRamps: t8.colorRamps.map((o12) => ({ type: "algorithmic", algorithm: r13, fromColor: [...o12.fromColor], toColor: [...o12.toColor] })) } : { type: "algorithmic", algorithm: r13, fromColor: [...t8.fromColor], toColor: [...t8.toColor] } : null;
}
function h6(o11) {
  ...
  return { ...o11, numColors: r13, distanceOffset: t8, interpolateAlpha: !!o11.interpolateAlpha, distanceInterval: e7, isCustomInterval: l7, weights: o11.weights };
}
function b3(o11, r13, t8) {
  const { numColors: l7, distanceOffset: e7, distanceInterval: i8, isCustomInterval: n15 } = t8, C5 = 0 === o11.s, m6 = 0 === r13.s;
  let a13 = o11.h, g6 = r13.h;
  C5 && !m6 ? a13 = g6 : m6 && !C5 && (r13 = { ...r13, h: a13 }, g6 = a13);
  ...
  let { s: c7, v: h7 } = o11, b4 = a13;
  if (e7) {
    const o12 = e7 / i8;
    b4 = (b4 + o12 * p5 + f9) % f9, c7 += o12 * s8, h7 += o12 * d4;
  }
  const v5 = [];
  for (let k4 = 0; k4 < l7 - 1; k4++) v5.push({ h: b4, s: c7, v: h7 }), b4 = (b4 + p5 + f9) % f9, c7 += s8, h7 += d4;
  return v5.push(n15 ? { h: b4, s: c7, v: h7 } : r13), v5;
}
function v3(o11, r13, t8) {
  const { numColors: l7, distanceOffset: e7, distanceInterval: i8, isCustomInterval: n15 } = t8;
  let { l: C5, a: m6, b: a13 } = o11;
  const g6 = (r13.l - C5) * i8, p5 = (r13.a - m6) * i8, u12 = (r13.b - a13) * i8, f9 = [];
  if (e7) {
    const o12 = e7 / i8;
    C5 += o12 * g6, m6 += o12 * p5, a13 += o12 * u12;
  }
  for (let s8 = 0; s8 < l7 - 1; s8++) f9.push({ l: C5, a: m6, b: a13 }), C5 += g6, m6 += p5, a13 += u12;
  return f9.push(n15 ? { l: C5, a: m6, b: a13 } : r13), f9;
}
function k3(o11, r13, t8) {
  const { numColors: l7, distanceOffset: e7, distanceInterval: i8, isCustomInterval: n15 } = t8, C5 = o11.h, m6 = r13.h, a13 = 2 * Math.PI;
  let g6;
  if (C5 <= m6) {
  ...
  let { l: s8, c: d4, h: c7 } = o11;
  if (e7) {
    const o12 = e7 / i8;
    s8 += o12 * u12, d4 += o12 * f9, c7 = (c7 + o12 * p5 + a13) % a13;
  }
  const h7 = [];
  for (let b4 = 0; b4 < l7 - 1; b4++) h7.push({ l: s8, c: d4, h: c7 }), s8 += u12, d4 += f9, c7 = (c7 + p5 + a13) % a13;
  return h7.push(n15 ? { l: s8, c: d4, h: c7 } : r13), h7;
}
function y5(o11, i8) {
  let { fromColor: n15, toColor: C5 } = o11;
  n15 = [...n15], C5 = [...C5], 3 === n15.length && (n15 = n15.concat([255])), 3 === C5.length && (C5 = C5.concat([255]));
  const m6 = o11.algorithm || "esriCIELabAlgorithm", a13 = h6(i8), { numColors: g6, distanceOffset: p5, isCustomInterval: u12, interpolateAlpha: f9 } = a13;
  if (1 === g6 && 0 === p5) return [n15];
  if (2 === g6 && 0 === p5 && !u12) return [n15, C5];
  const s8 = { r: n15[0], g: n15[1], b: n15[2] }, d4 = { r: C5[0], g: C5[1], b: C5[2] }, c7 = "esriCIELabAlgorithm" === m6 ? v3(A(s8), A(d4), a13) : "esriHSVAlgorithm" === m6 ? b3(z(s8), z(d4), a13) : k3(j(s8), j(d4), a13), y6 = [], R3 = n15[3] ?? 255, w5 = ((C5[3] ?? 255) - R3) / (g6 - 1);
  for (let r13 = 0; r13 < g6; r13++) {
    const { r: o12, g: t8, b: l7 } = y2(c7[r13]), i9 = f9 ? Math.round(R3 + w5 * r13) : 255;
    y6.push([o12, t8, l7, i9]);
  }
  return y6;
}
function R2(o11, r13) {
  const { numColors: t8, interpolateAlpha: l7 } = h6(r13);
  ...
  for (let p5 = 0; p5 < i8.length; p5++) {
    ...
    const u12 = y5(i8[p5], { numColors: g7, interpolateAlpha: l7, distanceOffset: r14 / e7[p5], distanceInterval: C5 / e7[p5] });
    n15.push(...u12);
  }
...
function B2(o11, r13) {
  const t8 = w4(o11, r13), l7 = r13 == null ? void 0 : r13.interpolateAlpha;
...
function I3(o11) {
  ...
  return { Algorithm: (r13 == null ? void 0 : r13.Algorithm) || "esriHSVAlgorithm", type: "AlgorithmicColorRamp", FromColor: D3(o11.fromColor), ToColor: D3(o11.toColor) };
}
function G2(o11) {
  const r13 = d3(o11);
  if (!r13) return null;
  if ("algorithmic" === o11.type) return { ...I3(o11), Name: r13 };
  if (o11.colorRamps) {
...
function t7(t8, e7) {
  const { attributeTable: u12, bandCount: r13 } = t8;
...
function e6(n15) {
  const { bandCount: t8, dataType: e7, pixelType: u12 } = n15;
  return "elevation" === e7 || "generic" === e7 && 1 === t8 && ("s16" === u12 || "s32" === u12 || "f32" === u12 || "f64" === u12);
}
function u11(n15, t8 = false) {
  const { bandCount: e7, colormap: u12, pixelType: r13 } = n15;
  return 1 === e7 && (!!(u12 == null ? void 0 : u12.length) || !t8 && "u8" === r13);
}
function r12(n15, t8 = false) {
  const { attributeTable: e7, bandCount: u12 } = n15;
...
var C4 = class extends f {
    ...
    try {
      ...
      switch (t8.pixels.length > 3 && (t8 = t8.extractBands(e7.bandIds ?? [0, 1, 2])), this.rendererJSON.type) {
        ...
        case "rasterStretch":
          ...
          break;
        case "rasterShadedRelief": {
          const s8 = e7.extent, o11 = s8.spatialReference.isGeographic, a13 = { x: (s8.xmax - s8.xmin) / t8.width, y: (s8.ymax - s8.ymin) / t8.height };
          r13 = this._symbolizeShadedRelief(t8, { isGCS: o11, resolution: a13 });
          break;
        }
      }
      return r13;
  ...
  simpleStretch(e7, t8) {
    if (!O3(e7)) return e7;
    try {
      return e7.pixels.length > 3 && (e7 = e7.extractBands([0, 1, 2])), M2(e7, { ...t8, isRenderer: true });
    } catch (r13) {
  ...
  generateWebGLParameters(e7) {
    ...
    const { pixelBlock: t8, isGCS: r13, resolution: s8, bandIds: o11 } = e7, { rendererJSON: a13 } = this;
  ...
  _symbolizeStretch(e7, t8) {
    var _a, _b;
    const { rasterInfo: r13 } = this, { pixelType: s8, bandCount: o11 } = r13, a13 = this.rendererJSON, n15 = ["u8", "u16", "s8", "s16"].includes(s8);
    let l7, c7;
    const { dra: p5 } = a13, { gamma: f9 } = this.lookup;
    if ("histogramEqualization" === a13.stretchType) {
      const s9 = p5 ? null : (_a = this.lookup) == null ? void 0 : _a.histogramLut, o12 = p2(a13, { rasterInfo: r13, pixelBlock: e7, bandIds: t8, returnHistogramLut: !s9 }), n16 = M2(e7, { ...o12, gamma: f9, isRenderer: true });
      c7 = f3(n16, { lut: p5 ? o12.histogramLut : s9, offset: 0 });
    } else if (n15) {
      if (p5) {
        const o12 = p2(a13, { rasterInfo: r13, pixelBlock: e7, bandIds: t8 });
        l7 = a9({ pixelType: s8, ...o12, gamma: f9, rounding: "floor" });
      } else if (this._isLUTChanged()) {
        if (!this.bind().success) return e7;
        l7 = this.lookup ? this.lookup.stretchLut : null;
      } else l7 = this.lookup ? this.lookup.stretchLut : null;
      if (!l7) return e7;
      o11 > 1 && null != t8 && t8.length === (e7 == null ? void 0 : e7.pixels.length) && (l7 == null ? void 0 : l7.lut.length) === o11 && (l7 = { lut: t8.map((e8) => l7.lut[e8]), offset: l7.offset }), c7 = f3(e7, l7);
    } else {
      const s9 = p2(a13, { rasterInfo: r13, pixelBlock: e7, bandIds: t8 });
      c7 = M2(e7, { ...s9, gamma: f9, isRenderer: true });
    }
    if (a13.colorRamp) {
  ...
  _symbolizeShadedRelief(e7, t8) {
    var _a;
    const r13 = this.rendererJSON, s8 = { ...r13, ...t8 }, o11 = r11(e7, s8);
  ...
  _updateUVRenderer(e7) {
    var _a;
    const { bandCount: t8, attributeTable: r13, pixelType: s8 } = this.rasterInfo, o11 = e7.field1;
    if (!o11) return { success: false, error: "Unsupported renderer; missing UniqueValueRenderer.field." };
    const a13 = e7.defaultSymbol, n15 = 1 === t8 && ["u8", "s8"].includes(s8);
    if (!t7(this.rasterInfo, o11) && !n15) return { success: false, error: "Unsupported data; UniqueValueRenderer is only supported on single band data with a valid raster attribute table." };
    const i8 = [];
    if (null != r13) {
      ...
      r13.features.forEach((r14) => {
        var _a2, _b;
        const s9 = (_a2 = e7.uniqueValueInfos) == null ? void 0 : _a2.find((e8) => String(e8.value) === String(r14.attributes[o11])), n16 = (_b = s9 == null ? void 0 : s9.symbol) == null ? void 0 : _b.color;
        n16 ? i8.push([r14.attributes[t9.name]].concat(n16)) : a13 && i8.push([r14.attributes[t9.name]].concat(a13.color));
      });
    } else {
      if ("value" !== o11.toLowerCase()) return { success: false, error: 'Unsupported renderer; UniqueValueRenderer.field must be "Value" when raster attribute table is not available.' };
      (_a = e7.uniqueValueInfos) == null ? void 0 : _a.forEach((e8) => {
        var _a2;
        const t9 = (_a2 = e8 == null ? void 0 : e8.symbol) == null ? void 0 : _a2.color;
        t9 ? i8.push([parseInt("" + e8.value, 10)].concat(t9)) : a13 && i8.push([parseInt("" + e8.value, 10)].concat(a13 == null ? void 0 : a13.color));
      });
    }
    ...
    const l7 = a4({ colormap: i8 });
    return this.lookup = { rendererJSON: e7, colormapLut: l7 }, this.canRenderInWebGL = _2(l7 == null ? void 0 : l7.indexedColormap), { success: true };
  }
  _updateColormapRenderer(e7) {
    if (!u11(this.rasterInfo)) return { success: false, error: "Unsupported data; the data source does not have a colormap." };
    ...
    return this.lookup = { rendererJSON: e7, colormapLut: r13 }, this.canRenderInWebGL = _2(r13 == null ? void 0 : r13.indexedColormap), { success: true };
  }
  _updateShadedReliefRenderer(e7) {
    ...
    if (e7.colorRamp) {
      const r13 = B2(e7.colorRamp, { interpolateAlpha: true }), s8 = a4({ colormap: r13 }), o11 = [], a13 = s8.indexedColormap;
      for (let e8 = 0; e8 < a13.length; e8 += 4) {
        const r14 = z({ r: a13[e8], g: a13[e8 + 1], b: a13[e8 + 2] });
        o11.push([r14.h / 60, r14.s / 100, 255 * r14.v / 100]);
      }
      this.lookup = { rendererJSON: e7, colormapLut: s8, hsvMap: o11 };
    } else this.lookup = null;
    return this.canRenderInWebGL = true, { success: true };
  }
  _analyzeClassBreaks(e7) {
    const { attributeTable: t8, pixelType: r13 } = this.rasterInfo, s8 = null != t8 ? t8.fields.find((e8) => "value" === e8.name.toLowerCase()) : null, o11 = null != t8 ? t8.fields.find((t9) => t9.name.toLowerCase() === e7.field.toLowerCase()) : null, a13 = null != s8 && null !== o11;
    return { canUseIndexedLUT: ["u8", "u16", "s8", "s16"].includes(r13) || a13, tableValueField: s8, tableBreakField: o11 };
  }
  _updateClassBreaksRenderer(e7) {
    const { attributeTable: t8 } = this.rasterInfo, { canUseIndexedLUT: r13, tableValueField: s8, tableBreakField: o11 } = this._analyzeClassBreaks(e7), a13 = e7.classBreakInfos;
    if (!(a13 == null ? void 0 : a13.length)) return { success: false, error: "Unsupported renderer; missing or invalid ClassBreaksRenderer.classBreakInfos." };
    const n15 = a13.sort((e8, t9) => e8.classMaxValue - t9.classMaxValue), i8 = n15[n15.length - 1];
    let l7 = e7.minValue;
    if (!r13) {
      const t9 = [];
      for (let e8 = 0; e8 < n15.length; e8++) t9.push({ value: n15[e8].classMinValue ?? l7, mappedColor: n15[e8].symbol.color }), l7 = n15[e8].classMaxValue;
      return t9.push({ value: i8.classMaxValue, mappedColor: i8.symbol.color }), this.lookup = { rendererJSON: e7, remapLut: t9 }, this.canRenderInWebGL = false, { success: true };
    }
    const u12 = [];
    if (null != t8 && null != s8 && null !== o11 && s8 !== o11) {
      const r14 = s8.name, a14 = o11.name, i9 = n15[n15.length - 1], { classMaxValue: c7 } = i9;
      l7 = e7.minValue;
      for (const e8 of t8.features) {
        const t9 = e8.attributes[r14], s9 = e8.attributes[a14], o12 = s9 === c7 ? i9 : s9 < l7 ? null : n15.find(({ classMaxValue: e9 }) => e9 > s9);
    ...
    const p5 = a4({ colormap: u12, fillUnspecified: false });
    return this.lookup = { rendererJSON: e7, colormapLut: p5 }, this.canRenderInWebGL = _2(p5 == null ? void 0 : p5.indexedColormap), { success: true };
  }
  _updateStretchRenderer(e7) {
    var _a, _b;
    let { stretchType: t8, dra: r13 } = e7;
    if (!("none" === t8 || ((_a = e7.statistics) == null ? void 0 : _a.length) || v4(this.rasterInfo.statistics) || r13)) return { success: false, error: "Unsupported renderer; StretchRenderer.statistics is required when dynamic range adjustment is not used." };
    const s8 = e7.histograms || this.rasterInfo.histograms;
    !V2(e7.stretchType) || (s8 == null ? void 0 : s8.length) || r13 || (t8 = "minMax");
    const { computeGamma: o11, useGamma: a13, colorRamp: n15 } = e7;
    let { gamma: i8 } = e7;
    if (a13 && o11 && !(i8 == null ? void 0 : i8.length)) {
    ...
    if ("histogramEqualization" === t8) {
      ...
      const t9 = p2(e7, { rasterInfo: this.rasterInfo }), r14 = a9({ pixelType: l7, ...t9, gamma: a13 ? i8 : null, rounding: "floor" });
      this.lookup = { rendererJSON: e7, stretchLut: r14 };
    }
    if (n15 && !U3(n15)) {
      const t9 = B2(n15, { interpolateAlpha: true });
      this.lookup || (this.lookup = { rendererJSON: e7 }), this.lookup.colormapLut = a4({ colormap: t9 }), this.lookup.rendererJSON = e7;
    }
    return this.lookup.gamma = a13 && (i8 == null ? void 0 : i8.length) ? i8 : null, this.canRenderInWebGL = true, { success: true };
  }
  _generateStretchWebGLParams(e7, t8, r13) {
    var _a;
    let s8 = null, o11 = null;
    const a13 = (_a = this.lookup) == null ? void 0 : _a.colormapLut;
    t8.colorRamp && a13 && (s8 = a13.indexedColormap, o11 = a13.offset), "histogramEqualization" === t8.stretchType && (t8 = { ...t8, stretchType: "minMax" });
    const { gamma: n15 } = this.lookup, i8 = !(!t8.useGamma || !(n15 == null ? void 0 : n15.some((e8) => 1 !== e8))), { minCutOff: l7, maxCutOff: u12, outMin: c7, outMax: p5 } = p2(t8, { rasterInfo: this.rasterInfo, pixelBlock: e7, bandIds: r13 });
    let d4 = 0;
    null != e7 && (d4 = e7.getPlaneCount(), 2 === d4 && ((e7 = e7.clone()).statistics = [e7.statistics[0]], e7.pixels = [e7.pixels[0]]));
    const { bandCount: m6 } = this.rasterInfo, f9 = Math.min(3, (r13 == null ? void 0 : r13.length) || d4 || m6, m6), y6 = new Float32Array(f9), g6 = s8 || i8 ? 1 : 255;
    let b4;
    ...
    return { bandCount: f9, outMin: c7 / g6, outMax: p5 / g6, minCutOff: l7, maxCutOff: u12, factor: y6, useGamma: i8, gamma: i8 ? n15 : [1, 1, 1], gammaCorrection: i8 ? S4 : [1, 1, 1], colormap: s8, colormapOffset: o11, stretchType: t8.stretchType, type: "stretch" };
  }
  _generateShadedReliefWebGLParams(e7, t8 = false, r13 = { x: 0, y: 0 }) {
    ...
    const n15 = { ...e7, isGCS: t8, resolution: r13 }, i8 = o9(n15), l7 = (_b = this.rasterInfo.statistics) == null ? void 0 : _b[0];
    return { ...i8, minValue: (l7 == null ? void 0 : l7.min) ?? 0, maxValue: (l7 == null ? void 0 : l7.max) ?? 8e3, hillshadeType: "traditional" === e7.hillshadeType ? 0 : 1, type: "hillshade", colormap: s8, colormapOffset: o11 };
  }
  _generateVectorFieldWebGLParams(e7) {
    var _a, _b, _c;
    const { style: t8, inputUnit: r13, outputUnit: s8, visualVariables: o11, symbolTileSize: a13, flowRepresentation: n15 } = e7;
    let i8;
    const l7 = ((_a = this.rasterInfo.statistics) == null ? void 0 : _a[0].min) ?? 0, u12 = ((_b = this.rasterInfo.statistics) == null ? void 0 : _b[0].max) ?? 50, c7 = (o11 == null ? void 0 : o11.find((e8) => "sizeInfo" === e8.type)) ?? { type: "sizeInfo", field: "Magnitude", maxDataValue: u12, maxSize: 0.8 * a13, minDataValue: l7, minSize: 0.2 * a13 }, p5 = c7.minDataValue ?? l7, d4 = c7.maxDataValue ?? u12, h7 = null != c7.maxSize && null != c7.minSize ? [c7.minSize / a13, c7.maxSize / a13] : [0.2, 0.8];
    if ("wind_speed" === t8) {
    ...
    const f9 = "flow_to" === n15 === ("ocean_current_kn" === t8 || "ocean_current_m" === t8) ? 0 : Math.PI, y6 = o11 == null ? void 0 : o11.find((e8) => "rotationInfo" === e8.type);
    return { breakValues: i8, dataRange: m6, inputUnit: r13, outputUnit: s8, symbolTileSize: a13, symbolPercentRange: h7, style: t8 || "single_arrow", rotation: f9, rotationType: ((_c = this.rasterInfo.storageInfo) == null ? void 0 : _c.tileInfo) && "vector-uv" === this.rasterInfo.dataType ? "geographic" : (y6 == null ? void 0 : y6.rotationType) || e7.rotationType, type: "vectorField" };
  }
};
e([y({ json: { write: true } })], C4.prototype, "rendererJSON", void 0), e([y({ type: m4, json: { write: true } })], C4.prototype, "rasterInfo", void 0), e([y({ json: { write: true } })], C4.prototype, "lookup", void 0), e([y()], C4.prototype, "canRenderInWebGL", void 0), C4 = e([a2("esri.renderers.support.RasterSymbolizer")], C4);
var L2 = C4;
function _2(e7) {
...
//# sourceMappingURL=chunk-W4QC7UYU.js.map
