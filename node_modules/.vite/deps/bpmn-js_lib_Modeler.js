...
// node_modules/bpmn-js/node_modules/diagram-js/lib/features/search/search.js
...
// node_modules/bpmn-js/node_modules/diagram-js/lib/features/search/index.js
var search_default = {
  search: ["value", search]
};
...
function createLine2(points, attrs, radius) {
  ...
  return updateLine2(line, points);
}
function updateLine2(gfx, points) {
...
function InteractionEvents(eventBus, elementRegistry, styles) {
  ...
  this.updateDefaultHit = function(element, gfx) {
    ...
    if (element.waypoints) {
      updateLine2(hit, element.waypoints);
    } else {
      attr2(hit, {
        width: element.width,
        height: element.height
...
function Outline(eventBus, styles) {
  ...
  eventBus.on(["shape.added", "shape.changed"], LOW_PRIORITY22, function(event2) {
    var element = event2.element, gfx = event2.gfx;
...
// node_modules/bpmn-js/node_modules/diagram-js/lib/features/outline/MultiSelectionOutline.js
...
function MovePreview(eventBus, canvas, styles, previewSupport) {
  ...
  eventBus.on("shape.move.start", LOW_PRIORITY24, function(event2) {
