...
function e(t, r2) {
  ...
  return new w(i2 ? { xmin: t[0], xmax: t[3], ymin: t[1], ymax: t[4], zmin: t[2], zmax: t[5], spatialReference: r2 } : { xmin: t[0], xmax: t[3], ymin: t[1], ymax: t[4], spatialReference: r2 });
}
function o(n, t) {
...
function c(n, t, r2 = 0, i2 = t.length / 3) {
  let a2 = n[0], u2 = n[1], e2 = n[2], m = n[3], o2 = n[4], f = n[5];
  for (let h2 = 0; h2 < i2; h2++) a2 = Math.min(a2, t[r2 + 3 * h2]), u2 = Math.min(u2, t[r2 + 3 * h2 + 1]), e2 = Math.min(e2, t[r2 + 3 * h2 + 2]), m = Math.max(m, t[r2 + 3 * h2]), o2 = Math.max(o2, t[r2 + 3 * h2 + 1]), f = Math.max(f, t[r2 + 3 * h2 + 2]);
  n[0] = a2, n[1] = u2, n[2] = e2, n[3] = m, n[4] = o2, n[5] = f;
}
function s(n) {
...
//# sourceMappingURL=chunk-BJHLU2MM.js.map
