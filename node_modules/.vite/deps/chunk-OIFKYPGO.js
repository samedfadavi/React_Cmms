...
function f(t) {
  ...
  if (t = t.filter(({ ratio: t2 }) => t2 >= 0 && t2 <= 1).sort((t2, r2) => t2.ratio - r2.ratio).map(({ color: t2, ratio: r2 }) => ({ color: t2, ratio: Math.max(r2, 1e-3) })), t.length < 1) return o;
...
//# sourceMappingURL=chunk-OIFKYPGO.js.map
