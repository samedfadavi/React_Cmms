...
e([o2({ inherited: "inherited" })], i4.prototype, "type", void 0), i4 = t2 = e([a2("esri.layers.support.InheritedDomain")], i4);
var p3 = i4;
...
e([y({ json: { type: [Number], read: { source: "range", reader: (e2, r) => {
  var _a;
  return (_a = r.range) == null ? void 0 : _a[1];
} }, write: { enabled: false, overridePolicy() {
  return { enabled: null != this.maxValue && null == this.minValue };
}, target: "range", writer(e2, r, o3) {
  r[o3] = [this.minValue || 0, e2];
} } } })], n2.prototype, "maxValue", void 0), e([y({ json: { type: [Number], read: { source: "range", reader: (e2, r) => {
  var _a;
  return (_a = r.range) == null ? void 0 : _a[0];
} }, write: { target: "range", writer(e2, r, o3) {
  r[o3] = [e2, this.maxValue || 0];
} } } })], n2.prototype, "minValue", void 0), e([o2({ range: "range" })], n2.prototype, "type", void 0), n2 = s = e([a2("esri.layers.support.RangeDomain")], n2);
var i5 = n2;

// ../node_modules/@arcgis/core/layers/support/domains.js
var n3 = { key: "type", base: i2, typeMap: { range: i5, "coded-value": i3, inherited: p3 } };
function i6(r) {
  if (!(r == null ? void 0 : r.type)) return null;
  switch (r.type) {
    case "range":
...
e([y({ type: String, json: { write: true } })], m.prototype, "alias", void 0), e([y({ type: [String, Number], json: { write: { allowNull: true } } })], m.prototype, "defaultValue", void 0), e([y()], m.prototype, "description", void 0), e([o("description")], m.prototype, "readDescription", null), e([y({ types: n3, json: { read: { reader: i6 }, write: true } })], m.prototype, "domain", void 0), e([y({ type: Boolean, json: { write: true } })], m.prototype, "editable", void 0), e([y({ type: N, json: { write: { overridePolicy: (e2) => ({ enabled: Number.isFinite(e2) }) } } })], m.prototype, "length", void 0), e([y({ type: String, json: { write: true } })], m.prototype, "name", void 0), e([y({ type: Boolean, json: { write: true } })], m.prototype, "nullable", void 0), e([o2(i)], m.prototype, "type", void 0), e([y()], m.prototype, "valueType", void 0), e([o("valueType", ["description"])], m.prototype, "readValueType", null), e([y({ type: Boolean, json: { read: false } })], m.prototype, "visible", void 0), m = u = e([a2("esri.layers.support.Field")], m);
var y2 = m;
...
//# sourceMappingURL=chunk-TXIL3QUC.js.map
