...
var d = p = class extends f {
  ...
  writeData(t, e2, a3, r2) {
    if (t instanceof HTMLImageElement) {
      const s = { type: "image-element", src: m(t.src, r2), crossOrigin: t.crossOrigin };
      e2[a3] = s;
    } else if (t instanceof HTMLCanvasElement) {
      const r3 = { type: "canvas-element", imageData: m2(t.getContext("2d").getImageData(0, 0, t.width, t.height)) };
      e2[a3] = r3;
    } else if (t instanceof HTMLVideoElement) {
      const s = { type: "video-element", src: m(t.src, r2), autoplay: t.autoplay, loop: t.loop, muted: t.muted, crossOrigin: t.crossOrigin, preload: t.preload };
      e2[a3] = s;
    } else if (t instanceof ImageData) {
      const r3 = { type: "image-data", imageData: m2(t) };
      e2[a3] = r3;
    }
  }
  readData(t) {
  ...
  static from(t) {
    return "string" == typeof t ? new p({ url: t }) : t instanceof HTMLImageElement || t instanceof HTMLCanvasElement || t instanceof ImageData || t instanceof HTMLVideoElement ? new p({ data: t }) : g(p, t);
  }
};
function m2(t) {
  let e2 = "";
...
e([y({ type: String, json: { write: h } })], d.prototype, "url", null), e([y({ json: { write: { overridePolicy() {
  return { enabled: !this.url };
} } } }), y()], d.prototype, "data", null), e([r("data")], d.prototype, "writeData", null), e([o("data")], d.prototype, "readData", null), e([y({ type: Boolean, json: { write: { overridePolicy() {
  return { enabled: this._isOverridden("transparent") };
} } } })], d.prototype, "transparent", null), e([y({ json: { write: true } })], d.prototype, "wrap", void 0), e([y({ readOnly: true })], d.prototype, "contentHash", null), d = p = e([a("esri.geometry.support.MeshTexture")], d);
var w = d;
...
e([y({ type: [Number], nonNullable: true, json: { write: true } })], p2.prototype, "offset", void 0), e([y({ type: Number, nonNullable: true, json: { write: true } })], p2.prototype, "rotation", void 0), e([y({ type: [Number], nonNullable: true, json: { write: true } })], p2.prototype, "scale", void 0), p2 = e([a("esri.geometry.support.MeshTextureTransform")], p2);
var c2 = p2;
...
e([y({ type: u, json: { write: true } })], u3.prototype, "color", void 0), e([y({ type: w, json: { write: true } })], u3.prototype, "colorTexture", void 0), e([y({ type: c2, json: { write: true } })], u3.prototype, "colorTextureTransform", void 0), e([y({ type: w, json: { write: true } })], u3.prototype, "normalTexture", void 0), e([y({ type: c2, json: { write: true } })], u3.prototype, "normalTextureTransform", void 0), e([y({ nonNullable: true, json: { write: true } })], u3.prototype, "alphaMode", void 0), e([y({ nonNullable: true, json: { write: true } })], u3.prototype, "alphaCutoff", void 0), e([y({ nonNullable: true, json: { write: true } })], u3.prototype, "doubleSided", void 0), u3 = n = e([a("esri.geometry.support.MeshMaterial")], u3);
var a2 = u3;
...
e([y({ type: u, json: { write: true } })], u4.prototype, "emissiveColor", void 0), e([y({ type: w, json: { write: true } })], u4.prototype, "emissiveTexture", void 0), e([y({ type: c2, json: { write: true } })], u4.prototype, "emissiveTextureTransform", void 0), e([y({ type: w, json: { write: true } })], u4.prototype, "occlusionTexture", void 0), e([y({ type: c2, json: { write: true } })], u4.prototype, "occlusionTextureTransform", void 0), e([y({ type: Number, nonNullable: true, json: { write: true }, range: { min: 0, max: 1 } })], u4.prototype, "metallic", void 0), e([y({ type: Number, nonNullable: true, json: { write: true }, range: { min: 0, max: 1 } })], u4.prototype, "roughness", void 0), e([y({ type: w, json: { write: true } })], u4.prototype, "metallicRoughnessTexture", void 0), e([y({ type: c2, json: { write: true } })], u4.prototype, "metallicRoughnessTextureTransform", void 0), u4 = n2 = e([a("esri.geometry.support.MeshMaterialMetallicRoughness")], u4);
var m3 = u4;
...
//# sourceMappingURL=chunk-U4K563LI.js.map
