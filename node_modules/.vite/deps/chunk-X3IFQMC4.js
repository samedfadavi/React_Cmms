...
var i2 = class {
  constructor(i4, s5, t3, e2) {
    this.semiMajorAxis = i4, this.flattening = s5, this.outerAtmosphereRimWidth = t3;
...
var s = new i2(6378137, 1 / 298.257223563, 3e5, 0.006694379990137799);
var t = new i2(3396190, 1 / 169.8944472236118, 23e4);
...
function _() {
  return t2 || (t2 = import("./pe-wasm-YDPTJL4W.js").then((e2) => e2.p).then(({ default: t3 }) => t3({ locateFile: (t4) => n(`esri/geometry/support/${t4}`) })).then((e2) => {
    l(e2);
  }), t2);
}
var P;
...
!function(e2) {
  ...
  function _3(e3, t4, r5, n4) {
    o.ensureCache.prepare();
    const _4 = M(r5), P3 = r5 === _4, s5 = o.ensureFloat64(_4), E4 = o._pe_proj_to_geog_center(o.getPointer(e3), t4, s5, n4);
    return E4 && A(r5, t4, s5, P3), E4;
  }
  ...
  function P3(e3) {
    return E4(s2.PE_TYPE_COORDSYS, e3);
  }
  function E4(e3, r5) {
  ...
  function p5(e3) {
    return E4(s2.PE_TYPE_GEOGCS, e3);
  }
  function u4(e3) {
    return E4(s2.PE_TYPE_GEOGTRAN, e3);
  }
  function a2(e3) {
    return o.PeFactory.prototype.getCode(e3);
  }
  function c3(e3) {
    return E4(s2.PE_TYPE_PROJCS, e3);
  }
  function T3(e3) {
    return E4(s2.PE_TYPE_UNIT, e3);
  }
  e2.initialize = _3, e2.coordsys = P3, e2.factoryByType = E4, e2.fromString = i4, e2.geogcs = p5, e2.geogtran = u4, e2.getCode = a2, e2.projcs = c3, e2.unit = T3;
}(E || (E = {}));
var i3 = null;
var p;
var u;
...
function l(e2) {
  ...
  o = e2, s2.init(), p.init(), T.init(), f.init(), S.init(), i3 = class extends o.PeGCSExtent {
    destroy() {
      o.destroy(this);
    }
  };
...
!function(e2) {
  ...
  function n3(e3, r5, n4, _3, P3, s5) {
    let E4 = null;
    const i4 = new o.PeInteger(s5);
    try {
      const p5 = o.PeGTlistExtended.prototype.getGTlist(e3, r5, n4, _3, P3, i4);
      if ((s5 = i4.val) && (E4 = [p5], s5 > 1)) {
        const e4 = o.getPointer(p5);
        for (let r6 = 1; r6 < s5; r6++) E4.push(o.wrapPointer(e4 + t3 * r6, o.PeGTlistExtendedEntry));
      }
    } finally {
      o.destroy(i4);
    }
  ...
  function t3(e3, t4, r4, n3, _3) {
    o.ensureCache.prepare();
    const P3 = M(r4), s5 = r4 === P3, E4 = o.ensureFloat64(P3);
    let i4 = 0;
    n3 && (i4 = o.ensureFloat64(n3));
    const p5 = o._pe_geog_to_geog(o.getPointer(e3), t4, E4, i4, _3);
    return p5 && A(r4, t4, E4, s5), p5;
  }
  e2.geogToGeog = t3;
}(a || (a = {})), function(e2) {
  const t3 = (e3, t4, r5, n4, _4, P4) => {
    ...
    switch (o.ensureCache.prepare(), e3) {
      case "dd":
        E5 = o._pe_geog_to_dd, i5 = s2.PE_DD_MAX;
        break;
      case "ddm":
        E5 = o._pe_geog_to_ddm, i5 = s2.PE_DDM_MAX;
        break;
      case "dms":
        E5 = o._pe_geog_to_dms, i5 = s2.PE_DMS_MAX;
    }
    let p6 = 0;
    t4 && (p6 = o.getPointer(t4));
    const u4 = M(n4), a2 = o.ensureFloat64(u4), c3 = y(r5, i5), T3 = E5(p6, r5, a2, _4, o.ensureInt32(c3));
    if (T3) for (let s5 = 0; s5 < r5; s5++) P4[s5] = o.UTF8ToString(c3[s5]);
    return T3;
  }, r4 = (e3, t4, r5, n4, _4) => {
    let P4;
    switch (o.ensureCache.prepare(), e3) {
    ...
    const E5 = n4.map((e4) => o.ensureString(e4)), i5 = o.ensureInt32(E5), p6 = o.ensureFloat64(new Array(2 * r5)), u4 = P4(s5, r5, i5, p6);
  ...
  function E4(e3, t4, o5, n4) {
    return r4("ddm", e3, t4, o5, n4);
  }
  function i4(e3, o5, r5, n4, _4) {
    return t3("dd", e3, o5, r5, n4, _4);
  }
  function p5(e3, t4, o5, n4) {
    return r4("dd", e3, t4, o5, n4);
  }
  e2.geogToDms = n3, e2.dmsToGeog = _3, e2.geogToDdm = P3, e2.ddmToGeog = E4, e2.geogToDd = i4, e2.ddToGeog = p5;
}(c || (c = {})), function(e2) {
  function t3() {
  ...
  function r4(e3, t4, r5, n4, _3, P3, E4) {
    o.ensureCache.prepare();
    let i4 = 0;
    e3 && (i4 = o.getPointer(e3));
    const p5 = M(r5), u4 = o.ensureFloat64(p5), a2 = y(t4, s2.PE_MGRS_MAX), c3 = o.ensureInt32(a2), T3 = o._pe_geog_to_mgrs_extended(i4, t4, u4, n4, _3, P3, c3);
    if (T3) for (let s5 = 0; s5 < t4; s5++) E4[s5] = o.UTF8ToString(a2[s5]);
    return T3;
  }
  function n3(e3, t4, r5, n4, _3) {
    ...
    const s5 = r5.map((e4) => o.ensureString(e4)), E4 = o.ensureInt32(s5), i4 = o.ensureFloat64(new Array(2 * t4)), p5 = o._pe_mgrs_to_geog_extended(P3, t4, E4, n4, i4);
    return p5 && A(_3, t4, i4), p5;
  }
  e2.init = t3, e2.geogToMgrsExtended = r4, e2.mgrsToGeogExtended = n3;
}(T || (T = {})), function(e2) {
  function t3(e3, t4, r5, n3, _3, P3, E4) {
    o.ensureCache.prepare();
    let i4 = 0;
    e3 && (i4 = o.getPointer(e3));
    const p5 = M(r5), u4 = o.ensureFloat64(p5), a2 = y(t4, s2.PE_MGRS_MAX), c3 = o.ensureInt32(a2), T3 = o._pe_geog_to_usng(i4, t4, u4, n3, _3, P3, c3);
    if (T3) for (let s5 = 0; s5 < t4; s5++) E4[s5] = o.UTF8ToString(a2[s5]);
    return T3;
  }
  function r4(e3, t4, r5, n3) {
    ...
    const P3 = r5.map((e4) => o.ensureString(e4)), s5 = o.ensureInt32(P3), E4 = o.ensureFloat64(new Array(2 * t4)), i4 = o._pe_usng_to_geog(_3, t4, s5, E4);
    return i4 && A(n3, t4, E4), i4;
  }
  ...
  function r4(e3, t4, r5, n4, _3) {
    ...
    let P3 = 0;
    e3 && (P3 = o.getPointer(e3));
    const E4 = M(r5), i4 = o.ensureFloat64(E4), p5 = y(t4, s2.PE_UTM_MAX), u4 = o.ensureInt32(p5), a2 = o._pe_geog_to_utm(P3, t4, i4, n4, u4);
  ...
  function n3(e3, t4, r5, n4, _3) {
    ...
    let P3 = 0;
    e3 && (P3 = o.getPointer(e3));
    const s5 = r5.map((e4) => o.ensureString(e4)), E4 = o.ensureInt32(s5), i4 = o.ensureFloat64(new Array(2 * t4)), p5 = o._pe_utm_to_geog(P3, t4, E4, n4, i4);
    return p5 && A(_3, t4, i4), p5;
  }
...
var o3 = { 102113: { wkTemplate: 'PROJCS["WGS_1984_Web_Mercator",GEOGCS["GCS_WGS_1984_Major_Auxiliary_Sphere",DATUM["D_WGS_1984_Major_Auxiliary_Sphere",SPHEROID["WGS_1984_Major_Auxiliary_Sphere",6378137.0,0.0]],PRIMEM["Greenwich",0.0],UNIT["Degree",0.0174532925199433]],PROJECTION["Mercator"],PARAMETER["False_Easting",0.0],PARAMETER["False_Northing",0.0],PARAMETER["Central_Meridian",{Central_Meridian}],PARAMETER["Standard_Parallel_1",0.0],UNIT["Meter",1.0]]', valid: u2, origin: R, dx: 1e-5 }, 102100: { wkTemplate: S3, valid: u2, origin: R, dx: 1e-5 }, 3785: { wkTemplate: 'PROJCS["WGS_1984_Web_Mercator",GEOGCS["GCS_WGS_1984_Major_Auxiliary_Sphere",DATUM["D_WGS_1984_Major_Auxiliary_Sphere",SPHEROID["WGS_1984_Major_Auxiliary_Sphere",6378137.0,0.0]],PRIMEM["Greenwich",0.0],UNIT["Degree",0.0174532925199433]],PROJECTION["Mercator"],PARAMETER["False_Easting",0.0],PARAMETER["False_Northing",0.0],PARAMETER["Central_Meridian",{Central_Meridian}],PARAMETER["Standard_Parallel_1",0.0],UNIT["Meter",1.0]]', valid: u2, origin: R, dx: 1e-5 }, 3857: { wkTemplate: S3, valid: u2, origin: R, dx: 1e-5 }, 4326: { wkTemplate: 'GEOGCS["GCS_WGS_1984",DATUM["D_WGS_1984",SPHEROID["WGS_1984",6378137.0,298.257223563]],PRIMEM["Greenwich",{Central_Meridian}],UNIT["Degree",0.0174532925199433]]', altTemplate: 'PROJCS["WGS_1984_Plate_Carree",GEOGCS["GCS_WGS_1984",DATUM["D_WGS_1984",SPHEROID["WGS_1984",6378137.0,298.257223563]],PRIMEM["Greenwich",0.0],UNIT["Degree",0.0174532925199433]],PROJECTION["Plate_Carree"],PARAMETER["False_Easting",0.0],PARAMETER["False_Northing",0.0],PARAMETER["Central_Meridian",{Central_Meridian}],UNIT["Degrees",111319.491]]', valid: [-180, 180], origin: [-180, 90], dx: 1e-5 }, 104971: { wkTemplate: 'GEOGCS["Mars_2000_(Sphere)",DATUM["Mars_2000_(Sphere)",SPHEROID["Mars_2000_(Sphere)",3396190.0,0.0]],PRIMEM["Reference_Meridian",0.0],UNIT["Degree",0.0174532925199433]]', valid: [-180, 180], origin: [-180, 90], dx: 1e-5 }, 104905: { wkTemplate: 'GEOGCS["GCS_Mars_2000",DATUM["D_Mars_2000",SPHEROID["Mars_2000_IAU_IAG",3396190.0,169.8944472236118]],PRIMEM["Reference_Meridian",0.0],UNIT["Degree",0.0174532925199433]]', valid: [-180, 180], origin: [-180, 90], dx: 1e-5 } };
function G(e2, r4) {
  if (e2 === r4) return true;
  if (null == e2 || null == r4) return false;
  const n3 = e2.wkid, i4 = r4.wkid;
  if (null != n3 || null != i4) {
    if (n3 === i4) return true;
    if (w(e2) && w(r4)) return true;
    const t4 = e2.latestWkid;
    if (null != t4 && i4 === t4) return true;
...
function d2(e2) {
  ...
  const i4 = e2.wkt || e2.wkt2;
  return JSON.stringify(i4 ? n3 ? { wkt: i4, vcsWkid: n3 } : { wkt: i4 } : {});
}
function A2(e2) {
...
function p2(e2) {
  return D(e2 == null ? void 0 : e2.wkid);
}
function W(e2) {
  const r4 = e2 == null ? void 0 : e2.wkid;
...
var g2 = { wkid: 4326, wkt: r(o3[4326].wkTemplate, { Central_Meridian: "0.0" }) };
var U = { wkid: 102100, latestWkid: 3857 };
var h = { wkid: 32662 };
...
function s4(o5) {
  if (null != o5 && N2(o5)) {
    ...
    if (t3 && S5 === I2) return t;
    if (D(n3) || S5 && S5 === E3) return e;
  }
  return s;
}
function R2(t3) {
...
function j(e2, s5, t3) {
  ...
  const i4 = I3(s5, r4) ? e2 : y2(e2, s5, r4);
  return I3(t3, r4) ? i4 : _2(i4, t3, r4);
}
...
function $(e2, s5 = false) {
  const t3 = (e2 == null ? void 0 : e2.wkid) ?? null, n3 = (e2 == null ? void 0 : e2.wkt2) ?? (e2 == null ? void 0 : e2.wkt) ?? null;
  let c3 = null;
  if (t3) {
...
function Q(e2, s5) {
  return (e2 == null ? void 0 : e2[1]) ? V(e2[1]) : s5;
}
function V(e2) {
...
function X(e2) {
  ...
  if (s5) r4 = d3.units[d3[s5]];
    ...
    if (e3) {
      const s6 = e3.exec(t3);
      (s6 == null ? void 0 : s6[1]) && (r4 = ne(s6[1]));
    }
  }
...
var le = { esriDUDecimalDegrees: "degrees", esriDURadians: "radians" };
var oe = i()(ue);
var me = i()(ce);
var fe = i()(le);
...
//# sourceMappingURL=chunk-X3IFQMC4.js.map
