...
var l2 = class _l {
  ...
  static fromDefinition(e4, a3) {
    const o = e4.service.request || U2, { row: r2, col: s3, width: h, height: c2 } = e4, m2 = { query: { f: "json" } };
    return a3 = a3 ? { ...m2, ...a3 } : m2, o(n2(e4), a3).then((t2) => t2.data).catch((t2) => {
      var _a;
      if (422 === ((_a = t2 == null ? void 0 : t2.details) == null ? void 0 : _a.httpStatus)) return { location: { top: r2, left: s3, width: h, height: c2 }, valid: true, data: new Array(h * c2).fill(0) };
      throw t2;
    }).then((t2) => {
      if (t2.location && (t2.location.top !== r2 || t2.location.left !== s3 || t2.location.width !== h || t2.location.height !== c2)) throw new s("tilemap:location-mismatch", "Tilemap response for different location than requested", { response: t2, definition: { top: r2, left: s3, width: h, height: c2 } });
...
var j = w = class extends S {
  ...
  fetchAvailability(e4, t2, i, r2) {
    return !this.layer.tileInfo.lodAt(e4) || e4 < this.effectiveMinLOD || e4 > this.effectiveMaxLOD ? Promise.reject(new s("tile-map:tile-unavailable", "Tile is not available", { level: e4, row: t2, col: i })) : this._fetchTilemap(e4, t2, i, r2).catch((e5) => e5).then((r3) => {
      if (r3 instanceof l2) {
        const l3 = r3.getAvailability(t2, i);
        if ("unavailable" === l3) throw new s("tile-map:tile-unavailable", "Tile is not available", { level: e4, row: t2, col: i });
        return l3;
      }
      if (b(r3)) throw r3;
      return "unknown";
...
j._maxPrefetch = 4, j._prefetches = new l({ initialSize: w._maxPrefetch }), e([y({ constructOnly: true })], j.prototype, "layer", void 0), e([y({ constructOnly: true })], j.prototype, "minLOD", void 0), e([y({ constructOnly: true })], j.prototype, "maxLOD", void 0), e([y({ constructOnly: true })], j.prototype, "request", void 0), e([y({ constructOnly: true })], j.prototype, "size", void 0), j = w = e([a2("esri.layers.support.TilemapCache")], j);

export {
  j
};
//# sourceMappingURL=chunk-2TBXKHHI.js.map
