...
function N({ scale: t, translate: e4 }, n3) {
  return Math.round((n3 - e4[0]) / t[0]);
}
function w({ scale: t, translate: e4 }, n3) {
  return Math.round((e4[1] - n3) / t[1]);
}
function F({ scale: t, translate: e4 }, n3, o) {
  return n3 * t[o] + e4[o];
}
function x(t, e4, n3) {
...
function k(t) {
  const e4 = t.coords;
  return { x: e4[0], y: e4[1], z: e4[2], m: e4[3] };
}
function V(t, e4) {
...
function Y(t, e4, n3, o) {
  ...
  for (const s3 of e4) {
    const { geometry: e5, attributes: n4 } = s3, o2 = null != e5 ? r(e5) : null;
...
function L(t, e4, n3, o, r) {
  const s3 = _(n3, o);
  for (const { geometry: u2, attributes: l2 } of e4) {
...
function S(t, e4, n3, o) {
  for (const { geometry: r, attributes: s3 } of e4) t.push({ attributes: s3, geometry: null != r ? U(r, n3, o) : null });
  return t;
}
function U(t, e4, n3) {
  ...
  return e4 ? n3 ? { points: r, hasZ: e4, hasM: n3 } : { points: r, hasZ: e4 } : n3 ? { points: r, hasM: n3 } : { points: r };
}
...
function A(t, e4, n3, o) {
  for (const { geometry: r, attributes: s3 } of e4) t.push({ attributes: s3, geometry: null != r ? $(r, n3, o) : null });
  return t;
}
function $(t, e4, n3) {
  if (!t) return null;
  const o = d2(e4, n3), { coords: r, lengths: s3 } = t, u2 = [];
  let l2 = 0;
  for (const c of s3) {
    const t2 = [];
  ...
  return e4 ? n3 ? { paths: u2, hasZ: e4, hasM: n3 } : { paths: u2, hasZ: e4 } : n3 ? { paths: u2, hasM: n3 } : { paths: u2 };
}
function B(t, e4, n3, o, r) {
  const s3 = d2(n3, o);
  for (const { geometry: u2, attributes: l2, centroid: c } of e4) {
...
function D(t, e4, n3, o) {
  for (const { geometry: r, attributes: s3, centroid: u2 } of e4) {
    const e5 = null != r ? H(r, n3, o) : null;
    if (null != u2) {
      const n4 = P(u2);
      t.push({ attributes: s3, centroid: n4, geometry: e5 });
    } else t.push({ attributes: s3, geometry: e5 });
  }
  return t;
}
function H(t, e4, n3) {
  ...
  return e4 ? n3 ? { rings: u2, hasZ: e4, hasM: n3 } : { rings: u2, hasZ: e4 } : n3 ? { rings: u2, hasM: n3 } : { rings: u2 };
}
function J(t, e4, n3, o, r) {
  for (const { geometry: s3, centroid: u2, attributes: l2 } of e4) {
...
function Q(t, e4, n3, o) {
  const r = d2(n3, o), { lengths: s3, coords: u2 } = t;
  let l2 = 0;
  wt(t);
  for (const c of e4) {
...
function st(t, e4) {
  for (const n3 of e4) t.push({ attributes: n3.attributes });
  return t;
}
...
function lt(t) {
  const { objectIdFieldName: e4, spatialReference: n3, transform: o, fields: r, hasM: s3, hasZ: u2, features: l2, geometryType: c, exceededTransferLimit: i, uniqueIdField: f2, queryGeometry: a2, queryGeometryType: h } = t, d3 = { features: ut([], l2, c, u2, s3), fields: r, geometryType: c, objectIdFieldName: e4, spatialReference: n3, uniqueIdField: f2, queryGeometry: rt(a2, h, false, false) };
  return o && (d3.transform = o), i && (d3.exceededTransferLimit = i), s3 && (d3.hasM = s3), u2 && (d3.hasZ = u2), d3;
}
function ct(e4, n3) {
  const o = new e3(), { hasM: r, hasZ: s3, features: u2, objectIdFieldName: l2, spatialReference: c, geometryType: i, exceededTransferLimit: f2, transform: h, fields: d3 } = e4;
...
function it(t) {
  const { transform: e4, features: n3, hasM: o, hasZ: r } = t;
  if (!e4) return t;
...
function ft(t, e4) {
  const { geometryType: n3, features: o, hasM: r, hasZ: s3 } = e4;
  if (!t) return e4;
...
function at(t, e4, n3, o, r, s3, u2 = n3, l2 = o) {
  if (wt(t), !(e4 == null ? void 0 : e4.coords.length)) return null;
  const c = g[r], { coords: i, lengths: f2 } = e4, a2 = d2(n3, o), h = d2(n3 && u2, o && l2), m2 = M(n3, o, u2, l2);
...
function gt(t, e4, n3, u2) {
  var _a;
  if (!((_a = e4 == null ? void 0 : e4.coords) == null ? void 0 : _a.length)) return null;
  const l2 = d2(n3, u2);
...
function pt(t, e4, o, r, s3) {
  const { coords: u2, lengths: l2 } = e4, c = d2(o, r);
...
//# sourceMappingURL=chunk-F54TE5DA.js.map
