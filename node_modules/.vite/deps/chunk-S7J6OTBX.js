...
var g = class {
  constructor(e5, t3, i7) {
    this.config = null, this.fieldMap = null, this.url = null, this._ongoingRequests = /* @__PURE__ */ new Map(), this._symbolCache = new e2(100), this._dictionaryVersion = null, this._fieldIndex = null, this._dictionaryPromise = null, this.url = e5, this.config = t3, this.fieldMap = i7;
  }
  getSymbolFields() {
    return this._symbolFields;
  }
  async getSymbolAsync(t3, i7) {
    var _a;
    let s5;
    this._dictionaryPromise || (this._dictionaryPromise = this.fetchResources(i7));
    try {
      s5 = await this._dictionaryPromise;
    } catch (f4) {
      if (b(f4)) return this._dictionaryPromise = null, null;
    }
    const r3 = (_a = this._dictionaryVersion) == null ? void 0 : _a.since(4, 0), o4 = {};
    if (this.fieldMap) for (const e5 of this._symbolFields) {
      const i8 = B(this.fieldMap[e5], this._fieldIndex);
      if (i8) {
        const s6 = t3.attributes[i8];
        o4[e5] = r3 ? s6 : null != s6 ? "" + t3.attributes[i8] : "";
      } else o4[e5] = "";
    }
    let l2 = null;
    try {
      l2 = s5 == null ? void 0 : s5(o4, i7);
    } catch (y5) {
      return null;
    }
    if (!l2 || "string" != typeof l2 || "invalid" === l2) return null;
    const a4 = l2.split(";"), c6 = [], m3 = [];
    for (const n3 of a4) if (n3) if (n3.includes("po:")) {
      const t4 = n3.substr(3).split("|");
      if (3 === t4.length) {
        const i8 = t4[0], s6 = t4[1];
        let r4 = t4[2];
        ...
        m3.push({ primitiveName: i8, propertyName: s6, value: r4, defaultValue: null });
      }
    } else if (n3.includes("|")) {
    ...
    } else this._itemNames.has(n3) && c6.push(n3);
    const u8 = null == t3.geometry || !t3.geometry.hasZ && "point" === t3.geometry.type;
    return this._cimPartsToCIMSymbol(t3, c6, m3, u8, i7);
  }
  async fetchResources(e5) {
    ...
    const s5 = U(this.url + "/resources/styles/dictionary-info.json", { responseType: "json", query: { f: "json" }, signal: null != e5 ? e5.signal : null }), [{ data: o4 }] = await Promise.all([s5, i3()]);
    if (!o4) throw this._dictionaryPromise = null, new s("esri.renderers.DictionaryRenderer", "Bad dictionary data!");
    const { authoringInfo: n3, dictionary_version: u8, expression: f4, itemsNames: h3 } = o4, y5 = f4;
    let d5 = false;
    ...
    const _2 = [];
    if ((e5 == null ? void 0 : e5.fields) && this.fieldMap) for (const t3 in this.fieldMap) {
      const i7 = this.fieldMap[t3], s6 = e5.fields.filter((e6) => e6.name.toLowerCase() === (i7 == null ? void 0 : i7.toLowerCase()));
    ...
    const b2 = u4(y5, null != e5 ? e5.spatialReference : null, _2, g2).then((e6) => {
      ...
      return (i7, s6) => {
        ...
        const r3 = e6.repurposeFeature({ geometry: null, attributes: i7 });
  ...
  async _cimPartsToCIMSymbol(e5, t3, i7, r3, o4) {
    ...
    return new d({ data: _(l2, i7, r3) });
  }
  async _getSymbolPart(e5, i7) {
    const s5 = this._symbolCache.get(e5);
    if (s5) return s5;
    if (this._ongoingRequests.has(e5)) return this._ongoingRequests.get(e5).then((e6) => e6.data);
    const r3 = this._refSymbolUrlTemplate.replaceAll(/\{itemName\}/gi, e5), o4 = U(r3, { responseType: "json", query: { f: "json" }, ...i7 });
...
function _(e5, t3, i7) {
  ...
  return i7 && (s5.callout = d3), { type: "CIMSymbolReference", symbol: s5, primitiveOverrides: t3 };
}
...
var c2 = p4 = class extends v2(p) {
  ...
  writeVisualVariables(e5, r3, s5, i7) {
    (i7 == null ? void 0 : i7.origin) || super.writeVisualVariables(e5, r3, s5, i7);
  }
  clone() {
...
} } } })], c2.prototype, "scaleExpressionTitle", void 0), e([y({ type: String, json: { write: true } })], c2.prototype, "url", void 0), e([r("visualVariables")], c2.prototype, "writeVisualVariables", null), c2 = p4 = e([a2("esri.renderers.DictionaryRenderer")], c2);
var u5 = c2;
...
e([y({ type: String, json: { write: true } })], p5.prototype, "unit", void 0), p5 = e4 = e([a2("esri.renderers.support.DotDensityLegendOptions")], p5);
var i4 = p5;
...
var m = h2 = class extends v2(p) {
  ...
  async collectRequiredFields(t3, e5) {
    ...
    for (const o4 of this.attributes ?? []) o4.valueExpression && await h(t3, e5, o4.valueExpression), o4.field && t3.add(o4.field);
  }
};
e([y({ type: [c3], json: { write: true } })], m.prototype, "attributes", void 0), e([y({ type: u3, json: { write: true } })], m.prototype, "backgroundColor", void 0), e([y({ type: Boolean, json: { write: true } })], m.prototype, "dotBlendingEnabled", void 0), e([y({ type: String, json: { write: false } })], m.prototype, "dotShape", void 0), e([y({ type: Number, json: { write: true } })], m.prototype, "dotSize", void 0), e([y({ type: i4, json: { write: true } })], m.prototype, "legendOptions", void 0), e([y({ type: d2, json: { default: null, write: true } })], m.prototype, "outline", void 0), e([y({ type: Number, json: { write: true } })], m.prototype, "dotValue", void 0), e([y({ type: Number, json: { write: true } })], m.prototype, "referenceScale", void 0), e([y({ type: Number, json: { write: true } })], m.prototype, "seed", void 0), e([o({ dotDensity: "dot-density" })], m.prototype, "type", void 0), m = h2 = e([a2("esri.renderers.DotDensityRenderer")], m);
var y4 = m;

// ../node_modules/@arcgis/core/renderers/support/HeatmapColorStop.js
var c4;
var i5 = c4 = class extends f {
  constructor(o4) {
    super(o4), this.color = null, this.ratio = null;
  }
  clone() {
    return new c4({ color: this.color && this.color.clone(), ratio: this.ratio });
  }
};
e([y({ type: u3, json: { type: [N], default: null, write: true } })], i5.prototype, "color", void 0), e([y({ type: Number, json: { write: true } })], i5.prototype, "ratio", void 0), i5 = c4 = e([a2("esri.renderers.support.HeatmapColorStop")], i5);
var l = i5;
...
e([y({ type: String, json: { write: true } })], p6.prototype, "minLabel", void 0), e([y({ type: String, json: { write: true } })], p6.prototype, "maxLabel", void 0), e([y({ type: String, json: { write: true } })], p6.prototype, "title", void 0), p6 = e([a2("esri.renderers.support.HeatmapLegendOptions")], p6);

// ../node_modules/@arcgis/core/renderers/HeatmapRenderer.js
var j3;
function D(t3) {
  if (null != t3) {
    const { maxDensity: e5, minDensity: i7, radius: s5 } = t3;
    if (null != e5 || null != i7 || null != s5) {
      const { blurRadius: e6, maxPixelIntensity: i8, minPixelIntensity: s6, ...r3 } = t3;
      return r3;
    }
  }
  return t3;
...
var I = j3 = class extends p {
  ...
  set blurRadius(t3) {
    const e5 = this.maxPixelIntensity, i7 = this.minPixelIntensity;
    this._set("radius", e3(t3)), this._warnAboutDeprecatedGaussianBlurProp("blurRadius", "radius"), this._set("maxDensity", e5 * this._pixelIntensityToDensity), this._set("minDensity", i7 * this._pixelIntensityToDensity);
  }
  ...
  _warnAboutDeprecatedGaussianBlurProp(t3, e5) {
    ...
    "user" === t(this).getDefaultOrigin() && (this._warnedProps[t3] = true, v(() => {
      i(n.getLogger(this), t3, { replacement: `${String(e5)} (suggested value: ${this._get(e5)})`, version: "4.24" });
    }));
  }
  read(t3, e5) {
  ...
  async collectRequiredFields(t3, e5) {
    const i7 = this.field, s5 = this.valueExpression;
    i7 && "string" == typeof i7 && w2(t3, e5, i7), s5 && "string" == typeof s5 && await h(t3, e5, s5);
  }
  getAttributeHash() {
    return null;
  }
  ...
  clone() {
    return new j3({ authoringInfo: this.authoringInfo && this.authoringInfo.clone(), colorStops: a(this.colorStops), field: this.field, legendOptions: a(this.legendOptions), maxDensity: this.maxDensity, minDensity: this.minDensity, radius: this.radius, referenceScale: this.referenceScale, valueExpression: this.valueExpression, valueExpressionTitle: this.valueExpressionTitle });
  }
};
e([y({ type: j, json: { write: true, origins: { "web-scene": { write: false, read: false } } } })], I.prototype, "authoringInfo", void 0), e([y({ type: Number, json: { origins: { "portal-item": { write: true }, "web-map": { write: true } } } })], I.prototype, "blurRadius", null), e([y({ type: [l], json: { write: true } })], I.prototype, "colorStops", void 0), e([y({ type: String, json: { write: true } })], I.prototype, "field", void 0), e([y({ type: p6, json: { write: true } })], I.prototype, "legendOptions", void 0), e([y({ type: Number, json: { write: true } })], I.prototype, "maxDensity", void 0), e([y({ type: Number, json: { origins: { "portal-item": { write: true }, "web-map": { write: true } } } })], I.prototype, "maxPixelIntensity", null), e([y({ type: Number, json: { write: true } })], I.prototype, "minDensity", void 0), e([y({ type: Number, json: { origins: { "portal-item": { write: true }, "web-map": { write: true } } } })], I.prototype, "minPixelIntensity", null), e([y({ type: Number, cast: o2, json: { write: true } })], I.prototype, "radius", void 0), e([y({ type: Number, range: { min: 0 }, json: { default: 0, write: true } })], I.prototype, "referenceScale", void 0), e([o({ heatmap: "heatmap" })], I.prototype, "type", void 0), e([y({ type: String, json: { write: true, origins: { "web-document": { write: false }, "portal-item": { write: false } } } })], I.prototype, "valueExpression", void 0), e([y({ type: String })], I.prototype, "valueExpressionTitle", void 0), e([y({ readOnly: true })], I.prototype, "_pixelIntensityToDensity", null), I = j3 = e([a2("esri.renderers.HeatmapRenderer")], I);
var S2 = I;

// ../node_modules/@arcgis/core/renderers/support/OthersCategory.js
var i6 = class extends i2(f) {
  constructor() {
    super(...arguments), this.color = new u3([0, 0, 0, 0]), this.label = null, this.threshold = 0;
  }
};
e([y({ type: u3, json: { write: true } })], i6.prototype, "color", void 0), e([y({ type: String, json: { write: true } })], i6.prototype, "label", void 0), e([y({ type: Number, range: { min: 0, max: 1 }, json: { write: true } })], i6.prototype, "threshold", void 0), i6 = e([a2("esri.renderers.support.OthersCategory")], i6);
...
e([y({ type: String, json: { write: true } })], p7.prototype, "title", void 0), p7 = e([a2("esri.renderers.support.PieChartLegendOptions")], p7);

// ../node_modules/@arcgis/core/renderers/PieChartRenderer.js
var f2 = class extends v2(i2(p)) {
  constructor(t3) {
    super(t3), this.attributes = null, this.backgroundFillSymbol = null, this.defaultColor = new u3([0, 0, 0, 0]), this.defaultLabel = null, this.holePercentage = 0, this.othersCategory = new i6(), this.legendOptions = null, this.outline = null, this.size = 12, this.type = "pie-chart";
  }
  getSymbol() {
    var _a;
...
e([y({ type: [c3], json: { write: true } })], f2.prototype, "attributes", void 0), e([y({ type: S, json: { default: null, write: true } })], f2.prototype, "backgroundFillSymbol", void 0), e([y({ type: u3, json: { write: true } })], f2.prototype, "defaultColor", void 0), e([y({ type: String, json: { write: true } })], f2.prototype, "defaultLabel", void 0), e([y({ type: Number, range: { min: 0, max: 1 }, json: { write: true } })], f2.prototype, "holePercentage", void 0), e([y({ type: i6, json: { write: true } })], f2.prototype, "othersCategory", void 0), e([y({ type: p7, json: { write: true } })], f2.prototype, "legendOptions", void 0), e([y({ type: d2, json: { default: null, write: true } })], f2.prototype, "outline", void 0), e([y({ type: Number, cast: o2, json: { write: true } })], f2.prototype, "size", void 0), e([o({ pieChart: "pie-chart" })], f2.prototype, "type", void 0), f2 = e([a2("esri.renderers.PieChartRenderer")], f2);
var j4 = f2;

// ../node_modules/@arcgis/core/renderers/support/types.js
var m2 = { key: "type", base: p, typeMap: { heatmap: S2, simple: p2, "unique-value": A, "class-breaks": w, "dot-density": y4, dictionary: u5, "pie-chart": j4 }, errorContext: "renderer" };
var u7 = { key: "type", base: p, typeMap: { simple: p2, "unique-value": A, "class-breaks": w, heatmap: S2 }, errorContext: "renderer", validate: p8 };
function p8(e5) {
  switch (e5.type) {
    case "simple":
      return c5(e5);
...
//# sourceMappingURL=chunk-S7J6OTBX.js.map
