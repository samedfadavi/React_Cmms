      ...
      for (const n5 of f2) if ("byteLength" in n5 && n5.byteLength > 267386880) {
        ...
        switch (r3.type) {
          case e3.INVOKE:
            throw n6;
          case e3.RESPONSE:
            return void a(t2, { type: e3.RESPONSE, jobId: r3.jobId, error: i2(n6) });
        }
      }
    }
...
function t(t2, r3) {
  return new Proxy({}, { get: (e5, i4, s5) => (...e6) => {
    let s6, o4;
    const a2 = e6[e6.length - 1];
    n3(a2) && (s6 = a2.signal, o4 = a2.transferList, e6.pop());
    return t2.apply(r3 ? `${r3}.${i4.toString()}` : i4.toString(), e6, { transferList: o4, signal: s6 });
  } });
}
function n3(t2) {
...
var r2 = { statsWorker: () => import("./statsWorker-JB46U2NX.js"), geometryEngineWorker: () => import("./geometryEngineWorker-LZ2IILYH.js"), CSVSourceWorker: () => import("./CSVSourceWorker-C7HE4EKS.js"), EdgeProcessingWorker: () => import("./EdgeProcessingWorker-QIHS35Q6.js"), ElevationSamplerWorker: () => import("./ElevationSamplerWorker-TY6CVVRF.js"), FeatureServiceSnappingSourceWorker: () => import("./FeatureServiceSnappingSourceWorker-5EQQNKXX.js"), GeoJSONSourceWorker: () => import("./GeoJSONSourceWorker-B3A3RO54.js"), LercWorker: () => import("./LercWorker-265XUXDM.js"), MemorySourceWorker: () => import("./MemorySourceWorker-XMNRKUQT.js"), PBFDecoderWorker: () => import("./PBFDecoderWorker-PL6BTD4L.js"), FeaturePipelineWorker: () => import("./FeaturePipelineWorker-MQRYXNFX.js"), PointCloudWorker: () => import("./PointCloudWorker-2PGZH2L3.js"), RasterWorker: () => import("./RasterWorker-4NV4YE6F.js"), SceneLayerSnappingSourceWorker: () => import("./SceneLayerSnappingSourceWorker-P5OHK2KI.js"), SceneLayerWorker: () => import("./SceneLayerWorker-ELWO2UKP.js"), WFSSourceWorker: () => import("./WFSSourceWorker-5SUETCHY.js"), WorkerTileHandler: () => import("./WorkerTileHandler-7QBE2FQM.js"), Lyr3DWorker: () => import("./Lyr3DWorker-UCMQNWXH.js") };
...
var E = class _E {
  static connect(e5, s5) {
    ...
    const n4 = new _E(t2.port1, { channel: t2, client: o4, schedule: s5 });
  ...
  apply(e5, t2, o4) {
    const a2 = o4 == null ? void 0 : o4.signal, h = o4 == null ? void 0 : o4.transferList;
    if (!this._port) return Promise.reject(new s(r, `Cannot call invoke('${e5}'), port is closed`, { methodName: e5, data: t2 }));
    const c5 = s4();
    return new Promise((s5, o5) => {
      if (c(a2)) return this._processWork(), void o5(u());
      const p = m(a2, () => {
        const e6 = this._outJobs.get(c5);
        e6 && (this._outJobs.delete(c5), this._processWork(), l(e6.abortHandle), this._post({ type: k, jobId: c5 }), o5(u()));
      }), _ = { resolve: s5, reject: o5, abortHandle: p, debugInfo: e5 };
      this._outJobs.set(c5, _), this._post({ type: j, jobId: c5, methodName: e5, abortable: null != a2 }, t2, h);
    });
  }
  ...
  on(e5, s5) {
    ...
    return this._port.postMessage({ type: e3.ON, eventType: e5, port: t2.port2 }, [t2.port2]), t2.port1.addEventListener("message", n4), t2.port1.start(), e(() => {
      t2.port1.postMessage({ type: e3.CLOSE }), t2.port1.close(), t2.port1.removeEventListener("message", n4);
    });
  }
  jobAdded() {
    this._processWork();
  ...
  _processWork() {
    ...
    if (!e5) return;
    const { methodName: s5, data: t2, invokeOptions: o4, resolver: n4 } = e5;
  ...
  _onInvokeMessage(e5) {
    const { methodName: s5, jobId: t2, data: o4 = [], abortable: n4 } = e5, r3 = n4 ? new AbortController() : null, i4 = this._inJobs;
    ...
    try {
      ...
      o4.push({ client: this, signal: r3 ? r3.signal : null }), l2 = p.apply(c5, o4);
    } catch (_) {
      return void this._post({ type: y, jobId: t2, error: i2(_) });
    }
    S(l2) ? (i4.set(t2, { controller: r3, promise: l2 }), l2.then((e6) => {
      i4.has(t2) && (i4.delete(t2), this._post({ type: y, jobId: t2 }, e6));
    }, (e6) => {
      i4.has(t2) && (i4.delete(t2), b(e6) || this._post({ type: y, jobId: t2, error: i2(e6 || { message: `Error encountered at method ${s5}` }) }));
    })) : this._post({ type: y, jobId: t2 }, l2);
  }
  _onOpenPortMessage(e5) {
    new _E(e5.port, { client: this._client });
  }
  _onOnMessage(e5) {
    const { port: s5 } = e5, o4 = this._client.on(e5.eventType, (e6) => {
      s5.postMessage(e6);
    }), n4 = o2(e5.port, "message", (e6) => {
      const t2 = f(e6);
      (t2 == null ? void 0 : t2.type) === e3.CLOSE && (n4.remove(), o4.remove(), s5.close());
    });
  }
  _onResponseMessage(e5) {
    const { jobId: t2, error: o4, data: r3 } = e5, i4 = this._outJobs;
    if (!i4.has(t2)) return;
    const l2 = i4.get(t2);
...
E.kernelInfo = { buildDate: e2, fullVersion: i, revision: c2 }, E.clients = /* @__PURE__ */ new Map();
...
var c4 = class {
  ...
  broadcast(e5, t2, s5) {
    ...
    for (let n4 = 0; n4 < this._clientPromises.length; ++n4) {
      ...
      i4[n4] = o4.then((i5) => i5 == null ? void 0 : i5.invoke(e5, t2, s5));
    }
    return i4;
  }
  close() {
    ...
    for (const t2 of this._clientPromises) t2.then((e6) => e6 == null ? void 0 : e6.close());
  ...
  apply(e5, t2, s5) {
    const n4 = L();
    this._ongoingJobsQueue.push({ methodName: e5, data: t2, invokeOptions: s5, resolver: n4 });
    for (let i4 = 0; i4 < this._clientPromises.length; i4++) {
      const e6 = this._clients[i4];
      e6 ? e6.jobAdded() : this._clientPromises[i4].then((e7) => e7 == null ? void 0 : e7.jobAdded());
    }
    return n4.promise;
  }
  createInvokeProxy(e5) {
...
//# sourceMappingURL=chunk-JJIIUFER.js.map
