...
var s = class extends ni {
  setupDefaultRules() {
    ...
    u("InterfaceColors").setAll({ stroke: Gt.fromHex(15066597), fill: Gt.fromHex(15987699), primaryButton: Gt.fromHex(6788316), primaryButtonHover: Gt.fromHex(6779356), primaryButtonDown: Gt.fromHex(6872182), primaryButtonActive: Gt.fromHex(6872182), primaryButtonText: Gt.fromHex(16777215), primaryButtonStroke: Gt.fromHex(16777215), secondaryButton: Gt.fromHex(14277081), secondaryButtonHover: Gt.fromHex(10724259), secondaryButtonDown: Gt.fromHex(9276813), secondaryButtonActive: Gt.fromHex(15132390), secondaryButtonText: Gt.fromHex(0), secondaryButtonStroke: Gt.fromHex(16777215), grid: Gt.fromHex(0), background: Gt.fromHex(16777215), alternativeBackground: Gt.fromHex(0), text: Gt.fromHex(0), alternativeText: Gt.fromHex(16777215), disabled: Gt.fromHex(11382189), positive: Gt.fromHex(5288704), negative: Gt.fromHex(11730944) });
    {
      const e2 = u("ColorSet");
      e2.setAll({ passOptions: { hue: 0.05, saturation: 0, lightness: 0 }, colors: [Gt.fromHex(6797276)], step: 1, reuse: false, startIndex: 0 }), e2.setPrivate("currentStep", 0), e2.setPrivate("currentPass", 0);
    }
    u("Entity").setAll({ stateAnimationDuration: 0, stateAnimationEasing: we(ye) }), u("Component").setAll({ interpolationDuration: 0, interpolationEasing: we(ye) }), u("Sprite").setAll({ visible: true, scale: 1, opacity: 1, rotation: 0, position: "relative", tooltipX: a, tooltipY: a, tooltipPosition: "fixed", isMeasured: true }), u("Sprite").states.create("default", { visible: true, opacity: 1 }), u("Container").setAll({ interactiveChildren: true, setStateOnChildren: false }), u("Graphics").setAll({ strokeWidth: 1 }), u("Chart").setAll({ width: r, height: r, interactiveChildren: false }), u("ZoomableContainer").setAll({ width: r, height: r, wheelable: true, pinchZoom: true, maxZoomLevel: 32, minZoomLevel: 1, zoomStep: 2, animationEasing: we(ye), animationDuration: 600 }), u("Sprite", ["horizontal", "center"]).setAll({ centerX: a, x: a }), u("Sprite", ["vertical", "center"]).setAll({ centerY: a, y: a }), u("Container", ["horizontal", "layout"]).setAll({ layout: d }), u("Container", ["vertical", "layout"]).setAll({ layout: c }), u("Pattern").setAll({ repetition: "repeat", width: 50, height: 50, rotation: 0, fillOpacity: 1 }), u("LinePattern").setAll({ gap: 6, colorOpacity: 1, width: 49, height: 49 }), u("RectanglePattern").setAll({ gap: 6, checkered: false, centered: true, maxWidth: 5, maxHeight: 5, width: 48, height: 48, strokeWidth: 0 }), u("CirclePattern").setAll({ gap: 5, checkered: false, centered: false, radius: 3, strokeWidth: 0, width: 45, height: 45 }), u("GrainPattern").setAll({ width: 200, height: 200, colors: [Gt.fromHex(0)], size: 1, horizontalGap: 0, verticalGap: 0, density: 1, minOpacity: 0, maxOpacity: 0.2 }), u("LinearGradient").setAll({ rotation: 90 }), u("Legend").setAll({ fillField: "fill", strokeField: "stroke", nameField: "name", layout: Je.new(this._root, {}), layer: 30, clickTarget: "itemContainer" }), u("Container", ["legend", "item", "itemcontainer"]).setAll({ paddingLeft: 5, paddingRight: 5, paddingBottom: 5, paddingTop: 5, layout: d, setStateOnChildren: true, interactiveChildren: false, ariaChecked: true, focusable: true, ariaLabel: e.translate("Press ENTER to toggle"), role: "checkbox" });
    {
    ...
    u("Graphics", ["switch", "icon"]).states.create("active", { dx: 16 }), u("Scrollbar").setAll({ start: 0, end: 1, layer: 30, animationEasing: we(ye) }), u("Scrollbar", ["vertical"]).setAll({ marginRight: 13, marginLeft: 13, minWidth: 12, height: r }), u("Scrollbar", ["horizontal"]).setAll({ marginTop: 13, marginBottom: 13, minHeight: 12, width: r }), this.rule("Button", ["scrollbar"]).setAll({ exportable: false });
    {
...
//# sourceMappingURL=chunk-5ZIAX347.js.map
