  ...
  _buildAttributesInfo() {
    ...
    for (const o2 of c3) {
      ...
      for (let e4 = 0; e4 < c4; e4++) {
        ...
        let f5 = s[u4], l5 = 0;
        if (!f5 || f5.count + o3 > 4) i6++, f5 = { dataIndex: i6, count: 0, offset: 0 }, 4 !== o3 && (s[u4] = f5), t6.push({ location: -1, name: "a_data_" + i6, count: o3, type: e5, normalized: a7 }), l5 = Math.ceil(Math.max(c5 / 4, 1));
        else {
...
var gt = { array: lt, boolean: lt, collator: null, format: null, image: null, literal: ct, number: lt, "number-format": null, object: lt, string: lt, "to-boolean": ut, "to-color": ut, "to-number": ut, "to-string": ut, typeof: ht, accumulated: null, "feature-state": null, "geometry-type": b2, id: v, "line-progress": null, properties: d2, at: O, get: F, has: G, in: V, "index-of": D, length: H, slice: J, "!": N3, "!=": M, "<": k2, "<=": A2, "==": $, ">": j2, ">=": q, all: C2, any: R3, case: I2, coalesce: L2, match: U, within: null, interpolate: P2, "interpolate-hcl": P2, "interpolate-lab": P2, step: S, let: B, var: T3, concat: st, downcase: nt, "is-supported-script": null, "resolved-locale": null, upcase: nt, rgb: at, rgba: ot, "to-rgba": it, "-": W, "*": X, "/": Y, "%": Z, "^": tt, "+": et, abs: rt, acos: rt, asin: rt, atan: rt, ceil: rt, cos: rt, e: rt, floor: rt, ln: rt, ln2: rt, log10: rt, log2: rt, max: rt, min: rt, pi: rt, round: rt, sin: rt, sqrt: rt, tan: rt, zoom: x, "heatmap-density": null, "has-id": K, none: z };
...
//# sourceMappingURL=chunk-6JPHDDUC.js.map
