...
function u(t4, a2) {
  ...
  if (a2.length < e4.minParams || a2.length > e4.maxParams) throw new n3(t2.InvalidParameterCount, { name: t4.toUpperCase() });
...
function T(n5, e4) {
  if (e4 instanceof Zone) return e4 === t.instance ? DateTime.fromMillis(n5.getTime(), { zone: t.instance }) : DateTime.fromJSDate(n5, { zone: e4 });
  switch (e4) {
    case "system":
    case "local":
    case null:
...
function w3(e4, t4, r5) {
  ...
  if (t4.length < l3.minParams || t4.length > l3.maxParams) throw new n3(t2.InvalidParameterCount, { name: e4.toUpperCase() });
...
n4 = function() {
  ...
  function e4(r6, n6) {
    ...
    function Du(t5) {
      ...
      for (e6 = { line: (e6 = Ru[n7]).line, column: e6.column }; n7 < t5; ) 10 === r6.charCodeAt(n7) ? (e6.line++, e6.column = 1) : e6.column++, n7++;
      return Ru[t5] = e6, e6;
    }
    function ju(r7, t5, n7) {
      var e6 = Du(r7), u5 = Du(t5);
      return { source: o5, start: { offset: r7, line: e6.line, column: e6.column }, end: { offset: t5, line: u5.line, column: u5.column } };
    }
    function Zu(r7) {
  ...
  _evaluateNode(o5, c3, h4, p4) {
    ...
    switch (o5.type) {
      ...
      case "number":
        return o5.value;
      case "date":
        return o5.parsedValue ?? (o5.parsedValue = V(o5.value, "unknown")), o5.parsedValue;
      case "timestamp":
        return o5.parsedValue ?? (o5.parsedValue = P2(o5.value, "unknown")), o5.parsedValue;
      case "time":
        return O(o5.value);
      case "current-time":
      ...
      case "function": {
        if (this.isAggregate && o3(o5.name, o5.args.value.length)) {
          const e5 = [];
          for (const t4 of ((_a = o5.args) == null ? void 0 : _a.value) || []) {
            const a2 = [];
    ...
    throw new n3(t2.UnsupportedSyntax, { node: o5.type });
  }
};
function F2(e4) {
  return true === e4;
...
var M4 = { getAttribute: (e4, t4) => (C3(e4) ? e4.attributes : e4)[t4] };
...
//# sourceMappingURL=chunk-DDQ2RCGU.js.map
