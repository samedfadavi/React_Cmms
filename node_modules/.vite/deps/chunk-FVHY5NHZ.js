...
var f = class extends t {
  ...
  _test(g) {
    ...
    const w = new E2(f2, l), v = c.createVertex(f2, F.STATIC_DRAW, new Uint16Array([0, 0, 1, 0, 0, 1, 1, 1])), x = new o(f2, /* @__PURE__ */ new Map([["a_pos", 0]]), m, { geometry: v }), h = new e();
...
//# sourceMappingURL=chunk-FVHY5NHZ.js.map
