...
function E2(e4) {
  if (e4 == null ? void 0 : e4.length) return e4[0];
}
...
var R = g = class extends o.EventedAccessor {
  ...
  constructor(e4) {
    super(e4), this._chgListeners = [], this._notifications = null, this._updating = false, this._timer = null, this._observable = new s2(), this.length = 0, this._items = [], Object.defineProperty(this, "uid", { value: j++ });
  }
  ...
  *[Symbol.iterator]() {
  ...
  addMany(e4, t2 = this._items.length) {
    if (s(this._observable), !(e4 == null ? void 0 : e4.length)) return this;
  ...
  removeMany(e4) {
    if (s(this._observable), !(e4 == null ? void 0 : e4.length) || this._emitBeforeChanges(E.REMOVE)) return [];
  ...
  _splice(e4, t2, s3) {
    ...
    let n2, h;
    if (!this._notifications && this.hasEventListener("change") && (this._notifications = [{ listeners: this._chgListeners.slice(), items: this._items.slice(), changes: [] }], this._timer && this._timer.remove(), this._updating = true, this._timer = v(() => this._dispatchChange())), e4 < 0 && (e4 += this.length), t2) {
...
R.ofType = (t2) => {
  ...
  return e([n({ Type: t2, ensureType: "function" == typeof t2 ? b(t2) : T(t2) })], i.prototype, "itemType", void 0), i = e([a2(`esri.core.Collection<${s3}>`)], i), x.set(t2, i), i;
}, e([y()], R.prototype, "_updating", void 0), e([y()], R.prototype, "length", void 0), e([y()], R.prototype, "items", null), e([y({ readOnly: true })], R.prototype, "updating", null), R = g = e([a2("esri.core.Collection")], R);
var V = R;
...
//# sourceMappingURL=chunk-3DBICPHD.js.map
