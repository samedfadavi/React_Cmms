...
function I(t, i2) {
  const s4 = [], { ymin: n, ymax: e, xmin: h, xmax: o } = t, u3 = t.xmax - t.xmin, [r2, m2] = i2.valid, { x, frameId: _ } = g2(t.xmin, i2), { x: l2, frameId: c } = g2(t.xmax, i2), p2 = x === l2 && u3 > 0;
  if (u3 > 2 * m2) {
    const t2 = { xmin: h < o ? x : l2, ymin: n, xmax: m2, ymax: e }, i3 = { xmin: r2, ymin: n, xmax: h < o ? l2 : x, ymax: e }, u4 = { xmin: 0, ymin: n, xmax: m2, ymax: e }, p3 = { xmin: r2, ymin: n, xmax: 0, ymax: e }, a4 = [], f3 = [];
  ...
  } else x > l2 || p2 ? s4.push(new P({ xmin: x, ymin: n, xmax: m2, ymax: e }, [_]), new P({ xmin: r2, ymin: n, xmax: l2, ymax: e }, [c])) : s4.push(new P({ xmin: x, ymin: n, xmax: l2, ymax: e }, [_]));
  return s4;
}
function g2(t, i2) {
...
//# sourceMappingURL=chunk-45NMBCKP.js.map
