...
async function W(e, t, r, n3 = {}) {
  const { featureType: a, extent: o4 } = await X(e, t, r, n3), { spatialReference: i } = oe(e.operations.GetFeature.url, a, n3.spatialReference), { fields: s2, geometryType: p2, swapXY: u2, objectIdField: l, geometryField: c } = await q(e, a, i, n3);
  return { url: e.operations.GetCapabilities.url, name: a.name, namespaceUri: a.namespaceUri, fields: s2, geometryField: c, geometryType: p2, objectIdField: l, spatialReference: n3.spatialReference ?? new f({ wkid: a.defaultSpatialReference }), extent: o4, swapXY: u2, wfsCapabilities: e, customParameters: n3.customParameters };
}
async function X(e, r, n3, a = {}) {
  const o4 = e.readFeatureTypes(), i = r ? Y(o4, r, n3) : o4.next().value, { spatialReference: u2 = new f({ wkid: i == null ? void 0 : i.defaultSpatialReference }) } = a;
...
async function q(e, r, n3, a = {}) {
  var _a, _b, _c;
  const { typeName: o4 } = r, [i, s2] = await Promise.allSettled([J(e.operations.DescribeFeatureType.url, o4, a), _(e, o4, n3, a)]), p2 = (e2) => new s(x, `An error occurred while getting info about the feature type '${o4}'`, { error: e2 });
...
async function _(t, r, n3, a = {}) {
  var _a;
  let o4, i = false;
  const [s2, p2] = await Promise.all([K3(t.operations.GetFeature.url, r, n3, t.operations.GetFeature.outputFormat, { ...a, count: 1 }), U(t.operations.GetFeature.url, { responseType: "text", query: Z(r, n3, void 0, { ...a, count: 1 }), signal: a == null ? void 0 : a.signal })]), u2 = "FeatureCollection" === s2.type && ((_a = s2.features[0]) == null ? void 0 : _a.geometry);
  if (u2) {
    let e;
...
async function K3(r, n3, a, o4, i) {
  ...
  try {
    ...
    throw new s(P, "Error while parsing the response", { response: s2, error: p2 });
  }
}
function Z(e, t, r, n3) {
...
//# sourceMappingURL=chunk-UZK3WY3W.js.map
