...
import {
  s as s7,
  s2 as s8
} from "./chunk-I7VQ35HP.js";
import {
  s as s9
} from "./chunk-4TEPLCXX.js";
import "./chunk-TPYC4AVC.js";
import {
  A as A2,
  B2 as B,
  G,
...
function b4(e5) {
  const n14 = (e5 == null ? void 0 : e5.Raster) ?? (e5 == null ? void 0 : e5.raster);
...
function T(e5, t6) {
  ...
  const c22 = "arithmetic" === e5.rotationType ? 1 : 2, f8 = "flow-from" === e5.flowRepresentation ? 0 : 1, p21 = e5.visualVariables ? e5.visualVariables.find((e6) => "Magnitude" === e6.field) : new b2(), g6 = { magnitudeBandID: s11, directionBandID: u6, isUVComponents: i11, referenceSystem: c22, massFlowAngleRepresentation: f8, symbolTileSize: 50, symbolTileSizeUnits: 100, calculationMethod: "Vector Average", symbologyName: m3[e5.style.toLowerCase().replace("-", "_")], minimumMagnitude: p21.minDataValue, maximumMagnitude: p21.maxDataValue, minimumSymbolSize: p21.minSize, maximumSymbolSize: p21.maxSize };
  r2.functionArguments = g6;
  const d12 = h2(r2);
  return t6.convertToRFT ? N2.fromJSON({ rasterFunctionDefinition: d12 }) : r2;
}
function v(e5, t6) {
  ...
  const s11 = "traditional" === e5.hillshadeType ? 0 : 1, u6 = "none" === e5.scalingType ? 1 : 3, l13 = { HillshadeType: s11, SlopeType: u6, ZFactor: e5.zFactor };
  return 0 === s11 && (l13.Azimuth = e5.azimuth, l13.Altitude = e5.altitude), 3 === u6 && (l13.PSPower = e5.pixelSizePower, l13.PSZFactor = e5.pixelSizeFactor), i11.functionArguments = l13, i11.variableName = "Raster", e5.colorRamp && (i11.functionName = "ShadedRelief", r2 ? l13.ColorRamp = G(e5.colorRamp) : l13.Colormap = B(e5.colorRamp)), r2 ? new N2({ rasterFunctionDefinition: h2(i11) }) : i11;
}
function w3(e5, t6) {
  var _a;
  const r2 = t6.convertToRFT, s11 = new N2();
  s11.functionName = "Stretch";
  const l13 = R2[n5.toJSON(e5.stretchType)], c22 = "u8", m12 = { StretchType: l13, Statistics: V(e5.statistics ?? []), DRA: e5.dynamicRangeAdjustment, UseGamma: e5.useGamma, Gamma: e5.gamma, ComputeGamma: e5.computeGamma };
  if (null != e5.outputMin && (m12.Min = e5.outputMin), null != e5.outputMax && (m12.Max = e5.outputMax), l13 === R2.standardDeviation ? (m12.NumberOfStandardDeviations = e5.numberOfStandardDeviations, s11.outputPixelType = c22) : l13 === R2.percentClip ? (m12.MinPercent = e5.minPercent, m12.MaxPercent = e5.maxPercent, s11.outputPixelType = c22) : l13 === R2.minMax ? s11.outputPixelType = c22 : l13 === R2.sigmoid && (m12.SigmoidStrengthLevel = e5.sigmoidStrengthLevel), s11.functionArguments = m12, s11.variableName = "Raster", e5.colorRamp) {
    ...
    if (r2) l14.functionArguments = { ColorRamp: G(u6) };
    else {
      const n14 = d3(u6, true);
      if (n14) l14.functionArguments = { colorRampName: n14 };
      else if (!t6.convertColorRampToColormap || "algorithmic" !== u6.type && "multipart" !== u6.type) {
        const n15 = e5.colorRamp.toJSON();
        "algorithmic" === n15.type ? n15.algorithm = n15.algorithm || "esriCIELabAlgorithm" : "multipart" === n15.type && ((_a = n15.colorRamps) == null ? void 0 : _a.length) && n15.colorRamps.forEach((e6) => e6.algorithm = e6.algorithm || "esriCIELabAlgorithm"), l14.functionArguments = { colorRamp: n15 };
      } else l14.functionArguments = { Colormap: B(u6) };
    }
    return l14.variableName = "Raster", l14.functionName = "Colormap", l14.functionArguments.Raster = s11, r2 ? new N2({ rasterFunctionDefinition: h2(l14) }) : l14;
  }
  return r2 ? new N2({ rasterFunctionDefinition: h2(s11) }) : s11;
}
function S2(e5, t6) {
  const r2 = [], o3 = [], a14 = [], i11 = [], s11 = 1e-4, { pixelType: u6, rasterAttributeTable: l13 } = t6, c22 = null == l13 ? null : l13.features, m12 = C(l13);
  if (m12 && c22 && Array.isArray(c22) && e5.classBreakInfos) {
    e5.classBreakInfos.forEach((n14, t7) => {
      var _a;
      const r4 = (_a = n14.symbol) == null ? void 0 : _a.color;
      let o5;
      (r4 == null ? void 0 : r4.a) && null != n14.minValue && null != n14.maxValue && c22.forEach((a15) => {
    ...
    return o4.functionName = "Colormap", o4.functionArguments = {}, o4.functionArguments.Colormap = r3, o4.variableName = "Raster", t6.convertToRFT ? new N2({ rasterFunctionDefinition: h2(o4) }) : o4;
  }
  e5.classBreakInfos.forEach((e6, n14) => {
    if (null == e6.minValue || null == e6.maxValue) return;
    const t7 = e6.symbol && e6.symbol.color;
    (t7 == null ? void 0 : t7.a) ? (0 === n14 ? r2.push(e6.minValue, e6.maxValue + s11) : r2.push(e6.minValue + s11, e6.maxValue + s11), o3.push(n14), i11.push([n14, t7.r, t7.g, t7.b])) : a14.push(e6.minValue, e6.maxValue);
  });
  const f8 = u6 ? x(i11, u6) : i11, p21 = new N2();
  p21.functionName = "Remap", p21.functionArguments = { InputRanges: r2, OutputValues: o3, NoDataRanges: a14 }, p21.variableName = "Raster";
  const g6 = new N2();
  return g6.functionName = "Colormap", g6.functionArguments = { Colormap: f8, Raster: p21 }, t6.convertToRFT ? new N2({ rasterFunctionDefinition: h2(g6) }) : g6;
}
function x(e5, n14) {
...
function C(e5) {
  if (null == e5) return;
  const { fields: n14 } = e5, t6 = n14 == null ? void 0 : n14.find((e6) => (e6 == null ? void 0 : e6.name) && "value" === e6.name.toLowerCase());
  return t6 == null ? void 0 : t6.name;
}
function F(e5, t6) {
  var _a, _b;
  const r2 = [], { pixelType: o3, rasterAttributeTable: a14 } = t6, i11 = null == a14 ? null : a14.features, s11 = C(a14), u6 = (_b = (_a = e5.defaultSymbol) == null ? void 0 : _a.color) == null ? void 0 : _b.toRgb(), l13 = e5.uniqueValueInfos;
  if (l13) if (i11) {
    if (s11) {
      const n14 = /* @__PURE__ */ new Map();
      l13.forEach((e6) => {
        const t8 = e6.value, r3 = A3(e6);
        null != t8 && (r3 == null ? void 0 : r3.a) && n14.set(String(t8), r3.toRgb());
      });
      const t7 = e5.field;
      t7 && i11.forEach(({ attributes: e6 }) => {
  ...
  return m12.functionName = "Colormap", m12.functionArguments = {}, m12.functionArguments.Colormap = c22, m12.variableName = "Raster", t6.convertToRFT ? new N2({ rasterFunctionDefinition: h2(m12) }) : m12;
}
function A3(e5) {
  var _a, _b, _c, _d, _e;
...
function N3(e5, t6) {
  ...
  const { pixelType: o3 } = t6, a14 = o3 ? x(r2, o3) : r2, i11 = new N2();
  return i11.functionName = "Colormap", i11.functionArguments = {}, i11.functionArguments.Colormap = a14, t6.convertToRFT ? new N2({ rasterFunctionDefinition: h2(i11) }) : i11;
}
function V(e5) {
  const n14 = [];
  return e5 == null ? void 0 : e5.forEach((e6) => {
    const t6 = e6;
...
var y6 = class extends f {
  ...
  get mosaicRule() {
    ...
    return t6 ? r2 && r2 !== t6.where && (t6 = t6.clone(), t6.where = r2) : r2 && (t6 = new j5({ where: r2 })), t6;
  }
  get rasterFunction() {
    var _a, _b;
    const e5 = this.layer;
    ...
    const i11 = (_a = e5.multidimensionalSubset) == null ? void 0 : _a.areaOfInterest;
    return i11 && (t6 = d9(t6, i11)), o3 && !r2 && "vector-field" !== ((_b = e5.renderer) == null ? void 0 : _b.type) && (t6 = this.combineRendererWithRenderingRule(t6)), t6;
  }
  combineRendererWithRenderingRule(e5) {
    ...
    return g4(y5(o3, { rasterAttributeTable: r2.attributeTable, pixelType: r2.pixelType, dataType: r2.dataType, bandNames: r2.bandInfos.map(({ name: e6 }) => e6), convertColorRampToColormap: t6.version < 10.6, convertToRFT: !!(e5 == null ? void 0 : e5.rasterFunctionDefinition), bandCount: r2.bandCount }), e5);
  }
...
e([y({ type: _, json: { read: true } })], i5.prototype, "fromGeometry", void 0), e([y({ type: _, json: { read: true, write: true } })], i5.prototype, "toGeometry", void 0), e([y({ json: { write: true } })], i5.prototype, "objectIds", void 0), e([y({ type: String, json: { write: true } })], i5.prototype, "where", void 0), e([y({ type: Number, json: { write: true } })], i5.prototype, "maxCount", void 0), i5 = e([a3("esri.rest.support.FindImagesParameters")], i5);
var m4 = i5;
...
var s10 = (s11) => {
  ...
  return e([y({ json: { write: true } })], e5.prototype, "make", void 0), e([y({ json: { write: true } })], e5.prototype, "model", void 0), e([y({ json: { write: true } })], e5.prototype, "focalLength", void 0), e([y({ json: { write: true } })], e5.prototype, "pixelSize", void 0), e([y({ json: { write: true } })], e5.prototype, "rows", void 0), e([y({ json: { write: true } })], e5.prototype, "cols", void 0), e5 = e([a3("esri.rest.support.CameraInfoMixin")], e5), e5;
};
...
e([y({ json: { write: true } })], n7.prototype, "id", void 0), e([y({ json: { name: "uri", write: true } })], n7.prototype, "referenceUri", void 0), e([y({ type: Date, json: { write: true } })], n7.prototype, "acquisitionDate", void 0), e([r("acquisitionDate")], n7.prototype, "writeAcquisitionDate", null), e([y({ json: { write: true } })], n7.prototype, "cameraID", void 0), e([y({ type: _, json: { write: true } })], n7.prototype, "center", void 0), e([y({ type: _, json: { write: true } })], n7.prototype, "perspectiveCenter", void 0), e([y({ json: { write: true } })], n7.prototype, "orientation", void 0), n7 = e([a3("esri.rest.support.ImageInspectionInfo")], n7);
var c6 = n7;
...
e([y({ type: [c6], json: { write: true } })], p7.prototype, "images", void 0), p7 = e([a3("esri.rest.support.FindImagesResult")], p7);
var c7 = p7;
...
e([y({ type: [String], json: { name: "angleName", write: true } })], m5.prototype, "angleNames", void 0), e([y({ type: _, json: { write: true } })], m5.prototype, "point", void 0), e([y({ type: f2, json: { write: true } })], m5.prototype, "spatialReference", void 0), e([y({ type: N, json: { write: true } })], m5.prototype, "rasterId", void 0), m5 = n8 = e([a3("esri.rest.support.ImageAngleParameters")], m5);
var l6 = m5;
...
e([y({ type: Number, json: { write: true } })], p8.prototype, "north", void 0), e([y({ type: Number, json: { write: true } })], p8.prototype, "up", void 0), e([y({ type: f2, json: { write: true } })], p8.prototype, "spatialReference", void 0), p8 = e([a3("esri.rest.support.ImageAngleResult")], p8);
var i6 = p8;
...
e([y()], p9.prototype, "type", void 0), e([y({ type: a6.apiValues, json: { read: a6.read, write: a6.write } })], p9.prototype, "measureOperation", void 0), e([y({ type: j5, json: { write: true } })], p9.prototype, "mosaicRule", void 0), e([y({ type: _, json: { write: true } })], p9.prototype, "pixelSize", void 0), e([y({ json: { write: true } })], p9.prototype, "raster", void 0), p9 = e([a3("esri.rest.support.BaseImageMeasureParameters")], p9);
...
var u2 = c8 = class extends p9 {
  ...
  clone() {
    return new c8(a({ geometry: this.geometry, is3D: this.is3D, linearUnit: this.linearUnit, areaUnit: this.areaUnit, mosaicRule: this.mosaicRule, pixelSize: this.pixelSize, raster: this.raster }));
  }
};
e([y({ types: n3, json: { name: "fromGeometry", read: true, write: true } })], u2.prototype, "geometry", void 0), e([r("geometry")], u2.prototype, "writeGeometry", null), e([y({ type: a6.apiValues, json: { write: a6.write } })], u2.prototype, "measureOperation", null), e([y({ json: { read: true } })], u2.prototype, "is3D", void 0), e([y({ type: String, json: { read: me.read, write: me.write } })], u2.prototype, "linearUnit", void 0), e([y({ type: String, json: { read: oe.read, write: oe.write } })], u2.prototype, "areaUnit", void 0), u2 = c8 = e([a3("esri.rest.support.ImageAreaParameters")], u2);
var y7 = u2;
...
e([y({ type: Number, json: { read: true, write: true } })], i7.prototype, "value", void 0), e([y({ type: String, json: { read: true, write: true } })], i7.prototype, "displayValue", void 0), e([y({ type: Number, json: { read: true, write: true } })], i7.prototype, "uncertainty", void 0), i7 = e([a3("esri.rest.support.BaseImageMeasureResult.BaseImageMeasureResultValue")], i7);
var p10 = class extends i7 {
  constructor() {
    super(...arguments), this.unit = null;
  }
};
e([y({ type: String, json: { read: me.read, write: me.write } })], p10.prototype, "unit", void 0), p10 = e([a3("esri.rest.support.BaseImageMeasureResult.ImageMeasureResultLengthValue")], p10);
var n9 = class extends i7 {
  constructor() {
    super(...arguments), this.unit = null;
  }
};
e([y({ type: String, json: { read: oe.read, write: oe.write } })], n9.prototype, "unit", void 0), n9 = e([a3("esri.rest.support.BaseImageMeasureResult.ImageMeasureResultAreaValue")], n9);
var l7 = class extends i7 {
  constructor() {
    super(...arguments), this.unit = null;
  }
};
e([y({ type: String, json: { read: fe.read, write: fe.write } })], l7.prototype, "unit", void 0), l7 = e([a3("esri.rest.support.BaseImageMeasureResult.ImageMeasureResultAngleValue")], l7);
var c9 = class extends f {
  constructor() {
    super(...arguments), this.name = null, this.sensorName = null;
  }
};
e([y({ type: String, json: { read: true, write: true } })], c9.prototype, "name", void 0), e([y({ type: String, json: { read: true, write: true } })], c9.prototype, "sensorName", void 0), c9 = e([a3("esri.rest.support.BaseImageMeasureResult")], c9);
...
e([y({ type: n9, json: { read: true, write: true } })], a7.prototype, "area", void 0), e([y({ type: p10, json: { read: true, write: true } })], a7.prototype, "perimeter", void 0), a7 = e([a3("esri.rest.support.ImageAreaResult")], a7);
var c10 = a7;
...
e([y({ type: f2, json: { name: "outSR", write: true } })], a8.prototype, "outSpatialReference", void 0), a8 = e([a3("esri.rest.support.ImageBoundaryParameters")], a8);
var c11 = a8;
...
e([y({ type: Number, json: { write: true } })], a9.prototype, "area", void 0), e([y({ json: { name: "shape", write: true } })], a9.prototype, "geometry", void 0), e([o("geometry")], a9.prototype, "readGeometry", null), a9 = e([a3("esri.rest.support.ImageBoundaryResult")], a9);
var c12 = a9;
...
e([y({ type: _, json: { read: true, write: true } })], c13.prototype, "fromGeometry", void 0), e([r("fromGeometry")], c13.prototype, "writeFromGeometry", null), e([y({ type: _, json: { read: true, write: true } })], c13.prototype, "toGeometry", void 0), e([y({ type: a6.apiValues, json: { write: a6.write } })], c13.prototype, "measureOperation", null), e([y({ json: { read: true } })], c13.prototype, "is3D", void 0), e([y({ type: String, json: { read: me.read, write: me.write } })], c13.prototype, "linearUnit", void 0), e([y({ type: String, json: { read: fe.read, write: fe.write } })], c13.prototype, "angularUnit", void 0), c13 = y8 = e([a3("esri.rest.support.ImageDistanceParameters")], c13);
var u3 = c13;
...
e([y({ type: p10, json: { read: true, write: true } })], a10.prototype, "distance", void 0), e([y({ type: l7, json: { read: true, write: true } })], a10.prototype, "azimuthAngle", void 0), e([y({ type: l7, json: { read: true, write: true } })], a10.prototype, "elevationAngle", void 0), a10 = e([a3("esri.rest.support.ImageDistanceResult")], a10);
var i8 = a10;
...
e([y({ types: n3, json: { read: y2, write: true } })], j6.prototype, "geometry", void 0), e([r("geometry")], j6.prototype, "writeGeometry", null), e([y({ json: { write: true } })], j6.prototype, "objectIds", void 0), e([o2(s4, { ignoreUnknown: false, name: "spatialRel" })], j6.prototype, "spatialRelationship", void 0), e([y({ type: c, json: { name: "time", write: true } })], j6.prototype, "timeExtent", void 0), e([y({ type: String, json: { write: true } })], j6.prototype, "where", void 0), j6 = e([a3("esri.rest.support.ImageGPSInfoParameters")], j6);
var y9 = j6;
...
e([y({ json: { write: true } })], p11.prototype, "id", void 0), p11 = e([a3("esri.rest.support.CameraInfo")], p11);
var c14 = p11;
...
e([y({ json: { write: true } })], p12.prototype, "id", void 0), e([y({ json: { write: true } })], p12.prototype, "name", void 0), e([y({ type: Date, json: { write: true } })], p12.prototype, "acquisitionDate", void 0), e([r("acquisitionDate")], p12.prototype, "writeAcquisitionDate", null), e([y({ json: { write: true } })], p12.prototype, "cameraID", void 0), e([y({ type: _, json: { write: true } })], p12.prototype, "center", void 0), e([y({ json: { write: true } })], p12.prototype, "gps", void 0), e([y({ json: { write: true } })], p12.prototype, "orientation", void 0), p12 = e([a3("esri.rest.support.ImageGPSInfo")], p12);
var n10 = p12;
...
e([y({ type: [n10], json: { write: true } })], m6.prototype, "images", void 0), e([y({ type: [c14], json: { write: true } })], m6.prototype, "cameras", void 0), m6 = e([a3("esri.rest.support.ImageGPSInfoResult")], m6);
var a11 = m6;
...
e([y({ type: _, json: { read: true } })], l8.prototype, "fromGeometry", void 0), e([r("fromGeometry")], l8.prototype, "writeFromGeometry", null), e([y({ type: _, json: { read: true, write: true } })], l8.prototype, "toGeometry", void 0), e([y({ type: a6.apiValues, json: { write: a6.write } })], l8.prototype, "measureOperation", null), e([y({ json: { read: true } })], l8.prototype, "operationType", void 0), e([y({ type: String, json: { read: me.read, write: me.write } })], l8.prototype, "linearUnit", void 0), l8 = y10 = e([a3("esri.rest.support.ImageHeightParameters")], l8);
var c15 = l8;
...
e([y({ type: p10, json: { read: true, write: true } })], p13.prototype, "height", void 0), p13 = e([a3("esri.rest.support.ImageHeightResult")], p13);
var c16 = p13;
...
var g5 = y11 = class extends f {
  ...
  set mosaicRule(t6) {
    let e5 = t6;
    (e5 == null ? void 0 : e5.mosaicMethod) && (e5 = j5.fromJSON({ ...e5.toJSON(), mosaicMethod: e5.mosaicMethod, mosaicOperation: e5.mosaicOperation })), this._set("mosaicRule", e5);
  }
  writeMosaicRule(t6, e5, r2) {
    null != t6 && (e5[r2] = JSON.stringify(t6.toJSON()));
  }
  get renderingRule() {
    return i(n.getLogger(this), "renderingRule", { replacement: "rasterFunction", version: "4.27", warnOnce: true }), this._get("rasterFunction");
  }
  set renderingRule(t6) {
    i(n.getLogger(this), "renderingRule", { replacement: "rasterFunction", version: "4.27", warnOnce: true }), this._set("rasterFunction", t6);
  }
  get renderingRules() {
    return i(n.getLogger(this), "renderingRules", { replacement: "rasterFunctions", version: "4.27", warnOnce: true }), this._get("rasterFunctions");
  }
  set renderingRules(t6) {
    i(n.getLogger(this), "renderingRules", { replacement: "rasterFunctions", version: "4.27", warnOnce: true }), this._set("rasterFunctions", t6);
  }
  set rasterFunction(t6) {
    let e5 = t6;
    (e5 == null ? void 0 : e5.rasterFunction) && (e5 = N2.fromJSON({ ...e5.toJSON(), rasterFunction: e5.rasterFunction, rasterFunctionArguments: e5.rasterFunctionArguments })), this._set("rasterFunction", e5);
  }
...
e([y({ json: { write: true } })], g5.prototype, "geometry", void 0), e([r("geometry")], g5.prototype, "writeGeometry", null), e([y({ type: j5, json: { write: true } })], g5.prototype, "mosaicRule", null), e([r("mosaicRule")], g5.prototype, "writeMosaicRule", null), e([y({ type: N2 })], g5.prototype, "renderingRule", null), e([y({ type: [N2] })], g5.prototype, "renderingRules", null), e([y({ type: N2, json: { write: true, name: "renderingRule" } })], g5.prototype, "rasterFunction", null), e([r("rasterFunction")], g5.prototype, "writeRasterFunction", null), e([y({ type: [N2], json: { write: true, name: "renderingRules" } })], g5.prototype, "rasterFunctions", void 0), e([r("rasterFunctions")], g5.prototype, "writeRasterFunctions", null), e([y({ type: _, json: { write: true } })], g5.prototype, "pixelSize", void 0), e([r("pixelSize")], g5.prototype, "writePixelSize", null), e([y({ type: Boolean, json: { write: true } })], g5.prototype, "returnGeometry", void 0), e([y({ type: Boolean, json: { write: true } })], g5.prototype, "returnCatalogItems", void 0), e([y({ type: Boolean, json: { write: true } })], g5.prototype, "returnPixelValues", void 0), e([y({ type: Number, json: { write: true } })], g5.prototype, "maxItemCount", void 0), e([y({ type: c, json: { write: { target: "time" } } })], g5.prototype, "timeExtent", void 0), e([r("timeExtent")], g5.prototype, "writeTimeExtent", null), e([y({ json: { write: true } })], g5.prototype, "raster", void 0), e([y({ json: { write: true } })], g5.prototype, "viewId", void 0), e([y({ type: Boolean, json: { write: true } })], g5.prototype, "processAsMultidimensional", void 0), g5 = y11 = e([a3("esri.rest.support.ImageIdentifyParameters")], g5);
var d10 = g5;
...
e([y({ json: { write: true } })], p14.prototype, "catalogItemVisibilities", void 0), e([y({ type: d4, json: { write: true } })], p14.prototype, "catalogItems", void 0), e([y({ type: _, json: { write: true } })], p14.prototype, "location", void 0), e([y({ json: { write: true } })], p14.prototype, "name", void 0), e([y({ json: { write: true } })], p14.prototype, "objectId", void 0), e([y({ json: { write: true } })], p14.prototype, "processedValues", void 0), e([y({ json: { write: true } })], p14.prototype, "properties", void 0), e([y({ json: { write: true } })], p14.prototype, "value", void 0), p14 = e([a3("esri.rest.support.ImageIdentifyResult")], p14);
var l9 = p14;
...
var c17 = m7 = class extends f {
  ...
  writeGeometry(r2, e5, o3) {
    e5.geometries = { geometryType: "esriGeometryPoint", geometries: r2.map((r3) => r3.toJSON()) };
  }
  clone() {
    var _a;
...
e([y({ type: [_], json: { write: true } })], c17.prototype, "geometries", void 0), e([r("geometries")], c17.prototype, "writeGeometry", null), e([y({ type: N, json: { write: true } })], c17.prototype, "rasterId", void 0), c17 = m7 = e([a3("esri.rest.support.ImagePixelLocationParameters")], c17);
var a12 = c17;
...
var u4 = c18 = class extends p9 {
  ...
  get measureOperation() {
    const { is3D: e5, geometry: r2 } = this;
    return "point" === r2.type ? e5 ? "point-3D" : "point" : e5 ? "centroid-3D" : "centroid";
  }
  clone() {
    return new c18(a({ geometry: this.geometry, is3D: this.is3D, mosaicRule: this.mosaicRule, pixelSize: this.pixelSize, raster: this.raster }));
  }
};
e([y({ types: n3, json: { name: "fromGeometry", read: y2 } })], u4.prototype, "geometry", void 0), e([r("geometry")], u4.prototype, "writeGeometry", null), e([y({ type: a6.apiValues, json: { read: a6.read, write: a6.write } })], u4.prototype, "measureOperation", null), e([y({ json: { read: true } })], u4.prototype, "is3D", void 0), u4 = c18 = e([a3("esri.rest.support.ImagePointParameters")], u4);
var y12 = u4;
...
e([y({ type: _, json: { name: "point.value", read: true, write: true } })], p16.prototype, "point", void 0), p16 = e([a3("esri.rest.support.ImagePointResult")], p16);
var m8 = p16;
...
var j7 = d11 = class extends f {
  ...
  set locations(t6) {
    if (t6 == null ? void 0 : t6.length) {
      const e5 = new u({ spatialReference: t6[0].spatialReference, points: t6.map(({ x: t7, y: e6 }) => [t7, e6]) });
...
e([y({ types: n3, json: { read: y2 } })], j7.prototype, "geometry", void 0), e([r("geometry")], j7.prototype, "writeGeometry", null), e([y()], j7.prototype, "locations", null), e([y({ type: String, json: { type: a5.jsonValues, read: a5.read, write: a5.write } })], j7.prototype, "interpolation", void 0), e([y({ type: j5, json: { write: true } })], j7.prototype, "mosaicRule", void 0), e([y({ type: [String], json: { write: true } })], j7.prototype, "outFields", void 0), e([y({ type: _, json: { write: true } })], j7.prototype, "pixelSize", void 0), e([y({ type: String, json: { write: true } })], j7.prototype, "raster", void 0), e([y({ type: Boolean, json: { write: true } })], j7.prototype, "returnFirstValueOnly", void 0), e([y({ type: Number, json: { write: true } })], j7.prototype, "sampleDistance", void 0), e([y({ type: Number, json: { write: true } })], j7.prototype, "sampleCount", void 0), e([y({ type: Number, json: { write: true } })], j7.prototype, "sliceId", void 0), e([y({ type: c, json: { read: { source: "time" }, write: { target: "time" } } })], j7.prototype, "timeExtent", void 0), j7 = d11 = e([a3("esri.rest.support.ImageSampleParameters")], j7);
var h3 = j7;
...
e([y({ json: { write: true } })], i9.prototype, "attributes", void 0), e([y({ type: _, json: { write: true } })], i9.prototype, "location", void 0), e([y({ json: { write: true } })], i9.prototype, "locationId", void 0), e([y({ json: { write: true } })], i9.prototype, "rasterId", void 0), e([y({ json: { write: true } })], i9.prototype, "resolution", void 0), e([y({ json: { write: true } })], i9.prototype, "pixelValue", void 0), i9 = e([a3("esri.rest.support.ImageSample")], i9);
var p17 = i9;
...
e([y({ type: [p17], json: { write: true } })], p18.prototype, "samples", void 0), p18 = e([a3("esri.rest.support.ImageSampleResult")], p18);
var m9 = p18;
...
var l10 = class extends i2(f) {
  ...
  writeGeometries(e5, r2, o3) {
    r2.geometries = (e5 == null ? void 0 : e5.length) ? { geometryType: p(e5[0]), geometries: e5.map((e6) => ({ ...e6.toJSON(), spatialReference: void 0 })) } : null;
  }
};
e([y({ types: [n3] })], l10.prototype, "geometries", void 0), e([r("geometries")], l10.prototype, "writeGeometries", null), e([y({ type: [N], json: { write: true } })], l10.prototype, "rasterIds", void 0), e([y({ type: f2, json: { name: "outSR", write: true } })], l10.prototype, "outSpatialReference", void 0), l10 = e([a3("esri.rest.support.ImageToMapMultirayParameters")], l10);
var u5 = l10;
...
var n11 = class extends i2(f) {
  ...
  writeGeometry(o3, e5, r2) {
    null != o3 && (e5.geometryType = p(o3), e5[r2] = { ...o3.toJSON(), spatialReference: void 0 });
  }
};
e([y({ types: n3, json: { read: y2, write: true } })], n11.prototype, "geometry", void 0), e([r("geometry")], n11.prototype, "writeGeometry", null), e([y({ json: { write: true } })], n11.prototype, "rasterId", void 0), e([y({ type: f2, json: { name: "outSR", write: true } })], n11.prototype, "outSpatialReference", void 0), e([y({ json: { name: "options.DOff", write: true } })], n11.prototype, "depthOffset", void 0), e([y({ json: { name: "options.Adjust", write: true } })], n11.prototype, "adjust", void 0), n11 = e([a3("esri.rest.support.ImageToMapParameters")], n11);
var l11 = n11;
...
e([y({ type: String, json: { name: "uri", write: true } })], p19.prototype, "referenceUri", void 0), e([y({ type: Number, json: { write: true } })], p19.prototype, "rasterId", void 0), p19 = e([a3("esri.rest.support.ImageUrlParameters")], p19);
var c19 = p19;
...
e([y({ json: { name: "imageURL", write: true } })], e4.prototype, "url", void 0), e4 = e([a3("esri.rest.support.ImageUrlResult")], e4);
var p20 = e4;
...
e([y({ types: n3, json: { read: y2, write: true } })], a13.prototype, "geometry", void 0), e([r("geometry")], a13.prototype, "writeGeometry", null), e([y({ json: { write: true } })], a13.prototype, "rasterId", void 0), e([y({ json: { name: "options.VisibleOnly", write: true } })], a13.prototype, "visibleOnly", void 0), a13 = e([a3("esri.rest.support.MapToImageParameters")], a13);
var l12 = a13;
...
var m10 = class extends f {
  ...
  readCenter(e5, r2) {
    return e5.spatialReference || (e5 = { ...e5, spatialReference: r2.Shape.spatialReference }), _.fromJSON(e5);
  }
};
e([y({ types: n3, json: { name: "Shape", read: y2, write: true } })], m10.prototype, "geometry", void 0), e([y({ json: { name: "Length", write: true } })], m10.prototype, "length", void 0), e([y({ json: { name: "Area", write: true } })], m10.prototype, "area", void 0), e([y({ json: { name: "Center", write: true } })], m10.prototype, "center", void 0), e([o("center")], m10.prototype, "readCenter", null), m10 = e([a3("esri.rest.support.MeasureAreaFromImageResult")], m10);
var i10 = m10;
...
var n12 = c20 = class extends f {
  ...
  writeGeometry(r2, o3, e5) {
    null != r2 && (o3.geometryType = p(r2), o3[e5] = { ...r2.toJSON(), spatialReference: void 0 });
  }
  clone() {
...
e([y({ types: n3, json: { name: "fromGeometry", read: y2, write: true } })], n12.prototype, "geometry", void 0), e([r("geometry")], n12.prototype, "writeGeometry", null), e([y({ json: { write: true } })], n12.prototype, "rasterId", void 0), n12 = c20 = e([a3("esri.rest.support.MeasureFromImageParameters")], n12);
var y13 = n12;
...
e([y({ types: n3, json: { name: "Shape", read: y2, write: true } })], m11.prototype, "geometry", void 0), e([y({ json: { name: "Length", write: true } })], m11.prototype, "length", void 0), m11 = e([a3("esri.rest.support.MeasureLengthFromImageResult")], m11);
var c21 = m11;
...
async function B3(t6, o3, m12) {
  o3 = g(h, o3);
  const i11 = f5(t6), p21 = o3.geometry ? [o3.geometry] : [], u6 = await R(p21), c22 = o3.toJSON();
  H(c22);
  const f8 = u6 == null ? void 0 : u6[0];
  null != f8 && (c22.geometry = rt(f8));
  const l13 = s3({ ...i11.query, f: "json", ...c22 });
  return i3(l13, m12);
}
async function D2(r2, o3, m12) {
  var _a, _b, _c;
  ...
  const c22 = f5(r2), f8 = s3({ ...c22.query, f: "json", ...i11 }), l13 = i3(f8, m12), { data: g6 } = await U(`${c22.path}/computeAngles`, l13);
  return g6.spatialReference = g6.spatialReference ? null != g6.spatialReference.geodataXform ? new f2({ wkid: 0, imageCoordinateSystem: g6.spatialReference }) : f2.fromJSON(g6.spatialReference) : null, "NaN" === g6.north && (g6.north = null), "NaN" === g6.up && (g6.up = null), new i6(g6);
}
async function k3(r2, o3, m12) {
  var _a;
  const i11 = (o3 = g(a12, o3)).toJSON(), { geometries: p21 } = o3;
  ...
  const u6 = f5(r2), c22 = s3({ ...u6.query, f: "json", ...i11 }), f8 = i3(c22, m12), { data: l13 } = await U(`${u6.path}/computePixelLocation`, f8);
  return p15.fromJSON(l13);
}
async function z(e5, r2, o3) {
  const s11 = await B3(e5, r2, o3), n14 = f5(e5), { data: m12 } = await U(`${n14.path}/computeStatisticsHistograms`, s11), { statistics: i11 } = m12;
...
async function E(e5, r2, o3) {
  const s11 = await B3(e5, r2, o3), n14 = f5(e5), { data: m12 } = await U(`${n14.path}/computeHistograms`, s11);
  return { histograms: m12.histograms };
}
async function V2(o3, m12, i11) {
  var _a, _b;
  const p21 = (m12 = g(h3, m12)).toJSON();
  H(p21), ((_a = p21.outFields) == null ? void 0 : _a.length) && (p21.outFields = p21.outFields.join(","));
  const u6 = await R(m12.geometry), c22 = u6 == null ? void 0 : u6[0];
  null != c22 && (p21.geometry = rt(c22));
  const f8 = f5(o3), l13 = s3({ ...f8.query, f: "json", ...p21 }), g6 = i3(l13, i11), { data: y14 } = await U(`${f8.path}/getSamples`, g6), j8 = (_b = y14 == null ? void 0 : y14.samples) == null ? void 0 : _b.map((t6) => {
    const e5 = "NaN" === t6.value || "" === t6.value ? null : t6.value.split(" ").map((t7) => Number(t7));
    return { ...t6, pixelValue: e5 };
  });
  return m9.fromJSON({ samples: j8 });
}
async function X(o3, m12, i11) {
  m12 = g(d10, m12);
  const p21 = f5(o3), u6 = m12.geometry ? [m12.geometry] : [];
  return R(u6).then((e5) => {
    const r2 = m12.toJSON(), o4 = e5 == null ? void 0 : e5[0];
    null != o4 && (r2.geometry = JSON.stringify(rt(o4)));
    const a14 = s3({ ...p21.query, f: "json", ...r2 }), u7 = i3(a14, i11);
    return U(p21.path + "/identify", u7);
  }).then((t6) => l9.fromJSON(t6.data));
}
async function K(t6, r2, o3) {
  r2 = g(c15, r2);
  const a14 = await Z2(t6, r2, [r2.fromGeometry, r2.toGeometry], o3);
  return c16.fromJSON(a14);
}
async function Q(t6, r2, o3) {
  r2 = g(y7, r2);
  const a14 = await Z2(t6, r2, [r2.geometry], o3);
  return c10.fromJSON(a14);
}
async function W(t6, r2, o3) {
  r2 = g(y12, r2);
  const a14 = await Z2(t6, r2, [r2.geometry], o3);
  return m8.fromJSON(a14);
}
async function Y(t6, r2, o3) {
  r2 = g(u3, r2);
  const a14 = await Z2(t6, r2, [r2.fromGeometry, r2.toGeometry], o3);
  return i8.fromJSON(a14);
}
async function Z2(e5, o3, m12, i11) {
  const p21 = f5(e5), u6 = await R(m12), c22 = o3.toJSON();
  null != u6[0] && (c22.fromGeometry = JSON.stringify(rt(u6[0]))), null != u6[1] && (c22.toGeometry = JSON.stringify(rt(u6[1])));
  const f8 = s3({ ...p21.query, f: "json", ...c22 }), l13 = i3(f8, i11), { data: g6 } = await U(p21.path + "/measure", l13);
  return g6;
}
async function _2(t6, e5, r2) {
  const o3 = await et(t6, e5, r2);
  return c21.fromJSON(o3);
}
async function tt(t6, e5, r2) {
  const o3 = await et(t6, e5, r2);
  return i10.fromJSON(o3);
}
async function et(r2, o3, m12) {
  o3 = g(y13, o3);
  const i11 = f5(r2), p21 = o3.toJSON(), u6 = s3({ ...i11.query, f: "json", ...p21 }), c22 = i3(u6, m12), { data: f8 } = await U(i11.path + "/measureFromImage", c22);
  return f8;
}
function rt(t6) {
  var _a;
  const e5 = t6.toJSON();
  return ((_a = t6.spatialReference) == null ? void 0 : _a.imageCoordinateSystem) && (e5.spatialReference = ot(t6.spatialReference)), e5;
}
function ot(t6) {
  const { imageCoordinateSystem: e5 } = t6;
  if (e5) {
    const { id: t7, referenceServiceName: r2 } = e5;
    return null != t7 ? r2 ? { icsid: t7, icsns: r2 } : { icsid: t7 } : { ics: e5 };
  }
  return t6.toJSON();
}
function at(t6, e5) {
  if (!t6.imageCoordinateSystem) return d2(t6);
  const r2 = ot(t6), { icsid: a14, icsns: s11 } = r2;
  return null == a14 || null != s11 && !(e5 == null ? void 0 : e5.toLowerCase().includes("/" + s11.toLowerCase() + "/")) ? JSON.stringify(r2) : `0:${a14}`;
}
async function st(r2, o3, m12) {
  o3 = g(c11, o3);
  const i11 = f5(r2), p21 = o3.toJSON();
  o3.outSpatialReference && (p21.outSR = at(o3.outSpatialReference));
  const u6 = s3({ ...i11.query, f: "json", ...p21 }), c22 = i3(u6, m12), { data: f8 } = await U(i11.path + "/queryBoundary", c22);
  return c12.fromJSON(f8);
}
async function nt(o3, m12, i11) {
  var _a, _b;
  ...
  const u6 = await R(m12.geometry), c22 = u6 == null ? void 0 : u6[0];
  null != c22 && (p21.geometry = rt(c22));
  const f8 = (c22 == null ? void 0 : c22.spatialReference) ?? ((_b = m12.geometry) == null ? void 0 : _b.spatialReference);
  f8 && (p21.inSR = at(f8));
  const l13 = f5(o3), g6 = s3({ ...l13.query, f: "json", ...p21 }), y14 = i3(g6, i11), { data: j8 } = await U(`${l13.path}/queryGPSInfo`, y14);
  return a11.fromJSON(j8);
}
async function mt(r2, o3, m12) {
  ...
  const p21 = f5(r2), u6 = s3({ ...p21.query, f: "json", ...i11 }), c22 = i3(u6, m12), { data: f8 } = await U(`${p21.path}/imageToMap`, c22);
  return y2(f8);
}
async function it(r2, o3, m12) {
  var _a;
  const i11 = (o3 = g(u5, o3)).toJSON();
  ((_a = o3.rasterIds) == null ? void 0 : _a.length) && (i11.rasterIds = o3.rasterIds.join(","));
  const p21 = f5(r2), u6 = s3({ ...p21.query, f: "json", ...i11 }), c22 = i3(u6, m12), { data: f8 } = await U(`${p21.path}/imageToMapMultiray`, c22);
  return y2(f8);
}
async function pt(o3, m12, i11) {
  var _a;
  const p21 = (m12 = g(l12, m12)).toJSON(), u6 = await R(m12.geometry), c22 = u6 == null ? void 0 : u6[0];
  null != c22 && (p21.geometry = rt(c22)), m12.visibleOnly || delete p21.options;
  const f8 = (c22 == null ? void 0 : c22.spatialReference) ?? ((_a = m12.geometry) == null ? void 0 : _a.spatialReference);
  f8 && (p21.inSR = at(f8));
  const l13 = f5(o3), g6 = s3({ ...l13.query, f: "json", ...p21 }), y14 = i3(g6, i11), { data: j8 } = await U(`${l13.path}/mapToImage`, y14);
  return y2(j8);
}
async function ut(r2, o3, m12) {
  const i11 = (o3 = g(c19, o3)).toJSON(), p21 = f5(r2), u6 = s3({ ...p21.query, f: "json", ...i11 }), c22 = i3(u6, m12), { data: f8 } = await U(`${p21.path}/getImageUrl`, c22);
  return p20.fromJSON(f8);
}
async function ct(o3, p21, u6) {
  var _a;
  const c22 = (p21 = g(m4, p21)).toJSON(), f8 = await R([p21.fromGeometry, p21.toGeometry]);
  null != f8[0] && (c22.fromGeometry = rt(f8[0]), f8[0].spatialReference && (c22.inSR = at(f8[0].spatialReference))), null != f8[1] && (c22.toGeometry = rt(f8[1])), ((_a = p21.objectIds) == null ? void 0 : _a.length) && (c22.objectIds = c22.objectIds.join(","));
  const l13 = f5(o3), g6 = s3({ ...l13.query, f: "json", ...c22 }), y14 = i3(g6, u6), { data: j8 } = await U(`${l13.path}/find`, y14);
  return c7.fromJSON(j8);
}

// ../node_modules/@arcgis/core/rest/imageService/getCatalogItemRasterInfo.js
async function n13(n14, m12, p21) {
  var _a, _b;
  const f8 = f5(n14), u6 = s3({ ...f8 == null ? void 0 : f8.query, f: "json" }), h4 = i3(u6, p21), d12 = `${f8 == null ? void 0 : f8.path}/${m12}/info`, c22 = U(`${d12}`, h4), g6 = U(`${d12}/keyProperties`, h4), x3 = await Promise.allSettled([c22, g6]), y14 = "fulfilled" === x3[0].status ? x3[0].value.data : null, v2 = "fulfilled" === x3[1].status ? x3[1].value.data : null;
  let P2 = null;
  ((_a = y14.statistics) == null ? void 0 : _a.length) && (P2 = y14.statistics.map((e5) => ({ min: e5[0], max: e5[1], avg: e5[2], stddev: e5[3] })));
  const S3 = w.fromJSON(y14.extent), j8 = Math.ceil(S3.width / y14.pixelSizeX - 0.1), w4 = Math.ceil(S3.height / y14.pixelSizeY - 0.1), b5 = S3.spatialReference, k4 = new _({ x: y14.pixelSizeX, y: y14.pixelSizeY, spatialReference: b5 }), z2 = ((_b = y14.histograms) == null ? void 0 : _b.length) ? y14.histograms : null, L3 = new n4({ origin: y14.origin, blockWidth: y14.blockWidth, blockHeight: y14.blockHeight, firstPyramidLevel: y14.firstPyramidLevel, maximumPyramidLevel: y14.maxPyramidLevel });
  return new m({ width: j8, height: w4, bandCount: y14.bandCount, extent: S3, spatialReference: b5, pixelSize: k4, pixelType: y14.pixelType.toLowerCase(), statistics: P2, histograms: z2, keyProperties: v2, storageInfo: L3 });
}
...
var je = j(a2, { min: 0, max: 255 });
function Pe(e5) {
  if (!e5) return null;
  const t6 = JSON.stringify(e5).match(/"rasterFunction":"(.*?")/gi), i11 = t6 == null ? void 0 : t6.map((e6) => e6.slice(18, -1));
...
var Ce = (d12) => {
  let g6 = class extends d12 {
    ...
    set mosaicRule(e5) {
      let t6 = e5;
      (t6 == null ? void 0 : t6.mosaicMethod) && (t6 = j5.fromJSON({ ...t6.toJSON(), mosaicMethod: t6.mosaicMethod, mosaicOperation: t6.mosaicOperation })), this._set("mosaicRule", t6);
    }
    ...
    writeMosaicRule(e5, t6, i11) {
      ...
      r2 ? s11 && s11 !== r2.where && (r2 = r2.clone(), r2.where = s11) : s11 && (r2 = new j5({ where: s11 })), this._isValidCustomizedMosaicRule(r2) && (t6[i11] = r2.toJSON());
    }
    ...
    readRenderer(e5, t6, i11) {
      var _a, _b;
      const r2 = (_b = (_a = t6 == null ? void 0 : t6.layerDefinition) == null ? void 0 : _a.drawingInfo) == null ? void 0 : _b.renderer, n14 = c2(r2, i11);
    ...
    get rasterFields() {
      var _a;
      const e5 = this._rasterAttributeTableFieldPrefix, t6 = new y3({ name: "Raster.ItemPixelValue", alias: "Item Pixel Value", domain: null, editable: false, length: 50, type: "string" }), i11 = new y3({ name: "Raster.ServicePixelValue", alias: "Service Pixel Value", domain: null, editable: false, length: 50, type: "string" }), r2 = new y3({ name: "Raster.ServicePixelValue.Raw", alias: "Raw Service Pixel Value", domain: null, editable: false, length: 50, type: "string" });
      let s11 = this.fields ? a(this.fields) : [];
      s11.push(i11), ((_a = this.capabilities) == null ? void 0 : _a.operations.supportsQuery) && this.fields && this.fields.length > 0 && s11.push(t6), this.version >= 10.4 && null != this.rasterFunctionInfos && this.rasterFunctionInfos.some((e6) => "none" === e6.name.toLowerCase()) && s11.push(r2), null != this.rasterFunctionInfos && this.rasterFunctionInfos.filter((e6) => "none" !== e6.name.toLowerCase()).forEach((e6) => {
        s11.push(new y3({ name: "Raster.ServicePixelValue." + e6.name, alias: e6.name, domain: null, editable: false, length: 50, type: "string" }));
      }), this._isVectorDataSet() && (s11.push(new y3({ name: "Raster.Magnitude", alias: "Magnitude", domain: null, editable: false, type: "double" })), s11.push(new y3({ name: "Raster.Direction", alias: "Direction", domain: null, editable: false, type: "double" })));
    ...
    get renderingRule() {
      return i(n.getLogger(this), "renderingRule", { replacement: "rasterFunction", version: "4.27", warnOnce: true }), this.rasterFunction;
    }
    set renderingRule(e5) {
      i(n.getLogger(this), "renderingRule", { replacement: "rasterFunction", version: "4.27", warnOnce: true }), this._set("rasterFunction", e5);
    }
    set rasterFunction(e5) {
      let t6 = e5;
      (t6 == null ? void 0 : t6.rasterFunction) && (t6 = N2.fromJSON({ ...t6.toJSON(), rasterFunction: t6.rasterFunction, rasterFunctionArguments: t6.rasterFunctionArguments })), this._set("rasterFunction", t6);
    }
    readRasterFunction(e5, t6) {
      const i11 = t6.rasterFunctionInfos;
      return t6.renderingRule || (i11 == null ? void 0 : i11.length) && "None" !== i11[0].name ? this._isRFTJson(t6.renderingRule) ? N2.fromJSON({ rasterFunctionDefinition: t6.renderingRule }) : N2.fromJSON(t6.renderingRule || { rasterFunctionInfos: t6.rasterFunctionInfos }) : null;
    }
    ...
    async applyRenderer(e5, t6) {
      let i11 = e5;
      const { renderer: r2, symbolizer: s11, pixelFilter: n14, bandIds: a14 } = this;
      if (!this._isPicture() && r2 && s11 && !n14) {
        ...
        if (o3) {
          n15 && (s11.bind(), await o3.updateSymbolizer(s11, t6), this._cachedRendererJson = r2.toJSON());
          const l13 = await o3.symbolize({ bandIds: a14, ...e5 }, t6);
          i11 = { extent: e5.extent, pixelBlock: l13 };
        } else i11 = { extent: e5.extent, pixelBlock: s11.symbolize({ bandIds: a14, ...e5 }) };
      }
      return i11;
    }
    destroy() {
    ...
    async fetchImage(e5, t6, i11, r2 = {}) {
      ...
      if (this.renderer || this.symbolizer) {
        const e6 = await this._generateRasterInfo(this.rasterFunction, { signal: r2.signal });
      ...
      if (null == s11) {
        if (r2.requestAsImageElement && this._canRequestImageElement(this.format)) {
          ...
          if (e6.width = t6, e6.height = i11, r2.returnImageBitmap) {
            return { imageBitmap: await t2(e6, `${Ce2(this.parsedUrl)}/exportImage`, r2.signal) };
          }
          return { imageOrCanvasElement: e6 };
        }
        const { bandIds: s12, rasterInfo: n15 } = this, a15 = ((s12 == null ? void 0 : s12.length) || n15.bandCount) ?? 0, o3 = t6 * i11, l14 = n15.pixelType, u6 = [];
        for (let e6 = 0; e6 < a15; e6++) u6.push(g2.createEmptyBand(l14, o3));
        return { pixelData: { pixelBlock: new g2({ width: t6, height: i11, pixels: u6, mask: new Uint8Array(o3), pixelType: l14 }), extent: e5 } };
      }
      const n14 = !!r2.requestAsImageElement && !this.pixelFilter, a14 = n14 && !!r2.returnImageBitmap, l13 = { imageServiceParameters: s11, imageProps: { extent: e5, width: t6, height: i11, format: this.format }, requestAsImageElement: n14, returnImageBitmap: a14, signal: r2.signal };
      return this._requestArrayBuffer(l13);
    }
    fetchKeyProperties(e5) {
      return U(Ce2(this.parsedUrl) + "/keyProperties", { query: this._getQueryParams({ renderingRule: this.version >= 10.3 ? e5 == null ? void 0 : e5.rasterFunction : null }) }).then((e6) => e6.data);
    }
    fetchRasterAttributeTable(e5) {
      return this.version < 10.1 ? Promise.reject(new s("#fetchRasterAttributeTable()", "Failed to get rasterAttributeTable")) : U(Ce2(this.parsedUrl) + "/rasterAttributeTable", { query: this._getQueryParams({ renderingRule: this.version >= 10.3 ? e5 == null ? void 0 : e5.rasterFunction : null }) }).then((e6) => d4.fromJSON(e6.data));
    }
    ...
    async getCatalogItemICSInfo(e5, t6) {
      var _a, _b, _c, _d, _e;
      const { data: i11 } = await U(Ce2(this.parsedUrl) + "/" + e5 + "/info/ics", { query: this._getQueryParams(), ...t6 }), r2 = i11 == null ? void 0 : i11.ics;
      if (!r2) return;
      let s11 = null;
      try {
        s11 = (await U(Ce2(this.parsedUrl) + "/" + e5 + "/info", { query: this._getQueryParams(), ...t6 })).data.extent;
      } catch {
      }
      if (!(s11 == null ? void 0 : s11.spatialReference)) return { ics: r2, icsToPixelTransform: null, icsExtent: null, northDirection: null };
      const a14 = this.version >= 10.7 ? U(Ce2(this.parsedUrl) + "/" + e5 + "/info/icstopixel", { query: this._getQueryParams(), ...t6 }).then((e6) => e6.data).catch(() => ({})) : {}, o3 = s11.spatialReference, l13 = { geometries: JSON.stringify({ geometryType: "esriGeometryEnvelope", geometries: [s11] }), inSR: d2(o3), outSR: "0:" + e5 }, u6 = U(Ce2(this.parsedUrl) + "/project", { query: this._getQueryParams(l13), ...t6 }).then((e6) => e6.data).catch(() => ({})), p21 = 5, m12 = (s11.xmin + s11.xmax) / 2, c22 = (s11.ymax - s11.ymin) / (p21 + 1), d13 = s11.ymin + c22, h4 = [];
      for (let n14 = 0; n14 < p21; n14++) h4.push({ x: m12, y: d13 + c22 * n14 });
      const y14 = { geometries: JSON.stringify({ geometryType: "esriGeometryPoint", geometries: h4 }), inSR: d2(o3), outSR: "0:" + e5 }, g7 = U(Ce2(this.parsedUrl) + "/project", { query: this._getQueryParams(y14), ...t6 }).then((e6) => e6.data).catch(() => ({})), f8 = await Promise.all([a14, u6, g7]);
      let R3 = f8[0].ipxf;
      if (null == R3) {
        const e6 = (_a = r2.geodataXform) == null ? void 0 : _a.xf_0;
      ...
      const b5 = w.fromJSON((_e = (_d = f8[1]) == null ? void 0 : _d.geometries) == null ? void 0 : _e[0]);
      b5 && (b5.spatialReference = new f2({ wkid: 0, imageCoordinateSystem: r2 }));
      const v2 = f8[2].geometries ? f8[2].geometries.filter((e6) => null != (e6 == null ? void 0 : e6.x) && null != e6.y && "NaN" !== e6.x && "NaN" !== e6.y) : [], I2 = v2.length;
      if (I2 < 3) return { ics: r2, icsToPixelTransform: R3, icsExtent: b5, northDirection: null };
      ...
      return D3 === 1 / 0 ? T3 = j8 ? 90 : 270 : 0 === D3 ? T3 = O ? 0 : 180 : D3 > 0 ? T3 = O ? 180 * Math.atan(D3) / Math.PI : 180 * Math.atan(D3) / Math.PI + 180 : D3 < 0 && (T3 = j8 ? 180 + 180 * Math.atan(D3) / Math.PI : 360 + 180 * Math.atan(D3) / Math.PI), { ics: r2, icsToPixelTransform: R3, icsExtent: b5, northDirection: T3 };
    }
    async generateRasterInfo(e5, t6) {
      var _a;
      if (e5 = g(N2, e5), this.serviceRasterInfo && (!e5 || "none" === ((_a = e5.functionName) == null ? void 0 : _a.toLowerCase()) || this._isVectorFieldResampleFunction(e5))) return this.serviceRasterInfo;
      const i11 = Pe(e5);
      ...
      const r2 = { ...t6, query: this._getQueryParams() }, s11 = p5(Ce2(this.parsedUrl), e5, r2);
    ...
    getExportImageServiceParameters(e5, t6, i11, r2) {
      ...
      let { renderingRule: l13 } = n14;
      const u6 = (_a = this.rasterFunction) == null ? void 0 : _a.rasterFunctionDefinition, p21 = !this.renderer || "raster-stretch" === this.renderer.type;
      if ((a14 == null ? void 0 : a14.length) && this._hasRasterFunction(this.rasterFunction) && !u6 && p21) {
        const e6 = { rasterFunction: "ExtractBand", rasterFunctionArguments: { BandIds: a14 } };
        if ("Stretch" === l13.rasterFunction) e6.rasterFunctionArguments.Raster = l13.rasterFunctionArguments.Raster, l13.rasterFunctionArguments.Raster = e6;
          ...
          "Stretch" === (t7 == null ? void 0 : t7.rasterFunction) ? (e6.rasterFunctionArguments.Raster = t7.rasterFunctionArguments.Raster, t7.rasterFunctionArguments.Raster = e6) : (e6.rasterFunctionArguments.Raster = t7, l13.rasterFunctionArguments.Raster = e6);
      ...
      const c22 = {};
      if (null != r2) {
        const { start: e6, end: t7 } = r2.toJSON();
        e6 && t7 && e6 === t7 ? c22.time = "" + e6 : null == e6 && null == t7 || (c22.time = `${e6 ?? "null"},${t7 ?? "null"}`);
      }
      return { bbox: e5.xmin + "," + e5.ymin + "," + e5.xmax + "," + e5.ymax, bboxSR: s11, imageSR: s11, size: t6 + "," + i11, ...n14, ...c22 };
    }
    ...
    async identify(e5, t6) {
      ...
      e5 = a(e5), this.version < 10.91 && "extent" === ((_a = e5.geometry) == null ? void 0 : _a.type) && (e5.geometry = j2.fromExtent(e5.geometry));
      ...
      const { raster: r2, rasterFunction: s11 } = this;
    ...
    async queryBoundary(e5, t6) {
      ...
      return e5 = e5 ?? { outSpatialReference: this.spatialReference }, st(Ce2(this.parsedUrl), e5, this._getRequestOptions(t6));
    }
    ...
    async queryGPSInfo(e5, t6) {
      ...
      return e5 = e5 ?? { where: "1=1" }, nt(Ce2(this.parsedUrl), e5, this._getRequestOptions(t6));
    }
    ...
    async queryVisibleRasters(e5, t6) {
      ...
      await this.load();
      const { pixelSize: i11, returnDomainValues: r2, returnTopmostRaster: s11, showNoDataRecords: n14 } = t6 || { pixelSize: null, returnDomainValues: false, returnTopmostRaster: false, showNoDataRecords: false };
      ...
      if (null != e5.outFields && (a14 = e5.outFields.some((e6) => !e6.toLowerCase().includes(p21)), this.version >= 10.4)) {
        ...
        l13 = t7.map((e6) => new N2({ functionName: e6[0] })), u6 = t7.map((e6) => e6[1]);
        const { rasterFunction: i12 } = this;
        0 === l13.length ? (i12 == null ? void 0 : i12.functionName) ? (l13.push(i12), u6.push(i12.functionName)) : l13 = null : (i12 == null ? void 0 : i12.functionName) && !l13.some((e6) => e6.functionName === i12.functionName) && (l13.push(i12), u6.push(i12.functionName));
      }
      const c22 = null == e5.outSpatialReference || e5.outSpatialReference.equals(this.spatialReference), { multidimensionalSubset: d13 } = this;
      let h4 = e5.timeExtent || this.timeExtent;
      if (d13) {
        const { isOutside: t7, intersection: i12 } = m2(d13, { geometry: e5.geometry, timeExtent: e5.timeExtent, multidimensionalDefinition: (_a = this.exportImageServiceParameters.mosaicRule) == null ? void 0 : _a.multidimensionalDefinition });
        ...
        null != (i12 == null ? void 0 : i12.timeExtent) && (h4 = i12.timeExtent);
      }
      const y14 = this._combineMosaicRuleWithTimeExtent(this.exportImageServiceParameters.mosaicRule, h4);
      let g7 = e5.geometry;
      this.version < 10.91 && "extent" === (g7 == null ? void 0 : g7.type) && (g7 = j2.fromExtent(g7));
      const f8 = this._getQueryParams({ geometry: g7, timeExtent: h4, mosaicRule: y14, rasterFunction: this.version < 10.4 ? this.rasterFunction : null, rasterFunctions: l13, pixelSize: i11, returnCatalogItems: a14, returnGeometry: c22, raster: this.raster, maxItemCount: s11 ? 1 : null });
      delete f8.f;
      const R3 = new d10(f8);
      try {
        await this._generateRasterInfo(this.rasterFunction);
        const i12 = await X(this.url, R3, { signal: t6 == null ? void 0 : t6.signal, query: { ...this.customParameters } }), s12 = e5.outFields, o3 = null != i12.value && i12.value.toLowerCase().includes("nodata");
        if (!(a14 && !c22 && ((_b = i12 == null ? void 0 : i12.catalogItems) == null ? void 0 : _b.features.length) && (n14 || !o3))) return this._processVisibleRastersResponse(i12, { returnDomainValues: r2, templateRRFunctionNames: u6, showNoDataRecords: n14, templateFields: s12 });
        const l14 = this.objectIdField || "ObjectId", p22 = ((_c = i12.catalogItems) == null ? void 0 : _c.features) ?? [], m13 = p22.map((e6) => {
          var _a2;
          return (_a2 = e6.attributes) == null ? void 0 : _a2[l14];
        }), d14 = new b3({ objectIds: m13, returnGeometry: true, outSpatialReference: e5.outSpatialReference, outFields: [l14] }), h5 = await this.queryRasters(d14);
        return ((_d = h5 == null ? void 0 : h5.features) == null ? void 0 : _d.length) && h5.features.forEach((t7) => {
          p22.forEach((i13) => {
        ...
        }), this._processVisibleRastersResponse(i12, { returnDomainValues: r2, templateRRFunctionNames: u6, showNoDataRecords: n14, templateFields: s12 });
      } catch {
    ...
    async fetchVariableStatisticsHistograms(e5, t6) {
      const i11 = U(Ce2(this.parsedUrl) + "/statistics", { query: this._getQueryParams({ variable: e5 }), signal: t6 }).then((e6) => {
        var _a;
        return (_a = e6.data) == null ? void 0 : _a.statistics;
      }), r2 = U(Ce2(this.parsedUrl) + "/histograms", { query: this._getQueryParams({ variable: e5 }), signal: t6 }).then((e6) => {
        var _a;
        return (_a = e6.data) == null ? void 0 : _a.histograms;
      }), s11 = await Promise.all([i11, r2]);
      return s11[0] && s11[0].forEach((e6) => {
        e6.avg = e6.mean, e6.stddev = e6.standardDeviation;
      }), { statistics: s11[0] || null, histograms: s11[1] || null };
    }
    async createFlowMesh(e5, t6) {
    ...
    async _fetchService(e5) {
      ...
      const t6 = this.sourceJSON, i11 = null != this.serviceRasterInfo ? Promise.resolve(this.serviceRasterInfo) : f6(Ce2(this.parsedUrl), t6, { signal: e5, query: this._getQueryParams() }).then((e6) => (this._set("serviceRasterInfo", e6), this._set("multidimensionalInfo", e6.multidimensionalInfo), c4(e6, t6), e6)), r2 = this._hasRasterFunction(this.rasterFunction) ? this._generateRasterInfo(this.rasterFunction, { signal: e5 }) : null, s11 = this._getRasterFunctionInfos();
    ...
    _combineMosaicRuleWithTimeExtent(e5, t6) {
      var _a;
      const i11 = this.timeInfo, { multidimensionalInfo: r2 } = this.serviceRasterInfo;
      if (null == e5 || null == r2 || null == t6 || null == (i11 == null ? void 0 : i11.startField)) return e5;
      const { startField: s11 } = i11, n14 = r2.variables.some((e6) => e6.dimensions.some((e7) => e7.name === s11)) ? s11 : "StdTime";
      if (e5 = e5.clone(), "mosaic-dataset" === this.sourceType) return e5.multidimensionalDefinition = (_a = e5.multidimensionalDefinition) == null ? void 0 : _a.filter((e6) => e6.dimensionName !== n14), this._cleanupMultidimensionalDefinition(e5);
      ...
      if (a14.length) a14.forEach((e6) => {
        ...
        }) : e5.multidimensionalDefinition.push(new p4({ variableName: "", dimensionName: n14, isSlice: u6, values: p21 }));
      }
    ...
    async _prepareForQuery(e5, t6) {
      ...
      return e5 = null != e5 ? g(b3, e5) : this.createQuery(), t6 = this._getRequestOptions(t6), this.raster && (t6.query = { ...t6.query, raster: this.raster }), { query: e5, requestOptions: t6 };
    }
    ...
    _isSupportedRenderer(e5) {
      ...
      return "unique-value" === e5.type && this._hasRasterFunction(i11) && 1 === (t6 == null ? void 0 : t6.bandCount) && ["u8", "s8"].includes(t6.pixelType) || null != t6 && null != e5 && B2(t6).includes(e5.type);
    }
    ...
    async _fetchServiceInfo(e5) {
      ...
      if (!t6) {
        const { data: i11, ssl: r2 } = await U(Ce2(this.parsedUrl), { query: this._getQueryParams(), signal: e5 });
    ...
    _isMosaicRuleSupported(e5) {
      var _a;
      if (!e5) return false;
      const t6 = this._isMosaicDataset(e5), i11 = e5.currentVersion >= 10.71 && e5.hasMultidimensions && !(((_a = e5.fields) == null ? void 0 : _a.length) > 1);
      return t6 || i11;
    }
    _isVectorFieldResampleFunction(e5) {
      if (null == e5) return false;
      const { functionName: t6, functionArguments: i11 } = e5, r2 = "resample" === (t6 == null ? void 0 : t6.toLowerCase()), s11 = (i11 == null ? void 0 : i11.ResampleType) || (i11 == null ? void 0 : i11.resampleType);
    ...
    _configRenderer(e5) {
      ...
      if (!t6 && !this.pixelFilter || this._isVectorDataSet()) {
        ...
        e5 || (e5 = L2(i11, { bandIds: this.bandIds, variableName: this.rasterFunction ? null : (_b = (_a = this.mosaicRule) == null ? void 0 : _a.multidimensionalDefinition) == null ? void 0 : _b[0].variableName }));
        const t7 = $(e5.toJSON());
        this.symbolizer ? (this.symbolizer.rendererJSON = t7, this.symbolizer.rasterInfo = i11) : this.symbolizer = new L({ rendererJSON: t7, rasterInfo: i11 }), this.symbolizer.bind().success || (this.symbolizer = null);
      }
      return e5;
    }
    _clonePixelData(e5) {
    ...
    _getQueryParams(e5) {
      ...
      return { raster: t6, viewId: i11, f: "json", ...e5, ...this.customParameters };
    }
    _getRequestOptions(e5) {
      return { ...e5, query: { ...e5 == null ? void 0 : e5.query, ...this.customParameters } };
    }
    _decodePixelBlock(e5, t6, i11) {
      return this._rasterJobHandler.instance ? this._rasterJobHandler.instance.decode({ data: e5, options: t6 }) : j4(e5, t6, i11);
    }
    async _getRasterFunctionInfos(e5) {
      ...
      if (t6 && this.version >= 10.3) {
        ...
        const i11 = await U(Ce2(this.parsedUrl) + "/rasterFunctionInfos", { query: this._getQueryParams(), signal: e5 });
    ...
    async _requestArrayBuffer(e5) {
      const { imageProps: t6, requestAsImageElement: i11, returnImageBitmap: r2, signal: s11 } = e5;
      if (i11 && this._canRequestImageElement(t6.format)) {
        const i12 = `${Ce2(this.parsedUrl)}/exportImage`, { data: a15 } = await U(i12, { responseType: r2 ? "blob" : "image", query: this._getQueryParams({ f: "image", ...this.refreshParameters, ...e5.imageServiceParameters }), signal: s11 });
        if (a15 instanceof Blob) {
          return { imageBitmap: await t2(a15, i12, s11), params: t6 };
        }
        return { imageOrCanvasElement: a15, params: t6 };
      }
      const a14 = this._initJobHandler(), l13 = U(Ce2(this.parsedUrl) + "/exportImage", { responseType: "array-buffer", query: this._getQueryParams({ f: "image", ...e5.imageServiceParameters }), signal: s11 }), u6 = (await Promise.all([l13, a14]))[0].data, p21 = t6.format || "jpgpng";
      let m12 = p21;
      ...
      const c22 = { signal: s11 }, d13 = "gif" === p21 || "bmp" === p21 || p21.includes("png") && ("png" === m12 || "jpg" === m12) ? j4(u6, { useCanvas: true, ...t6 }, c22) : this._decodePixelBlock(u6, { width: t6.width, height: t6.height, planes: null, pixelType: null, noDataValue: null, format: p21 }, c22);
      return { pixelData: { pixelBlock: await d13, extent: t6.extent }, params: t6 };
    }
    ...
    _updateMultidimensionalDefinition(e5) {
      ...
      let t6 = d6(e5, { multidimensionalSubset: this.multidimensionalSubset });
    ...
    _processVisibleRastersResponse(e5, i11) {
      var _a, _b, _c;
      i11 = i11 || {};
      const r2 = e5.value, { templateRRFunctionNames: s11, showNoDataRecords: n14, returnDomainValues: a14, templateFields: o3 } = i11, l13 = e5.processedValues;
      let u6 = (_a = e5.catalogItems) == null ? void 0 : _a.features, p21 = ((_c = (_b = e5.properties) == null ? void 0 : _b.Values) == null ? void 0 : _c.map((e6) => e6.replaceAll(/ /gi, ", "))) || [];
      const m12 = this.objectIdField || "ObjectId", c22 = "string" == typeof r2 && r2.toLowerCase().includes("nodata"), d13 = [];
      if (r2 && !u6 && !c22) {
        const e6 = {};
        e6[m12] = 0;
        p21 = [r2], u6 = [new d7({ geometry: this.fullExtent, attributes: e6 })];
      }
      if (!u6) return [];
      let h4, y14, g7;
    ...
    _processMultidimensionalIntersection(e5, t6, i11) {
      const { multidimensionalSubset: r2 } = this;
      if (!r2) return { isOutSide: false, timeExtent: t6, mosaicRule: i11 = this._combineMosaicRuleWithTimeExtent(i11, t6) };
      if (r2) {
        const { isOutside: i12, intersection: s11 } = m2(r2, { geometry: e5, timeExtent: t6 });
        if (i12) return { isOutSide: true, timeExtent: null, mosaicRule: null };
        null != (s11 == null ? void 0 : s11.timeExtent) && (t6 = s11.timeExtent);
      }
      if (i11 = this._combineMosaicRuleWithTimeExtent(i11, t6), i11 == null ? void 0 : i11.multidimensionalDefinition) {
        const { isOutside: e6 } = m2(r2, { multidimensionalDefinition: i11.multidimensionalDefinition });
    ...
    _updateFeatureWithRasterAttributeTableValues(e5, t6) {
      ...
      if (null == i11) return;
      const { features: r2, fields: s11 } = i11, n14 = s11.map((e6) => e6.name).find((e6) => "value" === e6.toLowerCase());
      if (!n14) return;
    ...
    _updateFeatureWithMagDirValues(e5, t6) {
      ...
      const i11 = t6.split(/,\s*/).map((e6) => parseFloat(e6)), r2 = i11.map((e6) => [e6]), s11 = i11.map((e6) => ({ minValue: e6, maxValue: e6, noDataValue: null })), n14 = new g2({ height: 1, width: 1, pixelType: "f32", pixels: r2, statistics: s11 });
      null != this.pixelFilter && this.pixelFilter({ pixelBlock: n14, extent: new w(0, 0, 0, 0, this.spatialReference) });
      const a14 = "esriImageServiceDataTypeVector-MagDir" === this.serviceDataType ? [n14.pixels[0][0], n14.pixels[1][0]] : l2([n14.pixels[0][0], n14.pixels[1][0]]);
    ...
    _updateResponseFieldNames(e5, t6) {
      ...
      null != i11 && e5.forEach((e6) => {
        var _a;
        if (e6 == null ? void 0 : e6.attributes) for (const r2 of t6) {
          const t7 = (_a = i11.get(r2)) == null ? void 0 : _a.name;
    ...
    _applyMosaicAndRenderingRules(e5) {
      const { raster: t6, mosaicRule: i11, rasterFunction: r2 } = this;
    ...
    _readCapabilities(e5) {
      var _a;
      const t6 = e5.capabilities ? e5.capabilities.toLowerCase().split(",").map((e6) => e6.trim()) : ["image", "catalog"], { currentVersion: i11, advancedQueryCapabilities: r2, maxRecordCount: s11 } = e5, n14 = t6.includes("image"), a14 = "esriImageServiceDataTypeElevation" === e5.serviceDataType, o3 = !(!e5.spatialReference && !((_a = e5.extent) == null ? void 0 : _a.spatialReference)), l13 = t6.includes("edit"), u6 = t6.includes("mensuration") && o3, p21 = null == e5.mensurationCapabilities ? [] : e5.mensurationCapabilities.toLowerCase().split(",").map((e6) => e6.trim()), m12 = u6 && p21.includes("basic"), c22 = this._isMosaicDataset(e5) && t6.includes("catalog"), d13 = t6.includes("download");
      return { data: { supportsAttachment: false }, operations: { supportsComputeHistograms: n14, supportsExportImage: n14, supportsIdentify: n14, supportsImageToMap: i11 >= 11.2 && c22, supportsImageToMapMultiray: i11 >= 11.2 && c22, supportsMapToImage: i11 >= 11.2 && c22, supportsFindImages: i11 >= 11.2 && c22, supportsGetImageUrl: i11 >= 11.3 && d13, supportsMeasure: u6, supportsMeasureFromImage: i11 >= 11.2, supportsDownload: d13, supportsQuery: c22 && e5.fields && e5.fields.length > 0, supportsGetSamples: i11 >= 10.2 && n14, supportsProject: i11 >= 10.3 && n14, supportsComputeStatisticsHistograms: i11 >= 10.4 && n14, supportsQueryBoundary: i11 >= 10.6 && n14, supportsCalculateVolume: i11 >= 10.7 && a14, supportsComputePixelLocation: i11 >= 10.7 && c22, supportsComputeAngles: i11 >= 10.91, supportsQueryGPSInfo: i11 >= 11.2 && c22, supportsAdd: l13, supportsDelete: l13, supportsEditing: l13, supportsUpdate: l13, supportsCalculate: false, supportsTruncate: false, supportsValidateSql: false, supportsChangeTracking: false, supportsQueryAttachments: false, supportsResizeAttachments: false, supportsSync: false, supportsExceedsLimitStatistics: false, supportsQueryAnalytics: false, supportsQueryTopFeatures: false, supportsAsyncConvert3D: false }, query: { maxRecordCount: s11, maxRecordCountFactor: void 0, supportsStatistics: !!(r2 == null ? void 0 : r2.supportsStatistics), supportsOrderBy: !!(r2 == null ? void 0 : r2.supportsOrderBy), supportsDistinct: !!(r2 == null ? void 0 : r2.supportsDistinct), supportsPagination: !!(r2 == null ? void 0 : r2.supportsPagination), supportsStandardizedQueriesOnly: !!(r2 == null ? void 0 : r2.useStandardizedQueries), supportsPercentileStatistics: !!(r2 == null ? void 0 : r2.supportsPercentileStatistics), supportsCentroid: !!(r2 == null ? void 0 : r2.supportsReturningGeometryCentroid), supportsDistance: !!(r2 == null ? void 0 : r2.supportsQueryWithDistance), supportsExtent: !!(r2 == null ? void 0 : r2.supportsReturningQueryExtent), supportsGeometryProperties: !!(r2 == null ? void 0 : r2.supportsReturningGeometryProperties), supportsHavingClause: !!(r2 == null ? void 0 : r2.supportsHavingClause), supportsQuantization: false, supportsQuantizationEditMode: false, supportsQueryGeometry: false, supportsResultType: false, supportsMaxRecordCountFactor: false, supportsSqlExpression: false, supportsTopFeaturesQuery: false, supportsQueryByAnonymous: false, supportsQueryByOthers: false, supportsHistoricMoment: false, supportsFormatPBF: false, supportsDisjointSpatialRelationship: false, supportsCacheHint: false, supportsSpatialAggregationStatistics: false, supportedSpatialAggregationStatistics: { envelope: false, centroid: false, convexHull: false }, supportsDefaultSpatialReference: !!(r2 == null ? void 0 : r2.supportsDefaultSR), supportsFullTextSearch: false, supportsCompactGeometry: false, standardMaxRecordCount: void 0, tileMaxRecordCount: void 0 }, mensuration: { supportsDistanceAndAngle: m12, supportsAreaAndPerimeter: m12, supportsPointOrCentroid: m12, supportsHeightFromBaseAndTop: u6 && p21.includes("base-top height"), supportsHeightFromBaseAndTopShadow: u6 && p21.includes("base-top shadow height"), supportsHeightFromTopAndTopShadow: u6 && p21.includes("top-top shadow height"), supports3D: u6 && p21.includes("3d") } };
    }
  };
  function Ce2(e5) {
    return (e5 == null ? void 0 : e5.path) ?? "";
  }
  return e([y({ clonable: false })], g6.prototype, "_functionRasterInfos", void 0), e([y({ clonable: false })], g6.prototype, "_rasterJobHandler", void 0), e([y({ clonable: false })], g6.prototype, "_cachedRendererJson", void 0), e([y({ readOnly: true })], g6.prototype, "_serviceSupportsMosaicRule", void 0), e([o("_serviceSupportsMosaicRule", ["currentVersion", "fields"])], g6.prototype, "readServiceSupportsMosaicRule", null), e([y({ readOnly: true })], g6.prototype, "_rasterAttributeTableFieldPrefix", void 0), e([y({ readOnly: true })], g6.prototype, "_rasterFunctionNamesIndex", null), e([y()], g6.prototype, "adjustAspectRatio", void 0), e([y({ type: [N], json: { write: true } })], g6.prototype, "bandIds", void 0), e([o("bandIds")], g6.prototype, "readBandIds", null), e([y({ readOnly: true, json: { read: false } })], g6.prototype, "capabilities", void 0), e([o("service", "capabilities", ["capabilities", "currentVersion", "serviceDataType"])], g6.prototype, "readCapabilities", null), e([y({ type: Number })], g6.prototype, "compressionQuality", void 0), e([r("compressionQuality")], g6.prototype, "writeCompressionQuality", null), e([y({ type: Number })], g6.prototype, "compressionTolerance", void 0), e([r("compressionTolerance")], g6.prototype, "writeCompressionTolerance", null), e([y({ json: { read: { source: "copyrightText" } } })], g6.prototype, "copyright", void 0), e([y({ readOnly: true, dependsOn: ["_serviceSupportsMosaicRule"] })], g6.prototype, "defaultMosaicRule", void 0), e([o("defaultMosaicRule", ["defaultMosaicMethod"])], g6.prototype, "readDefaultMosaicRule", null), e([y({ type: String, json: { name: "layerDefinition.definitionExpression", write: { enabled: true, allowNull: true } } })], g6.prototype, "definitionExpression", void 0), e([y({ readOnly: true, constructOnly: true })], g6.prototype, "exportImageServiceParameters", void 0), e([y()], g6.prototype, "rasterInfo", void 0), e([y({ readOnly: true, type: [y3] })], g6.prototype, "fields", void 0), e([y({ readOnly: true })], g6.prototype, "fieldsIndex", null), e([y({ type: ["png", "png8", "png24", "png32", "jpg", "bmp", "gif", "jpgpng", "lerc", "tiff", "bip", "bsq"], json: { write: true } })], g6.prototype, "format", null), e([o("service", "format", ["serviceDataType"])], g6.prototype, "readFormat", null), e([y({ type: w })], g6.prototype, "fullExtent", void 0), e([y({ readOnly: true })], g6.prototype, "hasMultidimensions", void 0), e([y({ json: { read: { source: "maxImageHeight" } } })], g6.prototype, "imageMaxHeight", void 0), e([y({ json: { read: { source: "maxImageWidth" } } })], g6.prototype, "imageMaxWidth", void 0), e([y({ type: String, json: { type: a5.jsonValues, read: a5.read, write: a5.write } })], g6.prototype, "interpolation", void 0), e([y()], g6.prototype, "minScale", void 0), e([o("service", "minScale")], g6.prototype, "readMinScale", null), e([y()], g6.prototype, "maxScale", void 0), e([o("service", "maxScale")], g6.prototype, "readMaxScale", null), e([y({ type: j5 })], g6.prototype, "mosaicRule", null), e([o("mosaicRule", ["mosaicRule", "defaultMosaicMethod"])], g6.prototype, "readMosaicRule", null), e([r("mosaicRule")], g6.prototype, "writeMosaicRule", null), e([y()], g6.prototype, "multidimensionalInfo", void 0), e([y({ type: c3, json: { write: true } })], g6.prototype, "multidimensionalSubset", void 0), e([y({ json: { type: N } })], g6.prototype, "noData", void 0), e([r("noData")], g6.prototype, "writeNoData", null), e([y({ type: String, json: { type: i4.jsonValues, read: i4.read, write: i4.write } })], g6.prototype, "noDataInterpretation", void 0), e([y({ type: String, readOnly: true, json: { read: { source: ["fields"] } } })], g6.prototype, "objectIdField", void 0), e([o("objectIdField")], g6.prototype, "readObjectIdField", null), e([y({ readOnly: true })], g6.prototype, "geometryType", void 0), e([y({})], g6.prototype, "typeIdField", void 0), e([y({})], g6.prototype, "types", void 0), e([y({ readOnly: true })], g6.prototype, "parsedUrl", null), e([y({ type: Function })], g6.prototype, "pixelFilter", void 0), e([y()], g6.prototype, "raster", void 0), e([y({ readOnly: true })], g6.prototype, "sourceType", void 0), e([o("sourceType", ["serviceSourceType", "fields"])], g6.prototype, "readSourceType", null), e([y()], g6.prototype, "viewId", void 0), e([y({ types: l5, json: { name: "layerDefinition.drawingInfo.renderer", origins: { "web-scene": { types: d5, name: "layerDefinition.drawingInfo.renderer", write: { overridePolicy: (e5) => ({ enabled: e5 && "vector-field" !== e5.type && "flow" !== e5.type }) } } } } })], g6.prototype, "renderer", null), e([o("renderer")], g6.prototype, "readRenderer", null), e([r("renderer")], g6.prototype, "writeRenderer", null), e([y({ clonable: false })], g6.prototype, "symbolizer", void 0), e([y(w2)], g6.prototype, "opacity", void 0), e([y({ readOnly: true })], g6.prototype, "rasterFields", null), e([y({ constructOnly: true })], g6.prototype, "rasterFunctionInfos", void 0), e([y({ type: N2 })], g6.prototype, "renderingRule", null), e([y({ type: N2, json: { name: "renderingRule" } })], g6.prototype, "rasterFunction", null), e([o("rasterFunction", ["renderingRule", "rasterFunctionInfos"])], g6.prototype, "readRasterFunction", null), e([y({ readOnly: true })], g6.prototype, "serviceDataType", void 0), e([y({ readOnly: true, type: f2 })], g6.prototype, "spatialReference", void 0), e([o("spatialReference", ["spatialReference", "extent"])], g6.prototype, "readSpatialReference", null), e([y({ json: { type: n6.jsonValues } })], g6.prototype, "pixelType", void 0), e([o("pixelType")], g6.prototype, "readPixelType", null), e([r("pixelType")], g6.prototype, "writePixelType", null), e([y({ constructOnly: true, type: m })], g6.prototype, "serviceRasterInfo", void 0), e([y()], g6.prototype, "sourceJSON", void 0), e([y(p2)], g6.prototype, "url", void 0), e([y({ readOnly: true })], g6.prototype, "version", void 0), e([o("version", ["currentVersion", "fields", "timeInfo"])], g6.prototype, "readVersion", null), g6 = e([a3("esri.layers.mixins.ArcGISImageService")], g6), g6;
};

// ../node_modules/@arcgis/core/layers/ImageryLayer.js
var T2 = class extends l(l4(t(b(j3(Ce(f4(e2(l3(S(i2(f3))))))))))) {
  constructor(...e5) {
    super(...e5), this.isReference = null, this.operationalLayerType = "ArcGISImageServiceLayer", this.popupEnabled = true, this.popupTemplate = null, this.type = "imagery", this._debouncedSaveOperations = k(async (e6, r2, t6) => {
      const { save: s11, saveAs: i11 } = await import("./imageryUtils-4DYH5KGR.js");
      switch (e6) {
        case A.SAVE:
          return s11(this, r2);
        case A.SAVE_AS:
  ...
  load(e5) {
    ...
    return this.addResolvingPromise(this.loadFromPortal({ supportedTypes: ["Image Service"] }, e5).catch(a4).then(() => this._fetchService(r2))), Promise.resolve(this);
  }
  get legendEnabled() {
  ...
  writeOperationalLayerType(e5, r2, t6) {
    var _a;
    const s11 = "vector-field" === ((_a = this.renderer) == null ? void 0 : _a.type);
  ...
  createPopupTemplate(e5) {
    ...
    const p21 = p3({ fields: r2, title: t6 }, { ...e5, visibleFieldNames: s11 });
    return (p21 == null ? void 0 : p21.fieldInfos) && ((_a = this.rasterInfo) == null ? void 0 : _a.pixelType.startsWith("f")) && p21.fieldInfos.forEach(({ format: e6, fieldName: r3 }) => {
      e6 && r3 && /^raster\.(item|service)pixelvalue/i.test(r3) && (e6.places = 2);
    }), p21;
  }
  queryFeatures(e5, r2) {
    return this.queryRasters(e5, r2).then((e6) => {
      if (e6 == null ? void 0 : e6.features) for (const r3 of e6.features) r3.layer = r3.sourceLayer = this;
      return e6;
    });
  }
  ...
  write(e5, r2) {
    ...
    if (r2 == null ? void 0 : r2.messages) {
      ...
      r2.messages.push(new s("layer:unsupported", `Imagery preview layer (${this.title}, ${this.id}) of type '${this.declaredClass}' are not supported in the context of '${e6}'`, { layer: this }));
    }
    return null;
  }
};
e([y(y4)], T2.prototype, "legendEnabled", null), e([y({ type: ["show", "hide"] })], T2.prototype, "listMode", null), e([y({ type: Boolean, json: { read: false, write: { enabled: true, overridePolicy: () => ({ enabled: false }) } } })], T2.prototype, "isReference", void 0), e([y({ type: ["ArcGISImageServiceLayer"], json: { origins: { "web-map": { type: ["ArcGISImageServiceLayer", "ArcGISImageServiceVectorLayer"], read: false, write: { target: "layerType", ignoreOrigin: true } } } } })], T2.prototype, "operationalLayerType", void 0), e([r("web-map", "operationalLayerType")], T2.prototype, "writeOperationalLayerType", null), e([y(s2)], T2.prototype, "popupEnabled", void 0), e([y({ type: k2, json: { read: { source: "popupInfo" }, write: { target: "popupInfo" } } })], T2.prototype, "popupTemplate", void 0), e([y({ readOnly: true })], T2.prototype, "defaultPopupTemplate", null), e([y({ readOnly: true, json: { read: false } })], T2.prototype, "type", void 0), e([y({ readOnly: true })], T2.prototype, "_isPreviewLayer", null), T2 = e([a3("esri.layers.ImageryLayer")], T2);
var x2 = T2;
export {
  x2 as default
};
//# sourceMappingURL=ImageryLayer-ZIAXT3CC.js.map
