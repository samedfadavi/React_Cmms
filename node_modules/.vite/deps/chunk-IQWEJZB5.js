...
var U2 = L = class extends l(f4(t(b(j(S(f3)))))) {
  ...
  get tileServers() {
    ...
    const e2 = [], { urlTemplate: t2, subDomains: r3 } = this, l2 = new x(t2), o3 = l2.scheme ? l2.scheme + "://" : "//", n = o3 + l2.authority + "/", a3 = l2.authority;
  ...
  async fetchImageBitmapTile(e2, r3, l2, o3 = {}) {
    ...
    const i2 = this.getTileUrl(e2, r3, l2), n = { responseType: "blob", signal: s2, query: { ...this.refreshParameters } }, { data: a3 } = await U(i2, n);
...
e([y({ type: String, value: "", json: { write: true } })], U2.prototype, "copyright", void 0), e([y({ type: w, json: { write: true }, nonNullable: true })], U2.prototype, "fullExtent", void 0), e([y({ readOnly: true, json: { read: false, write: false } })], U2.prototype, "legendEnabled", void 0), e([y({ type: ["show", "hide"] })], U2.prototype, "listMode", void 0), e([y({ json: { read: true, write: true } })], U2.prototype, "blendMode", void 0), e([y()], U2.prototype, "levelValues", null), e([y({ type: Boolean, json: { read: false, write: { enabled: true, overridePolicy: () => ({ enabled: false }) } } })], U2.prototype, "isReference", void 0), e([y({ type: ["WebTiledLayer"], value: "WebTiledLayer" })], U2.prototype, "operationalLayerType", void 0), e([y({ readOnly: true, json: { read: false, write: false } })], U2.prototype, "popupEnabled", void 0), e([y({ type: f2 })], U2.prototype, "spatialReference", void 0), e([o("spatialReference", ["spatialReference", "fullExtent.spatialReference"])], U2.prototype, "readSpatialReference", null), e([y({ type: [String], json: { write: true } })], U2.prototype, "subDomains", void 0), e([y({ type: z, json: { write: true } })], U2.prototype, "tileInfo", void 0), e([y({ readOnly: true })], U2.prototype, "tileServers", null), e([y({ json: { read: false } })], U2.prototype, "type", void 0), e([y()], U2.prototype, "urlPath", null), e([y({ type: String, json: { origins: { "portal-item": { read: { source: "url" } } } } })], U2.prototype, "urlTemplate", void 0), e([o("urlTemplate", ["urlTemplate", "templateUrl"])], U2.prototype, "readUrlTemplate", null), e([r2("urlTemplate", { templateUrl: { type: String } })], U2.prototype, "writeUrlTemplate", null), e([y({ type: p2, json: { write: true } })], U2.prototype, "wmtsInfo", void 0), U2 = L = e([a2("esri.layers.WebTileLayer")], U2);
var I = U2;
...
//# sourceMappingURL=chunk-IQWEJZB5.js.map
