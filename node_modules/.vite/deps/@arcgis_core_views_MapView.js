  ...
  let y11 = class extends n31 {
    ...
    async setupPopup() {
      ...
      if ((_a = this._popupSetupTask) == null ? void 0 : _a.abort(), this.popup && !m11(this.popup)) return this._popupSetupTask = d2(async (e29) => {
        const { default: p24 } = await import("./Popup-CMP3KBPS.js");
...
async function c12(r26) {
  s15 || (s15 = import("./geometryServiceUtils-63NYHJCH.js").then((e29) => n19 = e29)), await s15, s3(r26);
}
...
function r17() {
  return Promise.all([import("./webglDeps-A26HXEK6.js"), import("./mapViewDeps-H3H5TK4I.js")]);
}
var a10 = () => r17().then(() => import("./TileLayerView2D-VKNK7LDK.js"));
var t18 = () => r17().then(() => import("./FeatureLayerView2D-NTMRGGAZ.js"));
var i16 = { "base-dynamic": () => r17().then(() => import("./BaseDynamicLayerView2D-ALS232LD.js")), "base-tile": a10, "bing-maps": a10, catalog: () => r17().then(() => import("./CatalogLayerView2D-XGMLZNBF.js")), "catalog-dynamic-group": () => r17().then(() => import("./CatalogDynamicGroupLayerView2D-JVZG3PBP.js")), "catalog-footprint": () => r17().then(() => import("./CatalogFootprintLayerView2D-DPO6JKOH.js")), csv: t18, "geo-rss": () => r17().then(() => import("./GeoRSSLayerView2D-QHTMCMRA.js")), feature: t18, geojson: t18, graphics: () => r17().then(() => import("./GraphicsLayerView2D-QNK7TP6T.js")), group: () => r17().then(() => import("./GroupLayerView2D-KCMOE5J4.js")), imagery: () => r17().then(() => import("./ImageryLayerView2D-EW7X62XW.js")), "imagery-tile": () => r17().then(() => import("./ImageryTileLayerView2D-CAJU6AJI.js")), kml: () => r17().then(() => import("./KMLLayerView2D-6WM563XE.js")), "knowledge-graph": () => r17().then(() => import("./KnowledgeGraphLayerView2D-V5QX2HRV.js")), "link-chart": () => r17().then(() => import("./KnowledgeGraphLayerView2D-V5QX2HRV.js")), "knowledge-graph-sublayer": t18, "map-image": () => r17().then(() => import("./MapImageLayerView2D-SQNZEMWI.js")), "map-notes": () => r17().then(() => import("./MapNotesLayerView2D-BASRUCHV.js")), media: () => r17().then(() => import("./MediaLayerView2D-6AWJSYXQ.js")), "ogc-feature": () => r17().then(() => import("./OGCFeatureLayerView2D-6VJTYSNM.js")), "open-street-map": a10, "oriented-imagery": t18, route: () => r17().then(() => import("./RouteLayerView2D-6IBWJV5M.js")), stream: () => r17().then(() => import("./StreamLayerView2D-HD5GULSY.js")), "subtype-group": () => r17().then(() => import("./SubtypeGroupLayerView2D-VXFGFUUQ.js")), tile: a10, "vector-tile": () => r17().then(() => import("./VectorTileLayerView2D-QFW5T3V4.js")), video: () => r17().then(() => import("./VideoLayerView2D-RZB4QYGS.js")), wcs: () => r17().then(() => import("./ImageryTileLayerView2D-CAJU6AJI.js")), "web-tile": a10, wfs: t18, wms: () => r17().then(() => import("./WMSLayerView2D-5NHD7NXU.js")), wmts: () => r17().then(() => import("./WMTSLayerView2D-HR4AWRR2.js")), "line-of-sight": null, "base-elevation": null, "building-scene": null, dimension: null, elevation: null, "integrated-mesh": null, "integrated-mesh-3dtiles": null, "point-cloud": null, voxel: null, scene: null, unknown: null, unsupported: null };
function s20(r26) {
...
var J2;
async function K2() {
  const [, { GraphicsView2D: e29, GraphicContainer: t29, LabelManager: i22, MapViewNavigation: r26, MagnifierView2D: s29, Stage: a22 }] = await Promise.all([import("./webglDeps-A26HXEK6.js"), import("./mapViewDeps-H3H5TK4I.js")]);
