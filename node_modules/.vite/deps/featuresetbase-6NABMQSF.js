...
import "./chunk-3PSL3WSW.js";
import "./chunk-I7VQ35HP.js";
import "./chunk-4TEPLCXX.js";
import "./chunk-TPYC4AVC.js";
import "./chunk-RMOPI4S6.js";
  ...
  "async" === q2.mode && (q2.functions.timezone = function(t3, r2) {
    ...
    return q2.standardFunctionAsync(e2, n, (r2, s, l3) => {
      ...
      if (l3[0] instanceof t2) {
        ...
        let u3;
        return u3 = ((_a = e2.services) == null ? void 0 : _a.portal) ? e2.services.portal : C.getDefault(), u3 = l2(l3[0], u3), G2(t3, r3, e2.spatialReference ?? null, s2, f2, u3, e2.lrucache, e2.interceptor);
      }
      ...
      return G2(f, u2, e2.spatialReference ?? null, d2, c2, ((_b = e2.services) == null ? void 0 : _b.portal) ?? C.getDefault(), e2.lrucache, e2.interceptor);
    });
        ...
        if (!(o[0] instanceof N)) throw new a(e2, r.InvalidParameter, t3);
        {
          ...
          if (null !== r3) {
            ...
            for (const n2 of te2(r3, "fields", [])) {
              const e4 = { name: te2(n2, "name", ""), alias: te2(n2, "alias", ""), type: te2(n2, "type", ""), nullable: te2(n2, "nullable", true), editable: te2(n2, "editable", true), length: te2(n2, "length", null), domain: ne(te2(n2, "domain")) };
              t4.push(e4);
            }
            ...
            for (const e3 of o2) {
              const t4 = { name: te2(e3, "name", ""), alias: te2(e3, "alias", ""), type: te2(e3, "type", ""), nullable: te2(e3, "nullable", true), editable: te2(e3, "editable", true), length: te2(e3, "length", null), domain: ne(te2(e3, "domain")) };
              s2.push(t4);
            }
            ...
            if (U(u2)) for (const e3 of u2) {
              ...
              l3.featureSet.features.push({ attributes: t4, geometry: ie(te2(e3, "geometry", null)) });
            }
    ...
    return q2.standardFunctionAsync(e2, t3, async (n, r2, s) => {
      ...
      if (B(s[0])) {
        const t4 = await s[0].load(), n2 = O.create(s[1], t4.getFieldsIndex(), t4.dateFieldsTimeZoneDefaultUTC), a4 = n2.getVariables();
        if (a4.length > 0) {
          const t5 = [];
          for (let n3 = 0; n3 < a4.length; n3++) {
            const i2 = { name: a4[n3] };
            t5.push(await q2.evaluateIdentifier(e2, i2));
          }
          const i = {};
    ...
    return q2.standardFunctionAsync(e2, t3, async (n, r2, s) => {
      if (ae(s, 2, 2, e2, t3), B(s[0])) return new a3({ parentfeatureset: s[0], topnum: s[1] });
    ...
    return q2.standardFunctionAsync(e2, t3, async (n, a4, i) => {
    ...
    return q2.standardFunctionAsync(e2, t3, async (r2, s, o) => {
      ae(o, 1, 2, e2, t3);
      const f = { minsize: -1, maxsize: -1, types: null, returnMetadata: false };
      if (o.length > 1) {
        if (o[1] instanceof N) {
      ...
      if (H(o[0])) {
        let t4 = o[0]._layer;
        return t4 instanceof Ze && (t4 = T(t4, e2.spatialReference, ["*"], true, e2.lrucache, e2.interceptor)), null === t4 ? [] : false === B(t4) ? [] : (await t4.load(), t4.queryAttachments(o[0].field(t4.objectIdField), f.minsize, f.maxsize, f.types, f.returnMetadata));
      }
      if (null === o[0]) return [];
      throw new a(e2, r.InvalidParameter, t3);
    });
    ...
    return q2.standardFunctionAsync(e2, t3, async (n, r2, s) => {
      ...
      const I2 = await N2(F, y3.spatialReference, c2, p, e2.lrucache, e2.interceptor);
      await I2.load();
      ...
      if (D3 = D3.filter((e3) => e3.id === h[0].id), false === o.hasField(h[0].keyField) || null === o.field(h[0].keyField)) {
        ...
        if (e3) {
          ...
          return t4.parameters = { id: e3.attributes[h[0].keyField] }, I2.filter(t4);
        }
        return new u({ parentfeatureset: I2 });
      }
      const T2 = O.create(D3[0].keyField + "= @id", I2.getFieldsIndex(), I2.dateFieldsTimeZoneDefaultUTC);
      return T2.parameters = { id: o.field(h[0].keyField) }, I2.filter(T2);
    });
    ...
    return q2.standardFunctionAsync(e2, t3, async (n, r2, s) => {
      ...
      let O3 = null, z = new B2(new y({ name: "percentalong", alias: "percentalong", type: "double" }), O.create("0", y3.associations.getFieldsIndex(), y3.associations.dateFieldsTimeZoneDefaultUTC)), H2 = new B2(new y({ name: "side", alias: "side", type: "string" }), O.create("''", y3.associations.getFieldsIndex(), y3.associations.dateFieldsTimeZoneDefaultUTC));
      ...
      switch (f) {
        case "midspan": {
          ...
          e3.name = W2, e3.alias = W2, O3 = new B2(e3, O.create(`CASE WHEN (${A}='${F}') THEN ${E2} ELSE ${A} END`, y3.associations.getFieldsIndex(), y3.associations.dateFieldsTimeZoneDefaultUTC)), z = y3.unVersion >= 4 ? new I(L.findField(y3.associations.fields, T2.get("PERCENTALONG").name)) : new B2(new y({ name: "percentalong", alias: "percentalong", type: "double" }), O.create("0", y3.associations.getFieldsIndex(), y3.associations.dateFieldsTimeZoneDefaultUTC));
          break;
        }
        case "junctionedge": {
          ...
          const e3 = y2(L.findField(y3.associations.fields, A));
          e3.name = W2, e3.alias = W2, O3 = new B2(e3, O.create(`CASE WHEN (${A}='${F}') THEN ${E2} ELSE ${A} END`, y3.associations.getFieldsIndex(), y3.associations.dateFieldsTimeZoneDefaultUTC)), H2 = new B2(new y({ name: "side", alias: "side", type: "string" }), O.create(`CASE WHEN (${v2}=4) THEN 'from' ELSE 'to' END`, y3.associations.getFieldsIndex(), y3.associations.dateFieldsTimeZoneDefaultUTC));
          break;
        }
        case "connected": {
          let e3 = `${E2}='@T'`, t4 = `${A}='@T'`;
      ...
      D3 && (B3 = "1 <> 1");
      return new L({ parentfeatureset: y3.associations, adaptedFields: [new I(L.findField(y3.associations.fields, k2)), new I(L.findField(y3.associations.fields, P2)), O3, H2, q3, z], extraFilter: B3 ? O.create(B3, y3.associations.getFieldsIndex(), y3.associations.dateFieldsTimeZoneDefaultUTC) : null });
    });
    ...
    return q2.standardFunctionAsync(e2, t3, async (r2, s, o) => {
      ...
      for (const m2 of c2) if (G(m2)) {
        ...
        f.push({ name: t4, expression: e3 }), "%%%%FIELDNAME" === t4 && (d2 = true);
      } else {
        if (!(m2 instanceof N)) throw new a(e2, r.InvalidParameter, t3);
        {
          ...
          f.push({ name: n, expression: O.create(r3 || n, l3.getFieldsIndex(), l3.dateFieldsTimeZoneDefaultUTC) });
        }
      }
      ...
      for (const m2 of c2) {
        if (!(m2 instanceof N)) throw new a(e2, r.InvalidParameter, t3);
        {
          ...
          u2.push({ name: n, statistic: r3.toLowerCase(), expression: O.create(s2, l3.getFieldsIndex(), l3.dateFieldsTimeZoneDefaultUTC) });
        }
      }
      if (d2) {
        const e3 = {};
      ...
      for (const t4 of f) await ee2(t4.expression, q2, e2);
      for (const t4 of u2) await ee2(t4.expression, q2, e2);
    ...
    return q2.standardFunctionAsync(e2, t3, async (r2, s, o) => {
      if (B(o[0])) {
        ...
        for (const o2 of l3) if (G(o2)) {
          ...
          s2.push({ name: t4, expression: e3 }), "%%%%FIELDNAME" === t4 && (f = true);
        } else {
          if (!(o2 instanceof N)) throw new a(e2, r.InvalidParameter, t3);
          {
            ...
            s2.push({ name: n, expression: O.create(l4 || n, r3.getFieldsIndex(), r3.dateFieldsTimeZoneDefaultUTC) });
          }
        }
        if (f) {
          const e3 = {};
    ...
    return q2.standardFunctionAsync(e2, t3, async (a4, i, r2) => {
      if (ae(r2, 1, 1, e2, t3), !B(r2[0])) return null;
      const s = await r2[0].getFeatureSetInfo();
      return s ? N.convertObjectToArcadeDictionary({ layerId: s.layerId, layerName: s.layerName, itemId: s.itemId, serviceLayerUrl: s.serviceLayerUrl, webMapLayerId: s.webMapLayerId ?? null, webMapLayerTitle: s.webMapLayerTitle ?? null, className: null, objectClassId: null }, He(e2), false, false) : null;
    });
...
//# sourceMappingURL=featuresetbase-6NABMQSF.js.map
