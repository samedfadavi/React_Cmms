...
import {
  xn
} from "./chunk-DXP6ELIW.js";
import "./chunk-SG6UMYIZ.js";
import "./chunk-V2YNXA62.js";
import "./chunk-FPRNSQ4P.js";
...
async function W(e2, t) {
  const n3 = [];
  for (let r3 = 0; r3 < t.arguments.length; r3++) n3.push(await Y2(e2, t.arguments[r3]));
  return n3;
}
async function V(e2, t, n3) {
  if (true === t.preparsed) return n3(e2, null, t.arguments);
  return n3(e2, t, await W(e2, t));
}
var _2 = class extends r2 {
  ...
  marshalledCall(e2, t, n3, r3) {
    return r3(e2, t, async (o2, a2, i) => {
      ...
      return i = i.map((t2) => !_(t2) || t2 instanceof s3 ? t2 : n2(t2, e2, r3)), n2(await Pe(this.definition, l, i, t), n3, r3);
    });
  }
};
var z2 = class extends s {
  ...
  async global(e2) {
    ...
    if (t.valueset || (t.value = await Y2(this.executingContext, t.node), t.valueset = true), _(t.value) && !(t.value instanceof s3)) {
      const e3 = new s3();
  ...
  async loadModule(e2) {
    ...
    null == n3 && (n3 = new f({ wkid: 102100 })), this.moduleScope = Ge({}, e2.customfunctions, e2.timeZone), this.executingContext = { spatialReference: n3, services: e2.services, libraryResolver: new s2(e2.libraryResolver._moduleSingletons, this.source.syntax.loadedModules), exports: {}, abortSignal: void 0 === e2.abortSignal || null === e2.abortSignal ? { aborted: false } : e2.abortSignal, globalScope: this.moduleScope, console: e2.console ?? Ue, lrucache: e2.lrucache, timeZone: e2.timeZone ?? null, interceptor: e2.interceptor, localScope: null, depthCounter: { depth: 1 } }, await Y2(this.executingContext, this.source.syntax);
  }
};
...
async function Y2(e2, t, n3) {
  if (t.breakpoint && true !== n3) {
    const n4 = t.breakpoint();
    return await n4, Y2(e2, t, true);
  }
  try {
...
async function J2(e2, t) {
  const n3 = [];
  for (let o2 = 0; o2 < t.properties.length; o2++) n3[o2] = await Y2(e2, t.properties[o2]);
...
async function Q2(e2, t) {
  const n3 = await Y2(e2, t.value);
  if ("Identifier" === t.key.type) return { key: t.key.name, value: n3 };
  return { key: await Y2(e2, t.key), value: n3 };
}
async function X(e2, t) {
  const n3 = { testResult: true, lastAction: O };
  if (n3.testResult = await Y2(e2, t.test), false === n3.testResult) return O;
  if (true !== n3.testResult) throw new a(e2, r.BooleanConditionRequired, t);
  for (; true === n3.testResult && (n3.lastAction = await Y2(e2, t.body), n3.lastAction !== R) && !(n3.lastAction instanceof M); ) if (n3.testResult = await Y2(e2, t.test), true !== n3.testResult && false !== n3.testResult) throw new a(e2, r.BooleanConditionRequired, t);
  return n3.lastAction instanceof M ? n3.lastAction : O;
}
async function $(e2, t, n3) {
  const r3 = await Y2(e2, t.body);
  return n3.lastAction = r3, n3.lastAction === R || n3.lastAction instanceof M ? (n3.testResult = false, n3) : null !== t.update ? (await Y2(e2, t.update), n3) : n3;
}
async function ee(e2, t, n3) {
  var _a;
  if (null !== t.test) {
    const r3 = await Y2(e2, t.test);
    if (true === ((_a = e2.abortSignal) == null ? void 0 : _a.aborted)) throw new a(e2, r.Cancelled, t);
      ...
      try {
        ...
        s4 = "VariableDeclaration" === t.left.type ? Y2(e2, t.left) : Promise.resolve(), s4.then(() => {
          try {
            ...
            U(l) || G(l) ? ae2(e2, t, l, { reject: r3, resolve: n3 }, c) : Q(l) ? ie(e2, t, l, { reject: r3, resolve: n3 }, c) : l instanceof N || H(l) ? le(e2, t, l, { reject: r3, resolve: n3 }, c) : B(l) ? se(l.iterator(e2.abortSignal), e2, t, l, c, (e3) => {
              n3(e3);
            }, (e3) => {
              r3(e3);
            }, 0) : ae2(e2, t, [], { reject: r3, resolve: n3 }, c);
          } catch (s5) {
            r3(s5);
          }
        }, r3);
...
async function ue(e2, t) {
  ...
  if ("MemberExpression" === n3.type) {
    const r4 = { t: null }, l2 = await Y2(e2, n3.object);
    let s4 = null;
    r4.t = l2, true === n3.computed ? s4 = await Y2(e2, n3.property) : "Identifier" === n3.property.type && (s4 = n3.property.name);
    const c = r4.t;
    let u2;
    if (U(c)) {
      ...
      if (true !== c.hasField(s4)) throw new a(e2, r.FieldNotFound, t, { key: s4 });
      ...
      u2 = ge(await c.global(s4)), c.setGlobal(s4, "++" === t.operator ? u2 + 1 : u2 - 1);
    } else {
  ...
  let l;
  if (null != e2.localScope && void 0 !== e2.localScope[r3]) return l = ge(e2.localScope[r3].value), e2.localScope[r3] = { value: "++" === t.operator ? l + 1 : l - 1, valueset: true, node: t }, false === t.prefix ? l : "++" === t.operator ? l + 1 : l - 1;
  if (void 0 !== e2.globalScope[r3]) return l = ge(e2.globalScope[r3].value), e2.globalScope[r3] = { value: "++" === t.operator ? l + 1 : l - 1, valueset: true, node: t }, false === t.prefix ? l : "++" === t.operator ? l + 1 : l - 1;
...
async function pe(e2, t) {
  const n3 = t.left;
  if ("MemberExpression" === n3.type) {
    const r4 = await Y2(e2, n3.object);
    let l = null;
    if (true === n3.computed) l = await Y2(e2, n3.property);
    else {
      if ("Identifier" !== n3.property.type) throw new a(e2, r.InvalidIdentifier, t);
      l = n3.property.name;
    }
    const s4 = await Y2(e2, t.right);
    if (U(r4)) {
      ...
      if (true === r4.hasField(l)) r4.setField(l, fe2(s4, t.operator, r4.field(l), t, e2));
        ...
        if ("=" !== t.operator) throw new a(e2, r.FieldNotFound, t, { key: l });
      ...
      r4.setGlobal(l, fe2(s4, t.operator, await r4.global(l), t, e2));
    } else {
  ...
  if (null != e2.localScope && void 0 !== e2.localScope[r3]) {
    const n4 = await Y2(e2, t.right);
    return e2.localScope[r3] = { value: fe2(n4, t.operator, e2.localScope[r3].value, t, e2), valueset: true, node: t.right }, O;
  }
  if (void 0 !== e2.globalScope[r3]) {
    const n4 = await Y2(e2, t.right);
    return e2.globalScope[r3] = { value: fe2(n4, t.operator, e2.globalScope[r3].value, t, e2), valueset: true, node: t.right }, O;
  }
  throw new a(e2, r.InvalidIdentifier, t);
}
async function we(e2, t) {
  ...
  if ("CallExpression" === t.expression.type) {
    const n4 = await Y2(e2, t.expression);
    return n4 === O ? O : new x(n4);
  }
  const n3 = await Y2(e2, t.expression);
  return n3 === O ? O : new x(n3);
}
async function de(e2, t) {
  const n3 = await Y2(e2, t.test);
...
async function me2(e2, t, n3) {
  if (n3 >= t.body.length) return O;
  const r3 = await Y2(e2, t.body[n3]);
...
async function ge2(e2, t) {
  ...
  const n3 = await Y2(e2, t.argument);
  return new M(n3);
}
async function ye(e2, t) {
  const n3 = t.id.name.toLowerCase();
  return e2.globalScope[n3] = { valueset: true, node: null, value: new _2(t, e2) }, O;
}
async function ve(e2, t) {
  var _a, _b;
  const n3 = t.specifiers[0].local.name.toLowerCase(), r3 = e2.libraryResolver.loadLibrary(n3);
  let o2 = null;
  return ((_a = e2.libraryResolver._moduleSingletons) == null ? void 0 : _a.has(r3.uri)) ? o2 = e2.libraryResolver._moduleSingletons.get(r3.uri) : (o2 = new z2(r3), await o2.loadModule(e2), (_b = e2.libraryResolver._moduleSingletons) == null ? void 0 : _b.set(r3.uri, o2)), e2.globalScope[n3] = { value: o2, valueset: true, node: t }, O;
}
async function be(e2, t) {
  if (await Y2(e2, t.declaration), "FunctionDeclaration" === t.declaration.type) e2.exports[t.declaration.id.name.toLowerCase()] = "function";
...
async function Se(e2, t, n3) {
  return n3 >= t.declarations.length ? O : (await Y2(e2, t.declarations[n3]), n3 === t.declarations.length - 1 || await Se(e2, t, n3 + 1), O);
}
async function xe(e2, t) {
  let n3 = null;
  if (n3 = null === t.init ? null : await Y2(e2, t.init), null !== e2.localScope) {
    if (n3 === O && (n3 = null), "Identifier" !== t.id.type) throw new a(e2, r.InvalidIdentifier, t);
    const r4 = t.id.name.toLowerCase();
    return null != e2.localScope && (e2.localScope[r4] = { value: n3, valueset: true, node: t.init }), O;
  }
  if ("Identifier" !== t.id.type) throw new a(e2, r.InvalidIdentifier, t);
  const r3 = t.id.name.toLowerCase();
  return n3 === O && (n3 = null), e2.globalScope[r3] = { value: n3, valueset: true, node: t.init }, O;
}
async function Ie(e2, t) {
  const n3 = await Y2(e2, t.object);
...
async function Ce(e2, t) {
  const n3 = [];
  for (let r3 = 0; r3 < t.elements.length; r3++) n3.push(await Y2(e2, t.elements[r3]));
...
async function Re(e2, t) {
  const n3 = [];
  n3[0] = await Y2(e2, t.left), n3[1] = await Y2(e2, t.right);
...
async function je(e2, t) {
  if ("MemberExpression" === t.callee.type) {
    const n3 = await Y2(e2, t.callee.object);
    if (!(n3 instanceof z2)) throw new a(e2, r.FunctionNotFound, t);
    const r3 = false === t.callee.computed ? t.callee.property.name : await Y2(e2, t.callee.property);
    if (!n3.hasGlobal(r3)) throw new a(e2, r.FunctionNotFound, t);
    const o2 = await n3.global(r3);
...
async function Ee(e2, t) {
  ...
  for (let a2 = 0; a2 < t.expressions.length; a2++) {
    const r4 = await Y2(e2, t.expressions[a2]);
    n3[a2] = me(r4);
  }
  let r3 = "", o2 = 0;
...
var Ne = {};
async function Oe(e2, t, n3, r3) {
  const o2 = await Y2(e2, t.arguments[n3]);
...
async function Pe(e2, t, n3, r3) {
  ...
  for (let a2 = 0; a2 < n3.length; a2++) {
    ...
    "Identifier" === r4.type && null != t.localScope && (t.localScope[r4.name.toLowerCase()] = { d: null, value: n3[a2], valueset: true, node: null });
  }
  const l = await Y2(t, o2);
...
C(Ne, V), Y(Ne, V), M2(Ne, V), L(Ne, V), f2(Ne, V), xn({ functions: Ne, compiled: false, signatures: null, evaluateIdentifier: null, mode: "async", standardFunction: V, standardFunctionAsync: H2 }), Ne.iif = async function(e2, t) {
  ae(null === t.arguments ? [] : t.arguments, 3, 3, e2, t);
  const n3 = await Y2(e2, t.arguments[0]);
  ...
  const r3 = await Y2(e2, t.arguments[0]);
  if (3 === t.arguments.length) {
    const o2 = await Y2(e2, t.arguments[1]), a2 = p(r3, o2);
  ...
  return Oe(e2, t, 1, await Y2(e2, t.arguments[0]));
...
var Ke = { fixSpatialReference: Ze, parseArguments: W, standardFunction: V, standardFunctionAsync: H2, evaluateIdentifier: Me };
for (const We in Ne) Ne[We] = { value: new e(Ne[We]), valueset: true, node: null };
var De = function() {
};
function Ge(e2, t, n3) {
  const r3 = new De();
  ...
  a2.immutable = false, r3.textformatting = { value: a2, valueset: true, node: null };
  for (const o2 in t) r3[o2] = { value: new e(t[o2]), native: true, valueset: true, node: null };
  for (const o2 in e2) e2[o2] && "esri.Graphic" === e2[o2].declaredClass ? r3[o2] = { value: D.createFromGraphic(e2[o2], n3), valueset: true, node: null } : r3[o2] = { value: e2[o2], valueset: true, node: null };
  return r3;
}
function Ue(e2) {
  console.log(e2);
...
var Ze2 = Ke;
function qe(e2) {
  const t = { mode: "async", compiled: false, functions: {}, signatures: [], standardFunction: V, standardFunctionAsync: H2, evaluateIdentifier: Me };
  for (let n3 = 0; n3 < e2.length; n3++) e2[n3].registerFunctions(t);
  for (const n3 in t.functions) Ne[n3] = { value: new e(t.functions[n3]), valueset: true, node: null }, De.prototype[n3] = Ne[n3];
  for (let n3 = 0; n3 < t.signatures.length; n3++) o(t.signatures[n3], "async");
}
async function Te(e2, n3) {
  let r3 = n3.spatialReference;
  null == r3 && (r3 = new f({ wkid: 102100 }));
  let o2 = null;
  e2.usesModules && (o2 = new s2(/* @__PURE__ */ new Map(), e2.loadedModules));
  const l = Ge(n3.vars, n3.customfunctions, n3.timeZone), s4 = { spatialReference: r3, services: n3.services, exports: {}, libraryResolver: o2, abortSignal: void 0 === n3.abortSignal || null === n3.abortSignal ? { aborted: false } : n3.abortSignal, globalScope: l, console: n3.console ?? Ue, timeZone: n3.timeZone ?? null, lrucache: n3.lrucache, interceptor: n3.interceptor, localScope: null, depthCounter: { depth: 1 } };
  let c = await Y2(s4, e2);
...
//# sourceMappingURL=arcadeAsyncRuntime-XQMMZ6YT.js.map
