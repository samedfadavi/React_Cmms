...
function p({ displayField: t, editFieldsInfo: n2, fields: i2, objectIdField: o, title: r }, s) {
  if (!i2) return null;
  const l = w({ editFieldsInfo: n2, fields: i2, objectIdField: o }, s);
...
function w(e, n2) {
  ...
  return f(e.fields ?? [], (n2 == null ? void 0 : n2.ignoreFieldTypes) || I).map((n3) => new n({ fieldName: n3.name, isEditable: q(n3, e), label: n3.alias, format: g(n3), visible: c2(n3, { ...e, visibleFieldNames: i2 }) }));
}
function g(e) {
  switch (e.type) {
    case "small-integer":
...
//# sourceMappingURL=chunk-FTURJXD3.js.map
