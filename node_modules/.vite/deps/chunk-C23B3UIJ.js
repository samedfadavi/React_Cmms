...
async function T(n, e, a2 = true) {
  ...
  return { ...i2, coordinate: _.fromJSON(i2.coordinate) };
}
async function V(n, e) {
  const a2 = await s("nearestVertex", [r(n), n, e]);
  return { ...a2, coordinate: _.fromJSON(a2.coordinate) };
}
async function z(n, e, a2, i2) {
  return (await s("nearestVertices", [r(n), n, e, a2, i2])).map((n2) => ({ ...n2, coordinate: _.fromJSON(n2.coordinate) }));
}
function G(n) {
  var _a;
...
//# sourceMappingURL=chunk-C23B3UIJ.js.map
