...
var S = class {
  ...
  async load(t2) {
    ...
    const S2 = new Z(r);
    if (!b && (h && i4.push({ name: "feature-layer:spatial-reference-not-found", message: "Spatial reference not provided or found in features. Defaults to WGS84" }), !F)) throw new s("feature-layer:missing-property", "geometryType not set and couldn't be inferred from the provided features");
    ...
    for (const o2 of r) {
      if (null == o2.name && (o2.name = o2.alias), null == o2.alias && (o2.alias = o2.name), !o2.name) throw new s("feature-layer:invalid-field-name", "field name is missing", { field: o2 });
      if (o2.name === O2 && (o2.type = "esriFieldTypeOID"), !i2.jsonValues.includes(o2.type)) throw new s("feature-layer:invalid-field-type", `invalid type for field "${o2.name}"`, { field: o2 });
    ...
    const M = { warnings: i4, featureErrors: [], layerDefinition: { ...D, drawingInfo: o(F), templates: c(v), extent: I, geometryType: F, objectIdField: O2, fields: r, hasZ: p3, hasM: a, timeInfo: w2, dateFieldsTimeReference: Q }, assignedObjectIds: {} };
    if (this._queryEngine = new $({ fieldsIndex: Z.fromLayerJSON({ fields: r, timeInfo: w2, dateFieldsTimeReference: Q }), geometryType: F, hasM: a, hasZ: p3, objectIdField: O2, spatialReference: g2, featureStore: new m({ geometryType: F, hasM: a, hasZ: p3 }), timeInfo: w2, cacheSpatialQueries: true }), !(s2 == null ? void 0 : s2.length)) return this._nextObjectId = t, M;
    const Z2 = n(O2, s2);
  ...
  async _loadInitialFeatures(e, i4) {
    ...
    const { fullExtent: c2, timeExtent: m2 } = await this._queryEngine.fetchRecomputedExtents();
  ...
  async _applyEdits(e) {
    ...
    const { fullExtent: r, timeExtent: a } = await this._queryEngine.fetchRecomputedExtents();
  ...
  _applyUpdateEdits({ updateResults: e }, i4) {
    ...
    for (const c2 of i4) {
      const { attributes: i5, geometry: m2 } = c2, y2 = i5 == null ? void 0 : i5[l];
      if (null == y2) {
...
//# sourceMappingURL=MemorySourceWorker-XMNRKUQT.js.map
