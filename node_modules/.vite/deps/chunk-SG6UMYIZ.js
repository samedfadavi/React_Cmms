...
function y2(n, s2) {
  ...
  for (const e of a2) {
    if (l2++, e.length > 0 && e[0][h3] === s2) return { partId: l2, distanceAlong: o2, coordinate: new _({ hasZ: n.hasZ, hasM: n.hasM, spatialReference: n.spatialReference, x: e[0][0], y: e[0][1], ...n.hasZ ? { z: e[0][m3] } : {}, ...n.hasM ? { m: e[0][h3] } : {} }), segmentId: 0 };
    let t = -1;
    for (let a3 = 1; a3 < e.length; a3++) {
      const i2 = u3(e[a3 - 1], e[a3], r2);
      t++;
      const f3 = e[a3][h3] - e[a3 - 1][h3], y3 = e[a3][h3];
      if (y3 === s2) return { partId: l2, distanceAlong: i2 + o2, coordinate: new _({ hasZ: n.hasZ, hasM: n.hasM, spatialReference: n.spatialReference, x: e[a3][0], y: e[a3][1], ...n.hasZ ? { z: e[a3][m3] } : {}, ...n.hasM ? { m: e[a3][h3] } : {} }), segmentId: t };
      if (y3 > s2 && s2 > e[a3 - 1][h3]) {
        const y4 = (s2 - e[a3 - 1][h3]) / f3 * i2;
        let Z3 = n.hasZ ? p2(e[a3 - 1], e[a3], y4, r2) : d2(e[a3 - 1], e[a3], y4);
        Z3 = [...Z3, s2];
        const R3 = new _({ hasZ: n.hasZ, hasM: n.hasM, spatialReference: n.spatialReference, x: Z3[0], y: Z3[1], ...n.hasZ ? { z: Z3[m3] } : {}, ...n.hasM ? { m: Z3[h3] } : {} });
...
function Z2(n, s2) {
  ...
  let y3 = -1;
  if (0 === s2) return 0 === a2.length || 0 === a2[0].length ? null : { partId: 0, coordinate: new _({ hasZ: n.hasZ, hasM: n.hasM, spatialReference: n.spatialReference, x: a2[0][0][0], y: a2[0][0][1], ...n.hasZ ? { z: a2[0][0][u3] } : {}, ...n.hasM ? { m: a2[0][0][o2] } : {} }), segmentId: 0 };
  for (const e of a2) {
    y3++;
    let t = -1;
    for (let a3 = 1; a3 < e.length; a3++) {
      ...
      if (f3 === s2) return { partId: y3, coordinate: new _({ hasZ: n.hasZ, hasM: n.hasM, spatialReference: n.spatialReference, x: e[a3][0], y: e[a3][1], ...n.hasZ ? { z: e[a3][u3] } : {}, ...n.hasM ? { m: e[a3][o2] } : {} }), segmentId: t };
      if (f3 > s2) {
        let f4 = n.hasZ ? p2(e[a3 - 1], e[a3], s2 - l2, r2) : d2(e[a3 - 1], e[a3], s2 - l2);
        return f4 = [...f4, m2(e[a3 - 1][o2], e[a3][o2], i2, s2 - l2)], { partId: y3, coordinate: new _({ hasZ: n.hasZ, hasM: n.hasM, spatialReference: n.spatialReference, x: f4[0], y: f4[1], ...n.hasZ ? { z: f4[u3] } : {}, ...n.hasM ? { m: f4[o2] } : {} }), segmentId: t };
      }
      l2 = f3;
    }
  }
...
function M3(o2, f3) {
  ...
  o2.hasM && (W3 = m2(z2[x3], w2[x3], R3 ? r(z2, w2, h3) : h(z2, w2, false), R3 ? r(z2, g3, h3) : h(z2, g3, false))), o2.hasZ && false === f3.hasZ && (A = m2(z2[I2], w2[I2], R3 ? r(z2, w2, h3) : h(z2, w2, false), R3 ? r(z2, g3, h3) : h(z2, g3, false))), k2 = new _({ hasZ: R3, hasM: o2.hasM, spatialReference: f3.spatialReference, x: g3[0], y: g3[1], ...o2.hasZ ? { z: A } : {}, ...o2.hasM ? { m: W3 } : {} });
  let V = 0;
  for (let e = 0; e <= Z3; e++) {
...
//# sourceMappingURL=chunk-SG6UMYIZ.js.map
