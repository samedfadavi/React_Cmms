...
var d = class extends n2 {
  constructor(e2) {
    ...
    const { geometryType: t, spatialReference: o4, sourceSpatialReference: s2 } = e2;
...
var g = class extends d {
  ...
  async _fetchServiceDefinition(e2) {
    const r2 = { f: "json", ...this._config.customParameters }, i = U(e2.path, { query: r2, responseType: "json" }), o4 = (await i).data;
    return this._serviceDefinition = o4, o4;
  }
  _fetchWebSocketUrl(e2, t) {
    const r2 = e2[0], { urls: i, token: o4 } = r2, n3 = this._inferWebSocketBaseUrl(i);
  ...
  async _setFilter(e2, t) {
    ...
    const n3 = JSON.stringify({ filter: this._serializeFilter(e2, t) });
    let a3 = false;
    const c3 = L(), u = () => {
  ...
  _serializeFilter(e2, t) {
    ...
    if (e2 == null ? void 0 : e2.geometry) try {
  ...
  async _queryBuddyServices() {
    try {
      ...
      n.getLogger(this).error(new s("geoevent-connection", "Encountered an error when querying buddy services", { error: e2 }));
    }
  }
  ...
  async _queryBuddy(e2) {
    var _a;
    const t = new (await import("./@arcgis_core_layers_FeatureLayer__js.js")).default({ url: e2 }), { capabilities: r2 } = await t.load(), i = r2.query.supportsMaxRecordCountFactor, o4 = r2.query.supportsPagination, s2 = r2.query.supportsCentroid, n3 = this._config.maxRecordCountFactor, a3 = t.capabilities.query.maxRecordCount, l = i ? a3 * n3 : a3, h3 = new b();
    if (h3.outFields = this._config.outFields ?? ["*"], h3.where = ((_a = this._config.filter) == null ? void 0 : _a.where) ?? "1=1", h3.returnGeometry = true, h3.returnExceededLimitFeatures = true, h3.outSpatialReference = f.fromJSON(this._config.spatialReference), s2 && (h3.returnCentroid = true), i && (h3.maxRecordCountFactor = n3), o4) return h3.num = l, t.destroy(), this._queryPages(e2, h3);
    const d3 = await c(e2, h3, this._config.sourceSpatialReference);
    return t.destroy(), d3.data;
  }
  async _queryPages(e2, t, r2 = [], i = 0) {
    t.start = null != t.num ? i * t.num : null;
    const { data: o4 } = await c(e2, t, this._config.sourceSpatialReference);
...
function r(r2, i, s2, c3, l, u, a3, m, p) {
  const f2 = { source: r2, sourceSpatialReference: i, spatialReference: s2, geometryType: c3, filter: o3(l, u), maxReconnectionAttempts: a3, maxReconnectionInterval: m, customParameters: p };
...
//# sourceMappingURL=chunk-WZTFY7IX.js.map
