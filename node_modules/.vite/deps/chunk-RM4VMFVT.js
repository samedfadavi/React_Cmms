...
var m = d = class extends f {
  ...
  readHeightModel(e2, t, r2) {
    const o2 = p.read(e2);
    return o2 || ((r2 == null ? void 0 : r2.messages) && r2.messages.push(f2(e2, { context: r2 })), null);
  }
  readHeightUnit(e2, t, r2) {
    const o2 = g.read(e2);
    return o2 || ((r2 == null ? void 0 : r2.messages) && r2.messages.push(y2(e2, { context: r2 })), null);
  }
  ...
  static deriveUnitFromSR(e2, t) {
    const r2 = Y(t);
    return new d({ heightModel: e2.heightModel, heightUnit: r2 ?? void 0, vertCRS: e2.vertCRS });
  }
  write(e2, t) {
...
//# sourceMappingURL=chunk-RM4VMFVT.js.map
