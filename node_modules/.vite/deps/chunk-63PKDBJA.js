...
async function r2(l, e, o2) {
  ...
  return (await Promise.all(a2.map(async (o3, n2) => ({ value: o3, color: "opacity" === l.type ? await t(o3, l, e) : (await import("./visualVariableUtils-UXXQJZUU.js")).getColor(l, o3), label: r3 ? u3[n2] : (c == null ? void 0 : c[n2]) ?? "" })))).reverse();
}
async function t(e, n2, r3) {
  const t2 = new u(r3 ?? o), a2 = (await import("./visualVariableUtils-UXXQJZUU.js")).getOpacity(n2, e);
...
function a(l) {
  ...
  return o2.map((o3, n2) => ({ value: o3, color: u2(o3, l), label: e ? r3[n2] : (s2 == null ? void 0 : s2[n2]) ?? "" })).reverse();
}
function u2(e, o2) {
...
function i(e, o2) {
  ...
  if (e && "multipart" === e.type) e.colorRamps.reverse().forEach((r3, t2) => {
    0 === t2 ? n2.push({ value: o2.max, color: new u(r3.toColor), label: "high" }) : n2.push({ value: null, color: new u(r3.toColor), label: "" }), t2 === e.colorRamps.length - 1 ? n2.push({ value: o2.min, color: new u(r3.fromColor), label: "low" }) : n2.push({ value: null, color: new u(r3.fromColor), label: "" });
  });
  else {
    let r3, t2;
    e && "algorithmic" === e.type ? (r3 = e.fromColor, t2 = e.toColor) : (r3 = [0, 0, 0, 1], t2 = [255, 255, 255, 1]), n2 = [{ value: o2.max, color: new u(t2), label: "high" }, { value: o2.min, color: new u(r3), label: "low" }];
  }
  return n2;
}
...
//# sourceMappingURL=chunk-63PKDBJA.js.map
