...
function o2(n4, t2, e5) {
  return t2 ? Object.keys(t2).reduce((n5, u4) => {
    let i5 = n5[u4], f2 = t2[u4];
    return i5 === f2 ? n5 : void 0 === i5 ? (n5[u4] = a2(f2), n5) : (Array.isArray(f2) || Array.isArray(n5) ? (i5 = i5 ? Array.isArray(i5) ? n5[u4] = i5.concat() : n5[u4] = [i5] : n5[u4] = [], f2 && (Array.isArray(f2) || (f2 = [f2]), e5 ? f2.forEach((r3) => {
      i5.includes(r3) || i5.push(r3);
    }) : n5[u4] = f2.concat())) : f2 && "object" == typeof f2 ? n5[u4] = o2(i5, f2, e5) : n5.hasOwnProperty(u4) && !t2.hasOwnProperty(u4) || (n5[u4] = f2), n5);
  }, n4 || {}) : n4;
}
...
//# sourceMappingURL=chunk-YNL57W4I.js.map
