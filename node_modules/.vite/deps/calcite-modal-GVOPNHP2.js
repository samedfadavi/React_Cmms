...
var Modal = proxyCustomElement(class Modal2 extends H {
  ...
  render() {
    return h(Host, { key: "8564a697a28ed4b7901302a1737337cac97cfc5e", "aria-describedby": this.contentId, "aria-labelledby": this.titleId, "aria-modal": "true", role: "dialog" }, h("div", { key: "c0ecd13e2214b8a7a6239b19117a41570d46ff22", class: {
      [CSS.container]: true,
      [CSS.containerOpen]: this.opened,
      [CSS.containerEmbedded]: this.embedded
    } }, h("calcite-scrim", { key: "8083cb49047c5fe80ba6cdc6b842de6dac5a8b37", class: CSS.scrim, onClick: this.handleOutsideClose }), this.renderStyle(), h("div", { key: "d38c9e98e8b34626dc11bfaa73f71a0debc36fad", class: {
      [CSS.modal]: true
    }, ref: this.setTransitionEl }, h("div", { key: "9bc1a0823ddf4621b52db89237fe73344b3351a5", class: CSS.header }, this.renderCloseButton(), h("header", { key: "97d3a927123332d087366a90a406be6f10ce16a3", class: CSS.title }, h("slot", { key: "c7540bb4381dec0b88b18f0732a90b862d30c557", name: CSS.header }))), this.renderContentTop(), h("div", { key: "fe8943411971950170fabeac8bb79d2af7338227", class: {
      [CSS.content]: true,
      [CSS.contentNoFooter]: !this.hasFooter
    }, ref: (el) => this.modalContent = el }, h("slot", { key: "c31734ea1ea7aca1a625c8ac606c75500ae72021", name: SLOTS.content })), this.renderContentBottom(), this.renderFooter())));
  }
  renderFooter() {
...
@esri/calcite-components/dist/components/calcite-modal.js:
   ...
   *)
*/
//# sourceMappingURL=calcite-modal-GVOPNHP2.js.map
