import {
  i as i4
} from "./chunk-JSBYWL75.js";
import {
  t as t4
} from "./chunk-W366AY2Q.js";
import {
  C as C3
} from "./chunk-2UJLW7H2.js";
import {
  t as t5
...
var u8 = class extends h2 {
  ...
  processPath(t15) {
    const { _beginCut: i14, _endCut: r18, _middleCut: u14 } = this, n17 = t15.pathLength(), s13 = a6.createEmptyOptimizedCIM("esriGeometryPolyline");
    if (this._invert) {
...
var p3 = class extends h2 {
  ...
  processPath(s13) {
    if (0 === this._pattern.length()) {
      ...
      const r19 = n2(s13);
      return a6.fromJSONCIM({ paths: [r19] });
    }
    if (!this.iteratePath) {
      let r19 = true;
      ...
      if (this._pattern.isEmpty() || i15 < 0.1 * this._pattern.length()) {
        const r20 = n2(s13);
        return a6.fromJSONCIM({ paths: [r20] });
      }
    ...
    if (i14) if (this._walker.isPathEnd()) {
    ...
    return i14 == null ? void 0 : i14.reset(), i14;
  }
  isClippingRequired(t15) {
    const e14 = t2(t15);
    let i14 = 0;
  ...
  next() {
    ...
    for (; e14 = this._inputGeometries.next(); ) {
      if ("esriGeometryEnvelope" === e14.geometryType && this._width > 0) {
        ...
        return Math.min(i14.xmax - i14.xmin, i14.ymax - i14.ymin) - 2 * this._width < 0 ? e14 : a6.fromJSONCIM({ paths: [[[i14.xmin + this._width, i14.ymin + this._width], [i14.xmax - this._width, i14.ymin + this._width], [i14.xmax - this._width, i14.ymax - this._width], [i14.xmin + this._width, i14.ymax - this._width], [i14.xmin + this._width, i14.ymin + this._width]], [[i14.xmin, i14.ymin], [i14.xmin, i14.ymax], [i14.xmax, i14.ymax], [i14.xmax, i14.ymin], [i14.xmin, i14.ymin]]] });
      }
  ...
  next() {
    ...
    for (; r18 = this._inputGeometries.next(); ) {
      ...
      if ("esriGeometryEnvelope" === r18.geometryType) {
        ...
        const o9 = r18.asJSON();
        if (m(o9) && Math.min(o9.xmax - o9.xmin, o9.ymax - o9.ymin) + 2 * this._offset > 0) return a6.fromJSONCIM({ xmin: o9.xmin - this._offset, xmax: o9.xmax + this._offset, ymin: o9.ymin - this._offset, ymax: o9.ymax + this._offset });
      }
...
function f8(t15, e14, n17) {
  if (n17 && u11(t15, e14)) return { coord: t15, distance: 0 };
  ...
  return { coord: [r18, a12], distance: Math.sqrt(i14) };
}
...
function i12(r18) {
  ...
  let i14;
  return i14 = "rtl" === n15.checkContextual(r18) ? "IDNNN" : "ICNNN", [n15.bidiTransform(r18, i14, "VLYSN"), true];
}
...
var t12 = class {
  applyColorSubstituition(t15, a12) {
    ...
    const { width: e14, height: n17 } = t15, o9 = this._rasterizationCanvas, r18 = o9.getContext("2d", { willReadFrequently: true });
...
var n16 = class {
  ...
  rasterizeText(n17, h8) {
    ...
    const a12 = this._textRasterizationCanvas, l11 = a12.getContext("2d", { willReadFrequently: true });
    r17(l11, h8), this._parameters = h8, this._textLines = n17.split(/\r?\n/), this._lineHeight = this._computeLineHeight();
    const { decoration: d4, weight: c5 } = h8.font;
    ...
    if (a12.width = f9 + 2 * this._lineThroughWidthOffset, a12.height = u14, 0 === a12.width || 0 === a12.height) return a12.width = a12.height = 1, { size: [0, 0], image: new Uint32Array(0), sdf: false, simplePattern: false, anchorX: 0, anchorY: 0, canvas: a12 };
    ...
    this._fillStyle = s11(x4), this._haloStyle = i13(p7);
    ...
    if (g4) {
      l11.save();
      const e14 = h8.backgroundColor ?? [0, 0, 0, 0], i14 = ((_a = h8.borderLine) == null ? void 0 : _a.color) ?? [0, 0, 0, 0], n18 = 2 * u3(((_b = h8.borderLine) == null ? void 0 : _b.size) ?? 0);
    ...
    return { size: [S3, C5], image: new Uint32Array(W4.buffer), sdf: false, simplePattern: false, anchorX: k3, anchorY: L3, canvas: a12 };
  }
  _renderHalo(t15, e14, i14, s13, n17, o9) {
    ...
    const { decoration: c5, weight: g4 } = o9.font;
...
var M3 = class {
  ...
  get bounds() {
    if (!this._bounds) {
      const { height: t15, width: i14 } = this._mosaic.metrics, e14 = i14 * this._scale, n17 = Math.abs(t15) * this._scale, r18 = new Float32Array(8);
  ...
  _setTextureCoords({ x: t15, y: s13, width: i14, height: e14 }) {
    this._texcoords = { topLeft: [t15, s13], topRight: [t15 + i14, s13], bottomLeft: [t15, s13 + e14], bottomRight: [t15 + i14, s13 + e14] };
  }
};
var L2 = (t15, s13) => ({ code: 0, page: 0, sdf: true, rect: new t5(0, 0, 11, 8), textureBinding: s13, metrics: { advance: 0, height: 4, width: t15, left: 0, top: 0 } });
function R2(t15, s13) {
...
var B2 = class {
  ...
  shapeBackground(t15) {
    const s13 = this._borderLineSizePx || 0, i14 = (w4 + s13) / 2, e14 = this._borderLineSizePx ? i14 : 0, { xmin: o9, ymin: h8, xmax: n17, ymax: r18, x: a12, y: f9, width: c5, height: d4 } = this.bounds, m6 = [o9 - y4, h8 - y4], _6 = [n17 + y4, h8 - y4], l11 = [o9 - y4, r18 + y4], u14 = [n17 + y4, r18 + y4], x4 = R2([[m6[0] - i14, m6[1] - i14], [_6[0] + i14, _6[1] - i14], [m6[0] + e14, m6[1] + e14], [_6[0] - e14, _6[1] + e14]], t15), p7 = R2([[l11[0] + e14, l11[1] - e14], [u14[0] - e14, u14[1] - e14], [l11[0] - i14, l11[1] + i14], [u14[0] + i14, u14[1] + i14]], t15), b3 = R2([[m6[0] - i14, m6[1] - i14], [m6[0] + e14, m6[1] + e14], [l11[0] - i14, l11[1] + i14], [l11[0] + e14, l11[1] - e14]], t15), M4 = R2([[_6[0] - e14, _6[1] + e14], [_6[0] + i14, _6[1] - i14], [u14[0] - e14, u14[1] - e14], [u14[0] + i14, u14[1] + i14]], t15), L3 = { main: R2([m6, _6, l11, u14], t15), top: x4, bot: p7, left: b3, right: M4 };
...
function A5(t15, s13, i14) {
  ...
  for (; f9 !== r18; ) {
    const { code: s14, metrics: i15 } = t15[f9], o10 = Math.abs(i15.top);
...
function z(t15, s13) {
  ...
  return { x: 0, y: o9, height: t15[t15.length - 1].yMax + s13.lineHeight * (t15.length - 1) + e14 - o9, width: i14 };
}
function O2(t15, s13) {
  const i14 = s13.scale, e14 = new Array(), { glyphs: o9, isRightToLeft: h8 } = t15, n17 = A5(o9, h8, s13), r18 = n17.length ? z(n17, s13) : { x: 0, y: 0, height: 0, width: 0 }, a12 = a11(s13.horizontalAlignment), m6 = c4(s13.verticalAlignment), g4 = m6 === n14.Baseline ? 1 : 0, l11 = g4 ? 0 : m6 - 1, u14 = (1 - g4) * -r18.y + l11 * (r18.height / 2) + (g4 ? 1 : 0) * -_4;
  for (let f9 = 0; f9 < n17.length; f9++) {
    const { start: t16, end: h9, width: r19 } = n17[f9];
...
function l10(r18) {
  if (!r18) return null;
  const { xmin: n17, ymin: t15, xmax: i14, ymax: o9, spatialReference: s13 } = r18;
  return new j({ rings: [[[n17, t15], [n17, o9], [i14, o9], [i14, t15], [n17, t15]]], spatialReference: s13 });
}
function p6(e14) {
...
var Q = class {
  ...
  drawVectorMarker(t15, e14) {
    ...
    for (const d4 of r18) {
      (d4 == null ? void 0 : d4.symbol) && d4.geometry || W2().error("Invalid marker graphic", d4);
...
var Z2 = class extends Q {
  ...
  drawImage(t15, e14) {
    const { url: r18 } = t15, i14 = I(t15.scaleX, 1);
...
var $ = class extends Q {
  ...
  hitTest(t15, e14, r18, i14, n17, a12) {
    ...
    if (this._mapRotation = h8 ? n17 : 0, !has("esri-mobile")) {
      ...
      !(("CIMLineSymbol" === (e14 == null ? void 0 : e14.type) || "CIMPolygonSymbol" === (e14 == null ? void 0 : e14.type)) && ((_a = e14.symbolLayers) == null ? void 0 : _a.some(C))) && "CIMMeshSymbol" !== (e14 == null ? void 0 : e14.type) && (q(e14) ?? 0) < r19 && (this._searchDistPoint = t16);
    }
  ...
  drawImage(t15, e14) {
    const { url: r18 } = t15, i14 = I(t15.scaleX, 1), s13 = this._resourceManager.getResource(r18);
  ...
  drawText(t15, e14) {
    ...
    const s13 = p6(I(t15.height, t3.CIMTextSymbol.height)), { lineGapType: o9, lineGap: n17 } = t15, a12 = o9 ? nt(o9, I(n17), s13) : 0, l11 = "CIMBackgroundCallout" === ((_a = t15.callout) == null ? void 0 : _a.type), h8 = O2(i14.glyphMosaicItems, { scale: s13 / A2, angle: 0, xOffset: 0, yOffset: 0, horizontalAlignment: t15.horizontalAlignment, verticalAlignment: t15.verticalAlignment, maxLineWidth: g3(t15.lineWidth), lineHeight: V * Math.max(0.25, Math.min(a12 || 1, 4)), decoration: t15.font.decoration || "none", useCIMAngleBehavior: true, hasBackground: l11 }), c5 = this.reverseTransformPt(this._searchPoint), m6 = c5[0], f9 = c5[1];
...
var tt = class extends Q {
  ...
  drawImage(t15, e14) {
    const { colorSubstitutions: r18, url: i14, tintColor: s13 } = t15, o9 = I(t15.scaleX, 1), n17 = this._resourceManager.getResource(i14);
    if (null == n17) return;
    ...
    p7.save(), p7.setTransform({ m11: o9 * d4 * f9, m12: o9 * d4 * u14, m21: -d4 * u14, m22: d4 * f9, m41: m6[0], m42: m6[1] }), p7.drawImage(c5, -a12 / 2, -l11 / 2, a12, l11), p7.restore();
  }
  drawText(t15, e14) {
    if (!e14 || 0 === e14.length) return;
    this._textRasterizer || (this._textRasterizer = new n16());
    ...
    if (!i14) return;
    const { size: o9, anchorX: n17, anchorY: a12, canvas: l11 } = i14, h8 = o9[0] * (n17 + 0.5), c5 = o9[1] * (a12 - 0.5), m6 = this._ctx, f9 = this.transformPt([0, 0]), [u14, d4] = this.getTransformAngle(), p7 = 1;
    m6.save(), m6.setTransform({ m11: p7 * u14, m12: p7 * d4, m21: -p7 * d4, m22: p7 * u14, m41: f9[0] - p7 * h8, m42: f9[1] + p7 * c5 }), m6.drawImage(l11, 0, 0), m6.restore();
  }
  drawPictureFill(t15, e14) {
    if (!t15) return;
    let { colorSubstitutions: r18, height: i14, offsetX: s13, offsetY: o9, rotation: n17, scaleX: a12, tintColor: l11, url: h8 } = e14;
  ...
  drawPictureStroke(t15, r18) {
    if (!t15) return;
    let { colorSubstitutions: i14, capStyle: s13, joinStyle: n17, miterLimit: a12, tintColor: l11, url: h8, width: c5 } = r18;
...
var ot = (t15) => t15 ? { spatialReference: t15.spatialReference, rings: [[[t15.xmin, t15.ymin], [t15.xmin, t15.ymax], [t15.xmax, t15.ymax], [t15.xmax, t15.ymin], [t15.xmin, t15.ymin]]] } : null;
var nt = (t15, e14, r18) => {
  switch (t15) {
    case "ExtraLeading":
      return 1 + e14 / r18;
...
function at(e14, r18 = 1) {
  var _a;
  const i14 = w(e14), s13 = P(e14.fontStyleName), o9 = e14.fontFamilyName ?? t4, { weight: n17, style: a12 } = s13, l11 = r18 * (e14.height || 5), h8 = x(e14.horizontalAlignment), c5 = A(e14.verticalAlignment), m6 = L(e14), f9 = L(e14.haloSymbol), u14 = null != f9 ? r18 * (e14.haloSize ?? 0) : 0, d4 = "CIMBackgroundCallout" === ((_a = e14.callout) == null ? void 0 : _a.type) ? e14.callout.backgroundSymbol : null, p7 = L(d4), _6 = T(d4), g4 = N(d4);
  return { color: m6, size: l11, horizontalAlignment: h8, verticalAlignment: c5, font: { family: o9, style: S(a12), weight: g(n17), decoration: i14 }, halo: { size: u14 || 0, color: f9, style: a12 }, backgroundColor: p7, borderLine: null != _6 && null != g4 ? { size: _6, color: g4 } : null, pixelRatio: 1, premultiplyColors: true };
}
var lt = 1e-4;
function ht(t15) {
...
function $2(e14, t15, r18) {
  switch (t15.type) {
    ...
    case "CIMPointSymbol":
      null == r18 && (r18 = { x: 0, y: 0 }), e14.drawSymbol(t15, r18);
      break;
    case "CIMLineSymbol":
      null == r18 && (r18 = { paths: [[[0, 0], [10, 0]]] }), e14.drawSymbol(t15, r18);
      break;
    case "CIMPolygonSymbol":
      null == r18 && (r18 = { rings: [[[0, 0], [0, 10], [10, 10], [10, 0], [0, 0]]] }), e14.drawSymbol(t15, r18);
      break;
    case "CIMTextSymbol": {
      const r19 = { x: 0, y: 0 };
...
var Z3 = class {
  ...
  static _getTextInflatedSize(e14, t15, r18) {
    ...
    const { lineGapType: s13, lineGap: i14 } = t15, n17 = s13 ? nt(s13, i14 ?? 0, o9) : 0, l11 = "CIMBackgroundCallout" === ((_a = t15.callout) == null ? void 0 : _a.type), c5 = O2(a12.glyphMosaicItems, { scale: o9 / A2, angle: I(t15.angle), xOffset: I(t15.offsetX), yOffset: I(t15.offsetY), horizontalAlignment: t15.horizontalAlignment, verticalAlignment: t15.verticalAlignment, maxLineWidth: g3(t15.lineWidth), lineHeight: V * Math.max(0.25, Math.min(n17 || 1, 4)), decoration: t15.font.decoration || "none", useCIMAngleBehavior: true, hasBackground: l11 }).boundsT, m6 = Math.sqrt(c5.width * c5.width + c5.height * c5.height);
...
var ee = class _ee {
  ...
  static rasterize(e14, t15, r18, o9, a12 = true) {
    ...
    const l11 = e14.getContext("2d", { willReadFrequently: true }), m6 = K2.createScale(U2, -U2);
  ...
  static fromPictureFillSymbol(e14) {
    ...
    return l11.push({ type: "CIMPictureFill", invertBackfaceTexture: false, scaleX: 1, textureFilter: ie.Picture, tintColor: null, url: m6, height: h8, width: y5, offsetX: I(a12), offsetY: I(i14), rotation: I(-f9), colorSubstitutions: null }), c5;
  }
  static fromSimpleFillSymbol(e14) {
    const { color: r18, style: o9, outline: s13 } = e14, i14 = [], n17 = { type: "CIMPolygonSymbol", symbolLayers: i14 };
    if (s13) {
      const e15 = pe(s13);
      e15 && i14.push(e15);
    }
    if (o9 && "solid" !== o9 && "none" !== o9 && "esriSFSSolid" !== o9 && "esriSFSNull" !== o9) {
      const e15 = { type: "CIMLineSymbol", symbolLayers: [{ type: "CIMSolidStroke", color: ie2(r18), capStyle: U.Butt, joinStyle: w2.Miter, width: 0.75 }] };
      let s14 = 0;
      ...
      i14.push({ type: "CIMHatchFill", lineSymbol: e15, offsetX: 0, offsetY: 0, rotation: s14, separation: n18 }), "cross" === o9 || "esriSFSCross" === o9 ? i14.push({ type: "CIMHatchFill", lineSymbol: a(e15), offsetX: 0, offsetY: 0, rotation: 90, separation: n18 }) : "diagonal-cross" !== o9 && "esriSFSDiagonalCross" !== o9 || i14.push({ type: "CIMHatchFill", lineSymbol: a(e15), offsetX: 0, offsetY: 0, rotation: 45, separation: n18 });
    } else !o9 || "solid" !== o9 && "esriSFSSolid" !== o9 || i14.push({ type: "CIMSolidFill", enable: true, color: ie2(r18) });
    return n17;
  }
  static fromSimpleLineSymbol(e14) {
    const { cap: t15, color: r18, join: o9, marker: a12, miterLimit: s13, style: i14, width: n17 } = e14;
    let l11 = null;
    "solid" !== i14 && "none" !== i14 && "esriSLSSolid" !== i14 && "esriSLSNull" !== i14 && (l11 = [{ type: "CIMGeometricEffectDashes", dashTemplate: me(i14, t15), lineDashEnding: "NoConstraint", scaleDash: true, offsetAlongLine: null }]);
    const c5 = [];
    if (a12) {
      let e15;
      ...
      t16.markerPlacement = { type: "CIMMarkerPlacementAtExtremities", placePerPart: false, angleToLine: true, offset: 0, extremityPlacement: e15, offsetAlongLine: 0 }, c5.push(t16);
    }
    return c5.push({ type: "CIMSolidStroke", color: "none" !== i14 && "esriSLSNull" !== i14 ? ie2(r18) : [0, 0, 0, 0], capStyle: re(t15), joinStyle: oe2(o9), miterLimit: s13, width: n17, effects: l11 }), { type: "CIMLineSymbol", symbolLayers: c5 };
  }
  static fromPictureMarker(e14) {
    const { angle: t15, height: r18, width: o9, xoffset: a12, yoffset: s13 } = e14;
    let i14 = e14.url;
    return "esriPMS" === e14.type && e14.imageData && (i14 = e14.imageData), { type: "CIMPointSymbol", symbolLayers: [{ type: "CIMPictureMarker", invertBackfaceTexture: false, scaleX: 1, textureFilter: ie.Picture, tintColor: null, url: i14, size: r18, width: o9, offsetX: I(a12), offsetY: I(s13), rotation: I(-t15) }] };
  }
  static createCIMTextSymbolfromTextSymbol(t15) {
    const { angle: r18, color: o9, font: a12, haloColor: s13, haloSize: i14, horizontalAlignment: n17, kerning: l11, lineWidth: c5, text: m6, verticalAlignment: f9, xoffset: y5, yoffset: h8, backgroundColor: u14, borderLineColor: p7, borderLineSize: M4 } = t15;
    ...
    return (u14 || M4) && (E = { type: "CIMBackgroundCallout", margin: null, backgroundSymbol: { type: "CIMPolygonSymbol", symbolLayers: [{ type: "CIMSolidFill", color: ie2(u14) }, { type: "CIMSolidStroke", color: ie2(p7), width: M4 }] }, accentBarSymbol: null, gap: null, leaderLineSymbol: null, lineStyle: null }), { type: "CIMTextSymbol", angle: r18, blockProgression: C2.BTT, depth3D: 1, extrapolateBaselines: true, fontEffects: l3.Normal, fontEncoding: a4.Unicode, fontFamilyName: S3 || "Arial", fontStyleName: ne2(d4, L3), fontType: u5.Unspecified, haloSize: i14, height: z2, hinting: y.Default, horizontalAlignment: ae(n17 ?? "center"), kerning: l11, letterWidth: 100, ligatures: true, lineGapType: "Multiple", lineWidth: c5, offsetX: I(y5), offsetY: I(h8), strikethrough: "line-through" === D2, underline: "underline" === D2, symbol: { type: "CIMPolygonSymbol", symbolLayers: [{ type: "CIMSolidFill", enable: true, color: ie2(o9) }] }, haloSymbol: { type: "CIMPolygonSymbol", symbolLayers: [{ type: "CIMSolidFill", enable: true, color: ie2(s13) }] }, shadowColor: [0, 0, 0, 255], shadowOffsetX: 1, shadowOffsetY: 1, textCase: "Normal", textDirection: G3 ? ne.RTL : ne.LTR, verticalAlignment: se(f9 ?? "baseline"), verticalGlyphOrientation: oe.Right, wordSpacing: 100, billboardMode3D: T2.FaceNearPlane, callout: E };
  }
  static createPictureMarkerRasterizationParam(e14) {
    var _a, _b;
    const { angle: t15, height: r18, width: o9, xoffset: a12, yoffset: s13 } = e14, i14 = e14.url ?? ((_a = e14.source) == null ? void 0 : _a.url) ?? ((_b = e14.source) == null ? void 0 : _b.imageData);
    return i14 ? { type: "sprite-rasterization-param", overrides: [], resource: { type: "CIMPictureMarker", invertBackfaceTexture: false, scaleX: 1, textureFilter: ie.Picture, tintColor: null, url: i14, size: r18, width: o9, offsetX: I(a12), offsetY: I(s13), rotation: I(-t15) } } : null;
  }
  static createPictureFillRasterizationParam(e14) {
    const { width: t15, height: r18, xoffset: o9, yoffset: a12, url: s13 } = e14;
    return s13 ? { type: "sprite-rasterization-param", overrides: [], resource: { type: "CIMPictureFill", scaleX: 1, textureFilter: ie.Picture, tintColor: null, url: s13, width: t15, height: r18, offsetX: I(o9), offsetY: I(a12), rotation: 0 } } : null;
  }
  static fromSimpleMarker(e14, t15, r18) {
    const { style: o9 } = e14, a12 = e14.color ?? r18;
    if ("path" === o9 || "esriSMSPath" === o9) {
      const t16 = [];
      if ("outline" in e14 && e14.outline) {
        const r20 = e14.outline;
        t16.push({ type: "CIMSolidStroke", enable: true, width: r20.width, color: ie2(r20.color), path: e14.path });
      }
      t16.push({ type: "CIMSolidFill", enable: true, color: ie2(a12), path: e14.path });
      const [r19, o10] = ye("square");
      return { type: "CIMPointSymbol", symbolLayers: [{ type: "CIMVectorMarker", enable: true, rotation: -I(e14.angle), size: I(e14.size || 6), offsetX: I(e14.xoffset), offsetY: I(e14.yoffset), scaleSymbolsProportionally: false, frame: r19, markerGraphics: [{ type: "CIMMarkerGraphic", geometry: o10, symbol: { type: "CIMPolygonSymbol", symbolLayers: t16 } }] }] };
    }
    const s13 = [];
    ...
    if ("outline" in e14 && e14.outline && "none" !== e14.outline.style && "esriSLSNull" !== e14.outline.style) {
      ...
      const c6 = "cross" !== e14.style && "x" !== e14.style || "dot" === (e14 == null ? void 0 : e14.outline.style) || "short-dot" === (e14 == null ? void 0 : e14.outline.style) ? k2.HalfGap : k2.FullPattern, m6 = r19 ? [{ type: "CIMGeometricEffectAddControlPoints" }, { type: "CIMGeometricEffectDashes", dashTemplate: me(t16.style, null).map((e15) => t16.width && t16.width > 0 ? e15 * t16.width : e15), lineDashEnding: c6, controlPointEnding: k2.FullPattern }] : void 0;
      s13.push({ type: "CIMSolidStroke", capStyle: r19 ? U.Round : U.Butt, enable: true, width: a13, color: ie2(t16.color), effects: m6 });
    } else !t15 || "line-marker" !== e14.type || "cross" !== e14.style && "x" !== e14.style ? [i14, n17] = ye(o9) : ([i14, n17] = ye(o9), s13.push({ type: "CIMSolidStroke", enable: true, width: t15, color: ie2(a12) }));
    s13.push({ type: "CIMSolidFill", enable: true, color: ie2(a12) });
    const c5 = { type: "CIMPolygonSymbol", symbolLayers: s13 };
    return { type: "CIMPointSymbol", symbolLayers: [{ type: "CIMVectorMarker", enable: true, rotation: I(-e14.angle), size: I(l11 || 6 * t15), offsetX: I(e14.xoffset), offsetY: I(e14.yoffset), scaleSymbolsProportionally: false, frame: i14, markerGraphics: [{ type: "CIMMarkerGraphic", geometry: n17, symbol: c5 }] }] };
  }
  static fromCIMHatchFill(e14, r18) {
    ...
    (_a = s13.symbolLayers) == null ? void 0 : _a.forEach((e15) => {
      ...
      switch (e15.type) {
        case "CIMSolidStroke":
          null != e15.width && (e15.width *= r18), (_a2 = e15.effects) == null ? void 0 : _a2.forEach((e16) => {
            if ("CIMGeometricEffectDashes" === e16.type) {
              const t15 = e16.dashTemplate;
              e16.dashTemplate = t15 == null ? void 0 : t15.map((e17) => e17 * r18);
            }
          });
          break;
        case "CIMVectorMarker": {
    ...
    for (; i14 < H; ) i14 *= 2;
    const n17 = i14 / 2;
    return { type: "CIMVectorMarker", frame: { xmin: -n17, xmax: n17, ymin: -a12, ymax: a12 }, markerGraphics: [{ type: "CIMMarkerGraphic", geometry: { paths: [[[-n17, 0], [n17, 0]]] }, symbol: s13 }], size: o9 };
  }
  static fetchResources(e14, t15, r18, o9 = null) {
    return e14 && t15 ? (te(e14, (e15) => {
      ue(e15, t15, r18), "url" in e15 && e15.url && r18.push(t15.fetchResource(e15.url, { signal: o9 }));
    }), r18) : r18;
  }
  static fetchFonts(e14, t15, r18) {
    if (e14 && t15) {
      if ("symbolLayers" in e14 && e14.symbolLayers) {
        for (const o9 of e14.symbolLayers) if ("CIMVectorMarker" === o9.type && o9.markerGraphics) for (const e15 of o9.markerGraphics) (e15 == null ? void 0 : e15.symbol) && _ee.fetchFonts(e15.symbol, t15, r18);
      } else if ("CIMTextSymbol" === e14.type) {
        const { fontFamilyName: o9, fontStyleName: a12 } = e14;
        if (!o9 || "calcitewebcoreicons" === o9.toLowerCase()) return;
        const { style: s13, weight: i14 } = P(a12), n17 = w(e14), c5 = new m2({ family: o9, style: s13, weight: i14, decoration: n17 });
  ...
  static fromCIMInsidePolygon(e14) {
    const t15 = e14.markerPlacement, r18 = { ...e14 };
    ...
    if ("Random" === t15.gridType) {
      ...
      for (let t16 = 0; t16 < r19; t16++) for (let e16 = 0; e16 < y5; e16++) {
        ...
        f9.push({ x: r20, y: o9 }), 0 === t16 && f9.push({ x: r20 + 2 * l11, y: o9 }), 0 === e16 && f9.push({ x: r20, y: o9 + 2 * c5 });
      }
    } else true === t15.shiftOddRows ? (l11 = s13 / 2, c5 = i14, m6 = 2 * i14, f9 = [{ x: -l11, y: 0 }, { x: l11, y: 0 }, { x: 0, y: c5 }, { x: 0, y: -c5 }]) : (l11 = s13 / 2, c5 = i14 / 2, m6 = i14, f9 = [{ x: -s13, y: 0 }, { x: 0, y: -i14 }, { x: -s13, y: -i14 }, { x: 0, y: 0 }, { x: s13, y: 0 }, { x: 0, y: i14 }, { x: s13, y: i14 }, { x: -s13, y: i14 }, { x: s13, y: -i14 }]);
    return { type: "CIMVectorMarker", frame: { xmin: -l11, xmax: l11, ymin: -c5, ymax: c5 }, markerGraphics: f9.map((e15) => ({ type: "CIMMarkerGraphic", geometry: e15, symbol: { type: "CIMPointSymbol", symbolLayers: [r18] } })), size: m6 };
  }
};
function te(e14, t15) {
  if (e14) switch (e14.type) {
...
var ie2 = (e14) => {
  ...
  const { r: t15, g: r18, b: o9, a: a12 } = e14;
...
var ye = (e14, t15 = 100) => {
  ...
  if ("circle" === s13 || "esriSMSCircle" === s13) {
    ...
    i14.push([r18, 0]), o9 = { rings: [i14] }, a12 = { xmin: -r18, ymin: -r18, xmax: r18, ymax: r18 };
  } else if ("cross" === s13 || "esriSMSCross" === s13) {
    const e15 = 0;
    o9 = { paths: [[[e15, r18], [e15, -r18]], [[r18, e15], [-r18, e15]]] }, a12 = { xmin: -r18, ymin: -r18, xmax: r18, ymax: r18 };
  } else if ("diamond" === s13 || "esriSMSDiamond" === s13) o9 = { rings: [[[-r18, 0], [0, r18], [r18, 0], [0, -r18], [-r18, 0]]] }, a12 = { xmin: -r18, ymin: -r18, xmax: r18, ymax: r18 };
  else if ("square" === s13 || "esriSMSSquare" === s13) o9 = { rings: [[[-r18, -r18], [-r18, r18], [r18, r18], [r18, -r18], [-r18, -r18]]] }, a12 = { xmin: -r18, ymin: -r18, xmax: r18, ymax: r18 };
  else if ("x" === s13 || "esriSMSX" === s13) o9 = { paths: [[[r18, r18], [-r18, -r18]], [[r18, -r18], [-r18, r18]]] }, a12 = { xmin: -r18, ymin: -r18, xmax: r18, ymax: r18 };
  else if ("triangle" === s13 || "esriSMSTriangle" === s13) {
    const e15 = t15 * 0.5773502691896257, r19 = -e15, s14 = 2 / 3 * t15, i14 = s14 - t15;
    o9 = { rings: [[[r19, i14], [0, s14], [e15, i14], [r19, i14]]] }, a12 = { xmin: r19, ymin: i14, xmax: e15, ymax: s14 };
  } else "arrow" === s13 && (o9 = { rings: [[[-50, 50], [50, 0], [-50, -50], [-33, -20], [-33, 20], [-50, 50]]] }, a12 = { xmin: -r18, ymin: -r18, xmax: r18, ymax: r18 });
  return [a12, o9];
};
...
function pe(e14) {
  if (!e14) return null;
  let t15 = null;
  const { cap: r18, color: o9, join: a12, miterLimit: s13, style: i14, width: n17 } = e14;
  return "solid" !== i14 && "none" !== i14 && "esriSLSSolid" !== i14 && "esriSLSNull" !== i14 && (t15 = [{ type: "CIMGeometricEffectDashes", dashTemplate: me(i14, r18), lineDashEnding: "NoConstraint", scaleDash: true, offsetAlongLine: null }]), { type: "CIMSolidStroke", color: "esriSLSNull" !== i14 && "none" !== i14 ? ie2(o9) : [0, 0, 0, 0], capStyle: re(r18), joinStyle: oe2(a12), miterLimit: s13, width: n17, effects: t15 };
}
...
//# sourceMappingURL=chunk-CWKNMWWX.js.map
