...
var a2 = { async request(a6, s6) {
  ...
  const i3 = await U(a6.url, r2), o = { data: i3.data, httpStatus: i3.httpStatus, ssl: i3.ssl };
...
function r(s6) {
  var _a;
  const r2 = { async: s6.async, isDebug: s6.isDebug, locale: s6.locale, baseUrl: s6.baseUrl, has: { ...s6.has }, map: { ...s6.map }, packages: ((_a = s6.packages) == null ? void 0 : _a.concat()) || [], paths: { ...a3.paths, ...s6.paths } };
...
function b2() {
  ...
  const a6 = s.workers.loaderConfig, i3 = r({ baseUrl: a6 == null ? void 0 : a6.baseUrl, locale: c2(), has: { "csp-restrictions": 1, "dojo-test-sniff": 0, "host-webworker": 1, ...a6 == null ? void 0 : a6.has }, map: { ...a6 == null ? void 0 : a6.map }, paths: { ...a6 == null ? void 0 : a6.paths }, packages: (a6 == null ? void 0 : a6.packages) || [] }), l3 = { buildDate: e, fullVersion: i, revision: c };
  return JSON.stringify({ esriConfig: o, loaderConfig: i3, kernelInfo: l3 });
}
var v = 0;
...
var j = class _j {
  ...
  _onInvokeMessage(e4) {
    const { methodName: t2, jobId: o, data: s6, abortable: i3 } = e4, l3 = i3 ? new AbortController() : null, c5 = this._inJobs, h3 = a2[t2];
    let p3;
    try {
      if ("function" != typeof h3) throw new TypeError(`${t2} is not a function`);
      p3 = h3.call(null, s6, { signal: l3 ? l3.signal : null });
    } catch (b4) {
      return void this._post({ type: u, jobId: o, error: i2(b4) });
    }
    S(p3) ? (c5.set(o, { controller: l3, promise: p3 }), p3.then((e5) => {
      c5.has(o) && (c5.delete(o), this._post({ type: u, jobId: o }, e5));
    }, (e5) => {
      c5.has(o) && (c5.delete(o), e5 || (e5 = { message: "Error encountered at method" + t2 }), b(e5) || this._post({ type: u, jobId: o, error: i2(e5 || { message: `Error encountered at method ${t2}` }) }));
    })) : this._post({ type: u, jobId: o }, p3);
  }
  _onOpenedMessage(e4) {
    const { jobId: t2, data: s6 } = e4, r2 = this._outJobs.get(t2);
    r2 && (this._outJobs.delete(t2), l(r2.abortHandle), r2.resolve(s6));
  }
  _onResponseMessage(t2) {
    const { jobId: s6, error: r2, data: n4 } = t2, a6 = this._outJobs.get(s6);
...
async function f2(r2, t2) {
  const n4 = new c3(), { registryTarget: i3, ...s6 } = t2;
  return await n4.open(r2, s6), i3 && e2(i3, n4), n4;
}
async function p2(e4, o = {}) {
  ...
  if (has("host-webworker") && !has("esri-workers") && (i3 = "local"), "local" === i3) {
    ...
    return f2([E.connect(r2, o.schedule)], { ...o, client: i4 });
  }
  if (await g3(), s3(o.signal), "dedicated" === i3) {
    const r2 = c4++ % a5;
    return f2([await l2[r2].open(e4, o)], o);
  }
...
//# sourceMappingURL=chunk-ZRA2NDCA.js.map
