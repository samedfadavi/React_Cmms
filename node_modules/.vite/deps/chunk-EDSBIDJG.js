...
Object.defineProperty(n, "className", { enumerable: true, configurable: true, writable: true, value: "RoundedRectangle" }), Object.defineProperty(n, "classNames", { enumerable: true, configurable: true, writable: true, value: Ge.classNames.concat([n.className]) });
var o = class extends si {
  _afterNew() {
    this._settings.themeTags = Wt(this._settings.themeTags, ["button"]), super._afterNew(), this._settings.background || this.set("background", n.new(this._root, { themeTags: Wt(this._settings.themeTags, ["background"]) })), this.setPrivate("trustBounds", true);
  }
  _prepareChildren() {
...
Object.defineProperty(o, "className", { enumerable: true, configurable: true, writable: true, value: "Button" }), Object.defineProperty(o, "classNames", { enumerable: true, configurable: true, writable: true, value: si.classNames.concat([o.className]) });

export {
  n,
  o
};
//# sourceMappingURL=chunk-EDSBIDJG.js.map
