...
function K({ vertexSpace: r, transform: t2, inSpatialReference: o3, outSpatialReference: e4, localMode: n5, outPositions: c2, positions: a2 }) {
  const s2 = r.origin ?? l, l3 = null != r.origin ? (t2 == null ? void 0 : t2.localMatrix) ?? o : o, m = a(o3), u2 = e4.isWebMercator && n5 || !J(o3, m) ? o3 : m;
  u(o3, s2, tr, u2), c(tr, tr, l3);
  const T2 = c2 ?? t(a2.length);
  return e3(T2, a2, tr), n2(T2, u2, 0, T2, e4, 0, T2.length / 3), T2;
}
function Q({ vertexSpace: r, transform: t2, outPositions: o3, positions: e4, inSpatialReference: n5, outSpatialReference: i2 }) {
  const a2 = null != r.origin ? (t2 == null ? void 0 : t2.localMatrix) ?? o : o, s2 = o3 ?? t(e4.length);
...
//# sourceMappingURL=chunk-UPW2DNCP.js.map
