...
function N(t, n3, { vertexSpace: r, spatialReference: e5 }) {
  ...
  const { origin: a2 } = r, s = tt;
  if (!u(e5, a2, s, o2)) return false;
  const c3 = h(tt, s);
  return null != c3 && (O(t, i2, c3), true);
}
function M(t, r, e5) {
  const { vertexSpace: o2, transform: i2, vertexAttributes: l } = t, s = J(t.spatialReference, e5, nt.SOURCE | nt.TARGET);
  if (m(o2, r) && (!i2 || B(i2.localMatrix, o)) && x(s, 1)) {
    const { position: t2, normal: n3, tangent: r2 } = l, o3 = e5 == null ? void 0 : e5.allowBufferReuse;
    return { position: o3 ? t2 : t2.slice(), normal: o3 ? n3 : n3 == null ? void 0 : n3.slice(), tangent: o3 ? r2 : r2 == null ? void 0 : r2.slice() };
  }
...
function k2({ vertexAttributes: t, transform: n3, spatialReference: r }, { origin: e5 }, o2, i2) {
  const { position: l, normal: a2, tangent: s } = n3 ? q2(t, n3.localMatrix) : t, c3 = new Float64Array(l.length);
  let u2 = l;
  ...
  J(r, i2, nt.NONE);
  const f3 = i2 == null ? void 0 : i2.allowBufferReuse;
  return { position: u2 !== t.position || f3 ? u2 : u2.slice(), normal: a2 !== t.normal || f3 ? a2 : a2 == null ? void 0 : a2.slice(), tangent: s !== t.tangent || f3 ? s : s == null ? void 0 : s.slice() };
}
function B3({ spatialReference: t, vertexAttributes: n3, transform: r }, { origin: e5 }, o2, i2) {
  const l = a(t);
  ...
  return { position: c3, normal: u2, tangent: f3 };
}
function L({ vertexAttributes: t, spatialReference: n3, transform: r }, { origin: e5 }, i2, a2) {
  const s = a(n3);
  if (!u(n3, i2, Y2, s)) return S(G2(), n3, s), null;
  const u2 = 1 / J(n3, a2, nt.TARGET);
  f(Y2, Y2, [u2, u2, u2]);
  const f3 = h(Z, Y2), { position: m2, normal: p, tangent: g } = V2(t, e5, r), x2 = new Float64Array(m2.length), v2 = K(m2, n3, f3, x2);
  if (!v2) return null;
  const R = j3($, f3), j4 = Q(p, m2, x2, n3, R, p !== t.normal ? p : void 0);
  if (!j4 && p) return null;
  const w2 = W(g, m2, x2, n3, R, g !== t.tangent ? g : void 0);
  return !w2 && g ? null : { position: v2, normal: j4, tangent: w2 };
}
function V2(t, n3, r) {
  if (!n3) return t;
  if (!r) {
    const { position: r2, normal: e6, tangent: o2 } = t;
    return { position: i(new Float64Array(r2.length), r2, n3), tangent: o2, normal: e6 };
  }
  const e5 = q2(t, r.localMatrix);
  return i(e5.position, e5.position, n3), e5;
}
function P({ vertexAttributes: t, spatialReference: n3, transform: r }, { origin: e5 }, o2, i2) {
  const a2 = a(n3);
...
function q2(t, n3) {
  ...
  return e5 && t.normal && V(t.normal, e5, n3), o2 && t.tangent && B2(t.tangent, o2, n3), { position: r, normal: e5, tangent: o2 };
}
...
function J(t, n3, r) {
  const e5 = !!(r & nt.SOURCE), o2 = !!(r & nt.TARGET), i2 = n3 == null ? void 0 : n3.sourceUnit, l = n3 == null ? void 0 : n3.targetUnit;
  if (!i2 && !l) return 1;
  let a2 = X(i2, t);
...
//# sourceMappingURL=chunk-OUWBUGHV.js.map
