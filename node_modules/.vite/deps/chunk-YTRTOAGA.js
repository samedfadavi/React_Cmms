...
var t2 = class _t extends n4 {
  constructor(e2, r5) {
    super(s4(r5) + e2.message, { cause: e2 }), this.loc = null, Error.captureStackTrace && Error.captureStackTrace(this, _t), (r5 == null ? void 0 : r5.loc) && (this.loc = r5.loc);
  }
};
var a2 = class _a extends Error {
  constructor(r5, n6, t3, c4) {
    super("Execution error - " + s4(t3) + r(o[n6], c4)), this.loc = null, this.declaredRootClass = "esri.arcade.arcadeexecutionerror", Error.captureStackTrace && Error.captureStackTrace(this, _a), (t3 == null ? void 0 : t3.loc) && (this.loc = t3.loc);
  }
};
function s4(e2) {
  var _a, _b;
...
function u2(e2, r5, o2) {
  return "esri.arcade.arcadeexecutionerror" === o2.declaredRootClass || "esri.arcade.arcadecompilationerror" === o2.declaredRootClass ? null === o2.loc && (r5 == null ? void 0 : r5.loc) ? new t2(o2, { cause: o2 }) : o2 : ("esri.arcade.featureset.support.featureseterror" === o2.declaredRootClass || "esri.arcade.featureset.support.sqlerror" === o2.declaredRootClass || o2.declaredRootClass, (r5 == null ? void 0 : r5.loc) ? new t2(o2, { cause: o2 }) : o2);
}
var l;
!function(e2) {
...
function J(e2, r5) {
  ...
  return function e3(r6) {
    if ((r6 == null ? void 0 : r6.toJSON) && "function" == typeof r6.toJSON && (r6 = r6.toJSON()), void 0 === r6) return;
    ...
    const s7 = o2.push(r6) - 1, y4 = Object.keys(r6).sort(i3 == null ? void 0 : i3(r6));
...
function oe(e2, t3) {
  return isNaN(e2) || null == t3 || "" === t3 ? e2.toString() : (t3 = v2(t3, "‰", ""), t3 = v2(t3, "¤", ""), s2(e2, { pattern: t3 }));
}
function ue(e2, t3) {
...
function fe(e2, t3, r5) {
  ...
  if (e2 === O2) {
    ...
    if (X(t3)) return e2.timeZone !== t3.timeZone && (e2.isUnknownTimeZone ? e2 = m2.arcadeDateAndZoneToArcadeDate(e2, t3.timeZone) : t3.isUnknownTimeZone && (t3 = m2.arcadeDateAndZoneToArcadeDate(t3, e2.timeZone))), le(e2.toNumber(), t3.toNumber(), r5);
...
function ye(e2, t3 = false) {
  ...
  if (e2 instanceof n) return pe(e2, null, t3);
...
function he(e2, t3) {
  ...
  if (G2(e2)) {
    const r5 = be(e2, t3);
    if (r5) return m2.dateTimeToArcadeDate(r5);
  }
  return null;
}
function be(e2, t3) {
...
function Ce(e2, t3, n6 = null, r5 = null) {
  ...
  if (null === s7) throw new a2(null, r3.FieldNotFound, null, { key: e2 });
  ...
  return null != r5 && c4.some((e3) => {
    var _a;
    return e3[f3] === r5 && (a3 = (_a = e3.domains) == null ? void 0 : _a[s7.name], a3 && "inherited" === a3.type && (a3 = De(s7.name, t3), u4 = true), true);
  }), u4 || a3 || (a3 = De(e2, t3)), { field: s7, domain: a3 };
}
function De(e2, t3) {
  let n6;
...
function je(e2, t3) {
  ...
  const n6 = "boolean" == typeof t3.cycles && t3.cycles, r5 = t3.cmp && (a3 = t3.cmp, function(e3) {
    return function(t4, n7) {
      const r6 = { key: t4, value: e3[t4] }, i4 = { key: n7, value: e3[n7] };
      return a3(r6, i4);
    };
  });
  var a3;
  ...
  return function e3(t4) {
    ...
    const u4 = i3.push(t4) - 1, s7 = Object.keys(t4).sort(r5 == null ? void 0 : r5(t4));
...
function xe(e2, t3) {
  if (U(e2) || Q(e2)) {
    ...
    return a(a3) || (a3 = a3.slice(0).reverse()), new j({ rings: [a3], spatialReference: u4, hasZ: n6, hasM: r5 });
  }
  return e2;
}
function Me(e2, t3) {
  if (U(e2) || Q(e2)) {
    ...
    return 0 === a3.length ? null : new m({ paths: [a3], spatialReference: i3, hasZ: n6, hasM: r5 });
  }
  return e2;
}
function Oe(e2, t3) {
  if (U(e2) || Q(e2)) {
    ...
    return 0 === a3.length ? null : new u({ points: a3, spatialReference: i3, hasZ: n6, hasM: r5 });
  }
  return e2;
}
...
async function Ye(e2, t3, n6, r5, a3) {
  const i3 = await Pe(e2, t3, n6);
  a3[r5] = i3;
}
async function Pe(e2, t3 = null, n6 = null) {
  if (e2 instanceof t && (e2 = e2.toArray()), null == e2) return null;
  if (Y(e2) || e2 instanceof n || re(e2) || X(e2)) return Ie(e2, n6);
  if (Array.isArray(e2)) {
    const r5 = [], a3 = [];
    for (const i3 of e2) null === i3 || Y(i3) || i3 instanceof n || re(i3) || X(i3) ? a3.push(Ie(i3, n6)) : (a3.push(null), r5.push(Ye(i3, t3, n6, a3.length - 1, a3)));
    return r5.length > 0 && await Promise.all(r5), a3;
  }
...
function Ke(r5, a3) {
  return "system" === r5 && (r5 = m2.systemTimeZoneCanonicalName), { version: We, engineVersion: r2, timeZone: r5, spatialReference: a3 instanceof f ? a3.toJSON() : a3, application: s.applicationName ?? "", engine: "web", locale: c() };
}
var We = "1.24";
var $e = Object.freeze(Object.defineProperty({ __proto__: null, ImplicitResultE: w3, ReturnResultE: F2, absRound: ie, arcadeVersion: We, autoCastArrayOfPointsToMultiPoint: Oe, autoCastArrayOfPointsToPolygon: xe, autoCastArrayOfPointsToPolyline: Me, autoCastFeatureToGeometry: Fe, binaryOperator: _e, breakResult: R, castAsJson: Ie, castAsJsonAsync: Pe, continueResult: J2, defaultExecutingContext: Ke, defaultTimeZone: He, defaultUndefined: P, equalityTest: ce, featureDomainCodeLookup: Ue, featureDomainValueLookup: qe, featureFullDomain: Ee, featureSchema: Be, featureSubtypes: Ve, fixNullGeometry: Ae, fixSpatialReference: Ze, formatDate: ue, formatNumber: oe, getDomain: Ce, getDomainCode: ke, getDomainValue: Te, getType: L, greaterThanLessThan: fe, implicitResult: x, isArray: U, isBoolean: z, isDate: X, isDateOnly: ee, isDictionary: K, isFeature: H, isFeatureSet: B2, isFeatureSetCollection: W, isFunctionParameter: _2, isGeometry: q, isImmutableArray: Q, isInteger: V, isJsDate: re, isKnowledgeGraph: $, isModule: I, isNumber: E2, isObject: ne, isSimpleType: Y, isString: G2, isSubtypeGrouplayer: ze, isSubtypeSublayer: Ge, isTime: te, multiReplace: v2, parseGeometryFromJson: Se, pcCheck: ae, returnResult: M2, stableStringify: je, standardiseDateFormat: se, tick: ve, toBoolean: Ne, toDate: he, toNumber: ge, toNumberArray: de, toString: me, toStringArray: Re, toStringExplicit: pe, voidOperation: O2 }, Symbol.toStringTag, { value: "Module" }));
...
//# sourceMappingURL=chunk-YTRTOAGA.js.map
