...
function t4(t5) {
  const o3 = t5.map(({ name: e4, count: t6, type: o4 }) => `${e4}.${t6}.${o4}`).join(",");
  return l(o3);
}
function o(e4, t5, r3, i3, n5, a2, c3) {
  if (e4.primitiveName === t5) {
    for (const o3 in e4) if (o3 === r3) {
      let t6 = i3 == null ? void 0 : i3.readWithDefault(n5, a2, e4[o3] && c3);
...
function f(e4) {
  ...
  for (const r3 in e4) {
    ...
    }), (_a = t5[r3]) == null ? void 0 : _a.forEach((e5) => e5.stride = o3);
  }
  return t5;
}
var g = (e4) => {
...
var h = (e4) => {
  ...
  for (const r3 in e4) {
    const n5 = e4[r3];
    t5[r3] = (n5 == null ? void 0 : n5.length) ? n5[0].stride : 0;
  }
  return t5;
};
...
var b2 = (e4, t5) => {
  if (!w.has(e4)) {
    const r3 = f(t5), n5 = { strides: h(r3), bufferLayouts: r3, attributes: g(t5) };
    w.set(e4, n5);
  }
  return w.get(e4);
};
...
function M(e4) {
  return "url" in e4 && "urlHash" in e4 ? { ...e4, url: "" } : e4;
}
...
var r2 = class _r {
  ...
  static deserialize(i3) {
    ...
    return new _r(s6, n5, o3, a2, h2, d2, c3, { size: F, offsetX: f2, offsetY: l2 }, u2);
  }
};
...
//# sourceMappingURL=chunk-QBIZASGH.js.map
