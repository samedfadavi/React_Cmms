...
var g = y4 = class extends f {
  ...
  readFeatures(e2, t) {
    ...
    for (let n3 = 0; n3 < e2.length; n3++) {
      const t2 = e2[n3], i = d.fromJSON(t2), l = (_a = t2.geometry) == null ? void 0 : _a.spatialReference;
  ...
  writeGeometryType(e2, t, r2, o2) {
    ...
    if (s) {
      for (const n3 of s) if (null != (n3 == null ? void 0 : n3.geometry)) return void h.write(n3.geometry.type, t, r2, o2);
    }
  }
  ...
  quantize(e2) {
    ...
    for (let p = 0, m = l.length; p < m; p++) (a3 == null ? void 0 : a3(l[p].geometry)) || (l.splice(p, 1), p--, m--);
  ...
  unquantize() {
    ...
    for (const { geometry: f4 } of t) null != f4 && c && c(f4);
...
e([y({ type: String, json: { write: true } })], g.prototype, "displayFieldName", void 0), e([y({ type: Boolean, json: { write: { overridePolicy: (e2) => ({ enabled: e2 }) } } })], g.prototype, "exceededTransferLimit", void 0), e([y({ type: [d], json: { write: true } })], g.prototype, "features", void 0), e([o("features")], g.prototype, "readFeatures", null), e([y({ type: [y3], json: { write: true } })], g.prototype, "fields", void 0), e([y({ type: ["point", "multipoint", "polyline", "polygon", "extent", "mesh"], json: { read: { reader: h.read } } })], g.prototype, "geometryType", void 0), e([r("geometryType")], g.prototype, "writeGeometryType", null), e([y({ type: Boolean, json: { write: { overridePolicy: (e2) => ({ enabled: e2 }) } } })], g.prototype, "hasM", void 0), e([y({ type: Boolean, json: { write: { overridePolicy: (e2) => ({ enabled: e2 }) } } })], g.prototype, "hasZ", void 0), e([y({ types: n2, json: { write: true } })], g.prototype, "queryGeometry", void 0), e([o("queryGeometry")], g.prototype, "readQueryGeometry", null), e([y({ type: f2, json: { write: true } })], g.prototype, "spatialReference", void 0), e([r("spatialReference")], g.prototype, "writeSpatialReference", null), e([y({ json: { write: true } })], g.prototype, "transform", void 0), g = y4 = e([a2("esri.rest.support.FeatureSet")], g), g.prototype.toJSON.isDefaultToJSON = true;
var d2 = g;

export {
  d2 as d
};
//# sourceMappingURL=chunk-647CGSDX.js.map
