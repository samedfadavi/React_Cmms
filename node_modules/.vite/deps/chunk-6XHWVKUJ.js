...
function g(e, r2, c2, i2, u2, a2, f = null) {
  ...
  for (let d2 = 0; d2 < g2.length; d2++) {
    ...
    const c3 = new _({ x: i2, y: i2, spatialReference: e2.spatialReference });
    if (null == u2 && !(u2 = C(c3, y, e2, f))) return;
    const { pyramidLevel: s3, pyramidResolution: m3, excessiveReading: x3 } = re(u2, h2, a2 || "closest");
    if (x3) return;
...
//# sourceMappingURL=chunk-6XHWVKUJ.js.map
