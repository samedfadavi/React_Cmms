...
function h(e2, a, i2) {
  ...
  const t = n4.axis || "heading", r = "heading" === t && "arithmetic" === n4.rotationType ? 90 : 0, s = "heading" === t && "arithmetic" === n4.rotationType ? -1 : 1, l2 = "number" == typeof a ? null : a, o = l2 == null ? void 0 : l2.attributes, c2 = n4.field, { hasExpression: p2 } = n4.cache;
  let d3 = n4.cache.compiledFunc, v2 = 0;
  if (!c2 && !p2) return v2;
  if (p2) {
    if (null == (i2 == null ? void 0 : i2.arcade)) return void f();
    const e3 = { viewingMode: i2.viewingMode, scale: i2.scale, spatialReference: i2.spatialReference }, a2 = i2.arcade.arcadeUtils, t2 = a2.getViewInfo(e3), r2 = a2.createExecContext(l2, t2, i2.timeZone);
    if (!d3) {
      const e4 = a2.createSyntaxTree(n4.valueExpression);
      d3 = a2.createFunction(e4), n4.cache.compiledFunc = d3;
    }
...
function C(e2, a, i2, n4, t) {
  ...
  if (r === s) return g((_a = a.stops) == null ? void 0 : _a[r].size, i2, n4);
  {
    ...
    return e3 + (g((_c = a.stops) == null ? void 0 : _c[s].size, i2, n4) - e3) * l2;
  }
}
function D(e2, a, i2, n4) {
  const r = ((n4 == null ? void 0 : n4.resolution) ?? 1) * m[a.valueUnit], s = g(a.minSize, i2, n4), l2 = g(a.maxSize, i2, n4), { valueRepresentation: o } = a;
  let c2 = null;
...
//# sourceMappingURL=chunk-ACWF4COQ.js.map
