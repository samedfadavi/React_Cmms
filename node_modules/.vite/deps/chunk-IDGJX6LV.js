...
var T = class {
  constructor(t, e2, i3) {
    ...
    const { buffer: s2, pixelType: r3, textureOnly: a } = t, n3 = d(r3);
  ...
  updateTexture(e2, i3) {
    try {
      ...
      has("esri-2d-update-debug") && console.debug(`Version[${i3}] AttributeStoreView.updateTexture`, { start: s2, end: r3, firstBytes: new Uint8Array(this.data.buffer.slice(0, 16)), block: this }), this._resetRange();
  ...
  update(t) {
    const { data: e2, start: i3, end: s2 } = t;
  ...
  _initTexture(t) {
    ...
    if (null != this._lastTexture && this._fbos[0]) {
      const i3 = this._lastTexture.descriptor.width, s2 = this._lastTexture.descriptor.height, r3 = this._lastTexture.descriptor.dataType, a = this._lastTexture.descriptor.pixelFormat, n3 = this.getFBO(t), u = c2(r3), h = new (d(r3))(new ArrayBuffer(i3 * s2 * u * this.texelSize)), o = t.getBoundFramebufferObject(), { x: d2, y: _, width: g, height: c3 } = t.getViewport();
...
var m = class {
  ...
  _initialize(t) {
    ...
    if (this.size = t.blockSize, has("esri-2d-update-debug") && console.debug("AttributeStoreView.initialize", { message: t }), null == this._data) this._data = e2.map((t2, e3) => null != t2 ? new T(t2, this.size, e3) : null);
  ...
  update() {
    ...
    for (const e2 of t) {
      const { blockData: t2, initArgs: i3, sendUpdateEpoch: s2, version: r3 } = e2;
      ...
      for (let e3 = 0; e3 < t2.length; e3++) {
        ...
        null != s3 && null != i4 && (has("esri-2d-update-debug") && console.debug(`Version[${this._version}] CpuBlock[${e3}] AttributeStoreView.update`, { block: i4 }), s3.update(i4));
      }
    }
  }
  getUniforms(t) {
    return { filterFlags: { texture: this._getTexture(t, L2.FilterFlags), unit: k }, animation: { texture: this._getTexture(t, L2.Animation), unit: q }, gpgpu: { texture: this._getTexture(t, L2.GPGPU), unit: E }, visualVariableData: { texture: this._getTexture(t, L2.VV), unit: y }, dataDriven0: { texture: this._getTexture(t, L2.DD0), unit: z }, dataDriven1: { texture: this._getTexture(t, L2.DD1), unit: B }, dataDriven2: { texture: this._getTexture(t, L2.DD2), unit: C }, size: this.size };
  }
  _getTexture(t, e2) {
    var _a;
    const i3 = (_a = this._data) == null ? void 0 : _a[e2];
...
var i2 = class {
  ...
  createMeshInfo(i3) {
    return { id: n2(this._instanceId), techniqueType: this.techniqueRef.type, inputParams: i3, optionalAttributes: this._input.optionalAttributes };
  }
  getInput() {
    return this._input;
  }
...
//# sourceMappingURL=chunk-IDGJX6LV.js.map
