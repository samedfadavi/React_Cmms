...
import "./chunk-V2YNXA62.js";
import "./chunk-BCJB3EA6.js";
import "./chunk-G6M3KHFU.js";
import {
  D
} from "./chunk-X77CSNGT.js";
import {
  N
...
import "./chunk-QPPXYQ3P.js";
import "./chunk-Z4IMWZBX.js";
...
var C3 = null;
function J2(e5) {
  return 0 === r.indexOf("4.") ? j.fromExtent(e5) : new j({ spatialReference: e5.spatialReference, rings: [[[e5.xmin, e5.ymin], [e5.xmin, e5.ymax], [e5.xmax, e5.ymax], [e5.xmax, e5.ymin], [e5.xmin, e5.ymin]]] });
}
function U3(n7) {
  C3 = n7;
}
function W3(n7, e5) {
  ...
  const i3 = new m({ hasZ: false, hasM: false, spatialReference: n7.spatialReference, paths: [[0, 0], [0, r7]] });
  return C3.planarLength(i3, e5);
}
function H2(n7, b2) {
  function L5(n8, e5, i3) {
    if (ae(i3, 2, 2, n8, e5), i3[0] instanceof n2 && i3[1] instanceof n2) ;
  ...
  n7.disjoint = function(n8, e5) {
    ...
    return b2(n8, e5, (t3, r7, i3) => (ae(i3, 2, 2, n8, e5), i3[0] === i3[1] || (i3[0] instanceof n2 && i3[1] instanceof n2 ? C3.equals(i3[0], i3[1]) : (X(i3[0]) && X(i3[1]) || te(i3[0]) && te(i3[1]) || !(!ee(i3[0]) || !ee(i3[1]))) && i3[0].equals(i3[1]))));
  }, n7.relate = function(n8, e5) {
    return b2(n8, e5, (i3, a5, l5) => {
      if (l5 = Fe(l5), ae(l5, 3, 3, n8, e5), l5[0] instanceof n2 && l5[1] instanceof n2) return C3.relate(l5[0], l5[1], me(l5[2]));
      if (l5[0] instanceof n2 && null === l5[1]) return false;
      if (l5[1] instanceof n2 && null === l5[0]) return false;
    ...
    return b2(n8, e5, (a5, l5, f4) => {
      ...
      if (1 === f4.length) if (U2(f4[0])) {
        const i3 = Fe(f4[0]);
        for (let a6 = 0; a6 < i3.length; a6++) if (null !== i3[a6]) {
          if (!(i3[a6] instanceof n2)) throw new a3(n8, r3.InvalidParameter, e5);
          u5.push(i3[a6]);
        }
      } else {
        if (!Q(f4[0])) {
          if (f4[0] instanceof n2) return Ze(c(f4[0]), n8.spatialReference);
        ...
        if (!(f4[i3] instanceof n2)) throw new a3(n8, r3.InvalidParameter, e5);
        u5.push(f4[i3]);
      }
    ...
    return b2(n8, e5, (i3, a5, l5) => {
      ...
      if (!(l5[0] instanceof n2)) throw new a3(n8, r3.InvalidParameter, e5);
    ...
    return b2(n8, e5, (a5, l5, u5) => {
      ...
      if (null === u5[0]) return [];
      if (!(u5[0] instanceof n2)) throw new a3(n8, r3.InvalidParameter, e5);
    ...
    return b2(n8, e5, (i3, a5, u5) => {
      ...
      let c6 = u5[1];
      if ((U2(u5[1]) || Q(u5[1])) && (c6 = Oe(u5[1], n8.spatialReference)), !(s6 instanceof n2)) throw new a3(n8, r3.InvalidParameter, e5);
      if (!(c6 instanceof n2)) throw new a3(n8, r3.InvalidParameter, e5);
    ...
    return b2(n8, e5, (i3, a5, u5) => {
      ...
      const m3 = new m({ paths: [], spatialReference: s6.spatialReference });
    ...
    return b2(n8, e5, (a5, u5, s6) => {
      ...
      if (!(s6[0] instanceof n2)) throw new a3(n8, r3.InvalidParameter, e5);
      const c6 = ge(s6[1]);
    ...
    return b2(n8, e5, (a5, l5, u5) => {
      ...
      if (!(s6 instanceof n2)) throw new a3(n8, r3.InvalidParameter, e5);
    ...
    return b2(n8, i3, (a5, l5, u5) => {
      ...
      if (!(s6 instanceof n2)) throw new a3(n8, r3.InvalidParameter, i3);
    ...
    return b2(n8, e5, (a5, l5, u5) => {
      ...
      if (s6 instanceof j) {
        ...
        for (let t3 = 0; t3 < s6.rings.length; t3++) if (s6.isClockwise(s6.rings[t3])) {
          const e7 = y({ rings: [s6.rings[t3]], hasZ: true === s6.hasZ, hasM: true === s6.hasM, spatialReference: s6.spatialReference.toJSON() });
          n9.push(e7);
        } else e6.push({ ring: s6.rings[t3], pt: s6.getPoint(t3, 0) });
      ...
      if (s6 instanceof m) {
        ...
        for (let e6 = 0; e6 < s6.paths.length; e6++) {
          const t3 = y({ paths: [s6.paths[e6]], hasZ: true === s6.hasZ, hasM: true === s6.hasM, spatialReference: s6.spatialReference.toJSON() });
          n9.push(t3);
        }
        return n9;
      }
    ...
    return b2(n8, i3, (a5, l5, u5) => {
      if (u5 = Fe(u5), ae(u5, 2, 2, n8, i3), !(u5[0] instanceof n2 || null === u5[0])) throw new a3(n8, r3.InvalidParameter, i3);
      ...
      return null === s6 || s6.isEmpty ? null : N.convertObjectToArcadeDictionary({ coordinate: s6.coordinate, distance: s6.distance, sideOfLine: 0 === s6.distance ? "straddle" : s6.isRightSide ? "right" : "left" }, He(n8), false, true);
    });
...
var W4 = class extends r4 {
  ...
  marshalledCall(e5, n7, t3, o3) {
    return o3(e5, n7, (n8, l5, r7) => {
      ...
      const a5 = this.call(t3, { arguments: r7 });
...
function Q2(e5, n7) {
  ...
  if ("" === s6) {
    if (void 0 !== e5.globalScope[a5]) s6 = "gscope['" + a5 + "']";
      ...
      const t4 = { manglename: Ae(e5), node: n7.left };
...
function ee2(e5, n7) {
  ...
  if (null !== e5.localScope) {
    ...
    const o4 = { manglename: Ae(e5), node: n7.argument };
...
function te2(e5, n7) {
  ...
  if (null !== e5.localScope) {
    ...
    const l6 = { manglename: Ae(e5), node: n7.argument };
...
function Se(e5, n7) {
  try {
    ...
    if (null !== e5.localScope) {
      ...
      const o3 = { manglename: Ae(e5), node: n7.argument };
  ...
  try {
    ...
    if (null !== e5.localScope && (void 0 !== e5.localScope[t3] ? o3 = "lscope['" + t3 + "']" : void 0 !== e5.localScope._SymbolsMap[t3] && (o3 = "lscope['" + e5.localScope._SymbolsMap[t3] + "']")), "" === o3) {
      if (void 0 !== e5.globalScope[t3]) o3 = "gscope['" + t3 + "']";
        ...
        const l5 = { manglename: Ae(e5), node: n7.argument };
...
function Ge(e5, n7, t3, o3) {
  ...
  a5.immutable = false, r7._SymbolsMap = { textformatting: 1, infinity: 1, pi: 1 }, r7.textformatting = a5, r7.infinity = Number.POSITIVE_INFINITY, r7.pi = Math.PI;
...
ke.prototype = Oe2;
function je(e5, n7) {
  const t3 = { mode: n7, compiled: true, functions: {}, signatures: [], standardFunction: z2, standardFunctionAsync: z2, evaluateIdentifier: Le };
...
var Re = 0;
var Ue = { isNumber: (e5) => E(e5), isArray: (e5) => U2(e5), isImmutableArray: (e5) => Q(e5), isFeature: (e5) => H(e5), isString: (e5) => G(e5), isDictionary: (e5) => K(e5), isGeometry: (e5) => q(e5), geometryMember: (e5, n7, o3, l5, r7 = 1) => d(e5, n7, o3, l5, r7), error(e5) {
  ...
  function s6(e6) {
    var _a;
    e6.done ? t4(e6.value) : ((_a = e6.value) == null ? void 0 : _a.then) ? e6.value.then(r7, a5) : (Re++, Re % 100 == 0 ? setTimeout(() => {
      Re = 0, r7(e6.value);
    }, 0) : r7(e6.value));
  }
...
}, setAssig: (e5, n7) => (n7.gdefs[e5] = 1, e5), castString: (e5) => me(e5), aCheck(e5, n7) {
  if (_2(e5)) {
  ...
  return e5 === O ? null : e5;
}, Dictionary: N, Feature: D, UserDefinedCompiledFunction: W4, dictionary(e5) {
...
}, graphicToFeature: (e5, n7, t3) => null === e5 ? null : D.createFromGraphicLikeObject(e5.geometry, e5.attributes, n7, t3.timeZone), memberupdate(e5, n7, t3, o3) {
  let s6;
  if (U2(e5)) {
    ...
    if (true !== e5.hasField(n7)) throw new a3(null, r3.FieldNotFound, null, { key: n7 });
  ...
  const o3 = n7.moduleFactory[t3]({ vars: {}, moduleSingletons: n7.moduleSingletons, depthCounter: n7.depthCounter, console: n7.console, abortSignal: n7.abortSignal, isAsync: n7.isAsync, services: n7.services, lrucache: n7.lrucache, timeZone: n7.timeZone ?? null, interceptor: n7.interceptor }, n7.spatialReference);
  ...
  return l5.call(o3, { preparsed: true, arguments: n7 });
...
function Pe(e5, t3, o3 = false) {
  ...
  const i3 = { isAsync: o3, globalScope: Ee(t3.vars, o3 ? Oe2 : Ie, t3.customfunctions), moduleFactory: {}, moduleFactoryMap: {}, undeclaredGlobalsInFunctions: /* @__PURE__ */ new Map(), customfunctions: t3.customfunctions, libraryResolver: l5, localScope: null, mangleMap: {}, depthCounter: { depth: 1 }, exports: {}, console: De, lrucache: t3.lrucache, timeZone: t3.timeZone ?? null, interceptor: t3.interceptor, services: t3.services, symbols: { symbolCounter: 0 } };
  let c6 = J3(i3, e5);
  ...
  const x6 = { lc: $e, lang: Ue, mangles: i3.mangleMap, postProcess(e6) {
    ...
    return { localStack: [], isAsync: n7, moduleFactory: p6, moduleFactoryMap: m3, mangleMap: this.mangles, moduleSingletons: {}, exports: g3, gdefs: {}, exportmangle: f4, spatialReference: t4, globalScope: o4, abortSignal: void 0 === e6.abortSignal || null === e6.abortSignal ? { aborted: false } : e6.abortSignal, localScope: null, services: e6.services, console: e6.console ?? De, lrucache: e6.lrucache, timeZone: e6.timeZone ?? null, interceptor: e6.interceptor, symbols: { symbolCounter: 0 }, depthCounter: { depth: 1 } };
  } };
  return new Function("context", "spatialReference", u5).bind(x6);
}
async function Ze2() {
  return je([await import("./geomasync-HKFU7HDV.js")], "async"), true;
}
...
function Te(e5, t3, o3 = false) {
  const l5 = { isAsync: o3, moduleFactory: t3.moduleFactory, moduleFactoryMap: {}, libraryResolver: new s2(null, e5.loadedModules), globalScope: Ee(t3.vars, o3 ? Oe2 : Ie, t3.customfunctions), customfunctions: t3.customfunctions, localScope: null, mangleMap: {}, undeclaredGlobalsInFunctions: /* @__PURE__ */ new Map(), depthCounter: { depth: 1 }, exports: {}, console: De, lrucache: t3.lrucache, timeZone: t3.timeZone ?? null, interceptor: t3.interceptor, services: t3.services, symbols: { symbolCounter: 0 } };
  let r7 = J3(l5, e5);
  ...
  const p6 = { lc: $e, lang: Ue, mangles: l5.mangleMap, prepareModule: (e6) => new Ke(e6), prepare(e6, n7) {
    let t4 = e6.spatialReference;
    null == t4 && (t4 = new f({ wkid: 102100 }));
    const o4 = Ge(e6.vars, e6.customfunctions, n7, e6.timeZone);
    return { localStack: [], isAsync: n7, exports: c6, exportmangle: u5, gdefs: {}, moduleFactory: s6, moduleFactoryMap: i3, moduleSingletons: e6.moduleSingletons, mangleMap: this.mangles, spatialReference: t4, globalScope: o4, abortSignal: void 0 === e6.abortSignal || null === e6.abortSignal ? { aborted: false } : e6.abortSignal, localScope: null, services: e6.services, console: e6.console ?? De, lrucache: e6.lrucache, timeZone: e6.timeZone ?? null, interceptor: e6.interceptor, symbols: { symbolCounter: 0 }, depthCounter: e6.depthCounter };
  } };
  return new Function("context", "spatialReference", a5).bind(p6);
}

// ../node_modules/@arcgis/core/chunks/index.js
var e2 = { False: "false", Null: "null", True: "true" };
...
var o2 = { Unknown: 0, BooleanLiteral: 1, EOF: 2, Identifier: 3, Keyword: 4, NullLiteral: 5, NumericLiteral: 6, Punctuator: 7, StringLiteral: 8, Template: 10 };
var h = ["Unknown", "Boolean", "<end>", "Identifier", "Keyword", "Null", "Numeric", "Punctuator", "String", "RegularExpression", "Template"];
var c5 = { InvalidModuleUri: "InvalidModuleUri", ForInOfLoopInitializer: "ForInOfLoopInitializer", IdentiferExpected: "IdentiferExpected", InvalidEscapedReservedWord: "InvalidEscapedReservedWord", InvalidExpression: "InvalidExpression", InvalidFunctionIdentifier: "InvalidFunctionIdentifier", InvalidHexEscapeSequence: "InvalidHexEscapeSequence", InvalidLeftHandSideInAssignment: "InvalidLeftHandSideInAssignment", InvalidLeftHandSideInForIn: "InvalidLeftHandSideInForIn", InvalidTemplateHead: "InvalidTemplateHead", InvalidVariableAssignment: "InvalidVariableAssignment", KeyMustBeString: "KeyMustBeString", NoFunctionInsideBlock: "NoFunctionInsideBlock", NoFunctionInsideFunction: "NoFunctionInsideFunction", ModuleExportRootOnly: "ModuleExportRootOnly", ModuleImportRootOnly: "ModuleImportRootOnly", PunctuatorExpected: "PunctuatorExpected", TemplateOctalLiteral: "TemplateOctalLiteral", UnexpectedBoolean: "UnexpectedBoolean", UnexpectedEndOfScript: "UnexpectedEndOfScript", UnexpectedIdentifier: "UnexpectedIdentifier", UnexpectedKeyword: "UnexpectedKeyword", UnexpectedNull: "UnexpectedNull", UnexpectedNumber: "UnexpectedNumber", UnexpectedPunctuator: "UnexpectedPunctuator", UnexpectedString: "UnexpectedString", UnexpectedTemplate: "UnexpectedTemplate", UnexpectedToken: "UnexpectedToken" };
var l3 = { [c5.InvalidModuleUri]: "Module uri must be a text literal.", [c5.ForInOfLoopInitializer]: "for-in loop variable declaration may not have an initializer.", [c5.IdentiferExpected]: "'${value}' is an invalid identifier.", [c5.InvalidEscapedReservedWord]: "Keyword cannot contain escaped characters.", [c5.InvalidExpression]: "Invalid expression.", [c5.InvalidFunctionIdentifier]: "'${value}' is an invalid function identifier.", [c5.InvalidHexEscapeSequence]: "Invalid hexadecimal escape sequence.", [c5.InvalidLeftHandSideInAssignment]: "Invalid left-hand side in assignment.", [c5.InvalidLeftHandSideInForIn]: "Invalid left-hand side in for-in.", [c5.InvalidTemplateHead]: "Invalid template structure.", [c5.InvalidVariableAssignment]: "Invalid variable assignment.", [c5.KeyMustBeString]: "Object property keys must be a word starting with a letter.", [c5.NoFunctionInsideBlock]: "Functions cannot be declared inside of code blocks.", [c5.NoFunctionInsideFunction]: "Functions cannot be declared inside another function.", [c5.ModuleExportRootOnly]: "Module exports cannot be declared inside of code blocks.", [c5.ModuleImportRootOnly]: "Module import cannot be declared inside of code blocks.", [c5.PunctuatorExpected]: "'${value}' expected.", [c5.TemplateOctalLiteral]: "Octal literals are not allowed in template literals.", [c5.UnexpectedBoolean]: "Unexpected boolean literal.", [c5.UnexpectedEndOfScript]: "Unexpected end of Arcade expression.", [c5.UnexpectedIdentifier]: "Unexpected identifier.", [c5.UnexpectedKeyword]: "Unexpected keyword.", [c5.UnexpectedNull]: "Unexpected null literal.", [c5.UnexpectedNumber]: "Unexpected number.", [c5.UnexpectedPunctuator]: "Unexpected ponctuator.", [c5.UnexpectedString]: "Unexpected text literal.", [c5.UnexpectedTemplate]: "Unexpected quasi '${value}'.", [c5.UnexpectedToken]: "Unexpected token '${value}'." };
var d3 = class e3 extends Error {
  constructor({ code: t3, index: u5, line: i3, column: r7, len: n7 = 0, description: s6, data: a5 }) {
    var _a;
    super(s6 ?? t3), this.declaredRootClass = "esri.arcade.lib.diagnostic", this.name = "ParsingError", this.code = t3, this.index = u5, this.line = i3, this.column = r7, this.len = n7, this.data = a5, this.description = s6, this.range = { start: { line: i3, column: r7 - 1 }, end: { line: i3, column: r7 + n7 } }, (_a = Error.captureStackTrace) == null ? void 0 : _a.call(Error, this, e3);
  }
};
function C4(e5) {
...
var T = { fromCodePoint: (e5) => e5 < 65536 ? String.fromCharCode(e5) : String.fromCharCode(55296 + (e5 - 65536 >> 10)) + String.fromCharCode(56320 + (e5 - 65536 & 1023)), isWhiteSpace: (e5) => 32 === e5 || 9 === e5 || 11 === e5 || 12 === e5 || 160 === e5 || e5 >= 5760 && [5760, 8192, 8193, 8194, 8195, 8196, 8197, 8198, 8199, 8200, 8201, 8202, 8239, 8287, 12288, 65279].includes(e5), isLineTerminator: (e5) => 10 === e5 || 13 === e5 || 8232 === e5 || 8233 === e5, isIdentifierStart: (e5) => 36 === e5 || 95 === e5 || e5 >= 65 && e5 <= 90 || e5 >= 97 && e5 <= 122 || 92 === e5 || e5 >= 128 && I.NonAsciiIdentifierStart.test(T.fromCodePoint(e5)), isIdentifierPart: (e5) => 36 === e5 || 95 === e5 || e5 >= 65 && e5 <= 90 || e5 >= 97 && e5 <= 122 || e5 >= 48 && e5 <= 57 || 92 === e5 || e5 >= 128 && I.NonAsciiIdentifierPart.test(T.fromCodePoint(e5)), isDecimalDigit: (e5) => e5 >= 48 && e5 <= 57, isHexDigit: (e5) => e5 >= 48 && e5 <= 57 || e5 >= 65 && e5 <= 70 || e5 >= 97 && e5 <= 102, isOctalDigit: (e5) => e5 >= 48 && e5 <= 55 };
function b(e5) {
...
i2.forEach((e5) => {
  var _a;
  return (_a = v[e5.length - 1]) == null ? void 0 : _a.push(e5);
}), r6.forEach((e5) => {
  var _a;
  return (_a = v[e5.length - 1]) == null ? void 0 : _a.push(e5);
}), s4.forEach((e5) => {
...
var N2 = class {
  ...
  skipSingleLineComment(e5) {
    let t3 = [], u5 = this.index - e5, i3 = { start: { line: this.lineNumber, column: this.index - this.lineStart - e5 }, end: { line: 0, column: 0 } };
    for (; !this.eof(); ) {
      ...
      if (this.index += 1, T.isLineTerminator(r8)) {
        ...
        let n7 = { multiLine: false, start: u5 + e5, end: this.index - 1, range: [u5, this.index - 1], loc: i3 };
    ...
    let r7 = { multiLine: false, start: u5 + e5, end: this.index, range: [u5, this.index], loc: i3 };
    return t3.push(r7), t3;
  }
  skipMultiLineComment() {
    let e5 = [], t3 = this.index - 2, u5 = { start: { line: this.lineNumber, column: this.index - this.lineStart - 2 }, end: { line: 0, column: 0 } };
    for (; !this.eof(); ) {
  ...
  octalToDecimal(e5) {
    ...
    return !this.eof() && T.isOctalDigit(this.source.charCodeAt(this.index)) && (t3 = true, u5 = 8 * u5 + L2(this.source[this.index] ?? ""), this.index += 1, "0123".includes(e5) && !this.eof() && T.isOctalDigit(this.source.charCodeAt(this.index)) && (u5 = 8 * u5 + L2(this.source[this.index] ?? ""), this.index += 1)), { code: u5, octal: t3 };
  }
  scanIdentifier() {
  ...
  scanPunctuator() {
    ...
    switch (t3) {
      ...
      case "}":
        ...
        break;
      default:
        for (let e6 = v.length; e6 > 0; e6--) if (t3 = this.source.substring(this.index, this.index + e6), (_a = v[e6 - 1]) == null ? void 0 : _a.includes(t3)) {
          this.index += e6;
          break;
        }
    }
    return this.index === e5 && this.throwUnexpectedToken(), { type: o2.Punctuator, value: t3, lineNumber: this.lineNumber, lineStart: this.lineStart, start: e5, end: this.index };
  }
  scanHexLiteral(e5) {
    let t3 = "";
    for (; !this.eof() && T.isHexDigit(this.source.charCodeAt(this.index)); ) t3 += this.source[this.index], this.index += 1;
    return 0 === t3.length && this.throwUnexpectedToken(), T.isIdentifierStart(this.source.charCodeAt(this.index)) && this.throwUnexpectedToken(), { type: o2.NumericLiteral, value: Number.parseInt(`0x${t3}`, 16), lineNumber: this.lineNumber, lineStart: this.lineStart, start: e5, end: this.index };
  }
  scanBinaryLiteral(e5) {
    ...
    return { type: o2.NumericLiteral, value: Number.parseInt(t3, 2), lineNumber: this.lineNumber, lineStart: this.lineStart, start: e5, end: this.index };
  }
  ...
  scanNumericLiteral() {
    ...
    return T.isIdentifierStart(this.source.charCodeAt(this.index)) && this.throwUnexpectedToken(), { type: o2.NumericLiteral, value: Number.parseFloat(u5), lineNumber: this.lineNumber, lineStart: this.lineStart, start: e5, end: this.index };
  }
  scanStringLiteral() {
    let e5 = this.index, t3 = this.source[e5];
    ...
    for (; !this.eof(); ) {
      ...
      if ("\\" === e6) if (e6 = this.source[this.index] ?? "", this.index += 1, e6 && T.isLineTerminator(e6.charCodeAt(0))) this.lineNumber += 1, "\r" === e6 && "\n" === this.source[this.index] && (this.index += 1), this.lineStart = this.index;
      else switch (e6) {
        case "u":
    ...
    return "" !== t3 && (this.index = e5, this.throwUnexpectedToken()), { type: o2.StringLiteral, value: i3, lineNumber: this.lineNumber, lineStart: this.lineStart, start: e5, end: this.index };
  }
  scanTemplate() {
    ...
    return t3 || this.throwUnexpectedToken(), i3 || this.curlyStack.pop(), { type: o2.Template, value: this.source.slice(u5 + 1, this.index - n7), cooked: e5, head: i3, tail: r7, lineNumber: this.lineNumber, lineStart: this.lineStart, start: u5, end: this.index };
  }
  lex() {
    if (this.eof()) return { type: o2.EOF, value: "", lineNumber: this.lineNumber, lineStart: this.lineStart, start: this.index, end: this.index };
...
function M3(e5, t3 = 0) {
  ...
  return u5 < 0 && (u5 += t3, i3 -= 1), { index: e5.start, line: i3, column: u5 };
}
function O2(e5) {
...
var z3 = class {
  constructor(e5, t3 = {}, u5) {
    this.delegate = u5, this.hasLineTerminator = false, this.options = { tokens: "boolean" == typeof t3.tokens && t3.tokens, comments: "boolean" == typeof t3.comments && t3.comments, tolerant: "boolean" == typeof t3.tolerant && t3.tolerant }, this.options.comments && (this.commentHandler = new k()), this.errorHandler = new S2(this.options.tolerant), this.scanner = new N2(e5, this.errorHandler), this.context = { isAssignmentTarget: false, blockContext: U4.None, curlyParsingType: P2.AsObject }, this.rawToken = { type: o2.EOF, value: "", lineNumber: this.scanner.lineNumber, lineStart: 0, start: 0, end: 0 }, this.tokens = [], this.startMarker = { index: 0, line: this.scanner.lineNumber, column: 0 }, this.endMarker = { index: 0, line: this.scanner.lineNumber, column: 0 }, this.readNextRawToken(), this.endMarker = { index: this.scanner.index, line: this.scanner.lineNumber, column: this.scanner.index - this.scanner.lineStart };
  }
  throwIfInvalidType(e5, t3, { validTypes: u5, invalidTypes: i3 }) {
    (u5 == null ? void 0 : u5.some((t4) => e5.type === t4)) || (i3 == null ? void 0 : i3.some((t4) => e5.type === t4)) && this.throwError(c5.InvalidExpression, t3);
  }
  throwError(e5, t3, u5 = this.endMarker) {
    let { index: i3, line: r7, column: n7 } = t3, s6 = u5.index - i3 - 1;
    this.errorHandler.throwError({ code: e5, index: i3, line: r7, column: n7 + 1, len: s6 });
  }
  tolerateError(e5, t3) {
    throw new Error("######################################### !!!");
  }
  unexpectedTokenError(e5 = {}) {
    let t3, { rawToken: u5 } = e5, { code: i3, data: r7 } = e5;
    if (u5) {
    ...
    i3 ?? (i3 = c5.UnexpectedToken), r7 || (r7 = { value: t3 });
    let n7 = w2(i3, r7);
    if (u5) {
      let e6 = u5.start, t4 = u5.lineNumber, s7 = u5.start - u5.lineStart + 1;
      return new d3({ code: i3, index: e6, line: t4, column: s7, len: u5.end - u5.start - 1, data: r7, description: n7 });
    }
    let { index: s6, line: a5 } = this.endMarker;
    return new d3({ code: i3, index: s6, line: a5, column: this.endMarker.column + 1, data: r7, description: n7 });
  }
  ...
  collectComments(e5) {
    ...
    !t3 || !e5.length || e5.forEach((e6) => {
      let i3 = { type: e6.multiLine ? u4.BlockComment : u4.LineComment, value: this.getSourceValue(e6), range: e6.range, loc: e6.loc };
  ...
  convertToToken(e5) {
    return { type: h[e5.type], value: this.getSourceValue(e5), range: [e5.start, e5.end], loc: { start: { line: this.startMarker.line, column: this.startMarker.column }, end: { line: this.scanner.lineNumber, column: this.scanner.index - this.scanner.lineStart } } };
  }
  readNextRawToken() {
  ...
  expectPunctuator(e5) {
    ...
    this.matchPunctuator(e5) ? this.readNextRawToken() : this.throwUnexpectedToken({ rawToken: t3, code: c5.PunctuatorExpected, data: { value: e5 } });
  }
  expectKeyword(e5) {
    this.rawToken.type !== o2.Keyword || this.rawToken.value.toLowerCase() !== e5.toString() ? this.throwUnexpectedToken({ rawToken: this.rawToken }) : this.readNextRawToken();
  }
  expectContextualKeyword(e5) {
    this.rawToken.type !== o2.Identifier || this.rawToken.value.toLowerCase() !== e5 ? this.throwUnexpectedToken({ rawToken: this.rawToken }) : this.readNextRawToken();
  }
  matchKeyword(e5) {
  ...
  parsePrimaryExpression() {
    ...
    switch (i3.type) {
      ...
      case o2.BooleanLiteral:
        return this.context.isAssignmentTarget = false, this.readNextRawToken(), this.finalize({ type: u4.Literal, value: i3.value.toLowerCase() === e2.True, raw: this.getSourceValue(i3), isString: false, ...this.getItemLocation(t3) });
      case o2.NullLiteral:
  ...
  parseArrayInitializer() {
    ...
    return this.expectPunctuator("]"), this.finalize({ type: u4.ArrayExpression, elements: t3, ...this.getItemLocation(e5) });
  }
  parseObjectPropertyKey() {
    let e5 = this.captureStartMarker(), t3 = this.rawToken;
    switch (t3.type) {
      case o2.StringLiteral:
        return this.readNextRawToken(), this.finalize({ type: u4.Literal, value: t3.value, raw: this.getSourceValue(t3), isString: true, ...this.getItemLocation(e5) });
      case o2.Identifier:
      case o2.BooleanLiteral:
      case o2.NullLiteral:
      case o2.Keyword:
        return this.readNextRawToken(), this.finalize({ type: u4.Identifier, name: t3.value, ...this.getItemLocation(e5) });
      default:
  ...
  parseObjectProperty() {
    ...
    return this.matchPunctuator(":") ? (this.readNextRawToken(), n7 = this.inheritCoverGrammar(this.parseAssignmentExpression.bind(this))) : e5.type === o2.Identifier ? (r7 = true, n7 = this.finalize({ type: u4.Identifier, name: e5.value, ...this.getItemLocation(t3) })) : this.throwUnexpectedToken({ rawToken: this.rawToken }), this.finalize({ type: u4.Property, kind: "init", key: i3, value: n7, shorthand: r7, ...this.getItemLocation(t3) });
  }
  parseObjectExpression() {
    ...
    return this.expectPunctuator("}"), this.finalize({ type: u4.ObjectExpression, properties: t3, ...this.getItemLocation(e5) });
  }
  parseTemplateElement(e5 = false) {
    let t3 = this.rawToken;
    t3.type !== o2.Template && this.throwUnexpectedToken({ rawToken: t3 }), e5 && !t3.head && this.throwUnexpectedToken({ code: c5.InvalidTemplateHead, rawToken: t3 });
    let i3 = this.captureStartMarker();
    this.readNextRawToken();
    let { value: r7, cooked: n7, tail: s6 } = t3, a5 = this.finalize({ type: u4.TemplateElement, value: { raw: r7, cooked: n7 }, tail: s6, ...this.getItemLocation(i3) });
  ...
  parseTemplateLiteral() {
    ...
    return this.finalize({ type: u4.TemplateLiteral, quasis: i3, expressions: t3, ...this.getItemLocation(e5) });
  }
  ...
  parseMemberName() {
    ...
    return this.readNextRawToken(), e5.type !== o2.NullLiteral && e5.type !== o2.Identifier && e5.type !== o2.Keyword && e5.type !== o2.BooleanLiteral && this.throwUnexpectedToken({ rawToken: e5 }), this.finalize({ type: u4.Identifier, name: e5.value, ...this.getItemLocation(t3) });
  }
  parseLeftHandSideExpression() {
    ...
    for (; e5 = this.getMatchingPunctuator("([."); ) switch (e5) {
      case "(": {
        ...
        i3 = this.finalize({ type: u4.CallExpression, callee: i3, arguments: e6, ...this.getItemLocation(t3) });
        continue;
      }
      case "[": {
        this.context.isAssignmentTarget = true, this.expectPunctuator("[");
        let e6 = this.isolateCoverGrammar(() => this.parseExpression());
        this.expectPunctuator("]"), i3 = this.finalize({ type: u4.MemberExpression, computed: true, object: i3, property: e6, ...this.getItemLocation(t3) });
        continue;
      }
      case ".": {
        this.context.isAssignmentTarget = true, this.expectPunctuator(".");
        let e6 = this.parseMemberName();
        i3 = this.finalize({ type: u4.MemberExpression, computed: false, object: i3, property: e6, ...this.getItemLocation(t3) });
        continue;
      }
    }
    return i3;
  ...
  parseUpdateExpression() {
    ...
    if (t3) {
      ...
      return r8.type !== u4.Identifier && r8.type !== u4.MemberExpression && r8.type !== u4.CallExpression && this.throwError(c5.InvalidExpression, i3), this.context.isAssignmentTarget || this.tolerateError(c5.InvalidLeftHandSideInAssignment, e5), this.context.isAssignmentTarget = false, this.finalize({ type: u4.UpdateExpression, operator: t3, argument: r8, prefix: true, ...this.getItemLocation(e5) });
    }
  ...
  parseUnaryExpression() {
    ...
    if (e5) {
      ...
      return this.context.isAssignmentTarget = false, this.finalize({ type: u4.UnaryExpression, operator: e5, argument: i3, prefix: true, ...this.getItemLocation(t3) });
    }
  ...
  parseBinaryExpression() {
    ...
    for (; h3 > 1; ) {
      let e6 = r7.pop();
      if (!e6) break;
      let u6 = c6 == null ? void 0 : c6.lineStart, i4 = M3(e6, u6), n8 = a5[h3 - 1];
  ...
  createBinaryOrLogicalExpression(e5, t3, i3, r7) {
    ...
    return n7 === u4.BinaryExpression || ((i3.type === u4.AssignmentExpression || i3.type === u4.UpdateExpression) && this.throwError(c5.InvalidExpression, ...O2(i3)), (r7.type === u4.AssignmentExpression || r7.type === u4.UpdateExpression) && this.throwError(c5.InvalidExpression, ...O2(i3))), { type: n7, operator: t3, left: i3, right: r7, ...this.getItemLocation(e5) };
  }
  parseAssignmentExpression() {
    ...
    return this.finalize({ type: u4.AssignmentExpression, left: t3, operator: r7, right: s6, ...this.getItemLocation(e5) });
  }
  parseExpression() {
  ...
  parseBlock() {
    ...
    return this.expectPunctuator("}"), this.finalize({ type: u4.BlockStatement, body: t3, ...this.getItemLocation(e5) });
  }
  parseObjectStatement() {
    let e5 = this.captureStartMarker(), t3 = this.parseObjectExpression();
    return this.finalize({ type: u4.ExpressionStatement, expression: t3, ...this.getItemLocation(e5) });
  }
  ...
  parseIdentifier() {
    ...
    let t3 = this.captureStartMarker();
    return this.readNextRawToken(), this.finalize({ type: u4.Identifier, name: e5.value, ...this.getItemLocation(t3) });
  }
  parseVariableDeclarator() {
    let e5 = this.captureStartMarker(), t3 = this.parseIdentifier();
    t3 || this.throwUnexpectedToken({ code: c5.IdentiferExpected });
    let i3 = null;
    if (this.matchPunctuator("=")) {
      ...
      try {
        ...
        this.throwUnexpectedToken({ rawToken: e6, code: c5.InvalidVariableAssignment });
      }
    }
    return this.finalize({ type: u4.VariableDeclarator, id: t3, init: i3, ...this.getItemLocation(e5) });
  }
  ...
  parseVariableDeclaration() {
    ...
    return this.consumeSemicolon(), this.finalize({ type: u4.VariableDeclaration, declarations: i3, kind: "var", ...this.getItemLocation(e5) });
  }
  parseEmptyStatement() {
    let e5 = this.captureStartMarker();
    return this.expectPunctuator(";"), this.finalize({ type: u4.EmptyStatement, ...this.getItemLocation(e5) });
  }
  parseExpressionStatement() {
    let e5 = this.captureStartMarker(), t3 = this.parseExpression();
    return this.consumeSemicolon(), this.finalize({ type: u4.ExpressionStatement, expression: t3, ...this.getItemLocation(e5) });
  }
  parseIfClause() {
  ...
  parseIfStatement() {
    ...
    return this.matchKeyword(t.Else) && (this.readNextRawToken(), a5 = this.parseIfClause()), this.finalize({ type: u4.IfStatement, test: r7, consequent: s6, alternate: a5, ...this.getItemLocation(e5) });
  }
  parseWhileStatement() {
    let e5 = this.captureStartMarker();
    ...
    return this.finalize({ type: u4.WhileStatement, test: r7, body: s6, ...this.getItemLocation(e5) });
  }
  parseForStatement() {
    ...
    if (this.expectKeyword(t.For), this.expectPunctuator("("), this.matchPunctuator(";")) this.readNextRawToken();
      ...
      1 === r8.length && this.matchKeyword(t.In) ? (r8[0].init && this.throwError(c5.ForInOfLoopInitializer, i4), n7 = this.finalize({ type: u4.VariableDeclaration, declarations: r8, kind: "var", ...this.getItemLocation(i4) }), this.readNextRawToken(), s6 = this.parseExpression()) : (this.matchKeyword(t.In) && this.throwError(c5.InvalidLeftHandSideInForIn, i4), e5 = this.finalize({ type: u4.VariableDeclaration, declarations: r8, kind: "var", ...this.getItemLocation(i4) }), this.expectPunctuator(";"));
    } else {
    ...
    return n7 && s6 ? this.finalize({ type: u4.ForInStatement, left: n7, right: s6, body: D5, ...this.getItemLocation(a5) }) : this.finalize({ type: u4.ForStatement, init: e5, test: i3, update: r7, body: D5, ...this.getItemLocation(a5) });
  }
  parseContinueStatement() {
    let e5 = this.captureStartMarker();
    return this.expectKeyword(t.Continue), this.consumeSemicolon(), this.finalize({ type: u4.ContinueStatement, ...this.getItemLocation(e5) });
  }
  parseBreakStatement() {
    let e5 = this.captureStartMarker();
    return this.expectKeyword(t.Break), this.consumeSemicolon(), this.finalize({ type: u4.BreakStatement, ...this.getItemLocation(e5) });
  }
  parseReturnStatement() {
    ...
    return this.consumeSemicolon(), this.finalize({ type: u4.ReturnStatement, argument: i3, ...this.getItemLocation(e5) });
  }
  parseStatement() {
  ...
  parseFormalParameters() {
    ...
    if (this.expectPunctuator("("), !this.matchPunctuator(")")) for (; this.rawToken.type !== o2.EOF; ) {
      ...
      if (t3 || this.throwUnexpectedToken({ rawToken: this.rawToken, code: c5.IdentiferExpected }), e5.push(t3), this.matchPunctuator(")") || (this.expectPunctuator(","), this.matchPunctuator(")"))) break;
    }
    return this.expectPunctuator(")"), e5;
  }
  parseFunctionDeclaration() {
    (this.context.blockContext & U4.Function) === U4.Function && this.throwUnexpectedToken({ code: c5.NoFunctionInsideFunction }), ((this.context.blockContext & U4.WhileLoop) === U4.WhileLoop || (this.context.blockContext & U4.IfClause) === U4.IfClause) && this.throwUnexpectedToken({ code: c5.NoFunctionInsideBlock });
    let e5 = this.captureStartMarker();
    this.expectKeyword(t.Function);
    let i3 = this.parseIdentifier();
    i3 || this.throwUnexpectedToken({ code: c5.InvalidFunctionIdentifier });
    ...
    return this.context.blockContext = n7, this.finalize({ type: u4.FunctionDeclaration, id: i3, params: r7, body: s6, ...this.getItemLocation(e5) });
  }
  parseScript() {
    let e5 = this.captureStartMarker(), t3 = this.parseStatements(), i3 = this.finalize({ type: u4.Program, body: t3, ...this.getItemLocation(e5) });
    return this.options.tokens && (i3.tokens = this.tokens), this.options.tolerant && (i3.errors = this.errorHandler.errors), i3;
  }
  parseExportDeclaration() {
    this.context.blockContext !== U4.None && this.throwUnexpectedToken({ code: c5.ModuleExportRootOnly });
    let e5 = null, i3 = this.captureStartMarker();
    return this.expectKeyword(t.Export), this.matchKeyword(t.Var) ? e5 = this.parseVariableDeclaration() : this.matchKeyword("function") ? e5 = this.parseFunctionDeclaration() : this.throwUnexpectedToken({ code: c5.InvalidExpression }), this.finalize({ type: u4.ExportNamedDeclaration, declaration: e5, specifiers: [], source: null, ...this.getItemLocation(i3) });
  }
  parseModuleSpecifier() {
    let e5 = this.captureStartMarker(), t3 = this.rawToken;
    if (t3.type === o2.StringLiteral) return this.readNextRawToken(), this.finalize({ type: u4.Literal, value: t3.value, raw: this.getSourceValue(t3), isString: true, ...this.getItemLocation(e5) });
    this.throwError(c5.InvalidModuleUri, e5);
  }
  parseDefaultSpecifier() {
    let e5 = this.captureStartMarker(), t3 = this.parseIdentifier();
    return t3 || this.throwUnexpectedToken({ code: c5.IdentiferExpected }), this.finalize({ type: u4.ImportDefaultSpecifier, local: t3, ...this.getItemLocation(e5) });
  }
  parseImportDeclaration() {
    this.context.blockContext !== U4.None && this.throwUnexpectedToken({ code: c5.ModuleImportRootOnly });
    let e5 = this.captureStartMarker();
    ...
    return this.finalize({ type: u4.ImportDeclaration, specifiers: [i3], source: r7, ...this.getItemLocation(e5) });
  }
};
...
function d4(d5, r7 = []) {
  const s6 = H4(d5);
  if (null === s6.body || void 0 === s6.body) throw new d3({ index: 0, line: 0, column: 0, data: null, description: "", code: c5.InvalidExpression });
...
var l4 = class _l {
  ...
  normalizeModuleUri(e5) {
    ...
    if (e5.startsWith("portal+")) {
      ...
      if (false === d5) {
        if (!o3.test(l5)) throw new p(l.UnsupportedUriProtocol, { uri: e5 });
      ...
      return l5 = new C2({ url: a5 }).restUrl + "/content/items/" + m3 + "/resources/" + h3 + ".arc", { url: l5, scheme: "portal", uri: "PO:" + l5 };
    }
    if (e5.startsWith("mock")) {
      ...
      if (void 0 !== _l.mocks[t3]) return { url: "", scheme: "mock", data: _l.mocks[t3], uri: e5 };
    }
    throw new p(l.UnrecognizedUri, { uri: e5 });
  }
  ...
  async fetchSource(s6) {
    if ("portal" === s6.scheme) {
      const t3 = await U(s6.url, { responseType: "text", query: {} });
...
var T2 = class extends s {
  ...
  loadModule(e5) {
    ...
    null == n7 && (n7 = new f({ wkid: 102100 })), this.moduleScope = Re2({}, e5.customfunctions, e5.timeZone), this.executingContext = { spatialReference: n7, globalScope: this.moduleScope, localScope: null, libraryResolver: new s2(e5.libraryResolver._moduleSingletons, this.source.syntax.loadedModules), exports: {}, services: e5.services, console: e5.console ?? Me3, timeZone: e5.timeZone ?? null, lrucache: e5.lrucache, interceptor: e5.interceptor, depthCounter: { depth: 1 } }, _3(this.executingContext, this.source.syntax);
  }
};
function W5(e5, t3) {
  const n7 = [];
...
function H5(e5, t3) {
  return { key: "Identifier" === t3.key.type ? t3.key.name : _3(e5, t3.key), value: _3(e5, t3.value) };
}
function Y3(e5, t3) {
...
function J4(e5, t3) {
  ...
  const n7 = { testResult: true, lastAction: O };
  do {
    X3(e5, t3, n7);
...
function $(e5, t3) {
  ...
  if (null != e5.localScope && void 0 !== e5.localScope[o3]) return n7 = ge(e5.localScope[o3].value), e5.localScope[o3] = { value: "++" === t3.operator ? n7 + 1 : n7 - 1, valueset: true, node: t3 }, false === t3.prefix ? n7 : "++" === t3.operator ? n7 + 1 : n7 - 1;
  if (void 0 !== e5.globalScope[o3]) return n7 = ge(e5.globalScope[o3].value), e5.globalScope[o3] = { value: "++" === t3.operator ? n7 + 1 : n7 - 1, valueset: true, node: t3 }, false === t3.prefix ? n7 : "++" === t3.operator ? n7 + 1 : n7 - 1;
...
function te3(e5, t3) {
  ...
  if ("MemberExpression" === t3.left.type) {
    ...
    if (U2(n7)) {
      ...
      if (true === n7.hasField(o3)) n7.setField(o3, ee3(a6, t3.operator, n7.field(o3), t3, e5));
        ...
        if ("=" !== t3.operator) throw new a3(e5, r3.FieldNotFound, t3, { key: o3 });
  ...
  if (null != e5.localScope && void 0 !== e5.localScope[n7]) return e5.localScope[n7] = { value: ee3(a5, t3.operator, e5.localScope[n7].value, t3, e5), valueset: true, node: t3.right }, O;
  if (void 0 !== e5.globalScope[n7]) return e5.globalScope[n7] = { value: ee3(a5, t3.operator, e5.globalScope[n7].value, t3, e5), valueset: true, node: t3.right }, O;
  throw new a3(e5, r3.InvalidIdentifier, t3);
}
function ne2(e5, t3) {
...
function ie2(e5, t3) {
  ...
  return e5.globalScope[n7] = { valueset: true, node: null, value: new P3(t3, e5) }, O;
}
function ae3(e5, t3) {
  var _a, _b;
  const n7 = t3.specifiers[0].local.name.toLowerCase(), o3 = e5.libraryResolver.loadLibrary(n7);
  let r7 = null;
  return ((_a = e5.libraryResolver._moduleSingletons) == null ? void 0 : _a.has(o3.uri)) ? r7 = e5.libraryResolver._moduleSingletons.get(o3.uri) : (r7 = new T2(o3), r7.loadModule(e5), (_b = e5.libraryResolver._moduleSingletons) == null ? void 0 : _b.set(o3.uri, r7)), e5.globalScope[n7] = { value: r7, valueset: true, node: t3 }, O;
}
function se2(e5, t3) {
...
function ue2(e5, t3) {
  ...
  return null != e5.localScope ? e5.localScope[o3] = { value: n7, valueset: true, node: t3.init } : e5.globalScope[o3] = { value: n7, valueset: true, node: t3.init }, O;
}
function fe3(e5, t3) {
  try {
    ...
    if (false === t3.computed) {
      if ("Identifier" === t3.property.type) {
        ...
        if (n7 instanceof n2) return d(n7, t3.property.name, e5, t3);
        if (n7 instanceof T2) {
...
function Fe3(e5, t3, n7, o3) {
  try {
    ...
    if (null != t3.localScope) for (let o4 = 0; o4 < n7.length; o4++) t3.localScope[e5.params[o4].name.toLowerCase()] = { value: n7[o4], valueset: true, node: null };
    const a5 = _3(t3, r7);
...
for (const Ne2 in xe3) xe3[Ne2] = { value: new e(xe3[Ne2]), valueset: true, node: null };
var Ce2 = function() {
};
function Re2(e5, t3, n7) {
  const o3 = new Ce2();
  e5 || (e5 = {}), t3 || (t3 = {});
  const l5 = new N({ newline: "\n", tab: "	", singlequote: "'", doublequote: '"', forwardslash: "/", backwardslash: "\\" });
  l5.immutable = false, o3.textformatting = { value: l5, valueset: true, node: null };
  for (const r7 in t3) o3[r7] = { value: new e(t3[r7]), native: true, valueset: true, node: null };
  for (const r7 in e5) e5[r7] && "esri.Graphic" === e5[r7].declaredClass ? o3[r7] = { value: D.createFromGraphic(e5[r7], n7), valueset: true, node: null } : o3[r7] = { value: e5[r7], valueset: true, node: null };
  return o3;
}
Ce2.prototype = xe3, Ce2.prototype.infinity = { value: Number.POSITIVE_INFINITY, valueset: true, node: null }, Ce2.prototype.pi = { value: Math.PI, valueset: true, node: null };
function Me3(e5) {
  console.log(e5);
}
function Ee2(e5) {
  const t3 = { mode: "sync", compiled: false, functions: {}, signatures: [], standardFunction: V, evaluateIdentifier: ye2 };
  for (let n7 = 0; n7 < e5.length; n7++) e5[n7].registerFunctions(t3);
  for (const n7 in t3.functions) xe3[n7] = { value: new e(t3.functions[n7]), valueset: true, node: null }, Ce2.prototype[n7] = xe3[n7];
  for (let n7 = 0; n7 < t3.signatures.length; n7++) o(t3.signatures[n7], "sync");
}
function Le2(e5, n7) {
  let o3 = n7.spatialReference;
  null == o3 && (o3 = new f({ wkid: 102100 }));
  let r7 = null;
  e5.usesModules && (r7 = new s2(/* @__PURE__ */ new Map(), e5.loadedModules));
  const a5 = { spatialReference: o3, globalScope: Re2(n7.vars, n7.customfunctions, n7.timeZone), localScope: null, services: n7.services ?? null, exports: {}, libraryResolver: r7, console: n7.console ?? Me3, timeZone: n7.timeZone ?? null, lrucache: n7.lrucache, interceptor: n7.interceptor, depthCounter: { depth: 1 } };
  let s6 = _3(a5, e5);
...
async function z5() {
  const e5 = await import("./@arcgis_core_geometry_geometryEngine.js");
...
async function N3() {
  await Ze2(), A = await import("./arcadeAsyncRuntime-XQMMZ6YT.js");
...
async function J5() {
  await L3();
  const [e5, r7, n7, s6, a5, u5] = await Promise.all([import("./featureSetUtils-U4YFALIO.js"), import("./featuresetbase-6NABMQSF.js"), import("./featuresetgeom-JHPSUH2U.js"), import("./featuresetstats-4JP67EXN.js"), import("./featuresetstring-AY7QHF7P.js"), import("./knowledgegraph-WQJ7QLR2.js")]);
...
async function W6(e5, t3, r7 = [], n7 = false, s6 = null) {
  return X4(/* @__PURE__ */ new Set(), e5, t3, r7, n7, s6);
}
async function X4(e5, t3, r7, n7 = [], s6 = false, a5 = null) {
  const u5 = "string" == typeof t3 ? E3(t3) : t3, o3 = [];
  return u5 && (false === q2() && (k2(u5) || s6) && o3.push(D3()), false === T3() && (true === u5.isAsync || r7) && o3.push(L3()), false === O3() && (K2(u5) || V2(u5, n7)) && o3.push(H6())), o3.length && await Promise.all(o3), await Z2(e5, u5, a5, r7, s6), true;
}
function Y4(e5, t3 = []) {
  return void 0 === e5.usesModules && d2(e5, t3), true === e5.usesModules;
}
async function Z2(e5, t3, r7 = null, s6 = false, a5 = false) {
  const c6 = x2(t3);
  ...
  for (const n7 of c6) {
    ...
    e5.add(c7.uri);
    const i3 = await r7.fetchModule(c7);
    await X4(e5, i3, s6, [], a5, r7), e5.delete(c7.uri), i3.isAsync && (t3.isAsync = true), i3.usesFeatureSet && (t3.usesFeatureSet = true), i3.usesGeometry && (t3.usesGeometry = true), t3.loadedModules[n7.libname] = { uri: c7.uri, script: i3 };
  }
}
function $2(e5) {
...
var re3 = Object.freeze(Object.defineProperty({ __proto__: null, _loadScriptDependenciesImpl: X4, compileScript: x5, enableAsyncSupport: L3, enableAsyncSupportImpl: N3, enableFeatureSetSupport: H6, enableFeatureSetSupportImpl: J5, enableGeometrySupport: D3, enableGeometrySupportImpl: z5, executeScript: G2, extend: F2, extractExpectedFieldLiterals: R3, extractFieldLiterals: I2, featureSetUtils: te4, isAsyncEnabled: T3, isFeatureSetSupportEnabled: O3, isGeometryEnabled: q2, loadDependentModules: Z2, loadScriptDependencies: W6, parseAndExecuteScript: v2, parseScript: E3, referencesFunction: _4, referencesMember: U5, scriptIsAsync: Q4, scriptTouchesGeometry: $2, scriptUsesFeatureSet: K2, scriptUsesGeometryEngine: k2, scriptUsesModules: Y4 }, Symbol.toStringTag, { value: "Module" }));
...
function q3(e5) {
  return null == e5 ? null : U2(e5) || Q(e5) ? "array" : X(e5) ? "date" : G(e5) ? "text" : z(e5) ? "boolean" : E(e5) ? "number" : e5 instanceof N ? "dictionary" : H(e5) ? "feature" : e5 instanceof _ ? "point" : e5 instanceof j ? "polygon" : e5 instanceof m ? "polyline" : e5 instanceof u ? "multipoint" : e5 instanceof w ? "extent" : e5 instanceof n3 ? "dateOnly" : e5 instanceof n4 ? "time" : B(e5) ? "featureSet" : W2(e5) ? "featureSetCollection" : null;
}
function I3(n7) {
  if (!n7) return null;
  try {
...
function G3(e5, n7, r7) {
  return { vars: { $feature: null == e5 ? new D() : D.createFromGraphic(e5, r7), $view: n7 == null ? void 0 : n7.view }, spatialReference: n7 == null ? void 0 : n7.sr, timeZone: r7 ?? null };
}
...
function K3({ url: e5, spatialReference: n7, lrucache: r7, interceptor: t3 }) {
  const o3 = te4();
  return o3 ? o3.createFeatureSetCollectionFromService(e5, n7, r7, t3) : null;
}
function N4({ layer: e5, spatialReference: n7, outFields: r7, returnGeometry: t3, lrucache: o3, interceptor: i3 }) {
  if (null === e5) return null;
  const s6 = te4();
  return s6 ? s6.constructFeatureSet(e5, n7, r7, t3 ?? true, o3, i3) : null;
}
function Q5(e5) {
  if (null === (e5 == null ? void 0 : e5.map)) return null;
  const n7 = te4();
...
function te5(e5, n7) {
  ...
  if (ee5(r7)) {
    if ("dot-density" === r7.type) {
      const e7 = (_a = r7.attributes) == null ? void 0 : _a.some((e8) => n7(e8.valueExpression));
      if (e7) return e7;
    }
  ...
  if (ne3(r7)) {
    const e6 = (_b = r7.labelExpressionInfo) == null ? void 0 : _b.expression;
    return !(!e6 || !n7(e6)) || false;
  }
  return !!re4(r7) && (!!r7.expressionInfos && r7.expressionInfos.some((e6) => n7(e6.expression)) || Array.isArray(r7.content) && r7.content.some((e6) => {
    var _a2;
...
//# sourceMappingURL=arcadeUtils-KCKG2V74.js.map
