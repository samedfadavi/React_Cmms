...
function s3(s4) {
  const a6 = s4 == null ? void 0 : s4.match(t);
  if (!a6) return null;
  const [, r3, c6, o] = a6;
  if (!r3) return null;
  let l3 = null, m5 = null, n4 = null;
  const { devext: u3, qaext: i3, www: p2 } = e;
  if (c6) if (l3 = r3, o) switch (o.toLowerCase()) {
    case "devext":
  ...
  else ({ customBaseUrl: m5, portalHostname: n4 } = p2);
  ...
  return { customBaseUrl: m5, isPortal: false, portalHostname: n4, urlKey: l3 };
}
function a3(t5) {
...
function I(t5) {
  if (!t5) return null;
  const n4 = { path: null, query: null }, e3 = new x(t5), r3 = t5.indexOf("?");
...
function v(t5, n4) {
  return t5 ? n4 && "function" == typeof n4 ? Object.keys(t5).map((e3) => encodeURIComponent(e3) + "=" + encodeURIComponent(n4(e3, t5[e3]))).join("&") : Object.keys(t5).map((e3) => {
    const o = t5[e3];
    if (null == o) return "";
    const s4 = encodeURIComponent(e3) + "=", i3 = n4 == null ? void 0 : n4[e3];
...
function H(t5) {
  const n4 = { proxyUrl: t5.proxyUrl, urlPrefix: B(t5.urlPrefix) }, e3 = c2.proxyRules, r3 = n4.urlPrefix;
  let o = e3.length;
...
function _(t5, n4 = b2, e3) {
  return pt(t5) ? (e3 == null ? void 0 : e3.preserveProtocolRelative) ? t5 : "http" === U.scheme && U.authority === X(t5).slice(2) ? `http:${t5}` : `https:${t5}` : ht(t5) ? t5 : V("/" === t5[0] ? Ut(n4) : n4, t5);
}
...
function nt(t5) {
  const n4 = ot(t5);
  return (n4 == null ? void 0 : n4.isBase64) ? t2(n4.data) : null;
}
function et(t5) {
...
function ot(t5) {
  ...
  if (!n4) return null;
  const [, e3, r3, o] = n4;
  return { mediaType: e3, isBase64: !!r3, data: o };
}
function st(t5) {
...
function ut(t5) {
  ...
  if (!n4) return null;
  const e3 = ot(t5);
  return new Blob([n4], { type: e3.mediaType });
}
function pt(t5) {
...
function bt(t5, n4) {
  ...
  if (!(n4 == null ? void 0 : n4.length)) return r3;
...
function m3(s4) {
  const e3 = t3 == null ? void 0 : t3.findCredential(s4);
  return (e3 == null ? void 0 : e3.token) ? kt(s4, "token", e3.token) : s4;
}
has("host-webworker");
...
async function U2(e3, t5) {
  var _a;
  e3 instanceof URL && (e3 = e3.toString()), (t5 == null ? void 0 : t5.query) instanceof URLSearchParams && (t5.query = A(t5.query.toString().replaceAll("+", " ")));
  const r3 = tt(e3), s4 = Z(e3);
  s4 || r3 || (e3 = K(e3));
  const a6 = { url: e3, requestOptions: { ...t5 } }, n4 = (e4) => ({ data: e4, getAllHeaders: H2, getHeader: H2, httpStatus: 200, requestOptions: a6.requestOptions, url: a6.url }), i3 = D(e3, A2.internalInterceptors);
  if (i3) {
    const e4 = await G2(i3, a6);
    if (null != e4) return n4(e4);
  }
  let h2 = D(e3);
  if (h2) {
    const e4 = await G2(h2, a6);
    if (null != e4) return n4(e4);
  ...
  if (await B2(), j2) return j2.execute(e3, t5);
  const m5 = new AbortController(), f3 = m(t5, () => m5.abort()), y2 = { controller: m5, credential: void 0, credentialToken: void 0, fetchOptions: void 0, hasToken: false, interceptor: h2, params: a6, redoRequest: false, useIdentity: A2.useIdentity, useProxy: false, useSSL: false, withCredentials: false }, w2 = await Q2(y2).finally(() => f3 == null ? void 0 : f3.remove());
  return (_a = h2 == null ? void 0 : h2.after) == null ? void 0 : _a.call(h2, w2), w2;
}
var j2;
var A2 = s.request;
...
function N2(e3, t5, o, i3) {
  ...
  if (t5) {
    const e4 = i3 && (() => Array.from(i3.headers)), r3 = i3 && ((e5) => i3.headers.get(e5)), s4 = i3 == null ? void 0 : i3.status, o2 = t5.message;
...
async function B2() {
  has("host-webworker") && !j2 && (j2 = await import("./request-ZLEXUHFN.js"));
}
async function $2() {
  t3 || await import("./IdentityManager-CAO2BIBE.js");
}
async function z2(r3) {
  var _a;
  const s4 = r3.params.url, o = r3.params.requestOptions, a6 = r3.controller.signal, n4 = o.body;
  let l3 = null, u3 = null;
  if (P2 && "HTMLFormElement" in globalThis && (n4 instanceof FormData ? l3 = n4 : n4 instanceof HTMLFormElement && (l3 = new FormData(n4))), "string" == typeof n4 && (u3 = n4), r3.fetchOptions = { cache: o.cacheBust ? "no-cache" : "default", credentials: "same-origin", headers: o.headers || {}, method: "head" === o.method ? "HEAD" : "GET", mode: "cors", priority: A2.priority, redirect: "follow", signal: a6 }, (l3 || u3) && (r3.fetchOptions.body = l3 || u3), "anonymous" === o.authMode && (r3.useIdentity = false), r3.hasToken = !!(/token=/i.test(s4) || ((_a = o.query) == null ? void 0 : _a.token) || (l3 == null ? void 0 : l3.get("token"))), !r3.hasToken && s.apiKey && c4(s4) && (o.query || (o.query = {}), o.query.token = s.apiKey, r3.hasToken = true), r3.useIdentity && !r3.hasToken && !r3.credentialToken && !K2(s4) && !c(a6)) {
    let e3;
    "immediate" === o.authMode ? (await $2(), e3 = await t3.getCredential(s4, { signal: a6 }), r3.credential = e3) : "no-prompt" === o.authMode ? (await $2(), e3 = await t3.getCredential(s4, { prompt: false, signal: a6 }).catch(() => {
...
async function W2(e3) {
  ...
  if (!a6) {
    ...
    if (u3) {
      const e4 = P(r3);
      l4 = e4.path, !d3 && l4.length + 1 + i4 > A2.maxUrlLength && (d3 = true), e4.query && (a7 = { ...e4.query, ...a7 });
    }
    ...
    if (d3 ? (o.method = "delete" === s4.method ? "DELETE" : "put" === s4.method ? "PUT" : "POST", s4.body ? r3 = Et(r3, a7) : (o.body = v(a7), o.headers || (o.headers = {}), o.headers["Content-Type"] = "application/x-www-form-urlencoded")) : r3 = Et(r3, a7), u3 && (e3.useProxy = true, r3 = `${l4}?${r3}`), a7.token && P2 && o.body instanceof FormData && !a3(r3) && o.body.set("token", a7.token), s4.hasOwnProperty("withCredentials")) e3.withCredentials = s4.withCredentials;
      ...
      if (M(r3)) e3.withCredentials = true;
        ...
        (s5 == null ? void 0 : s5.webTierAuth) && (e3.withCredentials = true);
      }
    }
    e3.withCredentials && (o.credentials = "include", d2(r3) && await f2(d3 ? Et(r3, a7) : r3));
  }
  ...
  try {
    if ("native-request-init" === s4.responseType) O3 = o, O3.url = r3;
      ...
      if (U2._beforeFetch && await U2._beforeFetch(r3, o), p2 = await fetch(r3, o), U2._afterFetch && await U2._afterFetch(p2), e3.useProxy || R2(r3), "native" === s4.responseType) O3 = p2;
      else if ("HEAD" !== o.method) if (p2.ok) {
        switch (i3) {
          case "array-buffer":
            O3 = await p2.arrayBuffer();
            break;
          case "blob":
          case "image":
            O3 = await p2.blob();
        ...
        if (O3) {
          if ("array-buffer" === i3 || "blob" === i3) {
            ...
            if (e4 && /application\/json|text\/plain/i.test(e4) && O3["blob" === i3 ? "size" : "byteLength"] <= 750) try {
              const e5 = await new Response(O3).json();
              e5.error && (O3 = e5);
            } catch {
            }
          }
          "image" === i3 && O3 instanceof Blob && (O3 = await Y2(URL.createObjectURL(O3), e3, true));
        }
      } else {
        O3 = await p2.text();
        try {
    ...
    e3.redoRequest = true, H({ proxyUrl: A2.proxyUrl, urlPrefix: X(r3) ?? "" });
  } finally {
    v2 && clearTimeout(v2);
  }
  return [p2, O3];
}
async function G2(e3, t5) {
  if (null != e3.responseData) return e3.responseData;
  if (e3.headers && (t5.requestOptions.headers = { ...t5.requestOptions.headers, ...e3.headers }), e3.query && (t5.requestOptions.query = { ...t5.requestOptions.query, ...e3.query }), e3.before) {
    let o, a6;
    try {
      a6 = await e3.before(t5);
    } catch (s4) {
...
async function Q2(e3) {
  ...
  try {
    do {
      [r3, s4] = await W2(e3);
    } while (!await V2(e3, r3, s4));
  } catch (n4) {
    const t5 = N2("request:server", n4, e3.params, r3);
    throw t5.details.ssl = e3.useSSL, ((_a = e3.interceptor) == null ? void 0 : _a.error) && e3.interceptor.error(t5), t5;
  }
  const o = e3.params.url;
  if (s4 && /\/sharing\/rest\/(accounts|portals)\/self/i.test(o)) {
    if (!e3.hasToken && !e3.credentialToken && ((_b = s4.user) == null ? void 0 : _b.username) && !M(o)) {
      const e4 = X(o, true);
  ...
  if (a6 && t3) {
    ...
    let r4 = e4 == null ? void 0 : e4.owningSystemUrl;
    if (r4) {
  ...
  return { data: s4, getAllHeaders: r3 ? () => Array.from(r3.headers) : H2, getHeader: r3 ? (e4) => r3.headers.get(e4) : H2, httpStatus: (r3 == null ? void 0 : r3.status) ?? 200, requestOptions: e3.params.requestOptions, ssl: e3.useSSL, url: e3.params.url };
}
async function V2(e3, r3, s4) {
  var _a;
  ...
  let a6, n4;
  if (s4 && (s4.error && "object" == typeof s4.error ? a6 = s4.error : "error" === s4.status && Array.isArray(s4.messages) && (a6 = { ...s4 }, a6[I2] = s4, a6.details = s4.messages)), !a6 && !r3.ok) throw a6 = new Error(`Unable to load ${r3.url} status: ${r3.status}`), a6[I2] = s4, a6;
  let i3, l3 = null;
  a6 && (n4 = Number(a6.code), l3 = a6.hasOwnProperty("subcode") ? Number(a6.subcode) : null, i3 = a6.messageCode, i3 = i3 == null ? void 0 : i3.toUpperCase());
  const u3 = o.authMode;
  if (403 === n4 && (4 === l3 || ((_a = a6.message) == null ? void 0 : _a.toLowerCase().includes("ssl")) && !a6.message.toLowerCase().includes("permission"))) {
    ...
    await $2();
    try {
      const r4 = await t3.getCredential(e3.params.url, { error: N2("request:server", a6, e3.params), prompt: "no-prompt" !== u3, signal: e3.controller.signal, token: e3.credentialToken });
...
//# sourceMappingURL=chunk-WC4SPMPL.js.map
