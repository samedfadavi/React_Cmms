...
var m = class extends i2(f) {
  ...
  get orientation() {
    ...
    return a5.normalize(a2(o2), 0, true);
  }
  set orientation(o2) {
...
e([y({ type: Boolean, json: { write: true } })], m.prototype, "enabled", void 0), e([y({ type: String, json: { write: true } })], m.prototype, "label", void 0), e([y({ type: Number, json: { read: false }, clonable: false, range: { min: 0, max: 360 } }), s2((o2) => a5.normalize(a2(o2), 0, true))], m.prototype, "orientation", null), e([y({ type: Number, json: { read: false }, clonable: false, range: { min: 0, max: 360 } }), s2((o2) => a5.normalize(a2(o2), 0, true))], m.prototype, "tilt", null), e([y({ type: [Number], json: { write: true } })], m.prototype, "normal", void 0), e([y({ type: [Number], json: { write: true } })], m.prototype, "point", void 0), m = e([a3("esri.layers.voxel.VoxelSlice")], m);
var c4 = m;

// ../node_modules/@arcgis/core/layers/voxel/VoxelSection.js
var d2 = class extends i2(f) {
  constructor() {
  ...
  get orientation() {
    ...
    return a5.normalize(a2(e7), 0, true);
  }
  get tilt() {
    if (!Array.isArray(this.normal) || 3 !== this.normal.length) return 0;
    const [e7, r4] = b2(this.normal);
    return a5.normalize(a2(r4), 0, true);
  }
};
e([y({ type: Boolean, json: { default: true, write: true } })], d2.prototype, "enabled", void 0), e([y({ type: String, json: { origins: { service: { read: f4 } }, write: { enabled: true, isRequired: true } } }), j2({ origins: ["web-scene"], type: "resource", prefix: "sections", compress: true })], d2.prototype, "href", void 0), e([y({ type: N, json: { write: { enabled: true, isRequired: true } } })], d2.prototype, "id", void 0), e([y({ type: String, json: { write: true } })], d2.prototype, "label", void 0), e([y({ type: Number, clonable: false, readOnly: true, range: { min: 0, max: 360 } })], d2.prototype, "orientation", null), e([y({ type: Number, clonable: false, readOnly: true, range: { min: 0, max: 360 } })], d2.prototype, "tilt", null), e([y({ type: [Number], json: { write: { enabled: true, isRequired: true } } })], d2.prototype, "normal", void 0), e([y({ type: [Number], json: { write: { enabled: true, isRequired: true } } })], d2.prototype, "point", void 0), e([y({ type: [N], json: { write: { enabled: true, isRequired: true } } })], d2.prototype, "sizeInPixel", void 0), e([y({ type: [c4], json: { write: true } })], d2.prototype, "slices", void 0), e([y({ type: N, json: { default: 0, write: true } })], d2.prototype, "timeId", void 0), e([y({ type: N, json: { write: { enabled: true, isRequired: true } } })], d2.prototype, "variableId", void 0), d2 = e([a3("esri.layers.voxel.VoxelSection")], d2);
var u5 = d2;
...
e([y({ type: u3, json: { type: [N], write: { enabled: true, isRequired: true } } })], c5.prototype, "color", void 0), e([y({ type: Number, json: { write: { enabled: true, isRequired: true } } })], c5.prototype, "position", void 0), c5 = e([a3("esri.layers.voxel.VoxelColorStop")], c5);
var l5 = c5;
...
var y5 = class extends i2(f) {
  ...
  get rasterizedTransferFunction() {
    ...
    for (const t6 of this.colorStops) {
      ...
      e7.push({ color: { r: t6.color.r, g: t6.color.g, b: t6.color.b, a: Math.round(255 * (1 - t6.color.a)) }, position: t6.position, type: u6.Color });
    }
    if (0 === this.opacityStops.length) for (const t6 of e7) r4.push({ color: t6.color, position: t6.position });
    else {
      for (const t6 of this.opacityStops) {
        ...
        i7 || e7.push({ color: { r: 0, g: 0, b: 0, a: r5 }, position: t6.position, type: u6.Alpha });
      }
      ...
      for (const t6 of e7) r4.push({ color: t6.color, position: t6.position });
    }
...
e([y({ type: ["linear", "nearest"], json: { write: true } })], y5.prototype, "interpolation", void 0), e([y({ type: [Number], json: { write: { enabled: true, isRequired: true } } })], y5.prototype, "stretchRange", void 0), e([y({ type: V.ofType(l5), json: { write: { enabled: true, overridePolicy() {
  return { enabled: !!this.colorStops && this.colorStops.length > 0 };
} } } })], y5.prototype, "colorStops", null), e([y({ type: V.ofType(i5), json: { read: { source: "alphaStops" }, write: { enabled: true, target: "alphaStops", overridePolicy() {
  return { enabled: !!this.opacityStops && this.opacityStops.length > 0 };
} } } })], y5.prototype, "opacityStops", null), e([y({ type: a7, json: { write: true } })], y5.prototype, "rangeFilter", void 0), e([y({ type: [u3], clonable: false, json: { read: false } })], y5.prototype, "rasterizedTransferFunction", null), y5 = e([a3("esri.layers.voxel.VoxelTransferFunctionStyle")], y5);
var g2 = y5;
var S2 = ["r", "g", "b"];
...
e([y({ type: u3, json: { type: [N], write: { enabled: true, isRequired: true } } })], a8.prototype, "color", void 0), e([y({ type: N, json: { write: { enabled: true, isRequired: true } } })], a8.prototype, "value", void 0), e([y({ type: Boolean, json: { default: true, write: true } })], a8.prototype, "enabled", void 0), e([y({ type: String, json: { write: true } })], a8.prototype, "label", void 0), a8 = e([a3("esri.layers.voxel.VoxelUniqueValue")], a8);
var l6 = a8;
...
e([y({ type: N, json: { write: { enabled: true, isRequired: true } } })], c6.prototype, "variableId", void 0), e([y({ type: String, json: { write: true } })], c6.prototype, "label", void 0), e([y({ type: g2, json: { write: { enabled: true, overridePolicy() {
  return { enabled: !this.uniqueValues || this.uniqueValues.length < 1 };
} } } })], c6.prototype, "transferFunction", void 0), e([y({ type: V.ofType(l6), json: { write: { enabled: true, overridePolicy() {
...
function r3(r4) {
  ...
  if (null == e7) return { didParse: false };
  ...
  if (Number.isNaN(I2) || I2 < 1 || I2 > 31) return { didParse: false };
  if (2 === b3) {
    const r5 = m4 % 4 == 0 && (m4 % 100 != 0 || m4 % 400 == 0);
    if (r5 && I2 > 29 || !r5 && I2 > 28) return { didParse: false };
  } else if ((4 === b3 || 6 === b3 || 9 === b3 || 11 === b3) && I2 > 30) return { didParse: false };
  ...
  let w2 = 1, x3 = 0, y6 = 0;
  if (c8 && (w2 = "-" === c8 ? -1 : 1), f9) {
    if (x3 = parseInt(f9, 10), Number.isNaN(x3) || x3 < 0) return { didParse: false };
    if (0 !== x3) {
      const r5 = w2 * x3;
      if (r5 < -12 || r5 > 14) return { didParse: false };
    }
  }
  if (p14 && (y6 = parseInt(p14, 10), Number.isNaN(y6) || y6 < 0 || y6 > 59)) return { didParse: false };
  ...
  return { didParse: true, unit: $, reference: /* @__PURE__ */ new Date(`${T}-${Z}-${A}T${C2}:${D}:${L2}.000${g3}`) };
}
...
var f8 = class extends f {
  ...
  get timeStops() {
    ...
    if (s6.didParse) {
      if (e7.isRegular) {
        const t6 = ((_a = e7.regularSpacing) == null ? void 0 : _a.offset) ?? 0, n4 = ((_b = e7.regularSpacing) == null ? void 0 : _b.scale) || 1;
        for (let o2 = 0; o2 < e7.size; ++o2) {
          const e8 = t6 + n4 * o2;
          i6.push(i3(s6.reference, e8, s6.unit));
        }
      } else if (Array.isArray((_c = e7.irregularSpacing) == null ? void 0 : _c.values) && e7.irregularSpacing.values.length > 0) for (let t6 = 0; t6 < e7.irregularSpacing.values.length; ++t6) {
  ...
  computeVoxelSpaceLocation(e7) {
    ...
    e3(i6, i6, this.originInLayerSpace3D), i(i6, i6, this.voxelSizeInLayerSpaceSigned);
  ...
  computeLayerSpaceLocation(e7) {
    ...
    const i6 = e2(e7);
    if (c2(i6, i6, this.voxelSizeInLayerSpaceSigned), u2(i6, i6, this.originInLayerSpace3D), "xyt" === this.volumeType) return new _({ x: i6[0], y: i6[1], spatialReference: this.spatialReference });
    const s6 = this.dimensions[this.zDimension];
    return s6.isRegular || Array.isArray((_a = s6.irregularSpacing) == null ? void 0 : _a.values) && (e7[2] < 0 ? i6[2] = s6.irregularSpacing.values[0] : e7[2] < s6.irregularSpacing.values.length ? i6[2] = s6.irregularSpacing.values[e7[2]] : i6[2] = s6.irregularSpacing.values[s6.irregularSpacing.values.length - 1], s6.isPositiveUp || (i6[2] *= -1)), new _({ x: i6[0], y: i6[1], z: i6[2], spatialReference: this.spatialReference });
  }
};
e([y({ type: Number, json: { write: { enabled: true, isRequired: true } } })], f8.prototype, "id", void 0), e([y({ type: [p12], json: { write: { enabled: true, isRequired: true } } })], f8.prototype, "dimensions", void 0), e([y({ type: f2, json: { read: { enabled: false } } })], f8.prototype, "spatialReference", void 0), e([y({ type: Number, json: { read: false } })], f8.prototype, "zDimension", null), e([y({ type: [Boolean], json: { read: false } })], f8.prototype, "isValid", null), e([y({ type: [Number], json: { read: false } })], f8.prototype, "originInLayerSpace3D", null), e([y({ type: [Number], json: { read: false } })], f8.prototype, "voxelSizeInLayerSpaceSigned", null), e([y({ type: ["xyz", "xyzt", "xyt"], json: { read: { enabled: false } } })], f8.prototype, "volumeType", null), e([y({ type: [Number], json: { read: false } })], f8.prototype, "sizeInVoxels", null), e([y({ type: [Date], json: { read: false, write: false } })], f8.prototype, "timeStops", null), f8 = e([a3("esri.layers.voxel.VoxelVolume")], f8);
var S3 = f8;
...
e([y({ type: Number, json: { write: { enabled: true, isRequired: true } } })], s5.prototype, "apronWidth", void 0), e([y({ type: [Number], json: { write: { enabled: true, isRequired: true } } })], s5.prototype, "brickSize", void 0), e([y({ type: Number, json: { write: { enabled: true, isRequired: true } } })], s5.prototype, "maxLodLevel", void 0), e([y({ type: [Number], json: { write: { enabled: true, isRequired: true } } })], s5.prototype, "nodeSize", void 0), s5 = t5 = e([a3("esri.layers.voxel.VoxelVolumeIndex")], s5);
var d3 = s5;

// ../node_modules/@arcgis/core/layers/voxel/VoxelDynamicSection.js
var m2 = class extends i2(f) {
  constructor(o2) {
    super(o2), this.enabled = true, this.label = "", this.normal = null, this.point = null;
  }
  get orientation() {
...
e([y({ type: Boolean, json: { default: true, write: true } })], m2.prototype, "enabled", void 0), e([y({ type: String, json: { write: true } })], m2.prototype, "label", void 0), e([y({ type: Number, json: { read: false }, clonable: false, range: { min: 0, max: 360 } }), s2((o2) => a5.normalize(a2(o2), 0, true))], m2.prototype, "orientation", null), e([y({ type: Number, json: { read: false }, clonable: false, range: { min: 0, max: 360 } }), s2((o2) => a5.normalize(a2(o2), 0, true))], m2.prototype, "tilt", null), e([y({ type: [Number], json: { write: true } })], m2.prototype, "normal", void 0), e([y({ type: [Number], json: { write: true } })], m2.prototype, "point", void 0), m2 = e([a3("esri.layers.voxel.VoxelDynamicSection")], m2);
var c7 = m2;
...
e([y({ type: N, json: { write: { enabled: true, isRequired: true } } })], m3.prototype, "volumeId", void 0), e([y({ type: Number, json: { default: 1, write: true } })], m3.prototype, "verticalExaggeration", void 0), e([y({ type: ["scale-position", "scale-height"], json: { default: "scale-height", write: true } })], m3.prototype, "exaggerationMode", void 0), e([y({ type: Number, json: { default: 0, write: true } })], m3.prototype, "verticalOffset", void 0), e([y({ type: V.ofType(c4), json: { write: { enabled: true, overridePolicy() {
...
var z2 = class extends L(l(b(j(t(S(e6(i4(f5)))))))) {
  ...
  load(e7) {
    const t6 = null != e7 ? e7.signal : null, i6 = this.loadFromPortal({ supportedTypes: ["Scene Service"] }, e7).catch(a4).then(() => this._fetchService(t6)).then(() => this.serviceRoot = this.url);
  ...
  validateLayer(e7) {
    if (e7.layerType && e7.layerType !== this.operationalLayerType) throw new s("voxel-layer:layer-type-not-supported", "VoxelLayer does not support this layer type", { layerType: e7.layerType });
  ...
  get voxelFields() {
    ...
    if (null != t6) {
      if ("xyzt" === t6.volumeType || "xyt" === t6.volumeType) {
        ...
        e7.push(t7);
        const i6 = new y2({ name: "Voxel.ServiceNativeTime", alias: "Native Time", domain: null, editable: false, length: 128, type: "string" });
        e7.push(i6);
      }
  ...
  createPopupTemplate(e7) {
    ...
    return p2({ fields: t6, title: i6 }, e7);
  }
  getConfiguration() {
    var _a, _b;
  ...
  get timeInfo() {
    ...
    if ("xyzt" !== (e7 == null ? void 0 : e7.volumeType)) return null;
    const t6 = e7.timeStops;
    if (!(t6 == null ? void 0 : t6.length)) return null;
    const o2 = new c3({ start: t6[0], end: t6.at(-1) });
    return new d({ fullTimeExtent: o2, stops: t6 });
  }
  getVolumeStyle(e7) {
    const t6 = this.getVariable(e7);
  ...
  getColorForContinuousDataValue(e7, t6, i6) {
    ...
    if (null == o2 || "continuous" !== ((_a = o2.renderingFormat) == null ? void 0 : _a.continuity)) return null;
    ...
    return (s6 == null ? void 0 : s6.transferFunction) ? s6.transferFunction.getColorForContinuousDataValue(t6, i6) : null;
  }
  getSections() {
    const e7 = [];
    for (const t6 of this.sections) e7.push(new u5({ enabled: t6.enabled, href: t6.href, id: t6.id, label: t6.label, normal: t6.normal, point: t6.point, sizeInPixel: t6.sizeInPixel, slices: t6.slices, timeId: t6.timeId, variableId: t6.variableId }));
    return e7;
  }
  getVariableStyles() {
    const e7 = [];
...
e([y({ type: ["Voxel"] })], z2.prototype, "operationalLayerType", void 0), e([y(y4)], z2.prototype, "legendEnabled", void 0), e([y({ json: { write: true } })], z2.prototype, "title", void 0), e([y(p)], z2.prototype, "url", null), e([y({ type: V.ofType(u5), json: { origins: { "web-scene": { name: "layerDefinition.sections", write: true } } } })], z2.prototype, "sections", void 0), e([y({ type: N, json: { origins: { "web-scene": { name: "layerDefinition.style.currentVariableId", write: { enabled: true, isRequired: true, ignoreOrigin: true } }, service: { name: "style.currentVariableId" } } } })], z2.prototype, "currentVariableId", void 0), e([y({ type: V.ofType(d4), json: { origins: { "web-scene": { name: "layerDefinition.style.volumeStyles", write: true }, service: { name: "style.volumeStyles" } } } })], z2.prototype, "volumeStyles", void 0), e([y({ type: ["volume", "surfaces"], json: { origins: { "web-scene": { name: "layerDefinition.style.renderMode", write: true }, service: { name: "style.renderMode" } } } })], z2.prototype, "renderMode", void 0), e([y({ type: V.ofType(f7), json: { origins: { "web-scene": { name: "layerDefinition.style.variableStyles", write: true }, service: { name: "style.variableStyles" } } } })], z2.prototype, "variableStyles", void 0), e([y({ type: Boolean, json: { origins: { "web-scene": { name: "layerDefinition.style.enableSlices", write: true }, service: { name: "style.enableSlices" } } } })], z2.prototype, "enableSlices", void 0), e([y({ type: Boolean, json: { origins: { "web-scene": { name: "layerDefinition.style.enableSections", write: true }, service: { name: "style.enableSections" } } } })], z2.prototype, "enableSections", void 0), e([y({ type: Boolean, json: { origins: { "web-scene": { name: "layerDefinition.style.enableDynamicSections", write: true }, service: { name: "style.enableDynamicSections" } } } })], z2.prototype, "enableDynamicSections", void 0), e([y({ type: Boolean, json: { origins: { "web-scene": { name: "layerDefinition.style.enableIsosurfaces", write: true }, service: { name: "style.enableIsosurfaces" } } } })], z2.prototype, "enableIsosurfaces", void 0), e([y({ type: p4, json: { origins: { "web-scene": { name: "layerDefinition.style.shading", write: true }, service: { name: "style.shading" } } } })], z2.prototype, "shading", void 0), e([y({ type: ["show", "hide"] })], z2.prototype, "listMode", void 0), e([y({ type: Number, range: { min: 0, max: 1 }, nonNullable: true, json: { read: false, write: false, origins: { "web-scene": { read: false, write: false }, "portal-item": { read: false, write: false } } } })], z2.prototype, "opacity", void 0), e([y({ type: V.ofType(p6) })], z2.prototype, "variables", void 0), e([y({ type: V.ofType(S3) })], z2.prototype, "volumes", void 0), e([y({ type: d3 })], z2.prototype, "index", void 0), e([y({ type: Number, json: { name: "layerDefinition.minScale", write: true, origins: { service: { read: false, write: false } } } })], z2.prototype, "minScale", void 0), e([y({ type: Number, json: { name: "layerDefinition.maxScale", write: true, origins: { service: { read: false, write: false } } } })], z2.prototype, "maxScale", void 0), e([y({ json: { read: false }, readOnly: true })], z2.prototype, "type", void 0), e([y({ readOnly: true, json: { name: "serviceVersion" } })], z2.prototype, "version", void 0), e([o("service", "version")], z2.prototype, "readVersion", null), e([y({ type: w })], z2.prototype, "fullExtent", void 0), e([o("service", "fullExtent", ["fullExtent"])], z2.prototype, "readFullExtent", null), e([y({ readOnly: true, clonable: false, json: { read: false } })], z2.prototype, "voxelFields", null), e([y({ type: Boolean, json: { name: "disablePopup", read: { reader: (e7, t6) => !t6.disablePopup }, write: { enabled: true, ignoreOrigin: true, writer(e7, t6, i6) {
  t6[i6] = !e7;
} }, origins: { "portal-item": { default: true }, "web-scene": { default: true } } } })], z2.prototype, "popupEnabled", void 0), e([y({ type: k, json: { read: false } })], z2.prototype, "popupTemplate", null), e([y({ readOnly: true })], z2.prototype, "defaultPopupTemplate", null), e([y({ type: d, readOnly: true, json: { read: false } })], z2.prototype, "timeInfo", null), e([y({ type: c3, json: { read: false } })], z2.prototype, "timeExtent", void 0), e([y({ type: l2, json: { read: false } })], z2.prototype, "timeOffset", void 0), e([y({ type: Boolean, nonNullable: true, json: { origins: { "web-scene": { name: "timeAnimation", write: true }, service: { read: false } } } })], z2.prototype, "useViewTime", void 0), z2 = e([a3("esri.layers.VoxelLayer")], z2);
var C = z2;
export {
  C as default
};
//# sourceMappingURL=VoxelLayer-GIDNL5MJ.js.map
