...
e([y({ type: String, json: { write: { writerEnsuresNonNull: true } } })], n3.prototype, "expression", void 0), e([o("expression", ["expression", "value"])], n3.prototype, "readExpression", null), e([r("expression")], n3.prototype, "writeExpression", null), e([y({ type: String, json: { write: true, origins: { "web-scene": { write: false } } } })], n3.prototype, "title", void 0), e([y({ json: { read: false, write: false } })], n3.prototype, "value", void 0), n3 = l = e([a2("esri.layers.support.LabelExpressionInfo")], n3);
var a4 = n3;
...
function j(e2) {
  return x2(e2) || E2(e2 == null ? void 0 : e2.layer);
}
var A = S = class extends f {
  ...
  writeLabelExpressionInfo(e2, r2, t2, o3) {
    if (null == e2 && null != this.labelExpression && x2(o3)) e2 = new a4({ expression: this.getLabelExpressionArcade() });
    else if (!e2) return;
...
e([y({ type: String, json: { write: true } })], A.prototype, "name", void 0), e([y({ type: Boolean, json: { write: true, default: false, origins: { "web-scene": { write: false }, "portal-item": { default: false, write: { overridePolicy: P2 } } } } })], A.prototype, "allowOverrun", void 0), e([y({ type: String, json: { write: true, default: "static", origins: { "web-scene": { write: false }, "portal-item": { default: "static", write: { overridePolicy: P2 } } } } })], A.prototype, "deconflictionStrategy", void 0), e([y({ type: String, json: { write: { overridePolicy(e2, r2, t2) {
  return this.labelExpressionInfo && "service" === (t2 == null ? void 0 : t2.origin) && E2(t2.layer) ? { enabled: false } : { allowNull: true };
} } } })], A.prototype, "labelExpression", void 0), e([o("labelExpression")], A.prototype, "readLabelExpression", null), e([r("labelExpression")], A.prototype, "writeLabelExpression", null), e([y({ type: a4, json: { write: { overridePolicy: (e2, r2, t2) => j(t2) ? { allowNull: true } : { enabled: false } } } })], A.prototype, "labelExpressionInfo", void 0), e([r("labelExpressionInfo")], A.prototype, "writeLabelExpressionInfo", null), e([y({ type: L.apiValues, json: { type: L.jsonValues, read: L.read, write: L.write } })], A.prototype, "labelPlacement", void 0), e([y({ type: ["curved", "parallel"], json: { write: true, origins: { "web-map": { write: false }, "web-scene": { write: false }, "portal-item": { write: false } } } })], A.prototype, "labelPosition", void 0), e([y({ type: Number })], A.prototype, "maxScale", void 0), e([r("maxScale")], A.prototype, "writeMaxScale", null), e([y({ type: Number })], A.prototype, "minScale", void 0), e([r("minScale")], A.prototype, "writeMinScale", null), e([y({ type: Boolean, json: { write: true, origins: { "web-scene": { write: false }, "portal-item": { write: { overridePolicy: P2 } } } } })], A.prototype, "repeatLabel", void 0), e([y({ type: Number, cast: o2, json: { write: true, origins: { "web-scene": { write: false }, "portal-item": { write: { overridePolicy: P2 } } } } })], A.prototype, "repeatLabelDistance", void 0), e([y({ types: F, json: { origins: { "web-scene": { types: P, write: i, default: null } }, write: i, default: null } })], A.prototype, "symbol", void 0), e([y({ type: Boolean, json: { write: true } })], A.prototype, "useCodedValues", void 0), e([y({ type: String, json: { write: true } })], A.prototype, "where", void 0), A = S = e([a2("esri.layers.support.LabelClass")], A);
var C = A;
...
function l2(e2, o3, t2) {
  return e2 ? e2.map((e3) => {
    ...
    if (l3.read(e3, t2), l3.labelExpression) {
      const e4 = o3.fields || ((_a = o3.layerDefinition) == null ? void 0 : _a.fields) || this.fields;
...
var i2 = { esriGeometryPoint: ["above-right", "above-center", "above-left", "center-center", "center-left", "center-right", "below-center", "below-left", "below-right"], esriGeometryPolygon: ["always-horizontal"], esriGeometryPolyline: ["center-along", "above-along", "below-along"], esriGeometryMultipoint: null, esriGeometryEnvelope: null };
function a5(o3, r2) {
  const n5 = [];
  for (const l3 of o3) {
...
//# sourceMappingURL=chunk-QBW6ZJYD.js.map
