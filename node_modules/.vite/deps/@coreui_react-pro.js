import {
  require_prop_types
} from "./chunk-OLZGSNJS.js";
import "./chunk-ZN2V5MLS.js";
import {
  require_react_dom
} from "./chunk-S4XLA4ZE.js";
import {
  require_react
...
import {
  createPopper,
  init_lib
} from "./chunk-SWJ63LQT.js";
import "./chunk-TFVDYOTB.js";
import {
  __toESM
} from "./chunk-WG7MCETX.js";

// node_modules/@coreui/react-pro/dist/esm/node_modules/tslib/tslib.es6.js
...
// node_modules/@coreui/react-pro/dist/esm/components/accordion/CAccordionContext.js
var import_react = __toESM(require_react());
var CAccordionContext = (0, import_react.createContext)({});

// node_modules/@coreui/react-pro/dist/esm/components/accordion/CAccordion.js
var CAccordion = (0, import_react2.forwardRef)(function(_a3, ref) {
  var children2 = _a3.children, activeItemKey = _a3.activeItemKey, _b3 = _a3.alwaysOpen, alwaysOpen = _b3 === void 0 ? false : _b3, className = _a3.className, flush = _a3.flush, rest = __rest(_a3, ["children", "activeItemKey", "alwaysOpen", "className", "flush"]);
  var _c3 = (0, import_react2.useState)(activeItemKey), _activeItemKey = _c3[0], setActiveKey = _c3[1];
  return import_react2.default.createElement(
    "div",
    __assign({ className: classNames("accordion", { "accordion-flush": flush }, className) }, rest, { ref }),
    import_react2.default.createElement(CAccordionContext.Provider, { value: { _activeItemKey, alwaysOpen, setActiveKey } }, children2)
  );
});
...
var TransitionGroupContext = import_react3.default.createContext(null);
...
var Transition = function(_React$Component) {
  ...
  _proto.render = function render() {
    ...
    return (
      ...
      import_react4.default.createElement(TransitionGroupContext.Provider, {
        value: null
...
var CSSTransition = function(_React$Component) {
  ...
  _proto.render = function render() {
    ...
    return import_react5.default.createElement(Transition, _extends({}, props, {
...
// node_modules/@coreui/react-pro/dist/esm/node_modules/react-transition-group/esm/ReplaceTransition.js
var import_prop_types6 = __toESM(require_prop_types());
var import_react8 = __toESM(require_react());
var import_react_dom2 = __toESM(require_react_dom());

// node_modules/@coreui/react-pro/dist/esm/node_modules/@babel/runtime/helpers/esm/assertThisInitialized.js
function _assertThisInitialized(e) {
  if (void 0 === e) throw new ReferenceError("this hasn't been initialised - super() hasn't been called");
  return e;
}

// node_modules/@coreui/react-pro/dist/esm/node_modules/react-transition-group/esm/TransitionGroup.js
var import_prop_types5 = __toESM(require_prop_types());
var import_react7 = __toESM(require_react());

// node_modules/@coreui/react-pro/dist/esm/node_modules/react-transition-group/esm/utils/ChildMapping.js
...
var TransitionGroup = function(_React$Component) {
  ...
  _proto.render = function render() {
    ...
    delete props.exit;
    if (Component === null) {
      return import_react7.default.createElement(TransitionGroupContext.Provider, {
        value: contextValue
      }, children2);
    }
    return import_react7.default.createElement(TransitionGroupContext.Provider, {
...
var ReplaceTransition = function(_React$Component) {
  ...
  _proto.render = function render() {
    ...
    return import_react8.default.createElement(TransitionGroup, props, inProp ? import_react8.default.cloneElement(first, {
      key: "first",
...
// node_modules/@coreui/react-pro/dist/esm/node_modules/react-transition-group/esm/SwitchTransition.js
...
var SwitchTransition = function(_React$Component) {
  ...
  _proto.render = function render() {
    ...
    return import_react9.default.createElement(TransitionGroupContext.Provider, {
      value: {
...
// node_modules/@coreui/react-pro/dist/esm/components/collapse/CCollapse.js
var CCollapse = (0, import_react11.forwardRef)(function(_a3, ref) {
  var children2 = _a3.children, className = _a3.className, horizontal = _a3.horizontal, onHide = _a3.onHide, onShow = _a3.onShow, visible = _a3.visible, rest = __rest(_a3, ["children", "className", "horizontal", "onHide", "onShow", "visible"]);
  var collapseRef = (0, import_react11.useRef)(null);
  var forkedRef = useForkedRef(ref, collapseRef);
  var _b3 = (0, import_react11.useState)(), height = _b3[0], setHeight = _b3[1];
  var _c3 = (0, import_react11.useState)(), width = _c3[0], setWidth = _c3[1];
  ...
  return import_react11.default.createElement(CSSTransition, { in: visible, nodeRef: collapseRef, onEntering, onEntered, onExit, onExiting, onExited, timeout: 350 }, function(state) {
    var currentHeight = height === 0 ? null : { height };
    var currentWidth = width === 0 ? null : { width };
    return import_react11.default.createElement("div", __assign({ className: classNames(className, {
      "collapse-horizontal": horizontal,
      collapsing: state === "entering" || state === "exiting",
      "collapse show": state === "entered",
      collapse: state === "exited"
    }), style: __assign(__assign({}, currentHeight), currentWidth) }, rest, { ref: forkedRef }), children2);
  });
});
CCollapse.propTypes = {
  ...
  onHide: import_prop_types8.default.func,
  onShow: import_prop_types8.default.func,
  visible: import_prop_types8.default.bool
};
CCollapse.displayName = "CCollapse";

// node_modules/@coreui/react-pro/dist/esm/components/accordion/CAccordionItemContext.js
var import_react12 = __toESM(require_react());
var CAccordionItemContext = (0, import_react12.createContext)({});

// node_modules/@coreui/react-pro/dist/esm/components/accordion/CAccordionBody.js
var CAccordionBody = (0, import_react13.forwardRef)(function(_a3, ref) {
  var children2 = _a3.children, className = _a3.className, rest = __rest(_a3, ["children", "className"]);
  var _b3 = (0, import_react13.useContext)(CAccordionItemContext), id = _b3.id, visible = _b3.visible;
  return import_react13.default.createElement(
    CCollapse,
    { className: "accordion-collapse", id, visible },
    import_react13.default.createElement("div", __assign({ className: classNames("accordion-body", className) }, rest, { ref }), children2)
  );
});
...
var CAccordionButton = (0, import_react14.forwardRef)(function(_a3, ref) {
  var children2 = _a3.children, className = _a3.className, rest = __rest(_a3, ["children", "className"]);
  var _b3 = (0, import_react14.useContext)(CAccordionItemContext), id = _b3.id, visible = _b3.visible, setVisible = _b3.setVisible;
  return import_react14.default.createElement("button", __assign({ type: "button", className: classNames("accordion-button", { collapsed: !visible }, className), "aria-controls": id, "aria-expanded": visible, onClick: function() {
...
var CAccordionHeader = (0, import_react15.forwardRef)(function(_a3, ref) {
  var children2 = _a3.children, className = _a3.className, rest = __rest(_a3, ["children", "className"]);
  return import_react15.default.createElement(
    "div",
    __assign({ className: classNames("accordion-header", className) }, rest, { ref }),
    import_react15.default.createElement(CAccordionButton, null, children2)
  );
});
...
var CAccordionItem = (0, import_react16.forwardRef)(function(_a3, ref) {
  var children2 = _a3.children, className = _a3.className, id = _a3.id, itemKey = _a3.itemKey, rest = __rest(_a3, ["children", "className", "id", "itemKey"]);
  var uniqueId = (0, import_react16.useId)();
  var _id = id !== null && id !== void 0 ? id : uniqueId;
  var _itemKey = (0, import_react16.useRef)(itemKey !== null && itemKey !== void 0 ? itemKey : _id);
  var _b3 = (0, import_react16.useContext)(CAccordionContext), _activeItemKey = _b3._activeItemKey, alwaysOpen = _b3.alwaysOpen, setActiveKey = _b3.setActiveKey;
  var _c3 = (0, import_react16.useState)(Boolean(_activeItemKey === _itemKey.current)), visible = _c3[0], setVisible = _c3[1];
  ...
  return import_react16.default.createElement(
    ...
    import_react16.default.createElement(CAccordionItemContext.Provider, { value: { id: _id, setVisible, visible } }, children2)
  );
});
CAccordionItem.propTypes = {
  children: import_prop_types12.default.node,
  className: import_prop_types12.default.string,
  itemKey: import_prop_types12.default.oneOfType([import_prop_types12.default.number, import_prop_types12.default.string])
};
...
var CCloseButton = (0, import_react17.forwardRef)(function(_a3, ref) {
  ...
  return import_react17.default.createElement("button", __assign({ type: "button", className: classNames("btn", "btn-close", {
    "btn-close-white": white
  }, disabled, className), "aria-label": "Close", disabled }, dark && { "data-coreui-theme": "dark" }, rest, { ref }));
});
CCloseButton.propTypes = {
  className: import_prop_types13.default.string,
  dark: import_prop_types13.default.bool,
  disabled: import_prop_types13.default.bool,
  white: import_prop_types13.default.bool
};
...
var colorPropType = import_prop_types14.default.oneOfType([
...
var fallbackPlacementsPropType = import_prop_types14.default.oneOfType([
  import_prop_types14.default.arrayOf(import_prop_types14.default.oneOf(["top", "bottom", "right", "left"]).isRequired),
  import_prop_types14.default.oneOf(["top", "bottom", "right", "left"])
]);
var gradientsPropType = import_prop_types14.default.oneOf([
  "primary-gradient",
  "secondary-gradient",
  "success-gradient",
  "danger-gradient",
...
var placementPropType = import_prop_types14.default.oneOf([
  "auto",
  "auto-start",
  "auto-end",
  "top-end",
...
var shapePropType = import_prop_types14.default.oneOfType([
  import_prop_types14.default.oneOf([
    "rounded",
    "rounded-top",
    "rounded-end",
...
var textColorsPropType = import_prop_types14.default.oneOfType([
  colorPropType,
  import_prop_types14.default.oneOf(["white", "muted"]),
  import_prop_types14.default.string
]);
var triggerPropType = import_prop_types14.default.oneOfType([
  import_prop_types14.default.arrayOf(import_prop_types14.default.oneOf(["hover", "focus", "click"]).isRequired),
  import_prop_types14.default.oneOf(["hover", "focus", "click"])
]);

// node_modules/@coreui/react-pro/dist/esm/components/alert/CAlert.js
var CAlert = (0, import_react18.forwardRef)(function(_a3, ref) {
  var children2 = _a3.children, className = _a3.className, _b3 = _a3.color, color = _b3 === void 0 ? "primary" : _b3, dismissible = _a3.dismissible, variant = _a3.variant, _c3 = _a3.visible, visible = _c3 === void 0 ? true : _c3, onClose = _a3.onClose, rest = __rest(_a3, ["children", "className", "color", "dismissible", "variant", "visible", "onClose"]);
  var alertRef = (0, import_react18.useRef)(null);
  var forkedRef = useForkedRef(ref, alertRef);
  var _d3 = (0, import_react18.useState)(visible), _visible = _d3[0], setVisible = _d3[1];
  (0, import_react18.useEffect)(function() {
    setVisible(visible);
  }, [visible]);
  return import_react18.default.createElement(Transition, { in: _visible, mountOnEnter: true, nodeRef: alertRef, onExit: onClose, timeout: 150, unmountOnExit: true }, function(state) {
    return import_react18.default.createElement(
      ...
      children2,
      dismissible && import_react18.default.createElement(CCloseButton, { onClick: function() {
...
CAlert.propTypes = {
  ...
  dismissible: import_prop_types15.default.bool,
  onClose: import_prop_types15.default.func,
  variant: import_prop_types15.default.string,
...
var CAlertHeading = (0, import_react19.forwardRef)(function(_a3, ref) {
  var children2 = _a3.children, _b3 = _a3.as, Component = _b3 === void 0 ? "h4" : _b3, className = _a3.className, rest = __rest(_a3, ["children", "as", "className"]);
  return import_react19.default.createElement(Component, __assign({ className: classNames("alert-heading", className) }, rest, { ref }), children2);
});
...
var CLink = (0, import_react20.forwardRef)(function(_a3, ref) {
  var children2 = _a3.children, active = _a3.active, _b3 = _a3.as, Component = _b3 === void 0 ? "a" : _b3, className = _a3.className, disabled = _a3.disabled, rest = __rest(_a3, ["children", "active", "as", "className", "disabled"]);
...
// node_modules/@coreui/react-pro/dist/esm/components/alert/CAlertLink.js
var CAlertLink = (0, import_react21.forwardRef)(function(_a3, ref) {
  var children2 = _a3.children, className = _a3.className, rest = __rest(_a3, ["children", "className"]);
  return import_react21.default.createElement(CLink, __assign({ className: classNames("alert-link", className) }, rest, { ref }), children2);
});
...
var CAvatar = (0, import_react22.forwardRef)(function(_a3, ref) {
  var _b3;
  var children2 = _a3.children, className = _a3.className, color = _a3.color, shape = _a3.shape, size = _a3.size, src = _a3.src, status = _a3.status, textColor = _a3.textColor, rest = __rest(_a3, ["children", "className", "color", "shape", "size", "src", "status", "textColor"]);
  ...
  return import_react22.default.createElement(
    ...
    src ? import_react22.default.createElement("img", { src, className: "avatar-img" }) : children2,
    status && import_react22.default.createElement("span", { className: statusClassName })
  );
});
CAvatar.propTypes = {
...
init_lib();
var CBackdrop = (0, import_react23.forwardRef)(function(_a3, ref) {
  var _b3 = _a3.className, className = _b3 === void 0 ? "modal-backdrop" : _b3, visible = _a3.visible, rest = __rest(_a3, ["className", "visible"]);
  var backdropRef = (0, import_react23.useRef)(null);
  var forkedRef = useForkedRef(ref, backdropRef);
  return import_react23.default.createElement(Transition, { in: visible, mountOnEnter: true, nodeRef: backdropRef, timeout: 150, unmountOnExit: true }, function(state) {
    return import_react23.default.createElement("div", __assign({ className: classNames(className, "fade", {
      show: state === "entered"
    }) }, rest, { ref: forkedRef }));
  });
});
CBackdrop.propTypes = {
  ...
  visible: import_prop_types20.default.bool
};
...
var CBadge = (0, import_react24.forwardRef)(function(_a3, ref) {
  var _b3;
  var children2 = _a3.children, _c3 = _a3.as, Component = _c3 === void 0 ? "span" : _c3, className = _a3.className, color = _a3.color, position = _a3.position, shape = _a3.shape, size = _a3.size, textBgColor = _a3.textBgColor, textColor = _a3.textColor, rest = __rest(_a3, ["children", "as", "className", "color", "position", "shape", "size", "textBgColor", "textColor"]);
  return import_react24.default.createElement(Component, __assign({ className: classNames("badge", (_b3 = {}, _b3["bg-".concat(color)] = color, _b3["position-absolute translate-middle"] = position, _b3["top-0"] = position === null || position === void 0 ? void 0 : position.includes("top"), _b3["top-100"] = position === null || position === void 0 ? void 0 : position.includes("bottom"), _b3["start-100"] = position === null || position === void 0 ? void 0 : position.includes("end"), _b3["start-0"] = position === null || position === void 0 ? void 0 : position.includes("start"), _b3["badge-".concat(size)] = size, _b3["text-".concat(textColor)] = textColor, _b3["text-bg-".concat(textBgColor)] = textBgColor, _b3), shape, className) }, rest, { ref }), children2);
});
CBadge.propTypes = {
  as: import_prop_types21.default.elementType,
  children: import_prop_types21.default.node,
  className: import_prop_types21.default.string,
  color: import_prop_types21.default.oneOfType([colorPropType, gradientsPropType]),
  position: import_prop_types21.default.oneOf(["top-start", "top-end", "bottom-end", "bottom-start"]),
  shape: shapePropType,
  size: import_prop_types21.default.oneOf(["sm"]),
...
var CBreadcrumb = (0, import_react25.forwardRef)(function(_a3, ref) {
  var children2 = _a3.children, className = _a3.className, rest = __rest(_a3, ["children", "className"]);
  return import_react25.default.createElement(
    "nav",
    { "aria-label": "breadcrumb" },
    import_react25.default.createElement("ol", __assign({ className: classNames("breadcrumb", className) }, rest, { ref }), children2)
  );
});
...
var CBreadcrumbItem = (0, import_react26.forwardRef)(function(_a3, ref) {
  var children2 = _a3.children, active = _a3.active, as = _a3.as, className = _a3.className, href = _a3.href, rest = __rest(_a3, ["children", "active", "as", "className", "href"]);
  return import_react26.default.createElement("li", __assign({ className: classNames("breadcrumb-item", {
    active
  }, className) }, active && { "aria-current": "page" }, rest, { ref }), href ? import_react26.default.createElement(CLink, { as, href }, children2) : children2);
});
...
var CButton = (0, import_react27.forwardRef)(function(_a3, ref) {
  var _b3;
  var children2 = _a3.children, _c3 = _a3.as, as = _c3 === void 0 ? "button" : _c3, className = _a3.className, color = _a3.color, shape = _a3.shape, size = _a3.size, _d3 = _a3.type, type = _d3 === void 0 ? "button" : _d3, variant = _a3.variant, rest = __rest(_a3, ["children", "as", "className", "color", "shape", "size", "type", "variant"]);
  return import_react27.default.createElement(CLink, __assign({ as: rest.href ? "a" : as }, !rest.href && { type }, { className: classNames("btn", (_b3 = {}, _b3["btn-".concat(variant, "-").concat(color)] = variant && color, _b3["btn-".concat(variant)] = variant && !color, _b3["btn-".concat(color)] = !variant && color, _b3["btn-".concat(size)] = size, _b3), shape, className) }, rest, { ref }), children2);
});
CButton.propTypes = {
  ...
  color: colorPropType,
  shape: import_prop_types24.default.string,
  size: import_prop_types24.default.oneOf(["sm", "lg"]),
  type: import_prop_types24.default.oneOf(["button", "submit", "reset"]),
  variant: import_prop_types24.default.oneOf(["outline", "ghost"])
};
...
var CButtonToolbar = (0, import_react28.forwardRef)(function(_a3, ref) {
  var children2 = _a3.children, className = _a3.className, rest = __rest(_a3, ["children", "className"]);
  return import_react28.default.createElement("div", __assign({ className: classNames("btn-toolbar", className) }, rest, { ref }), children2);
});
...
var CButtonGroup = (0, import_react29.forwardRef)(function(_a3, ref) {
  var _b3;
  var children2 = _a3.children, className = _a3.className, size = _a3.size, vertical = _a3.vertical, rest = __rest(_a3, ["children", "className", "size", "vertical"]);
  return import_react29.default.createElement("div", __assign({ className: classNames(vertical ? "btn-group-vertical" : "btn-group", (_b3 = {}, _b3["btn-group-".concat(size)] = size, _b3), className) }, rest, { ref }), children2);
});
CButtonGroup.propTypes = {
  children: import_prop_types26.default.node,
  className: import_prop_types26.default.string,
  size: import_prop_types26.default.oneOf(["sm", "lg"]),
...
// node_modules/@coreui/react-pro/dist/esm/components/calendar/CCalendarNavigation.js
var import_react30 = __toESM(require_react());
var CCalendarNavigation = (0, import_react30.forwardRef)(function(_a3, ref) {
  var ariaNavNextMonthLabel = _a3.ariaNavNextMonthLabel, ariaNavNextYearLabel = _a3.ariaNavNextYearLabel, ariaNavPrevMonthLabel = _a3.ariaNavPrevMonthLabel, ariaNavPrevYearLabel = _a3.ariaNavPrevYearLabel, calendarDate = _a3.calendarDate, locale = _a3.locale, navigation = _a3.navigation, navNextDoubleIcon = _a3.navNextDoubleIcon, navNextIcon = _a3.navNextIcon, navPrevDoubleIcon = _a3.navPrevDoubleIcon, navPrevIcon = _a3.navPrevIcon, navYearFirst = _a3.navYearFirst, onMonthClick = _a3.onMonthClick, onNavigationClick = _a3.onNavigationClick, onYearClick = _a3.onYearClick, view = _a3.view;
  return import_react30.default.createElement(
    "div",
    { className: "calendar-nav", ref },
    navigation && import_react30.default.createElement(
      "div",
      { className: "calendar-nav-prev" },
      import_react30.default.createElement(CButton, { color: "transparent", size: "sm", "aria-label": ariaNavPrevYearLabel, onClick: function() {
        return onNavigationClick("prev", true);
      } }, navPrevDoubleIcon !== null && navPrevDoubleIcon !== void 0 ? navPrevDoubleIcon : import_react30.default.createElement("span", { className: "calendar-nav-icon calendar-nav-icon-double-prev" })),
      view === "days" && import_react30.default.createElement(CButton, { color: "transparent", size: "sm", "aria-label": ariaNavPrevMonthLabel, onClick: function() {
        return onNavigationClick("prev");
      } }, navPrevIcon !== null && navPrevIcon !== void 0 ? navPrevIcon : import_react30.default.createElement("span", { className: "calendar-nav-icon calendar-nav-icon-prev" }))
    ),
    import_react30.default.createElement(
      ...
      view === "days" && import_react30.default.createElement(CButton, { color: "transparent", size: "sm", onClick: function() {
        return navigation && onMonthClick();
      } }, calendarDate && calendarDate.toLocaleDateString(locale, { month: "long" })),
      import_react30.default.createElement(CButton, __assign({ color: "transparent", size: "sm", onClick: function() {
    ...
    navigation && import_react30.default.createElement(
      ...
      view === "days" && import_react30.default.createElement(CButton, { color: "transparent", size: "sm", "aria-label": ariaNavNextMonthLabel, onClick: function() {
        return onNavigationClick("next");
      } }, navNextIcon !== null && navNextIcon !== void 0 ? navNextIcon : import_react30.default.createElement("span", { className: "calendar-nav-icon calendar-nav-icon-next" })),
      import_react30.default.createElement(CButton, { color: "transparent", size: "sm", "aria-label": ariaNavNextYearLabel, onClick: function() {
        return onNavigationClick("next", true);
      } }, navNextDoubleIcon !== null && navNextDoubleIcon !== void 0 ? navNextDoubleIcon : import_react30.default.createElement("span", { className: "calendar-nav-icon calendar-nav-icon-double-next" }))
    )
  );
});
...
var convertIsoWeekToDate = function(isoWeek) {
  var _a3 = isoWeek.split(/[Ww]/), year = _a3[0], week = _a3[1];
...
var getYears = function(year, range) {
  ...
  return Array.from({ length: range * 2 }, function(_, i) {
    return year - range + i;
  });
};
...
var getWeekNumber = function(date) {
  ...
  var weekNumber = 1 + Math.round((tempDate.getTime() - week1.getTime()) / 864e5 / 7);
  return weekNumber;
};
...
var isMonthDisabled = function(date, min, max, disabledDates) {
  ...
  var end = max ? Math.min(date.getTime(), max.getTime()) : new Date((/* @__PURE__ */ new Date()).getFullYear(), 11, 31);
...
// node_modules/@coreui/react-pro/dist/esm/components/calendar/CCalendarPanel.js
var import_react31 = __toESM(require_react());
var CCalendarPanel = (0, import_react31.forwardRef)(function(_a3, ref) {
  var calendarDate = _a3.calendarDate, dayFormat = _a3.dayFormat, disabledDates = _a3.disabledDates, endDate = _a3.endDate, firstDayOfWeek = _a3.firstDayOfWeek, hoverDate = _a3.hoverDate, locale = _a3.locale, maxDate = _a3.maxDate, minDate = _a3.minDate, onCalendarClick = _a3.onCalendarClick, onCalendarKeyDown = _a3.onCalendarKeyDown, onCalendarMouseEnter = _a3.onCalendarMouseEnter, onCalendarMouseLeave = _a3.onCalendarMouseLeave, selectAdjacementDays = _a3.selectAdjacementDays, selectEndDate = _a3.selectEndDate, selectionType = _a3.selectionType, showWeekNumber = _a3.showWeekNumber, showAdjacementDays = _a3.showAdjacementDays, startDate = _a3.startDate, view = _a3.view, weekdayFormat = _a3.weekdayFormat, weekNumbersLabel = _a3.weekNumbersLabel;
  var _b3 = (0, import_react31.useState)([]), listOfMonths = _b3[0], setListOfMonths = _b3[1];
  ...
  return import_react31.default.createElement(
    "table",
    { ref },
    view === "days" && import_react31.default.createElement(
      "thead",
      null,
      import_react31.default.createElement(
        "tr",
        null,
        showWeekNumber && import_react31.default.createElement(
          "th",
          { className: "calendar-cell" },
          import_react31.default.createElement("div", { className: "calendar-header-cell-inner" }, weekNumbersLabel)
        ),
        weekDays.map(function(_a4, idx) {
          ...
          return import_react31.default.createElement(
            ...
            import_react31.default.createElement("div", { className: "calendar-header-cell-inner" }, typeof weekdayFormat === "function" ? weekdayFormat(date) : typeof weekdayFormat === "string" ? date.toLocaleDateString(locale, { weekday: weekdayFormat }) : date.toLocaleDateString(locale, { weekday: "long" }).slice(0, weekdayFormat))
          );
        })
      )
    ),
    import_react31.default.createElement(
      ...
      view === "days" && monthDetails.map(function(week, index) {
        ...
        return import_react31.default.createElement(
          ...
          showWeekNumber && import_react31.default.createElement("th", { className: "calendar-cell-week-number" }, week.weekNumber === 0 ? 53 : week.weekNumber),
          week.days.map(function(_a4, idx) {
            ...
            return month === "current" || showAdjacementDays ? import_react31.default.createElement(
              "td",
              ...
              }), (_b4 = {}, _b4[month] = true, _b4.today = month === "current" && isToday(date2), _b4))), key: idx, tabIndex: selectionType === "day" && (month === "current" || selectAdjacementDays) && !isDisabled2 ? 0 : -1, title: date2.toLocaleDateString(locale) }, isSelected2 && { "aria-selected": true }, selectionType === "day" && (month === "current" || selectAdjacementDays) && {
                onBlur: function() {
                  return onCalendarMouseLeave();
                },
                onClick: function() {
              ...
              import_react31.default.createElement("div", { className: "calendar-cell-inner" }, typeof dayFormat === "function" ? dayFormat(date2) : date2.toLocaleDateString(locale, { day: dayFormat }))
            ) : import_react31.default.createElement("td", { key: idx });
          })
        );
      }),
      view === "months" && listOfMonths.map(function(row, index) {
        return import_react31.default.createElement("tr", { key: index }, row.map(function(month, idx) {
          ...
          return import_react31.default.createElement(
            ...
            import_react31.default.createElement("div", { className: "calendar-cell-inner" }, month)
          );
        }));
      }),
      view === "years" && listOfYears.map(function(row, index) {
        return import_react31.default.createElement("tr", { key: index }, row.map(function(year, idx) {
          ...
          return import_react31.default.createElement(
            ...
            import_react31.default.createElement("div", { className: "calendar-cell-inner" }, new Date(year, 0, 1).toLocaleDateString(locale, { year: "numeric" }))
          );
        }));
      })
    )
...
// node_modules/@coreui/react-pro/dist/esm/components/calendar/CCalendar.js
var CCalendar = (0, import_react32.forwardRef)(function(_a3, ref) {
  var _b3;
  ...
  var calendarRef = (0, import_react32.useRef)(null);
  var forkedRef = useForkedRef(ref, calendarRef);
  var _t = (0, import_react32.useState)(null), _calendarDate = _t[0], setCalendarDate = _t[1];
  ...
  var _u = (0, import_react32.useState)(startDate ? convertToDateObject(startDate, selectionType) : null), _startDate = _u[0], setStartDate = _u[1];
  var _v = (0, import_react32.useState)(endDate ? convertToDateObject(endDate, selectionType) : null), _endDate = _v[0], setEndDate = _v[1];
  (0, import_react32.useEffect)(function() {
  ...
  var _w = (0, import_react32.useState)(null), _hoverDate = _w[0], setHoverDate = _w[1];
  var _x = (0, import_react32.useState)(maxDate ? convertToDateObject(maxDate, selectionType) : null), _maxDate = _x[0], setMaxDate = _x[1];
  (0, import_react32.useEffect)(function() {
    setMaxDate(maxDate ? convertToDateObject(maxDate, selectionType) : null);
  }, [maxDate]);
  var _y = (0, import_react32.useState)(minDate ? convertToDateObject(minDate, selectionType) : null), _minDate = _y[0], setMinDate = _y[1];
  (0, import_react32.useEffect)(function() {
    setMinDate(minDate ? convertToDateObject(minDate, selectionType) : null);
  }, [minDate]);
  var _z = (0, import_react32.useState)(selectEndDate), _selectEndDate = _z[0], setSelectEndDate = _z[1];
  (0, import_react32.useEffect)(function() {
    setSelectEndDate(selectEndDate);
  }, [selectEndDate]);
  var _0 = (0, import_react32.useState)("days"), view = _0[0], setView = _0[1];
  var _1 = (0, import_react32.useState)(), focusOn = _1[0], setFocusOn = _1[1];
  (0, import_react32.useEffect)(function() {
    var _a4;
    if (typeof focusOn === "number") {
      var list = getSelectableDates(calendarRef.current);
      (_a4 = list[focusOn]) === null || _a4 === void 0 ? void 0 : _a4.focus();
      setFocusOn(void 0);
    }
  }, [view]);
  ...
  var handleCalendarKeyDown = function(event, date, index) {
    if (event.code === "Space" || event.key === "Enter") {
      event.preventDefault();
      if (view === "months" && selectionType !== "month" || view === "years" && selectionType !== "year") {
        setFocusOn(0);
      }
    ...
    if (event.key === "ArrowRight" || event.key === "ArrowLeft" || event.key === "ArrowUp" || event.key === "ArrowDown") {
      event.preventDefault();
      if (_maxDate && date >= _maxDate && (event.key === "ArrowRight" || event.key === "ArrowDown")) {
        return;
      }
      if (_minDate && date <= _minDate && (event.key === "ArrowLeft" || event.key === "ArrowUp")) {
        return;
      }
      ...
      if (event.key === "ArrowRight" && last || event.key === "ArrowDown" && toBoundary["end"] < gap_1["ArrowDown"] || event.key === "ArrowLeft" && first || event.key === "ArrowUp" && toBoundary["start"] < Math.abs(gap_1["ArrowUp"])) {
        ...
        setTimeout(function() {
          var _a4, _b4;
          var _list = getSelectableDates((_a4 = element_1.parentNode) === null || _a4 === void 0 ? void 0 : _a4.parentNode);
          if (_list.length > 0 && event.key === "ArrowRight") {
            _list[0].focus();
          }
          if (_list.length > 0 && event.key === "ArrowLeft") {
            (_b4 = _list.at(-1)) === null || _b4 === void 0 ? void 0 : _b4.focus();
          }
  ...
  return import_react32.default.createElement("div", { className: classNames("calendars", (_b3 = {}, _b3["select-".concat(selectionType)] = selectionType && view === "days", _b3["show-week-numbers"] = showWeekNumber, _b3), className), ref: forkedRef }, _calendarDate && Array.from({ length: calendars }, function(_, index) {
    var calendarDate2 = getCalendarDate(_calendarDate, index, view);
    return import_react32.default.createElement(
      "div",
      { className: classNames("calendar", view), key: index },
      import_react32.default.createElement(CCalendarNavigation, { ariaNavNextMonthLabel, ariaNavNextYearLabel, ariaNavPrevMonthLabel, ariaNavPrevYearLabel, calendarDate: calendarDate2, locale, navigation, navNextDoubleIcon, navNextIcon, navPrevDoubleIcon, navPrevIcon, navYearFirst, onMonthClick: function() {
        return handleViewChange("months");
      }, onNavigationClick: handleNavigationOnClick, onYearClick: function() {
        return handleViewChange("years");
      }, view }),
      import_react32.default.createElement(CCalendarPanel, { calendarDate: calendarDate2, dayFormat, disabledDates, endDate: _endDate, firstDayOfWeek, hoverDate: _hoverDate, locale, maxDate: _maxDate, minDate: _minDate, onCalendarClick: function(date) {
...
CCalendar.propTypes = {
  ariaNavNextMonthLabel: import_prop_types27.default.string,
  ariaNavNextYearLabel: import_prop_types27.default.string,
  ariaNavPrevMonthLabel: import_prop_types27.default.string,
  ariaNavPrevYearLabel: import_prop_types27.default.string,
  className: import_prop_types27.default.string,
  calendarDate: import_prop_types27.default.oneOfType([import_prop_types27.default.instanceOf(Date), import_prop_types27.default.string]),
  calendars: import_prop_types27.default.number,
  dayFormat: import_prop_types27.default.oneOfType([
    import_prop_types27.default.func,
    import_prop_types27.default.oneOf(["2-digit", "numeric"])
  ]),
  disabledDates: import_prop_types27.default.oneOfType([import_prop_types27.default.instanceOf(Date), import_prop_types27.default.array, import_prop_types27.default.func]),
  endDate: import_prop_types27.default.oneOfType([import_prop_types27.default.instanceOf(Date), import_prop_types27.default.string]),
  firstDayOfWeek: import_prop_types27.default.number,
  locale: import_prop_types27.default.string,
  maxDate: import_prop_types27.default.oneOfType([import_prop_types27.default.instanceOf(Date), import_prop_types27.default.string]),
  minDate: import_prop_types27.default.oneOfType([import_prop_types27.default.instanceOf(Date), import_prop_types27.default.string]),
  navigation: import_prop_types27.default.bool,
  navNextIcon: import_prop_types27.default.node,
  navNextDoubleIcon: import_prop_types27.default.node,
  navPrevIcon: import_prop_types27.default.node,
  navPrevDoubleIcon: import_prop_types27.default.node,
  navYearFirst: import_prop_types27.default.bool,
  range: import_prop_types27.default.bool,
  selectAdjacementDays: import_prop_types27.default.bool,
  selectEndDate: import_prop_types27.default.bool,
  selectionType: import_prop_types27.default.oneOf(["day", "week", "month", "year"]),
  showAdjacementDays: import_prop_types27.default.bool,
  showWeekNumber: import_prop_types27.default.bool,
  startDate: import_prop_types27.default.oneOfType([import_prop_types27.default.instanceOf(Date), import_prop_types27.default.string]),
  weekdayFormat: import_prop_types27.default.oneOfType([
    import_prop_types27.default.func,
    import_prop_types27.default.number,
    import_prop_types27.default.oneOf(["long", "narrow", "short"])
  ]),
  weekNumbersLabel: import_prop_types27.default.string,
  onDateHover: import_prop_types27.default.func,
  onCalendarDateChange: import_prop_types27.default.func,
  onEndDateChange: import_prop_types27.default.func,
  onSelectEndChange: import_prop_types27.default.func,
  onStartDateChange: import_prop_types27.default.func,
  onViewChanged: import_prop_types27.default.func
};
...
var CCallout = (0, import_react33.forwardRef)(function(_a3, ref) {
  var _b3;
  var children2 = _a3.children, className = _a3.className, color = _a3.color, rest = __rest(_a3, ["children", "className", "color"]);
  return import_react33.default.createElement("div", __assign({ className: classNames("callout", (_b3 = {}, _b3["callout-".concat(color)] = color, _b3), className) }, rest, { ref }), children2);
});
CCallout.propTypes = {
...
var CCard = (0, import_react34.forwardRef)(function(_a3, ref) {
  var _b3;
  var children2 = _a3.children, className = _a3.className, color = _a3.color, textBgColor = _a3.textBgColor, textColor = _a3.textColor, rest = __rest(_a3, ["children", "className", "color", "textBgColor", "textColor"]);
  return import_react34.default.createElement("div", __assign({ className: classNames("card", (_b3 = {}, _b3["bg-".concat(color)] = color, _b3["text-".concat(textColor)] = textColor, _b3["text-bg-".concat(textBgColor)] = textBgColor, _b3), className) }, rest, { ref }), children2);
});
CCard.propTypes = {
  children: import_prop_types29.default.node,
  className: import_prop_types29.default.string,
  color: import_prop_types29.default.oneOfType([colorPropType, gradientsPropType]),
  textBgColor: colorPropType,
  textColor: import_prop_types29.default.string
};
...
var CCardBody = (0, import_react35.forwardRef)(function(_a3, ref) {
  var children2 = _a3.children, className = _a3.className, rest = __rest(_a3, ["children", "className"]);
  return import_react35.default.createElement("div", __assign({ className: classNames("card-body", className) }, rest, { ref }), children2);
});
CCardBody.propTypes = {
...
var CCardFooter = (0, import_react36.forwardRef)(function(_a3, ref) {
  var children2 = _a3.children, className = _a3.className, rest = __rest(_a3, ["children", "className"]);
  return import_react36.default.createElement("div", __assign({ className: classNames("card-footer", className) }, rest, { ref }), children2);
});
...
var CCardGroup = (0, import_react37.forwardRef)(function(_a3, ref) {
  var children2 = _a3.children, className = _a3.className, rest = __rest(_a3, ["children", "className"]);
  return import_react37.default.createElement("div", __assign({ className: classNames("card-group", className) }, rest, { ref }), children2);
});
...
var CCardHeader = (0, import_react38.forwardRef)(function(_a3, ref) {
  var children2 = _a3.children, _b3 = _a3.as, Component = _b3 === void 0 ? "div" : _b3, className = _a3.className, rest = __rest(_a3, ["children", "as", "className"]);
  return import_react38.default.createElement(Component, __assign({ className: classNames("card-header", className) }, rest, { ref }), children2);
});
...
var CCardImage = (0, import_react39.forwardRef)(function(_a3, ref) {
  var children2 = _a3.children, _b3 = _a3.as, Component = _b3 === void 0 ? "img" : _b3, className = _a3.className, orientation = _a3.orientation, rest = __rest(_a3, ["children", "as", "className", "orientation"]);
  return import_react39.default.createElement(Component, __assign({ className: classNames(orientation ? "card-img-".concat(orientation) : "card-img", className) }, rest, { ref }), children2);
});
CCardImage.propTypes = {
  as: import_prop_types34.default.elementType,
  children: import_prop_types34.default.node,
  className: import_prop_types34.default.string,
  orientation: import_prop_types34.default.oneOf(["top", "bottom"])
};
...
var CCardImageOverlay = (0, import_react40.forwardRef)(function(_a3, ref) {
  var children2 = _a3.children, className = _a3.className, rest = __rest(_a3, ["children", "className"]);
  return import_react40.default.createElement("div", __assign({ className: classNames("card-img-overlay", className) }, rest, { ref }), children2);
});
...
var CCardLink = (0, import_react41.forwardRef)(function(_a3, ref) {
  var children2 = _a3.children, className = _a3.className, rest = __rest(_a3, ["children", "className"]);
  return import_react41.default.createElement(CLink, __assign({ className: classNames("card-link", className) }, rest, { ref }), children2);
});
CCardLink.propTypes = {
...
var CCardSubtitle = (0, import_react42.forwardRef)(function(_a3, ref) {
  var children2 = _a3.children, _b3 = _a3.as, Component = _b3 === void 0 ? "h6" : _b3, className = _a3.className, rest = __rest(_a3, ["children", "as", "className"]);
  return import_react42.default.createElement(Component, __assign({ className: classNames("card-subtitle", className) }, rest, { ref }), children2);
});
...
var CCardText = (0, import_react43.forwardRef)(function(_a3, ref) {
  var children2 = _a3.children, _b3 = _a3.as, Component = _b3 === void 0 ? "p" : _b3, className = _a3.className, rest = __rest(_a3, ["children", "as", "className"]);
  return import_react43.default.createElement(Component, __assign({ className: classNames("card-text", className) }, rest, { ref }), children2);
});
CCardText.propTypes = {
...
var CCardTitle = (0, import_react44.forwardRef)(function(_a3, ref) {
  var children2 = _a3.children, _b3 = _a3.as, Component = _b3 === void 0 ? "h5" : _b3, className = _a3.className, rest = __rest(_a3, ["children", "as", "className"]);
  return import_react44.default.createElement(Component, __assign({ className: classNames("card-title", className) }, rest, { ref }), children2);
});
...
// node_modules/@coreui/react-pro/dist/esm/components/carousel/CCarouselContext.js
var import_react45 = __toESM(require_react());
var CCarouselContext = (0, import_react45.createContext)({});

// node_modules/@coreui/react-pro/dist/esm/components/carousel/CCarousel.js
var CCarousel = (0, import_react46.forwardRef)(function(_a3, ref) {
  var children2 = _a3.children, _b3 = _a3.activeIndex, activeIndex = _b3 === void 0 ? 0 : _b3, className = _a3.className, controls = _a3.controls, dark = _a3.dark, indicators = _a3.indicators, _c3 = _a3.interval, interval = _c3 === void 0 ? 5e3 : _c3, onSlid = _a3.onSlid, onSlide = _a3.onSlide, _d3 = _a3.pause, pause = _d3 === void 0 ? "hover" : _d3, _e3 = _a3.touch, touch = _e3 === void 0 ? true : _e3, transition = _a3.transition, _f3 = _a3.wrap, wrap = _f3 === void 0 ? true : _f3, rest = __rest(_a3, ["children", "activeIndex", "className", "controls", "dark", "indicators", "interval", "onSlid", "onSlide", "pause", "touch", "transition", "wrap"]);
  var carouselRef = (0, import_react46.useRef)(null);
  var forkedRef = useForkedRef(ref, carouselRef);
  var data = (0, import_react46.useRef)({}).current;
  var _g2 = (0, import_react46.useState)(activeIndex), active = _g2[0], setActive = _g2[1];
  var _h2 = (0, import_react46.useState)(false), animating = _h2[0], setAnimating = _h2[1];
  var _j2 = (0, import_react46.useState)(), customInterval = _j2[0], setCustomInterval = _j2[1];
  var _k2 = (0, import_react46.useState)("next"), direction = _k2[0], setDirection = _k2[1];
  var _l2 = (0, import_react46.useState)(0), itemsNumber = _l2[0], setItemsNumber = _l2[1];
  var _m2 = (0, import_react46.useState)(null), touchPosition = _m2[0], setTouchPosition = _m2[1];
  var _o = (0, import_react46.useState)(), visible = _o[0], setVisible = _o[1];
  (0, import_react46.useEffect)(function() {
    setItemsNumber(import_react46.Children.toArray(children2).length);
  });
  (0, import_react46.useEffect)(function() {
    visible && cycle();
  }, [visible]);
  ...
  return import_react46.default.createElement(
    ...
    import_react46.default.createElement(
      ...
      indicators && import_react46.default.createElement("div", { className: "carousel-indicators" }, Array.from({ length: itemsNumber }, function(_, i) {
        return i;
      }).map(function(index) {
        return import_react46.default.createElement("button", __assign({ key: "indicator".concat(index), onClick: function() {
          !animating && handleIndicatorClick(index);
        }, className: classNames({
          active: active === index
        }), "data-coreui-target": "" }, active === index && { "aria-current": true }, { "aria-label": "Slide ".concat(index + 1) }));
      })),
      import_react46.default.createElement("div", { className: "carousel-inner" }, import_react46.Children.map(children2, function(child, index) {
      ...
      controls && import_react46.default.createElement(
        ...
        import_react46.default.createElement(
          ...
          import_react46.default.createElement("span", { className: "carousel-control-prev-icon", "aria-label": "prev" })
        ),
        import_react46.default.createElement(
          "button",
          ...
          import_react46.default.createElement("span", { className: "carousel-control-next-icon", "aria-label": "next" })
        )
      )
    )
  );
...
CCarousel.propTypes = {
  ...
  interval: import_prop_types40.default.oneOfType([import_prop_types40.default.bool, import_prop_types40.default.number]),
  onSlid: import_prop_types40.default.func,
  onSlide: import_prop_types40.default.func,
  pause: import_prop_types40.default.oneOf([false, "hover"]),
  touch: import_prop_types40.default.bool,
  transition: import_prop_types40.default.oneOf(["slide", "crossfade"]),
  wrap: import_prop_types40.default.bool
};
...
var CCarouselCaption = (0, import_react47.forwardRef)(function(_a3, ref) {
  var className = _a3.className, rest = __rest(_a3, ["className"]);
  return import_react47.default.createElement("div", __assign({ className: classNames("carousel-caption", className) }, rest, { ref }));
});
...
init_lib();
var CCarouselItem = (0, import_react48.forwardRef)(function(_a3, ref) {
  var children2 = _a3.children, className = _a3.className, active = _a3.active, direction = _a3.direction, _b3 = _a3.interval, interval = _b3 === void 0 ? false : _b3, rest = __rest(_a3, ["children", "className", "active", "direction", "interval"]);
  var _c3 = (0, import_react48.useContext)(CCarouselContext), setAnimating = _c3.setAnimating, setCustomInterval = _c3.setCustomInterval;
  var carouselItemRef = (0, import_react48.useRef)(null);
  var forkedRef = useForkedRef(ref, carouselItemRef);
  var prevActive = (0, import_react48.useRef)(void 0);
  var _d3 = (0, import_react48.useState)(), directionClassName = _d3[0], setDirectionClassName = _d3[1];
  var _e3 = (0, import_react48.useState)(), orderClassName = _e3[0], setOrderClassName = _e3[1];
  var _f3 = (0, import_react48.useState)(active && "active"), activeClassName = _f3[0], setActiveClassName = _f3[1];
  var _g2 = (0, import_react48.useState)(0), count = _g2[0], setCount = _g2[1];
  ...
  return import_react48.default.createElement("div", __assign({ className: classNames("carousel-item", activeClassName, directionClassName, orderClassName, className), ref: forkedRef }, rest), children2);
});
CCarouselItem.propTypes = {
  active: import_prop_types42.default.bool,
  children: import_prop_types42.default.node,
  className: import_prop_types42.default.string,
  direction: import_prop_types42.default.string,
  interval: import_prop_types42.default.oneOfType([import_prop_types42.default.bool, import_prop_types42.default.number])
};
...
var CConditionalPortal = function(_a3) {
  var children2 = _a3.children, container = _a3.container, portal = _a3.portal;
  var _b3 = (0, import_react49.useState)(null), _container = _b3[0], setContainer = _b3[1];
  (0, import_react49.useEffect)(function() {
    portal && setContainer(getContainer(container) || document.body);
  }, [container, portal]);
  return typeof window !== "undefined" && portal && _container ? (0, import_react_dom3.createPortal)(children2, _container) : import_react49.default.createElement(import_react49.default.Fragment, null, children2);
};
CConditionalPortal.propTypes = {
  children: import_prop_types43.default.node,
  container: import_prop_types43.default.any,
  // HTMLElement
  portal: import_prop_types43.default.bool.isRequired
};
...
function requireUaParser_min() {
  if (hasRequiredUaParser_min) return uaParser_min.exports;
...
function requireLib() {
  ...
  var React$1 = import_react50.default;
  ...
  var AndroidView = function AndroidView2(_ref) {
    ...
    return isAndroid ? renderWithFragment ? React__default.createElement(React$1.Fragment, null, children2) : React__default.createElement("div", props, children2) : null;
  };
  var BrowserView = function BrowserView2(_ref2) {
    ...
    return isBrowser ? renderWithFragment ? React__default.createElement(React$1.Fragment, null, children2) : React__default.createElement("div", props, children2) : null;
  };
  var IEView = function IEView2(_ref3) {
    ...
    return isIE ? renderWithFragment ? React__default.createElement(React$1.Fragment, null, children2) : React__default.createElement("div", props, children2) : null;
  };
  var IOSView = function IOSView2(_ref4) {
    ...
    return isIOS ? renderWithFragment ? React__default.createElement(React$1.Fragment, null, children2) : React__default.createElement("div", props, children2) : null;
  };
  var MobileView = function MobileView2(_ref5) {
    ...
    return isMobile ? renderWithFragment ? React__default.createElement(React$1.Fragment, null, children2) : React__default.createElement("div", props, children2) : null;
  };
  var TabletView = function TabletView2(_ref6) {
    ...
    return isTablet ? renderWithFragment ? React__default.createElement(React$1.Fragment, null, children2) : React__default.createElement("div", props, children2) : null;
  };
  var WinPhoneView = function WinPhoneView2(_ref7) {
    ...
    return isWinPhone ? renderWithFragment ? React__default.createElement(React$1.Fragment, null, children2) : React__default.createElement("div", props, children2) : null;
  };
  var MobileOnlyView = function MobileOnlyView2(_ref8) {
    var renderWithFragment = _ref8.renderWithFragment, children2 = _ref8.children;
    _ref8.viewClassName;
    _ref8.style;
    var props = _objectWithoutProperties(_ref8, ["renderWithFragment", "children", "viewClassName", "style"]);
    return isMobileOnly ? renderWithFragment ? React__default.createElement(React$1.Fragment, null, children2) : React__default.createElement("div", props, children2) : null;
  };
  var SmartTVView = function SmartTVView2(_ref9) {
    ...
    return isSmartTV ? renderWithFragment ? React__default.createElement(React$1.Fragment, null, children2) : React__default.createElement("div", props, children2) : null;
  };
  var ConsoleView = function ConsoleView2(_ref10) {
    ...
    return isConsole ? renderWithFragment ? React__default.createElement(React$1.Fragment, null, children2) : React__default.createElement("div", props, children2) : null;
  };
  var WearableView = function WearableView2(_ref11) {
    ...
    return isWearable ? renderWithFragment ? React__default.createElement(React$1.Fragment, null, children2) : React__default.createElement("div", props, children2) : null;
  };
  var CustomView = function CustomView2(_ref12) {
    var renderWithFragment = _ref12.renderWithFragment, children2 = _ref12.children;
    ...
    return condition ? renderWithFragment ? React__default.createElement(React$1.Fragment, null, children2) : React__default.createElement("div", props, children2) : null;
  };
...
var CFormFeedback = (0, import_react51.forwardRef)(function(_a3, ref) {
  var _b3;
  var children2 = _a3.children, _c3 = _a3.as, Component = _c3 === void 0 ? "div" : _c3, className = _a3.className, invalid = _a3.invalid, tooltip = _a3.tooltip, valid = _a3.valid, rest = __rest(_a3, ["children", "as", "className", "invalid", "tooltip", "valid"]);
  return import_react51.default.createElement(Component, __assign({ className: classNames((_b3 = {}, _b3["invalid-".concat(tooltip ? "tooltip" : "feedback")] = invalid, _b3["valid-".concat(tooltip ? "tooltip" : "feedback")] = valid, _b3), className) }, rest, { ref }), children2);
});
CFormFeedback.propTypes = {
  ...
  tooltip: import_prop_types44.default.bool,
...
var CFormControlValidation = function(_a3) {
  ...
  return import_react52.default.createElement(
    ...
    null,
    feedback && (valid || invalid) && import_react52.default.createElement(CFormFeedback, __assign({}, invalid && { id: describedby }, { invalid, tooltip: tooltipFeedback, valid }), feedback),
    feedbackInvalid && import_react52.default.createElement(CFormFeedback, { id: describedby, invalid: true, tooltip: tooltipFeedback }, feedbackInvalid),
    feedbackValid && import_react52.default.createElement(CFormFeedback, { valid: true, tooltip: tooltipFeedback }, feedbackValid)
  );
};
CFormControlValidation.propTypes = {
  describedby: import_prop_types45.default.string,
  feedback: import_prop_types45.default.oneOfType([import_prop_types45.default.node, import_prop_types45.default.string]),
  feedbackValid: import_prop_types45.default.oneOfType([import_prop_types45.default.node, import_prop_types45.default.string]),
  feedbackInvalid: import_prop_types45.default.oneOfType([import_prop_types45.default.node, import_prop_types45.default.string]),
  invalid: import_prop_types45.default.bool,
  tooltipFeedback: import_prop_types45.default.bool,
...
var CFormFloating = (0, import_react53.forwardRef)(function(_a3, ref) {
  var children2 = _a3.children, className = _a3.className, rest = __rest(_a3, ["children", "className"]);
  return import_react53.default.createElement("div", __assign({ className: classNames("form-floating", className) }, rest, { ref }), children2);
});
...
var CFormLabel = (0, import_react54.forwardRef)(function(_a3, ref) {
  var children2 = _a3.children, className = _a3.className, customClassName = _a3.customClassName, rest = __rest(_a3, ["children", "className", "customClassName"]);
  return import_react54.default.createElement("label", __assign({ className: customClassName !== null && customClassName !== void 0 ? customClassName : classNames("form-label", className) }, rest, { ref }), children2);
});
CFormLabel.propTypes = {
  children: import_prop_types47.default.node,
  className: import_prop_types47.default.string,
  customClassName: import_prop_types47.default.string
};
...
var CFormText = (0, import_react55.forwardRef)(function(_a3, ref) {
  var children2 = _a3.children, _b3 = _a3.as, Component = _b3 === void 0 ? "div" : _b3, className = _a3.className, rest = __rest(_a3, ["children", "as", "className"]);
  return import_react55.default.createElement(Component, __assign({ className: classNames("form-text", className) }, rest, { ref }), children2);
});
CFormText.propTypes = {
...
var CFormControlWrapper = function(_a3) {
  var children2 = _a3.children, describedby = _a3.describedby, feedback = _a3.feedback, feedbackInvalid = _a3.feedbackInvalid, feedbackValid = _a3.feedbackValid, floatingClassName = _a3.floatingClassName, floatingLabel = _a3.floatingLabel, id = _a3.id, invalid = _a3.invalid, label = _a3.label, text = _a3.text, tooltipFeedback = _a3.tooltipFeedback, valid = _a3.valid;
...
CFormControlWrapper.propTypes = __assign({ children: import_prop_types49.default.node, floatingClassName: import_prop_types49.default.string, floatingLabel: import_prop_types49.default.oneOfType([import_prop_types49.default.node, import_prop_types49.default.string]), label: import_prop_types49.default.oneOfType([import_prop_types49.default.node, import_prop_types49.default.string]), text: import_prop_types49.default.oneOfType([import_prop_types49.default.node, import_prop_types49.default.string]) }, CFormControlValidation.propTypes);
...
var usePopper = function() {
  var _popper = (0, import_react57.useRef)(void 0);
  var el = (0, import_react57.useRef)(null);
...
var CPicker = (0, import_react58.forwardRef)(function(_a3, ref) {
  ...
  switch (container) {
    case "inline": {
      return import_react58.default.createElement("div", { className: classNames("picker", className), ref: pickerForkedRef }, children2);
    }
    default: {
      return import_react58.default.createElement(
        ...
        toggler && import_react58.default.isValidElement(toggler) && import_react58.default.cloneElement(toggler, {
          ref: togglerRef
        }),
...
CPicker.propTypes = {
  ...
  container: import_prop_types50.default.oneOf(["dropdown", "inline"]),
  disabled: import_prop_types50.default.bool,
  dropdownClassNames: import_prop_types50.default.string,
  footer: import_prop_types50.default.bool,
  footerContent: import_prop_types50.default.node,
  onHide: import_prop_types50.default.func,
  onShow: import_prop_types50.default.func,
  portal: import_prop_types50.default.bool,
  toggler: import_prop_types50.default.node,
  visible: import_prop_types50.default.bool
};
...
var useIsVisible = function(ref) {
  var _a3 = (0, import_react59.useState)(false), isIntersecting = _a3[0], setIntersecting = _a3[1];
...
// node_modules/@coreui/react-pro/dist/esm/components/time-picker/CTimePickerRollCol.js
var CTimePickerRollCol = (0, import_react60.forwardRef)(function(_a3, ref) {
  var elements = _a3.elements, onClick = _a3.onClick, selected = _a3.selected;
  var init = (0, import_react60.useRef)(true);
  var colRef = (0, import_react60.useRef)(null);
  ...
  return import_react60.default.createElement("div", { className: "time-picker-roll-col", ref: forkedRef }, elements.map(function(element, index) {
    return import_react60.default.createElement("div", { className: classNames("time-picker-roll-cell", {
...
CTimePickerRollCol.propTypes = {
  elements: import_prop_types51.default.array.isRequired,
  onClick: import_prop_types51.default.func,
  selected: import_prop_types51.default.oneOfType([import_prop_types51.default.number, import_prop_types51.default.string])
};
...
var formatTimePartials = function(values2, locale, partial) {
...
var useDebouncedCallback = function(callback, delay) {
  var timeout2 = (0, import_react61.useRef)();
...
var _e;
var _f;
var CTimePicker = (0, import_react62.forwardRef)(function(_a3, ref) {
  var _b3, _c3;
  ...
  var formRef = (0, import_react62.useRef)(null);
  var inputRef = (0, import_react62.useRef)(null);
  var _y = (0, import_react62.useState)(convertTimeToDate(time)), date = _y[0], setDate = _y[1];
  var _z = (0, import_react62.useState)(null), initialDate = _z[0], setInitialDate = _z[1];
  var _0 = (0, import_react62.useState)(valid !== null && valid !== void 0 ? valid : invalid === true ? false : void 0), isValid = _0[0], setIsValid = _0[1];
  var _1 = (0, import_react62.useState)(date ? getAmPm(new Date(date), locale) : "am"), _ampm = _1[0], setAmPm = _1[1];
  var _2 = (0, import_react62.useState)(visible), _visible = _2[0], setVisible = _2[1];
  var _3 = (0, import_react62.useState)({
    listOfHours: [],
    listOfMinutes: [],
    listOfSeconds: [],
    hour12: false
  ...
  var InputGroup = function() {
    return import_react62.default.createElement(
      ...
      import_react62.default.createElement("input", { autoComplete: "off", className: "time-picker-input", disabled, id, name, onChange: function(event) {
        return handleOnChange(event.target.value);
      }, placeholder, readOnly: inputReadOnly, required, ref: inputRef }),
      indicator && (typeof indicator === "boolean" ? import_react62.default.createElement("div", __assign({ className: "time-picker-indicator" }, disabled !== false && {
        onClick: function() {
      ...
      cleaner && date && (typeof cleaner === "boolean" ? import_react62.default.createElement("div", { className: "time-picker-cleaner", onClick: function(event) {
        return handleClear(event);
      } }) : import_react62.default.isValidElement(cleaner) && import_react62.default.cloneElement(cleaner, {
        onClick: function(event) {
          return handleClear(event);
        }
      }))
  ...
  var TimePickerSelect = function() {
    return import_react62.default.createElement(
      ...
      null,
      import_react62.default.createElement("span", { className: "time-picker-inline-icon" }),
      import_react62.default.createElement("select", { className: "time-picker-inline-select", disabled, onChange: function(event) {
        ...
        return import_react62.default.createElement("option", { value: option.value.toString(), key: index }, option.label);
      })),
      minutes && import_react62.default.createElement(
        import_react62.default.Fragment,
        null,
        import_react62.default.createElement(import_react62.default.Fragment, null, ":"),
        import_react62.default.createElement("select", { className: "time-picker-inline-select", disabled, onChange: function(event) {
      ...
      seconds && import_react62.default.createElement(
        import_react62.default.Fragment,
        null,
        import_react62.default.createElement(import_react62.default.Fragment, null, ":"),
        import_react62.default.createElement("select", { className: "time-picker-inline-select", disabled, onChange: function(event) {
      ...
      localizedTimePartials && localizedTimePartials.hour12 && import_react62.default.createElement(
        "select",
        { className: "time-picker-inline-select", disabled, onChange: function(event) {
          return handleTimeChange("toggle", event.target.value);
        }, value: _ampm },
        import_react62.default.createElement("option", { value: "am" }, "AM"),
        import_react62.default.createElement("option", { value: "pm" }, "PM")
      )
    );
  };
  return import_react62.default.createElement(
    ...
    import_react62.default.createElement(
      CPicker,
      __assign({ className: classNames("time-picker", (_b3 = {}, _b3["time-picker-".concat(size)] = size, _b3.disabled = disabled, _b3["is-invalid"] = isValid === false ? true : false, _b3["is-valid"] = isValid, _b3), className), container, disabled, dropdownClassNames: "time-picker-dropdown", footer, footerContent: import_react62.default.createElement(
        "div",
        { className: "time-picker-footer" },
        cancelButton && import_react62.default.createElement(CButton, { color: cancelButtonColor, size: cancelButtonSize, variant: cancelButtonVariant, onClick: function() {
          if (initialDate) {
            setDate(new Date(initialDate));
          }
          setVisible(false);
        } }, cancelButton),
        confirmButton && import_react62.default.createElement(CButton, { color: confirmButtonColor, size: confirmButtonSize, variant: confirmButtonVariant, onClick: function() {
          setVisible(false);
        } }, confirmButton)
      ), onHide: function() {
        setVisible(false);
      ...
      import_react62.default.createElement("div", { className: classNames("time-picker-body", (_c3 = {}, _c3["time-picker-roll"] = variant === "roll", _c3)) }, variant === "select" ? import_react62.default.createElement(TimePickerSelect, null) : import_react62.default.createElement(
        import_react62.default.Fragment,
        null,
        import_react62.default.createElement(CTimePickerRollCol, { elements: localizedTimePartials && localizedTimePartials.listOfHours, onClick: function(index) {
          return handleTimeChange("hours", index.toString());
        }, selected: getSelectedHour(date, locale, ampm) }),
        minutes && import_react62.default.createElement(CTimePickerRollCol, { elements: localizedTimePartials && localizedTimePartials.listOfMinutes, onClick: function(index) {
          return handleTimeChange("minutes", index.toString());
        }, selected: getSelectedMinutes(date) }),
        seconds && import_react62.default.createElement(CTimePickerRollCol, { elements: localizedTimePartials && localizedTimePartials.listOfSeconds, onClick: function(index) {
          return handleTimeChange("seconds", index.toString());
        }, selected: getSelectedSeconds(date) }),
        localizedTimePartials && localizedTimePartials.hour12 && import_react62.default.createElement(CTimePickerRollCol, { elements: [
          { value: "am", label: "AM" },
          { value: "pm", label: "PM" }
...
CTimePicker.propTypes = __assign(__assign(__assign({}, CFormControlWrapper.propTypes), CPicker.propTypes), { ampm: import_prop_types52.default.oneOfType([import_prop_types52.default.oneOf(["auto"]), import_prop_types52.default.bool]), cancelButton: import_prop_types52.default.oneOfType([import_prop_types52.default.bool, import_prop_types52.default.node]), cancelButtonColor: (_a = CButton.propTypes) === null || _a === void 0 ? void 0 : _a.color, cancelButtonSize: (_b = CButton.propTypes) === null || _b === void 0 ? void 0 : _b.size, cancelButtonVariant: (_c = CButton.propTypes) === null || _c === void 0 ? void 0 : _c.variant, className: import_prop_types52.default.string, confirmButton: import_prop_types52.default.oneOfType([import_prop_types52.default.bool, import_prop_types52.default.node]), confirmButtonColor: (_d = CButton.propTypes) === null || _d === void 0 ? void 0 : _d.color, confirmButtonSize: (_e = CButton.propTypes) === null || _e === void 0 ? void 0 : _e.size, confirmButtonVariant: (_f = CButton.propTypes) === null || _f === void 0 ? void 0 : _f.variant, hours: import_prop_types52.default.oneOfType([import_prop_types52.default.arrayOf(import_prop_types52.default.number.isRequired), import_prop_types52.default.func]), id: import_prop_types52.default.string, inputOnChangeDelay: import_prop_types52.default.number, locale: import_prop_types52.default.string, minutes: import_prop_types52.default.oneOfType([
  import_prop_types52.default.bool,
  import_prop_types52.default.arrayOf(import_prop_types52.default.number.isRequired),
  import_prop_types52.default.func
]), name: import_prop_types52.default.string, onTimeChange: import_prop_types52.default.func, required: import_prop_types52.default.bool, seconds: import_prop_types52.default.oneOfType([
  import_prop_types52.default.bool,
  import_prop_types52.default.arrayOf(import_prop_types52.default.number.isRequired),
  import_prop_types52.default.func
]), time: import_prop_types52.default.oneOfType([import_prop_types52.default.instanceOf(Date), import_prop_types52.default.string]), variant: import_prop_types52.default.oneOf(["roll", "select"]) });
...
var CDateRangePicker = (0, import_react63.forwardRef)(function(_a3, ref) {
  ...
  var InputGroup = function() {
    return import_react63.default.createElement(
      ...
      import_react63.default.createElement("input", __assign({ autoComplete: "off", className: classNames("date-picker-input", {
      ...
      range && separator !== false && import_react63.default.createElement("div", { className: "date-picker-separator" }),
      range && import_react63.default.createElement("input", __assign({ autoComplete: "off", className: classNames("date-picker-input", {
      ...
      indicator && (typeof indicator === "boolean" ? import_react63.default.createElement("div", __assign({ className: "date-picker-indicator" }, disabled !== false && {
        onClick: function() {
          return setVisible(!_visible);
        },
        onKeyDown: function(event) {
      ...
      cleaner && (_startDate || _endDate) && (typeof cleaner === "boolean" ? import_react63.default.createElement("div", { className: "date-picker-cleaner", onClick: function(event) {
        return handleClear(event);
      } }) : import_react63.default.isValidElement(cleaner) && import_react63.default.cloneElement(cleaner, {
        onClick: function(event) {
          return handleClear(event);
        }
      }))
  ...
  return import_react63.default.createElement(
    ...
    import_react63.default.createElement(
      CPicker,
      __assign({ className: classNames("date-picker", (_b3 = {}, _b3["date-picker-".concat(size)] = size, _b3.disabled = disabled, _b3["is-invalid"] = isValid === false ? true : false, _b3["is-valid"] = isValid, _b3), className), disabled, dropdownClassNames: "date-picker-dropdown", footer: footer || timepicker, footerContent: import_react63.default.createElement(
        "div",
        { className: "date-picker-footer" },
        todayButton && import_react63.default.createElement(CButton, { className: "me-auto", color: todayButtonColor, size: todayButtonSize, variant: todayButtonVariant, onClick: function() {
          var date = /* @__PURE__ */ new Date();
          handleStartDateChange(date);
          if (range)
            handleEndDateChange(date);
        ...
        cancelButton && import_react63.default.createElement(CButton, { color: cancelButtonColor, size: cancelButtonSize, variant: cancelButtonVariant, onClick: function() {
          handleStartDateChange(initialStartDate);
          if (range)
            handleEndDateChange(initialEndDate);
          setVisible(false);
        } }, cancelButton),
        confirmButton && import_react63.default.createElement(CButton, { color: confirmButtonColor, size: confirmButtonSize, variant: confirmButtonVariant, onClick: function() {
          setVisible(false);
        } }, confirmButton)
      ...
      import_react63.default.createElement(
        ...
        ranges && import_react63.default.createElement("div", { className: "date-picker-ranges" }, Object.keys(ranges).map(function(key, index) {
          return import_react63.default.createElement(CButton, { color: rangesButtonsColor, key: index, onClick: function() {
        ...
        timepicker && import_react63.default.createElement("div", { className: "date-picker-timepickers" }, libExports.isMobile && range || range && calendars === 1 ? import_react63.default.createElement(
          import_react63.default.Fragment,
          null,
          import_react63.default.createElement(CTimePicker, { container: "inline", disabled: _startDate === null ? true : false, locale, onTimeChange: function(_, __, date) {
            return date && handleStartDateChange(date);
          }, time: _startDate && new Date(_startDate), variant: "select" }),
          import_react63.default.createElement(CTimePicker, { container: "inline", disabled: _endDate === null ? true : false, locale, onTimeChange: function(_, __, date) {
          ...
          return import_react63.default.createElement(CTimePicker, { container: "inline", disabled: index === 0 ? _startDate === null ? true : false : _endDate === null ? true : false, key: index, locale, onTimeChange: function(_14, __, date) {
...
CDateRangePicker.propTypes = __assign(__assign(__assign(__assign({}, CCalendar.propTypes), CFormControlWrapper.propTypes), CPicker.propTypes), { cancelButton: import_prop_types53.default.oneOfType([import_prop_types53.default.bool, import_prop_types53.default.node]), cancelButtonColor: (_a2 = CButton.propTypes) === null || _a2 === void 0 ? void 0 : _a2.color, cancelButtonSize: (_b2 = CButton.propTypes) === null || _b2 === void 0 ? void 0 : _b2.size, cancelButtonVariant: (_c2 = CButton.propTypes) === null || _c2 === void 0 ? void 0 : _c2.variant, calendars: import_prop_types53.default.number, className: import_prop_types53.default.string, cleaner: import_prop_types53.default.bool, closeOnSelect: import_prop_types53.default.bool, confirmButton: import_prop_types53.default.oneOfType([import_prop_types53.default.bool, import_prop_types53.default.node]), confirmButtonColor: (_d2 = CButton.propTypes) === null || _d2 === void 0 ? void 0 : _d2.color, confirmButtonSize: (_e2 = CButton.propTypes) === null || _e2 === void 0 ? void 0 : _e2.size, confirmButtonVariant: (_f2 = CButton.propTypes) === null || _f2 === void 0 ? void 0 : _f2.variant, id: import_prop_types53.default.oneOfType([import_prop_types53.default.string, import_prop_types53.default.any]), indicator: import_prop_types53.default.oneOfType([import_prop_types53.default.bool, import_prop_types53.default.node]), inputDateFormat: import_prop_types53.default.func, inputDateParse: import_prop_types53.default.func, inputOnChangeDelay: import_prop_types53.default.number, inputReadOnly: import_prop_types53.default.bool, name: import_prop_types53.default.oneOfType([import_prop_types53.default.string, import_prop_types53.default.any]), placeholder: import_prop_types53.default.oneOfType([
  import_prop_types53.default.string,
  import_prop_types53.default.arrayOf(import_prop_types53.default.string.isRequired)
]), range: import_prop_types53.default.bool, ranges: import_prop_types53.default.object, rangesButtonsColor: (_g = CButton.propTypes) === null || _g === void 0 ? void 0 : _g.color, rangesButtonsSize: (_h = CButton.propTypes) === null || _h === void 0 ? void 0 : _h.size, rangesButtonsVariant: (_j = CButton.propTypes) === null || _j === void 0 ? void 0 : _j.variant, required: import_prop_types53.default.bool, separator: import_prop_types53.default.oneOfType([import_prop_types53.default.bool, import_prop_types53.default.node]), size: import_prop_types53.default.oneOf(["sm", "lg"]), timepicker: import_prop_types53.default.bool, todayButton: import_prop_types53.default.oneOfType([import_prop_types53.default.bool, import_prop_types53.default.node]), todayButtonColor: (_k = CButton.propTypes) === null || _k === void 0 ? void 0 : _k.color, todayButtonSize: (_l = CButton.propTypes) === null || _l === void 0 ? void 0 : _l.size, todayButtonVariant: (_m = CButton.propTypes) === null || _m === void 0 ? void 0 : _m.variant });

// node_modules/@coreui/react-pro/dist/esm/components/date-picker/CDatePicker.js
var CDatePicker = (0, import_react64.forwardRef)(function(_a3, ref) {
  ...
  return import_react64.default.createElement(CDateRangePicker, __assign({ calendars: 1, id, name, startDate: date, onStartDateChange: onDateChange, placeholder, range: false, ref }, rest));
});
CDatePicker.displayName = "CDatePicker";
CDatePicker.propTypes = __assign(__assign({}, CDateRangePicker.propTypes), { date: import_prop_types54.default.oneOfType([import_prop_types54.default.instanceOf(Date), import_prop_types54.default.string]), id: import_prop_types54.default.string, name: import_prop_types54.default.string, onDateChange: import_prop_types54.default.func });

// node_modules/@coreui/react-pro/dist/esm/components/dropdown/CDropdown.js
var import_react66 = __toESM(require_react());
var import_prop_types55 = __toESM(require_prop_types());

// node_modules/@coreui/react-pro/dist/esm/components/dropdown/CDropdownContext.js
var import_react65 = __toESM(require_react());
var CDropdownContext = (0, import_react65.createContext)({});
...
// node_modules/@coreui/react-pro/dist/esm/components/dropdown/CDropdown.js
var CDropdown = (0, import_react66.forwardRef)(function(_a3, ref) {
  var _b3;
  var children2 = _a3.children, alignment = _a3.alignment, _c3 = _a3.as, as = _c3 === void 0 ? "div" : _c3, _d3 = _a3.autoClose, autoClose = _d3 === void 0 ? true : _d3, className = _a3.className, container = _a3.container, dark = _a3.dark, direction = _a3.direction, _e3 = _a3.offset, offset = _e3 === void 0 ? [0, 2] : _e3, onHide = _a3.onHide, onShow = _a3.onShow, _f3 = _a3.placement, placement = _f3 === void 0 ? "bottom-start" : _f3, _g2 = _a3.popper, popper = _g2 === void 0 ? true : _g2, popperConfig = _a3.popperConfig, _h2 = _a3.portal, portal = _h2 === void 0 ? false : _h2, _j2 = _a3.variant, variant = _j2 === void 0 ? "btn-group" : _j2, _k2 = _a3.visible, visible = _k2 === void 0 ? false : _k2, rest = __rest(_a3, ["children", "alignment", "as", "autoClose", "className", "container", "dark", "direction", "offset", "onHide", "onShow", "placement", "popper", "popperConfig", "portal", "variant", "visible"]);
  var dropdownRef = (0, import_react66.useRef)(null);
  var dropdownToggleRef = (0, import_react66.useRef)(null);
  var dropdownMenuRef = (0, import_react66.useRef)(null);
  var forkedRef = useForkedRef(ref, dropdownRef);
  var _l2 = (0, import_react66.useState)(visible), _visible = _l2[0], setVisible = _l2[1];
  ...
  return import_react66.default.createElement(CDropdownContext.Provider, { value: contextValues }, variant === "input-group" ? import_react66.default.createElement(import_react66.default.Fragment, null, children2) : import_react66.default.createElement(Component, __assign({ className: classNames(variant === "nav-item" ? "nav-item dropdown" : variant, (_b3 = {
    "dropdown-center": direction === "center",
    "dropup dropup-center": direction === "dropup-center"
  }, _b3["".concat(direction)] = direction && direction !== "center" && direction !== "dropup-center", _b3), className) }, rest, { ref: forkedRef }), children2));
});
var alignmentDirection = import_prop_types55.default.oneOf(["start", "end"]);
CDropdown.propTypes = {
  alignment: import_prop_types55.default.oneOfType([
    alignmentDirection,
    import_prop_types55.default.shape({ xs: alignmentDirection.isRequired }),
    import_prop_types55.default.shape({ sm: alignmentDirection.isRequired }),
    import_prop_types55.default.shape({ md: alignmentDirection.isRequired }),
    import_prop_types55.default.shape({ lg: alignmentDirection.isRequired }),
    import_prop_types55.default.shape({ xl: alignmentDirection.isRequired }),
    import_prop_types55.default.shape({ xxl: alignmentDirection.isRequired })
  ]),
  as: import_prop_types55.default.elementType,
  autoClose: import_prop_types55.default.oneOfType([
    import_prop_types55.default.bool,
    import_prop_types55.default.oneOf(["inside", "outside"])
  ]),
  children: import_prop_types55.default.node,
  className: import_prop_types55.default.string,
  dark: import_prop_types55.default.bool,
  direction: import_prop_types55.default.oneOf(["center", "dropup", "dropup-center", "dropend", "dropstart"]),
  offset: import_prop_types55.default.any,
  // TODO: find good proptype
  onHide: import_prop_types55.default.func,
  onShow: import_prop_types55.default.func,
  placement: placementPropType,
  popper: import_prop_types55.default.bool,
  popperConfig: import_prop_types55.default.oneOfType([import_prop_types55.default.func, import_prop_types55.default.object]),
  portal: import_prop_types55.default.bool,
  variant: import_prop_types55.default.oneOf(["btn-group", "dropdown", "input-group", "nav-item"]),
  visible: import_prop_types55.default.bool
};
...
var CDropdownDivider = (0, import_react67.forwardRef)(function(_a3, ref) {
  var className = _a3.className, rest = __rest(_a3, ["className"]);
  return import_react67.default.createElement("hr", __assign({ className: classNames("dropdown-divider", className) }, rest, { ref }));
});
...
var CDropdownHeader = (0, import_react68.forwardRef)(function(_a3, ref) {
  var children2 = _a3.children, _b3 = _a3.as, Component = _b3 === void 0 ? "h6" : _b3, className = _a3.className, rest = __rest(_a3, ["children", "as", "className"]);
  return import_react68.default.createElement(Component, __assign({ className: classNames("dropdown-header", className) }, rest, { ref }), children2);
});
...
var CDropdownItem = (0, import_react69.forwardRef)(function(_a3, ref) {
  var children2 = _a3.children, _b3 = _a3.as, as = _b3 === void 0 ? "a" : _b3, className = _a3.className, rest = __rest(_a3, ["children", "as", "className"]);
  return import_react69.default.createElement(CLink, __assign({ className: classNames("dropdown-item", className), as }, rest, { ref }), children2);
});
...
var CDropdownItemPlain = (0, import_react70.forwardRef)(function(_a3, ref) {
  var children2 = _a3.children, _b3 = _a3.as, Component = _b3 === void 0 ? "span" : _b3, className = _a3.className, rest = __rest(_a3, ["children", "as", "className"]);
  return import_react70.default.createElement(Component, __assign({ className: classNames("dropdown-item-text", className) }, rest, { ref }), children2);
});
...
init_lib();
var CDropdownMenu = (0, import_react71.forwardRef)(function(_a3, ref) {
  var children2 = _a3.children, _b3 = _a3.as, Component = _b3 === void 0 ? "ul" : _b3, className = _a3.className, rest = __rest(_a3, ["children", "as", "className"]);
  var _c3 = (0, import_react71.useContext)(CDropdownContext), alignment = _c3.alignment, container = _c3.container, dark = _c3.dark, dropdownMenuRef = _c3.dropdownMenuRef, popper = _c3.popper, portal = _c3.portal, visible = _c3.visible;
  ...
  return import_react71.default.createElement(
    ...
    import_react71.default.createElement(Component, __assign({ className: classNames("dropdown-menu", {
      show: visible
    }, alignment && getAlignmentClassNames(alignment), className), ref: forkedRef, role: "menu" }, !popper && { "data-coreui-popper": "static" }, dark && { "data-coreui-theme": "dark" }, rest), Component === "ul" ? import_react71.default.Children.map(children2, function(child, index) {
      if (import_react71.default.isValidElement(child)) {
        return import_react71.default.createElement("li", { key: index }, import_react71.default.cloneElement(child));
      }
      return;
    }) : children2)
  );
...
var CDropdownToggle = function(_a3) {
  var children2 = _a3.children, _b3 = _a3.caret, caret = _b3 === void 0 ? true : _b3, custom = _a3.custom, className = _a3.className, _c3 = _a3.navLink, navLink = _c3 === void 0 ? true : _c3, split = _a3.split, _d3 = _a3.trigger, trigger = _d3 === void 0 ? "click" : _d3, rest = __rest(_a3, ["children", "caret", "custom", "className", "navLink", "split", "trigger"]);
  var _e3 = (0, import_react72.useContext)(CDropdownContext), dropdownToggleRef = _e3.dropdownToggleRef, variant = _e3.variant, visible = _e3.visible, setVisible = _e3.setVisible;
  ...
  var Toggler = function() {
    if (custom && import_react72.default.isValidElement(children2)) {
      return import_react72.default.createElement(import_react72.default.Fragment, null, import_react72.default.cloneElement(children2, __assign(__assign({ "aria-expanded": visible }, !rest.disabled && __assign({}, triggers)), { ref: dropdownToggleRef })));
    }
    if (variant === "nav-item" && navLink) {
      return import_react72.default.createElement("a", __assign({ href: "#" }, togglerProps, { role: "button" }, rest, { ref: dropdownToggleRef }), children2);
    }
    return import_react72.default.createElement(
      CButton,
      __assign({}, togglerProps, { tabIndex: 0 }, rest, { ref: dropdownToggleRef }),
      children2,
      split && import_react72.default.createElement("span", { className: "visually-hidden" }, "Toggle Dropdown")
    );
  };
  return import_react72.default.createElement(Toggler, null);
};
CDropdownToggle.propTypes = {
  caret: import_prop_types61.default.bool,
  children: import_prop_types61.default.node,
  className: import_prop_types61.default.string,
  custom: import_prop_types61.default.bool,
  split: import_prop_types61.default.bool,
...
var CSpinner = (0, import_react73.forwardRef)(function(_a3, ref) {
  var _b3;
  ...
  return import_react73.default.createElement(
    ...
    import_react73.default.createElement("span", { className: "visually-hidden" }, visuallyHiddenLabel)
  );
});
CSpinner.propTypes = {
  as: import_prop_types62.default.string,
  className: import_prop_types62.default.string,
  color: colorPropType,
  size: import_prop_types62.default.oneOf(["sm"]),
  variant: import_prop_types62.default.oneOf(["border", "grow"]),
  visuallyHiddenLabel: import_prop_types62.default.string
};
CSpinner.displayName = "CSpinner";

// node_modules/@coreui/react-pro/dist/esm/components/element-cover/CElementCover.js
var CElementCover = (0, import_react74.forwardRef)(function(_a3, ref) {
  var children2 = _a3.children, className = _a3.className, boundaries = _a3.boundaries, _b3 = _a3.opacity, opacity = _b3 === void 0 ? 0.4 : _b3, rest = __rest(_a3, ["children", "className", "boundaries", "opacity"]);
  var elementCoverRef = (0, import_react74.useRef)(null);
  var forkedRef = useForkedRef(ref, elementCoverRef);
  var _c3 = (0, import_react74.useState)({}), customBoundaries = _c3[0], setCustomBoundaries = _c3[1];
  ...
  return import_react74.default.createElement(
    ...
    import_react74.default.createElement("div", { style: {
      position: "absolute",
      top: "50%",
      left: "50%",
      transform: "translateX(-50%) translateY(-50%)"
    } }, children2 || import_react74.default.createElement(CSpinner, { variant: "grow", color: "primary" }))
  );
});
CElementCover.propTypes = {
  boundaries: import_prop_types63.default.array,
  children: import_prop_types63.default.node,
  className: import_prop_types63.default.string,
  opacity: import_prop_types63.default.number
};
...
var CFooter = (0, import_react75.forwardRef)(function(_a3, ref) {
  var _b3;
  var children2 = _a3.children, className = _a3.className, position = _a3.position, rest = __rest(_a3, ["children", "className", "position"]);
  return import_react75.default.createElement("div", __assign({ className: classNames("footer", (_b3 = {}, _b3["footer-".concat(position)] = position, _b3), className) }, rest, { ref }), children2);
});
CFooter.propTypes = {
  children: import_prop_types64.default.node,
  className: import_prop_types64.default.string,
  position: import_prop_types64.default.oneOf(["fixed", "sticky"])
};
...
var CForm = (0, import_react76.forwardRef)(function(_a3, ref) {
  var children2 = _a3.children, className = _a3.className, validated = _a3.validated, rest = __rest(_a3, ["children", "className", "validated"]);
  return import_react76.default.createElement("form", __assign({ className: classNames({ "was-validated": validated }, className) || void 0 }, rest, { ref }), children2);
});
CForm.propTypes = {
  children: import_prop_types65.default.node,
  className: import_prop_types65.default.string,
  validated: import_prop_types65.default.bool
};
...
init_lib();
var CFormCheck = (0, import_react77.forwardRef)(function(_a3, ref) {
  ...
  var FormControl = function() {
    return import_react77.default.createElement("input", __assign({ type, className: classNames(button ? "btn-check" : "form-check-input", {
      "is-invalid": invalid,
      "is-valid": valid,
      "me-2": hitArea
  ...
  var FormValidation = function() {
    return import_react77.default.createElement(CFormControlValidation, { describedby: rest["aria-describedby"], feedback, feedbackInvalid, feedbackValid, floatingLabel, invalid, tooltipFeedback, valid });
  };
  var FormLabel = function() {
    var _a4;
    return import_react77.default.createElement(CFormLabel, __assign({ customClassName: classNames(button ? classNames("btn", button.variant ? "btn-".concat(button.variant, "-").concat(button.color) : "btn-".concat(button.color), (_a4 = {}, _a4["btn-".concat(button.size)] = button.size, _a4), "".concat(button.shape)) : "form-check-label") }, id && { htmlFor: id }), label);
  };
  var FormCheck = function() {
    if (button) {
      return import_react77.default.createElement(
        ...
        null,
        import_react77.default.createElement(FormControl, null),
        label && import_react77.default.createElement(FormLabel, null),
        import_react77.default.createElement(FormValidation, null)
      );
    }
    if (label) {
      return hitArea ? import_react77.default.createElement(
        import_react77.default.Fragment,
        null,
        import_react77.default.createElement(FormControl, null),
        import_react77.default.createElement(CFormLabel, __assign({ customClassName: classNames("form-check-label stretched-link", className) }, id && { htmlFor: id }), label),
        import_react77.default.createElement(FormValidation, null)
        ...
        import_react77.default.createElement(FormControl, null),
        import_react77.default.createElement(FormLabel, null),
        import_react77.default.createElement(FormValidation, null)
      );
    }
    return import_react77.default.createElement(FormControl, null);
  };
  return import_react77.default.createElement(FormCheck, null);
});
CFormCheck.propTypes = __assign({ button: import_prop_types66.default.object, className: import_prop_types66.default.string, hitArea: import_prop_types66.default.oneOf(["full"]), id: import_prop_types66.default.string, indeterminate: import_prop_types66.default.bool, inline: import_prop_types66.default.bool, label: import_prop_types66.default.oneOfType([import_prop_types66.default.string, import_prop_types66.default.node]), reverse: import_prop_types66.default.bool, type: import_prop_types66.default.oneOf(["checkbox", "radio"]) }, CFormControlValidation.propTypes);
CFormCheck.displayName = "CFormCheck";

// node_modules/@coreui/react-pro/dist/esm/components/form/CFormInput.js
var import_react78 = __toESM(require_react());
var import_prop_types67 = __toESM(require_prop_types());
var CFormInput = (0, import_react78.forwardRef)(function(_a3, ref) {
  var _b3;
  var children2 = _a3.children, className = _a3.className, _c3 = _a3.delay, delay = _c3 === void 0 ? false : _c3, feedback = _a3.feedback, feedbackInvalid = _a3.feedbackInvalid, feedbackValid = _a3.feedbackValid, floatingClassName = _a3.floatingClassName, floatingLabel = _a3.floatingLabel, id = _a3.id, invalid = _a3.invalid, label = _a3.label, onChange = _a3.onChange, plainText = _a3.plainText, size = _a3.size, text = _a3.text, tooltipFeedback = _a3.tooltipFeedback, _d3 = _a3.type, type = _d3 === void 0 ? "text" : _d3, valid = _a3.valid, rest = __rest(_a3, ["children", "className", "delay", "feedback", "feedbackInvalid", "feedbackValid", "floatingClassName", "floatingLabel", "id", "invalid", "label", "onChange", "plainText", "size", "text", "tooltipFeedback", "type", "valid"]);
  var _e3 = (0, import_react78.useState)(), value = _e3[0], setValue = _e3[1];
  ...
  return import_react78.default.createElement(
    ...
    import_react78.default.createElement("input", __assign({ className: classNames(plainText ? "form-control-plaintext" : "form-control", (_b3 = {}, _b3["form-control-".concat(size)] = size, _b3["form-control-color"] = type === "color", _b3["is-invalid"] = invalid, _b3["is-valid"] = valid, _b3), className), id, type, onChange: function(event) {
      return delay ? setValue(event) : onChange && onChange(event);
    } }, rest, { ref }), children2)
  );
});
CFormInput.propTypes = __assign({ className: import_prop_types67.default.string, id: import_prop_types67.default.string, delay: import_prop_types67.default.oneOfType([import_prop_types67.default.bool, import_prop_types67.default.number]), plainText: import_prop_types67.default.bool, size: import_prop_types67.default.oneOf(["sm", "lg"]), type: import_prop_types67.default.oneOfType([import_prop_types67.default.oneOf(["color", "file", "text"]), import_prop_types67.default.string]) }, CFormControlWrapper.propTypes);
...
var CFormRange = (0, import_react79.forwardRef)(function(_a3, ref) {
  ...
  return import_react79.default.createElement(
    ...
    null,
    label && import_react79.default.createElement(CFormLabel, { htmlFor: rest.id }, label),
    import_react79.default.createElement("input", __assign({ type: "range", className: classNames("form-range", className) }, rest, { ref }))
  );
});
CFormRange.propTypes = {
  className: import_prop_types68.default.string,
  label: import_prop_types68.default.oneOfType([import_prop_types68.default.node, import_prop_types68.default.string])
};
...
var CFormSelect = (0, import_react80.forwardRef)(function(_a3, ref) {
  var _b3;
  var children2 = _a3.children, className = _a3.className, feedback = _a3.feedback, feedbackInvalid = _a3.feedbackInvalid, feedbackValid = _a3.feedbackValid, floatingClassName = _a3.floatingClassName, floatingLabel = _a3.floatingLabel, htmlSize = _a3.htmlSize, id = _a3.id, invalid = _a3.invalid, label = _a3.label, options = _a3.options, size = _a3.size, text = _a3.text, tooltipFeedback = _a3.tooltipFeedback, valid = _a3.valid, rest = __rest(_a3, ["children", "className", "feedback", "feedbackInvalid", "feedbackValid", "floatingClassName", "floatingLabel", "htmlSize", "id", "invalid", "label", "options", "size", "text", "tooltipFeedback", "valid"]);
  return import_react80.default.createElement(
    CFormControlWrapper,
    { describedby: rest["aria-describedby"], feedback, feedbackInvalid, feedbackValid, floatingClassName, floatingLabel, id, invalid, label, text, tooltipFeedback, valid },
    import_react80.default.createElement("select", __assign({ id, className: classNames("form-select", (_b3 = {}, _b3["form-select-".concat(size)] = size, _b3["is-invalid"] = invalid, _b3["is-valid"] = valid, _b3), className), size: htmlSize }, rest, { ref }), options ? options.map(function(option, index) {
      return import_react80.default.createElement("option", __assign({}, typeof option === "object" && option.disabled && { disabled: option.disabled }, typeof option === "object" && option.value !== void 0 && { value: option.value }, { key: index }), typeof option === "string" ? option : option.label);
    }) : children2)
  );
});
CFormSelect.propTypes = __assign({ className: import_prop_types69.default.string, htmlSize: import_prop_types69.default.number, options: import_prop_types69.default.array }, CFormControlWrapper.propTypes);
...
var CFormSwitch = (0, import_react81.forwardRef)(function(_a3, ref) {
  var _b3;
  ...
  return import_react81.default.createElement(
    ...
    import_react81.default.createElement("input", __assign({ type, className: classNames("form-check-input", {
      "is-invalid": invalid,
      "is-valid": valid
    }), id }, rest, { ref })),
    label && import_react81.default.createElement(CFormLabel, __assign({ customClassName: "form-check-label" }, id && { htmlFor: id }), label)
  );
});
CFormSwitch.propTypes = {
  className: import_prop_types70.default.string,
  id: import_prop_types70.default.string,
  invalid: import_prop_types70.default.bool,
  label: import_prop_types70.default.oneOfType([import_prop_types70.default.string, import_prop_types70.default.node]),
  reverse: import_prop_types70.default.bool,
  size: import_prop_types70.default.oneOf(["lg", "xl"]),
...
var CFormTextarea = (0, import_react82.forwardRef)(function(_a3, ref) {
  ...
  return import_react82.default.createElement(
    CFormControlWrapper,
    { describedby: rest["aria-describedby"], feedback, feedbackInvalid, feedbackValid, floatingClassName, floatingLabel, id, invalid, label, text, tooltipFeedback, valid },
    import_react82.default.createElement("textarea", __assign({ className: classNames(plainText ? "form-control-plaintext" : "form-control", {
      "is-invalid": invalid,
      "is-valid": valid
    }, className), id }, rest, { ref }), children2)
  );
});
CFormTextarea.propTypes = __assign({ className: import_prop_types71.default.string, id: import_prop_types71.default.string, plainText: import_prop_types71.default.bool }, CFormControlWrapper.propTypes);
...
var CInputGroup = (0, import_react83.forwardRef)(function(_a3, ref) {
  var _b3;
  var children2 = _a3.children, className = _a3.className, size = _a3.size, rest = __rest(_a3, ["children", "className", "size"]);
  return import_react83.default.createElement("div", __assign({ className: classNames("input-group", (_b3 = {}, _b3["input-group-".concat(size)] = size, _b3), className) }, rest, { ref }), children2);
});
CInputGroup.propTypes = {
  children: import_prop_types72.default.node,
  className: import_prop_types72.default.string,
  size: import_prop_types72.default.oneOf(["sm", "lg"])
};
...
var CInputGroupText = (0, import_react84.forwardRef)(function(_a3, ref) {
  var children2 = _a3.children, _b3 = _a3.as, Component = _b3 === void 0 ? "span" : _b3, className = _a3.className, rest = __rest(_a3, ["children", "as", "className"]);
  return import_react84.default.createElement(Component, __assign({ className: classNames("input-group-text", className) }, rest, { ref }), children2);
});
...
var CCol = (0, import_react85.forwardRef)(function(_a3, ref) {
  var children2 = _a3.children, className = _a3.className, rest = __rest(_a3, ["children", "className"]);
  ...
  return import_react85.default.createElement("div", __assign({ className: classNames(repsonsiveClassNames.length > 0 ? repsonsiveClassNames : "col", className) }, rest, { ref }), children2);
});
var span = import_prop_types74.default.oneOfType([
  import_prop_types74.default.bool,
  import_prop_types74.default.number,
  import_prop_types74.default.string,
  import_prop_types74.default.oneOf(["auto"])
]);
var col = import_prop_types74.default.oneOfType([
  span,
  import_prop_types74.default.shape({
    span,
    offset: import_prop_types74.default.oneOfType([import_prop_types74.default.number, import_prop_types74.default.string]),
    order: import_prop_types74.default.oneOfType([
      import_prop_types74.default.oneOf(["first", "last"]),
      import_prop_types74.default.number,
      import_prop_types74.default.string
    ])
  })
...
var CContainer = (0, import_react86.forwardRef)(function(_a3, ref) {
  var children2 = _a3.children, className = _a3.className, rest = __rest(_a3, ["children", "className"]);
  var repsonsiveClassNames = [];
  ...
  return import_react86.default.createElement("div", __assign({ className: classNames(repsonsiveClassNames.length > 0 ? repsonsiveClassNames : "container", className) }, rest, { ref }), children2);
});
CContainer.propTypes = {
  children: import_prop_types75.default.node,
  className: import_prop_types75.default.string,
  sm: import_prop_types75.default.bool,
  md: import_prop_types75.default.bool,
  lg: import_prop_types75.default.bool,
  xl: import_prop_types75.default.bool,
  xxl: import_prop_types75.default.bool,
...
var CRow = (0, import_react87.forwardRef)(function(_a3, ref) {
  var children2 = _a3.children, className = _a3.className, rest = __rest(_a3, ["children", "className"]);
  var repsonsiveClassNames = [];
  ...
  return import_react87.default.createElement("div", __assign({ className: classNames("row", repsonsiveClassNames, className) }, rest, { ref }), children2);
});
var bp = import_prop_types76.default.shape({
  cols: import_prop_types76.default.oneOfType([import_prop_types76.default.oneOf(["auto"]), import_prop_types76.default.number, import_prop_types76.default.string]),
  gutter: import_prop_types76.default.oneOfType([import_prop_types76.default.string, import_prop_types76.default.number]),
  gutterX: import_prop_types76.default.oneOfType([import_prop_types76.default.string, import_prop_types76.default.number]),
  gutterY: import_prop_types76.default.oneOfType([import_prop_types76.default.string, import_prop_types76.default.number])
});
CRow.propTypes = {
...
var CHeader = (0, import_react88.forwardRef)(function(_a3, ref) {
  var _b3;
  var children2 = _a3.children, className = _a3.className, container = _a3.container, position = _a3.position, rest = __rest(_a3, ["children", "className", "container", "position"]);
  return import_react88.default.createElement("div", __assign({ className: classNames("header", (_b3 = {}, _b3["header-".concat(position)] = position, _b3), className) }, rest, { ref }), container ? import_react88.default.createElement("div", { className: typeof container === "string" ? "container-".concat(container) : "container" }, children2) : import_react88.default.createElement(import_react88.default.Fragment, null, children2));
});
CHeader.propTypes = {
  children: import_prop_types77.default.node,
  className: import_prop_types77.default.string,
  container: import_prop_types77.default.oneOfType([
  ...
  position: import_prop_types77.default.oneOf(["fixed", "sticky"])
};
...
var CHeaderBrand = (0, import_react89.forwardRef)(function(_a3, ref) {
  var children2 = _a3.children, _b3 = _a3.as, Component = _b3 === void 0 ? "a" : _b3, className = _a3.className, rest = __rest(_a3, ["children", "as", "className"]);
  return import_react89.default.createElement(Component, __assign({ className: classNames("header-brand", className) }, rest, { ref }), children2);
});
...
var CHeaderDivider = (0, import_react90.forwardRef)(function(_a3, ref) {
  var className = _a3.className, rest = __rest(_a3, ["className"]);
  return import_react90.default.createElement("div", __assign({ className: classNames("header-divider", className) }, rest, { ref }));
});
...
var CHeaderNav = (0, import_react91.forwardRef)(function(_a3, ref) {
  var children2 = _a3.children, _b3 = _a3.as, Component = _b3 === void 0 ? "ul" : _b3, className = _a3.className, rest = __rest(_a3, ["children", "as", "className"]);
  return import_react91.default.createElement(Component, __assign({ className: classNames("header-nav", className), role: "navigation" }, rest, { ref }), children2);
});
...
var CHeaderText = (0, import_react92.forwardRef)(function(_a3, ref) {
  var children2 = _a3.children, className = _a3.className, rest = __rest(_a3, ["children", "className"]);
  return import_react92.default.createElement("span", __assign({ className: classNames("header-text", className) }, rest, { ref }), children2);
});
...
var CHeaderToggler = (0, import_react93.forwardRef)(function(_a3, ref) {
  var children2 = _a3.children, className = _a3.className, rest = __rest(_a3, ["children", "className"]);
  return import_react93.default.createElement("button", __assign({ type: "button", className: classNames("header-toggler", className) }, rest, { ref }), children2 !== null && children2 !== void 0 ? children2 : import_react93.default.createElement("span", { className: "header-toggler-icon" }));
});
...
var CImage = (0, import_react94.forwardRef)(function(_a3, ref) {
  var _b3;
  ...
  return import_react94.default.createElement("img", __assign({ className: classNames((_b3 = {}, _b3["float-".concat(align)] = align && (align === "start" || align === "end"), _b3["d-block mx-auto"] = align && align === "center", _b3["img-fluid"] = fluid, _b3.rounded = rounded, _b3["img-thumbnail"] = thumbnail, _b3), className) || void 0 }, rest, { ref }));
});
CImage.propTypes = {
  align: import_prop_types83.default.oneOf(["start", "center", "end"]),
  className: import_prop_types83.default.string,
  fluid: import_prop_types83.default.bool,
  rounded: import_prop_types83.default.bool,
  thumbnail: import_prop_types83.default.bool
};
...
var CListGroup = (0, import_react95.forwardRef)(function(_a3, ref) {
  var _b3;
  var children2 = _a3.children, _c3 = _a3.as, Component = _c3 === void 0 ? "ul" : _c3, className = _a3.className, flush = _a3.flush, layout = _a3.layout, rest = __rest(_a3, ["children", "as", "className", "flush", "layout"]);
  return import_react95.default.createElement(Component, __assign({ className: classNames("list-group", (_b3 = {
    "list-group-flush": flush
  }, _b3["list-group-".concat(layout)] = layout, _b3), className) }, rest, { ref }), children2);
});
CListGroup.propTypes = {
  ...
  flush: import_prop_types84.default.bool,
  layout: import_prop_types84.default.oneOf([
    "horizontal",
    "horizontal-sm",
    "horizontal-md",
    "horizontal-lg",
...
var CListGroupItem = (0, import_react96.forwardRef)(function(_a3, ref) {
  var _b3;
  var children2 = _a3.children, active = _a3.active, _c3 = _a3.as, as = _c3 === void 0 ? "li" : _c3, className = _a3.className, disabled = _a3.disabled, color = _a3.color, rest = __rest(_a3, ["children", "active", "as", "className", "disabled", "color"]);
  ...
  return import_react96.default.createElement(Component, __assign({ className: classNames("list-group-item", (_b3 = {}, _b3["list-group-item-".concat(color)] = color, _b3["list-group-item-action"] = as === "a" || as === "button", _b3.active = active, _b3.disabled = disabled, _b3), className) }, rest), children2);
});
...
var CLoadingButton = (0, import_react97.forwardRef)(function(_a3, ref) {
  var children2 = _a3.children, className = _a3.className, disabledOnLoading = _a3.disabledOnLoading, loading = _a3.loading, onClick = _a3.onClick, _b3 = _a3.spinnerType, spinnerType = _b3 === void 0 ? "border" : _b3, timeout2 = _a3.timeout, rest = __rest(_a3, ["children", "className", "disabledOnLoading", "loading", "onClick", "spinnerType", "timeout"]);
  var _c3 = (0, import_react97.useState)(), _loading = _c3[0], setLoading = _c3[1];
  ...
  return import_react97.default.createElement(
    ...
    import_react97.default.createElement(CSpinner, { className: "btn-loading-spinner", size: "sm", variant: spinnerType }),
    children2
  );
});
CLoadingButton.propTypes = {
  ...
  disabledOnLoading: import_prop_types86.default.bool,
  loading: import_prop_types86.default.bool,
  onClick: import_prop_types86.default.func,
  spinnerType: import_prop_types86.default.oneOf(["border", "grow"]),
  timeout: import_prop_types86.default.number
};
...
var CModalContent = (0, import_react98.forwardRef)(function(_a3, ref) {
  var children2 = _a3.children, className = _a3.className, rest = __rest(_a3, ["children", "className"]);
  return import_react98.default.createElement("div", __assign({ className: classNames("modal-content", className) }, rest, { ref }), children2);
});
...
// node_modules/@coreui/react-pro/dist/esm/components/modal/CModalContext.js
var import_react99 = __toESM(require_react());
var CModalContext = (0, import_react99.createContext)({});
...
var CModalDialog = (0, import_react100.forwardRef)(function(_a3, ref) {
  var _b3;
  var children2 = _a3.children, alignment = _a3.alignment, className = _a3.className, fullscreen = _a3.fullscreen, scrollable = _a3.scrollable, size = _a3.size, rest = __rest(_a3, ["children", "alignment", "className", "fullscreen", "scrollable", "size"]);
  return import_react100.default.createElement("div", __assign({ className: classNames("modal-dialog", (_b3 = {
    "modal-dialog-centered": alignment === "center"
  }, _b3[typeof fullscreen === "boolean" ? "modal-fullscreen" : "modal-fullscreen-".concat(fullscreen, "-down")] = fullscreen, _b3["modal-dialog-scrollable"] = scrollable, _b3["modal-".concat(size)] = size, _b3), className) }, rest, { ref }), children2);
});
CModalDialog.propTypes = {
  alignment: import_prop_types88.default.oneOf(["top", "center"]),
  children: import_prop_types88.default.node,
  className: import_prop_types88.default.string,
  fullscreen: import_prop_types88.default.oneOfType([
    import_prop_types88.default.bool,
    import_prop_types88.default.oneOf(["sm", "md", "lg", "xl", "xxl"])
  ]),
  scrollable: import_prop_types88.default.bool,
  size: import_prop_types88.default.oneOf(["sm", "lg", "xl"])
};
CModalDialog.displayName = "CModalDialog";

// node_modules/@coreui/react-pro/dist/esm/components/modal/CModal.js
init_lib();
var CModal = (0, import_react101.forwardRef)(function(_a3, ref) {
  var children2 = _a3.children, alignment = _a3.alignment, _b3 = _a3.backdrop, backdrop = _b3 === void 0 ? true : _b3, className = _a3.className, container = _a3.container, _c3 = _a3.duration, duration = _c3 === void 0 ? 150 : _c3, _d3 = _a3.focus, focus = _d3 === void 0 ? true : _d3, fullscreen = _a3.fullscreen, _e3 = _a3.keyboard, keyboard = _e3 === void 0 ? true : _e3, onClose = _a3.onClose, onClosePrevented = _a3.onClosePrevented, onShow = _a3.onShow, _f3 = _a3.portal, portal = _f3 === void 0 ? true : _f3, scrollable = _a3.scrollable, size = _a3.size, _g2 = _a3.transition, transition = _g2 === void 0 ? true : _g2, _h2 = _a3.unmountOnClose, unmountOnClose = _h2 === void 0 ? true : _h2, visible = _a3.visible, rest = __rest(_a3, ["children", "alignment", "backdrop", "className", "container", "duration", "focus", "fullscreen", "keyboard", "onClose", "onClosePrevented", "onShow", "portal", "scrollable", "size", "transition", "unmountOnClose", "visible"]);
  var activeElementRef = (0, import_react101.useRef)(null);
  var modalRef = (0, import_react101.useRef)(null);
  var modalContentRef = (0, import_react101.useRef)(null);
  var forkedRef = useForkedRef(ref, modalRef);
  var _j2 = (0, import_react101.useState)(visible), _visible = _j2[0], setVisible = _j2[1];
  var _k2 = (0, import_react101.useState)(false), staticBackdrop = _k2[0], setStaticBackdrop = _k2[1];
  var contextValues = {
    visible: _visible,
    setVisible
  };
  ...
  (0, import_react101.useLayoutEffect)(function() {
  ...
  return import_react101.default.createElement(
    ...
    null,
    import_react101.default.createElement(Transition, { in: _visible, mountOnEnter: true, nodeRef: modalRef, onEnter: onShow, onExit: onClose, unmountOnExit: unmountOnClose, timeout: transition ? duration : 0 }, function(state) {
      return import_react101.default.createElement(
        CConditionalPortal,
        { container, portal },
        import_react101.default.createElement(
          ...
          import_react101.default.createElement(
            ...
            import_react101.default.createElement(
              ...
              import_react101.default.createElement(CModalContent, { ref: modalContentRef }, children2)
            )
          )
        )
      );
    ...
    backdrop && import_react101.default.createElement(
      CConditionalPortal,
      { container, portal },
      import_react101.default.createElement(CBackdrop, { visible: _visible })
    )
  );
});
CModal.propTypes = {
  alignment: import_prop_types89.default.oneOf(["top", "center"]),
  backdrop: import_prop_types89.default.oneOfType([import_prop_types89.default.bool, import_prop_types89.default.oneOf(["static"])]),
  children: import_prop_types89.default.node,
  className: import_prop_types89.default.string,
  container: import_prop_types89.default.any,
  // HTMLElement
  duration: import_prop_types89.default.number,
  focus: import_prop_types89.default.bool,
  fullscreen: import_prop_types89.default.oneOfType([
    import_prop_types89.default.bool,
    import_prop_types89.default.oneOf(["sm", "md", "lg", "xl", "xxl"])
  ]),
  keyboard: import_prop_types89.default.bool,
  onClose: import_prop_types89.default.func,
  onClosePrevented: import_prop_types89.default.func,
  onShow: import_prop_types89.default.func,
  portal: import_prop_types89.default.bool,
  scrollable: import_prop_types89.default.bool,
  size: import_prop_types89.default.oneOf(["sm", "lg", "xl"]),
  transition: import_prop_types89.default.bool,
  unmountOnClose: import_prop_types89.default.bool,
  visible: import_prop_types89.default.bool
};
...
var CModalBody = (0, import_react102.forwardRef)(function(_a3, ref) {
  var children2 = _a3.children, className = _a3.className, rest = __rest(_a3, ["children", "className"]);
  return import_react102.default.createElement("div", __assign({ className: classNames("modal-body", className) }, rest, { ref }), children2);
});
...
var CModalFooter = (0, import_react103.forwardRef)(function(_a3, ref) {
  var children2 = _a3.children, className = _a3.className, rest = __rest(_a3, ["children", "className"]);
  return import_react103.default.createElement("div", __assign({ className: classNames("modal-footer", className) }, rest, { ref }), children2);
});
...
var CModalHeader = (0, import_react104.forwardRef)(function(_a3, ref) {
  var children2 = _a3.children, className = _a3.className, _b3 = _a3.closeButton, closeButton = _b3 === void 0 ? true : _b3, rest = __rest(_a3, ["children", "className", "closeButton"]);
  var setVisible = (0, import_react104.useContext)(CModalContext).setVisible;
  return import_react104.default.createElement(
    "div",
    __assign({ className: classNames("modal-header", className) }, rest, { ref }),
    children2,
    closeButton && import_react104.default.createElement(CCloseButton, { onClick: function() {
      return setVisible(false);
    } })
  );
});
CModalHeader.propTypes = {
  ...
  closeButton: import_prop_types92.default.bool
};
...
var CModalTitle = (0, import_react105.forwardRef)(function(_a3, ref) {
  var children2 = _a3.children, _b3 = _a3.as, Component = _b3 === void 0 ? "h5" : _b3, className = _a3.className, rest = __rest(_a3, ["children", "as", "className"]);
  return import_react105.default.createElement(Component, __assign({ className: classNames("modal-title", className) }, rest, { ref }), children2);
});
...
var createNativeOptions = function(options) {
  return options && options.map(function(option, index) {
    return option.options ? import_react106.default.createElement("optgroup", { label: option.label, key: index }, createNativeOptions(option.options)) : import_react106.default.createElement("option", { value: option.value, key: index, disabled: option.disabled }, option.label);
  });
};
var CMultiSelectNativeSelect = (0, import_react106.forwardRef)(function(_a3, ref) {
  var id = _a3.id, name = _a3.name, options = _a3.options, rest = __rest(_a3, ["id", "name", "options"]);
  return import_react106.default.createElement("select", __assign({ id }, id && !name && { name: "".concat(id, "-multi-select") }, name && { name }, { tabIndex: -1, style: { display: "none" } }, rest, { ref }), options && createNativeOptions(options));
});
CMultiSelectNativeSelect.propTypes = {
  id: import_prop_types94.default.string,
  name: import_prop_types94.default.string,
  options: import_prop_types94.default.array,
  value: import_prop_types94.default.oneOfType([
    import_prop_types94.default.number,
    import_prop_types94.default.string,
    import_prop_types94.default.arrayOf(import_prop_types94.default.string.isRequired)
  ])
};
...
init_lib();
var CVirtualScroller = (0, import_react107.forwardRef)(function(_a3, ref) {
  var children2 = _a3.children, className = _a3.className, visibleItems = _a3.visibleItems, onScroll = _a3.onScroll, rest = __rest(_a3, ["children", "className", "visibleItems", "onScroll"]);
  var virtualScrollRef = (0, import_react107.useRef)(null);
  var virtualScrollContentRef = (0, import_react107.useRef)(null);
  var forkedRef = useForkedRef(ref, virtualScrollRef);
  var _b3 = (0, import_react107.useState)(Math.floor(visibleItems / 2)), buffer = _b3[0], setBuffer = _b3[1];
  var _c3 = (0, import_react107.useState)(1), currentItemIndex = _c3[0], setCurrentItemIndex = _c3[1];
  var _d3 = (0, import_react107.useState)(0), itemHeight = _d3[0], setItemHeight = _d3[1];
  var _e3 = (0, import_react107.useState)(import_react107.default.Children.count(children2)), itemsNumber = _e3[0], setItemsNumber = _e3[1];
  var _f3 = (0, import_react107.useState)(0), viewportPadding = _f3[0], setViewportPadding = _f3[1];
  var _g2 = (0, import_react107.useState)(visibleItems * itemHeight + 2 * viewportPadding), viewportHeight = _g2[0], setViewportHeight = _g2[1];
  var _h2 = (0, import_react107.useState)(itemsNumber * itemHeight + 2 * viewportPadding), maxHeight = _h2[0], setMaxHeight = _h2[1];
  ...
  (0, import_react107.useEffect)(function() {
    setItemsNumber(import_react107.default.Children.count(children2));
  }, [children2]);
  (0, import_react107.useEffect)(function() {
  ...
  return import_react107.default.createElement(
    ...
    import_react107.default.createElement("div", { className: "virtual-scroller-content", style: {
      height: maxHeight
    }, ref: virtualScrollContentRef }, import_react107.default.Children.map(children2, function(child, index) {
      if (import_react107.default.isValidElement(child) && index + 1 > Math.max(currentItemIndex - buffer, 0) && index + 1 <= currentItemIndex + visibleItems + buffer) {
        return import_react107.default.cloneElement(child, {
...
CVirtualScroller.propTypes = {
  onScroll: import_prop_types95.default.func,
  visibleItems: import_prop_types95.default.number.isRequired
};
...
// node_modules/@coreui/react-pro/dist/esm/components/multi-select/CMultiSelectOptions.js
var CMultiSelectOptions = (0, import_react108.forwardRef)(function(_a3, ref) {
  ...
  var createOptions = function(options2) {
    return options2.length > 0 ? options2.map(function(option, index) {
      return "value" in option ? import_react108.default.createElement("div", { className: classNames("form-multi-select-option", {
      ...
      }, tabIndex: 0 }, optionsTemplate ? optionsTemplate(option) : option.label) : import_react108.default.createElement("div", { className: "form-multi-select-optgroup-label", key: index }, optionsGroupsTemplate ? optionsGroupsTemplate(option) : option.label);
    }) : import_react108.default.createElement("div", { className: "form-multi-select-options-empty" }, searchNoResultsLabel);
  };
  return import_react108.default.createElement(
    import_react108.default.Fragment,
    null,
    virtualScroller ? import_react108.default.createElement(CVirtualScroller, { className: "form-multi-select-options", onKeyDown, visibleItems, ref }, createOptions(options)) : import_react108.default.createElement("div", __assign({ className: "form-multi-select-options", onKeyDown }, optionsMaxHeight !== "auto" && {
      style: { maxHeight: optionsMaxHeight, overflow: "scroll" }
    }, { ref }), createOptions(options)),
    loading && import_react108.default.createElement(CElementCover, null)
  );
});
CMultiSelectOptions.propTypes = {
  loading: import_prop_types96.default.bool,
  onOptionOnClick: import_prop_types96.default.func,
  options: import_prop_types96.default.array.isRequired,
  optionsMaxHeight: import_prop_types96.default.oneOfType([import_prop_types96.default.number, import_prop_types96.default.string]),
  optionsStyle: import_prop_types96.default.oneOf(["checkbox", "text"]),
  optionsTemplate: import_prop_types96.default.func,
  optionsGroupsTemplate: import_prop_types96.default.func,
  searchNoResultsLabel: import_prop_types96.default.oneOfType([import_prop_types96.default.string, import_prop_types96.default.node]),
  virtualScroller: import_prop_types96.default.bool,
  visibleItems: import_prop_types96.default.number
};
...
var CMultiSelectSelection = (0, import_react109.forwardRef)(function(_a3, ref) {
  var children2 = _a3.children, disabled = _a3.disabled, multiple = _a3.multiple, placeholder = _a3.placeholder, onRemove = _a3.onRemove, search = _a3.search, _b3 = _a3.selected, selected = _b3 === void 0 ? [] : _b3, selectionType = _a3.selectionType, selectionTypeCounterText = _a3.selectionTypeCounterText;
    ...
    multiple && selectionType === "tags" && selected.map(function(option, index) {
      if (selectionType === "tags") {
        return import_react109.default.createElement(
          ...
          option.label,
          !disabled && !option.disabled && import_react109.default.createElement("button", { className: "form-multi-select-tag-delete", type: "button", "aria-label": "Close", onClick: function() {
...
CMultiSelectSelection.propTypes = {
  ...
  onRemove: import_prop_types97.default.func,
  placeholder: import_prop_types97.default.string,
  search: import_prop_types97.default.oneOfType([
    import_prop_types97.default.bool,
    import_prop_types97.default.oneOf(["external", "global"]),
    import_prop_types97.default.shape({
      external: import_prop_types97.default.bool.isRequired,
      global: import_prop_types97.default.bool.isRequired
    })
  ]),
  selected: import_prop_types97.default.array,
  selectionType: import_prop_types97.default.oneOf(["counter", "tags", "text"]),
  selectionTypeCounterText: import_prop_types97.default.string
};
...
var useDropdownWithPopper = function(popperConfig) {
  var dropdownRefElement = (0, import_react110.useRef)(null);
  var dropdownMenuElement = (0, import_react110.useRef)(null);
  var _a3 = (0, import_react110.useState)(false), isOpen = _a3[0], setIsOpen = _a3[1];
...
var CMultiSelect = (0, import_react111.forwardRef)(function(_a3, ref) {
  ...
  var nativeSelectRef = (0, import_react111.useRef)(null);
  var searchRef = (0, import_react111.useRef)(null);
  var isInitialMount = (0, import_react111.useRef)(true);
  var _v = (0, import_react111.useState)(""), searchValue = _v[0], setSearchValue = _v[1];
  var _w = (0, import_react111.useState)([]), selected = _w[0], setSelected = _w[1];
  var _x = (0, import_react111.useState)([]), userOptions = _x[0], setUserOptions = _x[1];
  var filteredOptions = (0, import_react111.useMemo)(function() {
  ...
  var flattenedOptions = (0, import_react111.useMemo)(function() {
  ...
  var userOption = (0, import_react111.useMemo)(function() {
  ...
  return import_react111.default.createElement(
    ...
    import_react111.default.createElement(CMultiSelectNativeSelect, { id, multiple, name, options: selected, required, value: multiple ? selected.map(function(option) {
    ...
    import_react111.default.createElement(
      ...
      import_react111.default.createElement(
        ...
        import_react111.default.createElement(
          ...
          search && import_react111.default.createElement("input", __assign({ type: "text", className: "form-multi-select-search", disabled, autoComplete: "off", onChange: handleSearchChange, onKeyDown: handleSearchKeyDown }, selected.length === 0 && { placeholder }, selected.length > 0 && selectionType === "counter" && {
          ...
          !search && selected.length === 0 && import_react111.default.createElement("span", { className: "form-multi-select-placeholder" }, placeholder)
        ),
        import_react111.default.createElement(
          "div",
          { className: "form-multi-select-buttons" },
          !disabled && cleaner && selected.length > 0 && import_react111.default.createElement("button", { type: "button", className: "form-multi-select-cleaner", onClick: function() {
            return handleDeselectAll();
          }, "aria-label": ariaCleanerLabel }),
          import_react111.default.createElement("button", __assign({ type: "button", className: "form-multi-select-indicator", onClick: function(event) {
            event.preventDefault();
            event.stopPropagation();
            if (!disabled) {
              toggleDropdown();
      ...
      import_react111.default.createElement(
        ...
        import_react111.default.createElement(
          ...
          multiple && selectAll && import_react111.default.createElement("button", { type: "button", className: "form-multi-select-all", onClick: function() {
            return handleSelectAll();
          } }, selectAllLabel),
          import_react111.default.createElement(CMultiSelectOptions, { loading, onOptionOnClick: function(option) {
            return !disabled && handleOnOptionClick(option);
...
CMultiSelect.propTypes = __assign({ allowCreateOptions: import_prop_types98.default.bool, ariaCleanerLabel: import_prop_types98.default.string, className: import_prop_types98.default.string, cleaner: import_prop_types98.default.bool, clearSearchOnSelect: import_prop_types98.default.bool, container: import_prop_types98.default.any, disabled: import_prop_types98.default.bool, loading: import_prop_types98.default.bool, multiple: import_prop_types98.default.bool, name: import_prop_types98.default.string, onChange: import_prop_types98.default.func, onFilterChange: import_prop_types98.default.func, onHide: import_prop_types98.default.func, onShow: import_prop_types98.default.func, options: import_prop_types98.default.array.isRequired, optionsMaxHeight: import_prop_types98.default.oneOfType([import_prop_types98.default.number, import_prop_types98.default.string]), optionsStyle: import_prop_types98.default.oneOf(["checkbox", "text"]), optionsTemplate: import_prop_types98.default.func, optionsGroupsTemplate: import_prop_types98.default.func, placeholder: import_prop_types98.default.string, portal: import_prop_types98.default.bool, required: import_prop_types98.default.bool, resetSelectionOnOptionsChange: import_prop_types98.default.bool, search: import_prop_types98.default.oneOfType([
  import_prop_types98.default.bool,
  import_prop_types98.default.oneOf(["external", "global"]),
  import_prop_types98.default.shape({
    external: import_prop_types98.default.bool.isRequired,
    global: import_prop_types98.default.bool.isRequired
  })
]), searchNoResultsLabel: import_prop_types98.default.oneOfType([import_prop_types98.default.string, import_prop_types98.default.node]), selectAll: import_prop_types98.default.bool, selectAllLabel: import_prop_types98.default.oneOfType([import_prop_types98.default.string, import_prop_types98.default.node]), selectionType: import_prop_types98.default.oneOf(["counter", "tags", "text"]), selectionTypeCounterText: import_prop_types98.default.string, size: import_prop_types98.default.oneOf(["sm", "lg"]), value: import_prop_types98.default.oneOfType([
  ...
  import_prop_types98.default.arrayOf(import_prop_types98.default.string)
]), virtualScroller: import_prop_types98.default.bool, visible: import_prop_types98.default.bool, visibleItems: import_prop_types98.default.number }, CFormControlWrapper.propTypes);
...
var CNav = (0, import_react112.forwardRef)(function(_a3, ref) {
  var _b3;
  var children2 = _a3.children, _c3 = _a3.as, Component = _c3 === void 0 ? "ul" : _c3, className = _a3.className, layout = _a3.layout, variant = _a3.variant, rest = __rest(_a3, ["children", "as", "className", "layout", "variant"]);
  return import_react112.default.createElement(Component, __assign({ className: classNames("nav", variant === "enclosed-pills" && "nav-enclosed", (_b3 = {}, _b3["nav-".concat(layout)] = layout, _b3["nav-".concat(variant)] = variant, _b3), className), role: "navigation" }, rest, { ref }), children2);
});
CNav.propTypes = {
  ...
  layout: import_prop_types99.default.oneOf(["fill", "justified"]),
  variant: import_prop_types99.default.oneOf([
    "enclosed",
    "enclosed-pills",
    "pills",
    "tabs",
...
var CNavGroupItems = (0, import_react113.forwardRef)(function(_a3, ref) {
  var children2 = _a3.children, _b3 = _a3.as, Component = _b3 === void 0 ? "ul" : _b3, className = _a3.className, rest = __rest(_a3, ["children", "as", "className"]);
  return import_react113.default.createElement(Component, __assign({ className: classNames("nav-group-items", className) }, rest, { ref }), children2);
});
...
// node_modules/@coreui/react-pro/dist/esm/components/sidebar/CSidebarNavContext.js
var import_react114 = __toESM(require_react());
var CSidebarNavContext = (0, import_react114.createContext)({});
...
var CNavGroup = (0, import_react115.forwardRef)(function(_a3, ref) {
  var children2 = _a3.children, _b3 = _a3.as, Component = _b3 === void 0 ? "li" : _b3, className = _a3.className, compact = _a3.compact, idx = _a3.idx, toggler = _a3.toggler, visible = _a3.visible, rest = __rest(_a3, ["children", "as", "className", "compact", "idx", "toggler", "visible"]);
  var _c3 = (0, import_react115.useState)(0), height = _c3[0], setHeight = _c3[1];
  var navItemsRef = (0, import_react115.useRef)(null);
  var _d3 = (0, import_react115.useContext)(CSidebarNavContext), visibleGroup = _d3.visibleGroup, setVisibleGroup = _d3.setVisibleGroup;
  var _e3 = (0, import_react115.useState)(Boolean(visible || idx && visibleGroup && isInVisibleGroup(visibleGroup, idx))), _visible = _e3[0], setVisible = _e3[1];
  ...
  return import_react115.default.createElement(
    ...
    toggler && import_react115.default.createElement("a", { className: "nav-link nav-group-toggle", href: "#", onClick: function(event) {
      return handleTogglerOnCLick(event);
    } }, toggler),
    import_react115.default.createElement(Transition, { in: _visible, nodeRef: navItemsRef, onEntering, onEntered, onExit, onExiting, onExited, timeout: 300 }, function(state) {
      return import_react115.default.createElement(NavGroupItemsComponent, { className: classNames("nav-group-items", {
        compact
      }), style: __assign(__assign({}, style), transitionStyles[state]), ref: navItemsRef }, children2);
    })
  );
});
CNavGroup.propTypes = {
  ...
  compact: import_prop_types101.default.bool,
  idx: import_prop_types101.default.string,
  toggler: import_prop_types101.default.oneOfType([import_prop_types101.default.string, import_prop_types101.default.node]),
  visible: import_prop_types101.default.bool
};
...
init_lib();
var CNavLink = (0, import_react116.forwardRef)(function(_a3, ref) {
  var children2 = _a3.children, className = _a3.className, idx = _a3.idx, rest = __rest(_a3, ["children", "className", "idx"]);
  var navLinkRef = (0, import_react116.useRef)(null);
  var forkedRef = useForkedRef(ref, navLinkRef);
  var setVisibleGroup = (0, import_react116.useContext)(CSidebarNavContext).setVisibleGroup;
  ...
  return import_react116.default.createElement(CLink, __assign({ className: classNames("nav-link", className) }, rest, { ref: forkedRef }), children2);
});
CNavLink.propTypes = {
  ...
  idx: import_prop_types102.default.string
};
CNavLink.displayName = "CNavLink";

// node_modules/@coreui/react-pro/dist/esm/components/nav/CNavItem.js
var CNavItem = (0, import_react117.forwardRef)(function(_a3, ref) {
  var children2 = _a3.children, _b3 = _a3.as, Component = _b3 === void 0 ? "li" : _b3, className = _a3.className, rest = __rest(_a3, ["children", "as", "className"]);
  return import_react117.default.createElement(Component, { className: classNames("nav-item", className), ref }, rest.href || rest.to ? import_react117.default.createElement(CNavLink, __assign({ className }, rest), children2) : children2);
});
CNavItem.propTypes = {
...
var CNavTitle = (0, import_react118.forwardRef)(function(_a3, ref) {
  var children2 = _a3.children, _b3 = _a3.as, Component = _b3 === void 0 ? "li" : _b3, className = _a3.className, rest = __rest(_a3, ["children", "as", "className"]);
  return import_react118.default.createElement(Component, __assign({ className: classNames("nav-title", className) }, rest, { ref }), children2);
});
CNavTitle.propTypes = {
...
var CNavbar = (0, import_react119.forwardRef)(function(_a3, ref) {
  var _b3;
  var children2 = _a3.children, _c3 = _a3.as, Component = _c3 === void 0 ? "nav" : _c3, className = _a3.className, color = _a3.color, colorScheme = _a3.colorScheme, container = _a3.container, expand = _a3.expand, placement = _a3.placement, rest = __rest(_a3, ["children", "as", "className", "color", "colorScheme", "container", "expand", "placement"]);
  return import_react119.default.createElement(Component, __assign({ className: classNames("navbar", (_b3 = {}, _b3["bg-".concat(color)] = color, _b3[typeof expand === "boolean" ? "navbar-expand" : "navbar-expand-".concat(expand)] = expand, _b3), placement, className) }, colorScheme && { "data-coreui-theme": colorScheme }, rest, { ref }), container ? import_react119.default.createElement("div", { className: typeof container === "string" ? "container-".concat(container) : "container" }, children2) : import_react119.default.createElement(import_react119.default.Fragment, null, children2));
});
CNavbar.propTypes = {
  ...
  container: import_prop_types105.default.oneOfType([
    import_prop_types105.default.bool,
    import_prop_types105.default.oneOf([
      "sm",
      "md",
      "lg",
      "xl",
  ...
  expand: import_prop_types105.default.oneOfType([
    import_prop_types105.default.bool,
    import_prop_types105.default.oneOf(["sm", "md", "lg", "xl", "xxl"])
  ]),
  placement: import_prop_types105.default.oneOf(["fixed-top", "fixed-bottom", "sticky-top"])
};
...
var CNavbarBrand = (0, import_react120.forwardRef)(function(_a3, ref) {
  var children2 = _a3.children, as = _a3.as, className = _a3.className, rest = __rest(_a3, ["children", "as", "className"]);
  var Component = as !== null && as !== void 0 ? as : rest.href ? "a" : "span";
  return import_react120.default.createElement(Component, __assign({ className: classNames("navbar-brand", className) }, rest, { ref }), children2);
});
...
var CNavbarNav = (0, import_react121.forwardRef)(function(_a3, ref) {
  var children2 = _a3.children, _b3 = _a3.as, Component = _b3 === void 0 ? "ul" : _b3, className = _a3.className, rest = __rest(_a3, ["children", "as", "className"]);
  return import_react121.default.createElement(Component, __assign({ className: classNames("navbar-nav", className), role: "navigation", ref }, rest), children2);
});
...
var CNavbarText = (0, import_react122.forwardRef)(function(_a3, ref) {
  var children2 = _a3.children, className = _a3.className, rest = __rest(_a3, ["children", "className"]);
  return import_react122.default.createElement("span", __assign({ className: classNames("navbar-text", className) }, rest, { ref }), children2);
});
...
var CNavbarToggler = (0, import_react123.forwardRef)(function(_a3, ref) {
  var children2 = _a3.children, className = _a3.className, rest = __rest(_a3, ["children", "className"]);
  return import_react123.default.createElement("button", __assign({ type: "button", className: classNames("navbar-toggler", className) }, rest, { ref }), children2 !== null && children2 !== void 0 ? children2 : import_react123.default.createElement("span", { className: "navbar-toggler-icon" }));
});
...
var COffcanvas = (0, import_react124.forwardRef)(function(_a3, ref) {
  ...
  return import_react124.default.createElement(
    ...
    null,
    import_react124.default.createElement(Transition, { in: _visible, nodeRef: offcanvasRef, onEnter: onShow, onEntered: function() {
      var _a4;
      ...
      return import_react124.default.createElement(
        CConditionalPortal,
        { portal },
        import_react124.default.createElement("div", __assign({ className: classNames((_a4 = {}, _a4["offcanvas".concat(typeof responsive === "string" ? "-" + responsive : "")] = responsive, _a4["offcanvas-".concat(placement)] = placement, _a4.showing = state === "entering", _a4.show = state === "entered", _a4["show hiding"] = state === "exiting", _a4), className), role: "dialog", tabIndex: -1, onKeyDown: handleKeyDown }, dark && { "data-coreui-theme": "dark" }, rest, { ref: forkedRef }), children2)
      );
    }),
    backdrop && import_react124.default.createElement(
      CConditionalPortal,
      { portal },
      import_react124.default.createElement(CBackdrop, { className: "offcanvas-backdrop", onClick: handleBackdropDismiss, visible: _visible })
    )
  );
});
COffcanvas.propTypes = {
  backdrop: import_prop_types110.default.oneOfType([import_prop_types110.default.bool, import_prop_types110.default.oneOf(["static"])]),
  children: import_prop_types110.default.node,
  className: import_prop_types110.default.string,
  dark: import_prop_types110.default.bool,
  keyboard: import_prop_types110.default.bool,
  onHide: import_prop_types110.default.func,
  onShow: import_prop_types110.default.func,
  placement: import_prop_types110.default.oneOf(["start", "end", "top", "bottom"]).isRequired,
  portal: import_prop_types110.default.bool,
  responsive: import_prop_types110.default.oneOfType([
    import_prop_types110.default.bool,
    import_prop_types110.default.oneOf(["sm", "md", "lg", "xl", "xxl"])
  ]),
  scroll: import_prop_types110.default.bool,
  visible: import_prop_types110.default.bool
};
...
var COffcanvasBody = (0, import_react125.forwardRef)(function(_a3, ref) {
  var children2 = _a3.children, className = _a3.className, rest = __rest(_a3, ["children", "className"]);
  return import_react125.default.createElement("div", __assign({ className: classNames("offcanvas-body", className) }, rest, { ref }), children2);
});
...
var COffcanvasHeader = (0, import_react126.forwardRef)(function(_a3, ref) {
  var children2 = _a3.children, className = _a3.className, rest = __rest(_a3, ["children", "className"]);
  return import_react126.default.createElement("div", __assign({ className: classNames("offcanvas-header", className) }, rest, { ref }), children2);
});
...
var COffcanvasTitle = (0, import_react127.forwardRef)(function(_a3, ref) {
  var children2 = _a3.children, _b3 = _a3.as, Component = _b3 === void 0 ? "h5" : _b3, className = _a3.className, rest = __rest(_a3, ["children", "as", "className"]);
  return import_react127.default.createElement(Component, __assign({ className: classNames("offcanvas-title", className) }, rest, { ref }), children2);
});
...
// node_modules/@coreui/react-pro/dist/esm/components/password-input/CPasswordInput.js
var import_react128 = __toESM(require_react());
var import_prop_types114 = __toESM(require_prop_types());
var CPasswordInput = (0, import_react128.forwardRef)(function(_a3, ref) {
  var children2 = _a3.children, _b3 = _a3.ariaLabelToggler, ariaLabelToggler = _b3 === void 0 ? "Toggle password visibility" : _b3, className = _a3.className, _c3 = _a3.delay, delay = _c3 === void 0 ? false : _c3, feedback = _a3.feedback, feedbackInvalid = _a3.feedbackInvalid, feedbackValid = _a3.feedbackValid, floatingClassName = _a3.floatingClassName, floatingLabel = _a3.floatingLabel, id = _a3.id, invalid = _a3.invalid, label = _a3.label, onChange = _a3.onChange, _d3 = _a3.showPassword, showPasswordProp = _d3 === void 0 ? false : _d3, size = _a3.size, text = _a3.text, tooltipFeedback = _a3.tooltipFeedback, valid = _a3.valid, rest = __rest(_a3, ["children", "ariaLabelToggler", "className", "delay", "feedback", "feedbackInvalid", "feedbackValid", "floatingClassName", "floatingLabel", "id", "invalid", "label", "onChange", "showPassword", "size", "text", "tooltipFeedback", "valid"]);
  var _e3 = (0, import_react128.useState)(), value = _e3[0], setValue = _e3[1];
  var _f3 = (0, import_react128.useState)(showPasswordProp), showPassword = _f3[0], setShowPassword = _f3[1];
  ...
  var renderInputAndButton = function() {
    ...
    return import_react128.default.createElement(
      ...
      null,
      import_react128.default.createElement("input", __assign({ className: classNames("form-control", (_a4 = {}, _a4["form-control-".concat(size)] = size, _a4["is-invalid"] = invalid, _a4["is-valid"] = valid, _a4), className), id, type: showPassword ? "text" : "password", onChange: function(event) {
        return delay ? setValue(event) : onChange === null || onChange === void 0 ? void 0 : onChange(event);
      } }, rest, { ref }), children2),
      import_react128.default.createElement(
        "button",
        { type: "button", className: "form-password-action", "data-coreui-toggle": "password", "aria-label": ariaLabelToggler, onClick: function() {
          return setShowPassword(function(prev) {
            return !prev;
          });
        } },
        import_react128.default.createElement("span", { className: "form-password-action-icon" })
      )
    );
  };
  return import_react128.default.createElement(CFormControlWrapper, { describedby: rest["aria-describedby"], feedback, feedbackInvalid, feedbackValid, floatingClassName: classNames("form-password", floatingClassName), floatingLabel, id, invalid, label, text, tooltipFeedback, valid }, floatingLabel ? renderInputAndButton() : import_react128.default.createElement("div", { className: "form-password" }, renderInputAndButton()));
});
CPasswordInput.propTypes = __assign({ ariaLabelToggler: import_prop_types114.default.string, className: import_prop_types114.default.string, id: import_prop_types114.default.string, delay: import_prop_types114.default.oneOfType([import_prop_types114.default.bool, import_prop_types114.default.number]), showPassword: import_prop_types114.default.bool, size: import_prop_types114.default.oneOf(["sm", "lg"]) }, CFormControlWrapper.propTypes);
...
var CPagination = (0, import_react129.forwardRef)(function(_a3, ref) {
  var _b3;
  var children2 = _a3.children, align = _a3.align, className = _a3.className, size = _a3.size, rest = __rest(_a3, ["children", "align", "className", "size"]);
  return import_react129.default.createElement(
    "nav",
    __assign({ ref }, rest),
    import_react129.default.createElement("ul", { className: classNames("pagination", (_b3 = {}, _b3["justify-content-".concat(align)] = align, _b3["pagination-".concat(size)] = size, _b3), className) }, children2)
  );
});
CPagination.propTypes = {
  align: import_prop_types115.default.oneOf(["start", "center", "end"]),
  children: import_prop_types115.default.node,
  className: import_prop_types115.default.string,
  size: import_prop_types115.default.oneOf(["sm", "lg"])
};
...
var CPaginationItem = (0, import_react130.forwardRef)(function(_a3, ref) {
  var children2 = _a3.children, as = _a3.as, className = _a3.className, rest = __rest(_a3, ["children", "as", "className"]);
  var Component = as !== null && as !== void 0 ? as : rest.active ? "span" : "a";
  return import_react130.default.createElement("li", __assign({ className: classNames("page-item", {
    active: rest.active,
    disabled: rest.disabled
  }, className) }, rest.active && { "aria-current": "page" }), Component === "a" ? import_react130.default.createElement(CLink, __assign({ className: "page-link", as: Component }, rest, { ref }), children2) : import_react130.default.createElement(Component, { className: "page-link", ref }, children2));
});
...
var CPlaceholder = (0, import_react131.forwardRef)(function(_a3, ref) {
  var _b3;
  var children2 = _a3.children, animation = _a3.animation, _c3 = _a3.as, Component = _c3 === void 0 ? "span" : _c3, className = _a3.className, color = _a3.color, size = _a3.size, rest = __rest(_a3, ["children", "animation", "as", "className", "color", "size"]);
  var repsonsiveClassNames = [];
  ...
  return import_react131.default.createElement(Component, __assign({ className: classNames(animation ? "placeholder-".concat(animation) : "placeholder", (_b3 = {}, _b3["bg-".concat(color)] = color, _b3["placeholder-".concat(size)] = size, _b3), repsonsiveClassNames, className) }, rest, { ref }), children2);
});
CPlaceholder.propTypes = {
  animation: import_prop_types117.default.oneOf(["glow", "wave"]),
  ...
  color: colorPropType,
  size: import_prop_types117.default.oneOf(["xs", "sm", "lg"])
};
...
// node_modules/@coreui/react-pro/dist/esm/components/progress/CProgressStackedContext.js
var import_react132 = __toESM(require_react());
var CProgressStackedContext = (0, import_react132.createContext)({});
...
var CProgressBar = (0, import_react133.forwardRef)(function(_a3, ref) {
  var _b3;
  var children2 = _a3.children, animated = _a3.animated, className = _a3.className, color = _a3.color, _c3 = _a3.value, value = _c3 === void 0 ? 0 : _c3, variant = _a3.variant, rest = __rest(_a3, ["children", "animated", "className", "color", "value", "variant"]);
  var stacked = (0, import_react133.useContext)(CProgressStackedContext).stacked;
  return import_react133.default.createElement("div", __assign({ className: classNames("progress-bar", (_b3 = {}, _b3["bg-".concat(color)] = color, _b3["progress-bar-".concat(variant)] = variant, _b3["progress-bar-animated"] = animated, _b3), className) }, !stacked && { style: { width: "".concat(value, "%") } }, rest, { ref }), children2);
});
CProgressBar.propTypes = {
  animated: import_prop_types118.default.bool,
  children: import_prop_types118.default.node,
  className: import_prop_types118.default.string,
  color: import_prop_types118.default.oneOfType([colorPropType, gradientsPropType]),
  value: import_prop_types118.default.number,
  variant: import_prop_types118.default.oneOf(["striped"])
};
CProgressBar.displayName = "CProgressBar";

// node_modules/@coreui/react-pro/dist/esm/components/progress/CProgress.js
var CProgress = (0, import_react134.forwardRef)(function(_a3, ref) {
  var children2 = _a3.children, className = _a3.className, height = _a3.height, progressBarClassName = _a3.progressBarClassName, thin = _a3.thin, value = _a3.value, white = _a3.white, rest = __rest(_a3, ["children", "className", "height", "progressBarClassName", "thin", "value", "white"]);
  var stacked = (0, import_react134.useContext)(CProgressStackedContext).stacked;
  return import_react134.default.createElement("div", __assign({ className: classNames("progress", {
    "progress-thin": thin,
    ...
    "aria-valuemin": 0,
    "aria-valuemax": 100
  }, { style: __assign(__assign({}, height ? { height: "".concat(height, "px") } : {}), stacked ? { width: "".concat(value, "%") } : {}), ref }), import_react134.default.Children.toArray(children2).some(
    // @ts-expect-error displayName is set in the CProgressBar component
    function(child) {
      return child.type && child.type.displayName === "CProgressBar";
    }
  ) ? import_react134.default.Children.map(children2, function(child) {
    if (import_react134.default.isValidElement(child) && child.type.displayName === "CProgressBar") {
      return import_react134.default.cloneElement(child, __assign(__assign({}, value && { value }), rest));
    }
    return;
  }) : import_react134.default.createElement(CProgressBar, __assign({}, progressBarClassName && { className: progressBarClassName }, { value }, rest), children2));
});
CProgress.propTypes = {
  children: import_prop_types119.default.node,
  className: import_prop_types119.default.string,
  height: import_prop_types119.default.number,
  progressBarClassName: import_prop_types119.default.string,
  thin: import_prop_types119.default.bool,
  value: import_prop_types119.default.number,
  white: import_prop_types119.default.bool
};
...
var CProgressStacked = (0, import_react135.forwardRef)(function(_a3, ref) {
  var children2 = _a3.children, className = _a3.className, rest = __rest(_a3, ["children", "className"]);
  return import_react135.default.createElement(
    "div",
    __assign({ className: classNames("progress-stacked", className), ref }, rest),
    import_react135.default.createElement(CProgressStackedContext.Provider, { value: {
      stacked: true
    } }, children2)
  );
});
...
// node_modules/@coreui/react-pro/dist/esm/components/popover/CPopover.js
var CPopover = (0, import_react136.forwardRef)(function(_a3, ref) {
  var children2 = _a3.children, _b3 = _a3.animation, animation = _b3 === void 0 ? true : _b3, className = _a3.className, container = _a3.container, content = _a3.content, _c3 = _a3.delay, delay = _c3 === void 0 ? 0 : _c3, _d3 = _a3.fallbackPlacements, fallbackPlacements = _d3 === void 0 ? ["top", "right", "bottom", "left"] : _d3, _e3 = _a3.offset, offset = _e3 === void 0 ? [0, 8] : _e3, onHide = _a3.onHide, onShow = _a3.onShow, _f3 = _a3.placement, placement = _f3 === void 0 ? "top" : _f3, popperConfig = _a3.popperConfig, title = _a3.title, _g2 = _a3.trigger, trigger = _g2 === void 0 ? "click" : _g2, visible = _a3.visible, rest = __rest(_a3, ["children", "animation", "className", "container", "content", "delay", "fallbackPlacements", "offset", "onHide", "onShow", "placement", "popperConfig", "title", "trigger", "visible"]);
  var popoverRef = (0, import_react136.useRef)(null);
  var togglerRef = (0, import_react136.useRef)(null);
  var forkedRef = useForkedRef(ref, popoverRef);
  var id = "popover".concat((0, import_react136.useId)());
  var _h2 = (0, import_react136.useState)(false), mounted = _h2[0], setMounted = _h2[1];
  var _j2 = (0, import_react136.useState)(visible), _visible = _j2[0], setVisible = _j2[1];
  ...
  return import_react136.default.createElement(
    ...
    null,
    import_react136.default.cloneElement(children2, __assign(__assign(__assign(__assign(__assign({}, _visible && {
      "aria-describedby": id
    ...
    import_react136.default.createElement(CConditionalPortal, { container, portal: true }, mounted && import_react136.default.createElement(
      "div",
      __assign({ className: classNames("popover", "bs-popover-auto", {
        fade: animation,
        show: _visible
      }, className), id, ref: forkedRef, role: "tooltip" }, rest),
      import_react136.default.createElement("div", { className: "popover-arrow" }),
      import_react136.default.createElement("div", { className: "popover-header" }, title),
      import_react136.default.createElement("div", { className: "popover-body" }, content)
    ))
  );
});
CPopover.propTypes = {
  animation: import_prop_types121.default.bool,
  children: import_prop_types121.default.node,
  className: import_prop_types121.default.string,
  container: import_prop_types121.default.any,
  content: import_prop_types121.default.oneOfType([import_prop_types121.default.string, import_prop_types121.default.node]),
  delay: import_prop_types121.default.oneOfType([
    import_prop_types121.default.number,
    import_prop_types121.default.shape({
      show: import_prop_types121.default.number.isRequired,
      hide: import_prop_types121.default.number.isRequired
    })
  ]),
  fallbackPlacements: fallbackPlacementsPropType,
  offset: import_prop_types121.default.any,
  // TODO: find good proptype
  onHide: import_prop_types121.default.func,
  onShow: import_prop_types121.default.func,
  placement: import_prop_types121.default.oneOf(["auto", "top", "right", "bottom", "left"]),
  popperConfig: import_prop_types121.default.oneOfType([import_prop_types121.default.func, import_prop_types121.default.object]),
  title: import_prop_types121.default.oneOfType([import_prop_types121.default.string, import_prop_types121.default.node]),
  trigger: triggerPropType,
...
var getNearestValueIndex = function(value, values2) {
  var valuesLength = values2.length;
  if (value < values2[0]) {
    return 0;
  }
  if (value > values2[valuesLength - 1]) {
    return valuesLength - 1;
  }
  var distances = values2.map(function(v) {
    return Math.abs(v - value);
  });
  var min = Math.min.apply(Math, distances);
  var firstIndex = distances.indexOf(min);
  return value < values2[firstIndex] ? firstIndex : distances.lastIndexOf(min);
};
...
var updateGradient = function(min, max, values2, vertical, rtl) {
  var minVal = Math.min.apply(Math, values2);
  var maxVal = Math.max.apply(Math, values2);
  var from = (minVal - min) / (max - min) * 100;
  var to = (maxVal - min) / (max - min) * 100;
  var direction = vertical ? "to top" : rtl ? "to left" : "to right";
  return {
    backgroundImage: values2.length === 1 ? "linear-gradient(\n    ".concat(direction, ",\n    var(--cui-range-slider-track-in-range-bg) 0%,\n    var(--cui-range-slider-track-in-range-bg) ").concat(to, "%,\n    transparent ").concat(to, "%,\n    transparent 100%\n  )") : "linear-gradient(\n    ".concat(direction, ",\n    transparent 0%,\n    transparent ").concat(from, "%,\n    var(--cui-range-slider-track-in-range-bg) ").concat(from, "%,\n    var(--cui-range-slider-track-in-range-bg) ").concat(to, "%,\n    transparent ").concat(to, "%,\n    transparent 100%\n  )")
  };
};
var updateValue = function(value, values2, distance, index) {
  var newValue = __spreadArray([], values2, true);
  newValue[index] = validateValue(value, values2, distance, index);
  return newValue;
};
var validateValue = function(value, values2, distance, index) {
  if (values2.length === 1) {
    return value;
  }
  var prevValue = index > 0 ? values2[index - 1] : void 0;
  var nextValue = index < values2.length - 1 ? values2[index + 1] : void 0;
  if (index === 0 && nextValue !== void 0) {
    return Math.min(value, nextValue - distance);
  }
  if (index === values2.length - 1 && prevValue !== void 0) {
...
// node_modules/@coreui/react-pro/dist/esm/components/range-slider/CRangeSlider.js
var CRangeSlider = (0, import_react137.forwardRef)(function(_a3, ref) {
  ...
  var rangeSliderRef = (0, import_react137.useRef)(null);
  var forkedRef = useForkedRef(ref, rangeSliderRef);
  var inputsRef = (0, import_react137.useRef)([]);
  var labelsContainerRef = (0, import_react137.useRef)(null);
  var labelsRef = (0, import_react137.useRef)([]);
  var trackRef = (0, import_react137.useRef)(null);
  var _m2 = (0, import_react137.useState)(Array.isArray(value) ? value : [value]), currentValue = _m2[0], setCurrentValue = _m2[1];
  var _o = (0, import_react137.useState)(false), isDragging = _o[0], setIsDragging = _o[1];
  var _p = (0, import_react137.useState)(false), _isRTL = _p[0], setIsRTL = _p[1];
  var _q = (0, import_react137.useState)(0), dragIndex = _q[0], setDragIndex = _q[1];
  var _r = (0, import_react137.useState)(), thumbSize = _r[0], setThumbSize = _r[1];
  ...
  var handleLabelClick = function(event, value2) {
    ...
    import_react137.default.createElement(
      ...
      currentValue.map(function(value2, index) {
        return import_react137.default.createElement(
          ...
          { key: index },
          import_react137.default.createElement("input", { className: "range-slider-input", type: "range", min, max, step, value: value2, name: Array.isArray(name) ? name[index] : "".concat(name || "", "-").concat(index, "}"), role: "slider", "aria-valuemin": min, "aria-valuemax": max, "aria-valuenow": value2, "aria-orientation": vertical ? "vertical" : "horizontal", disabled, onChange: function(event) {
            return handleInputChange(event, index);
          }, ref: function(el) {
            inputsRef.current[index] = el;
          } }),
          tooltips && import_react137.default.createElement(
            "div",
            __assign({ className: "range-slider-tooltip" }, thumbSize && {
              style: calculateTooltipPosition(min, max, value2, thumbSize, vertical, _isRTL)
            }),
            import_react137.default.createElement("div", { className: "range-slider-tooltip-inner" }, tooltipsFormat ? tooltipsFormat(value2) : value2),
            import_react137.default.createElement("div", { className: "range-slider-tooltip-arrow" })
          )
        );
      }),
      import_react137.default.createElement("div", __assign({ className: "range-slider-track" }, track && {
        style: updateGradient(min, max, currentValue, vertical, _isRTL)
      }, { ref: trackRef }))
    ),
    labels && import_react137.default.createElement("div", { className: "range-slider-labels-container", ref: labelsContainerRef }, Array.isArray(labels) && labels.map(function(label, index) {
      ...
      var labelStyle = Object.assign(vertical ? { bottom: labelPosition } : _isRTL ? { right: labelPosition } : { left: labelPosition }, typeof label === "object" && "style" in label && label.style);
      return import_react137.default.createElement("div", { className: classNames("range-slider-label", {
        clickable: clickableLabels
      }, typeof label === "object" && "className" in label && label.className), style: labelStyle, onMouseDown: function(event) {
...
CRangeSlider.propTypes = {
  clickableLabels: import_prop_types122.default.bool,
  disabled: import_prop_types122.default.bool,
  distance: import_prop_types122.default.number,
  labels: import_prop_types122.default.any,
  max: import_prop_types122.default.number,
  min: import_prop_types122.default.number,
  name: import_prop_types122.default.oneOfType([import_prop_types122.default.array, import_prop_types122.default.string]),
  step: import_prop_types122.default.number,
  tooltips: import_prop_types122.default.bool,
  tooltipsFormat: import_prop_types122.default.func,
  track: import_prop_types122.default.oneOfType([import_prop_types122.default.bool, import_prop_types122.default.oneOf(["fill"])]),
  value: import_prop_types122.default.oneOfType([import_prop_types122.default.array, import_prop_types122.default.number]),
  vertical: import_prop_types122.default.bool
};
...
var CTooltip = (0, import_react138.forwardRef)(function(_a3, ref) {
  var children2 = _a3.children, _b3 = _a3.animation, animation = _b3 === void 0 ? true : _b3, className = _a3.className, container = _a3.container, content = _a3.content, _c3 = _a3.delay, delay = _c3 === void 0 ? 0 : _c3, _d3 = _a3.fallbackPlacements, fallbackPlacements = _d3 === void 0 ? ["top", "right", "bottom", "left"] : _d3, _e3 = _a3.offset, offset = _e3 === void 0 ? [0, 6] : _e3, onHide = _a3.onHide, onShow = _a3.onShow, _f3 = _a3.placement, placement = _f3 === void 0 ? "top" : _f3, popperConfig = _a3.popperConfig, _g2 = _a3.trigger, trigger = _g2 === void 0 ? ["hover", "focus"] : _g2, visible = _a3.visible, rest = __rest(_a3, ["children", "animation", "className", "container", "content", "delay", "fallbackPlacements", "offset", "onHide", "onShow", "placement", "popperConfig", "trigger", "visible"]);
  var tooltipRef = (0, import_react138.useRef)(null);
  var togglerRef = (0, import_react138.useRef)(null);
  var forkedRef = useForkedRef(ref, tooltipRef);
  var id = "tooltip".concat((0, import_react138.useId)());
  var _h2 = (0, import_react138.useState)(false), mounted = _h2[0], setMounted = _h2[1];
  var _j2 = (0, import_react138.useState)(visible), _visible = _j2[0], setVisible = _j2[1];
  ...
  return import_react138.default.createElement(
    ...
    null,
    import_react138.default.cloneElement(children2, __assign(__assign(__assign(__assign(__assign({}, _visible && {
      "aria-describedby": id
    }), { ref: togglerRef }), (trigger === "click" || trigger.includes("click")) && {
      onClick: function() {
        return _visible ? handleHide() : handleShow();
    ...
    import_react138.default.createElement(CConditionalPortal, { container, portal: true }, mounted && import_react138.default.createElement(
      "div",
      __assign({ className: classNames("tooltip", "bs-tooltip-auto", {
        fade: animation,
        show: _visible
      }, className), id, ref: forkedRef, role: "tooltip" }, rest),
      import_react138.default.createElement("div", { className: "tooltip-arrow" }),
      import_react138.default.createElement("div", { className: "tooltip-inner" }, content)
    ))
  );
});
CTooltip.propTypes = {
  animation: import_prop_types123.default.bool,
  children: import_prop_types123.default.node,
  container: import_prop_types123.default.any,
  content: import_prop_types123.default.oneOfType([import_prop_types123.default.string, import_prop_types123.default.node]),
  delay: import_prop_types123.default.oneOfType([
    import_prop_types123.default.number,
    import_prop_types123.default.shape({
      show: import_prop_types123.default.number.isRequired,
      hide: import_prop_types123.default.number.isRequired
    })
  ]),
  fallbackPlacements: fallbackPlacementsPropType,
  offset: import_prop_types123.default.any,
  // TODO: find good proptype
  onHide: import_prop_types123.default.func,
  onShow: import_prop_types123.default.func,
  placement: import_prop_types123.default.oneOf(["auto", "top", "right", "bottom", "left"]),
  popperConfig: import_prop_types123.default.oneOfType([import_prop_types123.default.func, import_prop_types123.default.object]),
  trigger: triggerPropType,
...
var CConditionalTooltip = function(_a3) {
  var children2 = _a3.children, content = _a3.content, tooltip = _a3.tooltip;
  return tooltip ? import_react139.default.createElement(
    CTooltip,
    { content },
    import_react139.default.createElement("span", null, children2)
  ) : children2;
};
var CRating = (0, import_react139.forwardRef)(function(_a3, ref) {
  var _b3;
  ...
  var _e3 = (0, import_react139.useState)(false), cleared = _e3[0], setCleared = _e3[1];
  var _f3 = (0, import_react139.useState)(value !== null && value !== void 0 ? value : null), currentValue = _f3[0], setCurrentValue = _f3[1];
  var _g2 = (0, import_react139.useState)(null), hoverValue = _g2[0], setHoverValue = _g2[1];
  var _h2 = (0, import_react139.useState)(null), tooltipValue = _h2[0], setTooltipValue = _h2[1];
  var _name = name || (0, import_react139.useId)();
  ...
  return import_react139.default.createElement("div", __assign({ className: classNames("rating", (_b3 = {}, _b3["rating-".concat(size)] = size, _b3.disabled = disabled, _b3.readonly = readOnly, _b3), className), role: "radiogroup" }, rest, { ref }), Array.from({ length: itemCount }, function(_, index) {
    ...
    return import_react139.default.createElement(
      ...
      import_react139.default.createElement("div", { className: "rating-item" }, Array.from({ length: numberOfRadios }, function(_2, _index) {
        var _a4, _b4;
        var isNotLastItem = _index + 1 < numberOfRadios;
        var value2 = numberOfRadios === 1 ? index + 1 : index + (_index + 1) * (1 * precision);
        var id = (0, import_react139.useId)();
        ...
        return import_react139.default.createElement(
          ...
          import_react139.default.createElement(
            ...
            icon ? import_react139.default.createElement("div", { className: "rating-item-custom-icon" }, (_a4 = icon[value2]) !== null && _a4 !== void 0 ? _a4 : icon) : import_react139.default.createElement("div", { className: "rating-item-icon" }),
            activeIcon && import_react139.default.createElement("div", { className: "rating-item-custom-icon-active" }, (_b4 = activeIcon[value2]) !== null && _b4 !== void 0 ? _b4 : activeIcon)
          ),
          import_react139.default.createElement("input", { className: "rating-item-input", checked: isItemChecked(), disabled: disabled || readOnly, id, name: _name, onBlur: function() {
            return handleMouseLeave();
          }, onChange: function() {
...
CRating.propTypes = {
  ...
  activeIcon: import_prop_types124.default.any,
  allowClear: import_prop_types124.default.bool,
  disabled: import_prop_types124.default.bool,
  highlightOnlySelected: import_prop_types124.default.bool,
  icon: import_prop_types124.default.any,
  itemCount: import_prop_types124.default.number,
  name: import_prop_types124.default.string,
  onChange: import_prop_types124.default.func,
  onHover: import_prop_types124.default.func,
  precision: import_prop_types124.default.number,
  readOnly: import_prop_types124.default.bool,
  size: import_prop_types124.default.oneOf(["sm", "lg", "custom"]),
...
var PropTypes125 = getDefaultExportFromCjs2(propTypesExports);
...
var CIcon = (0, import_react140.forwardRef)(function(_a3, ref) {
  var _b3;
  ...
  var _c3 = (0, import_react140.useState)(0), change = _c3[0], setChange = _c3[1];
  ...
  (0, import_react140.useMemo)(function() {
    return setChange(change + 1);
  }, [_icon, JSON.stringify(_icon)]);
  var titleCode = title ? "<title>".concat(title, "</title>") : "";
  var code = (0, import_react140.useMemo)(function() {
    var iconName = _icon && typeof _icon === "string" && _icon.includes("-") ? toCamelCase(_icon) : _icon;
    if (Array.isArray(_icon)) {
      return _icon;
    }
    if (typeof _icon === "string" && import_react140.default["icons"]) {
      return import_react140.default[iconName];
    }
  }, [change]);
  var iconCode = (0, import_react140.useMemo)(function() {
  ...
  return import_react140.default.createElement(
    ...
    null,
    use ? import_react140.default.createElement(
      "svg",
      ...
      import_react140.default.createElement("use", { href: use })
    ) : import_react140.default.createElement("svg", __assign2({ xmlns: "http://www.w3.org/2000/svg", viewBox, className: _className }, height && { height }, width && { width }, { role: "img", "aria-hidden": "true", dangerouslySetInnerHTML: { __html: titleCode + iconCode } }, rest, { ref })),
    title && import_react140.default.createElement("span", { className: "visually-hidden" }, title)
  );
});
CIcon.propTypes = {
  className: PropTypes125.string,
  content: PropTypes125.oneOfType([PropTypes125.array, PropTypes125.string]),
  customClassName: PropTypes125.string,
  height: PropTypes125.number,
  icon: PropTypes125.oneOfType([PropTypes125.array, PropTypes125.string]),
  name: PropTypes125.string,
  size: PropTypes125.oneOf([
    "custom",
    "custom-size",
    "sm",
    "lg",
  ...
  title: PropTypes125.string,
  use: PropTypes125.string,
  viewBox: PropTypes125.string,
  width: PropTypes125.number
};
CIcon.displayName = "CIcon";
var CIconSvg = (0, import_react140.forwardRef)(function(_a3, ref) {
  var _b3;
  var children2 = _a3.children, className = _a3.className, customClassName = _a3.customClassName, height = _a3.height, size = _a3.size, title = _a3.title, width = _a3.width, rest = __rest2(_a3, ["children", "className", "customClassName", "height", "size", "title", "width"]);
  var _className = customClassName ? classNames2(customClassName) : classNames2("icon", (_b3 = {}, _b3["icon-".concat(size)] = size, _b3["icon-custom-size"] = height || width, _b3), className);
  return import_react140.default.createElement(
    import_react140.default.Fragment,
    null,
    import_react140.Children.map(children2, function(child) {
      if (import_react140.default.isValidElement(child)) {
        return import_react140.default.cloneElement(child, __assign2({ "aria-hidden": true, className: _className, focusable: "false", ref, role: "img" }, rest));
      }
      return;
    }),
    title && import_react140.default.createElement("span", { className: "visually-hidden" }, title)
...
var CSmartPagination = (0, import_react141.forwardRef)(function(_a3, ref) {
  var className = _a3.className, _b3 = _a3.activePage, activePage = _b3 === void 0 ? 1 : _b3, _c3 = _a3.align, align = _c3 === void 0 ? "start" : _c3, _d3 = _a3.arrows, arrows = _d3 === void 0 ? true : _d3, _e3 = _a3.dots, dots = _e3 === void 0 ? true : _e3, _f3 = _a3.doubleArrows, doubleArrows = _f3 === void 0 ? true : _f3, _g2 = _a3.firstButton, firstButton = _g2 === void 0 ? import_react141.default.createElement(import_react141.default.Fragment, null, "«") : _g2, _h2 = _a3.lastButton, lastButton = _h2 === void 0 ? import_react141.default.createElement(import_react141.default.Fragment, null, "»") : _h2, _j2 = _a3.limit, limit = _j2 === void 0 ? 5 : _j2, _k2 = _a3.nextButton, nextButton = _k2 === void 0 ? import_react141.default.createElement(import_react141.default.Fragment, null, "›") : _k2, onActivePageChange = _a3.onActivePageChange, pages = _a3.pages, _l2 = _a3.previousButton, previousButton = _l2 === void 0 ? import_react141.default.createElement(import_react141.default.Fragment, null, "‹") : _l2, size = _a3.size, rest = __rest(_a3, ["className", "activePage", "align", "arrows", "dots", "doubleArrows", "firstButton", "lastButton", "limit", "nextButton", "onActivePageChange", "pages", "previousButton", "size"]);
  ...
  return import_react141.default.createElement(
    ...
    doubleArrows && import_react141.default.createElement(CPaginationItem, { onClick: function() {
      return setPage(1);
    }, "aria-label": "Go to first page", "aria-disabled": activePage === 1, disabled: activePage === 1 }, firstButton),
    arrows && import_react141.default.createElement(CPaginationItem, { onClick: function() {
    ...
    beforeDots && import_react141.default.createElement(CPaginationItem, { role: "separator", disabled: true }, "…"),
    items.map(function(i) {
      return import_react141.default.createElement(CPaginationItem, { onClick: function() {
        return setPage(i);
      }, "aria-label": activePage === i ? "Current page ".concat(i) : "Go to page ".concat(i), active: activePage === i, key: i }, i);
    }),
    afterDots && import_react141.default.createElement(CPaginationItem, { role: "separator", disabled: true }, "…"),
    arrows && import_react141.default.createElement(CPaginationItem, { onClick: function() {
      return setPage(activePage + 1);
...
CSmartPagination.propTypes = {
  className: import_prop_types125.default.oneOfType([import_prop_types125.default.string]),
  activePage: import_prop_types125.default.number,
  dots: import_prop_types125.default.bool,
  arrows: import_prop_types125.default.bool,
  doubleArrows: import_prop_types125.default.bool,
  firstButton: import_prop_types125.default.oneOfType([import_prop_types125.default.node, import_prop_types125.default.string]),
  previousButton: import_prop_types125.default.oneOfType([import_prop_types125.default.node, import_prop_types125.default.string]),
  nextButton: import_prop_types125.default.oneOfType([import_prop_types125.default.node, import_prop_types125.default.string]),
  lastButton: import_prop_types125.default.oneOfType([import_prop_types125.default.node, import_prop_types125.default.string]),
  size: import_prop_types125.default.oneOf(["sm", "lg"]),
  align: import_prop_types125.default.oneOf(["start", "center", "end"]),
  limit: import_prop_types125.default.number,
  pages: import_prop_types125.default.number.isRequired,
  onActivePageChange: import_prop_types125.default.func
};
...
var CTableHead = (0, import_react142.forwardRef)(function(_a3, ref) {
  var _b3;
  var children2 = _a3.children, className = _a3.className, color = _a3.color, rest = __rest(_a3, ["children", "className", "color"]);
  return import_react142.default.createElement("thead", __assign({ className: classNames((_b3 = {}, _b3["table-".concat(color)] = color, _b3), className) || void 0 }, rest, { ref }), children2);
});
...
var CTableHeaderCell = (0, import_react143.forwardRef)(function(_a3, ref) {
  var _b3;
  var children2 = _a3.children, className = _a3.className, color = _a3.color, rest = __rest(_a3, ["children", "className", "color"]);
  return import_react143.default.createElement("th", __assign({ className: classNames((_b3 = {}, _b3["table-".concat(color)] = color, _b3), className) || void 0 }, rest, { ref }), children2);
});
...
var CTableBody = (0, import_react144.forwardRef)(function(_a3, ref) {
  var _b3;
  var children2 = _a3.children, className = _a3.className, color = _a3.color, rest = __rest(_a3, ["children", "className", "color"]);
  return import_react144.default.createElement("tbody", __assign({ className: classNames((_b3 = {}, _b3["table-".concat(color)] = color, _b3), className) || void 0 }, rest, { ref }), children2);
});
...
var CTableDataCell = (0, import_react145.forwardRef)(function(_a3, ref) {
  var _b3;
  var children2 = _a3.children, active = _a3.active, align = _a3.align, className = _a3.className, color = _a3.color, rest = __rest(_a3, ["children", "active", "align", "className", "color"]);
  var Component = rest.scope ? "th" : "td";
  return import_react145.default.createElement(Component, __assign({ className: classNames((_b3 = {}, _b3["align-".concat(align)] = align, _b3["table-active"] = active, _b3["table-".concat(color)] = color, _b3), className) || void 0 }, rest, { ref }), children2);
});
CTableDataCell.propTypes = {
  active: import_prop_types129.default.bool,
  align: import_prop_types129.default.oneOf(["bottom", "middle", "top"]),
...
var CTableRow = (0, import_react146.forwardRef)(function(_a3, ref) {
  var _b3;
  var children2 = _a3.children, active = _a3.active, align = _a3.align, className = _a3.className, color = _a3.color, rest = __rest(_a3, ["children", "active", "align", "className", "color"]);
  return import_react146.default.createElement("tr", __assign({ className: classNames((_b3 = {}, _b3["align-".concat(align)] = align, _b3["table-active"] = active, _b3["table-".concat(color)] = color, _b3), className) || void 0 }, rest, { ref }), children2);
});
CTableRow.propTypes = {
  active: import_prop_types130.default.bool,
  align: import_prop_types130.default.oneOf(["bottom", "middle", "top"]),
...
var CTableFoot = (0, import_react147.forwardRef)(function(_a3, ref) {
  var _b3;
  var children2 = _a3.children, className = _a3.className, color = _a3.color, rest = __rest(_a3, ["children", "className", "color"]);
  return import_react147.default.createElement("tfoot", __assign({ className: classNames((_b3 = {}, _b3["table-".concat(color)] = color, _b3), className) || void 0 }, rest, { ref }), children2);
});
...
var CTableCaption = (0, import_react148.forwardRef)(function(_a3, ref) {
  var children2 = _a3.children, props = __rest(_a3, ["children"]);
  return import_react148.default.createElement("caption", __assign({}, props, { ref }), children2);
});
...
var CTableResponsiveWrapper = function(_a3) {
  var children2 = _a3.children, responsive = _a3.responsive, rest = __rest(_a3, ["children", "responsive"]);
  return responsive ? import_react149.default.createElement("div", __assign({ className: typeof responsive === "boolean" ? "table-responsive" : "table-responsive-".concat(responsive) }, rest), children2) : import_react149.default.createElement(import_react149.default.Fragment, null, children2);
};
CTableResponsiveWrapper.propTypes = {
  children: import_prop_types133.default.node,
  responsive: import_prop_types133.default.oneOfType([
    import_prop_types133.default.bool,
    import_prop_types133.default.oneOf(["sm", "md", "lg", "xl", "xxl"])
  ])
};
...
var CTable = (0, import_react150.forwardRef)(function(_a3, ref) {
  ...
  return import_react150.default.createElement(
    ...
    import_react150.default.createElement(
      ...
      (caption && caption !== "top" || captionTop) && import_react150.default.createElement(CTableCaption, null, caption || captionTop),
      columns && import_react150.default.createElement(
        CTableHead,
        __assign({}, tableHeadProps),
        import_react150.default.createElement(CTableRow, null, columns.map(function(column, index) {
          return import_react150.default.createElement(CTableHeaderCell, __assign({}, column._props && __assign({}, column._props), column._style && { style: __assign({}, column._style) }, { key: index }), getColumnLabel(column));
        }))
      ),
      items && import_react150.default.createElement(CTableBody, null, items.map(function(item, index) {
        return import_react150.default.createElement(CTableRow, __assign({}, item._props && __assign({}, item._props), { key: index }), columnNames && columnNames.map(function(colName, index2) {
          return item[colName] !== void 0 ? import_react150.default.createElement(CTableDataCell, __assign({}, item._cellProps && __assign(__assign({}, item._cellProps["all"] && __assign({}, item._cellProps["all"])), item._cellProps[colName] && __assign({}, item._cellProps[colName])), { key: index2 }), item[colName]) : null;
        }));
      })),
      children2,
      footer && import_react150.default.createElement(
        CTableFoot,
        __assign({}, tableFootProps),
        import_react150.default.createElement(CTableRow, null, footer.map(function(item, index) {
          return import_react150.default.createElement(CTableDataCell, __assign({}, typeof item === "object" && item._props && __assign({}, item._props), { key: index }), typeof item === "object" ? item.label : item);
        }))
      )
    )
  );
...
CTable.propTypes = {
  align: import_prop_types134.default.oneOf(["bottom", "middle", "top"]),
  borderColor: import_prop_types134.default.string,
  bordered: import_prop_types134.default.bool,
  borderless: import_prop_types134.default.bool,
  caption: import_prop_types134.default.oneOfType([import_prop_types134.default.string, import_prop_types134.default.oneOf(["top"])]),
  captionTop: import_prop_types134.default.string,
  ...
  footer: import_prop_types134.default.array,
  hover: import_prop_types134.default.bool,
  items: import_prop_types134.default.array,
  responsive: import_prop_types134.default.oneOfType([
    import_prop_types134.default.bool,
    import_prop_types134.default.oneOf(["sm", "md", "lg", "xl", "xxl"])
  ]),
  small: import_prop_types134.default.bool,
  striped: import_prop_types134.default.bool,
  stripedColumns: import_prop_types134.default.bool,
  tableFootProps: import_prop_types134.default.shape(__assign({}, CTableFoot.propTypes)),
  tableHeadProps: import_prop_types134.default.shape(__assign({}, CTableHead.propTypes))
};
...
var getColumnGroups = function(columns) {
  ...
  var traverseColumns = function(column2, deep2, colSpan) {
    ...
    if (typeof column2 === "object" && column2.group) {
      var children2 = column2.children, group = column2.group, rest2 = __rest(column2, ["children", "group"]);
      groups2.push(__assign(__assign({ deep: deep2, label: group }, children2 && { colspan: countColumns(children2) }), rest2));
    }
    return groups2;
  };
  if (columns) {
...
// node_modules/@coreui/react-pro/dist/esm/components/smart-table/CSmartTableBody.js
var CSmartTableBody = (0, import_react151.forwardRef)(function(_a3, ref) {
  ...
  var _columns = (0, import_react151.useMemo)(function() {
    return getColumns(columns);
  }, [columns]);
  return import_react151.default.createElement(CTableBody, __assign({}, clickableRows && {
    style: { cursor: "pointer" }
    ...
    return import_react151.default.createElement(
      ...
      import_react151.default.createElement(
        ...
        selectable && import_react151.default.createElement(
          CTableDataCell,
          null,
          import_react151.default.createElement(CFormCheck, { checked: selected && isObjectInArray(selected, item, ITEM_INTERNAL_KEYS), disabled: item._selectable === false, onChange: function(event) {
        ...
        _columns.map(function(column, index) {
          ...
          return scopedColumns && scopedColumns[colName] && import_react151.default.cloneElement(scopedColumns[colName](item, trIndex + firstItemOnActivePageIndex), {
            key: index
          }) || item[colName] !== void 0 && import_react151.default.createElement(CTableDataCell, __assign({}, getTableDataCellProps(column, item, colName), { style: getTableDataCellStyles(column, item, colName), key: index }), item[colName]);
        })
      ),
      scopedColumns && scopedColumns.details && import_react151.default.createElement(
        import_react151.default.Fragment,
        null,
        import_react151.default.createElement(
          CTableRow,
          null,
          import_react151.default.createElement(CTableDataCell, { colSpan: colspan, className: "p-0", style: { borderBottomWidth: 0 }, tabIndex: -1 })
        ),
        import_react151.default.createElement(
          CTableRow,
          { className: "p-0", key: "details".concat(trIndex) },
          import_react151.default.createElement(CTableDataCell, { colSpan: colspan, className: "p-0", style: { border: 0 } }, scopedColumns.details(item, trIndex + firstItemOnActivePageIndex))
        )
      )
    );
  }) : import_react151.default.createElement(
    CTableRow,
    null,
    import_react151.default.createElement(CTableDataCell, { colSpan: colspan }, noItemsLabel)
  ));
});
CSmartTableBody.propTypes = {
  clickableRows: import_prop_types135.default.bool,
  columns: import_prop_types135.default.array.isRequired,
  currentItems: import_prop_types135.default.array.isRequired,
  firstItemOnActivePageIndex: import_prop_types135.default.number.isRequired,
  noItemsLabel: import_prop_types135.default.oneOfType([import_prop_types135.default.string, import_prop_types135.default.node]),
  onRowChecked: import_prop_types135.default.func,
  onRowClick: import_prop_types135.default.func,
  columnNames: import_prop_types135.default.array.isRequired,
  scopedColumns: import_prop_types135.default.object,
  selectable: import_prop_types135.default.bool,
  selected: import_prop_types135.default.array
};
...
var CSmartTableHead = (0, import_react152.forwardRef)(function(_a3, ref) {
  ...
  var selectAllcheckboxRef = (0, import_react152.useRef)(null);
  var _columns = (0, import_react152.useMemo)(function() {
    return getColumns(columns);
  }, [columns]);
  var groups = (0, import_react152.useMemo)(function() {
  ...
  var columnSorterIcon = function(column) {
    if (getColumnSorterState(getColumnKey(column), sorterState) === 0) {
      return import_react152.default.createElement("span", { className: "opacity-25 float-end me-1" }, sortingIcon);
    }
    if (getColumnSorterState(getColumnKey(column), sorterState) === "asc") {
      return import_react152.default.createElement("span", { className: "float-end me-1" }, sortingIconAscending);
    }
    if (getColumnSorterState(getColumnKey(column), sorterState) === "desc") {
      return import_react152.default.createElement("span", { className: "float-end me-1" }, sortingIconDescending);
    }
    return;
  };
  return import_react152.default.createElement(
    ...
    showGroups && groups && groups.length > 0 && groups.map(function(row, index) {
      return import_react152.default.createElement(
        CTableRow,
        { key: index },
        selectable && import_react152.default.createElement(CTableHeaderCell, null),
        row.map(function(cell, index2) {
          return import_react152.default.createElement(CTableHeaderCell, __assign({ colSpan: cell.colspan }, getTableHeaderCellProps(cell), { key: index2 }), cell.label);
        })
      );
    }),
    import_react152.default.createElement(
      CTableRow,
      null,
      selectable && import_react152.default.createElement(CTableHeaderCell, null, selectAll && import_react152.default.createElement(CFormCheck, { checked: typeof selectedAll === "boolean" ? selectedAll : false, indeterminate: selectedAll === "indeterminate" ? true : false, onChange: function() {
      ...
      _columns.map(function(column, index) {
        ...
        return import_react152.default.createElement(
          ...
          import_react152.default.createElement("div", { className: "d-inline" }, getColumnLabel2(column)),
          isSortable2 && columnSorterIcon(column)
        );
      })
    ),
    columnFilter && import_react152.default.createElement(
      CTableRow,
      null,
      selectable && import_react152.default.createElement(CTableHeaderCell, null),
      _columns.map(function(column, index) {
        return import_react152.default.createElement(CTableHeaderCell, __assign({}, getTableHeaderCellProps(column), { key: index }), (typeof column === "object" ? column.filter === void 0 ? true : column.filter : true) ? typeof column !== "string" && typeof column.filter === "function" ? column.filter(getColumnValues(items, getColumnKey(column)), function(value) {
          return handleOnCustomFilterChange && handleOnCustomFilterChange(getColumnKey(column), value);
        }, columnFilterState && columnFilterState[getColumnKey(column)] ? columnFilterState[getColumnKey(column)] : void 0) : import_react152.default.createElement(CFormInput, { size: "sm", onInput: function(event) {
...
CSmartTableHead.propTypes = {
  ...
  columnFilter: import_prop_types136.default.oneOfType([import_prop_types136.default.bool, import_prop_types136.default.object]),
  columnFilterState: import_prop_types136.default.object,
  columnSorter: import_prop_types136.default.oneOfType([import_prop_types136.default.bool, import_prop_types136.default.object]),
  children: import_prop_types136.default.node,
  columns: import_prop_types136.default.arrayOf(import_prop_types136.default.oneOfType([import_prop_types136.default.any, import_prop_types136.default.string])).isRequired,
  // TODO: improve this Prop Type,
  handleOnCustomFilterChange: import_prop_types136.default.func,
  handleFilterOnChange: import_prop_types136.default.func,
  handleFilterOnInput: import_prop_types136.default.func,
  handleSelectAllChecked: import_prop_types136.default.func,
  handleSort: import_prop_types136.default.func,
  items: import_prop_types136.default.array,
  selectable: import_prop_types136.default.bool,
  selectAll: import_prop_types136.default.oneOfType([import_prop_types136.default.bool, import_prop_types136.default.object]),
  selectedAll: import_prop_types136.default.oneOfType([import_prop_types136.default.bool, import_prop_types136.default.string]),
  showGroups: import_prop_types136.default.bool,
  sorterState: import_prop_types136.default.array,
  sortingIcon: import_prop_types136.default.node,
  sortingIconAscending: import_prop_types136.default.node,
  sortingIconDescending: import_prop_types136.default.node
};
...
var CSmartTable = (0, import_react153.forwardRef)(function(_a3, ref) {
  ...
  var sortedItems = (0, import_react153.useMemo)(function() {
  ...
  return import_react153.default.createElement(
    import_react153.default.Fragment,
    null,
    import_react153.default.createElement("div", __assign({}, rest, { ref }), (itemsPerPageSelect || tableFilter || cleaner) && import_react153.default.createElement("div", { className: "row my-2 mx-0" }, (tableFilter || cleaner) && import_react153.default.createElement(
      import_react153.default.Fragment,
      null,
      import_react153.default.createElement("div", { className: "col-auto p-0" }, tableFilter && import_react153.default.createElement(
        "div",
        { className: "row mb-2" },
        import_react153.default.createElement(CFormLabel, { className: "col-sm-auto col-form-label" }, tableFilterLabel),
        import_react153.default.createElement(
          "div",
          { className: "col-sm-auto" },
          import_react153.default.createElement(CFormInput, { onInput: function(e) {
      ...
      import_react153.default.createElement("div", { className: "col-auto p-0" }, cleaner && import_react153.default.createElement(
        "button",
        ...
        import_react153.default.createElement(CIcon, { width: 18, icon: cilFilterX })
      ))
    ))),
    import_react153.default.createElement(
      "div",
      ...
      import_react153.default.createElement(
        ...
        import_react153.default.createElement(CSmartTableBody, __assign({ clickableRows, columnNames, columns: columns !== null && columns !== void 0 ? columns : columnNames, currentItems, firstItemOnActivePageIndex, noItemsLabel, onRowClick: function(item, index, columnName, event) {
        ...
        typeof footer === "boolean" && footer && import_react153.default.createElement(CSmartTableHead, __assign({ as: CTableFoot }, tableFootProps, { columnFilter: false, columnSorter: false, columns: columns !== null && columns !== void 0 ? columns : columnNames, items: _items, handleSelectAllChecked: function() {
          return handleSelectAllChecked();
        }, selectable, selectAll, selectedAll, showGroups: false })),
        Array.isArray(footer) && import_react153.default.createElement(
          CTableFoot,
          __assign({}, tableFootProps),
          import_react153.default.createElement(CTableRow, null, footer.map(function(item, index) {
            return import_react153.default.createElement(CTableDataCell, __assign({}, typeof item === "object" && item._props && __assign({}, item._props), { key: index }), typeof item === "object" ? item.label : item);
          }))
        )
      ),
      loading && import_react153.default.createElement(CElementCover, { boundaries: [
        { sides: ["top"], query: "tbody" },
        { sides: ["bottom"], query: "tbody" }
      ] }, elementCover)
    ),
    (pagination || itemsPerPageSelect) && import_react153.default.createElement(
      "div",
      { className: "row" },
      import_react153.default.createElement("div", { className: "col" }, (pagination && numberOfPages > 1 || paginationProps && paginationProps.pages > 1) && import_react153.default.createElement(CSmartPagination, __assign({ activePage: _activePage, onActivePageChange: function(page) {
      ...
      import_react153.default.createElement("div", { className: "col-auto ms-auto" }, itemsPerPageSelect && import_react153.default.createElement(
        "div",
        { className: "row" },
        import_react153.default.createElement(CFormLabel, { className: "col-auto col-form-label" }, itemsPerPageLabel),
        import_react153.default.createElement(
          "div",
          { className: "col-auto" },
          import_react153.default.createElement(CFormSelect, { defaultValue: _itemsPerPage, onChange: function(event) {
            return handleItemsPerPageChange(event);
          } }, itemsPerPageOptions && itemsPerPageOptions.map(function(number, index) {
            return import_react153.default.createElement("option", { value: number, key: index }, number);
          }))
        )
      ))
    )
...
CSmartTable.propTypes = {
  activePage: import_prop_types137.default.number,
  cleaner: import_prop_types137.default.bool,
  clickableRows: import_prop_types137.default.bool,
  columnFilter: import_prop_types137.default.oneOfType([import_prop_types137.default.bool, import_prop_types137.default.object]),
  columnFilterValue: import_prop_types137.default.object,
  columns: import_prop_types137.default.array,
  columnSorter: import_prop_types137.default.oneOfType([import_prop_types137.default.bool, import_prop_types137.default.object]),
  elementCover: import_prop_types137.default.node,
  footer: import_prop_types137.default.oneOfType([import_prop_types137.default.bool, import_prop_types137.default.array]),
  header: import_prop_types137.default.bool,
  items: import_prop_types137.default.array,
  itemsNumber: import_prop_types137.default.number,
  itemsPerPage: import_prop_types137.default.number,
  itemsPerPageLabel: import_prop_types137.default.string,
  itemsPerPageOptions: import_prop_types137.default.array,
  itemsPerPageSelect: import_prop_types137.default.oneOfType([import_prop_types137.default.bool, import_prop_types137.default.object]),
  loading: import_prop_types137.default.bool,
  noItemsLabel: import_prop_types137.default.oneOfType([import_prop_types137.default.string, import_prop_types137.default.node]),
  onActivePageChange: import_prop_types137.default.func,
  onColumnFilterChange: import_prop_types137.default.func,
  onFilteredItemsChange: import_prop_types137.default.func,
  onItemsPerPageChange: import_prop_types137.default.func,
  onRowChecked: import_prop_types137.default.func,
  onRowClick: import_prop_types137.default.func,
  onSelectAll: import_prop_types137.default.func,
  onSelectedItemsChange: import_prop_types137.default.func,
  onSorterChange: import_prop_types137.default.func,
  // TODO: change to `onColumnSorterChange` in v6
  onTableFilterChange: import_prop_types137.default.func,
  pagination: import_prop_types137.default.oneOfType([import_prop_types137.default.bool, import_prop_types137.default.object]),
  paginationProps: import_prop_types137.default.any,
  // TODO: update
  scopedColumns: import_prop_types137.default.object,
  selectable: import_prop_types137.default.bool,
  selectAll: import_prop_types137.default.oneOfType([import_prop_types137.default.bool, import_prop_types137.default.object]),
  selected: import_prop_types137.default.array,
  sorterValue: import_prop_types137.default.oneOfType([
    import_prop_types137.default.shape({
      column: import_prop_types137.default.string.isRequired,
      state: import_prop_types137.default.oneOf(["asc", "desc", 0]).isRequired
    }),
    import_prop_types137.default.arrayOf(import_prop_types137.default.shape({
      column: import_prop_types137.default.string.isRequired,
      state: import_prop_types137.default.oneOf(["asc", "desc", 0]).isRequired
    }).isRequired)
  ]),
  sortingIcon: import_prop_types137.default.node,
  sortingIconAscending: import_prop_types137.default.node,
  sortingIconDescending: import_prop_types137.default.node,
  tableBodyProps: import_prop_types137.default.object,
  tableFootProps: import_prop_types137.default.object,
  tableFilter: import_prop_types137.default.oneOfType([import_prop_types137.default.bool, import_prop_types137.default.object]),
  tableFilterLabel: import_prop_types137.default.string,
  tableFilterPlaceholder: import_prop_types137.default.string,
  tableFilterValue: import_prop_types137.default.string,
  tableHeadProps: import_prop_types137.default.object,
  tableProps: import_prop_types137.default.object
};
...
var CSidebar = (0, import_react154.forwardRef)(function(_a3, ref) {
  var _b3;
  var children2 = _a3.children, _c3 = _a3.as, Component = _c3 === void 0 ? "div" : _c3, className = _a3.className, colorScheme = _a3.colorScheme, narrow = _a3.narrow, onHide = _a3.onHide, onShow = _a3.onShow, onVisibleChange = _a3.onVisibleChange, overlaid = _a3.overlaid, placement = _a3.placement, position = _a3.position, size = _a3.size, unfoldable = _a3.unfoldable, visible = _a3.visible, rest = __rest(_a3, ["children", "as", "className", "colorScheme", "narrow", "onHide", "onShow", "onVisibleChange", "overlaid", "placement", "position", "size", "unfoldable", "visible"]);
  var sidebarRef = (0, import_react154.useRef)(null);
  var forkedRef = useForkedRef(ref, sidebarRef);
  var _d3 = (0, import_react154.useState)(), inViewport = _d3[0], setInViewport = _d3[1];
  var _e3 = (0, import_react154.useState)(false), mobile = _e3[0], setMobile = _e3[1];
  var _f3 = (0, import_react154.useState)(false), visibleMobile = _f3[0], setVisibleMobile = _f3[1];
  var _g2 = (0, import_react154.useState)(visible !== void 0 ? visible : overlaid ? false : true), visibleDesktop = _g2[0], setVisibleDesktop = _g2[1];
  ...
  return import_react154.default.createElement(
    ...
    null,
    import_react154.default.createElement(Component, __assign({ className: classNames("sidebar", (_b3 = {}, _b3["sidebar-".concat(colorScheme)] = colorScheme, _b3["sidebar-narrow"] = narrow, _b3["sidebar-overlaid"] = overlaid, _b3["sidebar-".concat(placement)] = placement, _b3["sidebar-".concat(position)] = position, _b3["sidebar-".concat(size)] = size, _b3["sidebar-narrow-unfoldable"] = unfoldable, _b3.show = mobile && visibleMobile || overlaid && visibleDesktop, _b3.hide = visibleDesktop === false && !mobile && !overlaid, _b3), className) }, rest, { ref: forkedRef }), children2),
    typeof window !== "undefined" && mobile && (0, import_react_dom4.createPortal)(import_react154.default.createElement(CBackdrop, { className: "sidebar-backdrop", visible: mobile && visibleMobile }), document.body)
  );
});
CSidebar.propTypes = {
  ...
  colorScheme: import_prop_types138.default.oneOf(["dark", "light"]),
  narrow: import_prop_types138.default.bool,
  onHide: import_prop_types138.default.func,
  onShow: import_prop_types138.default.func,
  onVisibleChange: import_prop_types138.default.func,
  overlaid: import_prop_types138.default.bool,
  placement: import_prop_types138.default.oneOf(["start", "end"]),
  position: import_prop_types138.default.oneOf(["fixed", "sticky"]),
  size: import_prop_types138.default.oneOf(["sm", "lg", "xl"]),
  unfoldable: import_prop_types138.default.bool,
  visible: import_prop_types138.default.bool
};
...
var CSidebarBrand = (0, import_react155.forwardRef)(function(_a3, ref) {
  var children2 = _a3.children, _b3 = _a3.as, Component = _b3 === void 0 ? "a" : _b3, className = _a3.className, rest = __rest(_a3, ["children", "as", "className"]);
  return import_react155.default.createElement(Component, __assign({ className: classNames("sidebar-brand", className), ref }, rest), children2);
});
...
var CSidebarFooter = (0, import_react156.forwardRef)(function(_a3, ref) {
  var children2 = _a3.children, className = _a3.className, rest = __rest(_a3, ["children", "className"]);
  return import_react156.default.createElement("div", __assign({ className: classNames("sidebar-footer", className), ref }, rest), children2);
});
...
var CSidebarToggler = (0, import_react157.forwardRef)(function(_a3, ref) {
  var children2 = _a3.children, className = _a3.className, rest = __rest(_a3, ["children", "className"]);
  return import_react157.default.createElement("button", __assign({ className: classNames("sidebar-toggler", className), ref }, rest), children2);
});
...
var CSidebarHeader = (0, import_react158.forwardRef)(function(_a3, ref) {
  var children2 = _a3.children, className = _a3.className, rest = __rest(_a3, ["children", "className"]);
  return import_react158.default.createElement("div", __assign({ className: classNames("sidebar-header", className), ref }, rest), children2);
});
...
var isNavElement = function(child) {
  if (!import_react159.default.isValidElement(child))
    return false;
  var type = child.type;
  return type.displayName === "CNavGroup" || type.displayName === "CNavLink" || type.displayName === "CNavItem";
};
var recursiveClone = function(children2, id, updateId) {
  return import_react159.default.Children.map(children2, function(child, index) {
    ...
    if (child.props.children) {
      ...
      return import_react159.default.cloneElement(child, {
        idx: _id,
...
var CSidebarNav = (0, import_react159.forwardRef)(function(_a3, ref) {
  var children2 = _a3.children, _b3 = _a3.as, Component = _b3 === void 0 ? "ul" : _b3, className = _a3.className, rest = __rest(_a3, ["children", "as", "className"]);
  var _c3 = (0, import_react159.useState)(""), visibleGroup = _c3[0], setVisibleGroup = _c3[1];
  ...
  return import_react159.default.createElement(
    ...
    import_react159.default.createElement(Component, __assign({ className: classNames("sidebar-nav", className), ref }, rest), recursiveClone(children2))
  );
});
...
// node_modules/@coreui/react-pro/dist/esm/components/stepper/CStepper.js
var import_react160 = __toESM(require_react());
var import_prop_types144 = __toESM(require_prop_types());
var CStepper = (0, import_react160.forwardRef)(function(_a3, ref) {
  var controlledActiveStepNumber = _a3.activeStepNumber, controlledActiveStepIndex = _a3.activeStepIndex, className = _a3.className, defaultActiveStepNumber = _a3.defaultActiveStepNumber, _b3 = _a3.defaultActiveStepIndex, defaultActiveStepIndex = _b3 === void 0 ? 0 : _b3, _c3 = _a3.layout, layout = _c3 === void 0 ? "horizontal" : _c3, _d3 = _a3.linear, linear = _d3 === void 0 ? true : _d3, onFinish = _a3.onFinish, onReset = _a3.onReset, onStepChange = _a3.onStepChange, onStepValidationComplete = _a3.onStepValidationComplete, _e3 = _a3.steps, steps = _e3 === void 0 ? [] : _e3, _f3 = _a3.stepButtonLayout, stepButtonLayout = _f3 === void 0 ? "horizontal" : _f3, _g2 = _a3.validation, validation = _g2 === void 0 ? true : _g2, rest = __rest(_a3, ["activeStepNumber", "activeStepIndex", "className", "defaultActiveStepNumber", "defaultActiveStepIndex", "layout", "linear", "onFinish", "onReset", "onStepChange", "onStepValidationComplete", "steps", "stepButtonLayout", "validation"]);
  var stepperRef = (0, import_react160.useRef)(null);
  var stepsRef = (0, import_react160.useRef)(null);
  var stepButtonRefs = (0, import_react160.useRef)([]);
  var uniqueId = (0, import_react160.useId)();
  var isControlledByNumber = controlledActiveStepNumber !== void 0;
  var isControlledByIndex = controlledActiveStepIndex !== void 0;
  var isControlled = isControlledByNumber || isControlledByIndex;
  var getDefaultActiveStepIndex = function() {
    if (defaultActiveStepNumber !== void 0) {
  ...
  var _h2 = (0, import_react160.useState)(isControlled ? getControlledActiveStepIndex() : getDefaultActiveStepIndex()), internalActiveStepIndex = _h2[0], setInternalActiveStepIndex = _h2[1];
  var _j2 = (0, import_react160.useState)(false), isFinished = _j2[0], setIsFinished = _j2[1];
  ...
  var isStepValid = (0, import_react160.useCallback)(function(index) {
    var _a4;
    if (!validation) {
      return true;
    }
    ...
    var form = (_a4 = currentStepData === null || currentStepData === void 0 ? void 0 : currentStepData.formRef) === null || _a4 === void 0 ? void 0 : _a4.current;
    if (form) {
  ...
  var setActiveStep = (0, import_react160.useCallback)(function(index, bypassValidation) {
  ...
  var handlePrev = function() {
    if (activeStepIndex > 0) {
      setActiveStep(activeStepIndex - 1, true);
    }
  };
  ...
  var handleReset = function() {
    ...
    if (validation) {
      steps.forEach(function(step) {
        ...
        (_b4 = (_a5 = stepData.formRef) === null || _a5 === void 0 ? void 0 : _a5.current) === null || _b4 === void 0 ? void 0 : _b4.reset();
      });
    }
    ...
    setIsFinished(false);
    onStepChange === null || onStepChange === void 0 ? void 0 : onStepChange(resetIndex + 1);
    onReset === null || onReset === void 0 ? void 0 : onReset();
    (_a4 = stepButtonRefs.current[resetIndex]) === null || _a4 === void 0 ? void 0 : _a4.focus();
  };
  var handleKeyDown = function(event) {
    var target = event.target;
  ...
  (0, import_react160.useImperativeHandle)(ref, function() {
    return {
      next: handleNext,
      prev: handlePrev,
      finish: handleFinish,
  ...
  return import_react160.default.createElement(
    "div",
    __assign({ className: classNames("stepper", {
      "stepper-vertical": isVertical
    }, className), ref: stepperRef }, rest),
    import_react160.default.createElement("ol", { className: "stepper-steps", "aria-orientation": isVertical ? "vertical" : "horizontal", ref: stepsRef, onKeyDown: handleKeyDown, role: "tablist" }, steps.map(function(step, index) {
      var _a4;
      ...
      return import_react160.default.createElement(
        "li",
        { key: index, className: classNames("stepper-step", stepButtonLayout), role: "presentation" },
        import_react160.default.createElement(
          "button",
          __assign({ type: "button", className: classNames("stepper-step-button", {
            active: isActive,
            complete: isComplete
          }), disabled: isDisabled, id: stepId, role: "tab", onClick: function() {
          ...
          import_react160.default.createElement("span", { className: "stepper-step-indicator" }, isComplete ? import_react160.default.createElement("span", { className: "stepper-step-indicator-icon" }) : import_react160.default.createElement("span", { className: "stepper-step-indicator-text" }, (_a4 = stepData.indicator) !== null && _a4 !== void 0 ? _a4 : index + 1)),
          import_react160.default.createElement("span", { className: "stepper-step-label" }, stepData.label)
        ),
        index < steps.length - 1 && import_react160.default.createElement("div", { className: "stepper-step-connector" }),
        stepData.content && isVertical && import_react160.default.createElement(CCollapse, { className: "stepper-step-content", id: panelId, role: "tabpanel", visible: isActive, "aria-hidden": !isActive, "aria-labelledby": stepId, "aria-live": "polite" }, stepData.content)
      );
    })),
    !isVertical && steps.some(function(step) {
      var stepData = typeof step === "string" ? {} : step;
      return stepData.content !== void 0 && stepData.content !== null;
    }) && import_react160.default.createElement("div", { className: "stepper-content" }, steps.map(function(step, index) {
      var stepData = typeof step === "string" ? {} : step;
      var isActive = !isFinished && index === activeStepIndex;
      var stepId = "stepper-".concat(rest.id || uniqueId, "-step-").concat(index);
      var panelId = "stepper-".concat(rest.id || uniqueId, "-panel-").concat(index);
      return import_react160.default.createElement("div", { key: index, className: classNames("stepper-pane", {
        show: isActive,
        active: isActive
...
CStepper.propTypes = {
  activeStepNumber: import_prop_types144.default.number,
  activeStepIndex: import_prop_types144.default.number,
  className: import_prop_types144.default.string,
  defaultActiveStepNumber: import_prop_types144.default.number,
  defaultActiveStepIndex: import_prop_types144.default.number,
  layout: import_prop_types144.default.oneOf(["horizontal", "vertical"]),
  linear: import_prop_types144.default.bool,
  onFinish: import_prop_types144.default.func,
  onReset: import_prop_types144.default.func,
  onStepChange: import_prop_types144.default.func,
  onStepValidationComplete: import_prop_types144.default.func,
  steps: import_prop_types144.default.arrayOf(import_prop_types144.default.oneOfType([
    import_prop_types144.default.string,
    import_prop_types144.default.shape({
      label: import_prop_types144.default.node.isRequired,
      content: import_prop_types144.default.node,
      formRef: import_prop_types144.default.object
      // Check for object shape might be better
    }).isRequired
  ])).isRequired,
  stepButtonLayout: import_prop_types144.default.oneOf(["horizontal", "vertical"]),
  validation: import_prop_types144.default.bool
};
...
// node_modules/@coreui/react-pro/dist/esm/components/tabs/CTabsContext.js
var import_react161 = __toESM(require_react());
var CTabsContext = (0, import_react161.createContext)({});

// node_modules/@coreui/react-pro/dist/esm/components/tabs/CTab.js
var CTab = (0, import_react162.forwardRef)(function(_a3, ref) {
  var children2 = _a3.children, className = _a3.className, itemKey = _a3.itemKey, rest = __rest(_a3, ["children", "className", "itemKey"]);
  var _b3 = (0, import_react162.useContext)(CTabsContext), _activeItemKey = _b3._activeItemKey, setActiveItemKey = _b3.setActiveItemKey, id = _b3.id;
  var isActive = function() {
    return itemKey === _activeItemKey;
  };
  return import_react162.default.createElement("button", __assign({ className: classNames("nav-link", {
    active: isActive()
  }, className), id: "".concat(id).concat(itemKey, "-tab"), onClick: function() {
    return setActiveItemKey(itemKey);
  }, onFocus: function() {
    return setActiveItemKey(itemKey);
  }, role: "tab", tabIndex: isActive() ? 0 : -1, type: "button", "aria-controls": "".concat(id).concat(itemKey, "-tab-pane"), "aria-selected": isActive(), ref }, rest), children2);
});
CTab.propTypes = {
  ...
  itemKey: import_prop_types145.default.oneOfType([import_prop_types145.default.number, import_prop_types145.default.string]).isRequired
};
...
var CTabContent = (0, import_react163.forwardRef)(function(_a3, ref) {
  var children2 = _a3.children, className = _a3.className, rest = __rest(_a3, ["children", "className"]);
  return import_react163.default.createElement("div", __assign({ className: classNames("tab-content", className) }, rest, { ref }), children2);
});
...
init_lib();
var CTabPane = (0, import_react164.forwardRef)(function(_a3, ref) {
  var children2 = _a3.children, className = _a3.className, onHide = _a3.onHide, onShow = _a3.onShow, _b3 = _a3.transition, transition = _b3 === void 0 ? true : _b3, visible = _a3.visible, rest = __rest(_a3, ["children", "className", "onHide", "onShow", "transition", "visible"]);
  var tabPaneRef = (0, import_react164.useRef)(null);
  var forkedRef = useForkedRef(ref, tabPaneRef);
  return import_react164.default.createElement(Transition, { in: visible, nodeRef: tabPaneRef, onEnter: onShow, onExit: onHide, timeout: 150 }, function(state) {
    return import_react164.default.createElement("div", __assign({ className: classNames("tab-pane", {
      active: visible,
      fade: transition,
      show: state === "entered"
    }, className) }, rest, { ref: forkedRef }), children2);
  });
});
CTabPane.propTypes = {
  children: import_prop_types147.default.node,
  className: import_prop_types147.default.string,
  onHide: import_prop_types147.default.func,
  onShow: import_prop_types147.default.func,
  transition: import_prop_types147.default.bool,
  visible: import_prop_types147.default.bool
};
...
init_lib();
var CTabPanel = (0, import_react165.forwardRef)(function(_a3, ref) {
  var children2 = _a3.children, className = _a3.className, itemKey = _a3.itemKey, onHide = _a3.onHide, onShow = _a3.onShow, _b3 = _a3.transition, transition = _b3 === void 0 ? true : _b3, visible = _a3.visible, rest = __rest(_a3, ["children", "className", "itemKey", "onHide", "onShow", "transition", "visible"]);
  var _c3 = (0, import_react165.useContext)(CTabsContext), _activeItemKey = _c3._activeItemKey, id = _c3.id;
  var tabPaneRef = (0, import_react165.useRef)(null);
  var forkedRef = useForkedRef(ref, tabPaneRef);
  var _d3 = (0, import_react165.useState)(visible || _activeItemKey === itemKey), _visible = _d3[0], setVisible = _d3[1];
  ...
  return import_react165.default.createElement(Transition, { in: _visible, nodeRef: tabPaneRef, onEnter: onShow, onExit: onHide, timeout: tabPaneRef.current ? getTransitionDurationFromElement(tabPaneRef.current) : 0 }, function(state) {
    return import_react165.default.createElement("div", __assign({ className: classNames("tab-pane", {
      active: _visible,
      fade: transition,
      show: state === "entered"
    }, className), id: "".concat(id).concat(itemKey, "-tab-pane"), role: "tabpanel", "aria-labelledby": "".concat(id).concat(itemKey, "-tab"), tabIndex: 0, ref: forkedRef }, rest), children2);
  });
});
CTabPanel.propTypes = {
  children: import_prop_types148.default.node,
  className: import_prop_types148.default.string,
  itemKey: import_prop_types148.default.oneOfType([import_prop_types148.default.number, import_prop_types148.default.string]).isRequired,
  onHide: import_prop_types148.default.func,
  onShow: import_prop_types148.default.func,
  transition: import_prop_types148.default.bool,
  visible: import_prop_types148.default.bool
};
...
init_lib();
var CTabList = (0, import_react166.forwardRef)(function(_a3, ref) {
  var _b3;
  var children2 = _a3.children, className = _a3.className, layout = _a3.layout, variant = _a3.variant, rest = __rest(_a3, ["children", "className", "layout", "variant"]);
  var tabListRef = (0, import_react166.useRef)(null);
  ...
  return import_react166.default.createElement("div", __assign({ className: classNames("nav", variant === "enclosed-pills" && "nav-enclosed", (_b3 = {}, _b3["nav-".concat(layout)] = layout, _b3["nav-".concat(variant)] = variant, _b3), className), role: "tablist", onKeyDown: handleKeydown, ref: forkedRef }, rest), children2);
});
CTabList.propTypes = {
  children: import_prop_types149.default.node,
  className: import_prop_types149.default.string,
  layout: import_prop_types149.default.oneOf(["fill", "justified"]),
  variant: import_prop_types149.default.oneOf([
    "enclosed",
    "enclosed-pills",
    "pills",
    "tabs",
...
var CTabs = (0, import_react167.forwardRef)(function(_a3, ref) {
  var children2 = _a3.children, activeItemKey = _a3.activeItemKey, className = _a3.className, defaultActiveItemKey = _a3.defaultActiveItemKey, onChange = _a3.onChange;
  var id = (0, import_react167.useId)();
  var isControlled = activeItemKey !== void 0;
  var _b3 = (0, import_react167.useState)(function() {
    return isControlled ? void 0 : defaultActiveItemKey;
  }), internalActiveItemKey = _b3[0], setInternalActiveItemKey = _b3[1];
  ...
  return import_react167.default.createElement(
    ...
    import_react167.default.createElement("div", { className: classNames("tabs", className), ref }, children2)
  );
});
CTabs.propTypes = {
  activeItemKey: import_prop_types150.default.oneOfType([import_prop_types150.default.number, import_prop_types150.default.string]),
  children: import_prop_types150.default.node,
  className: import_prop_types150.default.string,
  defaultActiveItemKey: import_prop_types150.default.oneOfType([import_prop_types150.default.number, import_prop_types150.default.string]),
...
// node_modules/@coreui/react-pro/dist/esm/components/toast/CToastContext.js
var import_react168 = __toESM(require_react());
var CToastContext = (0, import_react168.createContext)({});

// node_modules/@coreui/react-pro/dist/esm/components/toast/CToast.js
init_lib();
var CToast = (0, import_react169.forwardRef)(function(_a3, ref) {
  var children2 = _a3.children, _b3 = _a3.animation, animation = _b3 === void 0 ? true : _b3, _c3 = _a3.autohide, autohide = _c3 === void 0 ? true : _c3, className = _a3.className, color = _a3.color, _d3 = _a3.delay, delay = _d3 === void 0 ? 5e3 : _d3, index = _a3.index, innerKey = _a3.innerKey, _e3 = _a3.visible, visible = _e3 === void 0 ? false : _e3, onClose = _a3.onClose, onShow = _a3.onShow, rest = __rest(_a3, ["children", "animation", "autohide", "className", "color", "delay", "index", "innerKey", "visible", "onClose", "onShow"]);
  var toastRef = (0, import_react169.useRef)(null);
  var forkedRef = useForkedRef(ref, toastRef);
  var _f3 = (0, import_react169.useState)(false), _visible = _f3[0], setVisible = _f3[1];
  var timeout2 = (0, import_react169.useRef)(void 0);
  ...
  return import_react169.default.createElement(Transition, { in: _visible, nodeRef: toastRef, onEnter: function() {
    ...
    return import_react169.default.createElement(
      ...
      { value: contextValues },
      import_react169.default.createElement("div", __assign({ className: classNames("toast", (_a4 = {
        fade: animation
        ...
        return _autohide();
      } }, rest, { key: innerKey, ref: forkedRef }), children2)
    );
  });
});
CToast.propTypes = {
  animation: import_prop_types151.default.bool,
  autohide: import_prop_types151.default.bool,
  children: import_prop_types151.default.node,
  className: import_prop_types151.default.string,
  color: colorPropType,
  delay: import_prop_types151.default.number,
  index: import_prop_types151.default.number,
  innerKey: import_prop_types151.default.oneOfType([import_prop_types151.default.number, import_prop_types151.default.string]),
  onClose: import_prop_types151.default.func,
  onShow: import_prop_types151.default.func,
  visible: import_prop_types151.default.bool
};
...
var CToastBody = (0, import_react170.forwardRef)(function(_a3, ref) {
  var children2 = _a3.children, className = _a3.className, rest = __rest(_a3, ["children", "className"]);
  return import_react170.default.createElement("div", __assign({ className: classNames("toast-body", className) }, rest, { ref }), children2);
});
...
var CToastClose = (0, import_react171.forwardRef)(function(_a3, ref) {
  var children2 = _a3.children, Component = _a3.as, rest = __rest(_a3, ["children", "as"]);
  var setVisible = (0, import_react171.useContext)(CToastContext).setVisible;
  return Component ? import_react171.default.createElement(Component, __assign({ onClick: function() {
    return setVisible(false);
  } }, rest, { ref }), children2) : import_react171.default.createElement(CCloseButton, __assign({ onClick: function() {
    return setVisible(false);
  } }, rest, { ref }));
});
CToastClose.propTypes = __assign(__assign({}, CCloseButton.propTypes), { as: import_prop_types153.default.elementType });
...
var CToastHeader = (0, import_react172.forwardRef)(function(_a3, ref) {
  var children2 = _a3.children, className = _a3.className, closeButton = _a3.closeButton, rest = __rest(_a3, ["children", "className", "closeButton"]);
  return import_react172.default.createElement(
    "div",
    __assign({ className: classNames("toast-header", className) }, rest, { ref }),
    children2,
    closeButton && import_react172.default.createElement(CToastClose, null)
  );
});
CToastHeader.propTypes = {
  children: import_prop_types154.default.node,
  className: import_prop_types154.default.string,
  closeButton: import_prop_types154.default.bool
};
...
var CToaster = (0, import_react173.forwardRef)(function(_a3, ref) {
  var children2 = _a3.children, className = _a3.className, placement = _a3.placement, push = _a3.push, rest = __rest(_a3, ["children", "className", "placement", "push"]);
  var _b3 = (0, import_react173.useState)([]), toasts = _b3[0], setToasts = _b3[1];
  var index = (0, import_react173.useRef)(0);
  ...
  var addToast = function(push2) {
    setToasts(function(state) {
      return __spreadArray(__spreadArray([], state, true), [
        import_react173.default.cloneElement(push2, {
          index: index.current,
  ...
  return import_react173.default.createElement(CConditionalPortal, { portal: typeof placement === "string" }, toasts.length > 0 || children2 ? import_react173.default.createElement(
    "div",
    ...
    toasts.map(function(toast, index2) {
      return import_react173.default.cloneElement(toast, { visible: true, key: index2 });
    })
  ) : null);
});
CToaster.propTypes = {
  ...
  placement: import_prop_types155.default.oneOfType([
    import_prop_types155.default.string,
    import_prop_types155.default.oneOf([
      "top-start",
      "top-center",
      "top-end",
      "middle-start",
  ...
  push: import_prop_types155.default.any
};
...
var CWidgetStatsA = (0, import_react174.forwardRef)(function(_a3, ref) {
  var _b3;
  ...
  return import_react174.default.createElement(
    ...
    import_react174.default.createElement(
      ...
      import_react174.default.createElement(
        "div",
        null,
        value && import_react174.default.createElement("div", { className: "fs-4 fw-semibold" }, value),
        title && import_react174.default.createElement("div", null, title)
      ),
      action
    ),
    chart
...
CWidgetStatsA.propTypes = {
  action: import_prop_types156.default.node,
  chart: import_prop_types156.default.oneOfType([import_prop_types156.default.string, import_prop_types156.default.node]),
...
var CWidgetStatsB = (0, import_react175.forwardRef)(function(_a3, ref) {
  ...
  return import_react175.default.createElement(
    ...
    import_react175.default.createElement(
      CCardBody,
      null,
      value && import_react175.default.createElement("div", { className: "fs-4 fw-semibold" }, value),
      title && import_react175.default.createElement("div", null, title),
      import_react175.default.createElement(CProgress, __assign({ className: "my-2", height: 4 }, inverse && { white: true }, progress)),
      text && import_react175.default.createElement("small", { className: inverse ? "text-white text-opacity-75" : "text-body-secondary" }, text)
    )
  );
});
CWidgetStatsB.propTypes = {
  ...
  color: colorPropType,
  inverse: import_prop_types157.default.bool,
  progress: import_prop_types157.default.object,
  text: import_prop_types157.default.string,
  title: import_prop_types157.default.oneOfType([import_prop_types157.default.string, import_prop_types157.default.node]),
  value: import_prop_types157.default.oneOfType([import_prop_types157.default.string, import_prop_types157.default.node, import_prop_types157.default.number])
};
...
var CWidgetStatsC = (0, import_react176.forwardRef)(function(_a3, ref) {
  ...
  return import_react176.default.createElement(
    ...
    import_react176.default.createElement(
      CCardBody,
      null,
      icon && import_react176.default.createElement("div", { className: classNames("text-end mb-4", inverse ? "text-white text-opacity-75" : "text-body-secondary") }, icon),
      value && import_react176.default.createElement("div", { className: "fs-4 fw-semibold" }, value),
      title && import_react176.default.createElement("div", { className: inverse ? "text-white text-opacity-75" : "text-body-secondary" }, title),
      import_react176.default.createElement(CProgress, __assign({ className: "mt-3 mb-0", height: 4 }, inverse && { white: true }, progress))
    )
  );
});
CWidgetStatsC.propTypes = {
  ...
  color: colorPropType,
  icon: import_prop_types158.default.oneOfType([import_prop_types158.default.string, import_prop_types158.default.node]),
  inverse: import_prop_types158.default.bool,
  progress: import_prop_types158.default.object,
  title: import_prop_types158.default.oneOfType([import_prop_types158.default.string, import_prop_types158.default.node]),
  value: import_prop_types158.default.oneOfType([import_prop_types158.default.string, import_prop_types158.default.node, import_prop_types158.default.number])
};
...
var CWidgetStatsD = (0, import_react177.forwardRef)(function(_a3, ref) {
  var _b3;
  var className = _a3.className, chart = _a3.chart, color = _a3.color, icon = _a3.icon, values2 = _a3.values, rest = __rest(_a3, ["className", "chart", "color", "icon", "values"]);
  return import_react177.default.createElement(
    ...
    import_react177.default.createElement(CCardBody, { className: "row text-center" }, values2 && values2.map(function(value, index) {
      return import_react177.default.createElement(
        import_react177.default.Fragment,
        { key: index },
        index % 2 !== 0 && import_react177.default.createElement("div", { className: "vr" }),
        import_react177.default.createElement(
          CCol,
          null,
          import_react177.default.createElement("div", { className: "fs-5 fw-semibold" }, value.value),
          import_react177.default.createElement("div", { className: "text-uppercase text-body-secondary small" }, value.title)
        )
      );
    }))
  );
...
CWidgetStatsD.propTypes = {
  chart: import_prop_types159.default.oneOfType([import_prop_types159.default.string, import_prop_types159.default.node]),
  className: import_prop_types159.default.string,
  color: colorPropType,
  icon: import_prop_types159.default.oneOfType([import_prop_types159.default.string, import_prop_types159.default.node]),
  values: import_prop_types159.default.arrayOf(import_prop_types159.default.any)
};
...
var CWidgetStatsE = (0, import_react178.forwardRef)(function(_a3, ref) {
  ...
  return import_react178.default.createElement(
    ...
    import_react178.default.createElement(
      ...
      title && import_react178.default.createElement("div", { className: "text-body-secondary small text-uppercase fw-semibold" }, title),
      value && import_react178.default.createElement("div", { className: "fs-6 fw-semibold py-3" }, value),
      chart
    )
  );
});
CWidgetStatsE.propTypes = {
  ...
  chart: import_prop_types160.default.oneOfType([import_prop_types160.default.string, import_prop_types160.default.node]),
  className: import_prop_types160.default.string,
  title: import_prop_types160.default.oneOfType([import_prop_types160.default.string, import_prop_types160.default.node]),
  value: import_prop_types160.default.oneOfType([import_prop_types160.default.string, import_prop_types160.default.node, import_prop_types160.default.number])
};
...
var CWidgetStatsF = (0, import_react179.forwardRef)(function(_a3, ref) {
  ...
  return import_react179.default.createElement(
    ...
    import_react179.default.createElement(
      ...
      import_react179.default.createElement("div", { className: "me-3 text-white bg-".concat(color, " ").concat(padding ? "p-3" : "p-4") }, icon),
      import_react179.default.createElement(
        "div",
        null,
        import_react179.default.createElement("div", { className: "fs-6 fw-semibold text-".concat(color) }, value),
        import_react179.default.createElement("div", { className: "text-body-secondary text-uppercase fw-semibold small" }, title)
      )
    ),
    footer && import_react179.default.createElement(CCardFooter, null, footer)
  );
});
CWidgetStatsF.propTypes = {
  className: import_prop_types161.default.string,
  color: colorPropType,
  footer: import_prop_types161.default.oneOfType([import_prop_types161.default.string, import_prop_types161.default.node]),
  icon: import_prop_types161.default.oneOfType([import_prop_types161.default.string, import_prop_types161.default.node]),
  padding: import_prop_types161.default.bool,
  title: import_prop_types161.default.oneOfType([import_prop_types161.default.string, import_prop_types161.default.node]),
  value: import_prop_types161.default.oneOfType([import_prop_types161.default.string, import_prop_types161.default.node, import_prop_types161.default.number])
};
CWidgetStatsF.displayName = "CWidgetStatsF";

// node_modules/@coreui/react-pro/dist/esm/hooks/useClipboard.js
var import_react180 = __toESM(require_react());
var useClipboard = function() {
  var _a3 = (0, import_react180.useState)(false), isCopied = _a3[0], setIsCopied = _a3[1];
  var _b3 = (0, import_react180.useState)(null), error = _b3[0], setError = _b3[1];
  var copy = (0, import_react180.useCallback)(function(text) {
...
var useColorModes = function(localStorageItemName) {
  ...
  var _a3 = (0, import_react181.useState)(getPreferredColorScheme(localStorageItemName)), colorMode = _a3[0], setColorMode = _a3[1];
...
var useDebounce = function(value, delay) {
  var _a3 = (0, import_react182.useState)(value), debouncedValue = _a3[0], setDebouncedValue = _a3[1];
...
var useStateWithCallback = function(initialState, handler, runHandler) {
  var _a3 = (0, import_react183.useState)(initialState), state = _a3[0], setState = _a3[1];
  handler && (0, import_react183.useEffect)(function() {
