...
var Loader = proxyCustomElement(class Loader2 extends H {
  ...
  render() {
    ...
    return h(Host, { key: "53c4523552d540e02cb38d599226d48d00ffffa0", "aria-label": label, id, role: "progressbar", ...isDeterminate ? hostAttributes : {} }, h("div", { key: "e9a31da95d1769f13150426eefa8fd46f03afb53", class: CSS.loaderParts }, [1, 2, 3].map((index) => h("svg", { "aria-hidden": "true", class: {
      [CSS.loaderPart]: true,
      [CSS.loaderPartId(index)]: true
    }, key: index, viewBox: viewbox, ...index === 3 && isDeterminate ? { style: determinateStyle } : {} }, h("circle", { ...svgAttributes })))), text && h("div", { key: "2942cb58f2b0466c94b925f05211972c5ede9244", class: CSS.loaderText }, text), isDeterminate && h("div", { key: "2f73c0a6b1fb26d125b2fee69f2caf09400666e3", class: CSS.loaderPercentage }, value));
  }
  //--------------------------------------------------------------------------
  //
  //  Private Methods
...
@esri/calcite-components/dist/components/loader.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-WODEXGRC.js.map
