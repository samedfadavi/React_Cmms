      ...
      if (void 0 === o) {
        for (const t3 in this.attributes) if (t3.toLowerCase() === r2.toLowerCase()) {
          if (o = this.attributes[t3], null !== o) {
            ...
            if ("date-only" === n4) {
              ee(o) || (this.attributes[t3] = n2.fromReader(o.toString()));
              break;
            }
        ...
        if ("date-only" === n4) {
          ee(o) ? this.attributes[r2] = o : this.attributes[r2] = n2.fromReader(o.toString());
          continue;
        }
        if ("timestamp-offset" === n4) {
...
//# sourceMappingURL=chunk-X77CSNGT.js.map
