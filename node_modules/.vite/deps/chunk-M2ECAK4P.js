...
var a2 = class extends S {
  ...
  get visibleSublayers() {
    const { layer: e2, scale: r } = this, s = e2 == null ? void 0 : e2.sublayers, t = [], o2 = (e3) => {
      const { minScale: s2, maxScale: a3, sublayers: l, visible: i } = e3;
      i && (0 === r || (0 === s2 || r <= s2) && (0 === a3 || r >= a3)) && (l ? l.forEach(o2) : t.push(e3));
    };
    return s == null ? void 0 : s.forEach(o2), t;
  }
  toJSON() {
    const { layer: e2, layers: r } = this, { imageFormat: s, imageTransparency: t, version: o2 } = e2;
    return { format: s, request: "GetMap", service: "WMS", styles: "", transparent: t ? "TRUE" : "FALSE", version: o2, layers: r };
  }
};
e([y()], a2.prototype, "layer", null), e([y({ readOnly: true })], a2.prototype, "layers", null), e([y({ type: Number })], a2.prototype, "scale", void 0), e([y({ readOnly: true })], a2.prototype, "version", null), e([y({ readOnly: true })], a2.prototype, "visibleSublayers", null), a2 = e([a("esri.layers.support.ExportWMSImageParameters")], a2);

export {
  a2 as a
};
//# sourceMappingURL=chunk-M2ECAK4P.js.map
