...
var S = "field";
var E = new n2({ esriNormalizeByLog: V, esriNormalizeByPercentOfTotal: F, esriNormalizeByField: S });
var j = b(a4);
var z = B2 = class extends v(p) {
  ...
  addClassBreakInfo(e2, t, i3) {
    let r2 = null;
    r2 = "number" == typeof e2 ? new a4({ minValue: e2, maxValue: t, symbol: B(i3) }) : j(a(e2)), this.classBreakInfos.push(r2), 1 === this.classBreakInfos.length && this.notifyChange("minValue");
  }
  ...
  getBreakIndex(e2, s2) {
    return this.valueExpression && null == (s2 == null ? void 0 : s2.arcade) && n.getLogger(this).warn(""), this.valueExpression ? this._getBreakIndexForExpression(e2, s2) : this._getBreakIndexForField(e2);
  }
  ...
  async getSymbolAsync(e2, s2) {
    ...
    if (this.valueExpression && null == (s2 == null ? void 0 : s2.arcade)) {
      const e3 = await i(), { arcadeUtils: s3 } = e3;
  ...
  async collectSymbolFields(e2, s2) {
    ...
    w(e2, s2, this.field), w(e2, s2, this.normalizationField), await Promise.all(t);
  }
  _getBreakIndexForExpression(e2, s2) {
    const { viewingMode: t, scale: o3, spatialReference: i3, arcade: r2, timeZone: a5 } = s2 ?? {}, { valueExpression: l2 } = this;
    ...
    const c = u2.executeFunction(n4, u2.createExecContext(e2, u2.getViewInfo({ viewingMode: t, scale: o3, spatialReference: i3 }), a5));
...
//# sourceMappingURL=chunk-LNOEFEG3.js.map
