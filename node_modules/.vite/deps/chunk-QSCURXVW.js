...
e([o({ classBreaksDef: "class-breaks-definition" })], l.prototype, "type", void 0), e([y({ json: { write: true } })], l.prototype, "breakCount", void 0), e([y({ json: { write: true } })], l.prototype, "classificationField", void 0), e([y({ type: String, json: { read: a2.read, write: a2.write } })], l.prototype, "classificationMethod", void 0), e([y({ json: { write: true } })], l.prototype, "normalizationField", void 0), e([y({ json: { read: n3.read, write: n3.write } })], l.prototype, "normalizationType", void 0), e([y({ value: null, json: { write: true } })], l.prototype, "standardDeviationInterval", null), e([y({ value: null, json: { write: true } })], l.prototype, "definedInterval", null), l = e([a("esri.rest.support.ClassBreaksDefinition")], l);
var d = l;
...
function u(e2) {
  const t2 = e2.definition, { classificationMethod: n4, normalizationType: a4, definedInterval: u2 } = t2, i2 = t2.breakCount ?? 1, c2 = [];
  let b2 = e2.values;
  ...
  if ("equal-interval" === n4) if (b2.length >= i2) {
    ...
    c2.push({ minValue: e3, maxValue: e3, label: s(e3, e3, a4) });
  });
    ...
    for (let n5 = 1; n5 < i2; n5++) {
      let u3 = t3 + l3 - 1;
      u3 > b2.length && (u3 = b2.length - 1), u3 < 0 && (u3 = 0), c2.push({ minValue: e3, maxValue: b2[u3], label: s(e3, b2[u3], a4) }), e3 = b2[u3], l3 += t3, t3 = Math.ceil((b2.length - l3) / (i2 - n5));
    }
    c2.push({ minValue: e3, maxValue: p, label: s(e3, p, a4) });
  } else {
    let e3 = -1;
    for (let t3 = 0; t3 < b2.length; t3++) {
      const l3 = b2[t3];
      l3 !== e3 && (e3 = l3, c2.push({ minValue: e3, maxValue: l3, label: s(e3, l3, a4) }), e3 = l3);
    }
  }
    ...
    if (0 === t3) c2.push({ minValue: b2[0], maxValue: b2[0], label: s(b2[0], b2[0], a4) });
      ...
      for (let t4 = i2; t4 >= 1; t4--) {
        ...
        c2.push({ minValue: o3, maxValue: r3, label: s(o3, r3, a4) }), o3 = r3, u3++;
      }
      let r2 = l2(e3 + 0.5 * n5, 6);
      c2.push({ minValue: o3, maxValue: r2, label: s(o3, r2, a4) }), o3 = r2, u3++;
      for (let t4 = 1; t4 <= i2; t4++) r2 = u3 === 2 * i2 ? p : l2(e3 + (t4 + 0.5) * n5, 6), c2.push({ minValue: o3, maxValue: r2, label: s(o3, r2, a4) }), o3 = r2, u3++;
    }
    ...
    for (let r2 = 1; r2 < n5; r2++) {
      ...
      c2.push({ minValue: o3, maxValue: t4, label: s(o3, t4, a4) }), o3 = t4;
    }
    c2.push({ minValue: o3, maxValue: t3, label: s(o3, t3, a4) });
  }
  return c2;
}
function s(e2, t2, l3) {
...
//# sourceMappingURL=chunk-QSCURXVW.js.map
