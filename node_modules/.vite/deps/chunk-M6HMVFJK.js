...
function a(t2, s) {
  return { analytics: n2(t2), attachment: i(t2), data: c(t2), metadata: d2(t2), operations: l(t2.capabilities, t2, s), query: y(t2, s), queryRelated: m(t2), queryTopFeatures: h(t2), editing: C(t2) };
}
function n2(t2) {
...
function l(s, r2, p2) {
  ...
  return n3 && !(i2 || c2 || d3) && (i2 = c2 = d3 = true), { supportsCalculate: n(r2, "supportsCalculate", false), supportsTruncate: n(r2, "supportsTruncate", false), supportsValidateSql: n(r2, "supportsValidateSql", false), supportsAdd: i2, supportsDelete: c2, supportsEditing: n3, supportsChangeTracking: l2, supportsQuery: a2, supportsQueryAnalytics: n(y2, "supportsQueryAnalytic", false), supportsQueryAttachments: n(y2, "supportsQueryAttachments", false), supportsQueryTopFeatures: n(y2, "supportsTopFeaturesQuery", false), supportsResizeAttachments: n(r2, "supportsAttachmentsResizing", false), supportsSync: o2.includes("sync"), supportsUpdate: d3, supportsExceedsLimitStatistics: n(r2, "supportsExceedsLimitStatistics", false), supportsAsyncConvert3D: n(r2, "supportsAsyncConvert3D", false) };
}
function y(t2, p2) {
  const a2 = t2.advancedQueryCapabilities, n3 = t2.ownershipBasedAccessControlForFeatures, i2 = t2.archivingInfo, c2 = t2.currentVersion, d3 = p2 == null ? void 0 : p2.includes("MapServer"), l2 = !d3 || c2 >= has("mapserver-pbf-version-support"), y2 = g(p2), m2 = new Set((t2.supportedQueryFormats ?? "").split(",").map((t3) => t3.toLowerCase().trim()));
  return { maxRecordCount: r(t2, "maxRecordCount", void 0), maxRecordCountFactor: r(t2, "maxRecordCountFactor", void 0), standardMaxRecordCount: r(t2, "standardMaxRecordCount", void 0), supportedSpatialAggregationStatistics: o(a2), supportsCacheHint: n(a2, "supportsQueryWithCacheHint", false) || u(a2, "query"), supportsCentroid: n(a2, "supportsReturningGeometryCentroid", false), supportsCompactGeometry: y2, supportsDefaultSpatialReference: n(a2, "supportsDefaultSR", false), supportsDisjointSpatialRelationship: n(a2, "supportsDisjointSpatialRel", false), supportsDistance: n(a2, "supportsQueryWithDistance", false), supportsDistinct: n(a2, "supportsDistinct", t2.supportsAdvancedQueries), supportsExtent: n(a2, "supportsReturningQueryExtent", false), supportsFormatPBF: l2 && m2.has("pbf"), supportsFullTextSearch: n(a2, "supportsFullTextSearch", false), supportsGeometryProperties: n(a2, "supportsReturningGeometryProperties", false), supportsHavingClause: n(a2, "supportsHavingClause", false), supportsHistoricMoment: n(i2, "supportsQueryWithHistoricMoment", false), supportsMaxRecordCountFactor: n(a2, "supportsMaxRecordCountFactor", false), supportsOrderBy: n(a2, "supportsOrderBy", t2.supportsAdvancedQueries), supportsPagination: n(a2, "supportsPagination", false), supportsPercentileStatistics: n(a2, "supportsPercentileStatistics", false), supportsQuantization: n(t2, "supportsCoordinatesQuantization", false), supportsQuantizationEditMode: n(t2, "supportsQuantizationEditMode", false), supportsQueryByAnonymous: n(n3, "allowAnonymousToQuery", true), supportsQueryByOthers: n(n3, "allowOthersToQuery", true), supportsQueryGeometry: n(t2, "supportsReturningQueryGeometry", false), supportsResultType: n(a2, "supportsQueryWithResultType", false), supportsSpatialAggregationStatistics: n(a2, "supportsSpatialAggregationStatistics", false), supportsSqlExpression: n(a2, "supportsSqlExpression", false), supportsStandardizedQueriesOnly: n(t2, "useStandardizedQueries", false), supportsStatistics: n(a2, "supportsStatistics", t2.supportsStatistics), supportsTopFeaturesQuery: n(a2, "supportsTopFeaturesQuery", false), tileMaxRecordCount: r(t2, "tileMaxRecordCount", void 0) };
}
function m(t2) {
...
function g2(t2) {
  var _a;
  return { operations: { supportsAppend: n(t2, "supportsAppend", false), supportsExportClip: n(t2, "supportsExportClip", false), supportsExportFrameset: n(t2, "supportsExportFrameset", false), supportsMensuration: n(t2, "supportsMensuration", false), supportsUpdate: n(t2, "supportsUpdate", false) }, query: { supportsCoverageQuery: ((_a = t2 == null ? void 0 : t2.playbackInfo) == null ? void 0 : _a.klv["0601"]) ?? false } };
}
...
//# sourceMappingURL=chunk-M6HMVFJK.js.map
