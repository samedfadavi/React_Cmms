...
var u = class extends B {
  ...
  loadDependencies() {
    return r2({ button: () => import("./calcite-button-PKF5XM3M.js"), input: () => import("./calcite-input-REMJS5HN.js"), label: () => import("./calcite-label-VXG5RRLC.js"), modal: () => import("./calcite-modal-GVOPNHP2.js"), notice: () => import("./calcite-notice-NY6XLCNV.js") });
  }
  get title() {
    var _a;
  ...
  render() {
    var _a;
    const { open: t4, title: e4, messages: s7, signingIn: o3, oAuthPrompt: i3, server: n3, resource: c4, error: u2 } = this, { info: m3, oAuthInfo: h, lblItem: g, invalidUser: b2, noAuthService: v2, lblUser: y2, lblPwd: f2, lblCancel: _2, lblSigning: I2, lblOk: j2 } = s7;
    return n2("div", { class: this.classes(p.base, c2()) }, n2("form", { bind: this, onsubmit: this._submit }, n2("calcite-modal", { bind: this, open: t4, outsideCloseDisabled: true, scale: "s", widthScale: "s", onCalciteModalClose: this._cancel, onCalciteModalOpen: this._focusUsernameInput }, n2("div", { slot: "header" }, e4), n2("div", { slot: "content" }, n2("div", { class: p.info }, s3(i3 ? h : m3, { server: n3 && /\.arcgis\.com/i.test(n3) ? d : n3, resource: `(${c4 || g})` })), u2 ? n2("calcite-notice", { class: p.notice, icon: "exclamation-mark-triangle", kind: "danger", open: true }, n2("div", { slot: "message" }, ((_a = u2.details) == null ? void 0 : _a.httpStatus) ? b2 : v2)) : null, i3 ? null : [n2("calcite-label", null, y2, n2("calcite-input", { afterCreate: (t5) => this._usernameInputNode = t5, autocomplete: "off", bind: this, name: "username", required: true, spellcheck: false, type: "text", value: "" })), n2("calcite-label", null, f2, n2("calcite-input", { afterCreate: (t5) => this._passwordInputNode = t5, bind: this, name: "password", required: true, type: "password", value: "" }))]), n2("calcite-button", { appearance: "outline", bind: this, onclick: this._cancel, slot: "secondary", type: "button", width: "full" }, _2), n2("calcite-button", { loading: !!o3, slot: "primary", type: "submit", width: "full" }, o3 ? I2 : j2))));
  }
  _focusUsernameInput() {
...
var e3 = class {
  ...
  save() {
    ...
    if ((s7 == null ? void 0 : s7.authNamespace) && s7.portalUrl) {
      ...
      r4 || (r4 = e4[s7.authNamespace] = {}), this.appId || (this.appId = s7.appId), r4[s7.portalUrl] = { appId: this.appId, codeVerifier: this.codeVerifier, expires: this.expires, refreshToken: this.refreshToken, ssl: this.ssl, stateUID: this.stateUID, token: this.token, userId: this.userId };
      try {
  ...
  _init() {
    ...
    if ((e4 == null ? void 0 : e4.authNamespace) && e4.portalUrl) {
...
e([y({ json: { write: true } })], i2.prototype, "adminTokenServiceUrl", void 0), e([y({ json: { write: true } })], i2.prototype, "currentVersion", void 0), e([y({ json: { write: true } })], i2.prototype, "hasPortal", void 0), e([y({ json: { write: true } })], i2.prototype, "hasServer", void 0), e([y({ json: { write: true } })], i2.prototype, "owningSystemUrl", void 0), e([y({ json: { write: true } })], i2.prototype, "owningTenant", void 0), e([y({ json: { write: true } })], i2.prototype, "server", void 0), e([y({ json: { write: true } })], i2.prototype, "shortLivedTokenValidity", void 0), e([y({ json: { write: true } })], i2.prototype, "tokenServiceUrl", void 0), e([y({ json: { write: true } })], i2.prototype, "webTierAuth", void 0), i2 = e([a("esri.identity.ServerInfo")], i2);
var s5 = i2;
...
var j = class extends o2 {
  ...
  registerToken(e4) {
    ...
    i3 || (i3 = new s5(), i3.server = this._getServerInstanceRoot(t4), r4 ? i3.hasServer = true : (i3.tokenServiceUrl = this._getTokenSvcUrl(t4), i3.hasPortal = true), this.registerServers([i3])), s7 = this._findCredential(t4), s7 ? (delete e4.server, Object.assign(s7, e4), o3 = false) : (s7 = new E({ userId: e4.userId, server: i3.server ?? void 0, token: e4.token, expires: e4.expires, ssl: e4.ssl, scope: r4 ? "server" : "portal" }), s7.resources = [t4], this.credentials.push(s7)), s7.emitTokenChange(false), o3 || s7.refreshServerTokens();
  }
  toJSON() {
  ...
  getCredential(e4, t4) {
    let r4, s7, o3 = true;
    t4 && (r4 = !!t4.token, s7 = t4.error, o3 = false !== t4.prompt), t4 = { ...t4 }, e4 = this._sanitizeUrl(e4);
    ...
    else if (u2) return _2 = new s2("identity-manager:not-authorized", "You are currently signed in as: '" + u2.userId + "'. You do not have access to this resource: " + e4, { error: s7 }), a3.reject(_2), a3.promise;
    ...
    return g.hasPortal && void 0 === g._selfReq && (o3 || F(g.tokenServiceUrl, this._appOrigin) || this._gwDomains.some((e5) => e5.tokenServiceUrl === g.tokenServiceUrl)) && (g._selfReq = { owningTenant: t4 == null ? void 0 : t4.owningTenant, selfDfd: this._getPortalSelf(g.tokenServiceUrl.replace(this._rePortalTokenSvc, "/sharing/rest/portals/self"), e4) }), this._enqueue(e4, g, t4, a3, h);
  }
  getResourceName(e4) {
  ...
  async checkSignInStatus(e4) {
    return (await this.checkAppAccess(e4, "")).credential;
  }
  checkAppAccess(e4, t4, r4) {
    let o3 = false;
    return this.getCredential(e4, { prompt: false }).then((n3) => {
      let a3;
      const h = { f: "json" };
      if ("portal" === n3.scope) if (t4 && (this._doPortalSignIn(e4) || (r4 == null ? void 0 : r4.force))) a3 = n3.server + "/sharing/rest/oauth2/validateAppAccess", h.client_id = t4;
      else {
      ...
      return n3.token && (h.token = n3.token), U(a3, { query: h, authMode: "anonymous" }).then((e5) => {
        if (false === e5.data.valid) throw new s2("identity-manager:not-authorized", `You are currently signed in as: '${n3.userId}'.`, e5.data);
        return o3 = !!e5.data.viewOnlyUserTypeApp, { credential: n3 };
      }).catch((e5) => {
        var _a;
        if ("identity-manager:not-authorized" === e5.name) throw e5;
        const t5 = (_a = e5.details) == null ? void 0 : _a.httpStatus;
    ...
    }).then((e5) => ({ credential: e5.credential, viewOnly: o3 }));
  }
  ...
  signIn(e4, t4, r4 = {}) {
    ...
    const a3 = new m2({ open: true, resource: this.getResourceName(e4), server: t4.server });
    this.dialog = a3, this.emit("dialog-create");
    let h = a3.on("cancel", n3), d2 = a3.on("submit", (e5) => {
      this.generateToken(t4, e5, { isAdmin: r4.isAdmin, signal: r4.signal }).then((i3) => {
        o3();
        const n4 = new E({ userId: e5.username, server: t4.server ?? void 0, token: i3.token, expires: null != i3.expires ? Number(i3.expires) : null, ssl: !!i3.ssl, isAdmin: r4.isAdmin, validity: i3.validity });
        s7.resolve(n4);
      }).catch((e6) => {
  ...
  oAuthSignIn(e4, t4, r4, s7) {
    ...
    this._getCodeChallenge(n3).then((i3) => {
      ...
      const n4 = new m2({ oAuthPrompt: true, server: t4.server, open: true });
    ...
    this._postMessageAuthHandle && this._postMessageAuthHandle.remove(), this._postMessageAuthHandle = o(window, "message", (t4) => {
      ...
      if ((t4.origin === this._appOrigin || t4.origin.endsWith(".arcgis.com")) && "arcgis:auth:requestCredential" === ((_a = t4.data) == null ? void 0 : _a.type)) {
        ...
        this.getCredential(e4).then((e5) => {
          r4.postMessage({ type: "arcgis:auth:credential", credential: { expires: e5.expires, server: e5.server, ssl: e5.ssl, token: e5.token, userId: e5.userId } }, t4.origin);
        }).catch((e5) => {
          r4.postMessage({ type: "arcgis:auth:error", error: { name: e5.name, message: e5.message } }, t4.origin);
        });
      }
    });
  }
  ...
  _getOAuthLocationParams() {
    ...
    if (t4) {
      ...
      if (r4) {
        ...
        const r5 = v(t5), s7 = window.location.pathname + (r5 ? `?${r5}` : "") + (((_b = e5.state) == null ? void 0 : _b.hash) || "");
        window.history.replaceState(window.history.state, "", s7);
      }
    }
  }
  _getOAuthToken(e4, t4, r4, i3, o3) {
    return e4 = e4.replace(/^http:/i, "https:"), U(`${e4}/sharing/rest/oauth2/token`, { authMode: "anonymous", method: "post", query: i3 && o3 ? { grant_type: "authorization_code", code: t4, redirect_uri: i3, client_id: r4, code_verifier: o3 } : { grant_type: "refresh_token", refresh_token: t4, client_id: r4 } }).then((e5) => e5.data);
  }
  async _getCodeChallenge(e4) {
    if (e4 && globalThis.isSecureContext) {
      const t4 = new TextEncoder().encode(e4), r4 = await crypto.subtle.digest("SHA-256", t4);
  ...
  _findCredential(e4, t4) {
    ...
    const a3 = t4 == null ? void 0 : t4.token, h = t4 == null ? void 0 : t4.resource, l2 = this._isServerRsrc(e4) ? "server" : "portal", c4 = this.credentials.filter((t5) => this._hasSameServerInstance(t5.server, e4) && t5.scope === l2);
    if (e4 = h || e4, c4.length) if (1 === c4.length) {
      if (r4 = c4[0], i3 = this.findServerInfo(r4.server), s7 = i3 == null ? void 0 : i3.owningSystemUrl, o3 = s7 ? this.findCredential(s7, r4.userId) : void 0, n3 = this._getIdenticalSvcIdx(e4, r4), !a3) return -1 === n3 && r4.resources.push(e4), this._addResource(e4, o3), r4;
      -1 !== n3 && (r4.resources.splice(n3, 1), this._removeResource(e4, o3));
    } else {
      let t5, r5;
      if (c4.some((a4) => (r5 = this._getIdenticalSvcIdx(e4, a4), -1 !== r5 && (t5 = a4, i3 = this.findServerInfo(t5.server), s7 = i3 == null ? void 0 : i3.owningSystemUrl, o3 = s7 ? this.findCredential(s7, t5.userId) : void 0, n3 = r5, true))), a3) t5 && (t5.resources.splice(n3, 1), this._removeResource(e4, o3));
  ...
  _useProxy(e4, t4) {
    return (t4 == null ? void 0 : t4.isAdmin) && !F(e4.adminTokenServiceUrl, this._appOrigin) || !this._isPortalDomain(e4.tokenServiceUrl) && "10.1" === String(e4.currentVersion) && !F(e4.tokenServiceUrl, this._appOrigin);
  }
  _getOrigin(e4) {
    const t4 = new x(e4);
  ...
  _isIdProvider(e4, t4) {
    ...
    if (r4 > -1 && s7 > -1 && (0 === r4 || 4 === r4 ? 0 !== s7 && 4 !== s7 || (i3 = true) : 1 === r4 ? 1 !== s7 && 2 !== s7 || (i3 = true) : 2 === r4 ? 2 === s7 && (i3 = true) : 3 === r4 && 3 === s7 && (i3 = true)), !i3) {
      const r5 = this.findServerInfo(t4), s8 = r5 == null ? void 0 : r5.owningSystemUrl;
  ...
  _getTokenSvcUrl(e4) {
    ...
    if (this._isRESTService(e4) || this._isAdminResource(e4)) {
      ...
      return t4 = i4 + "/admin/generateToken", r4 = U(e4 = i4 + "/rest/info", { query: { f: "json" } }).then((e5) => e5.data), { adminUrl: t4, promise: r4 };
    }
  ...
  _processOAuthResponseParams(e4, t4, r4) {
    ...
    if (e4.code) {
      ...
      return s7.codeVerifier = null, s7.stateUID = null, s7.save(), this._getOAuthToken(r4.server, e4.code, t4.appId, this._getRedirectURI(t4, true), i4).then((i5) => {
        const o3 = new E({ userId: i5.username, server: r4.server ?? void 0, token: i5.access_token, expires: Date.now() + 1e3 * i5.expires_in, ssl: i5.ssl, oAuthState: e4.state, _oAuthCred: s7 });
    ...
    const i3 = new E({ userId: e4.username, server: r4.server ?? void 0, token: e4.access_token, expires: Date.now() + 1e3 * Number(e4.expires_in), ssl: "true" === e4.ssl, oAuthState: e4.state, _oAuthCred: s7 });
  ...
  _processOAuthPopupParams(e4) {
    ...
    if (this._oAuthDfd = null, t4) if (clearInterval(this._oAuthIntervalId), (_a = this._oAuthOnPopupHandle) == null ? void 0 : _a.remove(), e4.error) {
  ...
  async _exchangeToken(e4, t4, r4) {
    return (await U(`${e4}/sharing/rest/oauth2/exchangeToken`, { authMode: "anonymous", method: "post", query: { f: "json", client_id: t4, token: r4 } })).data.token;
  }
  async _getPlatformSelf(e4, t4) {
    var _a;
    ...
    try {
      const r4 = await U(`${e4}/sharing/rest/oauth2/platformSelf`, { authMode: "anonymous", headers: { "X-Esri-Auth-Client-Id": t4, "X-Esri-Auth-Redirect-Uri": window.location.href.replace(/#.*$/, "") }, method: "post", query: { f: "json", expiration: 30 }, withCredentials: true });
  ...
  _getPortalSelf(e4, t4) {
    let r4;
    if (this._gwDomains.some((t5) => (t5.regex.test(e4) && (r4 = t5.customBaseUrl), !!r4)), r4) return Promise.resolve({ allSSL: true, currentVersion: "8.4", customBaseUrl: r4, portalMode: "multitenant", supportsOAuth: true });
  ...
  _checkProtocol(e4, t4, r4, s7) {
    ...
    if (n3.trim().toLowerCase().startsWith("https:") && !this._appOrigin.startsWith("https:") && T(n3) && (o3 = !!this._protocolFunc && !!this._protocolFunc({ resourceUrl: e4, serverInfo: t4 }), !o3)) {
  ...
  _doSignIn(e4) {
    ...
    const t4 = (t5) => {
      var _a;
      const r5 = (_a = e4.options_) == null ? void 0 : _a.resource, s8 = e4.resUrl_, i3 = e4.refresh_;
      let o4 = false;
      ...
      }), this._busy = e4.resUrl_ = e4.sinfo_ = e4.refresh_ = null, o4 || this.emit("credential-create", { credential: t5 }), this._soReqs.length ? this._doSignIn(this._soReqs.shift()) : this._xoReqs.length && this._doSignIn(this._xoReqs.shift());
    }, r4 = (t5) => {
      ...
      let f2, g;
      if (o4) t4(new E({ userId: o4, server: d3.server ?? void 0, token: h ?? void 0, expires: null != l3 ? Number(l3) : null, ssl: !!a4 }));
        ...
        if (o5.isValid()) {
          ...
          this._doPortalSignIn(e4.resUrl_) ? e4._pendingDfd = this._getPlatformSelf(d3.server, _2.appId).then((e5) => {
            F(e5.portalUrl, this._appOrigin, true) ? (f2 = new E({ userId: e5.username, server: d3.server ?? void 0, expires: Date.now() + 1e3 * e5.expires_in, token: e5.token }), t4(f2)) : s8();
          }).catch(s8) : s8();
        }
      } else if (u2) {
      ...
      let n3, a4, h, l3;
      if (o4 && (n3 = o4.token, a4 = o4.error, h = o4.prompt), l3 = this._findCredential(i3, { token: n3, resource: e4.resUrl_ }), !l3) {
      ...
      if (l3) {
        ...
        if (i4) t4(i4);
          ...
          (e4._pendingDfd = this.generateToken(this.findServerInfo(l3.server), null, { serverUrl: e4.resUrl_, token: l3.token, signal: e4.options_.signal, ssl: l3.ssl })).then((r5) => {
            t4(new E({ userId: l3 == null ? void 0 : l3.userId, server: s8.server ?? void 0, token: r5.token, expires: null != r5.expires ? Number(r5.expires) : null, ssl: !!r5.ssl, isAdmin: e4.admin_, validity: r5.validity }));
          }, r4);
        }
      } else {
        this._busy = null, n3 && (e4.options_.token = null);
        (e4._pendingDfd = this.getCredential(i3.replace(/\/?$/, "/sharing"), { resource: e4.resUrl_, owningTenant: s8.owningTenant, signal: e4.options_.signal, token: n3, error: a4, prompt: h })).then(() => {
    ...
    d2 ? d2.promise.then((t5) => {
      ...
      const r5 = {};
      let s8, i3, o4, n3;
      return t5 && (s8 = (_a = t5.user) == null ? void 0 : _a.username, r5.username = s8, r5.allSSL = t5.allSSL, i3 = t5.supportsOAuth, n3 = parseFloat(t5.currentVersion), "multitenant" === t5.portalMode && (o4 = t5.customBaseUrl), e4.sinfo_.currentVersion = n3), e4.sinfo_.webTierAuth = !!s8, s8 && this.normalizeWebTierAuth ? this.generateToken(e4.sinfo_, null, { ssl: r5.allSSL }).catch(() => null).then((e5) => (r5.portalToken = e5 == null ? void 0 : e5.token, r5.tokenExpiration = e5 == null ? void 0 : e5.expires, r5)) : !s8 && i3 && n3 >= 4.4 && !this._findOAuthInfo(e4.resUrl_) ? this._generateOAuthInfo({ portalUrl: e4.sinfo_.server, customBaseUrl: o4, owningTenant: e4.sinfo_._selfReq.owningTenant }).catch(() => null).then(() => r5) : r5;
    }).catch(() => null).then((t5) => {
  ...
  _generateOAuthInfo(e4) {
    ...
    return a3 && r4 ? (this._hasTestedIfAppIsOnPortal = true, t4 = U(r4 + "/sharing/rest", { query: { f: "json" } }).then(() => {
      ...
      if (this._defaultOAuthInfo) return i3 = i3.replace(/^http:/i, "https:"), U(i3 + "/sharing/rest/oauth2/validateRedirectUri", { query: { accountId: n3, client_id: this._defaultOAuthInfo.appId, redirect_uri: _(this._defaultOAuthInfo.popupCallbackUrl), f: "json" } }).then((e5) => {
        if (e5.data.valid) {
  ...
  _doOAuthSignIn(e4, t4, r4, s7) {
    const o3 = r4._oAuthCred, a3 = { portalUrl: r4.portalUrl };
    !r4.popup && r4.preserveUrlHash && window.location.hash && (a3.hash = window.location.hash), o3.stateUID && (a3.uid = o3.stateUID);
    const h = { client_id: r4.appId, response_type: o3.codeVerifier ? "code" : "token", state: JSON.stringify(a3), expiration: r4.expiration, locale: r4.locale, redirect_uri: this._getRedirectURI(r4, !!o3.codeVerifier) };
    ...
    } else this._rejectOnPersistedPageShow = true, this._oAuthRedirectFunc ? this._oAuthRedirectFunc({ authorizeParams: h, authorizeUrl: l2, resourceUrl: e4, serverInfo: t4, oAuthInfo: r4 }) : window.location.href = c4;
  }
...
var E = class extends o2.EventedAccessor {
  ...
  refreshToken() {
    const e4 = t2, t4 = e4.findServerInfo(this.server), s7 = t4 == null ? void 0 : t4.owningSystemUrl, i3 = !!s7 && "server" === this.scope, o3 = i3 && b(t4, e4._legacyFed), n3 = t4.webTierAuth, a3 = n3 && e4.normalizeWebTierAuth, h = R[this.server], l2 = h == null ? void 0 : h[this.userId];
    let c4, d2 = this.resources && this.resources[0], u2 = i3 ? e4.findServerInfo(s7) : null, p3 = { username: this.userId, password: l2 };
    if (n3 && !a3) return;
    ...
    if (!i3 || _2) {
      if (!o3) {
        if (i3) c4 = { serverUrl: d2, token: _2 == null ? void 0 : _2.token, ssl: _2 == null ? void 0 : _2.ssl };
  ...
  refreshServerTokens() {
    if ("portal" === this.scope) {
      ...
      e4.credentials.forEach((t4) => {
        const r4 = e4.findServerInfo(t4.server), s7 = r4 == null ? void 0 : r4.owningSystemUrl;
  ...
  emitTokenChange(e4) {
    ...
    const t4 = t2, s7 = this.server ? t4.findServerInfo(this.server) : null, i3 = s7 == null ? void 0 : s7.owningSystemUrl, o3 = i3 ? t4.findServerInfo(i3) : null;
    false === e4 || i3 && "portal" !== this.scope && (!(o3 == null ? void 0 : o3.webTierAuth) || t4.normalizeWebTierAuth) || null == this.expires && null == this.validity || this._startRefreshTimer(), this.emit("token-change");
  }
  destroy() {
  ...
  toJSON() {
    const e4 = l({ userId: this.userId, server: this.server, token: this.token, expires: this.expires, validity: this.validity, ssl: this.ssl, isAdmin: this.isAdmin, creationTime: this.creationTime, scope: this.scope }), t4 = this.resources;
...
//# sourceMappingURL=IdentityManager-CAO2BIBE.js.map
