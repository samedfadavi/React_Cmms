...
var h = class extends S {
  ...
  addOnCollectionChange(s, e3, { initial: i = false, final: n = false } = {}) {
    const r = ++this._handleId;
    return this.addHandles([v2(s, "after-changes", this._createSyncUpdatingCallback(), C), v2(s, "change", e3, { onListenerAdd: i ? (s2) => e3({ added: s2.toArray(), removed: [] }) : void 0, onListenerRemove: n ? (s2) => e3({ added: [], removed: s2.toArray() }) : void 0 })], r), e2(() => this.removeHandles(r));
  }
  addPromise(s) {
    if (null == s) return s;
  ...
  _installWatch(s, e3, i = {}, n) {
    ...
    const a2 = n(s, e3, i);
    return this.addHandles(a2, d2), e2(() => this.removeHandles(d2));
  }
...
e([y({ readOnly: true })], h.prototype, "updating", void 0), h = e([a("esri.core.support.UpdatingHandles")], h);
var c = -42;

export {
  h
};
//# sourceMappingURL=chunk-6V4RA3W6.js.map
