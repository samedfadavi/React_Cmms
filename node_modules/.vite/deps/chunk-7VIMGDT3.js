...
async function r2(r3, n4, t2, s2, a2, i3, l) {
  let d2 = null;
  if (null != t2) {
    const o3 = `${r3}/nodepages/`, n5 = o3 + Math.floor(t2.rootIndex / t2.nodesPerPage);
    try {
      ...
      null != i3 && i3.warn("#fetchIndexInfo()", "Failed to load root node page. Falling back to node documents.", n5, g2), d2 = g2;
    }
  }
  if (!n4) return null;
  const p3 = n4 == null ? void 0 : n4.split("/").pop(), c = `${r3}/nodes/`, u2 = c + p3;
  try {
    return { type: "node", rootNode: (await U(u2, { query: { f: "json", ...s2, token: a2 }, responseType: "json", signal: l })).data, urlPrefix: c };
  } catch (g2) {
    throw new s("sceneservice:root-node-missing", "Root node missing.", { pageError: d2, nodeError: g2, url: u2 });
  }
}
...
var L = (L2) => {
  let M = class extends L2 {
    ...
    set url(e2) {
      ...
      const t2 = S2({ layer: this, url: e2, nonStandardUrlAllowed: false, logger: n.getLogger(this) });
    ...
    async _fetchIndexAndUpdateExtent(e2, t2) {
      var _a;
      this.indexInfo = r2(((_a = this.parsedUrl) == null ? void 0 : _a.path) ?? "", this.rootNode, e2, this.customParameters, this.apiKey, n.getLogger(this), t2), null == this.fullExtent || this.fullExtent.hasZ || this._updateExtent(await this.indexInfo);
    }
    _updateExtent(e2) {
      var _a, _b, _c, _d;
    ...
    async _save(e2) {
      ...
      return await Promise.all(o3.resources.pendingOperations ?? []), await this._validateAgainstJSONSchema(i3, o3, t2), this.url && (this.portalItem.url = this.url), this.portalItem.title || (this.portalItem.title = this.title), O(this.portalItem, t2, P.existingItem), await n2(this.portalItem, i3, this.resourceReferences, o3), i(o3), this.portalItem;
    }
...
//# sourceMappingURL=chunk-7VIMGDT3.js.map
