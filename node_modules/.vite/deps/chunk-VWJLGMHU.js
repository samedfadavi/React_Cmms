...
import {
  stampVersion
} from "./chunk-GP37RDGU.js";
import {
  isBrowser
} from "./chunk-I4UBGMTI.js";
import {
  autoMode,
  darkMode
} from "./chunk-3XW4ZFBO.js";
import {
  getAssetPath,
  setAssetPath
} from "./chunk-P5HR6D5U.js";
import {
  n as n4
...
var e6 = { handleInterceptedEvent: (e10, p2, t4, n11) => (e10.scheduleRender(), p2.properties[`on${n11.type}`].apply(p2.properties.bind || t4, [n11])) };

// ../node_modules/@arcgis/core/libs/maquette-advanced-projector/utils.js
var e7 = { namespace: void 0, performanceLogger: () => {
}, eventHandlerInterceptor: void 0, styleApplyer: (e10, r3, t4) => {
...
var n8 = (e10, t4) => e10.find(t4);
var d3 = (e10, t4, r3 = false) => {
  let o6 = e10;
  return t4.forEach((e11, d4) => {
    const s3 = (o6 == null ? void 0 : o6.children) ? n8(o6.children, (t5) => t5.domNode === e11) : void 0;
    r3 && !s3 && d4 !== t4.length - 1 || (o6 = s3);
  }), o6;
};
var s2 = (n11) => {
  let s3;
  const i2 = { ...e6, ...n11 }, c3 = r(i2), a3 = c3.performanceLogger;
  ...
  const f6 = [], u2 = [], h2 = (e10, t4, r3) => {
    ...
    c3.eventHandlerInterceptor = (e11, t5, r4, c4) => function(e12) {
      let t6;
      a3("domEvent", e12);
      const r5 = o5(e12.currentTarget, n12.domNode), c5 = r5.some((e13) => {
        var _a2;
    ...
    }, (_a = i2.postProcessProjectionOptions) == null ? void 0 : _a.call(i2, c3);
    const m2 = r3();
  ...
  return i2.modifyDoRenderImplementation && (v = i2.modifyDoRenderImplementation(v, f6, u2)), s3 = { renderNow: v, scheduleRender: () => {
...
function r2(t4) {
  var _a;
  const o6 = [];
  for (const s3 of Object.keys(t4)) customElements.get(`calcite-${s3}`) || o6.push((_a = t4[s3]) == null ? void 0 : _a.call(t4));
...
var x = s2({ postProcessProjectionOptions(e10) {
  const t4 = e10.eventHandlerInterceptor, r3 = /capture$/i;
  e10.eventHandlerInterceptor = (e11, s3, o6, i2) => {
    const n11 = t4 == null ? void 0 : t4(e11, s3, o6, i2), a3 = r3.test(e11);
    if (!((e11 = e11.replace(r3, "")).toLowerCase() in o6) || a3) {
      const t5 = e11[2].toLowerCase() + e11.slice(3), r4 = (e12) => n11 == null ? void 0 : n11.call(o6, e12);
      o6.addEventListener(t5, r4, a3);
      const s4 = () => o6.removeEventListener(t5, r4, a3), d4 = i2.afterRemoved;
      i2.afterRemoved = (e12) => {
        d4 == null ? void 0 : d4(e12), s4();
      };
    }
    return n11;
  };
}, handleInterceptedEvent(e10, t4, r3, s3) {
  const { eventPhase: o6, type: i2 } = s3, n11 = o6 === Event.CAPTURING_PHASE;
...
var O = class extends n3(o2.EventedAccessor) {
  constructor(e10, t4) {
    super(e10, t4), this._attached = false, this._projector = x, this._readyForTrueRender = false, this.key = this, this.autoRenderingEnabled = true, this._loadLocale = k(async () => {
      var _a;
      if ((_a = this._messageBundleProps) == null ? void 0 : _a.length) {
        const e11 = await Promise.allSettled(this._messageBundleProps.map(async ({ bundlePath: e12, propertyName: t5 }) => {
    ...
    this._trackingTarget = new e2(() => {
      this.autoRenderingEnabled && this.scheduleRender();
    });
    const o6 = () => ({ vnodeSelector: "div", properties: { key: `${r3}-hidden`, class: "", styles: { display: "none" } }, domNode: null, children: void 0, text: void 0 }), i2 = () => {
      var _a, _b;
      if (!this._readyForTrueRender || this.destroyed) return null;
      const e11 = s3() ?? o6(), t5 = e11.properties ?? (e11.properties = {});
      if (t5.key ?? (t5.key = r3), f5(e11.vnodeSelector)) {
      ...
      let i3 = 0;
      return (_b = e11.children) == null ? void 0 : _b.forEach((e12) => {
        var _a2;
        f5(e12.vnodeSelector) || (e12.properties ?? (e12.properties = {}), (_a2 = e12.properties).key ?? (_a2.key = `${this.id}--${i3++}`));
      }), d2(this, e11);
    };
    this.render = () => {
      if (A2) return i2();
  ...
  beforeFirstRender() {
    ...
    return ((_a = this._messageBundleProps) == null ? void 0 : _a.length) || e10 ? Promise.all([e10, this._loadLocale()]).then(() => {
    }).catch(f2) : null;
  }
  loadDependencies() {
    return null;
  ...
  own(e10) {
    t(n.getLogger(this), "`Widget.own()` is deprecated in favor of 'Widget.addHandles()'", { replacement: "Widget.addHandles()", version: "4.28" }), this.addHandles(e10);
  }
  classes(...e10) {
  ...
  _postInitialize() {
    var _a;
    if (this.destroyed) return;
    this.scheduleRender(), ((_a = this._delegatedEventNames) == null ? void 0 : _a.length) && this.addHandles(d(() => this.viewModel, (e11, t4) => {
...
O[$] = true, e([y()], O.prototype, "_readyForTrueRender", void 0), e([y({ value: null })], O.prototype, "container", null), e([s("container")], O.prototype, "castContainer", null), e([y()], O.prototype, "icon", null), e([y()], O.prototype, "id", null), e([y()], O.prototype, "label", null), e([y()], O.prototype, "renderable", null), e([y()], O.prototype, "uiStrings", void 0), e([y()], O.prototype, "viewModel", void 0), e([y({ value: true })], O.prototype, "visible", null), e([y()], O.prototype, "key", void 0), e([y()], O.prototype, "children", void 0), e([y()], O.prototype, "afterCreate", void 0), e([y()], O.prototype, "afterUpdate", void 0), e([y()], O.prototype, "afterRemoved", void 0), O = e([a2(U)], O);
var B = O;
...
function e9(e10) {
  return (s3, r3) => {
    ...
    s3._messageBundleProps.push({ bundlePath: e10, propertyName: r3 });
  };
}
...
@esri/calcite-components/dist/components/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-VWJLGMHU.js.map
