...
e2 = i, r = "undefined" != typeof document && document.currentScript ? document.currentScript.src : void 0, a = function(n) {
  ...
  function _n(n2, t) {
    return t.ha && t.ga || tn("makeClassHandle requires ptr and ptrType"), !!t.la != !!t.ja && tn("Both smartPtrType and smartPtr must be specified"), t.count = { value: 1 }, Cn(Object.create(n2, { ea: { value: t } }));
  }
  function Cn(n2) {
    return "undefined" == typeof FinalizationRegistry ? (Cn = (n3) => n3, n2) : (pn = new FinalizationRegistry((n3) => {
      ...
      var t = n3.ea;
      return t.ja && pn.register(n3, { ea: t }, n3), n3;
    })(n2));
  }
  function Pn() {
  }
  ...
  function bt(n2, t, e4, r2) {
    ...
    var f2 = y[r2 + 40 >> 2];
    for (var s2 in r2 = { jb: y[r2 >> 2], ib: y[r2 + 4 >> 2], za: y[r2 + 8 >> 2], Ea: y[r2 + 12 >> 2], Aa: y[r2 + 16 >> 2], sa: y[r2 + 20 >> 2], na: y[r2 + 24 >> 2], ra: y[r2 + 28 >> 2], mb: y[r2 + 32 >> 2], hb: y[r2 + 36 >> 2], kb: f2 && f2 ? $(d, f2) : "" }, e4 = e4 ? $(d, e4) : "", f2 = { "%c": "%a %b %d %H:%M:%S %Y", "%D": "%m/%d/%y", "%F": "%Y-%m-%d", "%h": "%b", "%r": "%I:%M:%S %p", "%R": "%H:%M", "%T": "%H:%M:%S", "%x": "%m/%d/%y", "%X": "%H:%M:%S", "%Ec": "%c", "%EC": "%C", "%Ex": "%m/%d/%y", "%EX": "%H:%M:%S", "%Ey": "%y", "%EY": "%Y", "%Od": "%d", "%Oe": "%e", "%OH": "%H", "%OI": "%I", "%Om": "%m", "%OM": "%M", "%OS": "%S", "%Ou": "%u", "%OU": "%U", "%OV": "%V", "%Ow": "%w", "%OW": "%W", "%Oy": "%y" }) e4 = e4.replace(new RegExp(s2, "g"), f2[s2]);
  ...
  an = wt, un = e3.BindingError = Q("BindingError"), Pn.prototype.isAliasOf = function(n2) {
    ...
    return (n2 = n2(e4.call(t, r2, { ea: { value: { count: a3.count, ua: a3.ua, va: a3.va, ga: a3.ga, ha: a3.ha, ja: a3.ja, la: a3.la } } }))).ea.count.value += 1, n2.ea.ua = false, n2;
    ...
    return null === a3 ? t.call(this) : this.ya ? _n(r2.fa.pa, { ha: r2, ga: a3, la: this, ja: n2 }) : _n(r2.fa.pa, { ha: r2, ga: a3 });
  ...
  var Tt = { n: function(n2) {
    ...
    en([n2], a3.map((n3) => n3.Ta).concat(a3.map((n3) => n3.eb)), (n3) => {
      ...
      }, argPackAdvance: 8, readValueFromPointer: L, ka: r2 }];
    });
    ...
    i3 && (a3 = (1n << 64n) - 1n), fn(n2, { name: t, fromWireType: function(n3) {
      ...
      return e5;
    }, argPackAdvance: 8, readValueFromPointer: sn(t, e4, !i3), ka: null });
    ...
    kn(p2, function() {
      ...
      return mn[n2] = { pointerType: a4, Ia: l3 }, Dn(p2, t2), [e5, a4, l3];
    });
    ...
    e4 = ln(e4), t = on(t), a3.values = {}, fn(n2, { name: t, constructor: a3, fromWireType: function(n3) {
      ...
      return t2.value;
    }, argPackAdvance: 8, readValueFromPointer: Gn(t, e4, r2), ka: null }), kn(t, a3);
  }, e: function(n2, t, e4) {
    var r2 = Jn(n2, "enum");
    ...
    e4 = ln(e4), fn(n2, { name: t = on(t), fromWireType: function(n3) {
      ...
      return t2;
    }, argPackAdvance: 8, readValueFromPointer: Zn(t, e4), ka: null });
    ...
    e4 = t.includes("unsigned") ? function(n3, t2) {
      ...
      return t2;
    }, fn(n2, { name: t, fromWireType: i3, toWireType: e4, argPackAdvance: 8, readValueFromPointer: sn(t, a3, 0 !== r2), ka: null });
  }, r: function(n2, t, e4) {
    function r2(n3) {
      var t2 = b;
    ...
    q[n2] = { name: on(t), Ca: Un(e4, r2), oa: Un(a3, i3), Ga: [] };
  }, j: function(n2, t, e4, r2, a3, i3, o4, u3, c2, f2) {
    q[n2].Ga.push({ Na: on(t), Ta: e4, Ra: Un(r2, a3), Sa: i3, eb: o4, cb: Un(u3, c2), fb: f2 });
  }, T: function(n2, t) {
...
//# sourceMappingURL=arcgis-knowledge-client-core-simd-MHSS42PV.js.map
