...
var a = { visualVariableColor: null, visualVariableOpacity: null, visualVariableSizeMinMaxValue: null, visualVariableSizeScaleStops: null, visualVariableSizeStops: null, visualVariableSizeUnitValue: null, visualVariableRotation: null, visualVariableSizeOutlineScaleStops: null };
var o3 = class {
  constructor() {
    this.instances = { fill: n(h2.fill, { uniforms: a, optionalAttributes: { zoomRange: true } }), marker: n(h2.marker, { uniforms: a, optionalAttributes: { zoomRange: true } }), line: n(h2.line, { uniforms: a, optionalAttributes: { zoomRange: true } }), text: n(h2.text, { uniforms: a, optionalAttributes: { zoomRange: true, referenceSymbol: false, clipAngle: false } }), complexFill: n(h2.complexFill, { uniforms: a, optionalAttributes: { zoomRange: true } }), texturedLine: n(h2.texturedLine, { uniforms: a, optionalAttributes: { zoomRange: true } }) }, this._instancesById = Object.values(this.instances).reduce((e2, i4) => (e2.set(i4.instanceId, i4), e2), /* @__PURE__ */ new Map());
  }
  getInstance(e2) {
...
var b2 = class extends s {
  ...
  doRender(t2) {
    const { context: e2 } = t2, r5 = this._getBounds();
  ...
  _updateMatricesAndLocalOrigin(t2) {
    const { state: a2 } = t2, { displayMat3: m, size: c2, resolution: u2, pixelRatio: _, rotation: h3, viewpoint: d } = a2, p = v * h3, { x: g, y: x2 } = d.targetGeometry, b3 = L(g, a2.spatialReference);
  ...
  _updateBufferData(t2, e2) {
    const { x: r5, y: i4 } = this._localOrigin, s2 = 2 * x * e2.length, o4 = new Float32Array(s2), a2 = new Uint32Array(8 * e2.length);
    let n2 = 0, l2 = 0;
    ...
    if (this._vertexBuffer ? this._vertexBuffer.setData(o4.buffer) : this._vertexBuffer = c.createVertex(t2, F.DYNAMIC_DRAW, o4.buffer), this._indexBuffer ? this._indexBuffer.setData(a2) : this._indexBuffer = c.createIndex(t2, F.DYNAMIC_DRAW, a2), !this._vao) {
      const e3 = y();
      this._vao = new o2(t2, e3.attributes, e3.bufferLayouts, { geometry: this._vertexBuffer }, this._indexBuffer);
    }
  }
};
...
//# sourceMappingURL=chunk-C7HZGCQT.js.map
