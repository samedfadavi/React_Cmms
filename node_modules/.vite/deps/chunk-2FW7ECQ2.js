...
var c2 = m2 = class extends p {
  ...
  clone() {
    return new m2({ colorRamps: a(this.colorRamps) });
  }
};
e([y({ type: [a3], json: { write: true } })], c2.prototype, "colorRamps", void 0), e([y({ type: ["multipart"] })], c2.prototype, "type", void 0), c2 = m2 = e([a2("esri.rest.support.MultipartColorRamp")], c2);
var a4 = c2;

// ../node_modules/@arcgis/core/rest/support/colorRamps.js
var m3 = { key: "type", base: p, typeMap: { algorithmic: a3, multipart: a4 } };
function p2(o2) {
  return (o2 == null ? void 0 : o2.type) ? "algorithmic" === o2.type ? a3.fromJSON(o2) : "multipart" === o2.type ? a4.fromJSON(o2) : null : null;
}
...
//# sourceMappingURL=chunk-2FW7ECQ2.js.map
