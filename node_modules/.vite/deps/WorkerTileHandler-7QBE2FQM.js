...
var l4 = class {
  ...
  getShaping(s6, c5, h5) {
    ...
    for (const t5 of s6) {
      ...
      m2.push({ codePoint: e5, x: f3, y: p4, vertical: i6, glyphMosaicItem: s7 }), s7 && (f3 += s7.metrics.advance + l6);
    }
    let g2 = f3;
    if (r6 > 0) {
  ...
  static getTextBox(t5, e5) {
    ...
    return { x: i6, y: o6, width: s6 - i6, height: c5 - o6 };
  }
  static getBox(t5) {
    if (!t5.length) return null;
  ...
  static addDecoration(t5, e5) {
    ...
    for (let n5 = 1; n5 < i6; n5++) {
      ...
      if (i7.y !== h5) {
        ...
        t5.push({ codePoint: 0, x: c5, y: h5 + e5 - o6, vertical: false, glyphMosaicItem: { sdf: true, rect: new t2(4, 0, 4, 8), metrics: { width: l7 - c5, height: 2 + 2 * o6, left: 0, top: 0, advance: 0 }, page: 0, code: 0 } }), h5 = i7.y, c5 = i7.x + i7.glyphMosaicItem.metrics.left;
      }
    }
    const l6 = t5[i6 - 1].x + t5[i6 - 1].glyphMosaicItem.metrics.left + t5[i6 - 1].glyphMosaicItem.metrics.width;
    t5.push({ codePoint: 0, x: c5, y: h5 + e5 - o6, vertical: false, glyphMosaicItem: { sdf: true, rect: new t2(4, 0, 4, 8), metrics: { width: l6 - c5, height: 2 + 2 * o6, left: 0, top: 0, advance: 0 }, page: 0, code: 0 } });
  }
  ...
  _buildBreak(t5, e5, i6, o6, s6, c5) {
    ...
    return { index: t5, x: e5, score: l6, previousBreak: h5 };
  }
  _optimalBreaks(t5) {
...
var b2 = class {
  ...
  _addIconPlacement(t5, i6, s6, o6, a6) {
    ...
    if (t5.shapes.push(M), (!o6.allowOverlap || !o6.ignorePlacement) && o2) {
      const e5 = o6.size, s7 = o6.padding, l7 = { xTile: i6.x, yTile: i6.y, dxPixels: x2 * e5 - s7, dyPixels: d2 * e5 - s7, hard: !o6.optional, partIndex: 0, width: h5 * e5 + 2 * s7, height: r6 * e5 + 2 * s7, angle: a6, minLod: w, maxLod: r };
  ...
  getTextPlacement(s6, o6, a6, c5) {
    ...
    for (const t5 of o6) {
      ...
      if (M && N) {
        if (void 0 !== H && H !== t5.y) {
          ...
          const a7 = { xTile: s6.x, yTile: s6.y, dxPixels: e5 * R - P, dyPixels: t6 * R - P, hard: !c5.optional, partIndex: 1, width: i6 * R + 2 * P, height: o8 * R + 2 * P, angle: d2, minLod: w, maxLod: r };
      ...
      for (const i6 of m2) {
        ...
        if (k && B ? t5.vertical ? i6.alternateVerticalGlyph ? (p4 = 32, w2 = 96) : (p4 = 224, w2 = 32) : (p4 = 224, w2 = 96) : (p4 = 192, w2 = 64), E2.push(new I2(n5, a7, o8, r6, l6, i6.labelAngle, p4, w2, i6.anchor, i6.minzoom, i6.maxzoom, i6.page)), M && (!v || this._legible(i6.labelAngle))) {
          if (N) u4 < A2 && (A2 = u4), g3 < z && (z = g3), S > L2 && (L2 = S), m3 > F && (F = m3);
            ...
            const e5 = { xTile: s6.x, yTile: s6.y, dxPixels: (u4 + V) * R - P, dyPixels: (g3 + V) * R - P, hard: !c5.optional, partIndex: 1, width: (S - u4) * R + 2 * P, height: (m3 - g3) * R + 2 * P, angle: x3, minLod: i6.minzoom, maxLod: i6.maxzoom };
            M.push(e5);
          }
        }
      }
    ...
    if (M && N) {
      ...
      const a7 = { xTile: s6.x, yTile: s6.y, dxPixels: e5 * R - P, dyPixels: t5 * R - P, hard: !c5.optional, partIndex: 1, width: i6 * R + 2 * P, height: o7 * R + 2 * P, angle: d2, minLod: w, maxLod: r };
      M.push(a7);
    }
    const C2 = new u2(E2);
...
var s4 = class _s extends t4 {
  ...
  processFeatures(t5) {
    ...
    const e5 = this.layer, i6 = this.zoom, { fillMaterial: r6, outlineMaterial: l6, hasDataDrivenFill: n5, hasDataDrivenOutline: s6 } = e5;
    ...
    if (a6) {
      ...
      for (const a7 of u4) {
        ...
        n6.push({ ddFillAttributes: x2, ddOutlineAttributes: c5, page: h5.page, geometry: _2 }), n6.sort((t6, e6) => t6.page - e6.page);
        for (const { ddFillAttributes: t6, ddOutlineAttributes: i7, page: r7, geometry: l7 } of n6) this._processFeature(l7, f3, e5.outlineUsesFillColor, t6, i7, d2, r7);
      }
  ...
  _processFill(r6, l6, n5, s6, o6) {
    ...
    if (s6 && i2.deviation(d2, a6, 2, h5) > 0) {
      const t5 = l6.map((t6) => r6[t6].length), { buffer: e5, vertexCount: s7 } = a(d2, t5);
      if (s7 > 0) {
...
var n4 = class extends t4 {
  ...
  processFeatures(e5) {
    ...
    const t5 = this.layer, i6 = this.zoom, s6 = this._features, n5 = this._tessellationOptions, { hasDataDrivenLine: r6, lineMaterial: l6 } = t5;
    e5 && e5.setExtent(this.layerExtent);
    ...
    const c5 = (h5 == null ? void 0 : h5.isDataDriven) ? h5 : null, _2 = c5 ? null : t5.getLayoutValue("line-join", i6);
    ...
    if (u4 || f3) {
      ...
      for (const n6 of s6) {
        ...
        r7.push({ ddAttributes: h6, page: f4.page, cap: p4 ? p4.getValue(i6, n6) : g2, join: c5 ? c5.getValue(i6, n6) : _2, miterLimit: x2 ? x2.getValue(i6, n6) : V, roundLimit: m2 ? m2.getValue(i6, n6) : D, halfWidth: 0.5 * (P ? P.getValue(i6, n6) : I4), offset: L2 ? L2.getValue(i6, n6) : B, geometry: v });
      }
      r7.sort((e6, t6) => e6.page - t6.page), n5.textured = true;
      for (const { ddAttributes: e6, page: t6, cap: i7, join: s7, miterLimit: l7, roundLimit: a7, halfWidth: o7, offset: u5, geometry: f4 } of r7) n5.capType = i7, n5.joinType = s7, n5.miterLimit = l7, n5.roundLimit = a7, n5.halfWidth = o7, n5.offset = u5, this._processFeature(f4, e6, t6);
    } else {
      if (a6) {
...
var L = class _L extends t4 {
    ...
    for (const o6 of this._symbolFeatures) {
      ...
      for (let t5 of o6.geometry) {
        ...
        for (const i6 of s7) {
          ...
          if (r6 && g3 > 0 && (T2 == null ? void 0 : T2.rotationAlignment) === l2.MAP && !_L._honorsTextMaxAngle(t5, i6, g3, R, D)) continue;
  ...
  _processFeature(e5, t5, n5) {
    const { line: i6, iconMosaicItem: s6, shaping: a6, anchor: o6 } = e5, l6 = this.zoom, h5 = this.layer, x2 = !!s6;
    let c5 = true;
  ...
  _storePlacedGlyphs(e5, t5, n5, i6, s6) {
    ...
    for (const u4 of t5) {
      ...
      this._glyphBufferDataStorage.get(u4.page).push({ glyphAnchor: [p4.x, p4.y], tl: [x2.x, x2.y], tr: [c5.x, c5.y], bl: [d2.x, d2.y], br: [f3.x, f3.y], xmin: _2.x, ymin: _2.y, xmax: _2.x + _2.width, ymax: _2.y + _2.height, labelAngle: g2, minAngle: y2, maxAngle: m2, minLod: l6, maxLod: h5, placementLod: a6, symbolInstance: e5, ddAttributes: s6 });
    }
  }
...
var g = class {
  ...
  _processLayers(e5) {
    const { sourceNameToTileData: t5, zoom: r6, layers: s6, sourceNameToTileClipper: i6, sourceNameToUniqueSourceLayerBuckets: o6, sourceNameToUniqueSourceLayers: c5, returnedBuckets: n5, layerIdToBucket: l6, referencerUIDToReferencedId: a6 } = e5, u4 = this._sourceDataMaxLOD;
  ...
  _filterFeatures(e5) {
    const { signal: r6, sourceNameToTileData: s6, sourceNameToUniqueSourceLayerBuckets: i6, sourceNameToUniqueSourceLayers: c5 } = e5, n5 = 10 * this._level, l6 = 10 * (this._level + 1), a6 = [], u4 = [];
...
//# sourceMappingURL=WorkerTileHandler-7QBE2FQM.js.map
