import {
  t
} from "./chunk-TTOHDCA7.js";
import {
  R
} from "./chunk-P3MZKJDB.js";
import {
  t as t2
} from "./chunk-QG2IIIZW.js";
import {
  p
...
function y(t3, e) {
  ...
  if (null != r && (s.geometry = JSON.stringify(r), s.geometryType = p(r), s.inSR = d(r.spatialReference)), ((_a = o.topFilter) == null ? void 0 : _a.groupByFields) && (s.topFilter.groupByFields = o.topFilter.groupByFields.join(",")), ((_b = o.topFilter) == null ? void 0 : _b.orderByFields) && (s.topFilter.orderByFields = o.topFilter.orderByFields.join(",")), o.topFilter && (s.topFilter = JSON.stringify(s.topFilter)), o.objectIds && (s.objectIds = o.objectIds.join(",")), o.orderByFields && (s.orderByFields = o.orderByFields.join(",")), o.outFields && !((e == null ? void 0 : e.returnCountOnly) || (e == null ? void 0 : e.returnExtentOnly) || (e == null ? void 0 : e.returnIdsOnly)) ? o.outFields.includes("*") ? s.outFields = "*" : s.outFields = o.outFields.join(",") : delete s.outFields, o.outSR ? s.outSR = d(o.outSR) : r && o.returnGeometry && (s.outSR = s.inSR), o.returnGeometry && delete o.returnGeometry, o.timeExtent) {
...
//# sourceMappingURL=chunk-7FN6W2KK.js.map
