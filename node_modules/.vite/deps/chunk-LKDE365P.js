...
var n = class extends i {
  ...
  prepareRenderPasses(e4) {
    const i2 = e4.registerRenderPass({ name: "bitmap (tile)", brushes: [h.bitmap], target: () => this.children.map((e5) => e5.bitmap), drawPhase: E.MAP });
...
//# sourceMappingURL=chunk-LKDE365P.js.map
