...
var c = class extends S {
  ...
  async update(t, r) {
    const { addOrUpdateResources: e3 } = await import("./resourceUtils-EP5PCTS4.js");
    return await e3(this.portalItem, [{ resource: this, content: t, compress: r == null ? void 0 : r.compress, access: r == null ? void 0 : r.access }], "update", r), this;
  }
  hasPath() {
...
e([y()], c.prototype, "portalItem", void 0), e([y({ type: String, value: null })], c.prototype, "path", null), e([s2("path")], c.prototype, "_castPath", null), e([y({ type: String, readOnly: true })], c.prototype, "url", null), e([y({ type: String, readOnly: true })], c.prototype, "cdnUrl", null), e([y({ type: String, readOnly: true })], c.prototype, "itemRelativeUrl", null), c = e([a2("esri.portal.PortalItemResource")], c);
var u2 = c;
...
var k = v = class extends u(m) {
  ...
  load(e3) {
    const t = this.portal ?? (this.portal = C.getDefault()), i = t.load(e3).then(() => this.sourceJSON ? this.sourceJSON : this.id && this.itemUrl ? t.request(this.itemUrl, { signal: null != e3 ? e3.signal : null, query: { token: this.apiKey } }) : {}).then((e4) => {
  ...
  async addRating(e3) {
    ...
    return e3 instanceof c2 && (e3 = e3.rating), null == e3 || isNaN(e3) || "number" != typeof e3 || (t.query.rating = e3), this.portal ? (await this.portal.request(this.itemUrl + "/addRating", t), new c2({ rating: e3, created: /* @__PURE__ */ new Date() })) : null;
  }
  clone() {
    ...
    const t = new v({ sourceJSON: this.sourceJSON }).set(e3);
    return t._set("isOrgItem", this.isOrgItem), t;
  }
  createPostQuery() {
    var _a;
    const e3 = this.toJSON();
    for (const i of ["tags", "typeKeywords", "categories"]) e3[i] = (_a = e3[i]) == null ? void 0 : _a.join(", ");
    const { extent: t } = e3;
  ...
  fetchData(e3 = "json", t) {
    return this.portal.request(this.itemUrl + "/data", { responseType: e3, ...t, query: { token: this.apiKey } });
  }
  async fetchRating(e3) {
    const t = await this.portal.request(this.itemUrl + "/rating", { query: { token: this.apiKey }, ...e3 });
    return null != t.rating ? (t.created = new Date(t.created), new c2(t)) : null;
  }
  fetchRelatedItems(e3, t) {
    return this.portal.requestToTypedArray(this.itemUrl + "/relatedItems", { query: { ...e3, token: this.apiKey }, ...t }, v);
  }
  getThumbnailUrl(e3) {
  ...
  update(e3) {
    return this.id ? this.load().then(() => this.portal.signIn()).then(() => {
      const t = e3 == null ? void 0 : e3.data, i = { method: "post" };
  ...
  async copy(e3) {
    ...
    await t.signIn();
    const { copyResources: o2, folder: s3, tags: a3, title: n4 } = e3 || {}, l2 = { method: "post", query: { copyPrivateResources: "all" === o2, folder: "string" == typeof s3 ? s3 : s3 == null ? void 0 : s3.id, includeResources: !!o2, tags: a3 == null ? void 0 : a3.join(","), title: n4 } }, { itemId: p } = await t.request(`${r}/copy`, l2);
  ...
  async fetchResources(e3 = {}, t) {
    const { fetchResources: i } = await import("./resourceUtils-EP5PCTS4.js");
    return i(this, e3, t);
  }
  async addResource(e3, t, i) {
    const { addOrUpdateResources: r } = await import("./resourceUtils-EP5PCTS4.js");
    return e3.portalItem = this, await r(this, [{ resource: e3, content: t, compress: i == null ? void 0 : i.compress, access: i == null ? void 0 : i.access }], "add", i), e3;
  }
  async removeResource(e3, t) {
    const { removeResource: r } = await import("./resourceUtils-EP5PCTS4.js");
  ...
  async removeAllResources(e3) {
    const { removeAllResources: t } = await import("./resourceUtils-EP5PCTS4.js");
    return t(this, e3);
  }
  resourceFromPath(e3) {
...
e([y({ type: ["private", "shared", "org", "public"] })], k.prototype, "access", void 0), e([y()], k.prototype, "accessInformation", void 0), e([y({ type: String })], k.prototype, "apiKey", void 0), e([y({ json: { read: { source: "appProxies" } } })], k.prototype, "applicationProxies", void 0), e([y()], k.prototype, "avgRating", void 0), e([y()], k.prototype, "categories", void 0), e([y({ type: Date })], k.prototype, "created", void 0), e([y()], k.prototype, "culture", void 0), e([y()], k.prototype, "description", void 0), e([y({ readOnly: true })], k.prototype, "displayName", null), e([y({ type: w })], k.prototype, "extent", void 0), e([o("extent")], k.prototype, "readExtent", null), e([y()], k.prototype, "groupCategories", void 0), e([y({ readOnly: true })], k.prototype, "iconUrl", null), e([y()], k.prototype, "id", void 0), e([y({ readOnly: true })], k.prototype, "isLayer", null), e([y({ type: Boolean, readOnly: true })], k.prototype, "isOrgItem", void 0), e([y()], k.prototype, "itemControl", void 0), e([y({ readOnly: true })], k.prototype, "itemPageUrl", null), e([y({ readOnly: true })], k.prototype, "itemUrl", null), e([y()], k.prototype, "licenseInfo", void 0), e([y({ type: Date })], k.prototype, "modified", void 0), e([y()], k.prototype, "name", void 0), e([y()], k.prototype, "numComments", void 0), e([y()], k.prototype, "numRatings", void 0), e([y()], k.prototype, "numViews", void 0), e([y()], k.prototype, "owner", void 0), e([y()], k.prototype, "ownerFolder", void 0), e([y({ type: C })], k.prototype, "portal", void 0), e([y()], k.prototype, "screenshots", void 0), e([y()], k.prototype, "size", void 0), e([y()], k.prototype, "snippet", void 0), e([y()], k.prototype, "sourceJSON", void 0), e([y({ type: String })], k.prototype, "sourceUrl", void 0), e([y({ type: String })], k.prototype, "spatialReference", void 0), e([y()], k.prototype, "tags", void 0), e([y()], k.prototype, "thumbnail", void 0), e([y({ readOnly: true })], k.prototype, "thumbnailUrl", null), e([y()], k.prototype, "title", void 0), e([y()], k.prototype, "type", void 0), e([y()], k.prototype, "typeKeywords", void 0), e([y({ type: String, json: { read(e3, t) {
  var _a;
  if (b.has(t.type)) {
  ...
  return e3;
} } })], k.prototype, "url", void 0), e([y({ readOnly: true })], k.prototype, "userItemUrl", null), k = v = e([a2("esri.portal.PortalItem")], k);
var S2 = k;

export {
  S2 as S
};
//# sourceMappingURL=chunk-KQ5GHUVQ.js.map
