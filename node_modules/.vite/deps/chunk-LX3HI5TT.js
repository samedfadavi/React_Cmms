...
function D2(t9) {
  return new Proxy(t9, { get(n9, e7) {
    if ("constructor" === e7) return new Proxy(n9.constructor, { construct: (t10, n10, e8) => D2(new t10(...n10)) });
...
function N(t9) {
  return new Proxy(t9, { construct: (t10, n9, e7) => D2(new t10(...n9)) });
}
function P(t9) {
  return new Proxy(t9, { get(n9, e7) {
    if (e7 in n9) return n9[e7];
...
function q2(t9) {
  return new Proxy(t9, { construct: (t10, n9, e7) => P(new t10(...n9)) });
}
...
var U = s7 = class extends r3 {
  ...
  static ofType(t9, n9) {
    const e7 = { construct: (e8, r6) => new s7(new t9(), n9) };
...
nt.type = "mat4";
var et = { float: j, vec2: C2, vec3: G2, vec4: H2, int: O, ivec2: Q, ivec3: V, ivec4: W, uint: M, uvec2: R, uvec3: A2, uvec4: X, bool: Y, bvec2: _2, bvec3: J, bvec4: L };
var rt = (...t9) => new O(...t9);
var ct = (...t9) => new j(...t9);
var it = (...t9) => new C2(...t9);
var ut = (...t9) => new G2(...t9);
...
function bt(t9, n9, e7 = 0, r6 = t9.size) {
  const c4 = new O(e7).setMutable().setDebugName("FindIndexIterator"), i4 = n9(t9.get(c4)).setDebugName("FindIndexPredicate"), u5 = mt({ iter: c4 }, O, i4, ({ out: t10, iter: n10, subgraph: e8 }) => `
${t10} = -1;
...
function It(t9, n9, e7 = 0, r6 = t9.size) {
  const c4 = mt({ array: t9 }, O, null, ({ out: t10, array: c5 }) => `
${t10} = -1;
for (int i = ${e7}; i < ${r6}; i++) {
  bool condition;
  ${n9({ array: c5, i: "i", out: "condition" })}
  if (condition) {
    ${t10} = i;
    break;
  }
...
var r4 = class {
  ...
  _writeBlockNode(e7, r6) {
    const { captureList: n9, generator: i4, returnType: o6 } = r6, d8 = {};
    for (const t9 in n9) {
      if (!n9[t9]) continue;
    ...
    if (d8.out = c4, r6.subgraph) {
      ...
      d8.subgraph = { varName: n10, body: i5 };
    }
    const a7 = i4(d8);
  ...
  _writePrimitiveNode(r6, n9, i4 = false) {
    ...
    const d8 = 1 === n9.children.length && ((_a = n9.children[0]) == null ? void 0 : _a.type) === n9.type;
...
function n5(e7, t9, o6) {
  const i4 = t9.length;
  if (i4 !== o6) {
    const n9 = new s("Invalid Uniform", `Invalid length, expected ${o6} but got ${i4}`, { uniformName: e7, values: t9 });
    s8().errorOnce(n9);
  }
}
var a6 = class {
  ...
  bind(r6) {
    ...
    if (!this._program) {
      ...
      for (const r7 of this._transformFeedbackBindings ?? []) {
        const { index: e9, propertyKey: o6 } = r7;
        t9[e9] = `v_${o6}`;
      }
    ...
    for (const o6 of this._uniformBindings) {
      const { shaderModulePath: a7, uniformName: f6, uniformType: m5, uniformArrayLength: c4 } = o6, l8 = t2(a7, e7);
      if (null == l8) {
...
function f2(t9, e7, r6) {
  ...
  t9.constructor.hasOwnProperty(e7) || Object.defineProperty(t9.constructor, e7, { value: o6.slice() }), t9.constructor[e7].push(r6);
}
function h5(t9, e7) {
  return (r6, o6) => {
    f2(r6, "locations", { typeCtor: e7, propertyKey: o6, parameterIndex: null, index: t9 });
  };
}
var l5 = (t9) => (e7, r6) => {
  f2(e7, "builtins", { builtin: t9, propertyKey: r6 });
};
var m3 = (t9) => (e7, r6, o6) => {
  f2(e7, "inputs", { inputCtor: t9, propertyKey: r6, parameterIndex: o6 });
};
var g3 = (t9) => (e7, r6) => {
  f2(e7, "uniforms", { typeCtor: t9, propertyKey: r6 });
};
var _3 = (t9) => (e7, r6) => {
  f2(e7, "options", { typeCtor: t9, propertyKey: r6 });
};
var K2 = (t9, e7) => {
  f2(t9, "defines", { propertyKey: e7 });
};
var C3 = (t9, e7) => (r6, o6) => {
  r6.constructor.builtins.push({ builtin: t9, propertyKey: o6, typeCtor: e7 });
};
var b2 = class {
};
...
var j2 = class {
  ...
  get locationsMap() {
    ...
    for (const o6 of this.locations) r6.has(o6.index) ? n.getLogger("esri.views.2d.engine.webgl.shaderGraph.GraphShaderModule").warnOnce("mapview-rendering", `Unable to assigned attribute ${o6.propertyKey} to ${o6.index}. Index already in use`, { locationsMap: t9 }) : (t9.set(o6.propertyKey, o6.index), r6.add(o6.index));
    return t9;
  }
  get locationInfo() {
    if (!this._locationInfo) {
      ...
      this._locationInfo = { hash: o6, locations: t9, computeAttributeMap: n9 };
    }
    return this._locationInfo;
  }
  ...
  getProgram(t9, e7, r6, o6) {
    try {
      const { vertex: n9, fragment: s10, uniformBindings: i4 } = this._generateShaders(t9, e7, r6, o6);
  ...
  getDebugUniformClassInfo(t9) {
    ...
    if (e7) return { type: "option", className: e7.typeCtor };
  ...
  _generateShaders(t9, e7, r6, o6) {
    ...
    const m5 = this._getVertexInputBuiltins(), g8 = o4.createVertex({ ...s10, ...p7 }, d8, m5, n9, this.transformFeedbackBindings, l8);
    new r4().write(g8);
    ...
    return this.logShader && (console.log(C5), console.log(b5)), { vertex: C5, fragment: b5, uniformBindings: n9 };
  }
  _setDefines(t9) {
  ...
  _hydrateUniformGroup(t9, e7) {
    ...
    for (const o6 of r6._uniforms ?? []) {
      ...
      if ("type" in o6.typeCtor && "array" === o6.typeCtor.type) {
        const e8 = n9;
        t9.push({ shaderModulePath: p7, uniformName: s10, uniformType: i4, uniformArrayLength: e8.size, uniformArrayElementType: e8.elementType.type, uniformHydrated: n9 });
      } else t9.push({ shaderModulePath: p7, uniformName: s10, uniformType: i4, uniformHydrated: n9 });
      r6[o6.propertyKey] = n9;
    }
    return r6;
  }
  _hydrateVertexInput(t9) {
    const e7 = this.vertexInput.inputCtor, r6 = e7.locations.reduce((e8, r7) => false === t9[r7.propertyKey] ? e8 : { ...e8, [r7.propertyKey]: d4(r7.typeCtor) }, {});
    for (const { propertyKey: o6, typeCtor: n9 } of e7.builtins) {
      const t10 = d4(n9);
      r6[o6] = t10;
    }
    return r6;
  ...
  _hydrateComputeInput() {
    ...
    return this.computeInput.inputCtor.locations.reduce((t9, e7) => ({ ...t9, [e7.propertyKey]: d4(e7.typeCtor) }), {});
  }
  ...
  _hydrateFragmentInput(t9) {
    ...
    for (const { propertyKey: r6, typeCtor: o6 } of v2.builtins) {
      const t10 = d4(o6);
      e7[r6] = t10;
    }
    return e7;
  ...
  _getVertexInputBuiltins() {
    ...
    for (const { builtin: r6, propertyKey: o6 } of t9.builtins) e7.set(o6, r6);
    return e7;
  }
...
var P3 = class extends j2 {
  ...
  maybeRunHittest(t9, i4, e7) {
    ...
    return { glPointSize: new j(1), glPosition: new H2(h10, s10, 1), color: l8 };
  }
...
function z3(t9, u5, n9) {
  const { viewMat3: r6, tileMat3: i4 } = t9.view, y4 = r6.multiply(i4), s10 = y4.multiply(new G2(u5.pos, 1)), l8 = y4.multiply(new G2(n9.nextPos1, 1)), c4 = y4.multiply(new G2(n9.nextPos2, 1));
...
function t7(a7, e7, i4) {
  ...
  if (l6(a7)) {
    ...
    return ((_a = a7.visualVariableSizeMinMaxValue) == null ? void 0 : _a.getSize(l8, i4)) ?? ((_b = a7.visualVariableSizeScaleStops) == null ? void 0 : _b.getSizeForViewScale(a7.view.currentScale)) ?? ((_c = a7.visualVariableSizeStops) == null ? void 0 : _c.getSize(l8, i4)) ?? ((_d = a7.visualVariableSizeUnitValue) == null ? void 0 : _d.getSize(l8, i4));
  }
  return i4;
}
...
var x2 = class extends P3 {
  ...
  vertex(t9, o6) {
    ...
    return { glPosition: new H2(i4.xy, p7, 1), color: e7, ...this.maybeRunHittest(t9, o6, null) };
  }
  fragment(t9) {
...
e([_3(f3)], x2.prototype, "visualVariableColor", void 0), e([_3(h8)], x2.prototype, "visualVariableOpacity", void 0), e([t(0, m3(g6)), t(1, m3(q4))], x2.prototype, "vertex", null), e([t(0, m3(F2))], x2.prototype, "fragment", null);
...
function P5(t9, e7) {
  ...
  return null != t9.visualVariableColor && (b5 = xt(h6(t9.storage.getColorValue(e7.id)), new j(0), b5)), { tileTextureCoord: h10, tlbr: g8, sampleAlphaOnly: b5 };
}
function Z2(t9, e7) {
...
var _4 = class extends x2 {
  vertex(t9, e7) {
    return { ...super.vertex(t9, e7), ...P5(this, t9) };
  }
  fragment(t9) {
    const e7 = Z2(this, t9);
...
e([g3(p5)], _4.prototype, "mosaicInfo", void 0), e([g3(n7)], _4.prototype, "localTileOffset", void 0), e([t(0, m3(q6)), t(1, m3(q4))], _4.prototype, "vertex", null), e([t(0, m3(G3))], _4.prototype, "fragment", null);
...
function D3(t9, i4) {
  const { halfWidth: e7, normal: o6 } = t9, l8 = k3(e7), a7 = kn(o6).multiply(e7);
  return Zt(l8.multiply(e7.subtract(a7)).divide(i4.add(l8).subtract(new j(1))), new j(0), new j(1));
}
function G4(t9, i4) {
  const { id: e7, halfWidth: o6, referenceHalfWidth: l8 } = i4;
  if (l6(t9)) {
...
var B3 = class extends P3 {
  ...
  vertex(t9, i4) {
    const e7 = T2(this, t9);
    return { ...e7, ...this.maybeRunHittest(t9, i4, e7.halfWidth) };
  }
  fragment(t9) {
  ...
  hittest(t9, i4, e7) {
    const { viewMat3: o6, tileMat3: l8 } = this.view, a7 = o6.multiply(l8), r6 = a7.multiply(new G2(t9.pos, 1)), s10 = a7.multiply(new G2(i4.nextPos1, 1)), n9 = a7.multiply(new G2(i4.nextPos2, 1)), { distance: p7, smallSymbolDistance: u5, smallSymbolSizeThreshold: y4 } = this.hittestRequest, f6 = ee(e7, y4.multiply(0.5)).multiply(p7.subtract(u5)), h10 = this.hittestRequest.position;
    return Un(j4(h10, r6.xy, s10.xy), j4(h10, r6.xy, n9.xy)).subtract(e7).add(f6);
  }
};
e([g3(F3)], B3.prototype, "antialiasingControls", void 0), e([_3(f3)], B3.prototype, "visualVariableColor", void 0), e([_3(h8)], B3.prototype, "visualVariableOpacity", void 0), e([_3(m4)], B3.prototype, "visualVariableSizeMinMaxValue", void 0), e([_3(p6)], B3.prototype, "visualVariableSizeScaleStops", void 0), e([_3(f4)], B3.prototype, "visualVariableSizeStops", void 0), e([_3(l7)], B3.prototype, "visualVariableSizeUnitValue", void 0), e([t(0, m3(q7)), t(1, m3(q4))], B3.prototype, "vertex", null), e([t(0, m3(A3))], B3.prototype, "fragment", null);
...
function A4(t9, o6, i4) {
  const { id: e7, bitset: r6 } = o6, s10 = j3(r6, B), u5 = Ct(s10, new j(0.5)), d8 = T2(t9, o6), c4 = xt(u5, d8.halfWidth, new j(0)), f6 = u4(t9, e7), y4 = r5(t9, e7, o6.color), V2 = xt(u5, o6.color, y4.multiply(f6)), h10 = t9.view.displayViewScreenMat3.multiply(new G2(o6.pos.xy, 1)), b5 = t9.clip(o6.id), j6 = new H2(h10.xy, b5, 1), g8 = xt(u5, d8.glPosition, j6), w5 = i4 && t9.maybeRunHittest(o6, i4, u5);
  return { isOutline: s10, color: V2, opacity: new j(1), halfWidth: c4, normal: d8.normal, glPosition: g8, ...w5 };
}
...
var H3 = class extends F4 {
  ...
  fragment(t9) {
    const { color: o6, isOutline: i4 } = t9, e7 = Ct(i4, new j(0.5)), r6 = _5(t9, this.antialiasingControls.blur), s10 = xt(e7, r6, o6), n9 = xt(e7, new j(1 / 255), new j(0));
...
function O2(t9, e7) {
  ...
  return { tileTextureCoord: u5.multiply(c4).xy.subtract(d8), tlbr: e7.tlbr.divide(t9.mosaicInfo.size.xyxy) };
}
function T3(t9, e7) {
...
var z4 = class extends x2 {
  vertex(t9, e7) {
    return { ...super.vertex(t9, e7), ...O2(this, t9) };
  }
  fragment(t9) {
...
e([g3(p5)], z4.prototype, "mosaicInfo", void 0), e([g3(n7)], z4.prototype, "localTileOffset", void 0), e([t(0, m3(h9)), t(1, m3(q4))], z4.prototype, "vertex", null), e([t(0, m3(g7))], z4.prototype, "fragment", null);
...
var S4 = class extends H3 {
  vertex(t9, o6) {
    return { ...A4(this, t9, o6), ...O2(this, t9) };
  }
  fragment(t9) {
    const { isOutline: o6 } = t9, r6 = Ct(o6, new j(0.5)), e7 = _5(t9, this.antialiasingControls.blur), s10 = T3(t9, this.mosaicInfo), n9 = xt(r6, e7, s10), p7 = xt(r6, new j(1 / 255), new j(0));
    return this.getFragmentOutput(n9, t9, p7);
  }
};
e([g3(p5)], S4.prototype, "mosaicInfo", void 0), e([g3(n7)], S4.prototype, "localTileOffset", void 0), e([t(0, m3(x3)), t(1, m3(q4))], S4.prototype, "vertex", null), e([t(0, m3(y3))], S4.prototype, "fragment", null);
...
var C4 = class extends F4 {
  vertex(t9, o6) {
    const { aux1: e7, aux2: r6, aux3: i4, aux4: l8 } = t9, p7 = { ...t9, width: e7, height: r6, offset: i4, scale: l8.multiply(b4) }, n9 = { ...t9, halfWidth: e7, referenceHalfWidth: r6, offset: i4, normal: l8.subtract(w4).multiply(b4) }, m5 = A4(this, n9), u5 = P5(this, p7), h10 = Ct(m5.isOutline, new j(0.5));
    return { ...m5, ...u5, ...this.maybeRunHittest(t9, o6, h10) };
  }
  fragment(t9) {
    const { isOutline: o6 } = t9, e7 = Ct(o6, new j(0.5)), r6 = _5(t9, this.antialiasingControls.blur), i4 = Z2(this, t9), p7 = xt(e7, r6, i4), n9 = xt(e7, new j(1 / 255), new j(0));
...
e([g3(p5)], C4.prototype, "mosaicInfo", void 0), e([g3(n7)], C4.prototype, "localTileOffset", void 0), e([t(0, m3(F5)), t(1, m3(q4))], C4.prototype, "vertex", null), e([t(0, m3(R5))], C4.prototype, "fragment", null);

// ../node_modules/@arcgis/core/views/2d/engine/webgl/shaderGraph/techniques/markers/markerConstants.js
var o5 = { bitset: { isSDF: 0, isMapAligned: 1, scaleSymbolsProportionally: 2, overrideOutlineColor: 3, colorLocked: 4 } };
...
${r6}`);
  ...
  addUpdateTracking(t9, r6) {
    const s10 = d(() => r6.updating, (r7) => this._idToUpdatingState.set(t9, r7), { sync: true });
    this.addHandles(s10);
  }
  addPromise(t9) {
...
e([y({ constructOnly: true })], d7.prototype, "debugName", void 0), e([y({ readOnly: true })], d7.prototype, "updating", null), d7 = e([a("esri.views.2d.layers.support.UpdateTracking2D")], d7);
...
//# sourceMappingURL=chunk-LX3HI5TT.js.map
