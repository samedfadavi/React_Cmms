...
e([y({ type: String, json: { write: true } })], n.prototype, "variableName", void 0), e([y({ type: String, json: { write: true } })], n.prototype, "dimensionName", void 0), e([y({ type: B.array(B.oneOf([B.native(Number), B.array(B.native(Number))])), json: { write: true } })], n.prototype, "values", void 0), e([y({ type: Boolean, json: { write: true } })], n.prototype, "isSlice", void 0), n = a3 = e([a2("esri.layers.support.DimensionalDefinition")], n);
var p = n;
...
function u(e2, n2, t2) {
  ...
  if (t2) {
    ...
    if (!((_b = s2 == null ? void 0 : s2.values) == null ? void 0 : _b.length)) return e2;
    i2 = l(s2.values);
  } else {
  ...
  const a5 = i2;
  if (!(a5 == null ? void 0 : a5.length)) return e2;
...
function c(e2, t2) {
  ...
  if (2 === r2.length && (i2 == null ? void 0 : i2.extent.length) && (r2[0] = Math.max(r2[0], i2.extent[0]), r2[1] = Math.min(r2[1], i2.extent[1] ?? i2.extent[0]), r2[1] < r2[0])) return null;
...
function d(e2, t2 = {}) {
  ...
  for (let l2 = 0; l2 < s2.length; l2++) {
    ...
    let m2 = (i3 == null ? void 0 : i3[0]) ?? (o2 == null ? void 0 : o2[0]);
    "stdz" === e3.name.toLowerCase() && !e3.hasRanges && o2 && Math.abs(o2[1]) <= Math.abs(o2[0]) && (m2 = (i3 == null ? void 0 : i3.length) ? i3[i3.length - 1] : o2[1]), a5.push(new p({ variableName: r2, dimensionName: e3.name, values: [m2], isSlice: !t2.useRangeForRangedDimensionInfo || !!e3.hasRanges }));
  }
  return a5;
}
function h(e2) {
...
//# sourceMappingURL=chunk-MUBZ333A.js.map
