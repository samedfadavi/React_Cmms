...
function g(t3, s2, i2, f2) {
  ...
  return U(l, { query: { url: t3, model: "simple", folders: "", refresh: 0 !== i2 || void 0, outSR: JSON.stringify(s2) }, responseType: "json", signal: f2 });
}
...
function j(e) {
  ...
  const o2 = i(C), t3 = i(C);
  for (const r of e) {
    if ((_b = (_a = r.polygons) == null ? void 0 : _a.featureSet) == null ? void 0 : _b.features) for (const e2 of r.polygons.featureSet.features) m(o2, e2.geometry), o(t3, o2);
    if ((_d = (_c = r.polylines) == null ? void 0 : _c.featureSet) == null ? void 0 : _d.features) for (const e2 of r.polylines.featureSet.features) m(o2, e2.geometry), o(t3, o2);
    if ((_f = (_e = r.points) == null ? void 0 : _e.featureSet) == null ? void 0 : _f.features) for (const e2 of r.points.featureSet.features) m(o2, e2.geometry), o(t3, o2);
...
//# sourceMappingURL=chunk-ILEP7QLS.js.map
