...
function a6(t6, e9) {
  const { coords: n11, lengths: o10, hasIndeterminateRingOrder: r4 } = e9, s12 = 0, f6 = t6;
  if (r4) return false;
  let c8 = 0;
...
function p2(t6) {
  const { coords: n11, lengths: o10 } = t6, { buffer: r4 } = a2(n11, o10);
  return r4;
}
...
function x2(t6, e9) {
  ...
  for (; u7; ) {
    ...
    if (h7) f6 = true;
      ...
      } else i15.push({ line: e10, start: 0 });
...
var l3 = class {
  ...
  static applyEffects(n11, l6, c8) {
    ...
    return 0 === u7.length || null === i15 ? null : "esriGeometryPolygon" === i15 ? { rings: u7 } : { paths: u7 };
  }
};
...
async function e6() {
  n6 = await import("./geometryEngineJSON-2NHTEQ5O.js");
}
...
var n7 = class _n {
  static fromVertexSpec(t6, s12) {
    const { attributes: i15, optionalAttributes: a9 } = t6;
    let r4, c8, u7;
    const p7 = [];
    for (const e9 in i15) {
      const t7 = i15[e9];
      "position" === t7.pack ? r4 = { ...t7, name: e9, offset: 0 } : "id" === t7.pack ? c8 = { ...t7, name: e9, offset: 4 } : "bitset" === e9 ? u7 = { ...t7, name: e9, offset: 7 } : p7.push({ ...t7, name: e9 });
    }
    ...
    const h7 = o4(p7), f6 = [];
    let m6 = 8, b4 = 1;
    for (const o10 of h7) f6.push({ ...o10, offset: m6 }), m6 += e7(o10.type) * o10.count, o10.packAlternating && (b4 = Math.max(o10.packAlternating.count, b4));
  ...
  get attributeLayout() {
    if (!this._attributeLayout) {
      const s12 = t2(this._attributes), e9 = this._attributes.map((t6) => ({ name: t6.name, count: t6.count, offset: t6.offset, type: t6.type, packPrecisionFactor: t6.packPrecisionFactor, normalized: t6.normalized ?? false }));
      this._attributeLayout = { attributes: e9, hash: s12, stride: this.stride };
    }
...
var i10 = class _i {
  ...
  pack(t6, e9) {
    ...
    } else if ((_a = s12.packAlternating) == null ? void 0 : _a.pack) {
  ...
  _packPosition(e9, s12, i15) {
    const { offset: c8 } = this._spec.position, a9 = this._spec.position.packPrecisionFactor ?? 1, p7 = s5(e9 * a9, s12 * a9);
...
var c4 = class {
  ...
  async loadDependencies() {
    var _a;
    i11((_a = this._evaluator.inputMeshParams.effects) == null ? void 0 : _a.effectInfos) && await e6();
  }
  ...
  write(r4, a9, i15, c8, o10) {
    ...
    const u7 = (_a = i15.readGeometryForDisplay()) == null ? void 0 : _a.clone();
    if (!u7) return;
...
var a7 = class extends c4 {
  async loadDependencies() {
    await Promise.all([super.loadDependencies(), i2()]);
  }
  _write(e9, t6, r4) {
    const s12 = (r4 == null ? void 0 : r4.asOptimized()) ?? t6.readGeometryForDisplay(), i15 = this._clip(s12);
...
var r2 = { createComputedParams: (e9) => e9, optionalAttributes: {}, attributes: { id: { type: C.UNSIGNED_BYTE, count: 3, pack: "id" }, bitset: { type: C.UNSIGNED_BYTE, count: 1 }, pos: { type: C.SHORT, count: 2, pack: "position", packPrecisionFactor: 10 }, inverseArea: { type: C.FLOAT, count: 1, packTessellation: ({ inverseArea: e9 }) => e9 } } };
...
var a8 = 100;
function m3(r4, e9) {
  return [!!(r4 == null ? void 0 : r4.minScale) && e9.scaleToZoom(r4.minScale) || u5, !!(r4 == null ? void 0 : r4.maxScale) && e9.scaleToZoom(r4.maxScale) || a8];
}
function f3(r4) {
  return 1 << r4;
}
...
function g3(t6) {
  ...
  if ("string" == typeof t6) {
    ...
    if (!o11) return i12().errorOnce(new s("mapview:mesh-processing", "Unable to parse string into color", { color: t6 })), [0, 0, 0, 0];
    n11 = o11.toArray();
  } else n11 = t6;
...
var i13 = { createComputedParams: (t6) => t6, optionalAttributes: { zoomRange: { type: C.SHORT, count: 2, packPrecisionFactor: rt, pack: ({ scaleInfo: t6 }, { tileInfo: o10 }) => m3(t6, o10) } }, attributes: { id: { type: C.UNSIGNED_BYTE, count: 3, pack: "id" }, bitset: { type: C.UNSIGNED_BYTE, count: 1 }, pos: { type: C.SHORT, count: 2, pack: "position", packPrecisionFactor: 10 }, color: { type: C.UNSIGNED_BYTE, count: 4, normalized: true, pack: ({ color: t6 }) => g3(t6) } } };
...
var s8 = { createComputedParams: (t6) => t6, optionalAttributes: i13.optionalAttributes, attributes: { ...i13.attributes, tlbr: { count: 4, type: C.UNSIGNED_SHORT, pack: ({ sprite: e9 }) => {
  const { rect: r4, width: i15, height: s12 } = e9, o10 = r4.x + tt, a9 = r4.y + tt;
  return [o10, a9, o10 + i15, a9 + s12];
} }, inverseRasterizationScale: { count: 1, type: C.BYTE, packPrecisionFactor: 16, pack: ({ sprite: t6 }) => 1 / t6.rasterizationScale } } };
var o6 = class extends c5 {
  ...
  _write(t6, e9, r4) {
    var _a;
    const i15 = (r4 == null ? void 0 : r4.asOptimized()) ?? e9.readGeometryForDisplay(), s12 = this._clip(i15);
    if (!s12) return;
...
function p4(e9) {
  const { sprite: o10, aspectRatio: s12, scaleProportionally: r4 } = e9, i15 = u(e9.height), c8 = i15 > 0 ? i15 : o10.height;
  let a9 = i15 * s12;
  return a9 <= 0 ? a9 = o10.width : r4 && (a9 *= o10.width / o10.height), { width: a9, height: c8 };
}
function n9(t6) {
  const { applyRandomOffset: e9, sampleAlphaOnly: s12 } = t6;
  return l4([[C2, e9], [q, s12]]);
}
var l5 = { createComputedParams: (t6) => t6, optionalAttributes: s8.optionalAttributes, attributes: { ...s8.attributes, bitset: { count: 1, type: C.UNSIGNED_BYTE, pack: n9 }, width: { count: 1, type: C.HALF_FLOAT, pack: (t6) => p4(t6).width }, height: { count: 1, type: C.HALF_FLOAT, pack: (t6) => p4(t6).height }, offset: { count: 2, type: C.HALF_FLOAT, pack: ({ offsetX: e9, offsetY: o10 }) => [u(e9), -u(o10)] }, scale: { count: 2, type: C.UNSIGNED_BYTE, packPrecisionFactor: 16, pack: ({ scaleX: t6, scaleY: e9 }) => [t6, e9] }, angle: { count: 1, type: C.UNSIGNED_BYTE, pack: ({ angle: t6 }) => l(t6) } } };
...
var f4 = { createComputedParams: (t6) => t6, optionalAttributes: { zoomRange: { type: C.SHORT, count: 2, packPrecisionFactor: rt, pack: ({ scaleInfo: t6 }, { tileInfo: e9 }) => m3(t6, e9) } }, attributes: { id: { type: C.UNSIGNED_BYTE, count: 3, pack: "id" }, pos: { type: C.SHORT, count: 2, pack: "position", packPrecisionFactor: 10 }, bitset: { type: C.UNSIGNED_BYTE, count: 1 }, color: { type: C.UNSIGNED_BYTE, count: 4, normalized: true, pack: ({ color: t6 }) => g3(t6) }, offset: { type: C.BYTE, count: 2, packPrecisionFactor: 16, packTessellation: ({ extrusionOffsetX: t6, extrusionOffsetY: e9 }) => [S3(t6, 16), S3(e9, 16)] }, normal: { type: C.BYTE, count: 2, packPrecisionFactor: 16, packTessellation: ({ normalX: t6, normalY: e9 }) => [S3(t6, 16), S3(e9, 16)] }, halfWidth: { type: C.HALF_FLOAT, count: 1, pack: ({ width: e9 }) => u(0.5 * e9) }, referenceHalfWidth: { type: C.HALF_FLOAT, count: 1, pack: ({ referenceWidth: e9 }) => u(0.5 * e9) } } };
var _ = class {
  constructor() {
...
var T = class extends c4 {
  constructor(t6, e9, s12, i15) {
    super(t6, e9, s12, i15), this.vertexSpec = f4, this._currentWrite = new _(), this._tessellationOptions = { halfWidth: 0, pixelCoordRatio: 1, offset: 0, wrapDistance: x3, textured: false }, this._tessParams = new d4(), this._initializeTessellator();
  }
  ...
  _writeVertices(e9, s12, r4) {
    const { _currentWrite: o10, _tessellationOptions: n11, evaluatedMeshParams: a9 } = this, { width: c8, capType: m6, joinType: u7, miterLimit: p7, hasSizeVV: d6 } = a9, f6 = u(0.5 * c8);
    ...
    for (const { line: t6, start: i15 } of r4) n11.initialDistance = i15 % x3, this._lineTessellator.tessellate(t6, n11, _4);
  }
  _writeTesselatedVertex(t6, e9, s12, i15, r4, o10, n11, a9, c8, h7, l6) {
    const { out: m6, id: u7, vertexBounds: p7 } = this._currentWrite;
  ...
  _writeTriangle(t6, e9, s12) {
    const { out: i15 } = this._currentWrite;
...
var c6 = { createComputedParams: (e9) => e9, optionalAttributes: f4.optionalAttributes, attributes: { ...f4.attributes, bitset: { type: C.UNSIGNED_BYTE, count: 1, pack: (e9) => l4([[B, true]]) }, color: { type: C.UNSIGNED_BYTE, count: 4, normalized: true, pack: ({ outlineColor: e9 }) => g3(e9) } } };
...
var h5 = class extends c5 {
  ...
  _write(t6, r4, s12) {
    const i15 = (s12 == null ? void 0 : s12.asOptimized()) ?? r4.readGeometryForDisplay(), o10 = this._clip(i15);
...
var d5 = l5;
var h6 = c6;
var f5 = { createComputedParams: (e9) => e9, optionalAttributes: d5.optionalAttributes, attributes: { ...d5.attributes, bitset: { type: C.UNSIGNED_BYTE, count: 1, pack: (e9) => n9(e9) }, aux1: { count: 1, type: C.HALF_FLOAT, pack: (e9) => p4(e9).width }, aux2: { count: 1, type: C.HALF_FLOAT, pack: (e9) => p4(e9).height }, aux3: { count: 2, type: C.HALF_FLOAT, pack: ({ offsetX: t6, offsetY: r4 }) => [u(t6), u(r4)] }, aux4: { count: 2, type: C.UNSIGNED_BYTE, pack: ({ scaleX: e9, scaleY: t6 }) => [e9 * S2, t6 * S2] } } };
var y2 = { createComputedParams: (e9) => e9, optionalAttributes: d5.optionalAttributes, attributes: { ...d5.attributes, color: h6.attributes.color, bitset: { type: C.UNSIGNED_BYTE, count: 1, pack: (e9) => l4([[B, true]]) }, aux1: { count: 1, type: C.HALF_FLOAT, pack: (t6) => u(0.5 * t6.width) }, aux2: { count: 1, type: C.HALF_FLOAT, pack: (t6) => u(0.5 * t6.referenceWidth) }, aux3: { count: 2, type: C.HALF_FLOAT, packTessellation: ({ extrusionOffsetX: e9, extrusionOffsetY: t6 }) => [e9, t6] }, aux4: { count: 2, type: C.UNSIGNED_BYTE, packTessellation: ({ normalX: e9, normalY: t6 }) => [e9 * S2 + w2, t6 * S2 + w2] } } };
...
var _2 = class extends h5 {
  ...
  _write(e9, r4, s12) {
    ...
    const i15 = (s12 == null ? void 0 : s12.asOptimized()) ?? r4.readGeometryForDisplay(), o10 = this._clip(i15);
    if (!o10) return;
    const a9 = (_a = this.evaluatedMeshParams.sprite) == null ? void 0 : _a.textureBinding;
...
var n10 = { optionalAttributes: s8.optionalAttributes, createComputedParams: (e9) => e9, attributes: { ...s8.attributes, ...p5.attributes } };
var o7 = { optionalAttributes: s8.optionalAttributes, createComputedParams: (e9) => e9, attributes: { ...s8.attributes, ...c6.attributes } };
...
var c7 = class extends h5 {
  ...
  _write(t6, r4, s12) {
    var _a;
    const i15 = (s12 == null ? void 0 : s12.asOptimized()) ?? r4.readGeometryForDisplay(), a9 = this._clip(i15);
    if (!a9) return;
...
var r3 = { createComputedParams: (t6) => t6, optionalAttributes: {}, attributes: { pos: { type: C.SHORT, count: 2, pack: "position", packPrecisionFactor: 10 }, id: { type: C.UNSIGNED_BYTE, count: 3, pack: "id" }, bitset: { type: C.UNSIGNED_BYTE, count: 1 }, offset: { type: C.BYTE, count: 2, packAlternating: { count: 4, pack: () => [[-1, -1], [1, -1], [-1, 1], [1, 1]] } } } };
var i14 = class extends c4 {
  ...
  _write(t6, e9) {
    ...
    if ("esriGeometryPoint" === e9.geometryType) {
      ...
      i15 == null ? void 0 : i15.forEachVertex((e10, i16) => {
...
var o8 = class {
  constructor(o10) {
    const { offsetX: f6, offsetY: i15, postAngle: e9, fontSize: n11, scaleFactor: h7, transforms: r4 } = o10;
...
var b2 = [4, 4];
var k2 = [16, 4];
var T2 = { topLeft: k2, topRight: k2, bottomLeft: k2, bottomRight: k2 };
var B3 = [4, 2];
var R2 = [4, 6];
var w4 = { topLeft: B3, topRight: B3, bottomLeft: R2, bottomRight: R2 };
var M2 = { topLeft: B3, topRight: R2, bottomLeft: B3, bottomRight: R2 };
var z3 = { topLeft: R2, topRight: R2, bottomLeft: b2, bottomRight: b2 };
var L = { topLeft: b2, topRight: b2, bottomLeft: R2, bottomRight: R2 };
var I = { topLeft: R2, topRight: b2, bottomLeft: R2, bottomRight: b2 };
var E2 = { topLeft: b2, topRight: R2, bottomLeft: b2, bottomRight: R2 };
var G = { createComputedParams: (t6) => t6, optionalAttributes: { zoomRange: { type: C.UNSIGNED_SHORT, count: 2, packPrecisionFactor: rt, packTessellation: ({ minZoom: t6, maxZoom: e9 }) => [t6 || 0, e9 || S4] }, clipAngle: { type: C.UNSIGNED_BYTE, count: 1, packTessellation: ({ clipAngle: t6 }) => A4(t6 || 0) }, referenceSymbol: { type: C.BYTE, count: 4, packPrecisionFactor: 1, packTessellation: (t6, o10) => {
  if (!t6.referenceBounds) return [0, 0, 0, 0];
  const r4 = s4(o10.horizontalAlignment), n11 = i5(o10.verticalAlignment), { offsetX: a9, offsetY: c8, size: l6 } = t6.referenceBounds;
  return [u(a9), -u(c8), u(l6), r4 + 1 << 2 | n11 + 1];
} } }, attributes: { pos: { type: C.SHORT, count: 2, pack: "position", packPrecisionFactor: 10 }, id: { type: C.UNSIGNED_BYTE, count: 3, pack: "id" }, bitset: { type: C.UNSIGNED_BYTE, count: 1, packTessellation: ({ isBackground: t6, mapAligned: e9 }) => l4([[F, t6], [H, !!e9]]) }, offset: { type: C.SHORT, count: 2, packPrecisionFactor: 8, packAlternating: { count: 4, packTessellation: ({ offsets: t6 }) => {
  const { bottomLeft: e9, bottomRight: o10, topLeft: r4, topRight: i15 } = t6;
  return [r4, i15, e9, o10];
} } }, textureUV: { type: C.SHORT, count: 2, packPrecisionFactor: 4, packAlternating: { count: 4, packTessellation: ({ texcoords: t6 }) => {
  const { bottomLeft: e9, bottomRight: o10, topLeft: r4, topRight: i15 } = t6;
  return [r4, i15, e9, o10];
} } }, color: { type: C.UNSIGNED_BYTE, count: 4, normalized: true, packTessellation: ({ color: t6 }) => t6 }, fontSize: { type: C.UNSIGNED_SHORT, count: 1, packPrecisionFactor: 4, packTessellation: ({ fontSize: t6 }) => u(t6) }, referenceSize: { type: C.UNSIGNED_BYTE, count: 1, packPrecisionFactor: 4, packTessellation: ({ fontSize: t6 }, { referenceSize: o10 }) => u(o10 ?? t6) }, haloColor: { type: C.UNSIGNED_BYTE, count: 4, normalized: true, pack: ({ haloColor: t6 }) => g3(t6) }, haloFontSize: { type: C.UNSIGNED_SHORT, count: 1, packPrecisionFactor: 4, pack: ({ haloFontSize: t6 }) => u(t6) } } };
var N = class extends c4 {
  ...
  _write(t6, e9, o10) {
    ...
    if (o10 == null ? void 0 : o10.nextPath()) return o10.nextPoint(), this._writeGlyphs(t6, i15, o10.x, o10.y, r4, 0);
    ...
    if ("esriGeometryMultipoint" === e9.geometryType) {
      ...
      return void (o11 == null ? void 0 : o11.forEachVertex((e10, o12) => this._writeGlyphs(t6, i15, e10, o12, r4, 0)));
    }
  ...
  _getShaping(o10) {
    ...
    if (!((_a = i15.glyphs) == null ? void 0 : _a.glyphs.length)) return null;
    ...
    return O(i15.glyphs, { scale: s12 / A, angle: r4.postAngle, xOffset: n11, yOffset: p7, horizontalAlignment: i15.horizontalAlignment, verticalAlignment: o10 || i15.verticalAlignment, maxLineWidth: m6, lineHeight: d6, decoration: i15.decoration, borderLineSizePx: u(i15.boxBorderLineSize), hasBackground: !!i15.boxBackgroundColor, useCIMAngleBehavior: i15.useCIMAngleBehavior });
  }
  _writeGlyphs(t6, o10, r4, i15, s12, n11, a9, c8) {
    ...
    for (const e9 of s12.glyphs) {
      ...
      const { texcoords: s13, offsets: n12 } = e9;
      this._writeQuad(t6, o10, r4, i15, { texcoords: s13, offsets: n12, fontSize: h7, color: g3(l6.color), isBackground: false, referenceBounds: a9, minZoom: g4, maxZoom: x5, ...c8 }), t6.recordEnd();
    }
    0 !== n11 && s12.setRotation(-n11);
  }
  _writeTextBox(t6, e9, o10, r4, i15, s12, n11) {
    const a9 = this.evaluatedMeshParams, { fontSize: c8 } = this._textMeshTransformProps, { boxBackgroundColor: l6, boxBorderLineColor: f6 } = a9, h7 = { isBackground: true, fontSize: c8, referenceBounds: s12, ...n11 };
    l6 && (this._writeQuad(t6, e9, o10, r4, { texcoords: T2, offsets: i15.main, color: g3(l6), ...h7 }), f6 || (this._writeQuad(t6, e9, o10, r4, { texcoords: z3, offsets: i15.top, color: g3(l6), ...h7 }), this._writeQuad(t6, e9, o10, r4, { texcoords: L, offsets: i15.bot, color: g3(l6), ...h7 }), this._writeQuad(t6, e9, o10, r4, { texcoords: I, offsets: i15.left, color: g3(l6), ...h7 }), this._writeQuad(t6, e9, o10, r4, { texcoords: E2, offsets: i15.right, color: g3(l6), ...h7 }))), f6 && (this._writeQuad(t6, e9, o10, r4, { texcoords: w4, offsets: i15.top, color: g3(f6), ...h7 }), this._writeQuad(t6, e9, o10, r4, { texcoords: w4, offsets: i15.bot, color: g3(f6), ...h7 }), this._writeQuad(t6, e9, o10, r4, { texcoords: M2, offsets: i15.left, color: g3(f6), ...h7 }), this._writeQuad(t6, e9, o10, r4, { texcoords: M2, offsets: i15.right, color: g3(f6), ...h7 }));
  }
...
var p6 = { createComputedParams: (t6) => t6, optionalAttributes: f4.optionalAttributes, attributes: { ...f4.attributes, bitset: { type: C.UNSIGNED_BYTE, count: 1, pack: ({ shouldSampleAlphaOnly: t6, shouldScaleDash: e9, isSDF: s12 }) => l4([[q, t6], [D, e9], [E, s12]]) }, tlbr: { type: C.UNSIGNED_SHORT, count: 4, pack: ({ sprite: t6 }) => {
  const { rect: r4, width: s12, height: i15 } = t6, o10 = r4.x + tt, n11 = r4.y + tt;
  return [o10, n11, o10 + s12, n11 + i15];
} }, accumulatedDistance: { type: C.UNSIGNED_SHORT, count: 1, packTessellation: ({ distance: t6 }) => t6 }, segmentDirection: { type: C.BYTE, count: 2, packPrecisionFactor: 16, packTessellation: ({ directionX: t6, directionY: e9 }) => [t6, e9] } } };
var m5 = class extends T {
  ...
  _write(e9, r4, s12) {
    ...
    this._writeGeometry(e9, r4, i15, o10 == null ? void 0 : o10.textureBinding);
  }
};
...
var s10 = class _s {
  ...
  static fromSimpleMeshParams(e9) {
    const i15 = new _s(e9.sprite, e9.color, e9.outlineColor, e9.minPixelBuffer, e9.placement, e9.scaleInfo, e9.effects), { type: o10, width: h7, height: r4, angle: n11, alignment: a9, outlineSize: c8, referenceSize: l6, sprite: m6, overrideOutlineColor: f6 } = e9;
  ...
  static fromComplexMeshParams(e9) {
    ...
    let { alignment: h7, transforms: r4, size: n11, scaleX: a9, anchorX: c8, anchorY: l6, angle: m6, colorLocked: f6, frameHeight: d6, widthRatio: u7, offsetX: p7, offsetY: g4, outlineSize: x5, referenceSize: w5, scaleFactor: z4, sizeRatio: S6, isAbsoluteAnchorPoint: X, rotateClockwise: Y, scaleSymbolsProportionally: H2, sprite: M4 } = e9;
  ...
  _computeSize(t6, e9) {
    const { sprite: i15, hasSizeVV: s12 } = t6, h7 = !!i15.sdf, { rawWidth: r4, rawHeight: n11, sizeRatio: a9, outlineSize: c8 } = this, l6 = r4 * a9, m6 = n11 * a9;
    if (h7 && !s12) {
...
var _3 = { createComputedParams: (e9) => s10.from(e9), optionalAttributes: { zoomRange: { type: C.SHORT, count: 2, packPrecisionFactor: rt, pack: ({ scaleInfo: e9 }, { tileInfo: t6 }) => m3(e9, t6) } }, attributes: { pos: { type: C.SHORT, count: 2, pack: "position", packPrecisionFactor: 10 }, id: { type: C.UNSIGNED_BYTE, count: 3, pack: "id" }, bitset: { type: C.UNSIGNED_BYTE, count: 1, pack: ({ sprite: e9, alignment: t6, scaleSymbolsProportionally: r4, overrideOutlineColor: o10, colorLocked: s12 }) => {
  let i15 = 0;
...
} }, offset: { type: C.SHORT, count: 2, packPrecisionFactor: 4, packAlternating: { count: 4, pack: ({ angle: e9, computedWidth: t6, computedHeight: r4, anchorX: o10, anchorY: s12, offsetX: a9, offsetY: n11, rotateClockwise: c8 }) => {
...
} } }, textureUV: { type: C.SHORT, count: 2, packPrecisionFactor: 4, packAlternating: { count: 4, pack: ({ texXmax: e9, texXmin: t6, texYmax: r4, texYmin: o10 }) => [[t6, o10], [e9, o10], [t6, r4], [e9, r4]] } }, color: { type: C.UNSIGNED_BYTE, count: 4, normalized: true, pack: ({ color: e9 }) => g3(e9) }, outlineColor: { type: C.UNSIGNED_BYTE, count: 4, normalized: true, pack: ({ outlineColor: e9 }) => g3(e9) }, sizing: { type: C.UNSIGNED_BYTE, count: 4, pack: ({ rawWidth: e9, rawHeight: t6, outlineSize: r4, referenceSize: o10 }) => {
  const s12 = Math.max(e9, t6);
  return [d3(s12, 128), d3(r4, 128), d3(o10, 128), 0];
} }, placementAngle: { type: C.UNSIGNED_BYTE, count: 1, packTessellation: ({ placementAngle: e9 }) => S5(e9) }, sizeRatio: { type: C.UNSIGNED_SHORT, count: 1, packPrecisionFactor: 64, pack: ({ sizeRatio: e9 }) => e9 } } };
var v2 = class extends c4 {
  ...
  _write(e9, t6, r4) {
    var _a;
    const o10 = (_a = this.evaluatedMeshParams.sprite) == null ? void 0 : _a.textureBinding, s12 = t6.getDisplayId();
    ...
    if (null != this.evaluatedMeshParams.placement) this._writePlacedMarkers(e9, t6, r4, a9, c8);
    else if (r4 == null ? void 0 : r4.nextPath()) {
      r4.nextPoint();
      ...
      r5 == null ? void 0 : r5.forEachVertex((t7, r6) => {
  ...
  _writePlacedMarkers(t6, r4, o10, s12, i15) {
    var _a;
    const c8 = o10 ?? ((_a = a3.fromFeatureSetReaderCIM(r4)) == null ? void 0 : _a.clone());
    if (!c8) return;
  ...
  _writeQuad(e9, t6, r4, o10, s12) {
    const i15 = e9.vertexCount(), a9 = null == s12 ? null : { placementAngle: s12 };
...
var o9 = { createComputedParams: (e9) => e9, optionalAttributes: {}, attributes: { pos: { type: C.SHORT, count: 2, packPrecisionFactor: 10, pack: "position" }, id: { type: C.UNSIGNED_BYTE, count: 3, pack: "id" }, bitset: { type: C.UNSIGNED_BYTE, count: 1, pack: (e9) => 0 }, offset: { type: C.SHORT, count: 2, packPrecisionFactor: 16, packAlternating: { count: 4, pack: ({ size: t6 }) => {
  const r4 = u(t6), i15 = -r4 / 2, o10 = -r4 / 2;
  return [[i15, o10], [i15 + r4, o10], [i15, o10 + r4], [i15 + r4, o10 + r4]];
} } }, texCoords: { type: C.SHORT, count: 2, packPrecisionFactor: 4, packAlternating: { count: 4, pack: () => [[0, 1], [1, 1], [0, 0], [1, 0]] } }, size: { type: C.UNSIGNED_BYTE, count: 2, pack: ({ size: e9 }) => [e9, e9] }, referenceSize: { type: C.UNSIGNED_BYTE, count: 1, pack: ({ size: t6 }) => u(t6) }, zoomRange: { type: C.UNSIGNED_BYTE, count: 2, pack: ({ scaleInfo: e9 }, { tileInfo: r4 }) => m3(e9, r4) } } };
...
//# sourceMappingURL=chunk-T5HV76JZ.js.map
