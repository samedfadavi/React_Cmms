...
import {
  ...
  g as g2,
  k as k2
} from "./chunk-2FF45KTA.js";
import {
  l
} from "./chunk-5ZIAX347.js";
import {
  s
} from "./chunk-4JCQEQHA.js";
import {
  F,
  Ge,
  Gt,
...
function se2(e2, t) {
  var i2 = k2(true), s2 = null, a2 = ee, o2 = null, n4 = V(r2);
  function r2(r3) {
    var l2, h, d, c = (r3 = Q(r3)).length, u2 = false;
    for (null == s2 && (o2 = a2(d = n4())), l2 = 0; l2 <= c; ++l2) !(l2 < c && i2(h = r3[l2], l2, r3)) === u2 && ((u2 = !u2) ? o2.lineStart() : o2.lineEnd()), u2 && o2.point(+e2(h, l2, r3), +t(h, l2, r3));
...
function ae(e2, t, i2) {
  var s2 = null, a2 = k2(true), o2 = null, n4 = ee, r2 = null, l2 = V(h);
  function h(h2) {
    var d2, c, u2, g3, p, m = (h2 = Q(h2)).length, _3 = false, b = new Array(m), x3 = new Array(m);
    for (null == o2 && (r2 = n4(p = l2())), d2 = 0; d2 <= m; ++d2) {
      if (!(d2 < m && a2(g3 = h2[d2], d2, h2)) === _3) if (_3 = !_3) c = d2, r2.areaStart(), r2.lineStart();
      else {
        for (r2.lineEnd(), r2.lineStart(), u2 = d2 - 1; u2 >= c; --u2) r2.point(b[u2], x3[u2]);
        r2.lineEnd(), r2.areaEnd();
      }
      _3 && (b[d2] = +e2(g3, d2, h2), x3[d2] = +t(g3, d2, h2), r2.point(s2 ? +s2(g3, d2, h2) : b[d2], i2 ? +i2(g3, d2, h2) : x3[d2]));
    }
    if (p) return r2 = null, p + "" || null;
  }
  function d() {
    return se2().defined(a2).curve(n4).context(o2);
  }
  return e2 = "function" == typeof e2 ? e2 : void 0 === e2 ? te : k2(+e2), t = "function" == typeof t ? t : k2(void 0 === t ? 0 : +t), i2 = "function" == typeof i2 ? i2 : void 0 === i2 ? ie2 : k2(+i2), h.x = function(t2) {
    ...
    return arguments.length ? (n4 = e3, null != o2 && (r2 = n4(o2)), h) : n4;
  }, h.context = function(e3) {
    return arguments.length ? (null == e3 ? o2 = r2 = null : r2 = n4(o2 = e3), h) : o2;
  }, h;
}
...
var oe = class extends ni {
  setupDefaultRules() {
    ...
    const c = [{ timeUnit: "millisecond", count: 1 }, { timeUnit: "millisecond", count: 5 }, { timeUnit: "millisecond", count: 10 }, { timeUnit: "millisecond", count: 50 }, { timeUnit: "millisecond", count: 100 }, { timeUnit: "millisecond", count: 500 }, { timeUnit: "second", count: 1 }, { timeUnit: "second", count: 5 }, { timeUnit: "second", count: 10 }, { timeUnit: "second", count: 30 }, { timeUnit: "minute", count: 1 }, { timeUnit: "minute", count: 5 }, { timeUnit: "minute", count: 10 }, { timeUnit: "minute", count: 15 }, { timeUnit: "minute", count: 30 }, { timeUnit: "hour", count: 1 }, { timeUnit: "hour", count: 3 }, { timeUnit: "hour", count: 6 }, { timeUnit: "hour", count: 12 }, { timeUnit: "day", count: 1 }, { timeUnit: "day", count: 2 }, { timeUnit: "day", count: 3 }, { timeUnit: "day", count: 4 }, { timeUnit: "day", count: 5 }, { timeUnit: "week", count: 1 }, { timeUnit: "month", count: 1 }, { timeUnit: "month", count: 2 }, { timeUnit: "month", count: 3 }, { timeUnit: "month", count: 6 }, { timeUnit: "year", count: 1 }, { timeUnit: "year", count: 2 }, { timeUnit: "year", count: 5 }, { timeUnit: "year", count: 10 }, { timeUnit: "year", count: 50 }, { timeUnit: "year", count: 100 }, { timeUnit: "year", count: 200 }, { timeUnit: "year", count: 500 }, { timeUnit: "year", count: 1e3 }, { timeUnit: "year", count: 2e3 }, { timeUnit: "year", count: 5e3 }, { timeUnit: "year", count: 1e4 }, { timeUnit: "year", count: 1e5 }], u2 = { millisecond: h.translate("_date_millisecond"), second: h.translate("_date_second"), minute: h.translate("_date_minute"), hour: h.translate("_date_hour"), day: h.translate("_date_day"), week: h.translate("_date_day"), month: h.translate("_date_month"), year: h.translate("_date_year") }, g3 = { millisecond: h.translate("_date_millisecond"), second: h.translate("_date_second"), minute: h.translate("_date_minute"), hour: h.translate("_date_day"), day: h.translate("_date_day"), week: h.translate("_date_day"), month: h.translate("_date_month") + " " + h.translate("_date_year"), year: h.translate("_date_year") }, p = { millisecond: h.translate("_date_millisecond_full"), second: h.translate("_date_second_full"), minute: h.translate("_date_minute_full"), hour: h.translate("_date_hour_full"), day: h.translate("_date_day_full"), week: h.translate("_date_week_full"), month: h.translate("_date_month_full"), year: h.translate("_date_year") };
    d("CategoryDateAxis").setAll({ markUnitChange: true, gridIntervals: S(c), dateFormats: F(u2), periodChangeDateFormats: F(g3) }), d("DateAxis").setAll({ maxZoomFactor: null, strictMinMax: true, startLocation: 0, endLocation: 1, markUnitChange: true, groupData: false, groupCount: 500, gridIntervals: S(c), dateFormats: F(u2), periodChangeDateFormats: F(g3), tooltipDateFormats: p, groupIntervals: [{ timeUnit: "millisecond", count: 1 }, { timeUnit: "millisecond", count: 10 }, { timeUnit: "millisecond", count: 100 }, { timeUnit: "second", count: 1 }, { timeUnit: "second", count: 10 }, { timeUnit: "minute", count: 1 }, { timeUnit: "minute", count: 10 }, { timeUnit: "hour", count: 1 }, { timeUnit: "day", count: 1 }, { timeUnit: "week", count: 1 }, { timeUnit: "month", count: 1 }, { timeUnit: "year", count: 1 }], fillRule: (e3) => {
      const t = e3.get("axisFill");
      if (t) {
        const i2 = e3.component, s2 = e3.get("value"), a2 = e3.get("endValue"), o2 = i2.intervalDuration(), n4 = i2.getPrivate("baseInterval"), r2 = i2.getPrivate("gridInterval", n4);
...
var ne = class extends R {
  constructor() {
    super(...arguments), Object.defineProperty(this, "xAxes", { enumerable: true, configurable: true, writable: true, value: new se() }), Object.defineProperty(this, "yAxes", { enumerable: true, configurable: true, writable: true, value: new se() }), Object.defineProperty(this, "topAxesContainer", { enumerable: true, configurable: true, writable: true, value: this.chartContainer.children.push(si.new(this._root, { width: r, layout: this._root.verticalLayout })) }), Object.defineProperty(this, "yAxesAndPlotContainer", { enumerable: true, configurable: true, writable: true, value: this.chartContainer.children.push(si.new(this._root, { width: r, height: r, layout: this._root.horizontalLayout })) }), Object.defineProperty(this, "bottomAxesContainer", { enumerable: true, configurable: true, writable: true, value: this.chartContainer.children.push(si.new(this._root, { width: r, layout: this._root.verticalLayout })) }), Object.defineProperty(this, "leftAxesContainer", { enumerable: true, configurable: true, writable: true, value: this.yAxesAndPlotContainer.children.push(si.new(this._root, { height: r, layout: this._root.horizontalLayout })) }), Object.defineProperty(this, "plotsContainer", { enumerable: true, configurable: true, writable: true, value: this.yAxesAndPlotContainer.children.push(si.new(this._root, { width: r, height: r, maskContent: false })) }), Object.defineProperty(this, "plotContainer", { enumerable: true, configurable: true, writable: true, value: this.plotsContainer.children.push(si.new(this._root, { width: r, height: r })) }), Object.defineProperty(this, "topPlotContainer", { enumerable: true, configurable: true, writable: true, value: this.plotsContainer.children.push(si.new(this._root, { width: r, height: r })) }), Object.defineProperty(this, "gridContainer", { enumerable: true, configurable: true, writable: true, value: this.plotContainer.children.push(si.new(this._root, { width: r, height: r, isMeasured: false })) }), Object.defineProperty(this, "topGridContainer", { enumerable: true, configurable: true, writable: true, value: si.new(this._root, { width: r, height: r, isMeasured: false }) }), Object.defineProperty(this, "rightAxesContainer", { enumerable: true, configurable: true, writable: true, value: this.yAxesAndPlotContainer.children.push(si.new(this._root, { height: r, layout: this._root.horizontalLayout })) }), Object.defineProperty(this, "axisHeadersContainer", { enumerable: true, configurable: true, writable: true, value: this.plotContainer.children.push(si.new(this._root, {})) }), Object.defineProperty(this, "zoomOutButton", { enumerable: true, configurable: true, writable: true, value: this.topPlotContainer.children.push(o.new(this._root, { themeTags: ["zoom"], icon: ze.new(this._root, { themeTags: ["button", "icon"] }) })) }), Object.defineProperty(this, "_movePoint", { enumerable: true, configurable: true, writable: true, value: { x: 0, y: 0 } }), Object.defineProperty(this, "_wheelDp", { enumerable: true, configurable: true, writable: true, value: void 0 }), Object.defineProperty(this, "_otherCharts", { enumerable: true, configurable: true, writable: true, value: void 0 }), Object.defineProperty(this, "_movePoints", { enumerable: true, configurable: true, writable: true, value: {} }), Object.defineProperty(this, "_downStartX", { enumerable: true, configurable: true, writable: true, value: void 0 }), Object.defineProperty(this, "_downEndX", { enumerable: true, configurable: true, writable: true, value: void 0 }), Object.defineProperty(this, "_downStartY", { enumerable: true, configurable: true, writable: true, value: void 0 }), Object.defineProperty(this, "_downEndY", { enumerable: true, configurable: true, writable: true, value: void 0 });
  }
  _afterNew() {
  ...
  handleWheel(e2) {
    ...
    a2.preventDefault();
    const o2 = s2.toLocal(e2.point), n4 = this.get("wheelStep", 0.2), r2 = a2.deltaY / 100, l2 = a2.deltaX / 100, h = this.get("wheelZoomPositionX"), d = this.get("wheelZoomPositionY");
    "zoomX" !== t && "zoomXY" !== t || 0 == l2 || this.xAxes.each((e3) => {
      if (e3.get("zoomX")) {
        let t2 = e3.get("start"), i3 = e3.get("end"), a3 = e3.fixPosition(o2.x / s2.width());
        null != h && (a3 = h);
        let r3 = t2 - n4 * (i3 - t2) * l2 * a3, d2 = i3 + n4 * (i3 - t2) * l2 * (1 - a3);
      ...
      if (e3.get("zoomX")) {
        let t2 = e3.get("start"), i3 = e3.get("end"), a3 = e3.fixPosition(o2.x / s2.width());
        null != h && (a3 = h);
        let l3 = t2 - n4 * (i3 - t2) * r2 * a3, d2 = i3 + n4 * (i3 - t2) * r2 * (1 - a3);
      ...
      if (e3.get("zoomY")) {
        ...
        null != d && (a3 = d);
        let r3 = t2 - n4 * (i3 - t2) * l2 * a3, h2 = i3 + n4 * (i3 - t2) * l2 * (1 - a3);
      ...
      if (e3.get("zoomY")) {
        let t2 = e3.get("start"), i3 = e3.get("end"), a3 = e3.fixPosition(o2.y / s2.height());
        null != d && (a3 = d);
        let l3 = t2 - n4 * (i3 - t2) * r2 * a3, h2 = i3 + n4 * (i3 - t2) * r2 * (1 - a3);
      ...
      if (e3.get("panX")) {
        let t2 = e3.get("start"), i3 = e3.get("end"), s3 = this._getWheelSign(e3) * n4 * (i3 - t2) * l2, a3 = t2 + s3, o3 = i3 + s3, r3 = this._fixWheel(a3, o3);
        a3 = r3[0], o3 = r3[1], this._handleWheelAnimation(e3.zoom(a3, o3));
      }
    }), "panX" !== i2 && "panXY" !== i2 || 0 == r2 || this.xAxes.each((e3) => {
      if (e3.get("panX")) {
        let t2 = e3.get("start"), i3 = e3.get("end"), s3 = this._getWheelSign(e3) * n4 * (i3 - t2) * r2, a3 = t2 + s3, o3 = i3 + s3, l3 = this._fixWheel(a3, o3);
    ...
    if (i2) {
      ...
      if (a2) {
        ...
        e3 && e3.events.disableType("rangechanged"), this.xAxes.each((e4) => {
          if (e4.get("panX")) {
            e4._isPanning = true;
            let a3 = e4._panStart, o3 = e4._panEnd, n4 = (o3 - a3) * (i2.x - s2.x) / t.width();
            e4.get("renderer").get("inversed") && (n4 *= -1);
            let r2 = a3 + n4, l2 = o3 + n4;
      ...
      if (o2) {
        ...
        e3 && e3.events.disableType("rangechanged"), this.yAxes.each((e4) => {
          if (e4.get("panY")) {
            e4._isPanning = true;
            let a3 = e4._panStart, o3 = e4._panEnd, n4 = (o3 - a3) * (i2.y - s2.y) / t.height();
            e4.get("renderer").get("inversed") && (n4 *= -1);
            let r2 = a3 - n4, l2 = o3 - n4;
            l2 - r2 < 1 + 2 * e4.get("maxDeviation", 1) && (e4.set("start", r2), e4.set("end", l2));
          }
  ...
  _handlePinch() {
    ...
    if (W(e2._downPoints, (e3, a2) => {
      ...
      let o2 = i2[0], n4 = i2[1], r2 = s2[0], l2 = s2[1];
      if (o2 && n4 && r2 && l2) {
        if (r2 = e2.toLocal(r2), l2 = e2.toLocal(l2), o2 = e2.toLocal(o2), n4 = e2.toLocal(n4), this.get("pinchZoomX")) {
          const e3 = this._downStartX, i3 = this._downEndX;
          if (null != e3 && null != i3) {
            o2.x > n4.x && ([o2, n4] = [n4, o2], [r2, l2] = [l2, r2]);
            let s3 = e3 + o2.x / t2 * (i3 - e3), a3 = e3 + n4.x / t2 * (i3 - e3), h = e3 + r2.x / t2 * (i3 - e3), d = e3 + l2.x / t2 * (i3 - e3), c = Math.max(1e-3, a3 - s3) / Math.max(1e-3, d - h), u2 = e3 * c + s3 - h * c, g3 = i3 * c + a3 - d * c;
            this.xAxes.each((e4) => {
              let t3 = e4.fixPosition(u2), i4 = e4.fixPosition(g3);
              e4.zoom(t3, i4, 0);
            });
          }
        }
        if (this.get("pinchZoomY")) {
          ...
          if (null != e3 && null != t3) {
            o2.y < n4.y && ([o2, n4] = [n4, o2], [r2, l2] = [l2, r2]);
            let i3 = e3 + (1 - o2.y / a2) * (t3 - e3), s3 = e3 + (1 - n4.y / a2) * (t3 - e3), h = e3 + (1 - r2.y / a2) * (t3 - e3), d = e3 + (1 - l2.y / a2) * (t3 - e3), c = Math.max(1e-3, s3 - i3) / Math.max(1e-3, d - h), u2 = e3 * c + i3 - h * c, g3 = t3 * c + s3 - d * c;
            this.yAxes.each((e4) => {
              let t4 = e4.fixPosition(u2), i4 = e4.fixPosition(g3);
              e4.zoom(t4, i4, 0);
            });
          }
        }
    ...
    if (e2) {
      ...
      if (e2._downPoint && (i2 = void 0), i2 && t) {
        ...
        if (w(a2, (e3) => {
          ...
          if (i3) {
            let a3 = 0;
            a3 = "x" == s2 || "x!" == s2 ? Math.abs(t.x - i3.x) : "y" == s2 || "y!" == s2 ? Math.abs(t.y - i3.y) : Math.hypot(t.x - i3.x, t.y - i3.y), a3 < n4 && (n4 = a3, o2 = e3);
          }
        }), w(i2, (e3) => {
  ...
  _handleScrollbar(e2, t, i2, s2) {
    e2.each((e3) => {
      let a2 = e3.fixPosition(t), o2 = e3.fixPosition(i2), n4 = e3.zoom(a2, o2, void 0, s2);
      const r2 = "updateScrollbar";
      e3.setPrivateRaw(r2, false), n4 ? n4.events.on("stopped", () => {
  ...
  arrangeTooltips() {
    ...
    let o2 = e2._display.toGlobal({ x: 0, y: 0 }), n4 = e2._display.toGlobal({ x: t, y: i2 });
    const r2 = [];
    let l2, h, d = 0, c = 1 / 0, u2 = this._movePoint, g3 = this.get("maxTooltipDistance"), p = this.get("maxTooltipDistanceBy", "xy");
      ...
      if (!e3.isHidden()) {
        ...
        if (t2) {
          ...
          if (i3) {
            ...
            "x" == p ? t3 = Math.abs(u2.x - i3.x) : "y" == p && (t3 = Math.abs(u2.y - i3.y)), t3 < c && (c = t3, l2 = e3, h = i3);
          }
        }
      }
    });
    ...
    if (this.series.each((e3) => {
      ...
      if (d / t2 > i2 / 2 + o2.y) {
        ...
        if (w(r2, (i3) => {
          ...
          a2 instanceof e && (s3 *= a2.value), s3 += i3.get("marginBottom", 0), i3.set("bounds", { left: o2.x, top: o2.y, right: n4.x, bottom: t3 }), i3.setPrivate("customData", { left: o2.x, top: o2.y, right: n4.x, bottom: t3 }), t3 = Math.min(t3 - s3, i3._fy - s3), i3.parent == e3 && e3.children.moveValue(i3, 0);
        }), t3 < 0) {
          r2.reverse();
          let e4 = t3;
          w(r2, (i3) => {
            ...
            if (s3) {
              ...
              a2 < e4 && (a2 = e4, o3 = a2 + i3.height()), i3.set("bounds", { left: s3.left, top: a2, right: s3.right, bottom: o3 }), e4 = s3.bottom - t3 + i3.get("marginBottom", 0);
            }
          });
        }
      } else {
        ...
        if (w(r2, (i3) => {
          ...
          r3 instanceof e && (a2 *= r3.value), a2 += i3.get("marginBottom", 0), i3.set("bounds", { left: o2.x, top: t3, right: n4.x, bottom: Math.max(o2.y + s2, t3 + a2) }), i3.parent == e3 && e3.children.moveValue(i3, 0), t3 = Math.max(t3 + a2, i3._fy + a2);
        }), t3 > s2) {
          r2.reverse();
          let e4 = s2;
          w(r2, (i3) => {
            ...
            if (a2) {
              let o3 = a2.top - (s2 - t3), n5 = a2.bottom - (s2 - t3);
              n5 > e4 && (n5 = e4, o3 = n5 - i3.height()), i3.set("bounds", { left: a2.left, top: o3, right: a2.right, bottom: n5 }), e4 = n5 - i3.height() - i3.get("marginBottom", 0);
            }
          });
        }
      }
...
Object.defineProperty(ne, "className", { enumerable: true, configurable: true, writable: true, value: "XYChart" }), Object.defineProperty(ne, "classNames", { enumerable: true, configurable: true, writable: true, value: R.classNames.concat([ne.className]) });
var re2 = class extends ze {
  _beforeChanged() {
    super._beforeChanged(), (this.isPrivateDirty("width") || this.isPrivateDirty("height")) && (this._clear = true);
  }
};
Object.defineProperty(re2, "className", { enumerable: true, configurable: true, writable: true, value: "Grid" }), Object.defineProperty(re2, "classNames", { enumerable: true, configurable: true, writable: true, value: ze.classNames.concat([re2.className]) });
var le2 = class extends si {
  constructor() {
    super(...arguments), Object.defineProperty(this, "_alwaysShow", { enumerable: true, configurable: true, writable: true, value: false }), Object.defineProperty(this, "lineX", { enumerable: true, configurable: true, writable: true, value: this.children.push(re2.new(this._root, { themeTags: ["x"] })) }), Object.defineProperty(this, "lineY", { enumerable: true, configurable: true, writable: true, value: this.children.push(re2.new(this._root, { themeTags: ["y"] })) }), Object.defineProperty(this, "selection", { enumerable: true, configurable: true, writable: true, value: this.children.push(ze.new(this._root, { themeTags: ["selection", "cursor"], layer: 30 })) }), Object.defineProperty(this, "_movePoint", { enumerable: true, configurable: true, writable: true, value: void 0 }), Object.defineProperty(this, "_lastPoint", { enumerable: true, configurable: true, writable: true, value: { x: 0, y: 0 } }), Object.defineProperty(this, "_lastPoint2", { enumerable: true, configurable: true, writable: true, value: { x: 0, y: 0 } }), Object.defineProperty(this, "_tooltipX", { enumerable: true, configurable: true, writable: true, value: false }), Object.defineProperty(this, "_tooltipY", { enumerable: true, configurable: true, writable: true, value: false }), Object.defineProperty(this, "chart", { enumerable: true, configurable: true, writable: true, value: void 0 }), Object.defineProperty(this, "_toX", { enumerable: true, configurable: true, writable: true, value: void 0 }), Object.defineProperty(this, "_toY", { enumerable: true, configurable: true, writable: true, value: void 0 });
  }
  _afterNew() {
    this._settings.themeTags = Wt(this._settings.themeTags, ["xy", "cursor"]), super._afterNew(), this.setAll({ width: r, height: r, isMeasured: true, position: "absolute" }), this.states.create("hidden", { visible: true, opacity: 0 }), this._drawLines(), this.setPrivateRaw("visible", false), this._disposers.push(this.setTimeout(() => {
  ...
  handleMove(e2, t, i2) {
    ...
    this._movePoint = e2;
    let o2 = this._display.toLocal(e2), n4 = this.chart;
    if (n4 && (this._inPlot(o2) || this._downPoint)) {
      if (n4._movePoint = e2, this.isHidden()) {
        this.show();
      ...
      g(g3) && (p = g3), this.setPrivate("positionX", u2), this.setPrivate("positionY", p);
      const m = this._getPoint(u2, p);
      if (r2 = m.x, l2 = m.y, n4.xAxes.each((e3) => {
        e3._handleCursorPosition(u2, d), s2 && e3.handleCursorShow();
      }), n4.yAxes.each((e3) => {
        e3._handleCursorPosition(p, d), s2 && e3.handleCursorShow();
      }), !t) {
        n4._handleCursorPosition();
        const t2 = "cursormoved";
        this.events.isEnabled(t2) && this.events.dispatch(t2, { type: t2, target: this, point: e2, originalEvent: i2 });
      }
      this._updateLines(r2, l2), n4.arrangeTooltips();
...
var ce = class extends D {
  ...
  _makeFieldNames() {
    const e2 = this.get("xAxis"), t = this.get("yAxis"), i2 = e2.getPrivate("name"), s2 = Mt(i2), a2 = t.getPrivate("name"), o2 = Mt(a2), n4 = e2.get("renderer").getPrivate("letter"), r2 = t.get("renderer").getPrivate("letter"), l2 = "open", h = "low", d = "high", c = "Show";
    "ValueAxis" === e2.className ? (this._xField = this.get(i2 + n4 + c), this._xOpenField = this.get(l2 + s2 + n4 + c), this._xLowField = this.get(h + s2 + n4 + c), this._xHighField = this.get(d + s2 + n4 + c)) : (this._xField = i2 + n4, this._xOpenField = l2 + s2 + n4, this._xLowField = h + s2 + n4, this._xHighField = d + s2 + n4), "ValueAxis" === t.className ? (this._yField = this.get(a2 + r2 + c), this._yOpenField = this.get(l2 + o2 + r2 + c), this._yLowField = this.get(h + o2 + r2 + c), this._yHighField = this.get(d + o2 + r2 + c)) : (this._yField = a2 + r2, this._yOpenField = l2 + o2 + r2, this._yLowField = h + o2 + r2, this._yHighField = d + o2 + r2);
  }
  _fixVC() {
  ...
  _prepareChildren() {
    ...
    if (this.isDirty("stacked") && (o2 ? this._valuesDirty && !this._dataProcessed || this._stack() : this._unstack()), this._valuesDirty && !this._dataProcessed && (this._dataProcessed = true, o2 && this._stack(), w(this.dataItems, (i3) => {
      ...
      if (o3 > 0 && i2 && (i2.get("renderer").axisLength() / (a3 - s3) > o3 ? this._showBullets = true : this._showBullets = false), (this._psi != s3 || this._pei != a3 || this.isDirty("vcx") || this.isDirty("vcy") || this.isPrivateDirty("adjustedStartIndex") || this._stackDirty || this._valuesDirty) && !this._selectionProcessed) {
        ...
        const o4 = this.get("vcx", 1), n4 = this.get("vcy", 1), r2 = this.get("stacked", false), l2 = this.getPrivate("outOfSelection");
        ...
        else for (let e3 = s3; e3 < a3; e3++) this.processYSelectionDataItem(this.dataItems[e3], n4, r2);
  ...
  _stackDataItems() {
    ...
    let n4 = this._couldStackTo.length, r2 = 0;
    const l2 = this.get("stackToNegative");
    this._reallyStackedTo = {}, w(this.dataItems, (e3) => {
      for (let t2 = 0; t2 < n4; t2++) {
        let i3 = this._couldStackTo[t2], n5 = i3.dataItems[r2], h = e3.get(s2);
        if (n5) {
          let t3 = n5.get(s2);
          if (l2) {
            if (!g(h)) break;
            if (g(t3)) {
              if (h >= 0 && t3 >= 0) {
                e3.setRaw(o2, n5), this._reallyStackedTo[i3.uid] = i3, i3._stackedSeries[this.uid] = this;
                break;
              }
              if (h < 0 && t3 < 0) {
                e3.setRaw(o2, n5), this._reallyStackedTo[i3.uid] = i3, i3._stackedSeries[this.uid] = this;
  ...
  _positionBullet(e2) {
    let t = e2.get("sprite");
    if (t) {
      let i2 = t.dataItem, s2 = e2.get("locationX", i2.get("locationX", 0.5)), a2 = e2.get("locationY", i2.get("locationY", 0.5)), o2 = this.get("xAxis"), n4 = this.get("yAxis"), r2 = o2.getDataItemPositionX(i2, this._xField, s2, this.get("vcx", 1)), l2 = n4.getDataItemPositionY(i2, this._yField, a2, this.get("vcy", 1)), h = this.getPoint(r2, l2), d = i2.get("left", h.x), c = i2.get("right", h.x), u2 = i2.get("top", h.y), g3 = i2.get("bottom", h.y), p = 0, m = 0, _3 = c - d, b = g3 - u2;
      if (this._shouldShowBullet(r2, l2)) {
        t.setPrivate("visible", !e2.getPrivate("hidden"));
        let o3 = e2.get("field");
        const n5 = this.get("baseAxis"), c2 = this.get("xAxis"), u3 = this.get("yAxis");
        if (null != o3) {
          let e3;
          n5 == c2 ? ("value" == o3 ? e3 = this._yField : "open" == o3 ? e3 = this._yOpenField : "high" == o3 ? e3 = this._yHighField : "low" == o3 && (e3 = this._yLowField), e3 && (l2 = u3.getDataItemPositionY(i2, e3, 0, this.get("vcy", 1)), h = u3.get("renderer").positionToPoint(l2), m = h.y, p = d + _3 * s2)) : ("value" == o3 ? e3 = this._xField : "open" == o3 ? e3 = this._xOpenField : "high" == o3 ? e3 = this._xHighField : "low" == o3 && (e3 = this._xLowField), e3 && (r2 = c2.getDataItemPositionX(i2, e3, 0, this.get("vcx", 1)), h = c2.get("renderer").positionToPoint(r2), p = h.x, m = g3 - b * a2));
        } else p = d + _3 * s2, m = g3 - b * a2;
        const x3 = e2.get("stacked");
        if (x3) {
          const e3 = this.chart;
          if (n5 == c2) {
            ...
            if (i3) {
              ...
              m = s3.top, "down" == x3 ? m = s3.bottom - a3.top : "auto" == x3 ? e3 && (o4 < e3.plotContainer.height() / 2 ? m = s3.bottom - a3.top : m += a3.bottom) : m += a3.bottom;
            }
            ...
            if (i3) {
              ...
              p = s3.right, "down" == x3 ? p = s3.left - a3.right : "auto" == x3 ? e3 && (o4 < e3.plotContainer.width() / 2 ? p = s3.left - a3.right : p -= a3.left) : p -= a3.left;
            }
            this._bullets[r2 + "_" + l2] = t;
          }
        }
  ...
  showDataItem(e2, t) {
    ...
    return n(this, void 0, void 0, function* () {
      ...
      w(this._valueFields, (i3) => {
        s2.push(e2.animate({ key: i3 + "Working", to: e2.get(i3), duration: t, easing: o2 }).waitForStop());
  ...
  hideDataItem(e2, t) {
    ...
    return n(this, void 0, void 0, function* () {
      ...
      const n4 = o2.get("stateAnimationEasing", this.get("stateAnimationEasing")), r2 = this.get("xAxis"), l2 = this.get("yAxis"), h = this.get("baseAxis"), d = this.get("stacked");
      if (h !== r2 && h || w(this._valueYFields, (i3) => {
        let o3 = l2.getPrivate("min"), r3 = l2.baseValue();
        g(o3) && o3 > r3 && (r3 = o3), d && (r3 = 0), null != e2.get(i3) && s2.push(e2.animate({ key: i3 + "Working", to: r3, duration: t, easing: n4 }).waitForStop());
      }), h === l2 || !h) {
        let i3 = r2.getPrivate("min"), o3 = r2.baseValue();
        g(i3) && i3 > o3 && (o3 = i3), d && (o3 = 0), w(this._valueXFields, (i4) => {
          null != e2.get(i4) && s2.push(e2.animate({ key: i4 + "Working", to: o3, duration: t, easing: n4 }).waitForStop());
        });
      }
      yield Promise.all(s2);
    });
  ...
  showDataItemTooltip(e2) {
    ...
    if (t) if (!this.isHidden() && this.get("visible")) {
      if (t._setDataItem(e2), e2) {
        ...
        const n4 = this.get("xAxis"), r2 = this.get("yAxis"), l2 = this.get("vcx", 1), h = this.get("vcy", 1), d = n4.getDataItemPositionX(e2, this._tooltipFieldX, this._aLocationX0 + (this._aLocationX1 - this._aLocationX0) * a2, l2), c = r2.getDataItemPositionY(e2, this._tooltipFieldY, this._aLocationY0 + (this._aLocationY1 - this._aLocationY0) * o2, h), u2 = this.getPoint(d, c);
        let g3 = true;
...
var ue2 = class extends _ {
  constructor() {
    super(...arguments), Object.defineProperty(this, "_series", { enumerable: true, configurable: true, writable: true, value: [] }), Object.defineProperty(this, "_isPanning", { enumerable: true, configurable: true, writable: true, value: false }), Object.defineProperty(this, "minorDataItems", { enumerable: true, configurable: true, writable: true, value: [] }), Object.defineProperty(this, "labelsContainer", { enumerable: true, configurable: true, writable: true, value: this.children.push(si.new(this._root, {})) }), Object.defineProperty(this, "gridContainer", { enumerable: true, configurable: true, writable: true, value: si.new(this._root, { width: r, height: r }) }), Object.defineProperty(this, "topGridContainer", { enumerable: true, configurable: true, writable: true, value: si.new(this._root, { width: r, height: r }) }), Object.defineProperty(this, "bulletsContainer", { enumerable: true, configurable: true, writable: true, value: this.children.push(si.new(this._root, { isMeasured: false, width: r, height: r, position: "absolute" })) }), Object.defineProperty(this, "chart", { enumerable: true, configurable: true, writable: true, value: void 0 }), Object.defineProperty(this, "_rangesDirty", { enumerable: true, configurable: true, writable: true, value: false }), Object.defineProperty(this, "_panStart", { enumerable: true, configurable: true, writable: true, value: 0 }), Object.defineProperty(this, "_panEnd", { enumerable: true, configurable: true, writable: true, value: 1 }), Object.defineProperty(this, "_sAnimation", { enumerable: true, configurable: true, writable: true, value: void 0 }), Object.defineProperty(this, "_eAnimation", { enumerable: true, configurable: true, writable: true, value: void 0 }), Object.defineProperty(this, "_skipSync", { enumerable: true, configurable: true, writable: true, value: false }), Object.defineProperty(this, "axisRanges", { enumerable: true, configurable: true, writable: true, value: new ie() }), Object.defineProperty(this, "_seriesAxisRanges", { enumerable: true, configurable: true, writable: true, value: [] }), Object.defineProperty(this, "ghostLabel", { enumerable: true, configurable: true, writable: true, value: void 0 }), Object.defineProperty(this, "_cursorPosition", { enumerable: true, configurable: true, writable: true, value: -1 }), Object.defineProperty(this, "_snapToSeries", { enumerable: true, configurable: true, writable: true, value: void 0 }), Object.defineProperty(this, "_seriesValuesDirty", { enumerable: true, configurable: true, writable: true, value: false }), Object.defineProperty(this, "_seriesAdded", { enumerable: true, configurable: true, writable: true, value: false }), Object.defineProperty(this, "axisHeader", { enumerable: true, configurable: true, writable: true, value: this.children.push(si.new(this._root, { themeTags: ["axis", "header"], position: "absolute", background: Ge.new(this._root, { themeTags: ["header", "background"], fill: this._root.interfaceColors.get("background") }) })) }), Object.defineProperty(this, "_bullets", { enumerable: true, configurable: true, writable: true, value: {} });
  }
  _dispose() {
  ...
  zoom(e2, t, i2, s2) {
    if (this.get("zoomable", true)) if (this._updateFinals(e2, t), this.get("start") !== e2 || this.get("end") != t) {
      let o2 = this._sAnimation, n4 = this._eAnimation, r2 = this.get("maxDeviation", 0.5) * Math.min(1, t - e2);
      ...
      g(d) && (l2 = h / d);
      let u2 = 1;
      if (g(c) && (u2 = h / c), "start" === s2 ? (c > 0 && 1 / (t - e2) < u2 && (t = e2 + 1 / u2), 1 / (t - e2) > l2 && (t = e2 + 1 / l2), t > 1 && t - e2 < 1 / l2 && (e2 = t - 1 / l2)) : (c > 0 && 1 / (t - e2) < u2 && (e2 = t - 1 / u2), 1 / (t - e2) > l2 && (e2 = t - 1 / l2), e2 < 0 && t - e2 < 1 / l2 && (t = e2 + 1 / l2)), 1 / (t - e2) > l2 && (t = e2 + 1 / l2), 1 / (t - e2) > l2 && (e2 = t - 1 / l2), null != c && null != d && e2 == this.get("start") && t == this.get("end")) {
        const e3 = this.chart;
        e3 && e3._handleAxisSelection(this, true);
      }
      if ((o2 && o2.playing && o2.to == e2 || this.get("start") == e2) && (n4 && n4.playing && n4.to == t || this.get("end") == t)) return;
      if (i2 > 0) {
        let s3, a2, o3 = this.get("interpolationEasing");
        if (this.get("start") != e2 && (s3 = this.animate({ key: "start", to: e2, duration: i2, easing: o3 })), this.get("end") != t && (a2 = this.animate({ key: "end", to: t, duration: i2, easing: o3 })), this._sAnimation = s3, this._eAnimation = a2, s3) return s3;
        if (a2) return a2;
  ...
  _createAssets(e2, t, i2) {
    var s2, a2, o2;
    const n4 = this.get("renderer");
    let r2 = "minor";
    const l2 = e2.get("label");
    if (l2) {
      let a3 = l2.get("themeTags"), o3 = false;
      i2 ? -1 == (null == a3 ? void 0 : a3.indexOf(r2)) && (o3 = true) : -1 != (null == a3 ? void 0 : a3.indexOf(r2)) && (o3 = true), o3 && (null === (s2 = l2.parent) || void 0 === s2 || s2.children.removeValue(l2), n4.makeLabel(e2, t), l2.dispose(), n4.labels.removeValue(l2));
    } else n4.makeLabel(e2, t);
    const h = e2.get("grid");
    if (h) {
      let s3 = h.get("themeTags"), o3 = false;
      i2 ? -1 == (null == s3 ? void 0 : s3.indexOf(r2)) && (o3 = true) : -1 != (null == s3 ? void 0 : s3.indexOf(r2)) && (o3 = true), o3 && (null === (a2 = h.parent) || void 0 === a2 || a2.children.removeValue(h), n4.makeGrid(e2, t), h.dispose(), n4.grid.removeValue(h));
    } else n4.makeGrid(e2, t);
    const d = e2.get("tick");
    if (d) {
      let s3 = false, a3 = d.get("themeTags");
      i2 ? -1 == (null == a3 ? void 0 : a3.indexOf(r2)) && (s3 = true) : -1 != (null == a3 ? void 0 : a3.indexOf(r2)) && (s3 = true), s3 && (null === (o2 = d.parent) || void 0 === o2 || o2.children.removeValue(d), n4.makeTick(e2, t), d.dispose(), n4.ticks.removeValue(d));
    } else n4.makeTick(e2, t);
    i2 || e2.get("axisFill") || n4.makeAxisFill(e2, t), this._processBullet(e2);
  }
  _processBullet(e2) {
...
Object.defineProperty(ue2, "className", { enumerable: true, configurable: true, writable: true, value: "Axis" }), Object.defineProperty(ue2, "classNames", { enumerable: true, configurable: true, writable: true, value: _.classNames.concat([ue2.className]) });
var ge = class extends ue2 {
  ...
  _prepareAxisItems() {
    ...
    if (g(e2) && g(t)) {
      ...
      let n4 = s2 - i2, l2 = 1, h = e2;
      if (t2) {
        if (n4 = this._minLogAdjusted, n4 < s2) for (; n4 < s2; ) n4 += i2;
        h = n4, h <= 0 && (h = 1, i2 < 1 && (h = g(this._minRealLog) ? this._minRealLog : Math.pow(10, -50))), l2 = Math.log(o2 - i2) * Math.LOG10E - Math.log(h) * Math.LOG10E, l2 > 2 && (n4 = Math.pow(10, Math.log(h) * Math.LOG10E - 50));
      }
      const d = this.get("renderer"), c = d.get("minorLabelsEnabled"), u2 = d.get("minorGridEnabled", c);
      ...
      let _3 = i2 / m, x3 = 0, f = 0, v = -1 / 0;
      for (; n4 < o2; ) {
        let e3;
        this.dataItems.length < x3 + 1 ? (e3 = new g2(this, void 0, {}), this._dataItems.push(e3), this.processDataItem(e3)) : e3 = this.dataItems[x3], this._createAssets(e3, []), this._toggleDataItem(e3, true), e3.setRaw("value", n4);
        const s3 = e3.get("label");
        s3 && s3.set("text", this._formatText(n4)), this._prepareDataItem(e3);
        let a2 = n4;
        if (t2 && l2 > 2 ? a2 = Math.pow(10, Math.log(h) * Math.LOG10E + x3 - 50) : a2 += i2, u2) {
          let e4 = n4 + _3;
          if (t2) {
            if (l2 > 2) {
              _3 = this._adjustMinMax(n4, a2, 10).step;
            }
            e4 = n4 + _3;
          }
          for (; e4 < a2 - 1e-11 * i2; ) {
      ...
      for (let e3 = x3; e3 < this.dataItems.length; e3++) this._toggleDataItem(this.dataItems[e3], false);
  ...
  _prepareDataItem(e2, t) {
    let i2 = this.get("renderer"), s2 = e2.get("value"), o2 = e2.get("endValue"), n4 = this.valueToPosition(s2), r2 = n4, l2 = this.valueToPosition(s2 + this.getPrivate("step"));
    g(o2) && (r2 = this.valueToPosition(o2), l2 = r2), e2.get("isRange") && null == o2 && (l2 = n4);
    let h = r2, d = e2.get("labelEndValue");
    null != d && (h = this.valueToPosition(d)), i2.updateLabel(e2.get("label"), n4, h, t);
    const c = e2.get("grid");
    if (i2.updateGrid(c, n4, r2), c && (s2 == this.get("baseValue", 0) ? (c.addTag("base"), c._applyThemes()) : c.hasTag("base") && (c.removeTag("base"), c._applyThemes())), i2.updateTick(e2.get("tick"), n4, h, t), i2.updateFill(e2.get("axisFill"), n4, l2), this._processBullet(e2), i2.updateBullet(e2.get("bullet"), n4, r2), !e2.get("isRange")) {
          ...
          if (i2) for (let e3 = t; e3 < a2; e3++) {
            ...
            w(this.series, (i3) => {
              if (!i3.get("excludeFromTotal")) {
                let n4 = i3.dataItems[e3];
                if (n4) {
                  let e4 = n4.get(o2) * i3.get(s2);
                  n2(e4) || (t2 += e4, a3 += Math.abs(e4));
                }
              }
            }), w(this.series, (n4) => {
              if (!n4.get("excludeFromTotal")) {
                let r2 = n4.dataItems[e3];
                if (r2) {
                  let e4 = r2.get(o2) * n4.get(s2);
  ...
  _getSelectionMinMax() {
    ...
    let o2 = this.get("extraMin", 0), n4 = this.get("extraMax", 0);
    this.get("logarithmic") && (null == this.get("extraMin") && (o2 = 0.1), null == this.get("extraMax") && (n4 = 0.2));
    ...
    if (g(e2) && g(t)) {
      ...
      }), c > u2 && ([c, u2] = [u2, c]), g(i2) ? c = d ? i2 : e2 : d && g(this._minReal) && (c = this._minReal), g(s2) ? u2 = d ? s2 : t : d && g(this._maxReal) && (u2 = this._maxReal), c === u2) {
        let t2 = c;
      ...
      let g3 = c, p = u2;
      c -= (u2 - c) * o2, u2 += (u2 - c) * n4;
      let m = this._adjustMinMax(c, u2, l2);
      c = m.min, u2 = m.max, c = ue(c, e2, t), u2 = ue(u2, e2, t), m = this._adjustMinMax(c, u2, l2, true), d || (c = m.min, u2 = m.max);
      const _3 = this.get("syncWithAxis");
      _3 && (m = this._syncAxes(c, u2, m.step, _3.getPrivate("selectionMinFinal", _3.getPrivate("minFinal", 0)), _3.getPrivate("selectionMaxFinal", _3.getPrivate("maxFinal", 1)), _3.getPrivate("selectionStepFinal", _3.getPrivate("step", 1))), m.min < e2 && (m.min = e2), m.max > t && (m.max = t), c = m.min, u2 = m.max), d && (g(i2) && (c = Math.max(c, i2)), g(s2) && (u2 = Math.min(u2, s2))), h && (c = g3 - (u2 - c) * o2, u2 = p + (u2 - c) * n4), this.get("logarithmic") && (c <= 0 && (c = g3 * (1 - Math.min(o2, 0.99))), c < e2 && (c = e2), u2 > t && (u2 = t));
      let x3 = Math.min(20, Math.ceil(Math.log(this.getPrivate("maxZoomFactor", 100) + 1) / Math.LN10) + 2), f = le(this.valueToFinalPosition(c), x3), v = le(this.valueToFinalPosition(u2), x3);
  ...
  _getMinMax() {
    let e2 = this.get("min"), t = this.get("max"), i2 = 1 / 0, s2 = -1 / 0, o2 = this.get("extraMin", 0), n4 = this.get("extraMax", 0);
    this.get("logarithmic") && (null == this.get("extraMin") && (o2 = 0.1), null == this.get("extraMax") && (n4 = 0.2));
    let l2 = 1 / 0;
    if (w(this.series, (e3) => {
      if (!e3.get("ignoreMinMax")) {
    ...
    i2 > s2 && ([i2, s2] = [s2, i2]);
    const h = i2, d = s2;
    let c = this.adapters.fold("min", i2), u2 = this.adapters.fold("max", s2);
    this._minRealLog = i2, g(c) && (i2 = c), g(u2) && (s2 = u2), i2 = this._fixMin(i2), s2 = this._fixMax(s2), s2 - i2 <= 1 / Math.pow(10, 15) && (s2 - i2 != 0 ? this._deltaMinMax = (s2 - i2) / 2 : this._getDelta(s2), i2 -= this._deltaMinMax, s2 += this._deltaMinMax), i2 -= (s2 - i2) * o2, s2 += (s2 - i2) * n4, this.get("logarithmic") && (i2 < 0 && h >= 0 && (i2 = 0), s2 > 0 && d <= 0 && (s2 = 0)), this._minReal = i2, this._maxReal = s2;
    let g3 = this.get("strictMinMax"), p = this.get("strictMinMaxSelection", false);
    p && (g3 = p);
    let m = g3;
    g(t) && (m = true);
    let _3 = this.get("renderer").gridCount(), x3 = this._adjustMinMax(i2, s2, _3, m);
    i2 = x3.min, s2 = x3.max, x3 = this._adjustMinMax(i2, s2, _3, true), i2 = x3.min, s2 = x3.max, g3 && (i2 = g(e2) ? e2 : this._minReal, s2 = g(t) ? t : this._maxReal, s2 - i2 <= 1e-8 && (i2 -= this._deltaMinMax, s2 += this._deltaMinMax), i2 -= (s2 - i2) * o2, s2 += (s2 - i2) * n4), c = this.adapters.fold("min", i2), u2 = this.adapters.fold("max", s2), g(c) && (i2 = c), g(u2) && (s2 = u2), l2 == 1 / 0 && (l2 = s2 - i2);
    let f = Math.round(Math.abs(Math.log(Math.abs(s2 - i2)) * Math.LOG10E)) + 5;
    i2 = le(i2, f), s2 = le(s2, f);
    const v = this.get("syncWithAxis");
    if (v && (x3 = this._syncAxes(i2, s2, x3.step, v.getPrivate("minFinal", v.getPrivate("min", 0)), v.getPrivate("maxFinal", v.getPrivate("max", 1)), v.getPrivate("step", 1)), i2 = x3.min, s2 = x3.max), this.setPrivateRaw("maxZoomFactor", Math.max(1, Math.ceil((s2 - i2) / l2 * this.get("maxZoomFactor", 100)))), this._fixZoomFactor(), this.get("logarithmic") && (this._minLogAdjusted = i2, i2 = this._minReal, s2 = this._maxReal, i2 <= 0 && (i2 = h * (1 - Math.min(o2, 0.99)))), g(i2) && g(s2) && (this.getPrivate("minFinal") !== i2 || this.getPrivate("maxFinal") !== s2)) {
  ...
  _adjustMinMax(e2, t, i2, s2) {
    ...
    let o2 = e2, n4 = t, l2 = t - e2;
    0 === l2 && (l2 = Math.abs(t));
    let h = Math.log(Math.abs(l2)) * Math.LOG10E, d = Math.pow(10, Math.floor(h));
    d /= 10;
    let c = d;
    s2 && (c = 0), s2 ? (e2 = Math.floor(e2 / d) * d, t = Math.ceil(t / d) * d) : (e2 = Math.ceil(e2 / d) * d - c, t = Math.floor(t / d) * d + c), e2 < 0 && o2 >= 0 && (e2 = 0), t > 0 && n4 <= 0 && (t = 0), h = Math.log(Math.abs(l2)) * Math.LOG10E, d = Math.pow(10, Math.floor(h)), d /= 100;
    let u2 = Math.ceil(l2 / i2 / d) * d, g3 = Math.pow(10, Math.floor(Math.log(Math.abs(u2)) * Math.LOG10E)), p = Math.ceil(u2 / g3);
    p > 5 ? p = 10 : p <= 5 && p > 2 && (p = 5), u2 = Math.ceil(u2 / (g3 * p)) * g3 * p;
    let m = this.get("maxPrecision");
    if (g(m)) {
      let e3 = de(u2, m);
      m < Number.MAX_VALUE && u2 !== e3 && (u2 = e3, 0 == u2 && (u2 = 1));
    }
    let _3 = 0;
    g3 < 1 && (_3 = Math.round(Math.abs(Math.log(Math.abs(g3)) * Math.LOG10E)) + 1, u2 = le(u2, _3));
    let b, x3 = Math.floor(e2 / u2);
    return e2 = le(u2 * x3, _3), b = s2 ? Math.floor(t / u2) : Math.ceil(t / u2), b === x3 && b++, (t = le(u2 * b, _3)) < n4 && (t += u2), e2 > o2 && (e2 -= u2), u2 = this.fixSmallStep(u2), { min: e2, max: t, step: u2 };
  }
  getTooltipText(e2, t) {
    const i2 = this.get("tooltipNumberFormat", this.get("numberFormat")), s2 = this.getNumberFormatter(), a2 = this.get("extraTooltipPrecision", 0), o2 = this.getPrivate("stepDecimalPlaces", 0) + a2, n4 = le(this.positionToValue(e2), o2);
    return i2 ? s2.format(n4, i2) : s2.format(n4, void 0, o2);
  }
  getSeriesItem(e2, t) {
    let i2, s2, a2 = this.getPrivate("name") + this.get("renderer").getPrivate("letter"), o2 = this.positionToValue(t);
    if (w(e2.dataItems, (e3, t2) => {
      const n4 = Math.abs(e3.get(a2) - o2);
      (void 0 === i2 || n4 < s2) && (i2 = t2, s2 = n4);
  ...
  _syncAxes(e2, t, i2, s2, o2, n4) {
    if (this.get("syncWithAxis")) {
      let r2 = Math.round(o2 - s2) / n4, l2 = Math.round((t - e2) / i2), h = this.get("renderer").gridCount();
      if (g(r2) && g(l2)) {
        let s3 = false, a2 = 0, o3 = 0.01 * (t - e2), n5 = e2, l3 = t, d = i2;
        for (; 1 != s3; ) if (s3 = this._checkSync(n5, l3, d, r2), a2++, a2 > 500 && (s3 = true), s3) e2 = n5, t = l3, i2 = d;
        else {
          a2 / 3 == Math.round(a2 / 3) ? (n5 = e2 - o3 * a2, e2 >= 0 && n5 < 0 && (n5 = 0)) : (l3 = t + o3 * a2, l3 <= 0 && l3 > 0 && (l3 = 0));
          let i3 = this._adjustMinMax(n5, l3, h, true);
          n5 = i3.min, l3 = i3.max, d = i3.step;
        }
      }
    }
...
Object.defineProperty(pe, "className", { enumerable: true, configurable: true, writable: true, value: "AxisLabel" }), Object.defineProperty(pe, "classNames", { enumerable: true, configurable: true, writable: true, value: ai.classNames.concat([pe.className]) });
var me = class extends U {
  constructor() {
    super(...arguments), Object.defineProperty(this, "_tickPoints", { enumerable: true, configurable: true, writable: true, value: [] });
  }
};
Object.defineProperty(me, "className", { enumerable: true, configurable: true, writable: true, value: "AxisTick" }), Object.defineProperty(me, "classNames", { enumerable: true, configurable: true, writable: true, value: U.classNames.concat([me.className]) });
var _e = class extends ze {
  constructor() {
    super(...arguments), Object.defineProperty(this, "_axisLength", { enumerable: true, configurable: true, writable: true, value: 100 }), Object.defineProperty(this, "_start", { enumerable: true, configurable: true, writable: true, value: 0 }), Object.defineProperty(this, "_end", { enumerable: true, configurable: true, writable: true, value: 1 }), Object.defineProperty(this, "_inversed", { enumerable: true, configurable: true, writable: true, value: false }), Object.defineProperty(this, "_minSize", { enumerable: true, configurable: true, writable: true, value: 0 }), Object.defineProperty(this, "chart", { enumerable: true, configurable: true, writable: true, value: void 0 }), Object.defineProperty(this, "_lc", { enumerable: true, configurable: true, writable: true, value: 1 }), Object.defineProperty(this, "_ls", { enumerable: true, configurable: true, writable: true, value: 0 }), Object.defineProperty(this, "_thumbDownPoint", { enumerable: true, configurable: true, writable: true, value: void 0 }), Object.defineProperty(this, "_downStart", { enumerable: true, configurable: true, writable: true, value: void 0 }), Object.defineProperty(this, "_downEnd", { enumerable: true, configurable: true, writable: true, value: void 0 }), Object.defineProperty(this, "ticks", { enumerable: true, configurable: true, writable: true, value: new re(Ne.new({}), () => me._new(this._root, { themeTags: Wt(this.ticks.template.get("themeTags", []), this.get("themeTags", [])) }, [this.ticks.template])) }), Object.defineProperty(this, "grid", { enumerable: true, configurable: true, writable: true, value: new re(Ne.new({}), () => re2._new(this._root, { themeTags: Wt(this.grid.template.get("themeTags", []), this.get("themeTags", [])) }, [this.grid.template])) }), Object.defineProperty(this, "axisFills", { enumerable: true, configurable: true, writable: true, value: new re(Ne.new({}), () => ze._new(this._root, { themeTags: Wt(this.axisFills.template.get("themeTags", ["axis", "fill"]), this.get("themeTags", [])) }, [this.axisFills.template])) }), Object.defineProperty(this, "labels", { enumerable: true, configurable: true, writable: true, value: new re(Ne.new({}), () => pe._new(this._root, { themeTags: Wt(this.labels.template.get("themeTags", []), this.get("themeTags", [])) }, [this.labels.template])) }), Object.defineProperty(this, "axis", { enumerable: true, configurable: true, writable: true, value: void 0 }), Object.defineProperty(this, "thumb", { enumerable: true, configurable: true, writable: true, value: void 0 });
  }
  makeTick(e2, t) {
  ...
  toggleVisibility(e2, t, i2, s2) {
    let a2 = this.axis;
    const o2 = a2.get("start", 0), n4 = a2.get("end", 1);
    t < o2 + (n4 - o2) * (i2 - 1e-4) || t > o2 + (n4 - o2) * (s2 + 1e-4) ? e2.setPrivate("visible", false) : e2.setPrivate("visible", true);
  }
...
Object.defineProperty(_e, "className", { enumerable: true, configurable: true, writable: true, value: "AxisRenderer" }), Object.defineProperty(_e, "classNames", { enumerable: true, configurable: true, writable: true, value: ze.classNames.concat([_e.className]) });
var be = class extends _e {
  constructor() {
    super(...arguments), Object.defineProperty(this, "thumb", { enumerable: true, configurable: true, writable: true, value: Ge.new(this._root, { width: r, isMeasured: false, themeTags: ["axis", "x", "thumb"] }) });
  }
  _afterNew() {
  ...
  _updatePositions() {
    ...
    if (i2) {
      ...
      const n4 = e2.parent;
      n4 && (o2 -= n4.get("paddingLeft", 0)), s2.children.length > 0 ? (a2 = e2.axisHeader.width(), e2.set("marginLeft", a2 + 1)) : s2.set("width", a2), s2.setAll({ x: o2, y: -1, height: t2.height() + 2 });
    }
  }
  processAxis() {
    super.processAxis();
  ...
  updateTick(e2, t, s2, o2) {
    if (e2) {
      g(t) || (t = 0);
      let n4 = 0.5;
      n4 = g(o2) && o2 > 1 ? e2.get("multiLocation", n4) : e2.get("location", n4), g(s2) && s2 != t && (t += (s2 - t) * n4), e2.set("x", this.positionToCoordinate(t));
  ...
  updateLabel(e2, t, s2, o2) {
    if (e2) {
      let n4 = 0.5;
      n4 = g(o2) && o2 > 1 ? e2.get("multiLocation", n4) : e2.get("location", n4), g(t) || (t = 0);
      const r2 = e2.get("inside", this.get("inside", false));
      this.get("opposite") ? r2 ? (e2.set("position", "absolute"), e2.set("y", 0)) : (e2.set("position", "relative"), e2.set("y", r)) : r2 ? (e2.set("y", 0), e2.set("position", "absolute")) : (e2.set("y", void 0), e2.set("position", "relative")), g(s2) && s2 != t && (t += (s2 - t) * n4), e2.set("x", this.positionToCoordinate(t)), this.toggleVisibility(e2, t, e2.get("minPosition", 0), e2.get("maxPosition", 1));
    }
  }
  updateGrid(e2, t, i2) {
    if (e2) {
  ...
  updateBullet(e2, t, i2) {
    if (e2) {
      ...
      if (s2) {
        ...
        g(i2) && i2 != t && (t += (i2 - t) * o2);
        let n4 = this.axis.roundAxisPosition(t, o2), r2 = this.axis._bullets[n4], l2 = -1;
        if (this.get("opposite") && (l2 = 1), e2.get("stacked")) if (r2) {
          let e3 = r2.get("sprite");
          e3 && s2.set("y", e3.y() + e3.height() * l2);
        } else s2.set("y", 0);
        this.axis._bullets[n4] = e2, s2.set("x", this.positionToCoordinate(t)), this.toggleVisibility(s2, t, 0, 1);
      }
    }
  }
  updateFill(e2, t, i2) {
  ...
  updateTooltipBounds(e2) {
    ...
    let s2 = this._display.toGlobal({ x: 0, y: 0 }), a2 = s2.x, o2 = 0, n4 = this.axisLength(), r2 = i2, l2 = "up";
    this.get("opposite") ? t ? (l2 = "up", o2 = s2.y, r2 = i2) : (l2 = "down", o2 = s2.y - i2, r2 = i2) : t ? (l2 = "down", o2 = s2.y - i2, r2 = i2) : (l2 = "up", o2 = s2.y, r2 = i2);
    const h = { left: a2, right: a2 + n4, top: o2, bottom: o2 + r2 }, d = e2.get("bounds");
...
var xe = class extends _e {
  constructor() {
    super(...arguments), Object.defineProperty(this, "_downY", { enumerable: true, configurable: true, writable: true, value: void 0 }), Object.defineProperty(this, "thumb", { enumerable: true, configurable: true, writable: true, value: Ge.new(this._root, { height: r, isMeasured: false, themeTags: ["axis", "y", "thumb"] }) });
  }
  _afterNew() {
  ...
  updateLabel(e2, t, i2, s2) {
    if (e2) {
      ...
      const n4 = this.get("opposite"), r2 = e2.get("inside", this.get("inside", false));
      n4 ? (e2.set("x", 0), r2 ? e2.set("position", "absolute") : e2.set("position", "relative")) : r2 ? (e2.set("x", 0), e2.set("position", "absolute")) : (e2.set("x", void 0), e2.set("position", "relative")), g(i2) && i2 != t && (t += (i2 - t) * o2), e2.set("y", this.positionToCoordinate(t)), this.toggleVisibility(e2, t, e2.get("minPosition", 0), e2.get("maxPosition", 1));
    }
  }
  updateGrid(e2, t, i2) {
    if (e2) {
  ...
  updateTick(e2, t, i2, s2) {
    if (e2) {
      ...
      let n4 = e2.get("length", 0);
      const r2 = e2.get("inside", this.get("inside", false));
      this.get("opposite") ? (e2.set("x", 0), r2 && (n4 *= -1)) : r2 || (n4 *= -1), e2.set("draw", (e3) => {
        e3.moveTo(0, 0), e3.lineTo(n4, 0);
      }), this.toggleVisibility(e2, t, e2.get("minPosition", 0), e2.get("maxPosition", 1));
    }
  }
  updateBullet(e2, t, i2) {
    if (e2) {
      ...
      if (s2) {
        ...
        this.axis._bullets[n4] = e2, s2.set("y", this.positionToCoordinate(t)), this.toggleVisibility(s2, t, 0, 1);
      }
    }
  }
  updateFill(e2, t, i2) {
  ...
  updateTooltipBounds(e2) {
    const t = this.get("inside"), i2 = 1e5;
    let s2 = this._display.toGlobal({ x: 0, y: 0 }), a2 = s2.y, o2 = 0, n4 = this.axisLength(), r2 = i2, l2 = "right";
    this.get("opposite") ? t ? (l2 = "right", o2 = s2.x - i2, r2 = i2) : (l2 = "left", o2 = s2.x, r2 = i2) : t ? (l2 = "left", o2 = s2.x, r2 = i2) : (l2 = "right", o2 = s2.x - i2, r2 = i2);
    const h = { left: o2, right: o2 + r2, top: a2, bottom: a2 + n4 }, d = e2.get("bounds");
    Ut(h, d) || (e2.set("bounds", h), e2.set("pointerOrientation", l2));
  }
  _updateLC() {
    const e2 = this.axis, t = e2.parent;
...
var fe = class extends ce {
  constructor() {
    super(...arguments), Object.defineProperty(this, "_endIndex", { enumerable: true, configurable: true, writable: true, value: void 0 }), Object.defineProperty(this, "_strokeGenerator", { enumerable: true, configurable: true, writable: true, value: se2() }), Object.defineProperty(this, "_fillGenerator", { enumerable: true, configurable: true, writable: true, value: ae() }), Object.defineProperty(this, "_legendStroke", { enumerable: true, configurable: true, writable: true, value: void 0 }), Object.defineProperty(this, "_legendFill", { enumerable: true, configurable: true, writable: true, value: void 0 }), Object.defineProperty(this, "strokes", { enumerable: true, configurable: true, writable: true, value: new re(Ne.new({}), () => ze._new(this._root, { themeTags: Wt(this.strokes.template.get("themeTags", []), ["line", "series", "stroke"]) }, [this.strokes.template])) }), Object.defineProperty(this, "fills", { enumerable: true, configurable: true, writable: true, value: new re(Ne.new({}), () => ze._new(this._root, { themeTags: Wt(this.strokes.template.get("themeTags", []), ["line", "series", "fill"]) }, [this.fills.template])) }), Object.defineProperty(this, "_fillTemplate", { enumerable: true, configurable: true, writable: true, value: void 0 }), Object.defineProperty(this, "_strokeTemplate", { enumerable: true, configurable: true, writable: true, value: void 0 }), Object.defineProperty(this, "_previousPoint", { enumerable: true, configurable: true, writable: true, value: [0, 0, 0, 0] }), Object.defineProperty(this, "_dindex", { enumerable: true, configurable: true, writable: true, value: 0 }), Object.defineProperty(this, "_sindex", { enumerable: true, configurable: true, writable: true, value: 0 });
  }
  _afterNew() {
    ...
    if (e2.inited && t.inited) {
      if (this._axesDirty || this._valuesDirty || this._stackDirty || this.isDirty("vcx") || this.isDirty("vcy") || this._sizeDirty || this.isDirty("connect") || this.isDirty("curveFactory")) {
        ...
        for (let l2 = e3 - 1; l2 >= 0; l2--) {
          let n5 = this.dataItems[l2], r3 = true, h = n5.dataContext;
          if (t2 && h[t2] && (s2 = true), i2 && h[i2] && (o2 = true), w(this._valueFields, (e4) => {
            g(n5.get(e4)) || (r3 = false);
          }), r3 && s2 && o2) {
            e3 = l2;
            break;
          }
        }
        let n4 = this.dataItems.length, r2 = this.endIndex();
        if (r2 < n4) {
          r2++;
          for (let e4 = r2; e4 < n4; e4++) {
  ...
  _startSegment(e2) {
    ...
    const s2 = this.get("autoGapCount"), a2 = this.get("connect"), o2 = this.makeFill(this.fills), n4 = this._fillTemplate, r2 = this.fills.template;
    n4 && n4 != r2 && (o2.template = n4), o2.setPrivate("visible", true);
    ...
    let d = this.get("xAxis"), c = this.get("yAxis"), u2 = this.get("baseAxis"), g3 = this.get("vcx", 1), p = this.get("vcy", 1), m = this._xField, _3 = this._yField, b = this._xOpenField, x3 = this._yOpenField;
    const f = this.get("openValueXField"), v = this.get("openValueYField");
    f || (b = this._xField), v || (x3 = this._yField);
    ...
    let I2 = false;
    (y || f || v) && (I2 = true);
    const j = { points: D2, segments: k3, stacked: y, getOpen: I2, basePosX: w2, basePosY: P, fillVisible: F2, xField: m, yField: _3, xOpenField: b, yOpenField: x3, vcx: g3, vcy: p, baseAxis: u2, xAxis: d, yAxis: c, locationX: S2, locationY: O2, openLocationX: C, openLocationY: X, minDistance: Y2 };
    let V2 = this._strokeTemplate, E = this._fillTemplate;
    for (L = e2; L < i2; L++) {
      this._dindex = L;
      const t2 = this._dataItems[L];
      let n5 = t2.get(m), r3 = t2.get(_3);
      if (null == n5 || null == r3 ? a2 || (D2 = [], k3.push(D2), j.points = D2) : this._getPoints(t2, j), T) {
      ...
      if (!a2) {
        ...
        e3 && u2.shouldGap(t2, e3, s2, A) && (D2 = [], k3.push(D2), j.points = D2);
      }
    }
    o2.setRaw("userData", [e2, L]), l2.setRaw("userData", [e2, L]), L === t && this._endLine(D2, k3[0][0]), l2 && this._drawStroke(l2, k3), o2 && this._drawFill(o2, k3), this.axisRanges.each((t2) => {
      ...
      const o3 = t2.strokes, n5 = this.makeStroke(o3);
      i3 && i3.children.push(n5), V2 && V2 != this.strokes.template && (n5.template = V2), E && E != this.fills.template && (a3.template = E), n5.setPrivate("visible", true), this._drawStroke(n5, k3), a3.setRaw("userData", [e2, L]), n5.setRaw("userData", [e2, L]);
    });
  }
  _getPoints(e2, t) {
    let i2 = t.points, s2 = e2.get("locationX", t.locationX), a2 = e2.get("locationY", t.locationY), o2 = t.xAxis.getDataItemPositionX(e2, t.xField, s2, t.vcx), n4 = t.yAxis.getDataItemPositionY(e2, t.yField, a2, t.vcy);
    if (this._shouldInclude(o2)) {
      const s3 = this.getPoint(o2, n4), a3 = [s3.x, s3.y];
      ...
      if (t.minDistance > 0) {
        const e3 = a3[0], s4 = a3[1], o3 = a3[2], n5 = a3[3], r2 = this._previousPoint, l2 = r2[0], h = r2[1], d = r2[2], c = r2[3];
        (Math.hypot(e3 - l2, s4 - h) > t.minDistance || o3 && n5 && Math.hypot(o3 - d, n5 - c) > t.minDistance) && (i2.push(a3), this._previousPoint = a3);
      } else i2.push(a3);
    }
  }
  _endLine(e2, t) {
  ...
  _processAxisRange(e2) {
    super._processAxisRange(e2), e2.fills = new re(Ne.new({}), () => ze._new(this._root, { themeTags: Wt(e2.fills.template.get("themeTags", []), ["line", "series", "fill"]) }, [this.fills.template, e2.fills.template])), e2.strokes = new re(Ne.new({}), () => ze._new(this._root, { themeTags: Wt(e2.strokes.template.get("themeTags", []), ["line", "series", "stroke"]) }, [this.strokes.template, e2.strokes.template]));
  }
  createLegendMarker(e2) {
    const t = this.get("legendDataItem");
    if (t) {
      const e3 = t.get("marker"), i2 = t.get("markerRectangle");
      i2 && i2.setPrivate("visible", false), e3.set("background", Ge.new(e3._root, { fillOpacity: 0, fill: zt(0) }));
      const s2 = e3.children.push(ze._new(e3._root, { themeTags: ["line", "series", "legend", "marker", "stroke"], interactive: false }, [this.strokes.template]));
      this._legendStroke = s2;
      const a2 = e3.children.push(ze._new(e3._root, { themeTags: ["line", "series", "legend", "marker", "fill"] }, [this.fills.template]));
      this._legendFill = a2;
      ...
      if (s2.states.create("disabled", { fill: o2, stroke: o2 }), a2.states.create("disabled", { fill: o2, stroke: o2 }), this.bullets.length > 0) {
        ...
        if (t2) {
          ...
          if (i3) {
            ...
            t3 instanceof ze && t3.states.create("disabled", { fill: o2, stroke: o2 }), t3 && (t3.set("tooltipText", void 0), t3.set("tooltipHTML", void 0), e3.children.push(t3), t3.setAll({ x: e3.width() / 2, y: e3.height() / 2 }), e3.events.on("boundschanged", () => {
...
var u = class _u extends ce {
  ...
  _prepareChildren() {
    ...
    if (t.inited && e2.inited) for (let o2 = s2; o2 <= a2; o2++) {
  ...
  _updateChildren() {
    ...
    w(a2.series, (t2) => {
      ...
      t2 === this && (n4 = r2 - 1), h++;
    }), this.get("clustered") || (n4 = 0, r2 = 1), 0 === r2 && (r2 = 1, n4 = 0);
    const l2 = e2.get("renderer"), g3 = s2.get("renderer"), d = "cellStartLocation", c = "cellEndLocation", m = l2.get(d, 0), p = l2.get(c, 1), x3 = g3.get(d, 0), _3 = g3.get(c, 1);
    if (this._aLocationX0 = m + n4 / r2 * (p - m), this._aLocationX1 = m + (n4 + 1) / r2 * (p - m), this._aLocationY0 = x3 + n4 / r2 * (_3 - x3), this._aLocationY1 = x3 + (n4 + 1) / r2 * (_3 - x3), e2.inited && s2.inited) {
      if (this._axesDirty || this._valuesDirty || this._stackDirty || this.isDirty("vcx") || this.isDirty("vcy") || this._sizeDirty) {
        ...
        for (let a3 = e3; a3 <= i2; a3++) {
          ...
          if (null != t3.get("valueX") && null != t3.get("valueY")) {
            if (s3 = t3, a3 > 0 && e3 > 0) for (let t4 = a3 - 1; t4 >= 0; t4--) {
        ...
        for (let a3 = i2 + 1; a3 < t2; a3++) this._toggleColumn(this.dataItems[a3], false);
      }
    } else this._skipped = true;
  ...
  _updateGraphics(t, e2) {
    ...
    if (null != h && null != l2) {
      const h2 = this._xOpenField, l3 = this._yOpenField, g3 = this.get("locationX", t.get("locationX", 0.5)), d = this.get("locationY", t.get("locationY", 0.5)), c = this.get("openLocationX", t.get("openLocationX", g3)), m = this.get("openLocationY", t.get("openLocationY", d)), p = s2.get("width"), u2 = s2.get("height"), x3 = this.get("stacked"), _3 = this.get("xAxis"), I2 = this.get("yAxis"), f = this.get("baseAxis"), y = _3.get("start"), P = _3.get("end"), b = I2.get("start"), v = I2.get("end");
      let D2, T, C, w2, A = this.get("vcy", 1), k3 = this.get("vcx", 1), F2 = false, M = false;
      if (I2.isType("CategoryAxis") && _3.isType("CategoryAxis")) {
        let e3 = this._aLocationX0 + c - 0.5, i2 = this._aLocationX1 + g3 - 0.5;
        if (p instanceof e) {
          let t2 = (i2 - e3) * (1 - p.value) / 2;
          e3 += t2, i2 -= t2;
        }
        if (D2 = _3.getDataItemPositionX(t, h2, e3, k3), T = _3.getDataItemPositionX(t, a2, i2, k3), e3 = this._aLocationY0 + m - 0.5, i2 = this._aLocationY1 + d - 0.5, u2 instanceof e) {
          let t2 = (i2 - e3) * (1 - u2.value) / 2;
          e3 += t2, i2 -= t2;
        }
        C = I2.getDataItemPositionY(t, l3, e3, A), w2 = I2.getDataItemPositionY(t, r2, i2, A), t.setRaw("point", { x: D2 + (T - D2) / 2, y: C + (w2 - C) / 2 });
      } else if (_3 === f) {
        let e3 = this._aLocationX0 + c - 0.5, i2 = this._aLocationX1 + g3 - 0.5;
        if (p instanceof e) {
          let t2 = (i2 - e3) * (1 - p.value) / 2;
        ...
        if (D2 = _3.getDataItemPositionX(t, h2, e3, k3), T = _3.getDataItemPositionX(t, a2, i2, k3), C = I2.getDataItemPositionY(t, r2, d, A), this._yOpenField !== this._yField) w2 = I2.getDataItemPositionY(t, l3, m, A);
        else if (x3) {
          let e4 = t.get("stackToItemY");
          w2 = e4 ? I2.getDataItemPositionY(e4, r2, m, e4.component.get("vcy")) : I2.basePosition();
        } else w2 = I2.basePosition();
        t.setRaw("point", { x: D2 + (T - D2) / 2, y: C }), M = true;
      } else if (I2 === f) {
        let e3 = this._aLocationY0 + m - 0.5, i2 = this._aLocationY1 + d - 0.5;
        if (u2 instanceof e) {
          let t2 = (i2 - e3) * (1 - u2.value) / 2;
          e3 += t2, i2 -= t2;
        }
        if (C = I2.getDataItemPositionY(t, l3, e3, A), w2 = I2.getDataItemPositionY(t, r2, i2, A), T = _3.getDataItemPositionX(t, a2, g3, k3), this._xOpenField !== this._xField) D2 = _3.getDataItemPositionX(t, h2, c, k3);
        else if (x3) {
          let e4 = t.get("stackToItemX");
          D2 = e4 ? _3.getDataItemPositionX(e4, a2, c, e4.component.get("vcx")) : _3.basePosition();
        } else D2 = _3.basePosition();
        F2 = true, t.setRaw("point", { x: T, y: C + (w2 - C) / 2 });
      }
      this._updateSeriesGraphics(t, s2, D2, T, C, w2, F2, M), D2 < y && T < y || D2 > P && T > P || C < b && w2 <= b || C >= v && w2 > v || n2(D2) || n2(C) ? this._toggleColumn(t, false) : this._toggleColumn(t, true);
      let X = t.get("rangeGraphics");
      X && w(X, (e3) => {
        this._updateSeriesGraphics(t, e3, D2, T, C, w2, F2, M);
      }), this._applyGraphicsStates(t, e2);
    }
  }
  _updateSeriesGraphics(t, e2, i2, s2, a2, o2, n4, h) {
    const l2 = e2.get("width"), g3 = e2.get("height"), d = e2.get("maxWidth"), c = e2.get("maxHeight"), m = this.getPoint(i2, a2), p = this.getPoint(s2, o2), u2 = t.get("point");
    if (u2) {
    ...
    this.get("adjustBulletPosition") && (n4 && (s2 = Math.min(Math.max(0, s2), this._pw), i2 = Math.min(Math.max(0, i2), this._pw)), h && (a2 = Math.min(Math.max(0, a2), this._ph), o2 = Math.min(Math.max(0, o2), this._ph))), t.setRaw("left", i2), t.setRaw("right", s2), t.setRaw("top", a2), t.setRaw("bottom", o2), e2.setPrivate("width", s2 - i2), e2.setPrivate("height", o2 - a2), e2.set("x", i2), e2.set("y", o2 - (o2 - a2));
  }
  _handleDataSetChange() {
  ...
  _applyGraphicsStates(t, e2) {
    const i2 = t.get("graphics"), s2 = i2.states.lookup("dropFromOpen"), a2 = i2.states.lookup("riseFromOpen"), o2 = i2.states.lookup("dropFromPrevious"), n4 = i2.states.lookup("riseFromPrevious");
    if (s2 || o2 || a2 || n4) {
      const i3 = this.get("xAxis"), h = this.get("yAxis"), l2 = this.get("baseAxis");
      let g3, d, c;
      l2 === i3 && h.isType("ValueAxis") ? (g3 = t.get(this._yOpenField), d = t.get(this._yField), c = e2.get(this._yField)) : l2 === h && i3.isType("ValueAxis") && (g3 = t.get(this._xOpenField), d = t.get(this._xField), c = e2.get(this._xField)), g(g3) && g(d) && (d < g3 ? s2 && s2.apply() : a2 && a2.apply(), g(c) && (d < c ? o2 && o2.apply() : n4 && n4.apply()));
    }
  }
  disposeDataItem(t) {
...
Object.defineProperty(u, "className", { enumerable: true, configurable: true, writable: true, value: "BaseColumnSeries" }), Object.defineProperty(u, "classNames", { enumerable: true, configurable: true, writable: true, value: ce.classNames.concat([u.className]) });
var x2 = class _x extends ue2 {
  constructor() {
  ...
  _handleRangeChange() {
    w(this.series, (t) => {
      let e2 = this.dataItems[this.startIndex()].get("category"), s2 = this.dataItems[this.endIndex() - 1].get("category"), a2 = t.get("baseAxis"), o2 = t.get("xAxis"), n4 = t.get("yAxis");
      if (o2 instanceof _x && n4 instanceof _x) t._markDirtyAxes();
      else if (a2 === this) {
        let r2, h, l2 = n4;
        if (o2 === a2 ? (t.get("categoryXField") && (r2 = "categoryX"), t.get("openCategoryXField") && (h = "openCategoryX")) : n4 === a2 && (t.get("categoryYField") && (r2 = "categoryY"), t.get("openCategoryYField") && (h = "openCategoryY"), l2 = o2), "ValueAxis" == l2.className && (r2 || h)) {
          let a3, o3;
          ...
          let n5 = 0, l3 = t.dataItems.length;
          a3 && (n5 = t.dataItems.indexOf(a3)), o3 && (l3 = t.dataItems.indexOf(o3) + 1), t.setPrivate("startIndex", n5), t.setPrivate("endIndex", l3);
          let g3 = false;
          for (let e3 = n5; e3 < l3; e3++) {
            const s3 = t.dataItems[e3];
            if (w(t.__valueXShowFields, (t2) => {
              null != s3.get(t2) && (g3 = true);
  ...
  _prepareAxisItems() {
    ...
    a2 < i2 && a2++;
    const o2 = e2.get("minorLabelsEnabled"), n4 = e2.get("minorGridEnabled", o2);
    ...
    for (let g3 = 0; g3 < i2; g3++) this._toggleDataItem(this.dataItems[g3], false);
    let l2 = this.dataItems[s2].get("index", 0);
    for (let g3 = s2; g3 < a2; g3 += h) {
      let t2 = this.dataItems[g3];
      this._createAssets(t2, []), this._toggleDataItem(t2, true);
      let e3 = h;
      n4 && (e3 = 1), this._prepareDataItem(t2, l2, e3), l2++;
    }
    if (e2.get("minorGridEnabled")) for (let g3 = s2; g3 < a2; g3++) {
      let e3 = this.dataItems[g3];
      g3 % h != 0 && (this._createAssets(e3, ["minor"], true), this._toggleDataItem(e3, true), this._prepareDataItem(e3, 0, 1), o2 || null === (t = e3.get("label")) || void 0 === t || t.setPrivate("visible", false));
    }
    this._updateGhost();
  }
  _prepareDataItem(t, e2, i2) {
    let s2 = this.get("renderer"), a2 = t.get("categoryLocation", 0), o2 = t.get("endCategoryLocation", 1), n4 = t.get("index");
    g(n4) || (n4 = this.categoryToIndex(t.get("category")));
    let h, l2 = this.indexToPosition(n4, a2), g3 = t.get("endCategory");
    g3 ? (h = this.categoryToIndex(g3), g(h) || (h = n4)) : h = n4;
    let d, c, m = this.indexToPosition(h, o2);
    d = t.get("isRange") ? h : n4 + this._frequency - 1, c = this.indexToPosition(d, o2), s2.updateLabel(t.get("label"), l2, m, i2), s2.updateGrid(t.get("grid"), l2, m), s2.updateTick(t.get("tick"), l2, m, i2), s2.updateFill(t.get("axisFill"), l2, c), this._processBullet(t), s2.updateBullet(t.get("bullet"), l2, m);
  ...
  getSeriesItem(t, e2) {
    if (this.dataItems.length > 0) {
      let i2 = this.getPrivate("name") + this.get("renderer").getPrivate("letter"), s2 = this.axisPositionToIndex(e2), a2 = t.dataItems[s2], o2 = this.dataItems[s2], n4 = o2.get("category");
      if (a2 && o2 && a2.get(i2) === n4) return a2;
      for (let e3 = 0, r2 = t.dataItems.length; e3 < r2; e3++) {
        let s3 = t.dataItems[e3];
        if (s3.get(i2) === n4) return s3;
      }
    }
  }
  ...
  nextPosition(t) {
    ...
    const e2 = this.getPrivate("tooltipPosition", 0), i2 = ue(this.axisPositionToIndex(e2) + t, 0, this.dataItems.length - 1);
    return this.toGlobalPosition(this.indexToPosition(i2));
  }
};
Object.defineProperty(x2, "className", { enumerable: true, configurable: true, writable: true, value: "CategoryAxis" }), Object.defineProperty(x2, "classNames", { enumerable: true, configurable: true, writable: true, value: ue2.classNames.concat([x2.className]) });
var _2 = class extends u {
  constructor() {
    super(...arguments), Object.defineProperty(this, "columns", { enumerable: true, configurable: true, writable: true, value: new re(Ne.new({}), () => n3._new(this._root, { position: "absolute", themeTags: Wt(this.columns.template.get("themeTags", []), ["series", "column"]) }, [this.columns.template])) });
  }
  makeColumn(t, e2) {
  ...
  _processAxisRange(t) {
    super._processAxisRange(t), t.columns = new re(Ne.new({}), () => n3._new(this._root, { position: "absolute", themeTags: Wt(t.columns.template.get("themeTags", []), ["series", "column"]) }, [this.columns.template, t.columns.template]));
  }
};
...
//# sourceMappingURL=xyChart-SEMPMHG2.js.map
