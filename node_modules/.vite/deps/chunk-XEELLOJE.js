...
var r = class r2 {
  ...
  validate(r3) {
    if (this.major !== r3.major) {
      ...
      throw new s(o + "unsupported-version", `Required major ${s2}version is '${this.major}', but got '\${version.major}.\${version.minor}'`, { version: r3 });
    }
  }
  clone() {
...
//# sourceMappingURL=chunk-XEELLOJE.js.map
