...
function n3(e2) {
  for (const t2 of e2.values()) t2 == null ? void 0 : t2.destroy();
  e2.clear();
}
...
function d(e2, r, t2) {
  ...
  if (e2) for (let a3 = 0, i = e2.length; a3 < i; a3++) {
    if (s = e2.at(a3), (s == null ? void 0 : s[r]) === t2) return s;
    if ("group" === (s == null ? void 0 : s.type) && (o = d(s.layers, r, t2), o)) return o;
  }
}
var l2 = (l3) => {
...
//# sourceMappingURL=chunk-RSPPQPTD.js.map
