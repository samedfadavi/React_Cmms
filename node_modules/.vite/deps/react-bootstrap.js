import {
  ...
  hasChildOfType,
  map
} from "./chunk-SFTVDUI2.js";
import {
  Button_default,
  Button_default2,
  useButtonProps
} from "./chunk-QYWL6BVE.js";
import {
...
var Spinner = React110.forwardRef(({
  ...
  return (0, import_jsx_runtime113.jsx)(Component2, {
    ref,
    ...props,
    className: (0, import_classnames82.default)(className, bsSpinnerPrefix, size && `${bsSpinnerPrefix}-${size}`, variant && `text-${variant}`)
  });
});
