...
var u2 = (t3) => {
  ...
  return u3 = e([a2("esri.core.ReadOnlyMultiOriginJSONSupport")], u3), u3;
};
function a3(r3) {
  return t(r3).store;
}
...
var l = (t3) => {
  let s = class extends t3 {
    ...
    removeOrigin(r3) {
      ...
      for (const o2 of e4) t4.originOf(o2) === s2 && t4.set(o2, t4.get(o2, s2), e2.USER);
    }
    updateOrigin(r3, t4) {
  ...
  return s = e([a2("esri.core.MultiOriginJSONSupport.WriteableMultiOriginJSONSupport")], s), s.prototype.toJSON.isDefaultToJSON = true, s;
};
function O(r3) {
  return t(r3).store;
}
...
m = e([a2("esri.core.MultiOriginJSONSupport")], m);

export {
  S2 as S,
  m
};
//# sourceMappingURL=chunk-E7HFITKU.js.map
