...
var Button = proxyCustomElement(class Button2 extends H {
  ...
  render() {
    ...
    const iconStartEl = h("calcite-icon", { key: "5f802ba3711d5453f1e6122cb18bc29e432df0ca", class: { [CSS.icon]: true, [CSS.iconStart]: true }, flipRtl: this.iconFlipRtl === "start" || this.iconFlipRtl === "both", icon: this.iconStart, scale: getIconScale(this.scale) });
    const iconEndEl = h("calcite-icon", { key: "3ef0f67aecc6e5475d52447f8b8a985e5700291f", class: { [CSS.icon]: true, [CSS.iconEnd]: true }, flipRtl: this.iconFlipRtl === "end" || this.iconFlipRtl === "both", icon: this.iconEnd, scale: getIconScale(this.scale) });
    const contentEl = h("span", { key: "bccc400a38f1304ba1f5b0015870fb34e31fa97e", class: CSS.content, ref: (el) => this.contentEl = el }, h("slot", { key: "18b9553660036b6fcf83ceabf68b308b5d140904" }));
    return h(InteractiveContainer, { key: "e9bebe1bbc63bca93b02eb53efef76a035ce89d0", disabled: this.disabled }, h(Tag, { key: "2d99966fc0ba9d13cb623f6ae7936ba9ddfbe7e1", "aria-disabled": childElType === "a" ? toAriaBoolean(this.disabled || this.loading) : null, "aria-expanded": this.el.getAttribute("aria-expanded"), "aria-label": !this.loading ? getLabelText(this) : this.messages.loading, "aria-live": "polite", class: {
...
@esri/calcite-components/dist/components/calcite-button.js:
   ...
   *)
*/
//# sourceMappingURL=calcite-button-PKF5XM3M.js.map
