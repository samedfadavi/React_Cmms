...
var j = w = class extends f {
  static create(e2 = {}) {
    ...
    if (!N2(i2)) {
      ...
      if (o2) for (let t3 = 0; t3 < o2.length; t3++) {
        ...
        let t3 = 5e-4;
        for (let o3 = l2 - 1; o3 >= 0; o3--) e3.unshift(new p({ level: o3, scale: t3, resolution: t3 })), t3 *= 2;
      }
      return new w({ dpi: 96, lods: e3, origin: new _(0, 0, i2), size: [r2, r2], spatialReference: i2 });
    }
    const n2 = s(i2), p2 = e2.origin ? new _({ x: e2.origin.x, y: e2.origin.y, spatialReference: i2 }) : new _(n2 ? { x: n2.origin[0], y: n2.origin[1], spatialReference: i2 } : { x: 0, y: 0, spatialReference: i2 }), u2 = 96, d = 1 / (W(i2) * 39.37 * u2), g2 = [];
    ...
    return new w({ dpi: u2, lods: g2, origin: p2, size: [r2, r2], spatialReference: i2 });
  }
  constructor(e2) {
  ...
  readOrigin(e2, t2) {
    return _.fromJSON({ spatialReference: t2.spatialReference, ...e2 });
  }
  set lods(e2) {
    let t2 = 0, o2 = 0;
...
e([y({ type: Number, json: { write: true } })], j.prototype, "compressionQuality", void 0), e([y({ type: Number, json: { write: true } })], j.prototype, "dpi", void 0), e([y({ type: String, json: { read: x.read, write: x.write, origins: { "web-scene": { read: false, write: false } } } })], j.prototype, "format", void 0), e([y({ readOnly: true })], j.prototype, "isWrappable", null), e([y({ type: _, json: { write: true } })], j.prototype, "origin", void 0), e([o("origin")], j.prototype, "readOrigin", null), e([y({ type: [p], value: null, json: { write: true } })], j.prototype, "lods", null), e([y({ readOnly: true })], j.prototype, "scales", void 0), e([y({ cast: (e2) => Array.isArray(e2) ? e2 : "number" == typeof e2 ? [e2, e2] : [256, 256] })], j.prototype, "size", void 0), e([o("size", ["rows", "cols"])], j.prototype, "readSize", null), e([r("size", { cols: { type: N }, rows: { type: N } })], j.prototype, "writeSize", null), e([y({ type: f2, json: { write: true } })], j.prototype, "spatialReference", void 0), j = w = e([a("esri.layers.support.TileInfo")], j), function(e2) {
  var t2;
...
//# sourceMappingURL=chunk-JFTJTGUT.js.map
