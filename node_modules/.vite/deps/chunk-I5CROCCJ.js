  ...
  async (component, { referenceEl, floatingEl, overlayPositioning = "absolute", placement, flipDisabled, flipPlacements: flipPlacements2, offsetDistance, offsetSkidding, arrowEl, type }) => {
    ...
    const { x, y, placement: effectivePlacement, strategy: position, middlewareData } = await computePosition(referenceEl, floatingEl, {
      ...
      middleware: getMiddleware({
        placement,
        flipDisabled,
        flipPlacements: flipPlacements2 == null ? void 0 : flipPlacements2.map((placement2) => getEffectivePlacement(floatingEl, placement2)),
        offsetDistance,
        offsetSkidding,
        arrowEl,
        type
...
var Popover = proxyCustomElement(class Popover2 extends H {
  ...
  renderCloseButton() {
    ...
    return closable ? h("div", { class: CSS3.closeButtonContainer, key: CSS3.closeButtonContainer }, h("calcite-action", { appearance: "transparent", class: CSS3.closeButton, onClick: this.hide, ref: (closeButtonEl) => this.closeButtonEl = closeButtonEl, scale: this.scale, text: messages.close }, h("calcite-icon", { icon: "x", scale: getIconScale(this.scale) }))) : null;
  }
  renderHeader() {
  ...
  render() {
    ...
    return h(Host, { key: "3d353c97791fd0d5b2c1138f3b068669024b3512", "aria-hidden": toAriaBoolean(hidden), "aria-label": label, "aria-live": "polite", "calcite-hydrated-hidden": hidden, id: this.getId(), role: "dialog" }, h("div", { key: "1248ef4c8e83e622335b71a3b0034bf0490d7583", class: {
      ...
      [CSS3.container]: true
    } }, this.renderHeader(), h("div", { key: "1891093fcb573a52309328248aa9d4a2a057c7e4", class: CSS3.content }, h("slot", { key: "67bcfcbf92172b4575d44a201238faba5ceac271" })), !heading ? this.renderCloseButton() : null)));
  }
...
var ActionMenu = proxyCustomElement(class ActionMenu2 extends H {
  ...
  renderMenuButton() {
    ...
    const menuButtonSlot = h("slot", { name: SLOTS.trigger, onSlotchange: this.setMenuButtonEl }, h("calcite-action", { appearance, class: CSS4.defaultTrigger, icon: ICONS.menu, ref: this.setDefaultMenuButtonEl, scale, text: label, textEnabled: expanded }));
    return menuButtonSlot;
  }
  renderMenuItems() {
    const { actionElements, activeMenuItemIndex, open, menuId, menuButtonEl, label, placement, overlayPositioning, flipPlacements: flipPlacements2 } = this;
    const activeAction = actionElements[activeMenuItemIndex];
    const activeDescendantId = (activeAction == null ? void 0 : activeAction.id) || null;
    return h("calcite-popover", { autoClose: true, flipPlacements: flipPlacements2, focusTrapDisabled: true, label, offsetDistance: 0, onCalcitePopoverClose: this.handlePopoverClose, onCalcitePopoverOpen: this.handlePopoverOpen, open, overlayPositioning, placement, pointerDisabled: true, referenceElement: menuButtonEl }, h("div", { "aria-activedescendant": activeDescendantId, "aria-labelledby": menuButtonEl == null ? void 0 : menuButtonEl.id, class: CSS4.menu, id: menuId, onClick: this.handleCalciteActionClick, role: "menu", tabIndex: -1 }, h("slot", { onSlotchange: this.handleDefaultSlotChange })));
  }
  render() {
...
@esri/calcite-components/dist/components/action-menu.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-I5CROCCJ.js.map
