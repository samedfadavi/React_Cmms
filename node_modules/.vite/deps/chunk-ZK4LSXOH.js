...
!function(o3) {
  class c {
    ...
    emit(e3, t) {
      ...
      for (const i2 of r.slice()) {
        ...
        e4 ? e4 == null ? void 0 : e4.call(s, t) : n = true;
      }
    ...
    on(e3, t) {
      ...
      return n.push(t), this._listenersMap.set(e3, n), e2(() => {
        var _a;
        const r = (_a = this._listenersMap) == null ? void 0 : _a.get(e3), s = (r == null ? void 0 : r.indexOf(t)) ?? -1;
        s >= 0 && r.splice(s, 1);
      });
    }
    once(e3, t) {
    ...
    hasEventListener(e3) {
      var _a;
      const t = (_a = this._listenersMap) == null ? void 0 : _a.get(e3);
  ...
  o3.EventEmitter = c, o3.EventedMixin = (t) => {
    ...
    return r = e([a("esri.core.Evented")], r), r;
  };
  ...
  l = e([a("esri.core.Evented.EventedAccessor")], l), o3.EventedAccessor = l;
}(i || (i = {}));
var o2 = i;
...
//# sourceMappingURL=chunk-ZK4LSXOH.js.map
