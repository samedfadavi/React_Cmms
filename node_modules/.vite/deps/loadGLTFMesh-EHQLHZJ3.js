...
function e5(e7, t5, o7) {
  ...
  let u6 = ((o7 == null ? void 0 : o7.dstIndex) ?? 0) * f4, l4 = ((o7 == null ? void 0 : o7.srcIndex) ?? 0) * n4;
  for (let p = 0; p < c3; ++p) {
...
async function K(e7, t5, o7) {
  ...
  const { position: u6, normal: f4, tangent: m2, color: p, texCoord0: d } = c3.vertexAttributes, h2 = s2(e7, o7), T2 = e7.spatialReference.isGeographic ? s2(e7) : h2, v = M2({ vertexAttributes: { position: u6.typedBuffer, normal: f4 == null ? void 0 : f4.typedBuffer, tangent: m2 == null ? void 0 : m2.typedBuffer }, vertexSpace: T2, spatialReference: e7.spatialReference }, h2, { allowBufferReuse: true, sourceUnit: "meters" });
  if (!v) throw new s("loadGLTFMesh()", "Failed to load mesh from glTF due to projection errors");
  return { transform: null, vertexSpace: h2, components: c3.components, spatialReference: e7.spatialReference, vertexAttributes: new l({ ...v, color: p == null ? void 0 : p.typedBuffer, uv: d == null ? void 0 : d.typedBuffer }) };
}
function Q(e7) {
...
function W(e7) {
  ...
  return { vertexAttributes: { position: r6(T, t5), normal: has.normal ? r6(i, t5) : null, tangent: has.tangent ? r6(c, t5) : null, color: has.color ? r6(x, t5) : null, texCoord0: has.texCoord0 ? r6(u2, t5) : null }, parts: s3, components: [] };
}
function X(e7) {
  return new w({ data: (r5(e7.data), e7.data), wrap: re(e7.parameters.wrap) });
}
function Y(t5, r7) {
  const o7 = new u(se(t5.color, t5.opacity)), n4 = t5.emissiveFactor ? new u(ae(t5.emissiveFactor)) : null, a = (e7) => e7 ? new c2({ scale: e7.scale ? [e7.scale[0], e7.scale[1]] : [1, 1], rotation: M(e7.rotation ?? 0), offset: e7.offset ? [e7.offset[0], e7.offset[1]] : [0, 0] }) : null;
...
function ee(e7, t5) {
  ...
  } else null != o7 && f2(o7, 0, 0, 1, { dstIndex: f4, count: d });
  if (null != m2.tangent && null != s3) {
    const e8 = n(e2(), p), t6 = s3.slice(f4, d);
    f(t6, m2.tangent, e8), _(e8) && o(t6, t6);
  } else null != s3 && f3(s3, 0, 0, 1, 1, { dstIndex: f4, count: d });
...
//# sourceMappingURL=loadGLTFMesh-EHQLHZJ3.js.map
