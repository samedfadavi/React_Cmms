...
var i3 = class {
  ...
  endAccessor() {
    ...
    const r4 = { byteOffset: e6 * (this._accessorIndex / t3), componentType: this._componentType, count: i8, type: this._dataType, min: this._accessorMin, max: this._accessorMax, name: this._accessorAttribute };
  ...
  async finalize() {
    ...
    this._asyncWritePromise && t3.push(this._asyncWritePromise), await Promise.allSettled(t3), this._isFinalized = true, e6.byteOffset = this.getByteOffset(), e6.byteLength = this.dataSize, this._finalizedPromiseResolve && this._finalizedPromiseResolve();
  }
  _getElementSize() {
...
function e4(r4, c3) {
  ...
  const e6 = r4.faces, { position: m2, normal: p } = c3, h3 = e6.length / 3;
...
var O = class {
  constructor(e6, t3) {
    this.options = t3, this._materialMap = new Array(), this._imageMap = /* @__PURE__ */ new Map(), this._textureMap = /* @__PURE__ */ new Map(), this.gltf = { asset: { version: "2.0", copyright: e6.copyright, generator: e6.generator }, extras: { output: t3.output, binChunkBuffer: null, promises: [] } }, this._addScenes(e6);
  }
  _addScenes(e6) {
  ...
  _createMeshes(e6) {
    ...
    const o4 = M({ vertexAttributes: e6.vertexAttributes, vertexSpace: e6.vertexSpace, transform: ((_a = this.options) == null ? void 0 : _a.ignoreLocalTransform) ? null : e6.transform, spatialReference: e6.spatialReference }, a3, { targetUnit: "meters" });
    if (!o4) return [];
    c2(e6, o4), w(o4);
    const { position: n4, normal: l4, tangent: c3 } = o4, { uv: u2, color: d2 } = e6.vertexAttributes, _3 = r4.addBufferView(C.FLOAT, L2.VEC3, R.ARRAY_BUFFER);
    let T2, R2, A2, E2;
  ...
  _createTextureInfo(e6, t3) {
    const r4 = { index: this._addTexture(e6) };
    return t3 ? (r4.extensions || (r4.extensions = {}), r4.extensions.KHR_texture_transform = { scale: t3.scale, offset: t3.offset, rotation: h(t3.rotation) }, r4) : r4;
  }
  _addTexture(e6) {
    const s4 = this.gltf.textures ?? [];
    return this.gltf.textures = s4, r(this._textureMap, e6, () => {
      const t3 = { sampler: this._addSampler(e6), source: this._addImage(e6) }, r4 = s4.length;
      ...
      switch (r5.output.image) {
        case A.GLB: {
          ...
          if (r3(t4)) null != t4.data && e7.writeOutToBuffer(t4.data, 0);
            ...
            const i8 = i(t4, this.options.signal).then(({ data: e8, type: t5 }) => (s4.mimeType = t5, e8));
        ...
        default:
          ...
          r5.promises.push(i(t4, this.options.signal).then(({ data: e7, type: t5 }) => {
  ...
  _addAccessor(e6, t3) {
    ...
    const s4 = { bufferView: e6, byteOffset: t3.byteOffset, componentType: t3.componentType, count: t3.count, type: t3.type, min: t3.min, max: t3.max, name: t3.name };
  ...
  _addMeshVertexIndexed(e6, t3, s4, r4, i8, a3, o4, n4) {
    ...
    for (const c3 of t3) {
      ...
      const t4 = e6.endAccessor(), u2 = { attributes: { POSITION: r4 }, indices: this._addAccessor(e6.index, t4), material: this._addMaterial(c3.material) };
      ...
      if (h3) h3.primitives.push(u2);
        ...
        const e7 = { name: c3.name, primitives: [u2] };
  ...
  _addMeshVertexNonIndexed(e6, t3, s4, r4, i8, a3, o4) {
    const n4 = { primitives: [] };
    t3.push(n4);
    const l4 = { attributes: { POSITION: s4 } };
...
function w({ position: e6, normal: t3, tangent: s4 }) {
...
async function u(u2, l4) {
  ...
  const b = l4.jsonSpacing ?? 4, j = /* @__PURE__ */ new Map(), w2 = JSON.stringify(c3, (e6, t3) => {
    ...
    if ("extras" !== e6) {
      if (t3 instanceof ArrayBuffer) {
        ...
        switch ((_b2 = l4.output) == null ? void 0 : _b2.buffer) {
          case E.DataURI:
            return s2(t3);
          case E.GLB:
  ...
  return ((_a = l4.output) == null ? void 0 : _a.buffer) === E.GLB || ((_b = l4.output) == null ? void 0 : _b.image) === A.GLB ? j.set(i6, new e3(w2, d2).buffer) : j.set(f2, w2), j;
}
async function l3(e6, t3) {
  const r4 = (await u(e6, { output: { buffer: E.GLB, image: A.GLB }, jsonSpacing: 0, ...t3 })).get(i6);
...
async function i7(i8, t3) {
  const s4 = new s3(), m2 = new d();
  return s4.addScene(m2), m2.addNode(new e5(i8)), await l3(s4, { origin: i8.origin, ...t3 });
}
export {
  i7 as toBinaryGLTF
};
//# sourceMappingURL=gltfexport-RHLQI2JX.js.map
