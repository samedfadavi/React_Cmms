...
var b2 = class extends s {
  ...
  async setSourceAsync(i2, s2) {
    null != this._uploadStatus && this._uploadStatus.controller.abort();
    const r = new AbortController(), h2 = L();
    return w(s2, () => r.abort()), w(r, (t2) => h2.reject(t2)), this._uploadStatus = { controller: r, resolver: h2 }, this.source = i2, h2.promise;
  }
  invalidateTexture() {
  ...
  async updateTexture({ context: t2, painter: e3 }) {
    ...
    try {
      if (null != this._uploadStatus) {
        ...
        await a.enqueueTextureUpdate({ data: s2, texture: u, width: h2, height: o2 }, r), i2.resolve(), this._uploadStatus = null;
...
//# sourceMappingURL=chunk-PTZGICF3.js.map
