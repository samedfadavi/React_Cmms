...
async function p(t2, e) {
  ...
  if ("image/gif" === a) {
    const { isAnimatedGIF: t3, parseGif: a2 } = await import("./gif-7ZNBJQK2.js");
    if (t3(r)) return a2(r, e);
  }
  if (n) {
    const { isAnimatedPNG: t3, parseApng: a2 } = await import("./apng-TDFGDKZS.js");
    if (t3(r)) return a2(r, e);
  }
...
//# sourceMappingURL=chunk-YH5YACEX.js.map
