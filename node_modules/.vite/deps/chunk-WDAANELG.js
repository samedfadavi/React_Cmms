...
e([y({ type: String, json: { write: true } })], i2.prototype, "name", void 0), e([y({ type: String, json: { write: true } })], i2.prototype, "alias", void 0), e([y({ type: String, json: { write: true } })], i2.prototype, "fieldType", void 0), e([y({ type: String, json: { write: true } })], i2.prototype, "geometryType", void 0), e([y({ type: Boolean, json: { write: true } })], i2.prototype, "hasM", void 0), e([y({ type: Boolean, json: { write: true } })], i2.prototype, "hasZ", void 0), e([y({ type: Boolean, json: { write: true } })], i2.prototype, "nullable", void 0), e([y({ type: Boolean, json: { write: true } })], i2.prototype, "editable", void 0), e([y({ type: Boolean, json: { write: true } })], i2.prototype, "required", void 0), e([y({ type: Boolean, json: { write: true } })], i2.prototype, "defaultVisibility", void 0), e([y({ type: Boolean, json: { write: true } })], i2.prototype, "systemMaintained", void 0), e([y()], i2.prototype, "role", void 0), e([y({ json: { write: true } })], i2.prototype, "defaultValue", void 0), i2 = e([a("esri.rest.knowledgeGraph.GraphProperty")], i2);
var s3 = i2;
...
e([y({ type: String, json: { write: true } })], i3.prototype, "name", void 0), e([y({ type: String, json: { write: true } })], i3.prototype, "alias", void 0), e([y({ type: String, json: { write: true } })], i3.prototype, "role", void 0), e([y({ type: Boolean, json: { write: true } })], i3.prototype, "strict", void 0), e([y({ type: [s3], json: { write: true } })], i3.prototype, "properties", void 0), e([y({ type: [i], json: { write: true } })], i3.prototype, "fieldIndexes", void 0), i3 = e([a("esri.rest.knowledgeGraph.GraphObjectType")], i3);
var l = i3;
...
e([y({ type: Date, json: { type: Number, write: { writer: (t9, e7) => {
  e7.timestamp = t9 == null ? void 0 : t9.getTime();
} } } })], n4.prototype, "timestamp", void 0), e([y({ type: f2, json: { write: true } })], n4.prototype, "spatialReference", void 0), e([y({ type: Boolean, json: { write: true } })], n4.prototype, "strict", void 0), e([y({ type: String, json: { write: true } })], n4.prototype, "objectIdField", void 0), e([y({ type: String, json: { write: true } })], n4.prototype, "globalIdField", void 0), e([y()], n4.prototype, "arcgisManaged", void 0), e([y()], n4.prototype, "identifierInfo", void 0), e([y()], n4.prototype, "searchIndexes", void 0), e([y({ type: [e2], json: { write: true } })], n4.prototype, "entityTypes", void 0), e([y({ type: [p5], json: { write: true } })], n4.prototype, "relationshipTypes", void 0), e([y({ type: [e2], json: { write: true } })], n4.prototype, "metaEntityTypes", void 0), n4 = e([a("esri.rest.knowledgeGraph.DataModel")], n4);
var l2 = n4;
...
e([y({ type: [String], json: { write: true } })], p6.prototype, "capabilities", void 0), e([y({ type: Boolean, json: { write: true } })], p6.prototype, "supportsSearch", void 0), e([y({ type: [String], json: { write: true } })], p6.prototype, "supportedQueryFormats", void 0), e([y({ type: Boolean, json: { write: true } })], p6.prototype, "allowGeometryUpdates", void 0), e([y({ type: Number, json: { write: true } })], p6.prototype, "searchMaxRecordCount", void 0), e([y({ type: Object, json: { write: true } })], p6.prototype, "serviceCapabilities", void 0), e([y({ type: Number, json: { write: true } })], p6.prototype, "maxRecordCount", void 0), e([y({ type: String, json: { write: true } })], p6.prototype, "description", void 0), e([y({ type: String, json: { write: true } })], p6.prototype, "copyrightText", void 0), e([y({ type: String, json: { write: true } })], p6.prototype, "units", void 0), e([y({ type: f2, json: { write: true } })], p6.prototype, "spatialReference", void 0), e([y({ type: Number, json: { write: true } })], p6.prototype, "currentVersion", void 0), e([y({ type: Object, json: { write: true } })], p6.prototype, "dateFieldsTimeReference", void 0), e([y({ type: String, json: { write: true } })], p6.prototype, "serviceItemId", void 0), e([y({ type: Boolean, json: { write: true } })], p6.prototype, "supportsDocuments", void 0), e([y({ type: Boolean, json: { write: true } })], p6.prototype, "dataEditingNotSupported", void 0), e([y({ type: Boolean, json: { write: true } })], p6.prototype, "schemaEditingNotSupported", void 0), e([y({ type: Boolean, json: { write: true } })], p6.prototype, "supportsProvenance", void 0), p6 = e([a("esri.rest.knowledgeGraph.ServiceDefinition")], p6);
var s4 = p6;
...
e([y({ type: String, json: { write: true } })], p7.prototype, "url", void 0), e([y({ type: l2, json: { write: true } })], p7.prototype, "dataModel", void 0), e([y({ type: s4, json: { write: true } })], p7.prototype, "serviceDefinition", void 0), p7 = e([a("esri.rest.knowledgeGraph.KnowledgeGraph")], p7);
var c3 = p7;
...
async function o(s8) {
  if (s8) {
    const { default: s9 } = await import("./arcgis-knowledge-client-core-simd-MHSS42PV.js").then((e7) => e7.a);
    return s9({ locateFile: (s10) => n2(t6 + s10) });
  }
  const { default: n7 } = await import("./arcgis-knowledge-client-core-NANS77VX.js").then((e7) => e7.a);
  return n7({ locateFile: (s9) => n2(t6 + s9) });
}
...
function u2(a5, i7) {
  ...
  throw new s("knowledge-graph:unsupported-geometry", "Only Point, Multipoint, Polyline, and Polygon geometry are supported by ArcGIS Knowledge", { geometry: a5 });
}
function y2(e7, t9) {
  t9.input_quantization_parameters = { xy_resolution: e7.xyResolution, x_false_origin: e7.xFalseOrigin, y_false_origin: e7.yFalseOrigin, z_resolution: e7.zResolution, z_false_origin: e7.zFalseOrigin, m_resolution: e7.mResolution, m_false_origin: e7.mFalseOrigin };
}
function m3(t9, n7, o3) {
  ...
  n7.output_quantization_parameters = { extent: { xmax: t9.extent.xmax, ymax: t9.extent.ymax, xmin: t9.extent.xmin, ymin: t9.extent.ymin }, quantize_mode: o3.esriQuantizeMode[t9.quantizeMode], tolerance: t9.tolerance };
}
function c4(e7, t9) {
  t9.provenance_behavior = { value: i4[e7] };
}
function f3(e7, t9) {
  if (null == e7) return "";
...
function s7(e7) {
  return { xy_resolution: e7.xyResolution, x_false_origin: e7.xFalseOrigin, y_false_origin: e7.yFalseOrigin, z_resolution: e7.zResolution, z_false_origin: e7.zFalseOrigin, m_resolution: e7.mResolution, m_false_origin: e7.mFalseOrigin };
}
function a3(e7, t9) {
...
function _2(i7) {
  ...
  return i7.deleteLater(), new l2({ timestamp: i7.timestamp, spatialReference: new f2(i7.spatial_reference), strict: i7.strict, objectIdField: i7.objectid_property, globalIdField: i7.globalid_property, arcgisManaged: i7.arcgis_managed, identifierInfo: { identifierMappingInfo: { identifierInfoType: n6[(_c = (_b = (_a = i7.identifier_info) == null ? void 0 : _a.identifier_mapping_info) == null ? void 0 : _b.identifier_info_type) == null ? void 0 : _c.value], databaseNativeIdentifier: (_e = (_d = i7.identifier_info) == null ? void 0 : _d.identifier_mapping_info) == null ? void 0 : _e.database_native_identifier, uniformPropertyIdentifier: { identifierPropertyName: (_h = (_g = (_f = i7.identifier_info) == null ? void 0 : _f.identifier_mapping_info) == null ? void 0 : _g.uniform_property_identifier) == null ? void 0 : _h.identifier_property_name } }, identifierGenerationInfo: { uuidMethodHint: t8[(_k = (_j = (_i = i7.identifier_info) == null ? void 0 : _i.identifier_generation_info) == null ? void 0 : _j.uuid_method_hint) == null ? void 0 : _k.value] } }, searchIndexes: M(i7.search_indexes), entityTypes: j2(i7.entity_types), relationshipTypes: x(i7.relationship_types), metaEntityTypes: j2(i7.meta_entity_types) });
}
function c5(e7) {
  return e7.deleteLater(), new e2(z(e7));
}
function g2(e7) {
  return e7.deleteLater(), new i({ name: e7.name, unique: e7.unique, ascending: e7.ascending, description: e7.description, fieldNames: I(e7.fields) });
}
function z(e7) {
  return { name: e7.name, alias: e7.alias, role: e4[e7.role.value] ? e4[e7.role.value] : null, strict: e7.strict, properties: T2(e7.properties), fieldIndexes: w(e7.field_indexes) };
}
function b(e7) {
  return e7.deleteLater(), new s3({ alias: e7.alias, name: e7.name, fieldType: r3[e7.field_type.value] ? r3[e7.field_type.value] : null, geometryType: i5[e7.geometry_type.value] ? i5[e7.geometry_type.value] : null, hasM: e7.has_m, hasZ: e7.has_z, nullable: e7.nullable, editable: e7.editable, required: e7.required, defaultVisibility: e7.default_visibility, systemMaintained: e7.system_maintained, role: p10[e7.role.value], defaultValue: e7.default_value });
}
function v(e7) {
  e7.deleteLater();
  const t9 = z(e7), i7 = [];
  for (let n7 = 0; n7 < e7.end_points.size(); n7++) {
    ...
    i7.push({ originEntityType: t10.origin_entity_type, destinationEntityType: t10.dest_entity_type });
  }
  return e7.end_points.delete(), new p5(Object.assign({ endPoints: i7 }, t9));
}
function j2(e7) {
  const t9 = [];
...
function M(e7) {
  ...
  for (let i7 = 0; i7 < e7.size(); i7++) {
    ...
    for (let e8 = 0; e8 < r4; e8++) i8.analyzers.push({ name: n7.analyzers.get(e8).name });
    n7.analyzers.delete();
    for (let e8 = 0; e8 < n7.search_properties.keys().size(); e8++) {
      ...
      i8.searchProperties.set(t10, { propertyNames: a5 });
    }
    t9.push(i8);
  }
  return e7.delete(), t9;
...
function l4(e7, o3) {
  const r4 = { spatialReference: o3 }, n7 = c6(e7, r4), s8 = e7.lengths, l5 = e7.coords, i7 = s8[0];
  r4.points = [];
  let a5 = 0;
...
function f4(t9, o3) {
  const r4 = { spatialReference: o3 }, n7 = c6(t9, r4), l5 = t9.lengths, i7 = t9.coords;
  let a5 = "";
...
var f5 = { decodedWasmObjToQueryResponseObj: (e7, t9, r4) => {
...
function E2(e7, r4, n7) {
  ...
  return new m2(Object.assign({ typeName: o3, id: a5 }, s8));
}
function O(e7, t9, r4) {
...
function T3(e7, t9, r4) {
  ...
  return new c({ path: a5 });
}
function h2(e7, t9, r4) {
  const n7 = e7.type_name, o3 = O(e7, t9, r4);
  return new p(Object.assign({ typeName: n7, id: e7.get_id(), originId: e7.get_origin_entity_id(), destinationId: e7.get_destination_entity_id() }, o3));
}
function w2(e7) {
  const t9 = [];
  for (let n7 = 0; n7 < e7.get_header_keys().size(); n7++) t9.push(e7.get_header_keys().get(n7));
  const r4 = new f2(e7.get_out_sr());
  return new p2({ headerKeys: t9, outSpatialReference: r4, exceededTransferLimit: e7.exceeded_transfer_limit() });
}
...
function e6(e7) {
  const o3 = e7.has_error(), t9 = new p12({ hasError: o3, error: o3 ? { errorCode: e7.error.error_code, errorMessage: e7.error.error_message } : null }), s8 = e7.get_edit_results_count();
  for (let r4 = 0; r4 < s8; r4++) {
    ...
    for (let r5 = 0; r5 < a5; r5++) {
      ...
      _3.push({ id: e8.id, error: { errorCode: e8.error.error_code, errorMessage: e8.error.error_message } });
    }
    for (let r5 = 0; r5 < l5; r5++) {
      const e8 = o4.get_update_result_at(r5);
      d.push({ id: e8.id, error: { errorCode: e8.error.error_code, errorMessage: e8.error.error_message } });
    }
    for (let r5 = 0; r5 < g4; r5++) {
      const e8 = o4.get_delete_result_at(r5);
      u3.push({ id: e8.id, error: { errorCode: e8.error.error_code, errorMessage: e8.error.error_message } });
    }
    t9.editResults.push({ typeName: s9, adds: _3, updates: d, deletes: u3 });
  }
  return t9;
}

// ../node_modules/@arcgis/core/rest/knowledgeGraphService.js
var G = { fetchKnowledgeGraph: async (e7) => {
  const t9 = new c3({ url: e7 }), r4 = [];
  return r4.push(A(t9)), r4.push(M2(t9)), await Promise.all(r4), t9;
}, refreshDataModel: async (e7) => {
  e7.dataModel = await K(e7);
}, refreshServiceDefinition: async (e7) => {
  var _a, _b;
  const r4 = (await U(e7.url, { query: { f: "json" } })).data;
  return r4.capabilities = (_a = r4 == null ? void 0 : r4.capabilities) == null ? void 0 : _a.split(","), r4.supportedQueryFormats = (_b = r4 == null ? void 0 : r4.supportedQueryFormats) == null ? void 0 : _b.split(","), e7.serviceDefinition = new s4(r4), e7.serviceDefinition;
}, executeQueryStreaming: async (e7, t9, a5) => {
  var _a;
  const n7 = "include", o3 = `${e7.url}/graph/query`;
  await C(e7);
  const d = await L(o3, a5);
  if (!((_a = e7.serviceDefinition) == null ? void 0 : _a.supportsProvenance) && t9.provenanceBehavior === n7) throw new s("knowledge-graph:provenance-not-supported", "The Knowledge Graph Service definition indicated that provenance is not supported");
  d.data.body = await P(t9, e7);
  const s8 = await j4(d.data.url, d.data);
  if (e7.dataModel) {
    const t10 = await U2(s8, e7.dataModel);
    return new p4({ resultRowsStream: t10.readableStream, resultHeader: t10.resultHeader });
  }
  throw new s("knowledge-graph:undefined-data-model", "The KnowledgeGraph supplied did not have a data model");
}, executeApplyEdits: async (e7, t9, a5) => {
  var _a;
  if ((_a = e7.serviceDefinition) == null ? void 0 : _a.dataEditingNotSupported) throw new s("knowledge-graph:data-editing-not-supported", "The Knowledge Graph Service definition indicated that data editing is not supported");
  const n7 = `${e7.url}/graph/applyEdits`;
  await C(e7);
  const o3 = await L(n7, a5);
  o3.data.body = await W(t9, e7);
  return I2(await j4(o3.data.url, o3.data));
}, executeQuery: async (e7, a5, o3) => {
  var _a;
  const i7 = `${e7.url}/graph/query`, d = await U(i7, { responseType: "array-buffer", query: { f: "pbf", openCypherQuery: a5.openCypherQuery, ...o3 == null ? void 0 : o3.query }, signal: o3 == null ? void 0 : o3.signal, timeout: o3 == null ? void 0 : o3.timeout }), s8 = (_a = d.getHeader) == null ? void 0 : _a.call(d, "content-type"), l5 = d.data;
  if (s8 == null ? void 0 : s8.includes("application/x-protobuf")) {
    const t9 = new (await r()).GraphQueryDecoder();
    if (t9.deleteLater(), e7.dataModel) {
      const r4 = z2(t9, l5, e7.dataModel);
      return new c2({ resultRows: r4.resultRows, resultHeader: r4.resultHeader });
    }
    throw new s("knowledge-graph:undefined-data-model", "The KnowledgeGraph supplied did not have a data model");
  }
  throw new s("knowledge-graph:unexpected-server-response", "server returned an unexpected response", { responseType: s8, data: d.data });
}, executeSearch: async (e7, a5, o3) => {
  var _a;
  const i7 = a5.typeCategoryFilter, d = `${e7.url}/graph/search`, s8 = await U(d, { responseType: "array-buffer", query: { f: "pbf", searchQuery: `"${a5.searchQuery}"`, typeCategoryFilter: i7, ...o3 == null ? void 0 : o3.query }, signal: o3 == null ? void 0 : o3.signal, timeout: o3 == null ? void 0 : o3.timeout }), l5 = (_a = s8.getHeader) == null ? void 0 : _a.call(s8, "content-type"), c7 = s8.data;
  ...
  throw new s("knowledge-graph:unexpected-server-response", "server returned an unexpected response", { responseType: l5, data: s8.data });
}, executeSearchStreaming: async (e7, t9, a5) => {
  const n7 = `${e7.url}/graph/search`;
  await C(e7);
  const o3 = await L(n7, a5);
  o3.data.body = await F(t9);
  const d = await j4(o3.data.url, o3.data);
  if (e7.dataModel) {
    const t10 = await U2(d, e7.dataModel);
    return new p4({ resultRowsStream: t10.readableStream, resultHeader: t10.resultHeader });
  }
  throw new s("knowledge-graph:undefined-data-model", "The KnowledgeGraph supplied did not have a data model");
}, _fetchWrapper: async (e7, t9) => fetch(e7, t9) };
async function x2(e7, t9, r4) {
  return G.executeApplyEdits(e7, t9, r4);
}
async function E3(e7, t9, r4) {
  return G.executeQuery(e7, t9, r4);
}
async function T4(e7, t9, r4) {
  return G.executeQueryStreaming(e7, t9, r4);
}
async function q(e7, t9, r4) {
...
async function j4(e7, t9) {
  return G._fetchWrapper(e7, t9);
}
async function C(t9) {
  var _a;
  const r4 = (_a = t) == null ? void 0 : _a.findCredential(t9.url);
  r4 || (t9.dataModel ? await K(t9) : await A(t9));
}
function D(e7, t9, a5) {
  if (0 !== e7.error_code) throw new s(t9, a5, { errorCode: e7.error_code, errorMessage: e7.error_message });
}
...
async function W(e7, t9) {
  var _a, _b, _c, _d, _e, _f, _g, _h, _i;
  if (t9.dataModel || await A(t9), !t9.dataModel) throw new s("knowledge-graph:data-model-undefined", "Encoding could not proceed because a data model was not provided and it could not be determined from the service");
  const a5 = await r(), n7 = !!((_a = e7.options) == null ? void 0 : _a.cascadeDelete), o3 = new a5.GraphApplyEditsEncoder(a5.SpatialReferenceUtil.WGS84(), ((_b = e7.options) == null ? void 0 : _b.inputQuantizationParameters) ? s7((_c = e7.options) == null ? void 0 : _c.inputQuantizationParameters) : a5.InputQuantizationUtil.WGS84_lossless());
  o3.deleteLater(), o3.cascade_delete = n7;
  try {
    let t10;
    (_d = e7.entityAdds) == null ? void 0 : _d.forEach((e8) => {
    ...
    }), (_e = e7.relationshipAdds) == null ? void 0 : _e.forEach((e8) => {
    ...
    }), (_f = e7.entityUpdates) == null ? void 0 : _f.forEach((e8) => {
    ...
    }), (_g = e7.relationshipUpdates) == null ? void 0 : _g.forEach((e8) => {
    ...
    }), (_h = e7.entityDeletes) == null ? void 0 : _h.forEach((e8) => {
      var _a2;
      ...
      t11.deleteLater(), (_a2 = e8.ids) == null ? void 0 : _a2.forEach((e9) => {
        t11.delete_by_id(e9);
      });
    }), (_i = e7.relationshipDeletes) == null ? void 0 : _i.forEach((e8) => {
      var _a2;
      if (!e8.typeName) throw new s("knowledge-graph:no-type-name", "You must indicate the entity/relationship named object type to apply edits - delete");
      const t11 = o3.make_delete_helper(e8.typeName, false);
      (_a2 = e8.ids) == null ? void 0 : _a2.forEach((e9) => {
        t11.delete_by_id(e9);
      });
    }), o3.encode();
  } catch (d) {
    throw new s("knowledge-graph:applyEdits-encoding-failed", "Attempting to encode the applyEdits failed", { error: d });
  }
...
async function P(e7, t9) {
  var _a, _b;
  const a5 = await r(), n7 = new a5.GraphQueryRequestEncoder();
  if (n7.deleteLater(), e7.outputSpatialReference ? n7.output_spatial_reference = { wkid: e7.outputSpatialReference.wkid, latestWkid: e7.outputSpatialReference.latestWkid, vcsWkid: e7.outputSpatialReference.vcsWkid, latestVcsWkid: e7.outputSpatialReference.latestVcsWkid, wkt: e7.outputSpatialReference.wkt ?? "" } : n7.output_spatial_reference = a5.SpatialReferenceUtil.WGS84(), n7.open_cypher_query = e7.openCypherQuery, e7.bindParameters) for (const [r4, d] of Object.entries(e7.bindParameters)) H(r4, d, n7, a5);
  if (e7.bindGeometryQuantizationParameters) y2(e7.bindGeometryQuantizationParameters, n7);
  else {
    if (t9.dataModel || await A(t9), 4326 !== ((_b = (_a = t9.dataModel) == null ? void 0 : _a.spatialReference) == null ? void 0 : _b.wkid)) throw new s("knowledge-graph:SR-quantization-mismatch", "If the DataModel indicates a coordinate system other than WGS84, inputQuantizationParameters must be provided to the query encoder");
...
async function F(e7) {
  var _a;
  const t9 = await r(), a5 = new t9.GraphSearchRequestEncoder();
  ...
  (_a = e7.namedTypesFilter) == null ? void 0 : _a.forEach((e8) => {
...
async function L(e7, r4) {
  return U(e7, { responseType: "native-request-init", method: "post", query: { f: "pbf", ...r4 == null ? void 0 : r4.query }, body: "x", headers: { "Content-Type": "application/octet-stream" }, signal: r4 == null ? void 0 : r4.signal, timeout: r4 == null ? void 0 : r4.timeout });
}
async function I2(e7) {
  const t9 = e7.headers.get("content-type");
  if (t9 == null ? void 0 : t9.includes("application/x-protobuf")) {
    const t10 = await e7.arrayBuffer(), r4 = new (await r()).GraphApplyEditsDecoder();
    return r4.deleteLater(), r4.decode(new Uint8Array(t10)), e6(r4);
  }
  throw new s("knowledge-graph:unexpected-server-response", "server returned an unexpected response", { responseType: t9, data: e7.text() });
}
function z2(e7, t9, a5, n7) {
  ...
  let i7, d, s8 = 0;
  for (; e7.next_row(); ) {
    i7 && d || (i7 = n7 ?? w2(e7), d = i7.outSpatialReference ?? new f2({ wkid: 4326 })), s8 || (s8 = e7.get_header_keys().size());
  ...
  if (e7.has_error()) throw new s("knowledge-graph:stream-decoding-error", "One or more result rows were not successfully decoded - inner row decoding", { errorCode: e7.error.error_code, errorMessage: e7.error.error_message });
  return { resultHeader: i7, resultRows: o3 };
}
async function U2(e7, t9) {
  var _a;
  const n7 = e7.headers.get("content-type");
  if (e7.headers.get("content-length") && n.getLogger("esri.rest.knowledgeGraph.knowledgeGraphService").warnOnce("Found `Content-Length` header when expecting a streaming HTTP response! Please investigate whether all intermediate HTTP proxies and/or load balancers are configured such that they don't forcefully buffer the entire response before returning it to the client. A valid HTTP streaming response should use Chunked Transfer Encoding and not have a Content Length defined."), n7 == null ? void 0 : n7.includes("application/x-protobuf")) {
    const n8 = (_a = e7.body) == null ? void 0 : _a.getReader(), i7 = new (await r()).GraphQueryDecoder();
    let d, s8, l5;
    i7.deleteLater();
    ...
    let u3 = false;
    return { readableStream: new ReadableStream({ async start(e8) {
      try {
        return p13();
      } catch (c8) {
        n8 == null ? void 0 : n8.releaseLock(), e8.error(new s("knowledge-graph:stream-decoding-error", "The server returned a valid response, but there was an error decoding the response stream", { error: c8 })), e8.close();
      }
      function p13() {
        return n8 == null ? void 0 : n8.read().then(({ done: c8, value: h3 }) => {
          try {
            if (c8) {
              let t10;
              if (i7.has_error() ? t10 = new s("knowledge-graph:stream-decoding-error", "One or more result rows were not successfully decoded - query stream done", { errorCode: i7.error.error_code, errorMessage: i7.error.error_message }) : u3 || s8(new p2()), n8.releaseLock(), t10) throw e8.error(t10), l5(t10), t10;
            ...
            throw n.getLogger("esri.rest.knowledgeGraph.knowledgeGraphService").error(w3), l5(w3), new s("knowledge-graph:unexpected-server-response", "Error inside streaming data return parsing", { error: w3 });
          }
        });
      }
    } }), resultHeader: await c7 };
  }
  throw new s("knowledge-graph:unexpected-server-response", "server returned an unexpected response", { responseType: n7, data: e7.text() });
}
async function K(e7) {
  var _a;
  const a5 = `${e7.url}/dataModel/queryDataModel`, n7 = await U(a5, { responseType: "array-buffer", query: { f: "pbf" } }), o3 = (_a = n7.getHeader) == null ? void 0 : _a.call(n7, "content-type"), i7 = n7.data;
  if (o3 == null ? void 0 : o3.includes("application/x-protobuf")) {
    const e8 = (await r()).decode_data_model_from_protocol_buffer(new Uint8Array(i7));
...
//# sourceMappingURL=chunk-WDAANELG.js.map
