...
function l(t2, r, o2) {
  const a = o2(t2);
  if (!a.isValid) throw new s(`${r}:invalid-parameters`, a.errorMessage, { layer: t2 });
}
async function m(e) {
...
function u(t2) {
  ...
  if (i3(r), f2(t2), i4) {
    const t3 = i4(r);
    if (!t3.isValid) throw new s(`${o2}:invalid-parameters`, t3.errorMessage, { layer: a });
  }
}
function f2(t2) {
...
function y(e) {
  ...
  let i4 = S.from(t2);
  return i4.id && (i4 = i4.clone(), i4.id = null), i4.type ?? (i4.type = a), i4.portal ?? (i4.portal = C.getDefault()), u({ ...e, item: i4 }), i4;
}
function w(e) {
...
//# sourceMappingURL=chunk-OUNE6I33.js.map
