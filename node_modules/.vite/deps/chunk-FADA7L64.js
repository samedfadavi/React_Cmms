...
var p = u4 = class extends S {
  ...
  toRequestOptions(t3, r) {
    ...
    const i2 = { categories: e3, bbox: s4, q: o2, filter: this.filter, num: this.num, sortField: null, sortOrder: null, start: this.start };
    return this.sortField && (i2.sortField = this.sortField.split(",").map((t4) => m2.toJSON(t4.trim())).join(","), i2.sortOrder = this.sortOrder), { query: { ...r, ...i2 } };
  }
};
e([y()], p.prototype, "categories", void 0), e([y()], p.prototype, "disableExtraQuery", void 0), e([y({ type: w })], p.prototype, "extent", void 0), e([y()], p.prototype, "filter", void 0), e([y()], p.prototype, "num", void 0), e([y()], p.prototype, "query", void 0), e([y()], p.prototype, "sortField", void 0), e([y()], p.prototype, "sortOrder", null), e([y()], p.prototype, "start", void 0), p = u4 = e([a2("esri.portal.PortalQueryParams")], p);
var c4 = p;
...
e([y()], u5.prototype, "access", void 0), e([y({ type: Date })], u5.prototype, "created", void 0), e([y()], u5.prototype, "description", void 0), e([y()], u5.prototype, "id", void 0), e([y()], u5.prototype, "isInvitationOnly", void 0), e([y({ type: Date })], u5.prototype, "modified", void 0), e([y()], u5.prototype, "owner", void 0), e([y()], u5.prototype, "portal", void 0), e([y()], u5.prototype, "snippet", void 0), e([y()], u5.prototype, "sortField", void 0), e([y()], u5.prototype, "sortOrder", void 0), e([y()], u5.prototype, "sourceJSON", void 0), e([y()], u5.prototype, "tags", void 0), e([y()], u5.prototype, "thumbnail", void 0), e([y({ readOnly: true })], u5.prototype, "thumbnailUrl", null), e([y()], u5.prototype, "title", void 0), e([y({ readOnly: true })], u5.prototype, "url", null), u5 = l2 = e([a2("esri.portal.PortalGroup")], u5);
var p2 = u5;
...
e([y({ type: Date })], p4.prototype, "created", void 0), e([y()], p4.prototype, "id", void 0), e([y()], p4.prototype, "portal", void 0), e([y()], p4.prototype, "title", void 0), e([y({ readOnly: true })], p4.prototype, "url", null), e([y()], p4.prototype, "username", void 0), p4 = e([a2("esri.portal.PortalFolder")], p4);
var l3 = p4;
...
var u6 = i = class extends f {
  ...
  addItem(t3) {
    const e3 = t3 && t3.item, r = t3 == null ? void 0 : t3.data, o2 = t3 == null ? void 0 : t3.folder, s4 = { method: "post" };
  ...
  async deleteItem(t3, e3 = false) {
    let r = this.userContentUrl;
    t3.ownerFolder && (r += "/" + t3.ownerFolder);
    const o2 = e3 ? { permanentDelete: true } : {};
    await this.portal.request(r + `/items/${t3.id}/delete`, { method: "post", query: o2 }), t3.id = null, t3.portal = null;
  }
  async deleteItems(t3, r = false) {
    t3 = t3.concat();
    const o2 = this.userContentUrl + "/deleteItems", s4 = [], l4 = t3.map((t4) => t4.id);
    if (l4.length) {
      const n3 = { method: "post", query: { items: l4.join(","), permanentDelete: r } }, i2 = await this.portal.request(o2, n3);
      for (const r2 of i2.results) {
        const o3 = t3.find((t4) => r2.itemId === t4.id), l5 = r2.success;
        let n4 = null;
        l5 ? (o3.id = null, o3.portal = null) : r2.error && (n4 = new s2("portal:delete-item-failed", r2.error.message, r2.error)), s4.push({ item: o3, success: l5, error: n4 });
      }
    }
    return s4;
  }
  ...
  async fetchItems(t3) {
    ...
    const { default: r } = await import("./PortalItem-SGNF4ZBL.js"), o2 = { folders: false, inRecycleBin: !!t3.inRecycleBin || null, foldersContent: !(t3.folder || !t3.includeSubfolderItems) || null, num: t3.num || 10, start: t3.start || 1, sortField: t3.sortField || "created", sortOrder: t3.sortOrder || "asc" }, s4 = await this.portal.request(e3, { query: o2 });
    let l4;
    return (s4 == null ? void 0 : s4.items) ? (l4 = s4.items.map((t4) => {
      const e4 = r.fromJSON(t4);
      return e4.portal = this.portal, e4;
    }), await Promise.all(l4.map((t4) => t4.load())), { items: l4, nextStart: s4.nextStart, total: s4.total }) : { items: [], nextStart: -1, total: 0 };
  }
  fetchTags() {
  ...
  queryFavorites(t3) {
    return this.favGroupId ? (this._favGroup || (this._favGroup = new p2({ id: this.favGroupId, portal: this.portal })), this._favGroup.queryItems(t3)) : Promise.reject(new s2("internal:unknown", "Unknown internal error", { internalError: "Unknown favGroupId" }));
  }
  async restoreItem(t3, e3) {
    const r = this.userContentUrl, o2 = e3 ? { folderID: "string" == typeof e3 ? e3 : e3.id } : null;
    await this.portal.request(r + `/items/${t3.id}/restore`, { method: "post", query: o2 });
  }
  toJSON() {
...
var b2 = _ = class extends u3(m) {
  ...
  load(e3) {
    const t3 = import("./Basemap-7EN42X5L.js").then(({ default: t4 }) => {
      s3(e3), M = t4;
  ...
  async createElevationLayers() {
    await this.load();
    const e3 = this._getHelperService("defaultElevationLayers"), t3 = (await import("./ElevationLayer-LBJGBHUB.js")).default;
  ...
  fetchFeaturedGroups(e3) {
    const t3 = this.featuredGroups, r = new c4({ num: 100, sortField: "title" });
  ...
  fetchRegions(e3) {
    var _a;
    const t3 = ((_a = this.user) == null ? void 0 : _a.culture) || this.culture || c3();
  ...
  fetchSelf(e3 = this.authMode, t3 = false, r) {
    const o2 = this.restUrl + "/portals/self", s4 = { authMode: e3, query: { culture: c3().toLowerCase() }, withCredentials: true, ...r };
    return "auto" === s4.authMode && (s4.authMode = "no-prompt"), t3 && (s4.query.default = true), this.request(o2, s4);
  }
  queryPortal(e3, t3, r, o2) {
    const s4 = b(c4, t3), i2 = (t4) => this.request(this.restUrl + e3, { ...s4.toRequestOptions(this), ...o2 }).then((e4) => {
      const r2 = s4.clone();
      return r2.start = e4.nextStart, new p3({ nextQueryParams: r2, queryParams: s4, total: e4.total, results: _._resultsToTypedArray(t4, { portal: this }, e4, o2) });
    }).then((e4) => Promise.all(e4.results.map((t5) => "function" == typeof t5.when ? t5.when() : e4)).then(() => e4, (t5) => (a3(t5), e4)));
    return r && U2[r] ? U2[r]().then(({ default: e4 }) => (s3(o2), i2(e4))) : i2();
  }
  signIn() {
  ...
  requestToTypedArray(e3, t3, r) {
    return this.request(e3, t3).then((e4) => {
      const t4 = _._resultsToTypedArray(r, { portal: this }, e4);
      return Promise.all(t4.map((t5) => "function" == typeof t5.when ? t5.when() : e4)).then(() => t4, () => t4);
    });
  }
  request(e3, t3 = {}) {
    const r = { f: "json", ...t3.query }, { authMode: s4 = this.authMode === _.AUTH_MODE_ANONYMOUS || this.authMode === _.AUTH_MODE_NO_PROMPT ? this.authMode : "auto", body: i2 = null, cacheBust: a5 = false, method: l4 = "auto", responseType: u7 = "json", signal: n3 } = t3, p5 = { authMode: s4, body: i2, cacheBust: a5, method: l4, query: r, responseType: u7, timeout: 0, signal: n3 };
  ...
  async _fetchBasemaps(e3, r) {
    const o2 = new c4();
    o2.query = e3 || (s.apiKey && c2(this.url) ? this.devBasemapGalleryGroupQuery : this.useVectorBasemaps ? this.vectorBasemapGalleryGroupQuery : this.basemapGalleryGroupQuery), o2.disableExtraQuery = true;
    const s4 = await this.queryGroups(o2, r);
    if (!s4.total) return [];
    ...
    const a5 = await i2.queryItems(o2, r);
    if (!a5.total) return [];
    return a5.results.filter((e4) => "Web Map" === e4.type).map((e4) => new M({ portalItem: e4 }));
  }
  async _fetchBasemaps3D(e3, t3) {
    const r = e3 || this.basemapGalleryGroupQuery3D;
    if (!r) return [];
    const o2 = new c4({ query: r, disableExtraQuery: true }), s4 = await this.queryGroups(o2, t3);
    if (!s4.total) return [];
    const i2 = s4.results[0];
    o2.num = 100, o2.query = 'type:"Web Scene"', o2.sortField = i2.sortField || "name", o2.sortOrder = i2.sortOrder || "desc";
    const a5 = await i2.queryItems(o2, t3);
    if (!a5.total) return [];
    return a5.results.filter((e4) => "Web Scene" === e4.type).map((e4) => new M({ portalItem: e4 }));
  }
  _normalizeSSL(e3) {
...
//# sourceMappingURL=chunk-FADA7L64.js.map
