...
var d2 = { ArcGISFeatureLayer: "FeatureLayer", SubtypeGroupTable: "UnsupportedLayer" };
...
async function f(e3, r2, a2) {
  const t3 = new e3();
  return t3.read(r2, a2.context), "group" === t3.type && ("GroupLayer" === r2.layerType ? await w(t3, r2, a2) : b(r2) ? h(t3, r2, a2.context) : A(r2) && await C(t3, r2, a2.context)), await t(t3, a2.context), t3;
}
async function M(e3, n2) {
  ...
  if (b(e3)) {
    ...
    if (e3.itemId) {
      ...
      await i.load();
      const L = (await d(i, new e())).className || "UnknownLayer";
      S3 = a[L];
    }
...
async function C(e3, r2, t3) {
  var _a;
  const y = a.FeatureLayer, i = await y(), L = r2.featureCollection, o = L == null ? void 0 : L.showLegend, n2 = (_a = L == null ? void 0 : L.layers) == null ? void 0 : _a.map((a2, y2) => {
    const L2 = new i();
    L2.read(a2, t3);
    const n3 = { ...t3, ignoreDefaults: true };
    return F(L2, e3, r2, y2, n3), null != o && L2.read({ showLegend: o }, n3), L2;
  });
...
//# sourceMappingURL=chunk-R2DPWIJF.js.map
