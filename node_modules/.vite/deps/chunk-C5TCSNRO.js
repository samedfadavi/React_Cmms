...
async function b(e, t, n = true) {
  if (!t) return [];
  const { field: o, field2: i2, field3: s3, fieldDelimiter: u3, fieldInfos: a, timeZone: f2 } = e, m = o && (a == null ? void 0 : a.find((e2) => e2.name.toLowerCase() === o.toLowerCase())), y = !!m && be(m), g2 = !!m && Z(m), I2 = e.valueExpression, j3 = e.normalizationType, x2 = e.normalizationField, b2 = e.normalizationTotal, F = [], N = e.viewInfoParams;
  let E = null, v = null;
  if (I2) {
    if (!$) {
  ...
  return t.forEach((e2) => {
    ...
    let r2;
    if (I2) {
      const t3 = M ? { ...e2, layer: M } : e2, n2 = $.createExecContext(t3, v, f2);
...
//# sourceMappingURL=chunk-C5TCSNRO.js.map
