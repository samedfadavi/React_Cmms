...
var y = class _y {
  ...
  static findEffectOverrides(e, r) {
    if (!e) return null;
    if ("CIMGeometricEffectDashes" === e.type && D(e), !r || !e.primitiveName) return { type: "cim-effect-param", effect: e, overrides: [] };
    const i2 = H(e), t = e.primitiveName, c2 = [];
    for (const s4 of r) s4.primitiveName === t && c2.push(H(s4));
    return { type: "cim-effect-param", effect: i2, overrides: R(c2) };
  }
  static async resolveSymbolOverrides(e, r, t, s4, o3, a2, l2) {
    ...
    if (r || (r = { attributes: {} }, m2 = false), f) {
      if (m2 || (p = p.filter((e2) => {
        ...
        const e2 = { spatialReference: t, fields: F(r.attributes), geometryType: o3 };
        await _y.createRenderExpressions(p, e2), _y.evaluateOverrides(p, r, o3 ?? "esriGeometryPoint", a2, l2);
      }
...
//# sourceMappingURL=chunk-GMJ4G37M.js.map
