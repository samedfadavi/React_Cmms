...
var m = (() => {
  const e3 = /* @__PURE__ */ new Map(), t3 = new ResizeObserver((t4) => {
    var _a;
    t2();
    for (const n2 of t4) (_a = e3.get(n2.target)) == null ? void 0 : _a(n2);
  ...
  return (e4, t4, s) => {
    ...
    return o([d(() => "function" == typeof e4 ? e4() : e4, (e5) => {
      c2 == null ? void 0 : c2.remove(), e5 && (c2 = a(e5, t4, s));
    }, A), e(() => c2 == null ? void 0 : c2.remove())]);
  };
})();
function g(e3) {
  const t3 = e3 == null ? void 0 : e3.closest("[dir]");
...
var j = new Sanitizer({ whiteList: y, onTagAttr: (e3, t3, n2) => {
  const r = `${t3}="${n2}"`;
...
@esri/arcgis-html-sanitizer/dist/esm/index.js:
  ...
  ***************************************************************************** *)
*/
//# sourceMappingURL=chunk-KRKDK2RA.js.map
