...
var Notice = proxyCustomElement(class Notice2 extends H {
  ...
  render() {
    const { el } = this;
    const closeButton = h("button", { key: "4de511d4d93ee2078a4ed0d5fee2397d4d433691", "aria-label": this.messages.close, class: CSS.close, onClick: this.close, ref: (el2) => this.closeButton = el2 }, h("calcite-icon", { key: "bb983d2377b1f8c20b9d23cb63f258b4b6a670d9", icon: "x", scale: getIconScale(this.scale) }));
...
@esri/calcite-components/dist/components/calcite-notice.js:
   ...
   *)
*/
//# sourceMappingURL=calcite-notice-NY6XLCNV.js.map
