...
var a = class {
  ...
  finishFeatureResult(o2) {
    if (!(o2 == null ? void 0 : o2.features) || !o2.hasZ || !this._options.sourceSpatialReference || !o2.spatialReference || G(o2.spatialReference, this._options.sourceSpatialReference) || o2.spatialReference.vcsWkid) return;
...
function b(e4) {
  const t2 = 1, s3 = 2, r = 3, a3 = 4, n4 = 5, i2 = 6, l2 = e4.asUnsafe(), g2 = { type: o(0) };
...
function h(e4) {
  const t2 = 1, s3 = 2, r = 3, a3 = { originPosition: l(0) }, n4 = e4.asUnsafe();
  for (; n4.next(); ) switch (n4.tag()) {
    case t2:
...
//# sourceMappingURL=chunk-F6WID7U3.js.map
