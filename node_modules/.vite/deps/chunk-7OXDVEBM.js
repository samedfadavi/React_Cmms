...
var p;
function f(m3) {
  return null === m3 ? null : X(m3) ? m3.clone() : Y(m3) ? m3 : q(m3) ? m3.clone() : Q(m3) ? m3.toArray().map((a2) => f(a2)) : U(m3) ? m3.map((a2) => f(a2)) : H(m3) ? p.createFromArcadeFeature(m3) : W(m3) || B(m3) ? m3 : K(m3) || "esri.arcade.Attachment" === (m3 == null ? void 0 : m3.declaredClass) ? m3.deepClone() : ("esri.arcade.Portal" === (m3 == null ? void 0 : m3.declaredClass) || $(m3) || m3 instanceof s || _(m3), m3);
}
...
var N = class _N {
  ...
  castAsJson(t2 = null) {
    ...
    for (let i in this.attributes) {
      ...
      void 0 !== e && ((t2 == null ? void 0 : t2.keyTranslate) && (i = t2.keyTranslate(i)), s2[i] = Ie(e, t2));
    }
    return s2;
  }
  ...
  async castAsJsonAsync(s2 = null, i = null) {
    ...
    for (let n2 in this.attributes) {
      ...
      (i == null ? void 0 : i.keyTranslate) && (n2 = i.keyTranslate(n2)), void 0 !== o && (Y(o) || o instanceof n || o instanceof m ? e[n2] = Ie(o, i) : r2.push(this.castDictionaryValueAsJsonAsync(e, n2, o, s2, i)));
    }
...
//# sourceMappingURL=chunk-7OXDVEBM.js.map
