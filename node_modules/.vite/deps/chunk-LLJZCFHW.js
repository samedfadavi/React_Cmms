...
} } } })], p.prototype, "onFields", void 0), e([y({ type: String, json: { write: true } })], p.prototype, "operator", void 0), e([y({ type: String, json: { write: true } })], p.prototype, "searchTerm", void 0), e([y({ type: String, json: { write: true } })], p.prototype, "searchType", void 0), p = e([a2("esri.rest.support.FullTextSearch")], p);
var i2 = p;

// ../node_modules/@arcgis/core/rest/support/QuantizationParameters.js
var n3;
var c2 = new n({ upperLeft: "upper-left", lowerLeft: "lower-left" });
var m = n3 = class extends f {
  constructor(e2) {
    super(e2), this.extent = null, this.mode = "view", this.originPosition = "upper-left", this.tolerance = 1;
  }
  clone() {
    return new n3(a({ extent: this.extent, mode: this.mode, originPosition: this.originPosition, tolerance: this.tolerance }));
  }
};
e([y({ type: w, json: { write: { overridePolicy() {
...
var s2 = new n({ esriSpatialRelIntersects: "intersects", esriSpatialRelContains: "contains", esriSpatialRelCrosses: "crosses", esriSpatialRelDisjoint: "disjoint", esriSpatialRelEnvelopeIntersects: "envelope-intersects", esriSpatialRelIndexIntersects: "index-intersects", esriSpatialRelOverlaps: "overlaps", esriSpatialRelTouches: "touches", esriSpatialRelWithin: "within", esriSpatialRelRelation: "relation" });

// ../node_modules/@arcgis/core/rest/support/StatisticDefinition.js
var c3;
var n4 = new n({ count: "count", sum: "sum", min: "min", max: "max", avg: "avg", stddev: "stddev", var: "var", exceedslimit: "exceedslimit", percentile_cont: "percentile-continuous", percentile_disc: "percentile-discrete", EnvelopeAggregate: "envelope-aggregate", CentroidAggregate: "centroid-aggregate", ConvexHullAggregate: "convex-hull-aggregate" });
var p2 = c3 = class extends f {
  constructor(t) {
...
} } } })], R.prototype, "fullText", void 0), e([y({ type: String, json: { write: true } })], R.prototype, "gdbVersion", void 0), e([y({ types: n2, json: { read: y2, write: true } })], R.prototype, "geometry", void 0), e([y({ type: Number, json: { write: true } })], R.prototype, "geometryPrecision", void 0), e([y({ type: [String], json: { write: true } })], R.prototype, "groupByFieldsForStatistics", void 0), e([y({ type: String, json: { write: true } })], R.prototype, "having", void 0), e([y({ type: Date })], R.prototype, "historicMoment", void 0), e([r("historicMoment")], R.prototype, "writeHistoricMoment", null), e([y({ type: Number, json: { write: true } })], R.prototype, "maxAllowableOffset", void 0), e([y({ type: Number, cast: (t) => t < 1 ? 1 : t > R.MAX_MAX_RECORD_COUNT_FACTOR ? R.MAX_MAX_RECORD_COUNT_FACTOR : t, json: { write: { overridePolicy: (t) => ({ enabled: t > 1 }) } } })], R.prototype, "maxRecordCountFactor", void 0), e([y({ type: ["xyFootprint"], json: { write: true } })], R.prototype, "multipatchOption", void 0), e([y({ type: Number, json: { read: { source: "resultRecordCount" } } })], R.prototype, "num", void 0), e([y({ json: { write: true } })], R.prototype, "objectIds", void 0), e([y({ type: [String], json: { write: true } })], R.prototype, "orderByFields", void 0), e([y({ type: [String], json: { write: true } })], R.prototype, "outFields", void 0), e([y({ type: f2, json: { name: "outSR", write: true } })], R.prototype, "outSpatialReference", void 0), e([y({ type: [m2], json: { write: { enabled: true, overridePolicy() {
  return { enabled: null != this.outStatistics && this.outStatistics.length > 0 };
} } } })], R.prototype, "outStatistics", void 0), e([y({ json: { write: true } })], R.prototype, "parameterValues", void 0), e([r("parameterValues")], R.prototype, "writeParameterValues", null), e([y({ type: _, json: { write: true } })], R.prototype, "pixelSize", void 0), e([y({ type: a3, json: { write: true } })], R.prototype, "quantizationParameters", void 0), e([y({ type: [Object], json: { write: true } })], R.prototype, "rangeValues", void 0), e([y({ type: String, json: { read: { source: "relationParam" }, write: { target: "relationParam", overridePolicy() {
  return { enabled: "relation" === this.spatialRelationship };
} } } })], R.prototype, "relationParameter", void 0), e([y({ type: String, json: { write: true } })], R.prototype, "resultType", void 0), e([y({ type: Boolean, json: { default: false, write: true } })], R.prototype, "returnCentroid", void 0), e([y({ type: Boolean, json: { default: false, write: true } })], R.prototype, "returnDistinctValues", void 0), e([y({ type: Boolean, json: { default: true, write: true } })], R.prototype, "returnExceededLimitFeatures", void 0), e([y({ type: Boolean, json: { write: true } })], R.prototype, "returnGeometry", void 0), e([y({ type: Boolean, json: { default: false, write: true } })], R.prototype, "returnQueryGeometry", void 0), e([y({ type: Boolean, json: { default: false, write: true } })], R.prototype, "returnM", void 0), e([y({ type: Boolean, json: { write: { overridePolicy: (t) => ({ enabled: t }) } } })], R.prototype, "returnZ", void 0), e([y({ type: f2, json: { write: true } })], R.prototype, "sourceSpatialReference", void 0), e([o(s2, { ignoreUnknown: false, name: "spatialRel" })], R.prototype, "spatialRelationship", void 0), e([y({ type: Number, json: { read: { source: "resultOffset" } } })], R.prototype, "start", void 0), e([r("start"), r("num")], R.prototype, "writeStart", null), e([y({ type: String, json: { write: true } })], R.prototype, "sqlFormat", void 0), e([y({ type: String, json: { write: true } })], R.prototype, "text", void 0), e([y({ type: c, json: { write: true } })], R.prototype, "timeExtent", void 0), e([y({ type: Boolean, json: { default: false, write: true } })], R.prototype, "timeReferenceUnknownClient", void 0), e([o(g2, { ignoreUnknown: false }), y({ json: { write: { overridePolicy(t) {
...
//# sourceMappingURL=chunk-LLJZCFHW.js.map
