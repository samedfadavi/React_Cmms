import {
  a as a4
} from "./chunk-M2ECAK4P.js";
import {
  o as o2
} from "./chunk-IXP7PIYV.js";
import {
  i
...
e([y()], m2.prototype, "description", void 0), e([y({ readOnly: true })], m2.prototype, "dimensions", void 0), e([y({ type: w, json: { name: "extent" } })], m2.prototype, "fullExtent", void 0), e([y()], m2.prototype, "fullExtents", void 0), e([y({ type: Number, json: { write: { enabled: false, overridePolicy: () => ({ ignoreOrigin: true, enabled: true }) } } })], m2.prototype, "id", null), e([y({ type: String, json: { name: "legendUrl", write: { ignoreOrigin: true } } })], m2.prototype, "legendUrl", void 0), e([o("legendUrl", ["legendUrl", "legendURL"])], m2.prototype, "readLegendUrl", null), e([y({ type: Boolean, json: { name: "showLegend", origins: { "web-map": { read: false, write: false }, "web-scene": { read: false, write: false } } } })], m2.prototype, "legendEnabled", void 0), e([y()], m2.prototype, "layer", void 0), e([y()], m2.prototype, "maxScale", void 0), e([y()], m2.prototype, "minScale", void 0), e([y({ readOnly: true })], m2.prototype, "effectiveScaleRange", null), e([y({ type: String, json: { write: { ignoreOrigin: true } } })], m2.prototype, "name", void 0), e([y()], m2.prototype, "parent", void 0), e([y({ type: Boolean, json: { read: { source: "showPopup" }, write: { ignoreOrigin: true, target: "showPopup" } } })], m2.prototype, "popupEnabled", void 0), e([y({ type: Boolean, json: { write: { ignoreOrigin: true } } })], m2.prototype, "queryable", void 0), e([y()], m2.prototype, "sublayers", void 0), e([s3("sublayers")], m2.prototype, "castSublayers", null), e([y({ type: [Number], json: { read: { source: "spatialReferences" } } })], m2.prototype, "spatialReferences", void 0), e([y({ type: String, json: { write: { ignoreOrigin: true } } })], m2.prototype, "title", void 0), e([y({ type: Boolean, value: true, json: { read: { source: "defaultVisibility" } } })], m2.prototype, "visible", null), m2 = h = e([a2("esri.layers.support.WMSSublayer")], m2);
var f4 = m2;

// ../node_modules/@arcgis/core/layers/support/wmsUtils.js
var u = { 84: 4326, 83: 4269, 27: 4267 };
function a5(n2) {
  if (!n2) return null;
  ...
  if (W.length) {
    const t3 = W.map((e2) => {
      const { extent: t4 } = e2;
      return E(t4) ? t4.map((e3) => e3.getTime()) : t4 == null ? void 0 : t4.map((e3) => [e3.min.getTime(), e3.max.getTime()]);
    }).flat(2).filter(O);
    P = { startTimeField: null, endTimeField: null, trackIdField: void 0, timeExtent: [Math.min(...t3), Math.max(...t3)] };
  }
  return { copyright: h3, description: N3, dimensions: $, extent: O3, fullExtents: _2, featureInfoFormats: k3, featureInfoUrl: j3, mapUrl: F2, maxWidth: A2, maxHeight: w3, maxScale: D2, minScale: X3, layers: q2, spatialReferences: B2, supportedImageFormatTypes: L, timeInfo: P, title: d4, version: c3 };
}
function c2(e2) {
...
function f5(e2) {
  var _a;
  let t3 = [];
  for (const n2 of e2) t3.push(n2), ((_a = n2.sublayers) == null ? void 0 : _a.length) && (t3 = t3.concat(f5(n2.sublayers)), delete n2.sublayers);
  return t3;
}
...
function g2(e2, t3, n2) {
  var _a;
  return ((_a = x2(e2, t3)) == null ? void 0 : _a.textContent) ?? n2;
}
function N2(e2, t3, n2) {
  ...
  const d4 = new f({ wkid: t3 });
  return new w({ xmin: a6, ymin: c3, xmax: m4, ymax: f6, spatialReference: d4 });
}
function y3(e2, t3) {
  const n2 = x2(t3, e2);
  if (n2) {
...
function b4(t3, n2) {
  ...
  if (!r2.length) {
    return h2("Format", x2(n2, t3)).map(({ textContent: e2 }) => e2).filter(O);
  }
  const i2 = [];
...
function S3(e2, t3, n2) {
  if (!e2) return null;
  const o3 = { id: n2.idCounter++, fullExtents: [], parentLayerId: null, queryable: "1" === e2.getAttribute("queryable"), spatialReferences: [], sublayers: null }, l4 = x2("LatLonBoundingBox", e2), a6 = x2("EX_GeographicBoundingBox", e2);
  let c3 = null;
  l4 && (c3 = N2(l4, 4326)), a6 && (c3 = new w(0, 0, 0, 0, new f({ wkid: 4326 })), c3.xmin = parseFloat(g2("westBoundLongitude", a6, "0")), c3.ymin = parseFloat(g2("southBoundLatitude", a6, "0")), c3.xmax = parseFloat(g2("eastBoundLongitude", a6, "0")), c3.ymax = parseFloat(g2("northBoundLatitude", a6, "0"))), l4 || a6 || (c3 = new w(-180, -90, 180, 90, new f({ wkid: 4326 }))), o3.minScale = A(e2, "MaxScaleDenominator", 0), o3.maxScale = A(e2, "MinScaleDenominator", 0);
  ...
  return Array.prototype.slice.call(e2.childNodes).forEach((e3) => {
    ...
    if ("Name" === e3.nodeName) o3.name = e3.textContent || "";
      ...
      const r2 = n3 == null ? void 0 : n3.indexOf(":");
      if (r2 && r2 > -1) {
  ...
  }), o3.extent = c3 == null ? void 0 : c3.toJSON(), o3.dimensions = h2("Dimension", e2).filter((e3) => e3.getAttribute("name") && e3.getAttribute("units") && e3.textContent).map((e3) => {
    ...
    if (C2({ name: t4, units: n3 })) {
      return { name: "time", units: "ISO8601", extent: R(r2), default: R(s5), multipleValues: o4, nearestValue: l5, current: u2 };
    }
    if (F({ name: t4, units: n3 })) {
      return { name: "elevation", units: n3, extent: I2(r2), unitSymbol: i2, default: I2(s5), multipleValues: o4, nearestValue: l5 };
    }
    return { name: t4, units: n3, extent: v2(r2), unitSymbol: i2, default: v2(s5), multipleValues: o4, nearestValue: l5 };
  }), o3;
}
function E(e2) {
...
function V2(e2) {
  ...
  if (!n2) return null;
  return { years: O2(n2[1]), months: O2(n2[2]), days: O2(n2[3]), hours: O2(n2[4]), minutes: O2(n2[5]), seconds: O2(n2[6]) };
}
function O2(e2) {
  if (!e2) return 0;
...
var Q = class extends l2(l3(f3(t(b3(j(S2(f2))))))) {
  ...
  load(e2) {
    ...
    return this.addResolvingPromise(this.loadFromPortal({ supportedTypes: ["WMS"] }, e2).catch(a3).then(() => this._fetchService(t3))), Promise.resolve(this);
  }
  readFullExtentFromItemOrMap(e2, t3) {
    const r2 = t3.extent;
    return r2 ? new w({ xmin: r2[0][0], ymin: r2[0][1], xmax: r2[1][0], ymax: r2[1][1] }) : null;
  }
  ...
  writeSublayers(e2, t3, r2, o3) {
    var _a, _b;
    t3.layers = [];
    const s5 = /* @__PURE__ */ new Map(), i2 = e2.flatten(({ sublayers: e3 }) => e3 ?? []);
    ...
    for (const a6 of i2) {
      const e3 = { sublayer: a6, ...o3 }, r3 = a6.write({ parentLayerId: "number" == typeof ((_b = a6.parent) == null ? void 0 : _b.id) ? a6.parent.id : -1 }, e3);
  ...
  createExportImageParameters(e2, t3, r2, o3) {
    const s5 = (o3 == null ? void 0 : o3.pixelRatio) ?? 1, i2 = i({ extent: e2, width: t3 }) * s5, a6 = new a4({ layer: this, scale: i2 }), { xmin: n2, ymin: l4, xmax: p3, ymax: m4, spatialReference: u2 } = e2, c3 = D(u2, this.spatialReferences), f6 = "1.3.0" === this.version && o2(c3) ? `${l4},${n2},${m4},${p3}` : `${n2},${l4},${p3},${m4}`, y4 = a6.toJSON(), d4 = "1.3.0" === this.version ? "crs" : "srs";
    return { bbox: f6, [d4]: null == c3 || isNaN(c3) ? void 0 : "EPSG:" + c3, ...y4 };
  }
  async fetchImage(e2, t3, r2, o3) {
    ...
    const n2 = k2(o3 == null ? void 0 : o3.timeExtent), l4 = { responseType: "image", query: this._mixCustomParameters({ width: t3, height: r2, ...a6, time: n2, ...this.refreshParameters }), signal: o3 == null ? void 0 : o3.signal };
    return U(i2 ?? "", l4).then((e3) => e3.data);
  }
  async fetchImageBitmap(e2, t3, r2, o3) {
    const i2 = this.mapUrl ?? "", a6 = this.createExportImageParameters(e2, t3, r2, o3);
    if (!a6.layers) {
      const e3 = document.createElement("canvas");
      return e3.width = t3, e3.height = r2, e3;
    }
    const n2 = k2(o3 == null ? void 0 : o3.timeExtent), l4 = { responseType: "blob", query: this._mixCustomParameters({ width: t3, height: r2, ...a6, time: n2, ...this.refreshParameters }), signal: o3 == null ? void 0 : o3.signal }, { data: p3 } = await U(i2, l4);
    return t2(p3, i2, o3 == null ? void 0 : o3.signal);
  }
  fetchFeatureInfo(e2, t3, r2, o3, s5) {
    const i2 = i({ extent: e2, width: t3 }), a6 = new a4({ layer: this, scale: i2 }), n2 = c2(a6.visibleSublayers);
    ...
    const l4 = "1.3.0" === this.version ? { I: o3, J: s5 } : { x: o3, y: s5 }, p3 = { query_layers: n2, request: "GetFeatureInfo", info_format: this.featureInfoFormat, feature_count: 25, width: t3, height: r2, ...l4 }, m4 = { ...this.createExportImageParameters(e2, t3, r2), ...p3 }, u2 = this._mixCustomParameters(m4);
  ...
  _defaultFetchFeatureInfoFunction(e2) {
    ...
    const s5 = new k({ title: this.title, content: t3 }), i2 = new d2({ sourceLayer: this, popupTemplate: s5 });
    return Promise.resolve([i2]);
  }
  async _fetchService(e2) {
    var _a;
    if (!this.resourceInfo && ((_a = this.parsedUrl) == null ? void 0 : _a.path)) {
      const { path: t3, query: r2 } = this.parsedUrl, { data: o3 } = await U(t3, { query: { SERVICE: "WMS", REQUEST: "GetCapabilities", ...r2, ...this.customParameters }, responseType: "xml", signal: e2 });
