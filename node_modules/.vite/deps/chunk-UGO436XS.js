...
Object.defineProperty(p, "className", { enumerable: true, configurable: true, writable: true, value: "PointedRectangle" }), Object.defineProperty(p, "classNames", { enumerable: true, configurable: true, writable: true, value: ze.classNames.concat([p.className]) });
var u = class extends si {
  ...
  _updateBackground() {
    ...
    if (e2) {
      ...
      let _ = this.get("pointTo", { x: r / 2, y: a / 2 }), f = _.x, m = _.y, v = this.get("pointerOrientation"), T = this.get("background"), y = 0, D = 0, k = 0;
...
Object.defineProperty(u, "className", { enumerable: true, configurable: true, writable: true, value: "Tooltip" }), Object.defineProperty(u, "classNames", { enumerable: true, configurable: true, writable: true, value: si.classNames.concat([u.className]) });

export {
  u
};
//# sourceMappingURL=chunk-UGO436XS.js.map
