...
async function a4(e2) {
  if (!e2) return;
  const a5 = e2.includes("-vector") ? e2.slice(0, e2.indexOf("-vector")) : e2.includes("-3d") ? e2.slice(0, e2.indexOf("-3d")) : e2, s3 = await h("esri/t9n/basemaps");
  return s3[e2] || s3[a5];
}
...
var x = _ = class extends u2(m) {
  ...
  write(e2, r2) {
    var _a;
    return e2 = e2 || {}, (r2 == null ? void 0 : r2.origin) || (r2 = { origin: "web-map", ...r2 }), super.write(e2, r2), !this.loaded && ((_a = this.resourceInfo) == null ? void 0 : _a.data.baseMapLayers) && (e2.baseMapLayers = this.resourceInfo.data.baseMapLayers.map((e3) => {
      const r3 = a(e3);
  ...
  async _loadFromSource(e2) {
    const { resourceInfo: r2, portalItem: t2, style: s3 } = this;
    s(e2);
    const a5 = [];
    if (r2) {
  ...
  async _loadLayersFromJSON(e2, r2, t2) {
    var _a, _b;
    const s3 = (_a = this.resourceInfo) == null ? void 0 : _a.context, a5 = ((_b = this.portalItem) == null ? void 0 : _b.portal) || (s3 == null ? void 0 : s3.portal) || null, o = U2[(s3 == null ? void 0 : s3.origin) || ""] ?? "web-map", { populateOperationalLayers: i2 } = await import("./layersCreator-YSCMKCBR.js"), n4 = [];
    if (s(t2), e2.baseMapLayers && Array.isArray(e2.baseMapLayers)) {
      const t3 = { context: { ...s3, origin: o, url: r2, portal: a5, layerContainerType: "basemap" }, defaultLayerType: "DefaultTileLayer" }, l = (e3) => "web-scene" === o && "ArcGISSceneServiceLayer" === e3.layerType || e3.isReference, p2 = i2(this.baseLayers, e2.baseMapLayers.filter((e3) => !l(e3)), t3);
      n4.push(p2);
  ...
  async _loadFromItem(e2, r2) {
    const t2 = await e2.load(r2), s3 = await t2.fetchData("json", r2), a5 = I(e2.itemUrl ?? "");
    return this._set("resourceInfo", { data: s3.baseMap ?? {}, context: { origin: M[e2.type || ""] ?? "web-map", portal: e2.portal || C.getDefault(), url: a5 } }), this.read(this.resourceInfo.data, this.resourceInfo.context), this.read({ spatialReference: s3.spatialReference }, this.resourceInfo.context), this.read({ title: e2.title, thumbnailUrl: e2.thumbnailUrl }, { origin: "portal-item", portal: e2.portal || C.getDefault(), url: a5 }), this._loadLayersFromJSON(this.resourceInfo.data, a5, r2);
  }
  async _loadFromStylesService(e2, t2) {
    const s3 = `${e2.serviceUrl}/${e2.id}`, a5 = (await U(s3, { query: { language: e2.getLanguageParamValue(), places: e2.places, worldview: e2.worldview }, signal: t2 == null ? void 0 : t2.signal })).data, o = I(s3);
    return this._set("resourceInfo", { data: a5.baseMap ?? {}, context: { origin: "web-map", url: o } }), this.read(this.resourceInfo.data, this.resourceInfo.context), this.read({ spatialReference: a5.spatialReference }, this.resourceInfo.context), this._loadLayersFromJSON(this.resourceInfo.data, o, t2);
  }
  static fromId(e2) {
    const r2 = s2[e2];
    return r2 ? r2.itemId ? new _({ portalItem: { id: r2.itemId, portal: { url: "https://www.arcgis.com" } } }) : _.fromJSON(r2, { origin: r2.is3d ? "web-scene" : "web-map" }) : null;
  }
};
e([y2({ json: { write: { ignoreOrigin: true, target: "baseMapLayers", writer(e2, r2, t2, s3) {
  this._writeBaseLayers(e2, r2, s3);
} }, origins: { "web-scene": { write: { ignoreOrigin: true, target: { baseMapLayers: { type: V } }, writer(e2, r2, t2, s3) {
  this._writeBaseLayers(e2, r2, s3);
} } } } } })], x.prototype, "baseLayers", null), e([y2({ type: String, json: { origins: { "web-scene": { write: true } } } })], x.prototype, "id", void 0), e([y2({ type: S2 })], x.prototype, "portalItem", void 0), e([y2()], x.prototype, "referenceLayers", null), e([y2({ readOnly: true })], x.prototype, "resourceInfo", void 0), e([y2({ type: f })], x.prototype, "spatialReference", void 0), e([y2({ type: i })], x.prototype, "style", void 0), e([y2()], x.prototype, "thumbnailUrl", void 0), e([y2({ type: String, json: { origins: { "web-scene": { write: { isRequired: true } } } } })], x.prototype, "title", void 0), e([r("title")], x.prototype, "writeTitle", null), x = _ = e([a2("esri.Basemap")], x);
...
//# sourceMappingURL=chunk-LVH66MEH.js.map
