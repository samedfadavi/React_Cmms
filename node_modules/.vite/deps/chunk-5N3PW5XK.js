...
var u3 = class extends f {
  ...
  get flatWebGLFunctionChain() {
    ...
    for (; r8 == null ? void 0 : r8.length; ) {
      s12.unshift(...r8);
      const t7 = [];
      for (let s13 = 0; s13 < r8.length; s13++) {
        const { parameters: e10 } = r8[s13], n22 = e10.rasters || e10.raster && [e10.raster];
        (n22 == null ? void 0 : n22.length) && t7.push(...n22);
      }
      r8 = t7;
    }
    ...
    const i29 = s12.some(({ name: t7 }) => a6.has(t7.toLowerCase())), { rawSourceRasterInfos: o11 } = this;
    return { functions: s12, hasBranches: n21, hasFocalFunction: i29, isSourceSingleBand: 1 === ((_a = o11 == null ? void 0 : o11[0]) == null ? void 0 : _a.bandCount) };
  }
  ...
  _getSourceRasterInfos(t6) {
    const s12 = this._getRasterValues(), { rasterInfos: e9, rasterIds: r8 } = t6;
  ...
  _readRasterValue(t6, s12) {
    ...
    if ("number" == typeof t6) {
      ...
      const { width: r8, height: n21, pixelType: o11 } = s13, a28 = new Float32Array(r8 * n21);
      a28.fill(t6);
      const u18 = this.sourceRasterInfos[0].bandCount, p22 = new Array(u18).fill(a28);
      return new g({ width: r8, height: n21, pixelType: o11, pixels: p22 });
    }
  ...
  _patchRasterInfo() {
    ...
    const { bandCount: s12, keyProperties: e9, statistics: r8, histograms: n21 } = t6, i29 = e9.BandProperties;
    i29 && i29.length !== s12 && (t6.keyProperties = { ...e9, BandProperties: void 0 }), r8 && r8.length !== s12 && (t6.statistics = r8.length > s12 ? r8.slice(0, s12) : null), n21 && n21.length !== s12 && (t6.histograms = n21.length > s12 ? n21.slice(0, s12) : null), e9.BAND_COUNT && Number(e9.BAND_COUNT) !== s12 && (t6.keyProperties = { ...e9, BAND_COUNT: "string" == typeof e9.BAND_COUNT ? String(s12) : s12 });
  }
};
...
function pt(o11, s12, l18 = {}) {
  ...
  const { outputPixelType: i29 = "f32" } = l18, u18 = !ut.has(s12) || l18.processAsMultiband, h6 = u18 ? o11[0].pixels.length : 1, g6 = [];
  ...
  const p22 = o11[0];
  return new g({ width: p22.width, height: p22.height, pixelType: i29, mask: s12 === u4.isNull ? null : c32, pixels: g6 });
}
function mt(t6, e9, n21) {
  return pt(t6, e9 = [null, 1, 2, 3, 23, 5, 44][e9] ?? 1, { outputPixelType: n21 });
}
...
var p8 = class extends p5 {
  ...
  _processPixels(t6) {
    ...
    return null == (e9 == null ? void 0 : e9[0]) || null == (e9 == null ? void 0 : e9[1]) ? null : mt(e9, this.functionArguments.operation, this.outputPixelType);
  }
  _getWebGLParameters() {
    const { operation: t6 } = this.functionArguments, e9 = ["", "plus", "minus", "times", "divide", "power", "mod"][t6], r8 = this.outputPixelType ?? "f32";
    let [i29, n21] = s3(r8);
    const u18 = i(r8);
    return u18 && (i29 -= 1e-4, n21 += 1e-4), { imageCount: 2, operationName: e9, domainRange: [i29, n21], isOutputRounded: u18 };
  }
};
...
var n5 = class extends p5 {
  ...
  _bindSourceRasters() {
    ...
    const s12 = t6.clone();
    return s12.pixelType = this.outputPixelType, s12.statistics = [{ min: -1, max: 360, avg: 180, stddev: 30 }], s12.histograms = null, s12.colormap = null, s12.attributeTable = null, s12.bandCount = 1, this.rasterInfo = s12, { success: true, supportsGPU: true };
  }
  _processPixels(t6) {
    var _a;
    const s12 = (_a = t6.pixelBlocks) == null ? void 0 : _a[0];
    if (null == s12) return null;
    const { extent: e9, primaryPixelSizes: r8 } = t6, o11 = r8 == null ? void 0 : r8[0], n21 = o11 ?? (e9 ? { x: e9.width / s12.width, y: e9.height / s12.height } : { x: 1, y: 1 });
    return u2(s12, { resolution: n21 });
  }
};
e([y({ json: { write: true, name: "rasterFunction" } })], n5.prototype, "functionName", void 0), e([y({ type: c5, json: { write: true, name: "rasterFunctionArguments" } })], n5.prototype, "functionArguments", void 0), e([y()], n5.prototype, "rasterArgumentNames", void 0), e([y({ json: { write: true } })], n5.prototype, "isGCS", void 0), n5 = e([a2("esri.layers.support.rasterFunctions.AspectFunction")], n5);
var p9 = n5;
...
function t2(t6, r8) {
  ...
  return a28.length && s12.push(n6(a28, r8)), { ops: o11, nums: s12 };
}
function n6(e9, t6) {
...
function o4(e9) {
  ...
  return { opIndex: l18, numIndex: l18 - o11 };
}
function s5(e9, n21, s12) {
  let a28, { ops: i29, nums: f6 } = t2(s12, n21);
  if (0 === i29.length) {
  ...
  for (; i29.length > 0; ) {
    const { numIndex: t6, opIndex: n22 } = o4(i29);
...
function a9(n21, o11) {
  ...
  const { equation: a28, method: s12 } = o11, i29 = o11.bandIndexes.map((n22) => n22 - 1), { pixels: x4, mask: j3 } = n21;
  let q2;
  switch (s12) {
    case "gndvi":
    case "nbr":
  ...
  const U2 = new g({ width: n21.width, height: n21.height, pixelType: "f32", pixels: q2, mask: M4 });
  return U2.updateStatistics(), U2;
}
function s6(n21, e9, r8, o11) {
  const { mask: a28, pixels: s12, width: i29, height: l18 } = n21, c32 = s12[r8], u18 = s12[e9], f6 = u18.length, w7 = o11 ? new Uint8Array(f6) : new Float32Array(f6), h6 = o11 ? 100 : 1, m12 = o11 ? 100.5 : 0;
  for (let t6 = 0; t6 < f6; t6++) if (null == a28 || a28[t6]) {
    const n22 = c32[t6], e10 = u18[t6], r9 = n22 + e10;
    r9 && (w7[t6] = (n22 - e10) / r9 * h6 + m12);
  }
  const d8 = new g({ width: i29, height: l18, mask: a28, pixelType: o11 ? "u8" : "f32", pixels: [w7] });
...
var c7 = class extends p5 {
  ...
  _bindSourceRasters() {
    ...
    const s12 = e9.clone();
    s12.pixelType = this.outputPixelType, s12.bandCount = "sultan" === this.functionArguments.method ? 3 : 1, this._removeStatsHistColormapVAT(s12), s12.keyProperties = { ...s12.keyProperties, BandProperties: void 0 }, this.rasterInfo = s12;
    return { success: true, supportsGPU: !["custom", "gvitm", "sultan"].includes(this.functionArguments.method) };
  }
  _processPixels(e9) {
    var _a;
    const s12 = (_a = e9.pixelBlocks) == null ? void 0 : _a[0];
    if (null == s12) return s12;
    const { method: t6, bandIndexes: r8 } = this.functionArguments, i29 = r8.split(" ").map((e10) => parseFloat(e10));
    return a9(s12, { method: t6, bandIndexes: i29, equation: r8 });
  }
  _getWebGLParameters() {
    ...
    let t6, r8;
    const n21 = new Float32Array(3), { method: a28 } = this.functionArguments;
    switch (a28) {
      case "gndvi":
      case "nbr":
      case "ndbi":
    ...
    return { bandIndexMat3: t6, indexType: r8, adjustments: n21 };
  }
  _getInputBandIds(e9) {
...
e([y({ json: { write: true, name: "rasterFunction" } })], c7.prototype, "functionName", void 0), e([y({ type: a10, json: { write: true, name: "rasterFunctionArguments" } })], c7.prototype, "functionArguments", void 0), e([y()], c7.prototype, "rasterArgumentNames", void 0), c7 = e([a2("esri.layers.support.rasterFunctions.BandArithmeticFunction")], c7);
var u7 = c7;
...
e([y({ types: n2, json: { read: y2, write: true } })], m5.prototype, "clippingGeometry", void 0), e([y({ json: { read: n7.read, write: n7.write } })], m5.prototype, "clippingType", void 0), m5 = c8 = e([a2("esri.layers.support.rasterFunctions.ClipFunctionArguments")], m5);
var a11 = m5;
...
function e6(t6, o11) {
  const e9 = [], n21 = [];
  for (let r8 = 0; r8 < t6.length - 1; r8++) e9.push({ type: "algorithmic", algorithm: "esriHSVAlgorithm", fromColor: t6[r8].slice(1), toColor: t6[r8 + 1].slice(1) }), n21.push(t6[r8 + 1][0] - t6[r8][0]);
  const s12 = t6[t6.length - 1][0];
  return w3({ type: "multipart", colorRamps: e9 }, { numColors: s12, weights: o11 = o11 ?? n21 });
}
function n8() {
...
var m6 = class extends p5 {
  ...
  _bindSourceRasters() {
    ...
    let { colormap: r8, colormapName: t6, colorRamp: s12, colorRampName: e9 } = this.functionArguments;
    if (!(r8 == null ? void 0 : r8.length)) if (s12) this.colorRamp = s12, r8 = B(s12, { interpolateAlpha: true });
    else if (e9) {
      const o12 = c2(e9);
      o12 && (r8 = B(o12), this.colorRamp = p(o12));
    } else t6 && (r8 = c9(t6));
    if (!(r8 == null ? void 0 : r8.length)) return { success: false, supportsGPU: false, error: "colormap-function: missing colormap argument" };
    const p22 = this._getOutputPixelType(o11.pixelType);
    this.outputPixelType = p22.startsWith("f") ? "s32" : p22;
    const m12 = o11.clone();
    return m12.pixelType = this.outputPixelType, m12.colormap = r8, m12.bandCount = 1, this.rasterInfo = m12, { success: true, supportsGPU: true };
  }
  _processPixels(o11) {
    var _a;
    let r8 = (_a = o11.pixelBlocks) == null ? void 0 : _a[0];
    return !r8 || i(r8.pixelType) || (r8 = r8.clone(), r8.clamp(this.outputPixelType)), r8;
  }
};
e([y({ json: { write: true, name: "rasterFunction" } })], m6.prototype, "functionName", void 0), e([y({ type: d4, json: { write: true, name: "rasterFunctionArguments" } })], m6.prototype, "functionArguments", void 0), e([y()], m6.prototype, "rasterArgumentNames", void 0), e([y()], m6.prototype, "isNoopProcess", void 0), e([y({ json: { write: true } })], m6.prototype, "indexedColormap", void 0), e([y()], m6.prototype, "colorRamp", void 0), m6 = e([a2("esri.layers.support.rasterFunctions.ColormapFunction")], m6);
var u9 = m6;
...
e([y({ json: { write: true } })], c10.prototype, "rasters", void 0), e([r("rasters")], c10.prototype, "writeRasters", null), c10 = a13 = e([a2("esri.layers.support.rasterFunctions.CompositeBandFunctionArguments")], c10);
var i10 = c10;
...
var i11 = class extends p5 {
  ...
  _bindSourceRasters() {
    const { sourceRasterInfos: t6 } = this, e9 = t6[0];
    this.outputPixelType = this._getOutputPixelType(e9.pixelType);
    const s12 = e9.clone();
    if (s12.attributeTable = null, s12.colormap = null, s12.pixelType = this.outputPixelType, s12.bandCount = t6.map(({ bandCount: t7 }) => t7).reduce((t7, e10) => t7 + e10), t6.every(({ statistics: t7 }) => null != t7 && t7.length)) {
      const e10 = [];
      t6.forEach(({ statistics: t7 }) => null != t7 && e10.push(...t7)), s12.statistics = e10;
    }
    if (t6.every(({ histograms: t7 }) => null != t7 && t7.length)) {
      const e10 = [];
      t6.forEach(({ histograms: t7 }) => null != t7 && e10.push(...t7)), s12.histograms = e10;
    }
    s12.bandCount > 1 && (s12.colormap = null, s12.attributeTable = null);
    const r8 = t6.every((t7) => {
      var _a;
      return (_a = t7.keyProperties.BandProperties) == null ? void 0 : _a.length;
    }) ? t6.flatMap((t7) => t7.keyProperties.BandProperties) : void 0;
    s12.keyProperties = { ...s12.keyProperties, BandProperties: r8 }, this.rasterInfo = s12;
    return { success: true, supportsGPU: s12.bandCount <= 3 };
  }
  _processPixels(t6) {
    const { pixelBlocks: e9 } = t6;
    if (!e9) return null;
    const s12 = e9 == null ? void 0 : e9[0];
...
function i12(e9, n21, s12, i29) {
  const [f6, h6] = e9, m12 = i(s12) && !i(f6.pixelType) && !i(h6.pixelType), p22 = [f6.mask, h6.mask].filter((e10) => e10), u18 = g.combineBandMasks(p22), g6 = e9.map((e10) => e10.pixels[0]), { width: k4, height: x4 } = f6, b3 = g.createEmptyBand(s12, k4 * x4);
  switch (n21) {
    case "difference":
    case "relative-difference":
      o8({ bands: g6, mask: u18, outBand: b3, isRoundingNeeded: m12, isRelative: "relative-difference" === n21 });
      break;
    case "categorical":
      c11({ bands: g6, mask: u18, outBand: b3, ...i29 });
      break;
    case "euclidean-distance":
      l8({ pixels: e9.map((e10) => e10.pixels), mask: u18, outBand: b3 });
      break;
    case "angle-difference":
      r4({ pixels: e9.map((e10) => e10.pixels), mask: u18, outBand: b3 });
      break;
    case "band-with-most-change":
      d5({ pixels: e9.map((e10) => e10.pixels), mask: u18, outBand: b3 });
  }
  const B4 = new g({ width: k4, height: x4, pixels: [b3], pixelType: s12, mask: u18 });
  return B4.updateStatistics(), B4;
}
function o8(e9) {
  const { bands: [t6, a28], mask: n21, isRelative: s12, isRoundingNeeded: i29, outBand: o11 } = e9, c32 = t6.length;
...
function c11(e9) {
  const { bands: [t6, a28], categoryIndexLookups: [n21, s12], classNames: [i29, o11], mask: c32, keepMethod: l18, outBand: r8 } = e9, d8 = t6.length, f6 = i29.length, h6 = o11.length, m12 = f6 * h6, p22 = m12 + 1, u18 = m12 + 2;
...
function l8(e9) {
  const { pixels: [t6, a28], mask: n21, outBand: s12 } = e9, i29 = t6[0].length, o11 = t6.length;
...
var c12 = i13 = class extends p4 {
  ...
  clone() {
    return new i13({ raster: this.raster, raster2: this.raster2, method: this.method, keepMethod: this.keepMethod });
  }
};
e([o2(n9)], c12.prototype, "method", void 0), e([o2(s8)], c12.prototype, "keepMethod", void 0), e([y({ json: { write: true } })], c12.prototype, "raster2", void 0), e([y({ readOnly: true })], c12.prototype, "rasters", null), c12 = i13 = e([a2("esri.layers.support.rasterFunctions.ComputeChangeFunctionArguments")], c12);
var n10 = c12;
...
var l9 = class extends p5 {
  ...
  _bindSourceRasters() {
    ...
    if (this.outputPixelType = this._getOutputPixelType(t6.pixelType), t6.pixelType = this.outputPixelType, this._removeStatsHistColormapVAT(t6), "categorical" === e9) {
      ...
      if (null == s12[0] || null == s12[1] || null == r8[0] || null == r8[1]) return { success: false, supportsGPU: false, error: "both inputs must have proper attribute table with value and class fields" };
  ...
  _getWebGLParameters() {
    ...
    let [t6, s12] = s3(e9);
    const r8 = i(e9);
    return r8 && (t6 -= 1e-4, s12 += 1e-4), { method: this.functionArguments.method, domainRange: [t6, s12], isOutputRounded: r8 };
  }
  _updateAttributeTable(e9, t6, s12) {
    ...
    }), { keepMethod: u18 } = this.functionArguments;
    this._categoryConfig = { categoryIndexLookups: i29, classNames: a28, keepMethod: u18 };
    const l18 = n21[0].clone();
    l18.fields = [new y3({ name: "OID", type: "oid" }), new y3({ name: "Value", type: "integer" }), new y3({ name: "ClassName", type: "string" }), new y3({ name: "Class_From", type: "string" }), new y3({ name: "Class_To", type: "string" })];
    ...
    g6 && (d8.push(...n21.map((e10, t7) => e10.features.map((e11) => [e11.attributes[m12[t7]], e11.attributes[p22[t7]], e11.attributes[c32[t7]]]))), l18.fields.push(new y3({ name: "Red", type: "integer" }), new y3({ name: "Green", type: "integer" }), new y3({ name: "Blue", type: "integer" })));
    ...
    for (let r8 = 0; r8 < y9; r8++) {
      ...
      for (let t7 = 0; t7 < C3; t7++) {
        ...
        const n22 = h6.clone();
        n22.attributes = { OID: b3++, Value: r8 * C3 + t7, ClassName: e10 === s13 ? e10 : `${e10} -> ${s13}`, Class_From: e10, Class_To: s13 }, g6 && (n22.attributes.Red = d8[0][r8][0] + d8[1][t7][0] >> 1, n22.attributes.Green = d8[0][r8][1] + d8[1][t7][1] >> 1, n22.attributes.Blue = d8[0][r8][2] + d8[1][t7][2] >> 1), f6.push(n22);
      }
    }
    if ("changed" === u18) {
      const e10 = h6.clone();
      e10.attributes = { OID: b3++, Value: y9 * C3 + 1, ClassName: "No Change", Class_From: "Same", Class_To: "Same" }, f6.push(e10);
    } else if ("unchanged" === u18) {
      const e10 = h6.clone();
      e10.attributes = { OID: b3++, Value: y9 * C3 + 2, ClassName: "Changed", Class_From: "Any", Class_To: "Any" }, f6.push(e10);
    }
...
e([y({ json: { write: true, name: "rasterFunction" } })], l9.prototype, "functionName", void 0), e([y({ type: n10, json: { write: true, name: "rasterFunctionArguments" } })], l9.prototype, "functionArguments", void 0), e([y()], l9.prototype, "rasterArgumentNames", void 0), e([y({ json: { write: true } })], l9.prototype, "_categoryConfig", void 0), l9 = e([a2("esri.layers.support.rasterFunctions.ComputeChangeFunction")], l9);
var m7 = l9;
...
e([y({ json: { write: true } })], n11.prototype, "contrastOffset", void 0), e([y({ json: { write: true } })], n11.prototype, "brightnessOffset", void 0), n11 = e7 = e([a2("esri.layers.support.rasterFunctions.ContrastBrightnessFunctionArguments")], n11);
var i14 = n11;
...
var u10 = class extends p5 {
  ...
  _bindSourceRasters() {
    ...
    return this.lookup = l2(o11, e9), { success: true, supportsGPU: true };
  }
  _processPixels(t6) {
    var _a;
    const s12 = (_a = t6.pixelBlocks) == null ? void 0 : _a[0];
...
e([y({ json: { write: true, name: "rasterFunction" } })], u10.prototype, "functionName", void 0), e([y({ type: i14, json: { write: true, name: "rasterFunctionArguments" } })], u10.prototype, "functionArguments", void 0), e([y()], u10.prototype, "rasterArgumentNames", void 0), e([y({ json: { write: true } })], u10.prototype, "lookup", void 0), u10 = e([a2("esri.layers.support.rasterFunctions.ContrastBrightnessFunction")], u10);
var p13 = u10;
  ...
  for (let o11 = 1; o11 < t6; o11++) {
    ...
    for (let l19 = 0; l19 < t6; l19++) {
      ...
      if (null == n22) if (0 === s12) {
        if (r8) return { separable: false, row: null, col: null };
      } else n22 = r8 / s12;
      else if (r8 / s12 !== n22) return { separable: false, row: null, col: null };
    }
    if (null == n22) return { separable: false, row: null, col: null };
    l18.push(n22);
  }
  return { separable: true, row: n21, col: l18 };
}
...
function i15(t6, l18, o11 = true) {
  const { pixels: r8, width: i29, height: a28, pixelType: h6, mask: c32 } = t6, p22 = r8.length, u18 = [], { kernel: f6, rows: g6, cols: m12 } = l18;
  for (let e9 = 0; e9 < p22; e9++) {
    const t7 = s9(r8[e9], i29, a28, g6, m12, c32, f6);
    o11 && o9(t7, i29, a28, g6, m12), u18.push(t7);
  }
  return new g({ width: i29, height: a28, pixelType: h6, pixels: u18, mask: c32 });
}
function a15(t6, l18, o11, s12 = true) {
  const { pixels: i29, width: a28, height: h6, pixelType: c32, mask: p22 } = t6, u18 = i29.length, f6 = [], g6 = l18.length, m12 = o11.length, x4 = Math.floor(g6 / 2), w7 = Math.floor(m12 / 2);
  ...
  return new g({ width: a28, height: h6, pixelType: c32, pixels: f6, mask: p22 });
}
function h5(e9, t6) {
  const n21 = o10(t6.kernel), l18 = false !== t6.mirrorEdges, r8 = n21.separable ? a15(e9, n21.row, n21.col, l18) : i15(e9, t6, l18), { outputPixelType: s12 } = t6;
...
e([y({ json: { type: Number, write: true } })], c13.prototype, "rows", void 0), e([y({ json: { type: Number, write: true } })], c13.prototype, "cols", void 0), e([y({ json: { name: "type", type: Number, write: true } })], c13.prototype, "convolutionType", null), e([y({ json: { type: [Number], write: true } })], c13.prototype, "kernel", void 0), c13 = p14 = e([a2("esri.layers.support.rasterFunctions.ConvolutionFunctionArguments")], c13);
var l11 = c13;
...
var l12 = class extends p5 {
  ...
  _bindSourceRasters() {
    const { convolutionType: t6, rows: e9, cols: o11, kernel: n21 } = this.functionArguments;
    if (!Object.values(l3).includes(t6)) return { success: false, supportsGPU: false, error: `convolution-function: the specified kernel type is not supported ${t6}` };
    if (t6 !== l3.none && e9 * o11 !== n21.length) return { success: false, supportsGPU: false, error: "convolution-function: the specified rows and cols do not match the length of the kernel" };
    ...
    return { success: true, supportsGPU: n21.length <= c14 };
  }
  _processPixels(t6) {
    var _a;
    const e9 = (_a = t6.pixelBlocks) == null ? void 0 : _a[0];
    if (null == e9 || this.functionArguments.convolutionType === l3.none) return e9;
    const { rows: o11, cols: n21 } = this.functionArguments, { _normalizedKernel: r8 } = this;
    return h5(e9, { kernel: r8, rows: o11, cols: n21, outputPixelType: this.outputPixelType });
  }
  _getWebGLParameters() {
...
e([y({ json: { write: true, name: "rasterFunction" } })], l12.prototype, "functionName", void 0), e([y({ type: l11, json: { write: true, name: "rasterFunctionArguments" } })], l12.prototype, "functionArguments", void 0), e([y()], l12.prototype, "rasterArgumentNames", void 0), e([y()], l12.prototype, "_normalizedKernel", null), l12 = e([a2("esri.layers.support.rasterFunctions.ConvolutionFunction")], l12);
var p15 = l12;
...
var i16 = c15 = class extends p4 {
  ...
  clone() {
    return new c15({ curvatureType: this.curvatureType, zFactor: this.zFactor, raster: this.raster });
  }
};
e([y({ json: { write: { target: "type" } } }), o2(u11)], i16.prototype, "curvatureType", void 0), e([o("curvatureType", ["type", "curvatureType"])], i16.prototype, "readCurvatureType", null), e([y({ type: Number, json: { write: true } })], i16.prototype, "zFactor", void 0), i16 = c15 = e([a2("esri.layers.support.rasterFunctions.CurvatureFunctionArguments")], i16);
var n12 = i16;
...
var u12 = class extends p5 {
  ...
  _processPixels(t6) {
    var _a;
    const r8 = (_a = t6.pixelBlocks) == null ? void 0 : _a[0];
    if (null == r8) return null;
    const { zFactor: e9, curvatureType: s12 } = this.functionArguments, { extent: o11, primaryPixelSizes: u18 } = t6, c32 = u18 == null ? void 0 : u18[0], a28 = c32 ?? (o11 ? { x: o11.width / r8.width, y: o11.height / r8.height } : { x: 1, y: 1 }), p22 = this.isGCS && e9 >= 1 ? e9 * n4 : e9;
    return f3(r8, { zFactor: p22, curvatureType: s12, resolution: a28 });
  }
  _getWebGLParameters() {
    const { zFactor: t6, curvatureType: r8 } = this.functionArguments;
    return { curvatureType: r8, zFactor: this.isGCS && t6 >= 1 ? t6 * n4 : t6 };
  }
};
e([y({ json: { write: true, name: "rasterFunction" } })], u12.prototype, "functionName", void 0), e([y({ type: n12, json: { write: true, name: "rasterFunctionArguments" } })], u12.prototype, "functionArguments", void 0), e([y()], u12.prototype, "rasterArgumentNames", void 0), e([y({ json: { write: true } })], u12.prototype, "isGCS", void 0), u12 = e([a2("esri.layers.support.rasterFunctions.CurvatureFunction")], u12);
var c16 = u12;
...
var i17 = a16 = class extends p4 {
  ...
  clone() {
    var _a, _b, _c;
    return new a16({ bandIds: (_a = this.bandIds) == null ? void 0 : _a.slice(), bandNames: (_b = this.bandNames) == null ? void 0 : _b.slice(), bandWavelengths: (_c = this.bandWavelengths) == null ? void 0 : _c.slice(), missingBandAction: this.missingBandAction, method: this.method, wavelengthMatchTolerance: this.wavelengthMatchTolerance });
  }
};
e([y({ json: { write: true } })], i17.prototype, "bandIds", void 0), e([y({ json: { write: true } })], i17.prototype, "bandNames", void 0), e([y({ json: { write: true } })], i17.prototype, "bandWavelengths", void 0), e([o2({ 0: "name", 1: "wavelength", 2: "id" })], i17.prototype, "method", void 0), e([y({ json: { write: true } })], i17.prototype, "missingBandAction", void 0), e([y({ json: { write: true } })], i17.prototype, "wavelengthMatchTolerance", void 0), i17 = a16 = e([a2("esri.layers.support.rasterFunctions.ExtractBandFunctionArguments")], i17);
var c17 = i17;
...
var i18 = class extends p5 {
  ...
  _bindSourceRasters() {
    var _a;
    const { functionArguments: t6, sourceRasterInfos: n21 } = this, e9 = n21[0], { method: s12, bandNames: r8, bandWavelengths: o11, bandIds: i29, missingBandAction: l18 } = t6, h6 = (r8 == null ? void 0 : r8.length) && ("name" === s12 || "id" !== s12 && !(i29 == null ? void 0 : i29.length)), m12 = (o11 == null ? void 0 : o11.length) && ("wavelength" === s12 || "id" !== s12 && !(i29 == null ? void 0 : i29.length)), p22 = l18 === l.fail, g6 = h6 ? u13(e9, r8) : m12 ? d6(e9, o11, this.functionArguments, p22) : c18(e9, i29, p22);
    if (null == g6) {
      return { success: false, supportsGPU: false, error: `extract-band-function: Invalid ${h6 ? "band names" : m12 ? "band wavelengths" : "band ids"} for the imagery data source` };
    }
    ...
    const { statistics: b3, histograms: x4 } = f6;
    ...
    let I2 = (_a = f6.keyProperties) == null ? void 0 : _a.BandProperties;
    (I2 == null ? void 0 : I2.length) && (I2 = g6.map((t7) => t7 >= I2.length ? I2[I2.length - 1] : I2[t7]), f6.keyProperties = { ...f6.keyProperties, BandProperties: I2 }), this.rasterInfo = f6;
    return { success: true, supportsGPU: f6.bandCount <= 3 };
  }
  _processPixels(t6) {
    var _a;
...
e([y({ json: { write: true, name: "rasterFunction" } })], i18.prototype, "functionName", void 0), e([y({ type: c17, json: { write: true, name: "rasterFunctionArguments" } })], i18.prototype, "functionArguments", void 0), e([y()], i18.prototype, "rasterArgumentNames", void 0), i18 = e([a2("esri.layers.support.rasterFunctions.ExtractBandFunction")], i18);
var l13 = i18;
function u13(t6, n21) {
...
function c18(t6, n21, e9) {
  ...
  return !(n21 == null ? void 0 : n21.length) || e9 && n21.some((t7) => t7 < 0 || t7 >= s12) ? null : n21;
}
function d6(t6, n21, { wavelengthMatchTolerance: e9 }, s12) {
  const { bandInfos: r8 } = t6, o11 = [];
  for (let i29 = 0; i29 < r8.length; i29++) {
    const { minWavelength: t7, maxWavelength: n22 } = r8[i29];
    if (!t7 || !n22) return null;
    o11.push({ minWavelength: t7, maxWavelength: n22 });
  }
  const a28 = [];
...
function i19(i29, s12, a28) {
  const { pixels: l18, width: n21, height: r8, mask: o11, bandMasks: h6 } = i29, p22 = n21 * r8, m12 = (h6 == null ? void 0 : h6.length) ? g.combineBandMasks(h6) : o11, f6 = Math.min(s12.length, l18.length), c32 = a28.startsWith("f"), d8 = !c32 && a28 !== i29.pixelType, [x4, g6] = s3(a28), k4 = g.createEmptyBand(a28, p22);
  ...
  const u18 = new g({ width: n21, height: r8, pixels: [k4], pixelType: a28, mask: m12 });
...
e([y({ type: [Number], json: { write: true } })], a17.prototype, "conversionParameters", void 0), a17 = t4 = e([a2("esri.layers.support.rasterFunctions.GrayscaleFunctionArguments")], a17);
var c19 = a17;
...
e([y({ json: { write: true, name: "rasterFunction" } })], i20.prototype, "functionName", void 0), e([y({ type: c19, json: { write: true, name: "rasterFunctionArguments" } })], i20.prototype, "functionArguments", void 0), e([y()], i20.prototype, "rasterArgumentNames", void 0), e([y()], i20.prototype, "_normalizedWeights", null), i20 = e([a2("esri.layers.support.rasterFunctions.GrayscaleFunction")], i20);
var u14 = i20;
...
var a18 = i21 = class extends p4 {
  ...
  clone() {
    return new i21({ operation: this.operation, processAsMultiband: this.processAsMultiband, rasters: a(this.rasters) });
  }
};
e([y({ json: { write: true } })], a18.prototype, "operation", void 0), e([y({ json: { write: true } })], a18.prototype, "rasters", void 0), e([r("rasters")], a18.prototype, "writeRasters", null), e([y({ json: { write: true } })], a18.prototype, "processAsMultiband", void 0), a18 = i21 = e([a2("esri.layers.support.rasterFunctions.LocalFunctionArguments")], a18);
var c20 = a18;
...
var m8 = class extends p5 {
  ...
  _bindSourceRasters() {
    ...
    const { operation: n21, rasters: r8 } = this.functionArguments, i29 = c4[n21];
    if (!(999 === i29 || r8.length === i29 || r8.length <= 1 && 1 === i29)) return { success: false, supportsGPU: false, error: `local-function: the length of functionArguments.rasters does not match operation's requirement: ${i29}` };
    const a28 = s12.clone();
    ...
    return { success: true, supportsGPU: 1 === a28.bandCount && i29 <= 3 && (n21 < 11 || n21 > 16) };
  }
  _processPixels(t6) {
    const { pixelBlocks: s12 } = t6;
    return null == s12 || s12.some((t7) => null == t7) ? null : pt(s12, this.functionArguments.operation, { processAsMultiband: this.functionArguments.processAsMultiband, outputPixelType: this.outputPixelType ?? void 0 });
  }
  _getWebGLParameters() {
    var _a;
    const { operation: t6 } = this.functionArguments, s12 = c4[t6], e9 = ((_a = Object.keys(c3).find((s13) => c3[s13] === t6)) == null ? void 0 : _a.toLowerCase()) ?? "undefined", i29 = this.outputPixelType ?? "f32";
    let [a28, u18] = s3(i29);
    const p22 = i(i29);
    return p22 && (a28 -= 1e-4, u18 += 1e-4), { imageCount: s12, operationName: e9, domainRange: [a28, u18], isOutputRounded: p22 };
  }
  _updateStatistics(t6) {
    var _a, _b;
    const s12 = this.sourceRasterInfos[0], { operation: e9 } = this.functionArguments, o11 = (_a = l4(e9)) == null ? void 0 : _a.domain;
    if (o11) {
      t6.statistics = [];
  ...
  _updatePixelType(t6) {
    const { statistics: s12, pixelType: e9 } = this.sourceRasterInfos[0], { operation: o11 } = this.functionArguments, { domain: n21, isInteger: a28 } = l4(o11) ?? { domain: null, isInteger: false };
    let u18 = "f32";
    if (n21 && a28) u18 = u(n21[0], n21[1]);
      ...
      const t7 = s12 == null ? void 0 : s12.map(({ max: t8 }) => -t8), o12 = s12 == null ? void 0 : s12.map(({ min: t8 }) => -t8), n22 = (t7 == null ? void 0 : t7.length) ? Math.min(...t7) : null, r8 = (o12 == null ? void 0 : o12.length) ? Math.min(...o12) : null;
...
e([y({ json: { write: true, name: "rasterFunction" } })], m8.prototype, "functionName", void 0), e([y({ type: c20, json: { write: true, name: "rasterFunctionArguments" } })], m8.prototype, "functionArguments", void 0), e([y()], m8.prototype, "rasterArgumentNames", void 0), m8 = e([a2("esri.layers.support.rasterFunctions.LocalFunction")], m8);
var d7 = m8;
...
e([y({ json: { write: true } })], a19.prototype, "includedRanges", void 0), e([y({ json: { write: true } })], a19.prototype, "noDataValues", void 0), e([y()], a19.prototype, "normalizedNoDataValues", null), e([y({ json: { write: true } })], a19.prototype, "noDataInterpretation", void 0), a19 = s10 = e([a2("esri.layers.support.rasterFunctions.MaskFunctionArguments")], a19);
var i22 = a19;
...
var c21 = class extends p5 {
  ...
  _bindSourceRasters() {
    ...
    for (let a28 = 0; a28 < t6.bandCount; a28++) {
      const t7 = w2(e9, s12 == null ? void 0 : s12.slice(2 * a28, 2 * a28 + 2), o11 == null ? void 0 : o11[a28]);
      if (null == t7) {
        r8 = null;
        break;
      }
    ...
    this.lookups = r8;
    const n21 = null != o11 && o11.every((t7) => {
      var _a;
      return (t7 == null ? void 0 : t7.length) === ((_a = o11[0]) == null ? void 0 : _a.length);
    });
    return { success: true, supportsGPU: (!s12 || s12.length <= 2 * i2) && (!o11 || n21 && o11[0].length <= i2) };
  }
  _processPixels(t6) {
    var _a;
    const e9 = (_a = t6.pixelBlocks) == null ? void 0 : _a[0];
    if (null == e9) return null;
    const { outputPixelType: s12, lookups: o11 } = this, { includedRanges: r8, noDataInterpretation: n21, normalizedNoDataValues: u18 } = this.functionArguments, a28 = n21 === n3.matchAll;
    return g2(e9, { includedRanges: r8, noDataValues: u18, outputPixelType: s12, matchAll: a28, lookups: o11 });
  }
  _getWebGLParameters() {
    var _a;
    const { includedRanges: t6, normalizedNoDataValues: s12 } = this.functionArguments, o11 = new Float32Array(i2);
    o11.fill(j), ((_a = s12 == null ? void 0 : s12[0]) == null ? void 0 : _a.length) && o11.set(s12[0]);
    const r8 = new Float32Array(i2);
    for (let n21 = 0; n21 < r8.length; n21 += 2) r8[n21] = (t6 == null ? void 0 : t6[n21]) ?? -j, r8[n21 + 1] = (t6 == null ? void 0 : t6[n21 + 1]) ?? j;
    return (t6 == null ? void 0 : t6.length) && r8.set(t6), { bandCount: this.sourceRasterInfos[0].bandCount, noDataValues: o11, includedRanges: r8 };
  }
};
e([y({ json: { write: true, name: "rasterFunction" } })], c21.prototype, "functionName", void 0), e([y({ type: i22, json: { write: true, name: "rasterFunctionArguments" } })], c21.prototype, "functionArguments", void 0), e([y()], c21.prototype, "rasterArgumentNames", void 0), e([y({ json: { write: true } })], c21.prototype, "lookups", void 0), c21 = e([a2("esri.layers.support.rasterFunctions.MaskFunction")], c21);
var p16 = c21;
...
var e8 = i23 = class extends p4 {
  ...
  clone() {
    const { visibleBandID: r8, infraredBandID: t6, scientificOutput: s12 } = this;
    return new i23({ visibleBandID: r8, infraredBandID: t6, scientificOutput: s12 });
  }
};
e([y({ json: { write: true } })], e8.prototype, "visibleBandID", void 0), e([y({ json: { write: true } })], e8.prototype, "infraredBandID", void 0), e([y({ json: { write: true } })], e8.prototype, "scientificOutput", void 0), e8 = i23 = e([a2("esri.layers.support.rasterFunctions.NDVIFunctionArguments")], e8);
var n13 = e8;
...
var u15 = class extends p5 {
  ...
  _bindSourceRasters() {
    const { scientificOutput: t6, visibleBandID: s12, infraredBandID: r8 } = this.functionArguments;
    ...
    return o11.statistics = [{ min: i29, max: u18, avg: a28, stddev: c32 }], this.rasterInfo = o11, { success: true, supportsGPU: true };
  }
  _processPixels(t6) {
    var _a;
    const s12 = (_a = t6.pixelBlocks) == null ? void 0 : _a[0];
    if (null == s12) return null;
    const { visibleBandID: r8, infraredBandID: n21, scientificOutput: o11 } = this.functionArguments;
    return s6(s12, r8, n21, !o11);
  }
  _getWebGLParameters() {
    const { visibleBandID: t6, infraredBandID: s12, scientificOutput: r8 } = this.functionArguments, e9 = this.isInputBandIdsSwizzled ? [0, 1, 2] : [s12, t6, 0];
    return { bandIndexMat3: i5(e9), scaled: !r8 };
  }
  _getInputBandIds(t6) {
    const { visibleBandID: s12, infraredBandID: r8 } = this.functionArguments;
    return [r8, s12, 0].map((s13) => t6[s13]);
  }
};
e([y({ json: { write: true, name: "rasterFunction" } })], u15.prototype, "functionName", void 0), e([y({ type: n13, json: { write: true, name: "rasterFunctionArguments" } })], u15.prototype, "functionArguments", void 0), e([y()], u15.prototype, "rasterArgumentNames", void 0), u15 = e([a2("esri.layers.support.rasterFunctions.NDVIFunction")], u15);
var a20 = u15;
...
e([y({ json: { write: true } })], a21.prototype, "inputRanges", void 0), e([y({ json: { write: true } })], a21.prototype, "outputValues", void 0), e([y({ json: { write: true } })], a21.prototype, "noDataRanges", void 0), e([y({ json: { write: true } })], a21.prototype, "allowUnmatched", void 0), e([y({ json: { write: true } })], a21.prototype, "isLastInputRangeInclusive", void 0), a21 = n14 = e([a2("esri.layers.support.rasterFunctions.RemapFunctionArguments")], a21);
var r6 = a21;
...
var m9 = class extends p5 {
  ...
  _bindSourceRasters() {
    ...
    const { statistics: s12 } = t6, { allowUnmatched: n21, outputValues: o11, inputRanges: a28, noDataRanges: i29, isLastInputRangeInclusive: l18 } = this.functionArguments;
    if (null != s12 && s12.length && (o11 == null ? void 0 : o11.length)) if (n21) {
      const e10 = Math.min.apply(null, [...o11, s12[0].min]), n22 = Math.max.apply(null, [...o11, s12[0].max]);
      t6.statistics = [{ ...s12[0], min: e10, max: n22 }];
    } else {
      let e10 = o11[0], n22 = e10;
      for (let t7 = 0; t7 < o11.length; t7++) e10 = e10 > o11[t7] ? o11[t7] : e10, n22 = n22 > o11[t7] ? n22 : o11[t7];
      t6.statistics = [{ ...s12[0], min: e10, max: n22 }];
    }
    this.rasterInfo = t6, this.lookup = n21 ? null : y5({ srcPixelType: e9, inputRanges: a28, outputValues: o11, noDataRanges: i29, allowUnmatched: n21, isLastInputRangeInclusive: l18, outputPixelType: this.outputPixelType });
    return { success: true, supportsGPU: (!o11 || o11.length <= i2) && (!i29 || i29.length <= i2) };
  }
  _processPixels(t6) {
    var _a;
    const e9 = (_a = t6.pixelBlocks) == null ? void 0 : _a[0];
    if (null == e9) return null;
    const { lookup: s12, outputPixelType: n21 } = this;
    if (s12) {
      const t7 = f2(e9, { lut: [s12.lut], offset: s12.offset, outputPixelType: n21 });
      return null != t7 && s12.mask && (t7.mask = c(e9.pixels[0], e9.mask, s12.mask, s12.offset, "u8")), t7;
    }
    const { inputRanges: o11, outputValues: a28, noDataRanges: u18, allowUnmatched: r8, isLastInputRangeInclusive: c32 } = this.functionArguments;
    return p2(e9, { inputRanges: o11, outputValues: a28, noDataRanges: u18, outputPixelType: n21, allowUnmatched: r8, isLastInputRangeInclusive: c32 });
  }
  _getWebGLParameters() {
    const { allowUnmatched: t6, noDataRanges: s12, isLastInputRangeInclusive: n21 } = this.functionArguments, a28 = new Float32Array(3 * i2), u18 = 1e-5, i29 = this.functionArguments.inputRanges ?? [], l18 = this.functionArguments.outputValues ?? [], p22 = l18.length;
    ...
    c32.fill(j), (s12 == null ? void 0 : s12.length) && c32.set(s12);
    return { allowUnmatched: t6, rangeMaps: a28, noDataRanges: c32, clampRange: s3(this.outputPixelType) };
  }
};
e([y({ json: { write: true, name: "rasterFunction" } })], m9.prototype, "functionName", void 0), e([y({ type: r6, json: { write: true, name: "rasterFunctionArguments" } })], m9.prototype, "functionArguments", void 0), e([y()], m9.prototype, "rasterArgumentNames", void 0), e([y({ json: { write: true } })], m9.prototype, "lookup", void 0), m9 = e([a2("esri.layers.support.rasterFunctions.RemapFunction")], m9);
var g5 = m9;

// ../node_modules/@arcgis/core/layers/support/rasterFunctions/SlopeFunctionArguments.js
var i24;
var c22 = new n({ 1: "degree", 2: "percent-rise", 3: "adjusted" }, { useNumericKeys: true });
var a22 = i24 = class extends p4 {
  ...
  clone() {
    return new i24({ slopeType: this.slopeType, zFactor: this.zFactor, pixelSizePower: this.pixelSizePower, pixelSizeFactor: this.pixelSizeFactor, removeEdgeEffect: this.removeEdgeEffect, raster: this.raster });
  }
};
e([o2(c22)], a22.prototype, "slopeType", void 0), e([y({ type: Number, json: { write: true } })], a22.prototype, "zFactor", void 0), e([y({ type: Number, json: { name: "psPower", write: true } })], a22.prototype, "pixelSizePower", void 0), e([y({ type: Number, json: { name: "psZFactor", write: true } })], a22.prototype, "pixelSizeFactor", void 0), e([y({ type: Boolean, json: { write: true } })], a22.prototype, "removeEdgeEffect", void 0), a22 = i24 = e([a2("esri.layers.support.rasterFunctions.SlopeFunctionArguments")], a22);
var m10 = a22;
...
var p17 = class extends p5 {
  ...
  _processPixels(e9) {
    ...
    const { zFactor: s12, slopeType: r8, pixelSizePower: o11, pixelSizeFactor: n21 } = this.functionArguments, { isGCS: p22 } = this, { extent: c32, primaryPixelSizes: u18 } = e9, a28 = u18 == null ? void 0 : u18[0], l18 = a28 ?? (c32 ? { x: c32.width / t6.width, y: c32.height / t6.height } : { x: 1, y: 1 });
    return h(t6, { zFactor: s12, slopeType: r8, pixelSizePower: o11, pixelSizeFactor: n21, isGCS: p22, resolution: l18 });
  }
  _getWebGLParameters() {
    const { zFactor: e9, slopeType: t6, pixelSizeFactor: s12, pixelSizePower: r8 } = this.functionArguments;
    return { zFactor: this.isGCS && e9 >= 1 ? e9 * n4 : e9, slopeType: t6, pixelSizeFactor: s12 ?? 0, pixelSizePower: r8 ?? 0 };
  }
};
e([y({ json: { write: true, name: "rasterFunction" } })], p17.prototype, "functionName", void 0), e([y({ type: m10, json: { write: true, name: "rasterFunctionArguments" } })], p17.prototype, "functionArguments", void 0), e([y()], p17.prototype, "rasterArgumentNames", void 0), e([y({ json: { write: true } })], p17.prototype, "isGCS", void 0), p17 = e([a2("esri.layers.support.rasterFunctions.SlopeFunction")], p17);
var c23 = p17;
...
function s11(t6, e9) {
  const { fillNoDataOnly: o11 } = e9, { band: n21, width: s12, height: r8, mask: i29, outBand: l18 } = t6;
  if (o11 && !i29) return void l18.set(n21);
  const { statisticsType: a28, kernelRows: c32, kernelCols: f6 } = e9, h6 = "stddev" === a28, m12 = s12 * r8, u18 = new Float64Array(m12), d8 = new Float64Array(m12), y9 = new Uint32Array(m12);
...
function r7(t6, e9) {
  const { fillNoDataOnly: o11 } = e9, { band: n21, width: s12, height: r8, mask: i29, outBand: l18 } = t6;
  if (o11 && !i29) return void l18.set(n21);
  const { kernelRows: a28, kernelCols: c32, statisticsType: f6 } = e9, h6 = Math.floor(a28 / 2), m12 = Math.floor(c32 / 2), u18 = "min" === f6, d8 = l18.slice(), y9 = new Uint32Array(s12 * r8);
...
function i25(t6, e9) {
  const { fillNoDataOnly: o11 } = e9, { band: n21, width: s12, height: r8, mask: i29, outBand: l18 } = t6;
  if (o11 && !i29) return void l18.set(n21);
  const { kernelRows: a28, kernelCols: c32 } = e9, f6 = Math.floor(a28 / 2), h6 = Math.floor(c32 / 2), m12 = l18.slice(), u18 = new Uint32Array(s12 * r8);
  for (let d8 = f6; d8 < r8 - f6; d8++) {
    const t7 = d8 * s12;
    for (let e10 = h6; e10 < s12 - h6; e10++) {
      if (o11 && (i29 == null ? void 0 : i29[t7 + e10])) continue;
      const r9 = [];
...
function l14(t6, e9) {
  const { fillNoDataOnly: o11 } = e9, { band: n21, width: s12, height: r8, mask: i29, outBand: l18 } = t6;
  if (o11 && !i29) return void l18.set(n21);
  const { kernelRows: a28, kernelCols: c32 } = e9, f6 = Math.floor(a28 / 2), h6 = Math.floor(c32 / 2), m12 = "majority" === e9.statisticsType, u18 = a28 * c32, d8 = l18.slice(), y9 = new Uint32Array(s12 * r8);
...
function a23(t6, n21) {
  const { mask: a28 } = t6, { fillNoDataOnly: c32 } = n21;
  if (c32 && !a28) return t6;
  const { pixels: f6, width: h6, height: m12, bandMasks: u18, pixelType: d8 } = t6, y9 = f6.length, k4 = h6 * m12, w7 = [], { kernelRows: p22, kernelCols: M4, statisticsType: g6, mirrorEdges: b3 } = n21;
  if (c32 && !a28) return t6;
  const A3 = n21.outputPixelType ?? d8, x4 = [];
  for (let N3 = 0; N3 < y9; N3++) {
    const t7 = f6[N3], d9 = g.createEmptyBand(A3, k4);
    c32 && d9.set(t7);
    const y10 = (u18 == null ? void 0 : u18[N3]) ?? a28, j4 = (y10 == null ? void 0 : y10.slice()) ?? null, B5 = { band: t7, width: h6, height: m12, mask: j4, outBand: d9 };
    switch (g6) {
      case "min":
      case "max":
        r7(B5, n21);
  ...
  let j3 = x4[0] ?? a28;
  x4.length !== y9 && (x4.length = 0), y9 > 1 && (u18 == null ? void 0 : u18.length) && (j3 = g.combineBandMasks(u18));
  const B4 = new g({ pixelType: A3, width: h6, height: m12, pixels: w7, bandMasks: u18 && x4.length ? x4 : null, mask: j3 });
  return B4.updateStatistics(), B4;
}
...
var p18 = c24 = class extends p4 {
  ...
  clone() {
    return new c24({ rows: this.rows, cols: this.cols, fillNoDataOnly: this.fillNoDataOnly, statisticsType: this.statisticsType, raster: a(this.raster) });
  }
};
e([y({ json: { write: true, read: { source: ["kernelRows", "rows"], reader: (s12, r8) => Number(s12 ?? (r8 == null ? void 0 : r8.kernelRows) ?? 3) } } })], p18.prototype, "rows", void 0), e([y({ json: { write: true, read: { source: ["kernelCols", "cols"], reader: (s12, r8) => Number(s12 ?? (r8 == null ? void 0 : r8.kernelCols) ?? 3) } } })], p18.prototype, "cols", void 0), e([y({ json: { write: true } })], p18.prototype, "fillNoDataOnly", void 0), e([y({ json: { read: { source: ["statisticsType", "type"], reader: (s12, r8) => n15.fromJSON((r8 == null ? void 0 : r8.statisticsType) ?? (r8 == null ? void 0 : r8.type)) ?? "min" }, write: { target: "type" } } }), o2(n15)], p18.prototype, "statisticsType", void 0), p18 = c24 = e([a2("esri.layers.support.rasterFunctions.StatisticsFunctionArguments")], p18);
var l15 = p18;
...
var c25 = class extends p5 {
  ...
  _processPixels(t6) {
    ...
    const s12 = (_a = t6.pixelBlocks) == null ? void 0 : _a[0];
    if (null == s12) return s12;
    const { statisticsType: e9, rows: o11, cols: r8, fillNoDataOnly: n21 } = this.functionArguments;
    return a23(s12, { kernelRows: o11, kernelCols: r8, fillNoDataOnly: n21, outputPixelType: this.outputPixelType, statisticsType: e9, mirrorEdges: true });
  }
  _getWebGLParameters() {
    const { rows: t6, cols: s12, statisticsType: e9, fillNoDataOnly: r8 } = this.functionArguments;
    return { fillNoDataOnly: r8, kernelRows: t6, kernelCols: s12, statisticsType: e9, clampRange: s3(this.outputPixelType) };
  }
};
e([y({ json: { write: true, name: "rasterFunction" } })], c25.prototype, "functionName", void 0), e([y({ type: l15, json: { write: true, name: "rasterFunctionArguments" } })], c25.prototype, "functionArguments", void 0), e([y()], c25.prototype, "rasterArgumentNames", void 0), c25 = e([a2("esri.layers.support.rasterFunctions.StatisticsFunction")], c25);
var p19 = c25;
...
var n16 = c26 = class extends p4 {
  ...
  clone() {
    return new c26({ statistics: a(this.statistics), histograms: a(this.histograms) });
  }
};
e([y({ json: { write: true } })], n16.prototype, "statistics", void 0), e([o("statistics")], n16.prototype, "readStatistics", null), e([r("statistics")], n16.prototype, "writeStatistics", null), e([y({ json: { write: true } })], n16.prototype, "histograms", void 0), n16 = c26 = e([a2("esri.layers.support.rasterFunctions.StatisticsHistogramFunctionArguments")], n16);
var p20 = n16;
...
var i26 = class extends p5 {
  ...
  _bindSourceRasters() {
    const t6 = this.sourceRasterInfos[0];
    this.outputPixelType = this._getOutputPixelType("u8");
    const s12 = t6.clone(), { statistics: o11, histograms: r8 } = this.functionArguments;
    return r8 && (s12.histograms = r8), o11 && (s12.statistics = o11), this.rasterInfo = s12, { success: true, supportsGPU: true };
  }
  _processPixels(t6) {
    var _a;
    return (_a = t6.pixelBlocks) == null ? void 0 : _a[0];
...
e([y({ json: { write: true, name: "rasterFunction" } })], i26.prototype, "functionName", void 0), e([y({ type: p20, json: { write: true, name: "rasterFunctionArguments" } })], i26.prototype, "functionArguments", void 0), e([y()], i26.prototype, "rasterArgumentNames", void 0), e([y({ json: { write: true } })], i26.prototype, "indexedColormap", void 0), e([y()], i26.prototype, "isNoopProcess", void 0), i26 = e([a2("esri.layers.support.rasterFunctions.StatisticsHistogramFunction")], i26);
var n17 = i26;
...
e([y({ type: Boolean, json: { write: true } })], c27.prototype, "computeGamma", void 0), e([y({ type: Boolean, json: { name: "dra", write: true } })], c27.prototype, "dynamicRangeAdjustment", void 0), e([y({ type: [Number], json: { write: true } })], c27.prototype, "gamma", void 0), e([y()], c27.prototype, "histograms", void 0), e([y({ type: Number, json: { write: true } })], c27.prototype, "maxPercent", void 0), e([y({ type: Number, json: { write: true } })], c27.prototype, "minPercent", void 0), e([y({ type: Number, json: { write: true } })], c27.prototype, "numberOfStandardDeviations", void 0), e([y({ type: Number, json: { name: "max", write: true } })], c27.prototype, "outputMax", void 0), e([y({ type: Number, json: { name: "min", write: true } })], c27.prototype, "outputMin", void 0), e([y({ type: Number, json: { write: true } })], c27.prototype, "sigmoidStrengthLevel", void 0), e([y({ json: { type: [[Number]], write: true } })], c27.prototype, "statistics", void 0), e([r("statistics")], c27.prototype, "writeStatistics", null), e([o2(p21)], c27.prototype, "stretchType", void 0), e([y({ type: Boolean, json: { write: true } })], c27.prototype, "useGamma", void 0), c27 = n18 = e([a2("esri.layers.support.rasterFunctions.StretchFunctionArguments")], c27);
var u16 = c27;
...
var c28 = class extends p5 {
  ...
  _bindSourceRasters() {
    ...
    const t6 = this.sourceRasterInfos[0], { pixelType: s12 } = t6, { functionArguments: e9 } = this, { dynamicRangeAdjustment: r8, gamma: u18, useGamma: i29 } = e9;
    if (!r8 && ["u8", "u16", "s8", "s16"].includes(s12)) {
      const r9 = p3(e9.toJSON(), { rasterInfo: t6 }), p23 = i(this.outputPixelType) ? "round" : "float";
      this.lookup = a4({ pixelType: s12, ...r9, gamma: i29 ? u18 : null, rounding: p23 }), this.cutOffs = r9;
    } else r8 || (this.cutOffs = p3(e9.toJSON(), { rasterInfo: t6 }));
    ...
    const { outputMin: m12 = 0, outputMax: c32 = 255 } = this.functionArguments;
    p22.statistics = [];
    for (let o11 = 0; o11 < p22.bandCount; o11++) p22.statistics[o11] = { min: m12, max: c32 };
    this.rasterInfo = p22;
    return { success: true, supportsGPU: !r8 };
  }
  _processPixels(t6) {
    var _a;
    const s12 = (_a = t6.pixelBlocks) == null ? void 0 : _a[0];
    ...
    const { functionArguments: o11 } = this, r8 = this.cutOffs || p3(o11.toJSON(), { rasterInfo: this.sourceRasterInfos[0], pixelBlock: s12 }), i29 = o11.useGamma ? o11.gamma : null;
    return M(s12, { ...r8, gamma: i29, outputPixelType: this.outputPixelType });
  }
  _getWebGLParameters() {
    const { outputMin: t6 = 0, outputMax: s12 = 255, gamma: e9, useGamma: r8 } = this.functionArguments, u18 = this.rasterInfo.bandCount >= 2 ? 3 : 1, i29 = r8 && (e9 == null ? void 0 : e9.length) ? x(u18, e9) : [1, 1, 1], { minCutOff: n21, maxCutOff: a28 } = this.cutOffs ?? { minCutOff: [0, 0, 0], maxCutOff: [255, 255, 255] };
    ...
    return { bandCount: u18, outMin: t6, outMax: s12, minCutOff: n21, maxCutOff: a28, factor: p22, useGamma: r8, gamma: r8 && e9 ? e9 : [1, 1, 1], gammaCorrection: r8 && i29 ? i29 : [1, 1, 1], stretchType: this.functionArguments.stretchType, isOutputRounded: l18, type: "stretch" };
  }
};
e([y({ json: { write: true, name: "rasterFunction" } })], c28.prototype, "functionName", void 0), e([y({ type: u16, json: { write: true, name: "rasterFunctionArguments" } })], c28.prototype, "functionArguments", void 0), e([y()], c28.prototype, "rasterArgumentNames", void 0), e([y({ json: { write: true } })], c28.prototype, "lookup", void 0), e([y({ json: { write: true } })], c28.prototype, "cutOffs", void 0), c28 = e([a2("esri.layers.support.rasterFunctions.StretchFunction")], c28);
var l16 = c28;
...
var a24 = c29 = class extends p4 {
  ...
  clone() {
    return new c29({ attributeTableAsRecordSet: a(this.attributeTableAsRecordSet) });
  }
};
e([y({ json: { write: true } })], a24.prototype, "attributeTableAsRecordSet", void 0), a24 = c29 = e([a2("esri.layers.support.rasterFunctions.TableFunctionArguments")], a24);
var i27 = a24;
...
e([y({ json: { write: true, name: "rasterFunction" } })], i28.prototype, "functionName", void 0), e([y({ type: i27, json: { write: true, name: "rasterFunctionArguments" } })], i28.prototype, "functionArguments", void 0), e([y()], i28.prototype, "rasterArgumentNames", void 0), e([y()], i28.prototype, "isNoopProcess", void 0), i28 = e([a2("esri.layers.support.rasterFunctions.TableFunction")], i28);
var n19 = i28;

// ../node_modules/@arcgis/core/layers/support/rasterFunctions/rasterFunctionHelper.js
var N2 = /* @__PURE__ */ new Map();
function R2(t6, e9) {
  const { rasterFunctionArguments: r8 } = t6;
  if (!r8) return;
...
function D2(t6) {
  var _a;
  const { rasterFunction: e9, rasterFunctionArguments: r8 } = t6, n21 = {};
  for (const o11 in r8) {
    let t7 = r8[o11];
...
function V2(t6, r8) {
  var _a, _b;
  const { rasterFunction: n21, rasterFunctionArguments: o11 } = t6, s12 = (_a = t6.outputPixelType) == null ? void 0 : _a.toLowerCase();
  if (null == n21 || !N2.has(n21)) throw new s("raster-function-helper", `unsupported raster function: ${n21}`);
  const a28 = N2.get(n21), i29 = ("function" == typeof a28.ctor ? a28.ctor : a28.ctor.default).fromJSON({ ...t6, outputPixelType: s12 }), { rasterArgumentNames: c32 } = i29, u18 = [], m12 = v3(o11, c32), l18 = "rasters" === c32[0] || c32.length > 1, p22 = [];
  for (let e9 = 0; e9 < m12.length; e9++) {
    const t7 = m12[e9];
    let n22;
    null == t7 || "string" == typeof t7 && t7.startsWith("$") ? u18.push(r8 == null ? void 0 : r8.raster) : "string" == typeof t7 ? r8[t7] && u18.push(r8[t7]) : "number" != typeof t7 && "rasterFunction" in t7 && (n22 = V2(t7, r8), l18 || (i29.functionArguments[c32[e9]] = n22), u18.push(n22)), l18 && p22.push(n22 ?? t7);
  }
  if (l18 && ("rasters" === c32[0] ? i29.functionArguments.rasters = p22 : c32.forEach((t7, e9) => {
    ...
    const t7 = (_b = r8.raster) == null ? void 0 : _b.url;
...
function B3(e9) {
  ...
  let { FromColor: n21, ToColor: o11 } = e9;
  if (!Array.isArray(n21)) {
    const { r: e10, g: r9, b: o12 } = y4({ h: n21.Hue, s: n21.Saturation, v: n21.Value });
    n21 = [e10, r9, o12, n21.AlphaValue];
  }
  if (!Array.isArray(o11)) {
    const { r: e10, g: r9, b: n22 } = y4({ h: o11.Hue, s: o11.Saturation, v: o11.Value });
    o11 = [e10, r9, n22, o11.AlphaValue];
  }
  return { type: "algorithmic", algorithm: r8, fromColor: n21, toColor: o11 };
}
...
function E2(t6, e9) {
  ...
  const { renderingRule: r8, templates: n21 } = e9, { function: o11, arguments: s12, _object_id: a28 } = t6;
  if (!o11 || !s12) return;
  ...
  for (const c32 in s12) {
    ...
    const t7 = s12[c32];
    t7 && "object" == typeof t7 && "type" in t7 && ("RasterFunctionTemplate" === t7.type || "RasterFunctionVariable" === t7.type) ? ("RasterFunctionVariable" === t7.type ? i29[c32] = k3(t7, n21) : (r8.rasterFunctionArguments[c32] = {}, E2(t7, { renderingRule: r8.rasterFunctionArguments[c32], templates: n21 })), null != t7._object_id && n21.set(t7._object_id, i29[c32])) : i29[c32] = t7;
  }
...
function M3(t6) {
  const { renderingRule: r8, templates: n21 } = t6;
  if ("object" != typeof r8 || !(r8 == null ? void 0 : r8.rasterFunctionArguments) || !n21.size) return;
  const { rasterFunctionArguments: o11 } = r8;
  for (const s12 in o11) {
    ...
    if (null == r9) t7 && "object" == typeof t7 && (t7.rasterFunctionArguments && M3({ renderingRule: t7, templates: n21 }), Array.isArray(t7) && t7.forEach((o12, s13) => {
      ...
      } else M3({ renderingRule: o12, templates: n21 });
    }));
    else {
...
N2.set("Arithmetic", { desc: "Arithmetic Function", ctor: a8, rasterArgumentNames: ["rasters"] }), N2.set("Aspect", { desc: "Aspect Function", ctor: p9, rasterArgumentNames: ["raster"] }), N2.set("BandArithmetic", { desc: "Band Arithmetic Function", ctor: u7, rasterArgumentNames: ["raster"] }), N2.set("Colormap", { desc: "Colormap Function", ctor: u9, rasterArgumentNames: ["raster"] }), N2.set("CompositeBand", { desc: "CompositeBand Function", ctor: a14, rasterArgumentNames: ["rasters"] }), N2.set("ComputeChange", { desc: "ComputeChange Function", ctor: m7, rasterArgumentNames: ["rasters"] }), N2.set("Convolution", { desc: "Convolution Function", ctor: p15, rasterArgumentNames: ["raster"] }), N2.set("ContrastBrightness", { desc: "Contrast Brightness Function", ctor: p13, rasterArgumentNames: ["raster"] }), N2.set("ExtractBand", { desc: "ExtractBand Function", ctor: l13, rasterArgumentNames: ["raster"] }), N2.set("Curvature", { desc: "Curvature Function", ctor: c16, rasterArgumentNames: ["raster"] }), N2.set("Grayscale", { desc: "Grayscale Function", ctor: u14, rasterArgumentNames: ["raster"] }), N2.set("Clip", { desc: "Clip Function", ctor: p12, rasterArgumentNames: ["raster"] }), N2.set("Local", { desc: "Local Function", ctor: d7, rasterArgumentNames: ["rasters"] }), N2.set("Mask", { desc: "Mask Function", ctor: p16, rasterArgumentNames: ["raster"] }), N2.set("NDVI", { desc: "NDVI Function", ctor: a20, rasterArgumentNames: ["raster"] }), N2.set("Remap", { desc: "Remap Function", ctor: g5, rasterArgumentNames: ["raster"] }), N2.set("Slope", { desc: "Slope Function", ctor: c23, rasterArgumentNames: ["raster"] }), N2.set("Statistics", { desc: "Focal Statistics Function", ctor: p19, rasterArgumentNames: ["raster"] }), N2.set("StatisticsHistogram", { desc: "Statistics Histogram Function", ctor: n17, rasterArgumentNames: ["raster"] }), N2.set("Stretch", { desc: "Stretch Function", ctor: l16, rasterArgumentNames: ["raster"] }), N2.set("Table", { desc: "Attribute Table Function", ctor: n19, rasterArgumentNames: ["raster"] });
...
var n20 = a26 = class extends a25 {
  ...
  clone() {
    return new a26({ tolerance: this.tolerance });
  }
};
e([o2({ GCSShiftXform: "gcs-shift" })], n20.prototype, "type", void 0), e([y()], n20.prototype, "tolerance", void 0), n20 = a26 = e([a2("esri.layers.support.rasterTransforms.GCSShiftTransform")], n20);
var c30 = n20;
...
function a27(e9, r8, o11) {
  const { x: t6, y: s12 } = r8;
  if (o11 < 2) {
    return { x: e9[0] + t6 * e9[2] + s12 * e9[4], y: e9[1] + t6 * e9[3] + s12 * e9[5] };
  }
  if (2 === o11) {
    const r9 = t6 * t6, o12 = s12 * s12, i30 = t6 * s12;
    return { x: e9[0] + t6 * e9[2] + s12 * e9[4] + r9 * e9[6] + i30 * e9[8] + o12 * e9[10], y: e9[1] + t6 * e9[3] + s12 * e9[5] + r9 * e9[7] + i30 * e9[9] + o12 * e9[11] };
  }
  const i29 = t6 * t6, n21 = s12 * s12, f6 = t6 * s12, p22 = i29 * t6, l18 = i29 * s12, a28 = t6 * n21, c32 = s12 * n21;
  return { x: e9[0] + t6 * e9[2] + s12 * e9[4] + i29 * e9[6] + f6 * e9[8] + n21 * e9[10] + p22 * e9[12] + l18 * e9[14] + a28 * e9[16] + c32 * e9[18], y: e9[1] + t6 * e9[3] + s12 * e9[5] + i29 * e9[7] + f6 * e9[9] + n21 * e9[11] + p22 * e9[13] + l18 * e9[15] + a28 * e9[17] + c32 * e9[19] };
}
function c31(e9, r8, o11) {
  const { xmin: t6, ymin: s12, xmax: i29, ymax: n21, spatialReference: f6 } = r8;
  let l18 = [];
  if (o11 < 2) l18.push({ x: t6, y: n21 }), l18.push({ x: i29, y: n21 }), l18.push({ x: t6, y: s12 }), l18.push({ x: i29, y: s12 });
  else {
    let e10 = 10;
    for (let r9 = 0; r9 < e10; r9++) l18.push({ x: t6, y: s12 + (n21 - s12) * r9 / (e10 - 1) }), l18.push({ x: i29, y: s12 + (n21 - s12) * r9 / (e10 - 1) });
    e10 = 8;
    for (let r9 = 1; r9 <= e10; r9++) l18.push({ x: t6 + (i29 - t6) * r9 / e10, y: s12 }), l18.push({ x: t6 + (i29 - t6) * r9 / e10, y: n21 });
  }
  l18 = l18.map((r9) => a27(e9, r9, o11));
  const c32 = l18.map((e10) => e10.x), m12 = l18.map((e10) => e10.y);
  return new w({ xmin: Math.min.apply(null, c32), xmax: Math.max.apply(null, c32), ymin: Math.min.apply(null, m12), ymax: Math.max.apply(null, m12), spatialReference: f6 });
}
function m11(e9) {
...
var u17 = l17 = class extends a25 {
  ...
  readForwardCoefficients(e9, r8) {
    const { coeffX: o11, coeffY: t6 } = r8;
    if (!(o11 == null ? void 0 : o11.length) || !(t6 == null ? void 0 : t6.length) || o11.length !== t6.length) return null;
    const s12 = [];
  ...
  writeForwardCoefficients(e9, r8, o11) {
    const t6 = [], s12 = [];
    for (let i29 = 0; i29 < (e9 == null ? void 0 : e9.length); i29++) i29 % 2 == 0 ? t6.push(e9[i29]) : s12.push(e9[i29]);
  ...
  readInverseCoefficients(e9, r8) {
    const { inverseCoeffX: o11, inverseCoeffY: t6 } = r8;
    if (!(o11 == null ? void 0 : o11.length) || !(t6 == null ? void 0 : t6.length) || o11.length !== t6.length) return null;
    const s12 = [];
    for (let i29 = 0; i29 < o11.length; i29++) s12.push(o11[i29]), s12.push(t6[i29]);
    return s12;
  ...
  forwardTransform(e9) {
    if ("point" === e9.type) {
      ...
      return new _({ x: r8.x, y: r8.y, spatialReference: e9.spatialReference });
    }
...
//# sourceMappingURL=chunk-5N3PW5XK.js.map
