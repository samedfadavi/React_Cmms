...
} from "./chunk-YGYJXSX5.js";
import {
  MAX_COLUMNS
} from "./chunk-UK5G73HF.js";
import {
  Symbol$1,
  baseGetTag,
  debounce,
  ...
  isSymbol,
  root$1
} from "./chunk-WPXGL3FG.js";
import {
  defineCustomElement as defineCustomElement3,
  defineCustomElement2 as defineCustomElement4,
  defineCustomElement3 as defineCustomElement5
} from "./chunk-WGZFANQS.js";
import "./chunk-F74DEOEQ.js";
import {
  InteractiveContainer,
  connectInteractive,
  disconnectInteractive,
  updateHostInteraction
} from "./chunk-RWSYSYHD.js";
import "./chunk-UIHEYGFG.js";
import {
  defineCustomElement as defineCustomElement6
} from "./chunk-6ATQUN5Q.js";
import {
  defineCustomElement as defineCustomElement2
} from "./chunk-WODEXGRC.js";
import {
  connectLocalized,
  connectMessages,
  disconnectLocalized,
  ...
  setUpMessages,
  updateMessages
} from "./chunk-ZHU3XE44.js";
import {
  componentFocusable,
  setComponentLoaded,
  setUpLoadableComponent
} from "./chunk-A4CAFQ6Q.js";
import {
  defineCustomElement
} from "./chunk-DKFKIUUE.js";
import {
  createObserver
} from "./chunk-VGYSTLRL.js";
import "./chunk-76UNYNDT.js";
import {
  slotChangeHasAssignedElement,
  toAriaBoolean
} from "./chunk-YY6NWUAB.js";
import "./chunk-EVFIPTNI.js";
...
var Stack = proxyCustomElement(class Stack2 extends H {
  ...
  render() {
    return h(Host, { key: "77243a78e7e5f05ef2fa43193460dc3b0a63afb8" }, h("div", { key: "761521ceb58a4d186a1aff5889e29db18e5f5f4d", class: CSS2.container }, this.renderActionsStart(), this.renderContentStart(), this.renderDefaultContent(), this.renderContentEnd(), this.renderActionsEnd()));
  }
  static get style() {
...
var Filter = proxyCustomElement(class Filter2 extends H {
  constructor() {
    ...
    this.filterDebounced = debounce((value, emit = false, onFilter) => this.items.length && this.updateFiltered(filter(this.items, value, this.filterProps), emit, onFilter), DEBOUNCE.filter);
  ...
  render() {
    ...
    return h(InteractiveContainer, { key: "45e216d51b5b12ddc4295ade0be6dd451aeef851", disabled }, h("div", { key: "72a041cd4c1a9afcc3e20dc48719024fa0bd91d8", class: CSS3.container }, h("label", { key: "94096613f5abe9d5334b47986556a7d8aaac4556" }, h("calcite-input", { key: "cb61179b03fca1436146f80a96adc6177fb92a2e", clearable: true, disabled, icon: ICONS.search, label: this.messages.label, messageOverrides: { clear: this.messages.clear }, onCalciteInputInput: this.inputHandler, onKeyDown: this.keyDownHandler, placeholder: this.placeholder, ref: (el) => {
      this.textInput = el;
...
var List = proxyCustomElement(class List2 extends H {
  ...
  render() {
    ...
    return h(InteractiveContainer, { key: "835ad7cd3b23dafd88ecb2b203da9cb0ed5c608a", disabled: this.disabled }, h("div", { key: "d3a24de65bb88f763d5ea1ac28366ed17fa5b1aa", class: CSS4.container }, this.dragEnabled ? h("span", { "aria-live": "assertive", class: CSS4.assistiveText }, this.assistiveText) : null, this.renderItemAriaLive(), loading ? h("calcite-scrim", { class: CSS4.scrim, loading }) : null, h("table", { key: "dfeccafe1a193d11e322834ff2c192fd451695eb", "aria-busy": toAriaBoolean(loading), "aria-label": label || "", class: CSS4.table, onKeyDown: this.handleListKeydown, role: "treegrid" }, filterEnabled || hasFilterActionsStart || hasFilterActionsEnd ? h("thead", { class: CSS4.sticky }, h("tr", null, h("th", { colSpan: MAX_COLUMNS }, h("calcite-stack", { class: CSS4.stack }, h("slot", { name: SLOTS2.filterActionsStart, onSlotchange: this.handleFilterActionsStartSlotChange, slot: SLOTS.actionsStart }), h("calcite-filter", { "aria-label": filterPlaceholder, disabled, filterProps, items: dataForFilter, onCalciteFilterChange: this.handleFilterChange, placeholder: filterPlaceholder, ref: this.setFilterEl, value: filterText }), h("slot", { name: SLOTS2.filterActionsEnd, onSlotchange: this.handleFilterActionsEndSlotChange, slot: SLOTS.actionsEnd }))))) : null, h("tbody", { key: "0c7eac45016250148863ffcb8159944dae887c64", class: CSS4.tableContainer }, h("slot", { key: "64c8f6a0ffa7a2179fbb0289bf79f3b5c76b55fc", onSlotchange: this.handleDefaultSlotChange }))), h("div", { key: "91fd4c27deb58481fb0be8117c13f93efc9abb16", "aria-live": "polite", "data-test-id": "no-results-container", hidden: !(hasFilterNoResults && filterEnabled && filterText && !filteredItems.length) }, h("slot", { key: "4090a37ff3323e58bdbfe98c773338b03696bbfc", name: SLOTS2.filterNoResults, onSlotchange: this.handleFilterNoResultsSlotChange }))));
  }
  // --------------------------------------------------------------------------
  //
  //  Private Methods
...
@esri/calcite-components/dist/components/calcite-list.js:
   ...
   *)
*/
//# sourceMappingURL=calcite-list-I4SFG3PL.js.map
